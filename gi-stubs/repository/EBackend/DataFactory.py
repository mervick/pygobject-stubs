...
class DataFactory(DBusServer, __gi_repository_Gio.Initable):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dbf8a1d90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DataFactory), '__module__': 'gi.repository.EBackend', '__gtype__': <GType EDataFactory (94170535264432)>, '__doc__': None, '__gsignals__': {}, 'backend_closed': gi.FunctionInfo(backend_closed), 'backend_closed_by_sender': gi.FunctionInfo(backend_closed_by_sender), 'construct_path': gi.FunctionInfo(construct_path), 'create_backend': gi.FunctionInfo(create_backend), 'get_backend_per_process': gi.FunctionInfo(get_backend_per_process), 'get_registry': gi.FunctionInfo(get_registry), 'get_reload_supported': gi.FunctionInfo(get_reload_supported), 'list_opened_backends': gi.FunctionInfo(list_opened_backends), 'open_backend': gi.FunctionInfo(open_backend), 'ref_backend_factory': gi.FunctionInfo(ref_backend_factory), 'spawn_subprocess_backend': gi.FunctionInfo(spawn_subprocess_backend), 'use_backend_per_process': gi.FunctionInfo(use_backend_per_process), 'do_complete_open': gi.VFuncInfo(complete_open), 'do_create_backend': gi.VFuncInfo(create_backend), 'do_open_backend': gi.VFuncInfo(open_backend), 'parent': <property object at 0x7f9dc2d8cbd0>, 'priv': <property object at 0x7f9dc2d8ccc0>})"
    __gdoc__ = 'Object EDataFactory\n\nProperties from EDataFactory:\n  registry -> ESourceRegistry: Registry\n    Data source registry\n  reload-supported -> gboolean: Reload Supported\n    Whether the data factory supports Reload\n  backend-per-process -> gint: Backend Per Process\n    Override backend-per-process compile-time option\n\nSignals from EDBusServer:\n  bus-acquired (GDBusConnection)\n  bus-name-acquired (GDBusConnection)\n  bus-name-lost (GDBusConnection)\n  run-server () -> EDBusServerExitCode\n  quit-server (EDBusServerExitCode)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EDataFactory (94170535264432)>'
    __info__ = ObjectInfo(DataFactory)
