...
class SourceRegistryServer(DataFactory):
    """
    :Constructors:
    
    ::
    
        SourceRegistryServer(**properties)
        new() -> EBackend.DBusServer
    """
    def add_source(self, source): # real signature unknown; restored from __doc__
        """ add_source(self, source:EDataServer.Source) """
        pass
    ...
    def do_files_loaded(self, *args, **kwargs): # real signature unknown
        """ files_loaded(self) """
        pass

    def do_load_error(self, *args, **kwargs): # real signature unknown
        """ load_error(self, file:Gio.File, error:error) """
        pass
    ...
    def do_tweak_key_file(self, *args, **kwargs): # real signature unknown
        """ tweak_key_file(self, key_file:GLib.KeyFile, uid:str) -> bool """
        pass
    ...
    def find_extension(self, source, extension_name): # real signature unknown; restored from __doc__
        """ find_extension(self, source:EDataServer.Source, extension_name:str) -> EDataServer.Source or None """
        pass
    ...
    def list_sources(self, extension_name): # real signature unknown; restored from __doc__
        """ list_sources(self, extension_name:str) -> list """
        return []

    def load_directory(self, path, flags): # real signature unknown; restored from __doc__
        """ load_directory(self, path:str, flags:EBackend.SourcePermissionFlags) -> bool """
        return False

    def load_error(self, file, error): # real signature unknown; restored from __doc__
        """ load_error(self, file:Gio.File, error:error) """
        pass
    ...
    def load_file(self, file, flags): # real signature unknown; restored from __doc__
        """ load_file(self, file:Gio.File, flags:EBackend.SourcePermissionFlags) -> EDataServer.Source or None """
        pass
    ...
    def load_resource(self, resource, path, flags): # real signature unknown; restored from __doc__
        """ load_resource(self, resource:Gio.Resource, path:str, flags:EBackend.SourcePermissionFlags) -> bool """
        return False
    ...
    def ref_backend(self, source): # real signature unknown; restored from __doc__
        """ ref_backend(self, source:EDataServer.Source) -> EBackend.CollectionBackend or None """
        pass

    def ref_backend_factory(self, source): # real signature unknown; restored from __doc__
        """ ref_backend_factory(self, source:EDataServer.Source) -> EBackend.CollectionBackendFactory or None """
        pass

    def ref_credentials_provider(self): # real signature unknown; restored from __doc__
        """ ref_credentials_provider(self) -> EDataServer.SourceCredentialsProvider """
        pass
    ...
    def ref_source(self, uid): # real signature unknown; restored from __doc__
        """ ref_source(self, uid:str) -> EDataServer.Source or None """
        pass
    ...
    def remove_source(self, source): # real signature unknown; restored from __doc__
        """ remove_source(self, source:EDataServer.Source) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dbf78fac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceRegistryServer), '__module__': 'gi.repository.EBackend', '__gtype__': <GType ESourceRegistryServer (94170535337232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_source': gi.FunctionInfo(add_source), 'find_extension': gi.FunctionInfo(find_extension), 'get_oauth2_services': gi.FunctionInfo(get_oauth2_services), 'list_sources': gi.FunctionInfo(list_sources), 'load_directory': gi.FunctionInfo(load_directory), 'load_error': gi.FunctionInfo(load_error), 'load_file': gi.FunctionInfo(load_file), 'load_resource': gi.FunctionInfo(load_resource), 'ref_backend': gi.FunctionInfo(ref_backend), 'ref_backend_factory': gi.FunctionInfo(ref_backend_factory), 'ref_credentials_provider': gi.FunctionInfo(ref_credentials_provider), 'ref_source': gi.FunctionInfo(ref_source), 'remove_source': gi.FunctionInfo(remove_source), 'do_files_loaded': gi.VFuncInfo(files_loaded), 'do_load_error': gi.VFuncInfo(load_error), 'do_source_added': gi.VFuncInfo(source_added), 'do_source_removed': gi.VFuncInfo(source_removed), 'do_tweak_key_file': gi.VFuncInfo(tweak_key_file), 'parent': <property object at 0x7f9dbf898680>, 'priv': <property object at 0x7f9dbf898770>})"
    __gdoc__ = 'Object ESourceRegistryServer\n\nSignals from ESourceRegistryServer:\n  load-error (GFile, GError)\n  files-loaded ()\n  source-added (EServerSideSource)\n  source-removed (EServerSideSource)\n  tweak-key-file (GKeyFile, gchararray) -> gboolean\n\nProperties from EDataFactory:\n  registry -> ESourceRegistry: Registry\n    Data source registry\n  reload-supported -> gboolean: Reload Supported\n    Whether the data factory supports Reload\n  backend-per-process -> gint: Backend Per Process\n    Override backend-per-process compile-time option\n\nSignals from EDBusServer:\n  bus-acquired (GDBusConnection)\n  bus-name-acquired (GDBusConnection)\n  bus-name-lost (GDBusConnection)\n  run-server () -> EDBusServerExitCode\n  quit-server (EDBusServerExitCode)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceRegistryServer (94170535337232)>'
    __info__ = ObjectInfo(SourceRegistryServer)
