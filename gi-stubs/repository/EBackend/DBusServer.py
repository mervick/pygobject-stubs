...
class DBusServer(__gi_overrides_GObject.Object, __gi_repository_EDataServer.Extensible):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dbf8c3760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DBusServer), '__module__': 'gi.repository.EBackend', '__gtype__': <GType EDBusServer (94170535250960)>, '__doc__': None, '__gsignals__': {}, 'hold': gi.FunctionInfo(hold), 'load_modules': gi.FunctionInfo(load_modules), 'quit': gi.FunctionInfo(quit), 'release': gi.FunctionInfo(release), 'run': gi.FunctionInfo(run), 'do_bus_acquired': gi.VFuncInfo(bus_acquired), 'do_bus_name_acquired': gi.VFuncInfo(bus_name_acquired), 'do_bus_name_lost': gi.VFuncInfo(bus_name_lost), 'do_quit_server': gi.VFuncInfo(quit_server), 'do_run_server': gi.VFuncInfo(run_server), 'parent': <property object at 0x7f9dc2d8a900>, 'priv': <property object at 0x7f9dc2d8a9f0>})"
    __gdoc__ = 'Object EDBusServer\n\nSignals from EDBusServer:\n  bus-acquired (GDBusConnection)\n  bus-name-acquired (GDBusConnection)\n  bus-name-lost (GDBusConnection)\n  run-server () -> EDBusServerExitCode\n  quit-server (EDBusServerExitCode)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EDBusServer (94170535250960)>'
