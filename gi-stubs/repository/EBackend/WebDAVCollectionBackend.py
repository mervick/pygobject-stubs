...
class WebDAVCollectionBackend(CollectionBackend):
    """
    :Constructors:
    
    ::
    
        WebDAVCollectionBackend(**properties)
    """
    ...
    def discover_sync(self, calendar_url=None, contacts_url=None, credentials, cancellable=None): # real signature unknown; restored from __doc__
        """ discover_sync(self, calendar_url:str=None, contacts_url:str=None, credentials:EDataServer.NamedParameters, cancellable:Gio.Cancellable=None) -> EDataServer.SourceAuthenticationResult, out_certificate_pem:str, out_certificate_errors:Gio.TlsCertificateFlags """
        pass
    ...
    def do_get_resource_id(self, *args, **kwargs): # real signature unknown
        """ get_resource_id(self, source:EDataServer.Source) -> str or None """
        pass

    def do_is_custom_source(self, *args, **kwargs): # real signature unknown
        """ is_custom_source(self, source:EDataServer.Source) -> bool """
        pass
    ...
    def get_resource_id(self, source): # real signature unknown; restored from __doc__
        """ get_resource_id(self, source:EDataServer.Source) -> str or None """
        return ""
    ...
    def is_custom_source(self, source): # real signature unknown; restored from __doc__
        """ is_custom_source(self, source:EDataServer.Source) -> bool """
        return False
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WebDAVCollectionBackend), '__module__': 'gi.repository.EBackend', '__gtype__': <GType EWebDAVCollectionBackend (94170535369728)>, '__doc__': None, '__gsignals__': {}, 'discover_sync': gi.FunctionInfo(discover_sync), 'get_resource_id': gi.FunctionInfo(get_resource_id), 'is_custom_source': gi.FunctionInfo(is_custom_source), 'do_get_resource_id': gi.VFuncInfo(get_resource_id), 'do_is_custom_source': gi.VFuncInfo(is_custom_source), 'parent': <property object at 0x7f9dbf8a0220>, 'priv': <property object at 0x7f9dbf8a0360>})"
    __gdoc__ = 'Object EWebDAVCollectionBackend\n\nSignals from ECollectionBackend:\n  child-added (EServerSideSource)\n  child-removed (EServerSideSource)\n\nProperties from ECollectionBackend:\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    The proxy resolver for this backend\n  server -> ESourceRegistryServer: Server\n    The server to which the backend belongs\n\nProperties from EBackend:\n  connectable -> GSocketConnectable: Connectable\n    Socket endpoint of a network service\n  main-context -> GMainContext: Main Context\n    The main loop context on which to attach event sources\n  online -> gboolean: Online\n    Whether the backend is online\n  source -> ESource: Source\n    The data source being acted upon\n  user-prompter -> EUserPrompter: User Prompter\n    User prompter instance\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EWebDAVCollectionBackend (94170535369728)>'
    __info__ = ObjectInfo(WebDAVCollectionBackend)
