...
class UserPrompterServer(DBusServer):
    """
    :Constructors:
    
    ::
    
        UserPrompterServer(**properties)
    ...
    def register(self, extension, dialog_name): # real signature unknown; restored from __doc__
        """ register(self, extension:EDataServer.Extension, dialog_name:str) -> bool """
        return False
    ...
    def response(self, prompt_id, response, extension_values=None): # real signature unknown; restored from __doc__
        """ response(self, prompt_id:int, response:int, extension_values:EDataServer.NamedParameters=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dc2dc2730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UserPrompterServer), '__module__': 'gi.repository.EBackend', '__gtype__': <GType EUserPrompterServer (94170535359328)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'register': gi.FunctionInfo(register), 'response': gi.FunctionInfo(response), 'parent': <property object at 0x7f9dbf89d360>, 'priv': <property object at 0x7f9dbf89d450>})"
    __gdoc__ = 'Object EUserPrompterServer\n\nSignals from EUserPrompterServer:\n  prompt (gint, gchararray, gchararray, gchararray, gchararray, gboolean, gpointer)\n\nSignals from EDBusServer:\n  bus-acquired (GDBusConnection)\n  bus-name-acquired (GDBusConnection)\n  bus-name-lost (GDBusConnection)\n  run-server () -> EDBusServerExitCode\n  quit-server (EDBusServerExitCode)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EUserPrompterServer (94170535359328)>'
    __info__ = ObjectInfo(UserPrompterServer)
