...
class Backend(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dc2d5f310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Backend), '__module__': 'gi.repository.EBackend', '__gtype__': <GType EBackend (94170535182000)>, '__doc__': None, '__gsignals__': {}, 'credentials_required': gi.FunctionInfo(credentials_required), 'credentials_required_finish': gi.FunctionInfo(credentials_required_finish), 'credentials_required_sync': gi.FunctionInfo(credentials_required_sync), 'ensure_online_state_updated': gi.FunctionInfo(ensure_online_state_updated), 'ensure_source_status_connected': gi.FunctionInfo(ensure_source_status_connected), 'get_destination_address': gi.FunctionInfo(get_destination_address), 'get_online': gi.FunctionInfo(get_online), 'get_source': gi.FunctionInfo(get_source), 'get_user_prompter': gi.FunctionInfo(get_user_prompter), 'is_destination_reachable': gi.FunctionInfo(is_destination_reachable), 'prepare_shutdown': gi.FunctionInfo(prepare_shutdown), 'ref_connectable': gi.FunctionInfo(ref_connectable), 'ref_main_context': gi.FunctionInfo(ref_main_context), 'schedule_authenticate': gi.FunctionInfo(schedule_authenticate), 'schedule_credentials_required': gi.FunctionInfo(schedule_credentials_required), 'set_connectable': gi.FunctionInfo(set_connectable), 'set_online': gi.FunctionInfo(set_online), 'trust_prompt': gi.FunctionInfo(trust_prompt), 'trust_prompt_finish': gi.FunctionInfo(trust_prompt_finish), 'trust_prompt_sync': gi.FunctionInfo(trust_prompt_sync), 'do_authenticate_sync': gi.VFuncInfo(authenticate_sync), 'do_get_destination_address': gi.VFuncInfo(get_destination_address), 'do_prepare_shutdown': gi.VFuncInfo(prepare_shutdown), 'parent': <property object at 0x7f9dc2db4c70>, 'priv': <property object at 0x7f9dc2db4db0>})"
    __gdoc__ = 'Object EBackend\n\nProperties from EBackend:\n  connectable -> GSocketConnectable: Connectable\n    Socket endpoint of a network service\n  main-context -> GMainContext: Main Context\n    The main loop context on which to attach event sources\n  online -> gboolean: Online\n    Whether the backend is online\n  source -> ESource: Source\n    The data source being acted upon\n  user-prompter -> EUserPrompter: User Prompter\n    User prompter instance\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EBackend (94170535182000)>'
    __info__ = ObjectInfo(Backend)
