...
class ServerSideSourceCredentialsProvider(__gi_repository_EDataServer.SourceCredentialsProvider):
    """
    :Constructors:
    
    ::
    
        ServerSideSourceCredentialsProvider(**properties)
        new(registry:EBackend.SourceRegistryServer) -> EDataServer.SourceCredentialsProvider
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dbf78f490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ServerSideSourceCredentialsProvider), '__module__': 'gi.repository.EBackend', '__gtype__': <GType EServerSideSourceCredentialsProvider (94170535318448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7f9dbf894b30>, 'priv': <property object at 0x7f9dbf894c70>})"
    __gdoc__ = 'Object EServerSideSourceCredentialsProvider\n\nProperties from ESourceCredentialsProvider:\n  registry -> GObject: Registry\n    An ESourceRegistry\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EServerSideSourceCredentialsProvider (94170535318448)>'
    __info__ = ObjectInfo(ServerSideSourceCredentialsProvider)
