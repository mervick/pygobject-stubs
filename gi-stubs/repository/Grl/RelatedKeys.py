...
class RelatedKeys(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    def set_boolean(self, key, booleanvalue): # real signature unknown; restored from __doc__
        """ set_boolean(self, key:int, booleanvalue:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa0404799d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RelatedKeys), '__module__': 'gi.repository.Grl', '__gtype__': <GType GrlRelatedKeys (94188897704784)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'dup': gi.FunctionInfo(dup), 'get': gi.FunctionInfo(get), 'get_binary': gi.FunctionInfo(get_binary), 'get_boolean': gi.FunctionInfo(get_boolean), 'get_boxed': gi.FunctionInfo(get_boxed), 'get_float': gi.FunctionInfo(get_float), 'get_int': gi.FunctionInfo(get_int), 'get_int64': gi.FunctionInfo(get_int64), 'get_keys': gi.FunctionInfo(get_keys), 'get_string': gi.FunctionInfo(get_string), 'has_key': gi.FunctionInfo(has_key), 'remove': gi.FunctionInfo(remove), 'set': gi.FunctionInfo(set), 'set_binary': gi.FunctionInfo(set_binary), 'set_boolean': gi.FunctionInfo(set_boolean), 'set_boxed': gi.FunctionInfo(set_boxed), 'set_float': gi.FunctionInfo(set_float), 'set_int': gi.FunctionInfo(set_int), 'set_int64': gi.FunctionInfo(set_int64), 'set_string': gi.FunctionInfo(set_string), 'parent': <property object at 0x7fa0404a4360>, 'priv': <property object at 0x7fa0404a4450>, '_grl_reserved': <property object at 0x7fa0404a4540>})"
    __gdoc__ = 'Object GrlRelatedKeys\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GrlRelatedKeys (94188897704784)>'
    __info__ = ObjectInfo(RelatedKeys)
