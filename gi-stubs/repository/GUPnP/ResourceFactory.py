...
class ResourceFactory(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ResourceFactory), '__module__': 'gi.repository.GUPnP', '__gtype__': <GType GUPnPResourceFactory (94417776034016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_default': gi.FunctionInfo(get_default), 'register_resource_proxy_type': gi.FunctionInfo(register_resource_proxy_type), 'register_resource_type': gi.FunctionInfo(register_resource_type), 'unregister_resource_proxy_type': gi.FunctionInfo(unregister_resource_proxy_type), 'unregister_resource_type': gi.FunctionInfo(unregister_resource_type), 'parent': <property object at 0x7f24ea381900>, 'priv': <property object at 0x7f24ea3819f0>})"
    __gdoc__ = 'Object GUPnPResourceFactory\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GUPnPResourceFactory (94417776034016)>'
    __info__ = ObjectInfo(ResourceFactory)
