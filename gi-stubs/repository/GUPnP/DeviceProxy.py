...
class DeviceProxy(DeviceInfo):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f24ea36ab80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceProxy), '__module__': 'gi.repository.GUPnP', '__gtype__': <GType GUPnPDeviceProxy (94417776028768)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f24ea37ebd0>, 'priv': <property object at 0x7f24ea37ecc0>})"
    __gdoc__ = 'Object GUPnPDeviceProxy\n\nProperties from GUPnPDeviceInfo:\n  resource-factory -> GUPnPResourceFactory: Resource Factory\n    The resource factory to use\n  context -> GUPnPContext: Context\n    The GUPnPContext\n  location -> gchararray: Location\n    The location of the device description file\n  udn -> gchararray: UDN\n    The UDN\n  device-type -> gchararray: Device type\n    The device type\n  url-base -> SoupURI: URL base\n    The URL base\n  document -> GUPnPXMLDoc: Document\n    The XML document related to this device\n  element -> gpointer: Element\n    The XML element related to this device\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GUPnPDeviceProxy (94417776028768)>'
    __info__ = ObjectInfo(DeviceProxy)
