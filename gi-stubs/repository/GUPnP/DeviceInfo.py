...
class DeviceInfo(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f24ea38aee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceInfo), '__module__': 'gi.repository.GUPnP', '__gtype__': <GType GUPnPDeviceInfo (94417775739024)>, '__doc__': None, '__gsignals__': {}, 'get_context': gi.FunctionInfo(get_context), 'get_description_value': gi.FunctionInfo(get_description_value), 'get_device': gi.FunctionInfo(get_device), 'get_device_type': gi.FunctionInfo(get_device_type), 'get_friendly_name': gi.FunctionInfo(get_friendly_name), 'get_icon_url': gi.FunctionInfo(get_icon_url), 'get_location': gi.FunctionInfo(get_location), 'get_manufacturer': gi.FunctionInfo(get_manufacturer), 'get_manufacturer_url': gi.FunctionInfo(get_manufacturer_url), 'get_model_description': gi.FunctionInfo(get_model_description), 'get_model_name': gi.FunctionInfo(get_model_name), 'get_model_number': gi.FunctionInfo(get_model_number), 'get_model_url': gi.FunctionInfo(get_model_url), 'get_presentation_url': gi.FunctionInfo(get_presentation_url), 'get_resource_factory': gi.FunctionInfo(get_resource_factory), 'get_serial_number': gi.FunctionInfo(get_serial_number), 'get_service': gi.FunctionInfo(get_service), 'get_udn': gi.FunctionInfo(get_udn), 'get_upc': gi.FunctionInfo(get_upc), 'get_url_base': gi.FunctionInfo(get_url_base), 'list_device_types': gi.FunctionInfo(list_device_types), 'list_devices': gi.FunctionInfo(list_devices), 'list_dlna_capabilities': gi.FunctionInfo(list_dlna_capabilities), 'list_dlna_device_class_identifier': gi.FunctionInfo(list_dlna_device_class_identifier), 'list_service_types': gi.FunctionInfo(list_service_types), 'list_services': gi.FunctionInfo(list_services), 'parent': <property object at 0x7f24ea37c900>, 'priv': <property object at 0x7f24ea37c9f0>})"
    __gdoc__ = 'Object GUPnPDeviceInfo\n\nProperties from GUPnPDeviceInfo:\n  resource-factory -> GUPnPResourceFactory: Resource Factory\n    The resource factory to use\n  context -> GUPnPContext: Context\n    The GUPnPContext\n  location -> gchararray: Location\n    The location of the device description file\n  udn -> gchararray: UDN\n    The UDN\n  device-type -> gchararray: Device type\n    The device type\n  url-base -> SoupURI: URL base\n    The URL base\n  document -> GUPnPXMLDoc: Document\n    The XML document related to this device\n  element -> gpointer: Element\n    The XML element related to this device\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GUPnPDeviceInfo (94417775739024)>'
    __info__ = ObjectInfo(DeviceInfo)
