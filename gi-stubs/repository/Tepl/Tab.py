...
class Tab(__gi_repository_Gtk.Grid, TabGroup):
    """
    :Constructors:
    ...
    ::
        ...
        Tab(**properties)
        new() -> Tepl.Tab
        new_with_view(view:Tepl.View) -> Tepl.Tab
    """
    ...
    def add_info_bar(self, info_bar): # real signature unknown; restored from __doc__
        """ add_info_bar(self, info_bar:Gtk.InfoBar) """
        pass
    ...
    def do_close_request(self, *args, **kwargs): # real signature unknown
        """ close_request(self) """
        pass
    ...
    def do_pack_info_bar(self, *args, **kwargs): # real signature unknown
        """ pack_info_bar(self, info_bar:Gtk.InfoBar) """
        pass

    def do_pack_view(self, *args, **kwargs): # real signature unknown
        """ pack_view(self, view:Tepl.View) """
        pass
    ...
    def load_file(self, location): # real signature unknown; restored from __doc__
        """ load_file(self, location:Gio.File) """
        pass
    ...
    def new_with_view(self, view): # real signature unknown; restored from __doc__
        """ new_with_view(view:Tepl.View) -> Tepl.Tab """
        pass
    ...
    def save_async_simple(self): # real signature unknown; restored from __doc__
        """ save_async_simple(self) """
        pass

    def save_as_async(self, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ save_as_async(self, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def save_as_async_simple(self): # real signature unknown; restored from __doc__
        """ save_as_async_simple(self) """
        pass

    def save_as_finish(self, result): # real signature unknown; restored from __doc__
        """ save_as_finish(self, result:Gio.AsyncResult) -> bool """
        return False
