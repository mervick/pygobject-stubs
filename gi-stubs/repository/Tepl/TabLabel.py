...
class TabLabel(__gi_repository_Gtk.Grid):
    """
    :Constructors:
    ...
    def do_get_tooltip_markup(self, *args, **kwargs): # real signature unknown
        """ get_tooltip_markup(self) -> str """
        pass
    ...
    def get_tab(self): # real signature unknown; restored from __doc__
        """ get_tab(self) -> Tepl.Tab or None """
        pass
    ...
    def new(self, tab): # real signature unknown; restored from __doc__
        """ new(tab:Tepl.Tab) -> Gtk.Widget """
        pass
    ...
    def update_tooltip(self): # real signature unknown; restored from __doc__
        """ update_tooltip(self) """
        pass
