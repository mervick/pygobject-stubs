...
class InfoBar(__gi_repository_Gtk.InfoBar):
    """
    :Constructors:
    ...
    ::
        ...
        InfoBar(**properties)
        new() -> Tepl.InfoBar
        new_simple(msg_type:Gtk.MessageType, primary_msg:str, secondary_msg:str=None) -> Tepl.InfoBar
    """
    ...
    def add_close_button(self): # real signature unknown; restored from __doc__
        """ add_close_button(self) """
        pass

    def add_content_widget(self, content): # real signature unknown; restored from __doc__
        """ add_content_widget(self, content:Gtk.Widget) """
        pass
    ...
    def add_icon(self): # real signature unknown; restored from __doc__
        """ add_icon(self) """
        pass
    ...
    def add_primary_message(self, primary_msg): # real signature unknown; restored from __doc__
        """ add_primary_message(self, primary_msg:str) """
        pass

    def add_secondary_message(self, secondary_msg): # real signature unknown; restored from __doc__
        """ add_secondary_message(self, secondary_msg:str) """
        pass
    ...
    def create_label(self): # real signature unknown; restored from __doc__
    ...
    def new_simple(self, msg_type, primary_msg, secondary_msg=None): # real signature unknown; restored from __doc__
        """ new_simple(msg_type:Gtk.MessageType, primary_msg:str, secondary_msg:str=None) -> Tepl.InfoBar """
        pass
