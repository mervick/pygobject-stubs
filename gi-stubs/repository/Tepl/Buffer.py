...
class Buffer(__gi_repository_GtkSource.Buffer):
    """
    :Constructors:
    ...
    def do_tepl_cursor_moved(self, *args, **kwargs): # real signature unknown
        """ tepl_cursor_moved(self) """
        pass
    ...
    def get_full_title(self): # real signature unknown; restored from __doc__
        """ get_full_title(self) -> str """
        return ""
    ...
    def get_selection_type(self): # real signature unknown; restored from __doc__
        """ get_selection_type(self) -> Tepl.SelectionType """
        pass
    ...
    def get_style_scheme_id(self): # real signature unknown; restored from __doc__
        """ get_style_scheme_id(self) -> str """
        return ""
    ...
    def is_untouched(self): # real signature unknown; restored from __doc__
        """ is_untouched(self) -> bool """
        return False
    ...
    def set_style_scheme_id(self, style_scheme_id): # real signature unknown; restored from __doc__
        """ set_style_scheme_id(self, style_scheme_id:str) """
        pass
