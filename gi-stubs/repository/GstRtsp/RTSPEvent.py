...
class RTSPEvent(__gobject.GFlags):
    # no doc
    ...
    WRITE = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GstRtsp', '__dict__': <attribute '__dict__' of 'RTSPEvent' objects>, '__doc__': None, '__gtype__': <GType GstRTSPEvent (93854383052592)>, '__flags_values__': {1: <flags GST_RTSP_EV_READ of type GstRtsp.RTSPEvent>, 2: <flags GST_RTSP_EV_WRITE of type GstRtsp.RTSPEvent>}, '__info__': gi.EnumInfo(RTSPEvent), 'READ': <flags GST_RTSP_EV_READ of type GstRtsp.RTSPEvent>, 'WRITE': <flags GST_RTSP_EV_WRITE of type GstRtsp.RTSPEvent>})"
    __flags_values__ = {
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType GstRTSPEvent (93854383052592)>'
    __info__ = gi.EnumInfo(RTSPEvent)
