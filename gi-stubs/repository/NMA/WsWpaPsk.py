...
class WsWpaPsk(__gi_repository_Gtk.Grid, Ws):
    """
    :Constructors:
    ...
    ::
        ...
        WsWpaPsk(**properties)
        new(connection:NM.Connection, secrets_only:bool) -> NMA.WsWpaPsk
    """
    ...
    def new(self, connection, secrets_only): # real signature unknown; restored from __doc__
        """ new(connection:NM.Connection, secrets_only:bool) -> NMA.WsWpaPsk """
        pass
