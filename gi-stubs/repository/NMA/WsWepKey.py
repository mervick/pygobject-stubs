...
class WsWepKey(__gi_repository_Gtk.Grid, Ws):
    """
    :Constructors:
    ...
    ::
        ...
        WsWepKey(**properties)
        new(connection:NM.Connection, type:NM.WepKeyType, adhoc_create:bool, secrets_only:bool) -> NMA.WsWepKey
    """
    ...
    def new(self, connection, type, adhoc_create, secrets_only): # real signature unknown; restored from __doc__
        """ new(connection:NM.Connection, type:NM.WepKeyType, adhoc_create:bool, secrets_only:bool) -> NMA.WsWepKey """
        pass
