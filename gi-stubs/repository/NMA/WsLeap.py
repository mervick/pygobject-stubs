...
class WsLeap(__gi_repository_Gtk.Grid, Ws):
    """
    :Constructors:
    ...
    ::
        ...
        WsLeap(**properties)
        new(connection:NM.Connection, secrets_only:bool) -> NMA.WsLeap
    """
