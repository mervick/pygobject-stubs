...
class WsWpaEap(Ws8021x):
    ...
    ::
        ...
        WsWpaEap(**properties)
        new(connection:NM.Connection, is_editor:bool, secrets_only:bool, secrets_hints:str) -> NMA.WsWpaEap
    """
    ...
    def new(self, connection, is_editor, secrets_only, secrets_hints): # real signature unknown; restored from __doc__
        """ new(connection:NM.Connection, is_editor:bool, secrets_only:bool, secrets_hints:str) -> NMA.WsWpaEap """
        pass
