...
class WifiDialog(__gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    ...
    def get_connection(self): # real signature unknown; restored from __doc__
        """ get_connection(self) -> NM.Connection, device:NM.Device, ap:NM.AccessPoint """
        pass
    ...
    def get_nag_ignored(self): # real signature unknown; restored from __doc__
        """ get_nag_ignored(self) -> bool """
        return False
    ...
    def nag_user(self): # real signature unknown; restored from __doc__
        """ nag_user(self) -> Gtk.Widget """
        pass

    def new(self, client, connection, device, ap, secrets_only): # real signature unknown; restored from __doc__
        """ new(client:NM.Client, connection:NM.Connection, device:NM.Device, ap:NM.AccessPoint, secrets_only:bool) -> Gtk.Widget """
        pass
    ...
    def new_for_create(self, client): # real signature unknown; restored from __doc__
        """ new_for_create(client:NM.Client) -> Gtk.Widget """
        pass

    def new_for_hidden(self, client): # real signature unknown; restored from __doc__
        """ new_for_hidden(client:NM.Client) -> Gtk.Widget """
        pass

    def new_for_other(self, client): # real signature unknown; restored from __doc__
        """ new_for_other(client:NM.Client) -> Gtk.Widget """
        pass

    def new_for_secrets(self, client, connection, secrets_setting_name, secrets_hints): # real signature unknown; restored from __doc__
        """ new_for_secrets(client:NM.Client, connection:NM.Connection, secrets_setting_name:str, secrets_hints:str) -> Gtk.Widget """
        pass
    ...
    def set_nag_ignored(self, ignored): # real signature unknown; restored from __doc__
        """ set_nag_ignored(self, ignored:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9b2343c250>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
