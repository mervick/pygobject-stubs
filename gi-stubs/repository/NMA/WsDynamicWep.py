...
class WsDynamicWep(Ws8021x):
    """
    :Constructors:
    
    ::
    
        WsDynamicWep(**properties)
        new(connection:NM.Connection, is_editor:bool, secrets_only:bool) -> NMA.WsDynamicWep
    """
    ...
    def new(self, connection, is_editor, secrets_only): # real signature unknown; restored from __doc__
        """ new(connection:NM.Connection, is_editor:bool, secrets_only:bool) -> NMA.WsDynamicWep """
        pass
