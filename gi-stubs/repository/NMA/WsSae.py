...
class WsSae(__gi_repository_Gtk.Grid, Ws):
    """
    :Constructors:
    ...
    ::
        ...
        WsSae(**properties)
        new(connection:NM.Connection, secrets_only:bool) -> NMA.WsSae
    """
