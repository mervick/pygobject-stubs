...
class Ws8021x(__gi_repository_Gtk.Grid, Ws):
    """
    :Constructors:
    ...
    ::
        ...
        Ws8021x(**properties)
        new(connection:NM.Connection, is_editor:bool, secrets_only:bool) -> NMA.Ws8021x
    """
