# encoding: utf-8
# module gi.repository.ColordGtk
# from /usr/lib64/girepository-1.0/ColordGtk-1.0.typelib
# by generator 1.147
"""
...
class SampleWidget(__gi_repository_Gtk.DrawingArea):
    """
    :Constructors:
    
    ::
    
        SampleWidget(**properties)
        new() -> Gtk.Widget
    """
    ...
    def set_color(self, color): # real signature unknown; restored from __doc__
        """ set_color(self, color:Colord.ColorRGB) """
        pass
...
class SampleWidgetClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SampleWidgetClass), '__module__': 'gi.repository.ColordGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SampleWidgetClass' objects>, '__weakref__': <attribute '__weakref__' of 'SampleWidgetClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2ff31c99a0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(SampleWidgetClass)


class SampleWidgetPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SampleWidgetPrivate), '__module__': 'gi.repository.ColordGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SampleWidgetPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'SampleWidgetPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(SampleWidgetPrivate)


class SampleWindow(__gi_overrides_Gtk.Window):
    """
    :Constructors:
    
    ::
    
        SampleWindow(**properties)
        new() -> Gtk.Window
    """
    def activate(self): # real signature unknown; restored from __doc__
        """ activate(self) -> bool """
...
class SampleWindowClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SampleWindowClass), '__module__': 'gi.repository.ColordGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SampleWindowClass' objects>, '__weakref__': <attribute '__weakref__' of 'SampleWindowClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2ff31e56d0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(SampleWindowClass)


class SampleWindowPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SampleWindowPrivate), '__module__': 'gi.repository.ColordGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SampleWindowPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'SampleWindowPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(SampleWindowPrivate)
...
class Window(__gi_overrides_GObject.Object):
    ...
    def do_changed(self, *args, **kwargs): # real signature unknown
        """ changed(self, profile:Colord.Profile) """
        pass
    ...
    def get_last_profile(self): # real signature unknown; restored from __doc__
        """ get_last_profile(self) -> Colord.Profile """
        pass

    def get_profile(self, widget, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_profile(self, widget:Gtk.Widget, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_profile_finish(self, res): # real signature unknown; restored from __doc__
        """ get_profile_finish(self, res:Gio.AsyncResult) -> Colord.Profile """
        pass

    def get_profile_sync(self, widget, cancellable=None): # real signature unknown; restored from __doc__
        """ get_profile_sync(self, widget:Gtk.Widget, cancellable:Gio.Cancellable=None) -> Colord.Profile """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2ff319f970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Window), '__module__': 'gi.repository.ColordGtk', '__gtype__': <GType CdWindow (94332097832000)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'error_quark': gi.FunctionInfo(error_quark), 'get_last_profile': gi.FunctionInfo(get_last_profile), 'get_profile': gi.FunctionInfo(get_profile), 'get_profile_finish': gi.FunctionInfo(get_profile_finish), 'get_profile_sync': gi.FunctionInfo(get_profile_sync), 'do_changed': gi.VFuncInfo(changed), 'parent': <property object at 0x7f2ff31e59f0>, 'priv': <property object at 0x7f2ff31e5ae0>})"
    __gdoc__ = 'Object CdWindow\n\nSignals from CdWindow:\n  changed (CdProfile)\n\nProperties from CdWindow:\n  Profile -> gchararray: Color profile\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CdWindow (94332097832000)>'
...
class WindowClass(__gi.Struct):
    ...
    _cd_window_reserved1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _cd_window_reserved2 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _cd_window_reserved3 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _cd_window_reserved4 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _cd_window_reserved5 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _cd_window_reserved6 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _cd_window_reserved7 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _cd_window_reserved8 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(WindowClass), '__module__': 'gi.repository.ColordGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'WindowClass' objects>, '__weakref__': <attribute '__weakref__' of 'WindowClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2ff31e5c70>, 'changed': <property object at 0x7f2ff31e5d60>, '_cd_window_reserved1': <property object at 0x7f2ff31e5ea0>, '_cd_window_reserved2': <property object at 0x7f2ff3138040>, '_cd_window_reserved3': <property object at 0x7f2ff3138180>, '_cd_window_reserved4': <property object at 0x7f2ff31382c0>, '_cd_window_reserved5': <property object at 0x7f2ff3138400>, '_cd_window_reserved6': <property object at 0x7f2ff3138540>, '_cd_window_reserved7': <property object at 0x7f2ff3138680>, '_cd_window_reserved8': <property object at 0x7f2ff31387c0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(WindowClass)


class WindowError(__gobject.GEnum):
    # no doc
    ...
    LAST = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.ColordGtk', '__dict__': <attribute '__dict__' of 'WindowError' objects>, '__doc__': None, '__gtype__': <GType PyColordGtkWindowError (94332098053856)>, '__enum_values__': {0: <enum CD_WINDOW_ERROR_FAILED of type ColordGtk.WindowError>, 1: <enum CD_WINDOW_ERROR_LAST of type ColordGtk.WindowError>}, '__info__': gi.EnumInfo(WindowError), 'FAILED': <enum CD_WINDOW_ERROR_FAILED of type ColordGtk.WindowError>, 'LAST': <enum CD_WINDOW_ERROR_LAST of type ColordGtk.WindowError>})"
    __enum_values__ = {
        0: 0,
        1: 1,
    }
    __gtype__ = None # (!) real value is '<GType PyColordGtkWindowError (94332098053856)>'
    __info__ = gi.EnumInfo(WindowError)
...
class WindowPrivate(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(WindowPrivate), '__module__': 'gi.repository.ColordGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'WindowPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'WindowPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7f2ff457b1f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7f2ff457b280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7f2ff457b310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7f2ff457b3a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7f2ff51b7d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/ColordGtk-1.0.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.ColordGtk', loader=<gi.importer.DynamicImporter object at 0x7f2ff51b7d00>)"
