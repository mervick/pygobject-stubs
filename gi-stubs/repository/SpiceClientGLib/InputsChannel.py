...
class InputsChannel(Channel):
    """
    :Constructors:
    
    ::
    
        InputsChannel(**properties)
    """
    ...
    def button_press(self, button, button_state): # real signature unknown; restored from __doc__
        """ button_press(self, button:int, button_state:int) """
        pass

    def button_release(self, button, button_state): # real signature unknown; restored from __doc__
        """ button_release(self, button:int, button_state:int) """
        pass
    ...
    def key_press(self, scancode): # real signature unknown; restored from __doc__
        """ key_press(self, scancode:int) """
        pass

    def key_press_and_release(self, scancode): # real signature unknown; restored from __doc__
        """ key_press_and_release(self, scancode:int) """
        pass

    def key_release(self, scancode): # real signature unknown; restored from __doc__
        """ key_release(self, scancode:int) """
        pass
    ...
    def motion(self, dx, dy, button_state): # real signature unknown; restored from __doc__
        """ motion(self, dx:int, dy:int, button_state:int) """
        pass
    ...
    def position(self, x, y, display, button_state): # real signature unknown; restored from __doc__
        """ position(self, x:int, y:int, display:int, button_state:int) """
        pass
    ...
    def set_key_locks(self, locks): # real signature unknown; restored from __doc__
        """ set_key_locks(self, locks:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dce6bcdf0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputsChannel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceInputsChannel (93951199794688)>, '__doc__': None, '__gsignals__': {}, 'button_press': gi.FunctionInfo(button_press), 'button_release': gi.FunctionInfo(button_release), 'key_press': gi.FunctionInfo(key_press), 'key_press_and_release': gi.FunctionInfo(key_press_and_release), 'key_release': gi.FunctionInfo(key_release), 'motion': gi.FunctionInfo(motion), 'position': gi.FunctionInfo(position), 'set_key_locks': gi.FunctionInfo(set_key_locks), 'parent': <property object at 0x7f9dce6dcc70>, 'priv': <property object at 0x7f9dce6dcd60>})"
    __gdoc__ = 'Object SpiceInputsChannel\n\nSignals from SpiceInputsChannel:\n  inputs-modifiers ()\n\nProperties from SpiceInputsChannel:\n  key-modifiers -> gint: Key modifiers\n    Guest keyboard lock/led state\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceInputsChannel (93951199794688)>'
    __info__ = ObjectInfo(InputsChannel)
