...
class CursorChannel(Channel):
    """
    :Constructors:
    
    ::
    
        CursorChannel(**properties)
    """
    ...
    def do_cursor_hide(self, *args, **kwargs): # real signature unknown
        """ cursor_hide(self) """
        pass

    def do_cursor_move(self, *args, **kwargs): # real signature unknown
        """ cursor_move(self, x:int, y:int) """
        pass

    def do_cursor_reset(self, *args, **kwargs): # real signature unknown
        """ cursor_reset(self) """
        pass

    def do_cursor_set(self, *args, **kwargs): # real signature unknown
        """ cursor_set(self, width:int, height:int, hot_x:int, hot_y:int, rgba=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dcd622610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CursorChannel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceCursorChannel (93951199776976)>, '__doc__': None, '__gsignals__': {}, 'do_cursor_hide': gi.VFuncInfo(cursor_hide), 'do_cursor_move': gi.VFuncInfo(cursor_move), 'do_cursor_reset': gi.VFuncInfo(cursor_reset), 'do_cursor_set': gi.VFuncInfo(cursor_set), 'parent': <property object at 0x7f9dce6d6d10>, 'priv': <property object at 0x7f9dce6d6e50>})"
    __gdoc__ = 'Object SpiceCursorChannel\n\nSignals from SpiceCursorChannel:\n  cursor-set (gint, gint, gint, gint, gpointer)\n  cursor-move (gint, gint)\n  cursor-hide ()\n  cursor-reset ()\n\nProperties from SpiceCursorChannel:\n  cursor -> SpiceCursorShape: Last cursor shape\n    Last cursor shape received from the server\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceCursorChannel (93951199776976)>'
    __info__ = ObjectInfo(CursorChannel)
