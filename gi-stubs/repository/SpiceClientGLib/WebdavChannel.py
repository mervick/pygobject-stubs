...
class WebdavChannel(PortChannel):
    """
    :Constructors:
    
    ::
    
        WebdavChannel(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dcd622af0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WebdavChannel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceWebdavChannel (93951199895568)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f9dcd61cb30>, 'priv': <property object at 0x7f9dcd61cc20>})"
    __gdoc__ = 'Object SpiceWebdavChannel\n\nSignals from SpicePortChannel:\n  port-data (gpointer, gint)\n  port-event (gint)\n\nProperties from SpicePortChannel:\n  port-name -> gchararray: Port name\n    Port name\n  port-opened -> gboolean: Port opened\n    Port opened\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceWebdavChannel (93951199895568)>'
    __info__ = ObjectInfo(WebdavChannel)
