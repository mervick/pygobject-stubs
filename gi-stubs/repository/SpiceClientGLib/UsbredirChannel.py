...
class UsbredirChannel(Channel):
    """
    :Constructors:
    
    ::
    
        UsbredirChannel(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dcd6459a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UsbredirChannel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceUsbredirChannel (93951199879952)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f9dcd61c4f0>, 'priv': <property object at 0x7f9dcd61c5e0>})"
    __gdoc__ = 'Object SpiceUsbredirChannel\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceUsbredirChannel (93951199879952)>'
    __info__ = ObjectInfo(UsbredirChannel)
