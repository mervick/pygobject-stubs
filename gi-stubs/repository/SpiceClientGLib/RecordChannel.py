...
class RecordChannel(Channel):
    ...
    def do_record_data(self, *args, **kwargs): # real signature unknown
        """ record_data(self, data=None, size:int) """
        pass

    def do_record_start(self, *args, **kwargs): # real signature unknown
        """ record_start(self, format:int, channels:int, freq:int) """
        pass

    def do_record_stop(self, *args, **kwargs): # real signature unknown
        """ record_stop(self) """
        pass
    ...
    def send_data(self, data=None, bytes, time): # real signature unknown; restored from __doc__
        """ send_data(self, data=None, bytes:int, time:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dcd5c74c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecordChannel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceRecordChannel (93951199837984)>, '__doc__': None, '__gsignals__': {}, 'send_data': gi.FunctionInfo(send_data), 'do_record_data': gi.VFuncInfo(record_data), 'do_record_start': gi.VFuncInfo(record_start), 'do_record_stop': gi.VFuncInfo(record_stop), 'parent': <property object at 0x7f9dce6e3a90>, 'priv': <property object at 0x7f9dce6e3b30>})"
    __gdoc__ = 'Object SpiceRecordChannel\n\nSignals from SpiceRecordChannel:\n  record-start (gint, gint, gint)\n  record-stop ()\n\nProperties from SpiceRecordChannel:\n  nchannels -> guint: Number of Channels\n    Number of Channels\n  volume -> gpointer: Record volume\n    Record volume\n  mute -> gboolean: Mute\n    Mute\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceRecordChannel (93951199837984)>'
    __info__ = ObjectInfo(RecordChannel)
