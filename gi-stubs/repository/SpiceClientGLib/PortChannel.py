...
class PortChannel(Channel):
    ...
    def write_async(self, buffer, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ write_async(self, buffer:list, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dcd5c7a90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PortChannel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpicePortChannel (93951199786720)>, '__doc__': None, '__gsignals__': {}, 'event': gi.FunctionInfo(event), 'write_async': gi.FunctionInfo(write_async), 'write_finish': gi.FunctionInfo(write_finish), 'parent': <property object at 0x7f9dce6e0a90>, 'priv': <property object at 0x7f9dce6e0b80>})"
    __gdoc__ = 'Object SpicePortChannel\n\nSignals from SpicePortChannel:\n  port-data (gpointer, gint)\n  port-event (gint)\n\nProperties from SpicePortChannel:\n  port-name -> gchararray: Port name\n    Port name\n  port-opened -> gboolean: Port opened\n    Port opened\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpicePortChannel (93951199786720)>'
    __info__ = ObjectInfo(PortChannel)
