...
class DisplayChannel(Channel):
    ...
    def change_preferred_compression(self, channel, compression): # real signature unknown; restored from __doc__
        """ change_preferred_compression(channel:SpiceClientGLib.Channel, compression:int) """
        pass

    def change_preferred_video_codec_type(self, channel, codec_type): # real signature unknown; restored from __doc__
        """ change_preferred_video_codec_type(channel:SpiceClientGLib.Channel, codec_type:int) """
        pass

    def change_preferred_video_codec_types(self, channel, codecs, ncodecs): # real signature unknown; restored from __doc__
        """ change_preferred_video_codec_types(channel:SpiceClientGLib.Channel, codecs:int, ncodecs:int) -> bool """
        return False
    ...
    def get_gl_scanout(self): # real signature unknown; restored from __doc__
        """ get_gl_scanout(self) -> SpiceClientGLib.GlScanout """
        pass

    def get_primary(self, channel, surface_id, primary): # real signature unknown; restored from __doc__
        """ get_primary(channel:SpiceClientGLib.Channel, surface_id:int, primary:SpiceClientGLib.DisplayPrimary) -> bool """
        return False
    ...
    def gl_draw_done(self): # real signature unknown; restored from __doc__
        """ gl_draw_done(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dcd6228b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DisplayChannel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceDisplayChannel (93951199783952)>, '__doc__': None, '__gsignals__': {}, 'change_preferred_compression': gi.FunctionInfo(change_preferred_compression), 'change_preferred_video_codec_type': gi.FunctionInfo(change_preferred_video_codec_type), 'change_preferred_video_codec_types': gi.FunctionInfo(change_preferred_video_codec_types), 'get_primary': gi.FunctionInfo(get_primary), 'get_gl_scanout': gi.FunctionInfo(get_gl_scanout), 'gl_draw_done': gi.FunctionInfo(gl_draw_done), 'parent': <property object at 0x7f9dce6d9cc0>, 'priv': <property object at 0x7f9dce6d9db0>})"
    __gdoc__ = 'Object SpiceDisplayChannel\n\nSignals from SpiceDisplayChannel:\n  display-primary-create (gint, gint, gint, gint, gint, gpointer)\n  display-primary-destroy ()\n  display-invalidate (gint, gint, gint, gint)\n  display-mark (gint)\n  gl-draw (guint, guint, guint, guint)\n  streaming-mode (gboolean) -> gpointer\n  gst-video-overlay (GstPipeline) -> gboolean\n\nProperties from SpiceDisplayChannel:\n  width -> guint: Display width\n    The primary surface width\n  height -> guint: Display height\n    The primary surface height\n  monitors -> GArray: Display monitors\n    The monitors configuration\n  monitors-max -> guint: Max display monitors\n    The current maximum number of monitors\n  gl-scanout -> SpiceGlScanout: GL scanout\n    GL scanout\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceDisplayChannel (93951199783952)>'
    __info__ = ObjectInfo(DisplayChannel)
