...
class SmartcardChannel(Channel):
    """
    :Constructors:
    
    ::
    
        SmartcardChannel(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dcd622400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SmartcardChannel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceSmartcardChannel (93951199858048)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f9dcd617180>, 'priv': <property object at 0x7f9dcd617270>})"
    __gdoc__ = 'Object SpiceSmartcardChannel\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceSmartcardChannel (93951199858048)>'
    __info__ = ObjectInfo(SmartcardChannel)
