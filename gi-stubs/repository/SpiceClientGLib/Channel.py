...
class Channel(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dce70f820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Channel), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceChannel (93951199766848)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'string_to_type': gi.FunctionInfo(string_to_type), 'type_to_string': gi.FunctionInfo(type_to_string), 'connect': gi.FunctionInfo(connect), 'destroy': gi.FunctionInfo(destroy), 'disconnect': gi.FunctionInfo(disconnect), 'flush_async': gi.FunctionInfo(flush_async), 'flush_finish': gi.FunctionInfo(flush_finish), 'get_error': gi.FunctionInfo(get_error), 'open_fd': gi.FunctionInfo(open_fd), 'set_capability': gi.FunctionInfo(set_capability), 'test_capability': gi.FunctionInfo(test_capability), 'test_common_capability': gi.FunctionInfo(test_common_capability), 'do_channel_event': gi.VFuncInfo(channel_event), 'do_channel_reset': gi.VFuncInfo(channel_reset), 'do_channel_send_migration_handshake': gi.VFuncInfo(channel_send_migration_handshake), 'do_channel_up': gi.VFuncInfo(channel_up), 'do_handle_msg': gi.VFuncInfo(handle_msg), 'do_iterate_read': gi.VFuncInfo(iterate_read), 'do_iterate_write': gi.VFuncInfo(iterate_write), 'do_open_fd': gi.VFuncInfo(open_fd), 'parent': <property object at 0x7f9dce6d5540>, 'priv': <property object at 0x7f9dce6d5630>})"
    __gdoc__ = 'Object SpiceChannel\n\nSignals from SpiceChannel:\n  channel-event (SpiceChannelEvent)\n  open-fd (gint)\n\nProperties from SpiceChannel:\n  spice-session -> SpiceSession: Spice session\n    Spice session\n  channel-type -> gint: Channel type\n    Channel type\n  channel-id -> gint: Channel ID\n    Channel ID\n  total-read-bytes -> gulong: Total read bytes\n    Total read bytes\n  socket -> GSocket: Socket\n    Underlying GSocket\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceChannel (93951199766848)>'
