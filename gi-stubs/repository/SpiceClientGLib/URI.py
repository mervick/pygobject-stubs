...
class URI(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9dcd645c40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(URI), '__module__': 'gi.repository.SpiceClientGLib', '__gtype__': <GType SpiceURI (93951199867280)>, '__doc__': None, '__gsignals__': {}, 'get_hostname': gi.FunctionInfo(get_hostname), 'get_password': gi.FunctionInfo(get_password), 'get_port': gi.FunctionInfo(get_port), 'get_scheme': gi.FunctionInfo(get_scheme), 'get_user': gi.FunctionInfo(get_user), 'set_hostname': gi.FunctionInfo(set_hostname), 'set_password': gi.FunctionInfo(set_password), 'set_port': gi.FunctionInfo(set_port), 'set_scheme': gi.FunctionInfo(set_scheme), 'set_user': gi.FunctionInfo(set_user), 'to_string': gi.FunctionInfo(to_string)})"
    __gdoc__ = 'Object SpiceURI\n\nProperties from SpiceURI:\n  scheme -> gchararray: scheme\n    scheme\n  user -> gchararray: user\n    user\n  password -> gchararray: password\n    password\n  hostname -> gchararray: hostname\n    hostname\n  port -> guint: port\n    port\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceURI (93951199867280)>'
    __info__ = ObjectInfo(URI)
