...
class GLDisplayWayland(GLDisplay):
    ...
    ::
        ...
        GLDisplayWayland(**properties)
        new(name:str=None) -> GstGL.GLDisplayWayland
        new_with_display(display=None) -> GstGL.GLDisplayWayland
    """
    ...
    def new_with_display(self, display=None): # real signature unknown; restored from __doc__
        """ new_with_display(display=None) -> GstGL.GLDisplayWayland """
        pass
    ...
    compositor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    registry = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    shell = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    subcompositor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLDisplayWayland), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLDisplayWayland (93979012388544)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_display': gi.FunctionInfo(new_with_display), 'parent': <property object at 0x7f56a3ff57c0>, 'display': <property object at 0x7f56a3ff58b0>, 'registry': <property object at 0x7f56a3ff59a0>, 'compositor': <property object at 0x7f56a3ff5a90>, 'subcompositor': <property object at 0x7f56a3ff5b80>, 'shell': <property object at 0x7f56a3ff5c20>, 'foreign_display': <property object at 0x7f56a3ff5d10>, '_padding': <property object at 0x7f56a3ff5e00>})"
    __gdoc__ = 'Object GstGLDisplayWayland\n\nSignals from GstGLDisplay:\n  create-context (GstGLContext) -> GstGLContext\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLDisplayWayland (93979012388544)>'
    __info__ = ObjectInfo(GLDisplayWayland)
