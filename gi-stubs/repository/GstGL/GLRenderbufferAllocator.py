...
class GLRenderbufferAllocator(GLBaseMemoryAllocator):
    ...
    ::
        ...
        GLRenderbufferAllocator(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLRenderbufferAllocator), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLRenderbufferAllocator (93979012459872)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f56a3a28860>, '_padding': <property object at 0x7f56a3a289a0>})"
    __gdoc__ = 'Object GstGLRenderbufferAllocator\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLRenderbufferAllocator (93979012459872)>'
    __info__ = ObjectInfo(GLRenderbufferAllocator)
