...
class GLBufferAllocator(GLBaseMemoryAllocator):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a39f7e80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLBufferAllocator), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLBufferAllocator (93979012158672)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f56a3fe6950>, '_padding': <property object at 0x7f56a3fe6a90>})"
    __gdoc__ = 'Object GstGLBufferAllocator\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLBufferAllocator (93979012158672)>'
    __info__ = ObjectInfo(GLBufferAllocator)
