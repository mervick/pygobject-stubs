...
class GLMemoryPBOAllocator(GLMemoryAllocator):
    ...
    ::
        ...
        GLMemoryPBOAllocator(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a403dca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLMemoryPBOAllocator), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLMemoryPBOAllocator (93979012436576)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f56a3a23900>, '_padding': <property object at 0x7f56a3a23a40>})"
    __gdoc__ = 'Object GstGLMemoryPBOAllocator\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLMemoryPBOAllocator (93979012436576)>'
    __info__ = ObjectInfo(GLMemoryPBOAllocator)
