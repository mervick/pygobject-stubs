...
class GLBaseMemoryAllocator(__gi_repository_Gst.Allocator):
    """
    :Constructors:
    
    ::
    
        GLBaseMemoryAllocator(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a39f7a00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLBaseMemoryAllocator), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLBaseMemoryAllocator (93979012304608)>, '__doc__': None, '__gsignals__': {}, 'do_alloc': gi.VFuncInfo(alloc), 'parent': <property object at 0x7f56a3fe5130>, 'fallback_mem_copy': <property object at 0x7f56a3fe5270>, '_padding': <property object at 0x7f56a3fe5360>})"
    __gdoc__ = 'Object GstGLBaseMemoryAllocator\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLBaseMemoryAllocator (93979012304608)>'
    __info__ = ObjectInfo(GLBaseMemoryAllocator)
