...
class GLUpload(__gi_repository_Gst.Object):
    """
    :Constructors:
    ...
    def get_caps(self): # real signature unknown; restored from __doc__
        """ get_caps(self) -> in_caps:Gst.Caps, out_caps:Gst.Caps """
        pass
    ...
    def get_input_template_caps(self): # real signature unknown; restored from __doc__
    ...
    def perform_with_buffer(self, buffer): # real signature unknown; restored from __doc__
        """ perform_with_buffer(self, buffer:Gst.Buffer) -> GstGL.GLUploadReturn, outbuf_ptr:Gst.Buffer """
        pass

    def propose_allocation(self, decide_query=None, query): # real signature unknown; restored from __doc__
        """ propose_allocation(self, decide_query:Gst.Query=None, query:Gst.Query) """
        pass
    ...
    def transform_caps(self, context, direction, caps, filter): # real signature unknown; restored from __doc__
        """ transform_caps(self, context:GstGL.GLContext, direction:Gst.PadDirection, caps:Gst.Caps, filter:Gst.Caps) -> Gst.Caps """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a3a4d490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLUpload), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLUpload (93979012478592)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_input_template_caps': gi.FunctionInfo(get_input_template_caps), 'get_caps': gi.FunctionInfo(get_caps), 'perform_with_buffer': gi.FunctionInfo(perform_with_buffer), 'propose_allocation': gi.FunctionInfo(propose_allocation), 'set_caps': gi.FunctionInfo(set_caps), 'set_context': gi.FunctionInfo(set_context), 'transform_caps': gi.FunctionInfo(transform_caps), 'parent': <property object at 0x7f56a3a33270>, 'context': <property object at 0x7f56a3a332c0>, 'priv': <property object at 0x7f56a3a33360>, '_reserved': <property object at 0x7f56a3a33450>})"
    __gdoc__ = 'Object GstGLUpload\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLUpload (93979012478592)>'
    __info__ = ObjectInfo(GLUpload)
