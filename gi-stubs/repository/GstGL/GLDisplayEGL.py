...
class GLDisplayEGL(GLDisplay):
    ...
    ::
        ...
        GLDisplayEGL(**properties)
        new() -> GstGL.GLDisplayEGL
        new_with_egl_display(display=None) -> GstGL.GLDisplayEGL
    """
    ...
    def get_from_native(self, type, display): # real signature unknown; restored from __doc__
        """ get_from_native(type:GstGL.GLDisplayType, display:int) """
        pass
    ...
    def new_with_egl_display(self, display=None): # real signature unknown; restored from __doc__
        """ new_with_egl_display(display=None) -> GstGL.GLDisplayEGL """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a4029b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLDisplayEGL), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLDisplayEGL (93979012380304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_egl_display': gi.FunctionInfo(new_with_egl_display), 'get_from_native': gi.FunctionInfo(get_from_native), 'parent': <property object at 0x7f56a3ff38b0>, 'display': <property object at 0x7f56a3ff39a0>, 'foreign_display': <property object at 0x7f56a3ff3a90>, '_padding': <property object at 0x7f56a3ff3b80>})"
    __gdoc__ = 'Object GstGLDisplayEGL\n\nSignals from GstGLDisplay:\n  create-context (GstGLContext) -> GstGLContext\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLDisplayEGL (93979012380304)>'
    __info__ = ObjectInfo(GLDisplayEGL)
