...
class GLColorConvert(__gi_repository_Gst.Object):
    """
    :Constructors:
    
    ::
    
        GLColorConvert(**properties)
    ...
    def decide_allocation(self, query): # real signature unknown; restored from __doc__
    ...
    def fixate_caps(self, context, direction, caps, other): # real signature unknown; restored from __doc__
        """ fixate_caps(context:GstGL.GLContext, direction:Gst.PadDirection, caps:Gst.Caps, other:Gst.Caps) -> Gst.Caps """
        pass
    ...
    def transform_caps(self, context, direction, caps, filter): # real signature unknown; restored from __doc__
        """ transform_caps(context:GstGL.GLContext, direction:Gst.PadDirection, caps:Gst.Caps, filter:Gst.Caps) -> Gst.Caps """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a3a4da60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLColorConvert), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLColorConvert (93979011859808)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'fixate_caps': gi.FunctionInfo(fixate_caps), 'transform_caps': gi.FunctionInfo(transform_caps), 'decide_allocation': gi.FunctionInfo(decide_allocation), 'perform': gi.FunctionInfo(perform), 'set_caps': gi.FunctionInfo(set_caps), 'parent': <property object at 0x7f56a3fe8e50>, 'context': <property object at 0x7f56a3fe8f40>, 'in_info': <property object at 0x7f56a3fed090>, 'out_info': <property object at 0x7f56a3fed180>, 'initted': <property object at 0x7f56a3fed270>, 'passthrough': <property object at 0x7f56a3fed360>, 'inbuf': <property object at 0x7f56a3fed450>, 'outbuf': <property object at 0x7f56a3fed540>, 'fbo': <property object at 0x7f56a3fed630>, 'shader': <property object at 0x7f56a3fed720>, 'priv': <property object at 0x7f56a3fed810>, '_reserved': <property object at 0x7f56a3fed900>})"
    __gdoc__ = 'Object GstGLColorConvert\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLColorConvert (93979011859808)>'
    __info__ = ObjectInfo(GLColorConvert)
