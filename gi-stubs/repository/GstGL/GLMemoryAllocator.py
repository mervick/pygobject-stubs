...
class GLMemoryAllocator(GLBaseMemoryAllocator):
    ...
    def do_alloc(self, *args, **kwargs): # real signature unknown
        """ alloc(self, params:GstGL.GLAllocationParams) -> GstGL.GLBaseMemory """
        pass
    ...
    def get_default(self, context): # real signature unknown; restored from __doc__
        """ get_default(context:GstGL.GLContext) -> GstGL.GLMemoryAllocator """
        pass
    ...
    fallback_mem_copy = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a39f77c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLMemoryAllocator), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLMemoryAllocator (93979012410688)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default), 'parent': <property object at 0x7f56a4000900>, '_padding': <property object at 0x7f56a4000a40>})"
    __gdoc__ = 'Object GstGLMemoryAllocator\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLMemoryAllocator (93979012410688)>'
    __info__ = ObjectInfo(GLMemoryAllocator)
