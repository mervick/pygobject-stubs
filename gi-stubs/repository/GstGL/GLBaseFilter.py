...
class GLBaseFilter(__gi_repository_GstBase.BaseTransform):
    """
    :Constructors:
    
    ::
    
        GLBaseFilter(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a40332b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLBaseFilter), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLBaseFilter (93979012136256)>, '__doc__': None, '__gsignals__': {}, 'find_gl_context': gi.FunctionInfo(find_gl_context), 'do_gl_set_caps': gi.VFuncInfo(gl_set_caps), 'do_gl_start': gi.VFuncInfo(gl_start), 'do_gl_stop': gi.VFuncInfo(gl_stop), 'parent': <property object at 0x7f56a3fdfae0>, 'display': <property object at 0x7f56a3fdfbd0>, 'context': <property object at 0x7f56a3fdfcc0>, 'in_caps': <property object at 0x7f56a3fdfdb0>, 'out_caps': <property object at 0x7f56a3fdfea0>, '_padding': <property object at 0x7f56a3fdff90>, 'priv': <property object at 0x7f56a3fe10e0>})"
    __gdoc__ = 'Object GstGLBaseFilter\n\nProperties from GstGLBaseFilter:\n  context -> GstGLContext: OpenGL context\n    Get OpenGL context\n\nProperties from GstBaseTransform:\n  qos -> gboolean: QoS\n    Handle Quality-of-Service events\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLBaseFilter (93979012136256)>'
    __info__ = ObjectInfo(GLBaseFilter)
