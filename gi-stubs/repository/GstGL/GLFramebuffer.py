...
class GLFramebuffer(__gi_repository_Gst.Object):
    """
    :Constructors:
    
    ::
    
        GLFramebuffer(**properties)
    ...
    def attach(self, attachment_point, mem): # real signature unknown; restored from __doc__
        """ attach(self, attachment_point:int, mem:GstGL.GLBaseMemory) """
        pass
    ...
    def draw_to_texture(self, mem, func, user_data=None): # real signature unknown; restored from __doc__
        """ draw_to_texture(self, mem:GstGL.GLMemory, func:GstGL.GLFramebufferFunc, user_data=None) -> bool """
        return False
    ...
    def get_effective_dimensions(self): # real signature unknown; restored from __doc__
        """ get_effective_dimensions(self) -> width:int, height:int """
        pass
    ...
    def new_with_default_depth(self, context, width, height): # real signature unknown; restored from __doc__
        """ new_with_default_depth(context:GstGL.GLContext, width:int, height:int) -> GstGL.GLFramebuffer """
        pass
    ...
    fbo_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a39f7ee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLFramebuffer), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLFramebuffer (93979012409408)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_default_depth': gi.FunctionInfo(new_with_default_depth), 'attach': gi.FunctionInfo(attach), 'bind': gi.FunctionInfo(bind), 'draw_to_texture': gi.FunctionInfo(draw_to_texture), 'get_effective_dimensions': gi.FunctionInfo(get_effective_dimensions), 'get_id': gi.FunctionInfo(get_id), 'object': <property object at 0x7f56a53b9e50>, 'context': <property object at 0x7f56a3ffb180>, 'fbo_id': <property object at 0x7f56a3ffb270>, 'attachments': <property object at 0x7f56a3ffb360>, '_padding': <property object at 0x7f56a3ffb450>, 'priv': <property object at 0x7f56a3ffb540>})"
    __gdoc__ = 'Object GstGLFramebuffer\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLFramebuffer (93979012409408)>'
    __info__ = ObjectInfo(GLFramebuffer)
