...
class GLDisplay(__gi_repository_Gst.Object):
    """
    :Constructors:
    
    ::
    
        GLDisplay(**properties)
        new() -> GstGL.GLDisplay
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a3a4d3d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLDisplay), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLDisplay (93979012372832)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_context': gi.FunctionInfo(add_context), 'create_context': gi.FunctionInfo(create_context), 'create_window': gi.FunctionInfo(create_window), 'egl_from_gl_display': gi.FunctionInfo(egl_from_gl_display), 'filter_gl_api': gi.FunctionInfo(filter_gl_api), 'find_window': gi.FunctionInfo(find_window), 'get_gl_api': gi.FunctionInfo(get_gl_api), 'get_gl_api_unlocked': gi.FunctionInfo(get_gl_api_unlocked), 'get_gl_context_for_thread': gi.FunctionInfo(get_gl_context_for_thread), 'get_handle': gi.FunctionInfo(get_handle), 'get_handle_type': gi.FunctionInfo(get_handle_type), 'remove_window': gi.FunctionInfo(remove_window), 'do_create_window': gi.VFuncInfo(create_window), 'do_get_handle': gi.VFuncInfo(get_handle), 'object': <property object at 0x7f56a3ff1c70>, 'type': <property object at 0x7f56a3ff1d60>, 'windows': <property object at 0x7f56a3ff1e50>, 'main_context': <property object at 0x7f56a3ff1f40>, 'main_loop': <property object at 0x7f56a3ff3090>, 'event_source': <property object at 0x7f56a3ff3180>, 'priv': <property object at 0x7f56a3ff3270>})"
    __gdoc__ = 'Object GstGLDisplay\n\nSignals from GstGLDisplay:\n  create-context (GstGLContext) -> GstGLContext\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLDisplay (93979012372832)>'
    __info__ = ObjectInfo(GLDisplay)
