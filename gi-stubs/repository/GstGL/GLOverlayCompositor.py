...
class GLOverlayCompositor(__gi_repository_Gst.Object):
    """
    :Constructors:
    
    ::
    
        GLOverlayCompositor(**properties)
        new(context:GstGL.GLContext) -> GstGL.GLOverlayCompositor
    """
    def add_caps(self, caps): # real signature unknown; restored from __doc__
    ...
    def draw_overlays(self): # real signature unknown; restored from __doc__
        """ draw_overlays(self) """
        pass
    ...
    def free_overlays(self): # real signature unknown; restored from __doc__
        """ free_overlays(self) """
        pass
    ...
    def upload_overlays(self, buf): # real signature unknown; restored from __doc__
        """ upload_overlays(self, buf:Gst.Buffer) """
        pass
    ...
    last_window_height = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    last_window_width = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    overlays = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    position_attrib = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    texcoord_attrib = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a3a4d6d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLOverlayCompositor), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLOverlayCompositor (93979012436848)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_caps': gi.FunctionInfo(add_caps), 'draw_overlays': gi.FunctionInfo(draw_overlays), 'free_overlays': gi.FunctionInfo(free_overlays), 'upload_overlays': gi.FunctionInfo(upload_overlays), 'parent': <property object at 0x7f56a3a23ea0>, 'context': <property object at 0x7f56a3a23f90>, 'last_window_width': <property object at 0x7f56a3a25130>, 'last_window_height': <property object at 0x7f56a3a25270>, 'overlays': <property object at 0x7f56a3a25360>, 'shader': <property object at 0x7f56a3a25450>, 'position_attrib': <property object at 0x7f56a3a25540>, 'texcoord_attrib': <property object at 0x7f56a3a25630>, '_padding': <property object at 0x7f56a3a25720>})"
    __gdoc__ = 'Object GstGLOverlayCompositor\n\nProperties from GstGLOverlayCompositor:\n  yinvert -> gboolean: Y-Invert\n    Whether to invert the output across a horizintal axis\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLOverlayCompositor (93979012436848)>'
    __info__ = ObjectInfo(GLOverlayCompositor)
