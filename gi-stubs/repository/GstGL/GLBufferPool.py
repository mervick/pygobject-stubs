...
class GLBufferPool(__gi_repository_Gst.BufferPool):
    """
    :Constructors:
    
    ::
    
        GLBufferPool(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f56a403d970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLBufferPool), '__module__': 'gi.repository.GstGL', '__gtype__': <GType GstGLBufferPool (93979011859552)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'bufferpool': <property object at 0x7f56a3fe86d0>, 'context': <property object at 0x7f56a3fe87c0>, 'priv': <property object at 0x7f56a3fe88b0>, '_padding': <property object at 0x7f56a3fe89a0>})"
    __gdoc__ = 'Object GstGLBufferPool\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstGLBufferPool (93979011859552)>'
    __info__ = ObjectInfo(GLBufferPool)
