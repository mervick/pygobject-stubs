...
class ChooserSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Chooser):
    """
    :Constructors:
    
    ::
    
        ChooserSkeleton(**properties)
        new() -> Gdm.ChooserSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f26ef077ac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ChooserSkeleton), '__module__': 'gi.repository.Gdm', '__gtype__': <GType GdmChooserSkeleton (94876616765392)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f26ef036c20>, 'priv': <property object at 0x7f26ef036d60>})"
    __gdoc__ = 'Object GdmChooserSkeleton\n\nSignals from GdmChooser:\n  handle-select-hostname (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-disconnect (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdmChooserSkeleton (94876616765392)>'
    __info__ = ObjectInfo(ChooserSkeleton)
