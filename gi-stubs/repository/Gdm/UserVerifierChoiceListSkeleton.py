...
class UserVerifierChoiceListSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, UserVerifierChoiceList):
    """
    :Constructors:
    
    ::
    
        UserVerifierChoiceListSkeleton(**properties)
        new() -> Gdm.UserVerifierChoiceListSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f26ef0105b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UserVerifierChoiceListSkeleton), '__module__': 'gi.repository.Gdm', '__gtype__': <GType GdmUserVerifierChoiceListSkeleton (94876617217712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f26ef049090>, 'priv': <property object at 0x7f26ef0491d0>})"
    __gdoc__ = 'Object GdmUserVerifierChoiceListSkeleton\n\nSignals from GdmUserVerifierChoiceList:\n  handle-select-choice (GDBusMethodInvocation, gchararray, gchararray) -> gboolean\n  choice-query (gchararray, gchararray, GVariant)\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdmUserVerifierChoiceListSkeleton (94876617217712)>'
    __info__ = ObjectInfo(UserVerifierChoiceListSkeleton)
