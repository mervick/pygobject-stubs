...
class WorkerManagerSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, WorkerManager):
    """
    :Constructors:
    
    ::
    
        WorkerManagerSkeleton(**properties)
        new() -> Gdm.WorkerManagerSkeleton
    """
