...
class GreeterSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Greeter):
    """
    :Constructors:
    
    ::
    
        GreeterSkeleton(**properties)
        new() -> Gdm.GreeterSkeleton
    """
