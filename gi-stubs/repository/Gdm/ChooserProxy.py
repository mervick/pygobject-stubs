...
class ChooserProxy(__gi_overrides_Gio.DBusProxy, Chooser):
    """
    :Constructors:
    
    ::
    
        ChooserProxy(**properties)
        new_finish(res:Gio.AsyncResult) -> Gdm.ChooserProxy
        new_for_bus_finish(res:Gio.AsyncResult) -> Gdm.ChooserProxy
        new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> Gdm.ChooserProxy
        new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> Gdm.ChooserProxy
    """
    ...
    def call_select_hostname(self, arg_hostname, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_select_hostname(self, arg_hostname:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_select_hostname_finish(self, res): # real signature unknown; restored from __doc__
        """ call_select_hostname_finish(self, res:Gio.AsyncResult) """
        pass

    def call_select_hostname_sync(self, arg_hostname, cancellable=None): # real signature unknown; restored from __doc__
        """ call_select_hostname_sync(self, arg_hostname:str, cancellable:Gio.Cancellable=None) """
        pass
    ...
    def complete_select_hostname(self, invocation): # real signature unknown; restored from __doc__
        """ complete_select_hostname(self, invocation:Gio.DBusMethodInvocation) """
        pass
