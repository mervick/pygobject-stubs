...
class RemoteGreeterSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, RemoteGreeter):
    """
    :Constructors:
    
    ::
    
        RemoteGreeterSkeleton(**properties)
        new() -> Gdm.RemoteGreeterSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f26eed389a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RemoteGreeterSkeleton), '__module__': 'gi.repository.Gdm', '__gtype__': <GType GdmRemoteGreeterSkeleton (94876617042992)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f26ef044770>, 'priv': <property object at 0x7f26ef0448b0>})"
    __gdoc__ = 'Object GdmRemoteGreeterSkeleton\n\nSignals from GdmRemoteGreeter:\n  handle-disconnect (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdmRemoteGreeterSkeleton (94876617042992)>'
    __info__ = ObjectInfo(RemoteGreeterSkeleton)
