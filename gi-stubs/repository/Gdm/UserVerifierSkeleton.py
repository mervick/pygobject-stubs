...
class UserVerifierSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, UserVerifier):
    """
    :Constructors:
    
    ::
    
        UserVerifierSkeleton(**properties)
        new() -> Gdm.UserVerifierSkeleton
    """
