...
class PicasaWebAlbum(Entry):
    """
    :Constructors:
    
    ::
    
        PicasaWebAlbum(**properties)
        new(id:str=None) -> GData.PicasaWebAlbum
    """
    ...
    def get_bytes_used(self): # real signature unknown; restored from __doc__
        """ get_bytes_used(self) -> int """
        return 0
    ...
    def get_num_photos(self): # real signature unknown; restored from __doc__
        """ get_num_photos(self) -> int """
        return 0

    def get_num_photos_remaining(self): # real signature unknown; restored from __doc__
        """ get_num_photos_remaining(self) -> int """
        return 0
    ...
    def get_visibility(self): # real signature unknown; restored from __doc__
        """ get_visibility(self) -> GData.PicasaWebVisibility """
        pass
    ...
    def set_visibility(self, visibility): # real signature unknown; restored from __doc__
        """ set_visibility(self, visibility:GData.PicasaWebVisibility) """
        pass
