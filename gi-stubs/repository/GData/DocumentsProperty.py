...
class DocumentsProperty(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        DocumentsProperty(**properties)
        new(key:str) -> GData.DocumentsProperty
    """
    ...
    def set_visibility(self, visibility): # real signature unknown; restored from __doc__
        """ set_visibility(self, visibility:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e16e1e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DocumentsProperty), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataDocumentsProperty (94233464474624)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_etag': gi.FunctionInfo(get_etag), 'get_key': gi.FunctionInfo(get_key), 'get_value': gi.FunctionInfo(get_value), 'get_visibility': gi.FunctionInfo(get_visibility), 'set_value': gi.FunctionInfo(set_value), 'set_visibility': gi.FunctionInfo(set_visibility), 'parent': <property object at 0x7fd5e1796950>, 'priv': <property object at 0x7fd5e1796a40>})"
    __gdoc__ = 'Object GDataDocumentsProperty\n\nProperties from GDataDocumentsProperty:\n  key -> gchararray: Key\n    The key of this property.\n  etag -> gchararray: ETag\n    ETag of the property.\n  value -> gchararray: Value\n    The value of this property.\n  visibility -> gchararray: Visibility\n    The visibility of this property.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataDocumentsProperty (94233464474624)>'
    __info__ = ObjectInfo(DocumentsProperty)
