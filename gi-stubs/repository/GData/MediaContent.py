...
class MediaContent(Parsable):
    """
    :Constructors:
    
    ::
    
        MediaContent(**properties)
    """
    ...
    def download(self, service, cancellable=None): # real signature unknown; restored from __doc__
        """ download(self, service:GData.Service, cancellable:Gio.Cancellable=None) -> GData.DownloadStream """
        pass
    ...
    def get_expression(self): # real signature unknown; restored from __doc__
        """ get_expression(self) -> GData.MediaExpression """
        pass

    def get_filesize(self): # real signature unknown; restored from __doc__
        """ get_filesize(self) -> int """
        return 0
    ...
    def get_medium(self): # real signature unknown; restored from __doc__
        """ get_medium(self) -> GData.MediaMedium """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e151da90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaContent), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataMediaContent (94233464509088)>, '__doc__': None, '__gsignals__': {}, 'download': gi.FunctionInfo(download), 'get_content_type': gi.FunctionInfo(get_content_type), 'get_duration': gi.FunctionInfo(get_duration), 'get_expression': gi.FunctionInfo(get_expression), 'get_filesize': gi.FunctionInfo(get_filesize), 'get_height': gi.FunctionInfo(get_height), 'get_medium': gi.FunctionInfo(get_medium), 'get_uri': gi.FunctionInfo(get_uri), 'get_width': gi.FunctionInfo(get_width), 'is_default': gi.FunctionInfo(is_default), 'parent': <property object at 0x7fd5e174d4f0>, 'priv': <property object at 0x7fd5e174d5e0>})"
    __gdoc__ = 'Object GDataMediaContent\n\nProperties from GDataMediaContent:\n  uri -> gchararray: URI\n    The direct URI to the media object.\n  filesize -> gulong: Filesize\n    The number of bytes of the media object.\n  content-type -> gchararray: Content type\n    The standard MIME type of the object.\n  medium -> GDataMediaMedium: Medium\n    The type of object.\n  is-default -> gboolean: Default?\n    Determines if this is the default content for the media group.\n  expression -> GDataMediaExpression: Expression\n    Determines if the object is a sample or the full version of the object.\n  duration -> gint64: Duration\n    The number of seconds for which the media object plays.\n  height -> guint: Height\n    The height of the media object.\n  width -> guint: Width\n    The width of the media object.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataMediaContent (94233464509088)>'
    __info__ = ObjectInfo(MediaContent)
