...
class GDReminder(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        GDReminder(**properties)
        new(method:str=None, absolute_time:int, relative_time:int) -> GData.GDReminder
    """
    ...
    def get_relative_time(self): # real signature unknown; restored from __doc__
        """ get_relative_time(self) -> int """
        return 0
    ...
    def is_absolute_time(self): # real signature unknown; restored from __doc__
        """ is_absolute_time(self) -> bool """
        return False
    ...
    def new(self, method=None, absolute_time, relative_time): # real signature unknown; restored from __doc__
        """ new(method:str=None, absolute_time:int, relative_time:int) -> GData.GDReminder """
        pass
    ...
    def set_absolute_time(self, absolute_time): # real signature unknown; restored from __doc__
        """ set_absolute_time(self, absolute_time:int) """
        pass
    ...
    def set_relative_time(self, relative_time): # real signature unknown; restored from __doc__
        """ set_relative_time(self, relative_time:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e14a14f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GDReminder), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGDReminder (94233464678240)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_absolute_time': gi.FunctionInfo(get_absolute_time), 'get_method': gi.FunctionInfo(get_method), 'get_relative_time': gi.FunctionInfo(get_relative_time), 'is_absolute_time': gi.FunctionInfo(is_absolute_time), 'set_absolute_time': gi.FunctionInfo(set_absolute_time), 'set_method': gi.FunctionInfo(set_method), 'set_relative_time': gi.FunctionInfo(set_relative_time), 'parent': <property object at 0x7fd5e1742900>, 'priv': <property object at 0x7fd5e17429f0>})"
    __gdoc__ = 'Object GDataGDReminder\n\nProperties from GDataGDReminder:\n  method -> gchararray: Method\n    The notification method the reminder should use.\n  absolute-time -> gint64: Absolute time\n    Absolute time at which the reminder should be issued.\n  is-absolute-time -> gboolean: Absolute time?\n    Whether the reminder is specified as an absolute or relative time.\n  relative-time -> gint: Relative time\n    Time at which the reminder should be issued, in minutes.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGDReminder (94233464678240)>'
    __info__ = ObjectInfo(GDReminder)
