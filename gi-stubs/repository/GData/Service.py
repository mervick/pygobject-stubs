...
class Service(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e170d7c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Service), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataService (94233464332368)>, '__doc__': None, '__gsignals__': {}, 'get_authorization_domains': gi.FunctionInfo(get_authorization_domains), 'delete_entry': gi.FunctionInfo(delete_entry), 'delete_entry_async': gi.FunctionInfo(delete_entry_async), 'delete_entry_finish': gi.FunctionInfo(delete_entry_finish), 'get_authorizer': gi.FunctionInfo(get_authorizer), 'get_locale': gi.FunctionInfo(get_locale), 'get_proxy_resolver': gi.FunctionInfo(get_proxy_resolver), 'get_proxy_uri': gi.FunctionInfo(get_proxy_uri), 'get_timeout': gi.FunctionInfo(get_timeout), 'insert_entry': gi.FunctionInfo(insert_entry), 'insert_entry_async': gi.FunctionInfo(insert_entry_async), 'insert_entry_finish': gi.FunctionInfo(insert_entry_finish), 'is_authorized': gi.FunctionInfo(is_authorized), 'query': gi.FunctionInfo(query), 'query_async': gi.FunctionInfo(query_async), 'query_finish': gi.FunctionInfo(query_finish), 'query_single_entry': gi.FunctionInfo(query_single_entry), 'query_single_entry_async': gi.FunctionInfo(query_single_entry_async), 'query_single_entry_finish': gi.FunctionInfo(query_single_entry_finish), 'set_authorizer': gi.FunctionInfo(set_authorizer), 'set_locale': gi.FunctionInfo(set_locale), 'set_proxy_resolver': gi.FunctionInfo(set_proxy_resolver), 'set_proxy_uri': gi.FunctionInfo(set_proxy_uri), 'set_timeout': gi.FunctionInfo(set_timeout), 'update_entry': gi.FunctionInfo(update_entry), 'update_entry_async': gi.FunctionInfo(update_entry_async), 'update_entry_finish': gi.FunctionInfo(update_entry_finish), 'do_append_query_headers': gi.VFuncInfo(append_query_headers), 'do_parse_error_response': gi.VFuncInfo(parse_error_response), 'parent': <property object at 0x7fd5e1778900>, 'priv': <property object at 0x7fd5e1778a90>})"
    __gdoc__ = 'Object GDataService\n\nProperties from GDataService:\n  proxy-uri -> SoupURI: Proxy URI\n    The proxy URI used internally for all network requests.\n  timeout -> guint: Timeout\n    A timeout, in seconds, for network operations.\n  locale -> gchararray: Locale\n    The locale to use for network requests, in Unix locale format.\n  authorizer -> GDataAuthorizer: Authorizer\n    An authorizer object to provide an authorization token for each request.\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    A GProxyResolver used to determine a proxy URI.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataService (94233464332368)>'
