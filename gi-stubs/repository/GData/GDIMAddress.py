...
class GDIMAddress(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        GDIMAddress(**properties)
        new(address:str, protocol:str=None, relation_type:str=None, label:str=None, is_primary:bool) -> GData.GDIMAddress
    """
    ...
    def new(self, address, protocol=None, relation_type=None, label=None, is_primary): # real signature unknown; restored from __doc__
        """ new(address:str, protocol:str=None, relation_type:str=None, label:str=None, is_primary:bool) -> GData.GDIMAddress """
        pass
    ...
    def set_protocol(self, protocol=None): # real signature unknown; restored from __doc__
        """ set_protocol(self, protocol:str=None) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GDIMAddress), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGDIMAddress (94233464650448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_address': gi.FunctionInfo(get_address), 'get_label': gi.FunctionInfo(get_label), 'get_protocol': gi.FunctionInfo(get_protocol), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'is_primary': gi.FunctionInfo(is_primary), 'set_address': gi.FunctionInfo(set_address), 'set_is_primary': gi.FunctionInfo(set_is_primary), 'set_label': gi.FunctionInfo(set_label), 'set_protocol': gi.FunctionInfo(set_protocol), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'parent': <property object at 0x7fd5e1739090>, 'priv': <property object at 0x7fd5e1739180>})"
    __gdoc__ = 'Object GDataGDIMAddress\n\nProperties from GDataGDIMAddress:\n  address -> gchararray: Address\n    The IM address itself.\n  protocol -> gchararray: Protocol\n    Identifies the IM network.\n  relation-type -> gchararray: Relation type\n    A programmatic value that identifies the type of IM address.\n  label -> gchararray: Label\n    A simple string value used to name this IM address.\n  is-primary -> gboolean: Primary?\n    Indicates which IM address out of a group is primary.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGDIMAddress (94233464650448)>'
    __info__ = ObjectInfo(GDIMAddress)
