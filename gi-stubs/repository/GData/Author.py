...
class Author(Parsable, Comparable):
    """
    :Constructors:
    ...
    ::
        ...
        Author(**properties)
        new(name:str, uri:str=None, email_address:str=None) -> GData.Author
    """
    ...
    def new(self, name, uri=None, email_address=None): # real signature unknown; restored from __doc__
        """ new(name:str, uri:str=None, email_address:str=None) -> GData.Author """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e238e430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Author), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataAuthor (94233464141248)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_email_address': gi.FunctionInfo(get_email_address), 'get_name': gi.FunctionInfo(get_name), 'get_uri': gi.FunctionInfo(get_uri), 'set_email_address': gi.FunctionInfo(set_email_address), 'set_name': gi.FunctionInfo(set_name), 'set_uri': gi.FunctionInfo(set_uri), 'parent': <property object at 0x7fd5e237bd10>, 'priv': <property object at 0x7fd5e237be00>})"
    __gdoc__ = 'Object GDataAuthor\n\nProperties from GDataAuthor:\n  name -> gchararray: Name\n    A human-readable name for the person.\n  uri -> gchararray: URI\n    An IRI associated with the person.\n  email-address -> gchararray: E-mail address\n    An e-mail address associated with the person.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataAuthor (94233464141248)>'
    __info__ = ObjectInfo(Author)
