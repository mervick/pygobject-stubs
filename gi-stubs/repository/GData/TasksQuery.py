...
class TasksQuery(Query):
    """
    :Constructors:
    
    ::
    
        TasksQuery(**properties)
        new(q:str=None) -> GData.TasksQuery
    """
    ...
    def get_completed_max(self): # real signature unknown; restored from __doc__
        """ get_completed_max(self) -> int """
        return 0

    def get_completed_min(self): # real signature unknown; restored from __doc__
        """ get_completed_min(self) -> int """
        return 0
    ...
    def get_due_max(self): # real signature unknown; restored from __doc__
        """ get_due_max(self) -> int """
        return 0

    def get_due_min(self): # real signature unknown; restored from __doc__
        """ get_due_min(self) -> int """
        return 0
    ...
    def get_show_completed(self): # real signature unknown; restored from __doc__
        """ get_show_completed(self) -> bool """
        return False

    def get_show_deleted(self): # real signature unknown; restored from __doc__
        """ get_show_deleted(self) -> bool """
        return False
    ...
    def set_completed_max(self, completed_max): # real signature unknown; restored from __doc__
        """ set_completed_max(self, completed_max:int) """
        pass

    def set_completed_min(self, completed_min): # real signature unknown; restored from __doc__
        """ set_completed_min(self, completed_min:int) """
        pass
    ...
    def set_due_max(self, due_max): # real signature unknown; restored from __doc__
        """ set_due_max(self, due_max:int) """
        pass

    def set_due_min(self, due_min): # real signature unknown; restored from __doc__
        """ set_due_min(self, due_min:int) """
        pass
    ...
    def set_show_completed(self, show_completed): # real signature unknown; restored from __doc__
        """ set_show_completed(self, show_completed:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e13659d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TasksQuery), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataTasksQuery (94233464857728)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_completed_max': gi.FunctionInfo(get_completed_max), 'get_completed_min': gi.FunctionInfo(get_completed_min), 'get_due_max': gi.FunctionInfo(get_due_max), 'get_due_min': gi.FunctionInfo(get_due_min), 'get_show_completed': gi.FunctionInfo(get_show_completed), 'get_show_deleted': gi.FunctionInfo(get_show_deleted), 'get_show_hidden': gi.FunctionInfo(get_show_hidden), 'set_completed_max': gi.FunctionInfo(set_completed_max), 'set_completed_min': gi.FunctionInfo(set_completed_min), 'set_due_max': gi.FunctionInfo(set_due_max), 'set_due_min': gi.FunctionInfo(set_due_min), 'set_show_completed': gi.FunctionInfo(set_show_completed), 'set_show_deleted': gi.FunctionInfo(set_show_deleted), 'set_show_hidden': gi.FunctionInfo(set_show_hidden), 'parent': <property object at 0x7fd5e1766b80>, 'priv': <property object at 0x7fd5e1766c70>})"
    __gdoc__ = "Object GDataTasksQuery\n\nProperties from GDataTasksQuery:\n  completed-max -> gint64: Max task completion date\n    Upper bound for a task's completion date to filter by.\n  completed-min -> gint64: Min task completion date\n    Lower bound for a task's completion date to filter by.\n  due-max -> gint64: Max task completion date\n    Upper bound for a task's completion date to filter by.\n  due-min -> gint64: Min task completion date\n    Lower bound for a task's completion date to filter by.\n  show-completed -> gboolean: Show completed tasks?\n    Indicated whatever completed tasks are returned in the result.\n  show-deleted -> gboolean: Show deleted tasks?\n    Indicated whatever deleted tasks are returned in the result.\n  show-hidden -> gboolean: Show hidden tasks?\n    Indicated whatever hidden tasks are returned in the result.\n\nProperties from GDataQuery:\n  q -> gchararray: Query terms\n    Query terms for which to search.\n  categories -> gchararray: Category string\n    Category search string.\n  author -> gchararray: Author\n    Author search string.\n  updated-min -> gint64: Minimum update date\n    Minimum date for updates on returned entries.\n  updated-max -> gint64: Maximum update date\n    Maximum date for updates on returned entries.\n  published-min -> gint64: Minimum publish date\n    Minimum date for returned entries to be published.\n  published-max -> gint64: Maximum publish date\n    Maximum date for returned entries to be published.\n  start-index -> guint: Start index\n    One-based result start index.\n  is-strict -> gboolean: Strict?\n    Should the server be strict about the query?\n  max-results -> guint: Maximum number of results\n    The maximum number of entries to return.\n  etag -> gchararray: ETag\n    An ETag against which to check.\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataTasksQuery (94233464857728)>'
    __info__ = ObjectInfo(TasksQuery)
