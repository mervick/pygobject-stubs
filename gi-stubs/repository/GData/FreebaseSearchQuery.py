...
class FreebaseSearchQuery(Query):
    """
    :Constructors:
    
    ::
    
        FreebaseSearchQuery(**properties)
        new(search_terms:str) -> GData.FreebaseSearchQuery
    """
    def add_filter(self, property, value): # real signature unknown; restored from __doc__
        """ add_filter(self, property:str, value:str) """
        pass

    def add_location(self, radius, lat, lon): # real signature unknown; restored from __doc__
        """ add_location(self, radius:int, lat:float, lon:float) """
        pass
    ...
    def close_filter(self): # real signature unknown; restored from __doc__
        """ close_filter(self) """
        pass
    ...
    def get_stemmed(self): # real signature unknown; restored from __doc__
        """ get_stemmed(self) -> bool """
        return False
    ...
    def new(self, search_terms): # real signature unknown; restored from __doc__
        """ new(search_terms:str) -> GData.FreebaseSearchQuery """
        pass
    ...
    def open_filter(self, filter_type): # real signature unknown; restored from __doc__
        """ open_filter(self, filter_type:GData.FreebaseSearchFilterType) """
        pass
    ...
    def set_language(self, lang=None): # real signature unknown; restored from __doc__
        """ set_language(self, lang:str=None) """
        pass
    ...
    def set_stemmed(self, stemmed): # real signature unknown; restored from __doc__
        """ set_stemmed(self, stemmed:bool) """
        pass
