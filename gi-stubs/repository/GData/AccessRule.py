...
class AccessRule(Entry):
    ...
    def get_scope(self): # real signature unknown; restored from __doc__
        """ get_scope(self) -> type:str, value:str """
        return type(*(), **{})
    ...
    def set_scope(self, type, value=None): # real signature unknown; restored from __doc__
        """ set_scope(self, type:str, value:str=None) """
        pass
