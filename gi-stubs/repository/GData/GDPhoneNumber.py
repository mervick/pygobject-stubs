...
class GDPhoneNumber(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        GDPhoneNumber(**properties)
        new(number:str, relation_type:str=None, label:str=None, uri:str=None, is_primary:bool) -> GData.GDPhoneNumber
    """
    ...
    def new(self, number, relation_type=None, label=None, uri=None, is_primary): # real signature unknown; restored from __doc__
        """ new(number:str, relation_type:str=None, label:str=None, uri:str=None, is_primary:bool) -> GData.GDPhoneNumber """
        pass
    ...
    def set_uri(self, uri=None): # real signature unknown; restored from __doc__
        """ set_uri(self, uri:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e151d520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GDPhoneNumber), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGDPhoneNumber (94233464651664)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_label': gi.FunctionInfo(get_label), 'get_number': gi.FunctionInfo(get_number), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'get_uri': gi.FunctionInfo(get_uri), 'is_primary': gi.FunctionInfo(is_primary), 'set_is_primary': gi.FunctionInfo(set_is_primary), 'set_label': gi.FunctionInfo(set_label), 'set_number': gi.FunctionInfo(set_number), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'set_uri': gi.FunctionInfo(set_uri), 'parent': <property object at 0x7fd5e173d7c0>, 'priv': <property object at 0x7fd5e173d8b0>})"
    __gdoc__ = 'Object GDataGDPhoneNumber\n\nProperties from GDataGDPhoneNumber:\n  number -> gchararray: Number\n    Human-readable phone number; may be in any telephone number format.\n  uri -> gchararray: URI\n    An optional "tel URI" used to represent the number in a formal way.\n  relation-type -> gchararray: Relation type\n    A programmatic value that identifies the type of phone number.\n  label -> gchararray: Label\n    A simple string value used to name this phone number.\n  is-primary -> gboolean: Primary?\n    Indicates which phone number out of a group is primary.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGDPhoneNumber (94233464651664)>'
    __info__ = ObjectInfo(GDPhoneNumber)
