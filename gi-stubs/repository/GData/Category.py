...
class Category(Parsable, Comparable):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e23ccb80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Category), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataCategory (94233464366448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_label': gi.FunctionInfo(get_label), 'get_scheme': gi.FunctionInfo(get_scheme), 'get_term': gi.FunctionInfo(get_term), 'set_label': gi.FunctionInfo(set_label), 'set_scheme': gi.FunctionInfo(set_scheme), 'set_term': gi.FunctionInfo(set_term), 'parent': <property object at 0x7fd5e177b900>, 'priv': <property object at 0x7fd5e177b9f0>})"
    __gdoc__ = 'Object GDataCategory\n\nProperties from GDataCategory:\n  term -> gchararray: Term\n    Identifies the category to which the entry or feed belongs.\n  scheme -> gchararray: Scheme\n    An IRI that identifies a categorization scheme.\n  label -> gchararray: Label\n    A human-readable label for display in end-user applications.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataCategory (94233464366448)>'
