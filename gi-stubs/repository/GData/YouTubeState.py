...
class YouTubeState(Parsable):
    """
    :Constructors:
    
    ::
    
        YouTubeState(**properties)
    """
    ...
    def get_help_uri(self): # real signature unknown; restored from __doc__
        """ get_help_uri(self) -> str """
        return ""
    ...
    def get_reason_code(self): # real signature unknown; restored from __doc__
        """ get_reason_code(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e24af700>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(YouTubeState), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataYouTubeState (94233464947216)>, '__doc__': None, '__gsignals__': {}, 'get_help_uri': gi.FunctionInfo(get_help_uri), 'get_message': gi.FunctionInfo(get_message), 'get_name': gi.FunctionInfo(get_name), 'get_reason_code': gi.FunctionInfo(get_reason_code), 'parent': <property object at 0x7fd5e16fd7c0>, 'priv': <property object at 0x7fd5e16fd8b0>})"
    __gdoc__ = 'Object GDataYouTubeState\n\nProperties from GDataYouTubeState:\n  name -> gchararray: Name\n    The name of the status of the unpublished video.\n  reason-code -> gchararray: Reason code\n    The reason code explaining why the video failed to upload.\n  help-uri -> gchararray: Help URI\n    A URI for a YouTube Help Center page.\n  message -> gchararray: Message\n    A human-readable description of why the video failed to upload.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataYouTubeState (94233464947216)>'
    __info__ = ObjectInfo(YouTubeState)
