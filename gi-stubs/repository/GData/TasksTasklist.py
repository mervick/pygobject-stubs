...
class TasksTasklist(Entry):
    """
    :Constructors:
    
    ::
    
        TasksTasklist(**properties)
        new(id:str=None) -> GData.TasksTasklist
    """
