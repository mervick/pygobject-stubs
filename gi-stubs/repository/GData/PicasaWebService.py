...
class PicasaWebService(Service):
    ...
    ::
        ...
        PicasaWebService(**properties)
        new(authorizer:GData.Authorizer=None) -> GData.PicasaWebService
    """
    ...
    def finish_file_upload(self, upload_stream): # real signature unknown; restored from __doc__
        """ finish_file_upload(self, upload_stream:GData.UploadStream) -> GData.PicasaWebFile """
        pass
    ...
    def get_user(self, username=None, cancellable=None): # real signature unknown; restored from __doc__
        """ get_user(self, username:str=None, cancellable:Gio.Cancellable=None) -> GData.PicasaWebUser """
        pass

    def get_user_async(self, username=None, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_user_async(self, username:str=None, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_user_finish(self, result): # real signature unknown; restored from __doc__
        """ get_user_finish(self, result:Gio.AsyncResult) -> GData.PicasaWebUser """
        pass
    ...
    def insert_album(self, album, cancellable=None): # real signature unknown; restored from __doc__
        """ insert_album(self, album:GData.PicasaWebAlbum, cancellable:Gio.Cancellable=None) -> GData.PicasaWebAlbum """
        pass

    def insert_album_async(self, album, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ insert_album_async(self, album:GData.PicasaWebAlbum, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def query_all_albums(self, query=None, username=None, cancellable=None, progress_callback=None, progress_user_data=None): # real signature unknown; restored from __doc__
        """ query_all_albums(self, query:GData.Query=None, username:str=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None) -> GData.Feed """
        pass

    def query_all_albums_async(self, query=None, username=None, cancellable=None, progress_callback=None, progress_user_data=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ query_all_albums_async(self, query:GData.Query=None, username:str=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def query_files(self, album=None, query=None, cancellable=None, progress_callback=None, progress_user_data=None): # real signature unknown; restored from __doc__
        """ query_files(self, album:GData.PicasaWebAlbum=None, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None) -> GData.Feed """
        pass

    def query_files_async(self, album=None, query=None, cancellable=None, progress_callback=None, progress_user_data=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ query_files_async(self, album:GData.PicasaWebAlbum=None, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def upload_file(self, album=None, file_entry, slug, content_type, cancellable=None): # real signature unknown; restored from __doc__
        """ upload_file(self, album:GData.PicasaWebAlbum=None, file_entry:GData.PicasaWebFile, slug:str, content_type:str, cancellable:Gio.Cancellable=None) -> GData.UploadStream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e14a1bb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PicasaWebService), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataPicasaWebService (94233464819024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_primary_authorization_domain': gi.FunctionInfo(get_primary_authorization_domain), 'finish_file_upload': gi.FunctionInfo(finish_file_upload), 'get_user': gi.FunctionInfo(get_user), 'get_user_async': gi.FunctionInfo(get_user_async), 'get_user_finish': gi.FunctionInfo(get_user_finish), 'insert_album': gi.FunctionInfo(insert_album), 'insert_album_async': gi.FunctionInfo(insert_album_async), 'query_all_albums': gi.FunctionInfo(query_all_albums), 'query_all_albums_async': gi.FunctionInfo(query_all_albums_async), 'query_files': gi.FunctionInfo(query_files), 'query_files_async': gi.FunctionInfo(query_files_async), 'upload_file': gi.FunctionInfo(upload_file), 'parent': <property object at 0x7fd5e1760630>})"
    __gdoc__ = 'Object GDataPicasaWebService\n\nProperties from GDataService:\n  proxy-uri -> SoupURI: Proxy URI\n    The proxy URI used internally for all network requests.\n  timeout -> guint: Timeout\n    A timeout, in seconds, for network operations.\n  locale -> gchararray: Locale\n    The locale to use for network requests, in Unix locale format.\n  authorizer -> GDataAuthorizer: Authorizer\n    An authorizer object to provide an authorization token for each request.\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    A GProxyResolver used to determine a proxy URI.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataPicasaWebService (94233464819024)>'
    __info__ = ObjectInfo(PicasaWebService)
