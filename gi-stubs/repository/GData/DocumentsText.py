...
class DocumentsText(DocumentsDocument):
    """
    :Constructors:
    
    ::
    
        DocumentsText(**properties)
        new(id:str=None) -> GData.DocumentsText
    """
