...
class UploadStream(__gi_repository_Gio.OutputStream):
    """
    :Constructors:
    ...
    ::
        ...
        new(service:GData.Service, domain:GData.AuthorizationDomain=None, method:str, upload_uri:str, entry:GData.Entry=None, slug:str, content_type:str, cancellable:Gio.Cancellable=None) -> Gio.OutputStream
        new_resumable(service:GData.Service, domain:GData.AuthorizationDomain=None, method:str, upload_uri:str, entry:GData.Entry=None, slug:str, content_type:str, content_length:int, cancellable:Gio.Cancellable=None) -> Gio.OutputStream
    """
    ...
    def get_response(self): # real signature unknown; restored from __doc__
        """ get_response(self) -> str, length:int """
        return ""
    ...
    def get_slug(self): # real signature unknown; restored from __doc__
        """ get_slug(self) -> str """
        return ""

    def get_upload_uri(self): # real signature unknown; restored from __doc__
        """ get_upload_uri(self) -> str """
        return ""
    ...
    def new(self, service, domain=None, method, upload_uri, entry=None, slug, content_type, cancellable=None): # real signature unknown; restored from __doc__
        """ new(service:GData.Service, domain:GData.AuthorizationDomain=None, method:str, upload_uri:str, entry:GData.Entry=None, slug:str, content_type:str, cancellable:Gio.Cancellable=None) -> Gio.OutputStream """
        pass
    ...
    def new_resumable(self, service, domain=None, method, upload_uri, entry=None, slug, content_type, content_length, cancellable=None): # real signature unknown; restored from __doc__
        """ new_resumable(service:GData.Service, domain:GData.AuthorizationDomain=None, method:str, upload_uri:str, entry:GData.Entry=None, slug:str, content_type:str, content_length:int, cancellable:Gio.Cancellable=None) -> Gio.OutputStream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1365340>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UploadStream), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataUploadStream (94233464881024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_resumable': gi.FunctionInfo(new_resumable), 'get_authorization_domain': gi.FunctionInfo(get_authorization_domain), 'get_cancellable': gi.FunctionInfo(get_cancellable), 'get_content_length': gi.FunctionInfo(get_content_length), 'get_content_type': gi.FunctionInfo(get_content_type), 'get_entry': gi.FunctionInfo(get_entry), 'get_method': gi.FunctionInfo(get_method), 'get_response': gi.FunctionInfo(get_response), 'get_service': gi.FunctionInfo(get_service), 'get_slug': gi.FunctionInfo(get_slug), 'get_upload_uri': gi.FunctionInfo(get_upload_uri), 'parent': <property object at 0x7fd5e176bcc0>, 'priv': <property object at 0x7fd5e176bdb0>})"
    __gdoc__ = 'Object GDataUploadStream\n\nProperties from GDataUploadStream:\n  service -> GDataService: Service\n    The service which is used to authorize the upload.\n  upload-uri -> gchararray: Upload URI\n    The URI to upload the data and metadata to.\n  entry -> GDataEntry: Entry\n    The entry used for metadata to upload.\n  slug -> gchararray: Slug\n    The slug of the file being uploaded.\n  content-type -> gchararray: Content type\n    The content type of the file being uploaded.\n  method -> gchararray: Method\n    The HTTP request method to use when uploading the file.\n  cancellable -> GCancellable: Cancellable\n    An optional cancellable used to cancel the entire upload operation.\n  authorization-domain -> GDataAuthorizationDomain: Authorization domain\n    The authorization domain for the upload.\n  content-length -> gint64: Content length\n    The content length (in bytes) of the file being uploaded.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataUploadStream (94233464881024)>'
    __info__ = ObjectInfo(UploadStream)
