...
class GContactCalendar(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        GContactCalendar(**properties)
        new(uri:str, relation_type:str=None, label:str=None, is_primary:bool) -> GData.GContactCalendar
    """
    ...
    def new(self, uri, relation_type=None, label=None, is_primary): # real signature unknown; restored from __doc__
        """ new(uri:str, relation_type:str=None, label:str=None, is_primary:bool) -> GData.GContactCalendar """
        pass
