...
class DocumentsDrawing(DocumentsDocument):
    """
    :Constructors:
    
    ::
    
        DocumentsDrawing(**properties)
        new(id:str=None) -> GData.DocumentsDrawing
    """
