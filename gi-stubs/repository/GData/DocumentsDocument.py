...
class DocumentsDocument(DocumentsEntry):
    """
    :Constructors:
    
    ::
    
        DocumentsDocument(**properties)
        new(id:str=None) -> GData.DocumentsDocument
    """
    ...
    def download(self, service, export_format, cancellable=None): # real signature unknown; restored from __doc__
        """ download(self, service:GData.DocumentsService, export_format:str, cancellable:Gio.Cancellable=None) -> GData.DownloadStream """
        pass
    ...
    def get_download_uri(self, export_format): # real signature unknown; restored from __doc__
        """ get_download_uri(self, export_format:str) -> str or None """
        return ""
    ...
    def get_thumbnail_uri(self): # real signature unknown; restored from __doc__
        """ get_thumbnail_uri(self) -> str or None """
        return ""
