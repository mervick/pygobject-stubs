...
class CalendarService(Service, Batchable):
    """
    :Constructors:
    ...
    ::
        ...
        new(authorizer:GData.Authorizer=None) -> GData.CalendarService
    """
    ...
    def insert_calendar_event(self, calendar, event, cancellable=None): # real signature unknown; restored from __doc__
        """ insert_calendar_event(self, calendar:GData.CalendarCalendar, event:GData.CalendarEvent, cancellable:Gio.Cancellable=None) -> GData.CalendarEvent """
        pass

    def insert_calendar_event_async(self, calendar, event, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ insert_calendar_event_async(self, calendar:GData.CalendarCalendar, event:GData.CalendarEvent, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def insert_event(self, event, cancellable=None): # real signature unknown; restored from __doc__
        """ insert_event(self, event:GData.CalendarEvent, cancellable:Gio.Cancellable=None) -> GData.CalendarEvent """
        pass

    def insert_event_async(self, event, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ insert_event_async(self, event:GData.CalendarEvent, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def query_all_calendars(self, query=None, cancellable=None, progress_callback=None, progress_user_data=None): # real signature unknown; restored from __doc__
        """ query_all_calendars(self, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None) -> GData.Feed """
        pass

    def query_all_calendars_async(self, query=None, cancellable=None, progress_callback=None, progress_user_data=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ query_all_calendars_async(self, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def query_events(self, calendar, query=None, cancellable=None, progress_callback=None, progress_user_data=None): # real signature unknown; restored from __doc__
        """ query_events(self, calendar:GData.CalendarCalendar, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None) -> GData.Feed """
        pass

    def query_events_async(self, calendar, query=None, cancellable=None, progress_callback=None, progress_user_data=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ query_events_async(self, calendar:GData.CalendarCalendar, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def query_own_calendars(self, query=None, cancellable=None, progress_callback=None, progress_user_data=None): # real signature unknown; restored from __doc__
        """ query_own_calendars(self, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None) -> GData.Feed """
        pass

    def query_own_calendars_async(self, query=None, cancellable=None, progress_callback=None, progress_user_data=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ query_own_calendars_async(self, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e170d970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CalendarService), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataCalendarService (94233464361104)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_primary_authorization_domain': gi.FunctionInfo(get_primary_authorization_domain), 'insert_calendar_event': gi.FunctionInfo(insert_calendar_event), 'insert_calendar_event_async': gi.FunctionInfo(insert_calendar_event_async), 'insert_event': gi.FunctionInfo(insert_event), 'insert_event_async': gi.FunctionInfo(insert_event_async), 'query_all_calendars': gi.FunctionInfo(query_all_calendars), 'query_all_calendars_async': gi.FunctionInfo(query_all_calendars_async), 'query_events': gi.FunctionInfo(query_events), 'query_events_async': gi.FunctionInfo(query_events_async), 'query_own_calendars': gi.FunctionInfo(query_own_calendars), 'query_own_calendars_async': gi.FunctionInfo(query_own_calendars_async), 'parent': <property object at 0x7fd5e1778ea0>})"
    __gdoc__ = 'Object GDataCalendarService\n\nProperties from GDataService:\n  proxy-uri -> SoupURI: Proxy URI\n    The proxy URI used internally for all network requests.\n  timeout -> guint: Timeout\n    A timeout, in seconds, for network operations.\n  locale -> gchararray: Locale\n    The locale to use for network requests, in Unix locale format.\n  authorizer -> GDataAuthorizer: Authorizer\n    An authorizer object to provide an authorization token for each request.\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    A GProxyResolver used to determine a proxy URI.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataCalendarService (94233464361104)>'
    __info__ = ObjectInfo(CalendarService)
