...
class GDWhere(Parsable, Comparable):
    """
    :Constructors:
    ...
    ::
        ...
        GDWhere(**properties)
        new(relation_type:str=None, value_string:str=None, label:str=None) -> GData.GDWhere
    """
    ...
    def new(self, relation_type=None, value_string=None, label=None): # real signature unknown; restored from __doc__
        """ new(relation_type:str=None, value_string:str=None, label:str=None) -> GData.GDWhere """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1377f10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GDWhere), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGDWhere (94233464706928)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_label': gi.FunctionInfo(get_label), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'get_value_string': gi.FunctionInfo(get_value_string), 'set_label': gi.FunctionInfo(set_label), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'set_value_string': gi.FunctionInfo(set_value_string), 'parent': <property object at 0x7fd5e1743860>, 'priv': <property object at 0x7fd5e1743950>})"
    __gdoc__ = 'Object GDataGDWhere\n\nProperties from GDataGDWhere:\n  relation-type -> gchararray: Relation type\n    Specifies the relationship between the container and the containee.\n  value-string -> gchararray: Value string\n    A simple string representation of this location.\n  label -> gchararray: Label\n    Specifies a user-readable label to distinguish this location from others.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGDWhere (94233464706928)>'
    __info__ = ObjectInfo(GDWhere)
