...
class MediaCredit(Parsable):
    """
    :Constructors:
    
    ::
    
        MediaCredit(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e134e1f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaCredit), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataMediaCredit (94233464758256)>, '__doc__': None, '__gsignals__': {}, 'get_credit': gi.FunctionInfo(get_credit), 'get_role': gi.FunctionInfo(get_role), 'get_scheme': gi.FunctionInfo(get_scheme), 'parent': <property object at 0x7fd5e174dc20>, 'priv': <property object at 0x7fd5e174dd10>})"
    __gdoc__ = "Object GDataMediaCredit\n\nProperties from GDataMediaCredit:\n  credit -> gchararray: Credit\n    The credited entity's name.\n  scheme -> gchararray: Scheme\n    A URI that identifies the role scheme.\n  role -> gchararray: Role\n    The role the credited entity played in the production of the media.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataMediaCredit (94233464758256)>'
    __info__ = ObjectInfo(MediaCredit)
