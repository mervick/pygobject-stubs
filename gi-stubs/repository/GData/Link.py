...
class Link(Parsable, Comparable):
    """
    :Constructors:
    ...
    ::
        ...
        Link(**properties)
        new(uri:str, relation_type:str=None) -> GData.Link
    """
    ...
    def get_relation_type(self): # real signature unknown; restored from __doc__
        """ get_relation_type(self) -> str or None """
        return ""
    ...
    def new(self, uri, relation_type=None): # real signature unknown; restored from __doc__
        """ new(uri:str, relation_type:str=None) -> GData.Link """
        pass
    ...
    def set_content_type(self, content_type=None): # real signature unknown; restored from __doc__
        """ set_content_type(self, content_type:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e134ea00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Link), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataLink (94233464515104)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_content_type': gi.FunctionInfo(get_content_type), 'get_language': gi.FunctionInfo(get_language), 'get_length': gi.FunctionInfo(get_length), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'get_title': gi.FunctionInfo(get_title), 'get_uri': gi.FunctionInfo(get_uri), 'set_content_type': gi.FunctionInfo(set_content_type), 'set_language': gi.FunctionInfo(set_language), 'set_length': gi.FunctionInfo(set_length), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'set_title': gi.FunctionInfo(set_title), 'set_uri': gi.FunctionInfo(set_uri), 'parent': <property object at 0x7fd5e174a630>, 'priv': <property object at 0x7fd5e174a720>})"
    __gdoc__ = "Object GDataLink\n\nProperties from GDataLink:\n  uri -> gchararray: URI\n    The link's IRI.\n  relation-type -> gchararray: Relation type\n    The link relation type.\n  content-type -> gchararray: Content type\n    An advisory media type.\n  language -> gchararray: Language\n    Describes the language of the resource pointed to by the uri property.\n  title -> gchararray: Title\n    Conveys human-readable information about the link.\n  length -> gint: Length\n    Indicates an advisory length of the linked content in octets.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataLink (94233464515104)>'
    __info__ = ObjectInfo(Link)
