...
class Feed(Parsable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e16f8ca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Feed), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataFeed (94233464347664)>, '__doc__': None, '__gsignals__': {}, 'get_authors': gi.FunctionInfo(get_authors), 'get_categories': gi.FunctionInfo(get_categories), 'get_entries': gi.FunctionInfo(get_entries), 'get_etag': gi.FunctionInfo(get_etag), 'get_generator': gi.FunctionInfo(get_generator), 'get_icon': gi.FunctionInfo(get_icon), 'get_id': gi.FunctionInfo(get_id), 'get_items_per_page': gi.FunctionInfo(get_items_per_page), 'get_links': gi.FunctionInfo(get_links), 'get_logo': gi.FunctionInfo(get_logo), 'get_next_page_token': gi.FunctionInfo(get_next_page_token), 'get_rights': gi.FunctionInfo(get_rights), 'get_start_index': gi.FunctionInfo(get_start_index), 'get_subtitle': gi.FunctionInfo(get_subtitle), 'get_title': gi.FunctionInfo(get_title), 'get_total_results': gi.FunctionInfo(get_total_results), 'get_updated': gi.FunctionInfo(get_updated), 'look_up_entry': gi.FunctionInfo(look_up_entry), 'look_up_link': gi.FunctionInfo(look_up_link), 'parent': <property object at 0x7fd5e1773c70>, 'priv': <property object at 0x7fd5e1773d60>})"
    __gdoc__ = 'Object GDataFeed\n\nProperties from GDataFeed:\n  id -> gchararray: ID\n    The unique and permanent URN ID for the feed.\n  etag -> gchararray: ETag\n    The unique ETag for this version of the feed.\n  updated -> gint64: Updated\n    The time the feed was last updated.\n  title -> gchararray: Title\n    The title of the feed.\n  subtitle -> gchararray: Subtitle\n    The subtitle of the feed.\n  logo -> gchararray: Logo\n    The URI of a logo for the feed.\n  icon -> gchararray: Icon\n    The URI of an icon for the feed.\n  generator -> GDataGenerator: Generator\n    Details of the software used to generate the feed.\n  items-per-page -> guint: Items per page\n    The number of items per results page feed.\n  start-index -> guint: Start index\n    The one-based index of the first item in the results feed.\n  total-results -> guint: Total results\n    The total number of results in the feed.\n  rights -> gchararray: Rights\n    The ownership rights pertaining to the entire feed.\n  next-page-token -> gchararray: Next page token\n    The next page token for feeds.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataFeed (94233464347664)>'
    __info__ = ObjectInfo(Feed)
