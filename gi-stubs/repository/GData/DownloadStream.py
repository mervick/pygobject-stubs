...
class DownloadStream(__gi_repository_Gio.InputStream, __gi_repository_Gio.Seekable):
    """
    :Constructors:
    
    ::
    
        DownloadStream(**properties)
        new(service:GData.Service, domain:GData.AuthorizationDomain=None, download_uri:str, cancellable:Gio.Cancellable=None) -> Gio.InputStream
    """
    ...
    def get_download_uri(self): # real signature unknown; restored from __doc__
        """ get_download_uri(self) -> str """
        return ""
    ...
    def new(self, service, domain=None, download_uri, cancellable=None): # real signature unknown; restored from __doc__
        """ new(service:GData.Service, domain:GData.AuthorizationDomain=None, download_uri:str, cancellable:Gio.Cancellable=None) -> Gio.InputStream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e14a1b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DownloadStream), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataDownloadStream (94233464385808)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_authorization_domain': gi.FunctionInfo(get_authorization_domain), 'get_cancellable': gi.FunctionInfo(get_cancellable), 'get_content_length': gi.FunctionInfo(get_content_length), 'get_content_type': gi.FunctionInfo(get_content_type), 'get_download_uri': gi.FunctionInfo(get_download_uri), 'get_service': gi.FunctionInfo(get_service), 'parent': <property object at 0x7fd5e179c180>, 'priv': <property object at 0x7fd5e17a16d0>})"
    __gdoc__ = 'Object GDataDownloadStream\n\nProperties from GDataDownloadStream:\n  service -> GDataService: Service\n    The service which is used to authorize the download.\n  download-uri -> gchararray: Download URI\n    The URI of the file to download.\n  content-type -> gchararray: Content type\n    The content type of the file being downloaded.\n  content-length -> glong: Content length\n    The length (in bytes) of the file being downloaded.\n  cancellable -> GCancellable: Cancellable\n    An optional cancellable used to cancel the entire download operation.\n  authorization-domain -> GDataAuthorizationDomain: Authorization domain\n    The authorization domain for the download.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataDownloadStream (94233464385808)>'
    __info__ = ObjectInfo(DownloadStream)
