...
class CalendarAccessRule(AccessRule):
    """
    :Constructors:
    
    ::
    
        CalendarAccessRule(**properties)
        new(id:str) -> GData.CalendarAccessRule
    """
