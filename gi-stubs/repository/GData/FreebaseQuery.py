...
class FreebaseQuery(Query):
    """
    :Constructors:
    
    ::
    
        FreebaseQuery(**properties)
        new(mql:str) -> GData.FreebaseQuery
        new_from_variant(variant:GLib.Variant) -> GData.FreebaseQuery
    """
    ...
    def new(self, mql): # real signature unknown; restored from __doc__
        """ new(mql:str) -> GData.FreebaseQuery """
        pass
    ...
    def new_from_variant(self, variant): # real signature unknown; restored from __doc__
        """ new_from_variant(variant:GLib.Variant) -> GData.FreebaseQuery """
        pass
