...
class FreebaseTopicQuery(Query):
    """
    :Constructors:
    
    ::
    
        FreebaseTopicQuery(**properties)
        new(id:str) -> GData.FreebaseTopicQuery
    """
    ...
    def set_filter(self, filter=None): # real signature unknown; restored from __doc__
        """ set_filter(self, filter:list=None) """
        pass
