...
class YouTubeCredit(MediaCredit):
    """
    :Constructors:
    
    ::
    
        YouTubeCredit(**properties)
    """
    ...
    def get_entity_type(self): # real signature unknown; restored from __doc__
        """ get_entity_type(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1034490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(YouTubeCredit), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataYouTubeCredit (94233464583120)>, '__doc__': None, '__gsignals__': {}, 'get_entity_type': gi.FunctionInfo(get_entity_type), 'parent': <property object at 0x7fd5e16f40e0>, 'priv': <property object at 0x7fd5e16f41d0>})"
    __gdoc__ = "Object GDataYouTubeCredit\n\nProperties from GDataYouTubeCredit:\n  entity-type -> gchararray: Entity type\n    The type of entity who is credited.\n\nProperties from GDataMediaCredit:\n  credit -> gchararray: Credit\n    The credited entity's name.\n  scheme -> gchararray: Scheme\n    A URI that identifies the role scheme.\n  role -> gchararray: Role\n    The role the credited entity played in the production of the media.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataYouTubeCredit (94233464583120)>'
    __info__ = ObjectInfo(YouTubeCredit)
