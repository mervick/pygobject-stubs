...
class MediaThumbnail(Parsable):
    """
    :Constructors:
    
    ::
    
        MediaThumbnail(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1377250>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaThumbnail), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataMediaThumbnail (94233464763552)>, '__doc__': None, '__gsignals__': {}, 'download': gi.FunctionInfo(download), 'get_height': gi.FunctionInfo(get_height), 'get_time': gi.FunctionInfo(get_time), 'get_uri': gi.FunctionInfo(get_uri), 'get_width': gi.FunctionInfo(get_width), 'parent': <property object at 0x7fd5e1751860>, 'priv': <property object at 0x7fd5e1751950>})"
    __gdoc__ = 'Object GDataMediaThumbnail\n\nProperties from GDataMediaThumbnail:\n  uri -> gchararray: URI\n    The URI of the thumbnail.\n  height -> guint: Height\n    The height of the thumbnail, in pixels.\n  width -> guint: Width\n    The width of the thumbnail, in pixels.\n  time -> gint64: Time\n    The time offset of the thumbnail in relation to the media object, in ms.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataMediaThumbnail (94233464763552)>'
    __info__ = ObjectInfo(MediaThumbnail)
