...
class APPCategories(Parsable):
    """
    :Constructors:
    
    ::
    
        APPCategories(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e23572e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(APPCategories), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataAPPCategories (94233464151856)>, '__doc__': None, '__gsignals__': {}, 'get_categories': gi.FunctionInfo(get_categories), 'is_fixed': gi.FunctionInfo(is_fixed), 'parent': <property object at 0x7fd5e2379360>, 'priv': <property object at 0x7fd5e23793b0>})"
    __gdoc__ = 'Object GDataAPPCategories\n\nProperties from GDataAPPCategories:\n  is-fixed -> gboolean: Fixed?\n    Whether entries may use categories not in this category list.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataAPPCategories (94233464151856)>'
    __info__ = ObjectInfo(APPCategories)
