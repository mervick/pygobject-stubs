...
class TasksTask(Entry):
    """
    :Constructors:
    
    ::
    
        TasksTask(**properties)
        new(id:str=None) -> GData.TasksTask
    """
    ...
    def get_notes(self): # real signature unknown; restored from __doc__
        """ get_notes(self) -> str or None """
        return ""

    def get_parent(self): # real signature unknown; restored from __doc__
        """ get_parent(self) -> str or None """
        return ""

    def get_position(self): # real signature unknown; restored from __doc__
        """ get_position(self) -> str or None """
        return ""
    ...
    def is_hidden(self): # real signature unknown; restored from __doc__
        """ is_hidden(self) -> bool """
        return False
    ...
    def set_completed(self, completed): # real signature unknown; restored from __doc__
        """ set_completed(self, completed:int) """
        pass
    ...
    def set_due(self, due): # real signature unknown; restored from __doc__
        """ set_due(self, due:int) """
        pass

    def set_is_deleted(self, deleted): # real signature unknown; restored from __doc__
        """ set_is_deleted(self, deleted:bool) """
        pass

    def set_notes(self, notes=None): # real signature unknown; restored from __doc__
        """ set_notes(self, notes:str=None) """
        pass
    ...
    def set_position(self, position): # real signature unknown; restored from __doc__
        """ set_position(self, position:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1365ca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TasksTask), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataTasksTask (94233464871744)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_completed': gi.FunctionInfo(get_completed), 'get_due': gi.FunctionInfo(get_due), 'get_notes': gi.FunctionInfo(get_notes), 'get_parent': gi.FunctionInfo(get_parent), 'get_position': gi.FunctionInfo(get_position), 'get_status': gi.FunctionInfo(get_status), 'is_deleted': gi.FunctionInfo(is_deleted), 'is_hidden': gi.FunctionInfo(is_hidden), 'set_completed': gi.FunctionInfo(set_completed), 'set_due': gi.FunctionInfo(set_due), 'set_is_deleted': gi.FunctionInfo(set_is_deleted), 'set_notes': gi.FunctionInfo(set_notes), 'set_parent': gi.FunctionInfo(set_parent), 'set_position': gi.FunctionInfo(set_position), 'set_status': gi.FunctionInfo(set_status), 'parent': <property object at 0x7fd5e1769b30>, 'priv': <property object at 0x7fd5e1769c20>})"
    __gdoc__ = 'Object GDataTasksTask\n\nProperties from GDataTasksTask:\n  parent -> gchararray: Parent of task\n    Identifier of parent task.\n  position -> gchararray: Position of task\n    Position of the task among sibling tasks using lexicographical order.\n  notes -> gchararray: Notes of task\n    Notes describing the task.\n  status -> gchararray: Status of task\n    Status of the task.\n  due -> gint64: Due date of the task\n    Due date of the task.\n  completed -> gint64: Completion date of task\n    Completion date of the task.\n  is-deleted -> gboolean: Deleted?\n    Indicated whatever task is deleted.\n  is-hidden -> gboolean: Hidden?\n    Indicated whatever task is hidden.\n\nProperties from GDataEntry:\n  title -> gchararray: Title\n    A human-readable title for the entry.\n  summary -> gchararray: Summary\n    A short summary, abstract, or excerpt of the entry.\n  etag -> gchararray: ETag\n    An identifier for a particular version of the entry.\n  id -> gchararray: ID\n    A permanent, universally unique identifier for the entry, in IRI form.\n  updated -> gint64: Updated\n    The date and time when the entry was most recently updated significantly.\n  published -> gint64: Published\n    The date and time the entry was first published or made available.\n  content -> gchararray: Content\n    The content of the entry.\n  is-inserted -> gboolean: Inserted?\n    Whether the entry has been inserted on the server.\n  rights -> gchararray: Rights\n    The ownership rights pertaining to the entry.\n  content-uri -> gchararray: Content URI\n    A URI pointing to the location of the content of the entry.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataTasksTask (94233464871744)>'
    __info__ = ObjectInfo(TasksTask)
