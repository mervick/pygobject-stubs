...
class DocumentsPresentation(DocumentsDocument):
    """
    :Constructors:
    
    ::
    
        DocumentsPresentation(**properties)
        new(id:str=None) -> GData.DocumentsPresentation
    """
