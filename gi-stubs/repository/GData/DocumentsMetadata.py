...
class DocumentsMetadata(Parsable):
    """
    :Constructors:
    
    ::
    
        DocumentsMetadata(**properties)
    """
    ...
    def get_quota_total(self): # real signature unknown; restored from __doc__
        """ get_quota_total(self) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e16e13a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DocumentsMetadata), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataDocumentsMetadata (94233464457536)>, '__doc__': None, '__gsignals__': {}, 'get_quota_total': gi.FunctionInfo(get_quota_total), 'get_quota_used': gi.FunctionInfo(get_quota_used), 'parent': <property object at 0x7fd5e1793360>, 'priv': <property object at 0x7fd5e1793450>})"
    __gdoc__ = 'Object GDataDocumentsMetadata\n\nProperties from GDataDocumentsMetadata:\n  quota-total -> gint64: Quota total\n    The user quota limit across all services.\n  quota-used -> gint64: Quota used\n    The amount of user quota used up across all services.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataDocumentsMetadata (94233464457536)>'
    __info__ = ObjectInfo(DocumentsMetadata)
