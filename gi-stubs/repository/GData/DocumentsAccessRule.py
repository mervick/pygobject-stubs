...
class DocumentsAccessRule(AccessRule):
    """
    :Constructors:
    
    ::
    
        DocumentsAccessRule(**properties)
        new(id:str) -> GData.DocumentsAccessRule
    """
