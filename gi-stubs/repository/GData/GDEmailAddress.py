...
class GDEmailAddress(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        GDEmailAddress(**properties)
        new(address:str, relation_type:str=None, label:str=None, is_primary:bool) -> GData.GDEmailAddress
    """
    ...
    def new(self, address, relation_type=None, label=None, is_primary): # real signature unknown; restored from __doc__
        """ new(address:str, relation_type:str=None, label:str=None, is_primary:bool) -> GData.GDEmailAddress """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1590af0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GDEmailAddress), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGDEmailAddress (94233464646656)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_address': gi.FunctionInfo(get_address), 'get_display_name': gi.FunctionInfo(get_display_name), 'get_label': gi.FunctionInfo(get_label), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'is_primary': gi.FunctionInfo(is_primary), 'set_address': gi.FunctionInfo(set_address), 'set_display_name': gi.FunctionInfo(set_display_name), 'set_is_primary': gi.FunctionInfo(set_is_primary), 'set_label': gi.FunctionInfo(set_label), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'parent': <property object at 0x7fd5e1738900>, 'priv': <property object at 0x7fd5e17389f0>})"
    __gdoc__ = 'Object GDataGDEmailAddress\n\nProperties from GDataGDEmailAddress:\n  address -> gchararray: Address\n    The e-mail address itself.\n  relation-type -> gchararray: Relation type\n    A programmatic value that identifies the type of e-mail address.\n  label -> gchararray: Label\n    A simple string value used to name this e-mail address.\n  is-primary -> gboolean: Primary?\n    Indicates which e-mail address out of a group is primary.\n  display-name -> gchararray: Display name\n    A display name of the entity the e-mail address belongs to.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGDEmailAddress (94233464646656)>'
    __info__ = ObjectInfo(GDEmailAddress)
