...
class GContactLanguage(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        GContactLanguage(**properties)
        new(code:str=None, label:str=None) -> GData.GContactLanguage
    """
    ...
    def new(self, code=None, label=None): # real signature unknown; restored from __doc__
        """ new(code:str=None, label:str=None) -> GData.GContactLanguage """
        pass
    ...
    def set_code(self, code=None): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e151d5e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GContactLanguage), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGContactLanguage (94233464606528)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_code': gi.FunctionInfo(get_code), 'get_label': gi.FunctionInfo(get_label), 'set_code': gi.FunctionInfo(set_code), 'set_label': gi.FunctionInfo(set_label), 'parent': <property object at 0x7fd5e1735270>, 'priv': <property object at 0x7fd5e1735360>})"
    __gdoc__ = 'Object GDataGContactLanguage\n\nProperties from GDataGContactLanguage:\n  code -> gchararray: Code\n    A code identifying the language, conforming to the IETF BCP 47 specification.\n  label -> gchararray: Label\n    A free-form string that identifies the language.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGContactLanguage (94233464606528)>'
    __info__ = ObjectInfo(GContactLanguage)
