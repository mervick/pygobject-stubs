...
class GContactEvent(Parsable):
    """
    :Constructors:
    
    ::
    
        GContactEvent(**properties)
        new(date:GLib.Date, relation_type:str=None, label:str=None) -> GData.GContactEvent
    """
    ...
    def new(self, date, relation_type=None, label=None): # real signature unknown; restored from __doc__
        """ new(date:GLib.Date, relation_type:str=None, label:str=None) -> GData.GContactEvent """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1377070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GContactEvent), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGContactEvent (94233464591184)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_date': gi.FunctionInfo(get_date), 'get_label': gi.FunctionInfo(get_label), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'set_date': gi.FunctionInfo(set_date), 'set_label': gi.FunctionInfo(set_label), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'parent': <property object at 0x7fd5e17aec20>, 'priv': <property object at 0x7fd5e17aed10>})"
    __gdoc__ = 'Object GDataGContactEvent\n\nProperties from GDataGContactEvent:\n  date -> GDate: Date\n    The date of the event.\n  relation-type -> gchararray: Relation type\n    A programmatic value that identifies the type of website.\n  label -> gchararray: Label\n    A simple string value used to name this event.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGContactEvent (94233464591184)>'
    __info__ = ObjectInfo(GContactEvent)
