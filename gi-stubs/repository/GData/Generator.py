...
class Generator(Parsable, Comparable):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Generator), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGenerator (94233464506656)>, '__doc__': None, '__gsignals__': {}, 'get_name': gi.FunctionInfo(get_name), 'get_uri': gi.FunctionInfo(get_uri), 'get_version': gi.FunctionInfo(get_version), 'parent': <property object at 0x7fd5e1745720>, 'priv': <property object at 0x7fd5e1745810>})"
    __gdoc__ = 'Object GDataGenerator\n\nProperties from GDataGenerator:\n  name -> gchararray: Name\n    A human-readable name for the generating agent.\n  uri -> gchararray: URI\n    An IRI reference that is relevant to the agent.\n  version -> gchararray: Version\n    Indicates the version of the generating agent.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGenerator (94233464506656)>'
