...
class GContactRelation(Parsable):
    """
    :Constructors:
    
    ::
    
        GContactRelation(**properties)
        new(name:str, relation_type:str=None, label:str=None) -> GData.GContactRelation
    """
    ...
    def new(self, name, relation_type=None, label=None): # real signature unknown; restored from __doc__
        """ new(name:str, relation_type:str=None, label:str=None) -> GData.GContactRelation """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e151d8e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GContactRelation), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGContactRelation (94233464629136)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_label': gi.FunctionInfo(get_label), 'get_name': gi.FunctionInfo(get_name), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'set_label': gi.FunctionInfo(set_label), 'set_name': gi.FunctionInfo(set_name), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'parent': <property object at 0x7fd5e17359a0>, 'priv': <property object at 0x7fd5e1735a90>})"
    __gdoc__ = 'Object GDataGContactRelation\n\nProperties from GDataGContactRelation:\n  name -> gchararray: Name\n    The name of the relation.\n  relation-type -> gchararray: Relation type\n    A programmatic value that identifies the type of relation.\n  label -> gchararray: Label\n    A free-form string that identifies the type of relation.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGContactRelation (94233464629136)>'
    __info__ = ObjectInfo(GContactRelation)
