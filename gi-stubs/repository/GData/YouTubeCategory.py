...
class YouTubeCategory(Category):
    """
    :Constructors:
    
    ::
    
        YouTubeCategory(**properties)
    """
    ...
    def get_term(self): # real signature unknown; restored from __doc__
        """ get_term(self) -> str """
        return ""
    ...
    def is_assignable(self): # real signature unknown; restored from __doc__
        """ is_assignable(self) -> bool """
        return False

    def is_browsable(self, region): # real signature unknown; restored from __doc__
        """ is_browsable(self, region:str) -> bool """
        return False

    def is_deprecated(self): # real signature unknown; restored from __doc__
    ...
    def new(self, term, scheme=None, label=None): # real signature unknown; restored from __doc__
        """ new(term:str, scheme:str=None, label:str=None) -> GData.Category """
        pass
    ...
    def set_scheme(self, scheme=None): # real signature unknown; restored from __doc__
        """ set_scheme(self, scheme:str=None) """
        pass

    def set_term(self, term): # real signature unknown; restored from __doc__
        """ set_term(self, term:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e24af190>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(YouTubeCategory), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataYouTubeCategory (94233464900208)>, '__doc__': None, '__gsignals__': {}, 'is_assignable': gi.FunctionInfo(is_assignable), 'is_browsable': gi.FunctionInfo(is_browsable), 'is_deprecated': gi.FunctionInfo(is_deprecated), 'parent': <property object at 0x7fd5e176f9a0>, 'priv': <property object at 0x7fd5e176fae0>})"
    __gdoc__ = 'Object GDataYouTubeCategory\n\nProperties from GDataYouTubeCategory:\n  is-assignable -> gboolean: Assignable?\n    Whether new videos can be added to the category.\n  is-deprecated -> gboolean: Deprecated?\n    Whether the category is deprecated.\n\nProperties from GDataCategory:\n  term -> gchararray: Term\n    Identifies the category to which the entry or feed belongs.\n  scheme -> gchararray: Scheme\n    An IRI that identifies a categorization scheme.\n  label -> gchararray: Label\n    A human-readable label for display in end-user applications.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataYouTubeCategory (94233464900208)>'
    __info__ = ObjectInfo(YouTubeCategory)
