...
class PicasaWebQuery(Query):
    """
    :Constructors:
    
    ::
    
        PicasaWebQuery(**properties)
        new(q:str=None) -> GData.PicasaWebQuery
        new_with_limits(q:str=None, start_index:int, max_results:int) -> GData.PicasaWebQuery
    """
    ...
    def get_bounding_box(self): # real signature unknown; restored from __doc__
        """ get_bounding_box(self) -> north:float, east:float, south:float, west:float """
        pass
    ...
    def set_bounding_box(self, north, east, south, west): # real signature unknown; restored from __doc__
        """ set_bounding_box(self, north:float, east:float, south:float, west:float) """
        pass
    ...
    def set_image_size(self, image_size=None): # real signature unknown; restored from __doc__
        """ set_image_size(self, image_size:str=None) """
        pass
    ...
    def set_tag(self, tag=None): # real signature unknown; restored from __doc__
        """ set_tag(self, tag:str=None) """
        pass

    def set_thumbnail_size(self, thumbnail_size=None): # real signature unknown; restored from __doc__
        """ set_thumbnail_size(self, thumbnail_size:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1365160>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PicasaWebQuery), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataPicasaWebQuery (94233464821680)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_limits': gi.FunctionInfo(new_with_limits), 'get_bounding_box': gi.FunctionInfo(get_bounding_box), 'get_image_size': gi.FunctionInfo(get_image_size), 'get_location': gi.FunctionInfo(get_location), 'get_tag': gi.FunctionInfo(get_tag), 'get_thumbnail_size': gi.FunctionInfo(get_thumbnail_size), 'get_visibility': gi.FunctionInfo(get_visibility), 'set_bounding_box': gi.FunctionInfo(set_bounding_box), 'set_image_size': gi.FunctionInfo(set_image_size), 'set_location': gi.FunctionInfo(set_location), 'set_tag': gi.FunctionInfo(set_tag), 'set_thumbnail_size': gi.FunctionInfo(set_thumbnail_size), 'set_visibility': gi.FunctionInfo(set_visibility), 'parent': <property object at 0x7fd5e175dd10>, 'priv': <property object at 0x7fd5e175de00>})"
    __gdoc__ = 'Object GDataPicasaWebQuery\n\nProperties from GDataPicasaWebQuery:\n  visibility -> gint: Visibility\n    Specifies which albums should be listed, in terms of their visibility.\n  thumbnail-size -> gchararray: Thumbnail size\n    A comma-separated list of thumbnail width (in pixels) to return.\n  image-size -> gchararray: Image size\n    A comma-separated list of image sizes (width in pixels) to return.\n  tag -> gchararray: Tag\n    A tag which returned results must contain.\n  location -> gchararray: Location\n    A location to search for photos, e.g. "London".\n\nProperties from GDataQuery:\n  q -> gchararray: Query terms\n    Query terms for which to search.\n  categories -> gchararray: Category string\n    Category search string.\n  author -> gchararray: Author\n    Author search string.\n  updated-min -> gint64: Minimum update date\n    Minimum date for updates on returned entries.\n  updated-max -> gint64: Maximum update date\n    Maximum date for updates on returned entries.\n  published-min -> gint64: Minimum publish date\n    Minimum date for returned entries to be published.\n  published-max -> gint64: Maximum publish date\n    Maximum date for returned entries to be published.\n  start-index -> guint: Start index\n    One-based result start index.\n  is-strict -> gboolean: Strict?\n    Should the server be strict about the query?\n  max-results -> guint: Maximum number of results\n    The maximum number of entries to return.\n  etag -> gchararray: ETag\n    An ETag against which to check.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataPicasaWebQuery (94233464821680)>'
    __info__ = ObjectInfo(PicasaWebQuery)
