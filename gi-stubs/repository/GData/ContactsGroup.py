...
class ContactsGroup(Entry):
    """
    :Constructors:
    
    ::
    
        ContactsGroup(**properties)
        new(id:str=None) -> GData.ContactsGroup
    """
    ...
    def get_system_group_id(self): # real signature unknown; restored from __doc__
        """ get_system_group_id(self) -> str """
        return ""
