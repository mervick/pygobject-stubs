...
class Entry(Parsable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e238ee50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Entry), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataEntry (94233464160672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_author': gi.FunctionInfo(add_author), 'add_category': gi.FunctionInfo(add_category), 'add_link': gi.FunctionInfo(add_link), 'get_authors': gi.FunctionInfo(get_authors), 'get_categories': gi.FunctionInfo(get_categories), 'get_content': gi.FunctionInfo(get_content), 'get_content_uri': gi.FunctionInfo(get_content_uri), 'get_etag': gi.FunctionInfo(get_etag), 'get_id': gi.FunctionInfo(get_id), 'get_published': gi.FunctionInfo(get_published), 'get_rights': gi.FunctionInfo(get_rights), 'get_summary': gi.FunctionInfo(get_summary), 'get_title': gi.FunctionInfo(get_title), 'get_updated': gi.FunctionInfo(get_updated), 'is_inserted': gi.FunctionInfo(is_inserted), 'look_up_link': gi.FunctionInfo(look_up_link), 'look_up_links': gi.FunctionInfo(look_up_links), 'remove_link': gi.FunctionInfo(remove_link), 'set_content': gi.FunctionInfo(set_content), 'set_content_uri': gi.FunctionInfo(set_content_uri), 'set_rights': gi.FunctionInfo(set_rights), 'set_summary': gi.FunctionInfo(set_summary), 'set_title': gi.FunctionInfo(set_title), 'parent': <property object at 0x7fd5e237b2c0>, 'priv': <property object at 0x7fd5e237b400>})"
    __gdoc__ = 'Object GDataEntry\n\nProperties from GDataEntry:\n  title -> gchararray: Title\n    A human-readable title for the entry.\n  summary -> gchararray: Summary\n    A short summary, abstract, or excerpt of the entry.\n  etag -> gchararray: ETag\n    An identifier for a particular version of the entry.\n  id -> gchararray: ID\n    A permanent, universally unique identifier for the entry, in IRI form.\n  updated -> gint64: Updated\n    The date and time when the entry was most recently updated significantly.\n  published -> gint64: Published\n    The date and time the entry was first published or made available.\n  content -> gchararray: Content\n    The content of the entry.\n  is-inserted -> gboolean: Inserted?\n    Whether the entry has been inserted on the server.\n  rights -> gchararray: Rights\n    The ownership rights pertaining to the entry.\n  content-uri -> gchararray: Content URI\n    A URI pointing to the location of the content of the entry.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataEntry (94233464160672)>'
