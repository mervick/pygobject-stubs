...
class DocumentsSpreadsheet(DocumentsDocument):
    """
    :Constructors:
    
    ::
    
        DocumentsSpreadsheet(**properties)
        new(id:str=None) -> GData.DocumentsSpreadsheet
    """
    ...
    def get_download_uri(self, export_format, gid): # real signature unknown; restored from __doc__
        """ get_download_uri(self, export_format:str, gid:int) -> str """
        return ""
