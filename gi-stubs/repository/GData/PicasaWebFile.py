...
class PicasaWebFile(Entry, Commentable):
    """
    :Constructors:
    
    ::
    
        PicasaWebFile(**properties)
        new(id:str=None) -> GData.PicasaWebFile
    """
    ...
    def get_album_id(self): # real signature unknown; restored from __doc__
        """ get_album_id(self) -> str """
        return ""
    ...
    def get_comment_count(self): # real signature unknown; restored from __doc__
        """ get_comment_count(self) -> int """
        return 0
    ...
    def get_exposure(self): # real signature unknown; restored from __doc__
        """ get_exposure(self) -> float """
        return 0.0

    def get_flash(self): # real signature unknown; restored from __doc__
        """ get_flash(self) -> bool """
        return False
    ...
    def get_fstop(self): # real signature unknown; restored from __doc__
        """ get_fstop(self) -> float """
        return 0.0
    ...
    def get_image_unique_id(self): # real signature unknown; restored from __doc__
        """ get_image_unique_id(self) -> str """
        return ""

    def get_iso(self): # real signature unknown; restored from __doc__
        """ get_iso(self) -> int """
        return 0
    ...
    def get_make(self): # real signature unknown; restored from __doc__
        """ get_make(self) -> str """
        return ""
    ...
    def get_video_status(self): # real signature unknown; restored from __doc__
        """ get_video_status(self) -> str """
        return ""
    ...
    def is_commenting_enabled(self): # real signature unknown; restored from __doc__
        """ is_commenting_enabled(self) -> bool """
        return False
    ...
    def set_album_id(self, album_id): # real signature unknown; restored from __doc__
        """ set_album_id(self, album_id:str) """
        pass

    def set_caption(self, caption=None): # real signature unknown; restored from __doc__
        """ set_caption(self, caption:str=None) """
        pass

    def set_checksum(self, checksum=None): # real signature unknown; restored from __doc__
        """ set_checksum(self, checksum:str=None) """
        pass
    ...
    def set_is_commenting_enabled(self, is_commenting_enabled): # real signature unknown; restored from __doc__
        """ set_is_commenting_enabled(self, is_commenting_enabled:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1377af0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PicasaWebFile), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataPicasaWebFile (94233464815488)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_album_id': gi.FunctionInfo(get_album_id), 'get_caption': gi.FunctionInfo(get_caption), 'get_checksum': gi.FunctionInfo(get_checksum), 'get_comment_count': gi.FunctionInfo(get_comment_count), 'get_contents': gi.FunctionInfo(get_contents), 'get_coordinates': gi.FunctionInfo(get_coordinates), 'get_credit': gi.FunctionInfo(get_credit), 'get_distance': gi.FunctionInfo(get_distance), 'get_edited': gi.FunctionInfo(get_edited), 'get_exposure': gi.FunctionInfo(get_exposure), 'get_flash': gi.FunctionInfo(get_flash), 'get_focal_length': gi.FunctionInfo(get_focal_length), 'get_fstop': gi.FunctionInfo(get_fstop), 'get_height': gi.FunctionInfo(get_height), 'get_id': gi.FunctionInfo(get_id), 'get_image_unique_id': gi.FunctionInfo(get_image_unique_id), 'get_iso': gi.FunctionInfo(get_iso), 'get_make': gi.FunctionInfo(get_make), 'get_model': gi.FunctionInfo(get_model), 'get_rotation': gi.FunctionInfo(get_rotation), 'get_size': gi.FunctionInfo(get_size), 'get_tags': gi.FunctionInfo(get_tags), 'get_thumbnails': gi.FunctionInfo(get_thumbnails), 'get_timestamp': gi.FunctionInfo(get_timestamp), 'get_version': gi.FunctionInfo(get_version), 'get_video_status': gi.FunctionInfo(get_video_status), 'get_width': gi.FunctionInfo(get_width), 'is_commenting_enabled': gi.FunctionInfo(is_commenting_enabled), 'set_album_id': gi.FunctionInfo(set_album_id), 'set_caption': gi.FunctionInfo(set_caption), 'set_checksum': gi.FunctionInfo(set_checksum), 'set_coordinates': gi.FunctionInfo(set_coordinates), 'set_is_commenting_enabled': gi.FunctionInfo(set_is_commenting_enabled), 'set_rotation': gi.FunctionInfo(set_rotation), 'set_tags': gi.FunctionInfo(set_tags), 'set_timestamp': gi.FunctionInfo(set_timestamp), 'parent': <property object at 0x7fd5e175d4f0>, 'priv': <property object at 0x7fd5e175d5e0>})"
    __gdoc__ = "Object GDataPicasaWebFile\n\nProperties from GDataPicasaWebFile:\n  edited -> gint64: Edited\n    The time this file was last edited.\n  version -> gchararray: Version\n    The version number of the file.\n  album-id -> gchararray: Album ID\n    The ID for the file's album.\n  width -> guint: Width\n    The width of the photo or video, in pixels.\n  height -> guint: Height\n    The height of the photo or video, in pixels.\n  size -> gulong: Size\n    The size of the file, in bytes.\n  checksum -> gchararray: Checksum\n    A checksum of the file, useful for duplicate detection.\n  timestamp -> gint64: Timestamp\n    The time the file was purportedly taken.\n  is-commenting-enabled -> gboolean: Commenting enabled?\n    Indicates whether comments are enabled.\n  comment-count -> guint: Comment Count\n    The number of comments on the file.\n  rotation -> guint: Rotation\n    The rotation of the photo, in degrees.\n  video-status -> gchararray: Video Status\n    The status of the file, if it is a video.\n  credit -> gchararray: Credit\n    The nickname of the user credited with this file.\n  caption -> gchararray: Caption\n    The file's descriptive caption.\n  tags -> GStrv: Tags\n    A NULL-terminated array of tags associated with the file.\n  distance -> gdouble: Distance\n    The distance to the subject.\n  exposure -> gdouble: Exposure\n    The exposure time.\n  flash -> gboolean: Flash\n    Indicates whether the flash was used.\n  focal-length -> gdouble: Focal Length\n    The focal length used in the shot.\n  fstop -> gdouble: F-stop\n    The F-stop used.\n  image-unique-id -> gchararray: Image Unique ID\n    An unique ID for the image.\n  iso -> glong: ISO\n    The ISO speed.\n  make -> gchararray: Make\n    The name of the manufacturer.\n  model -> gchararray: Model\n    The model of the camera.\n  latitude -> gdouble: Latitude\n    The location as a latitude coordinate associated with this file.\n  longitude -> gdouble: Longitude\n    The location as a longitude coordinate associated with this file.\n  file-id -> gchararray: File ID\n    The ID of the file.\n\nProperties from GDataEntry:\n  title -> gchararray: Title\n    A human-readable title for the entry.\n  summary -> gchararray: Summary\n    A short summary, abstract, or excerpt of the entry.\n  etag -> gchararray: ETag\n    An identifier for a particular version of the entry.\n  id -> gchararray: ID\n    A permanent, universally unique identifier for the entry, in IRI form.\n  updated -> gint64: Updated\n    The date and time when the entry was most recently updated significantly.\n  published -> gint64: Published\n    The date and time the entry was first published or made available.\n  content -> gchararray: Content\n    The content of the entry.\n  is-inserted -> gboolean: Inserted?\n    Whether the entry has been inserted on the server.\n  rights -> gchararray: Rights\n    The ownership rights pertaining to the entry.\n  content-uri -> gchararray: Content URI\n    A URI pointing to the location of the content of the entry.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataPicasaWebFile (94233464815488)>'
    __info__ = ObjectInfo(PicasaWebFile)
