...
class FreebaseTopicResult(FreebaseResult):
    """
    :Constructors:
    
    ::
    
        FreebaseTopicResult(**properties)
        new() -> GData.FreebaseTopicResult
    """
    ...
    def dup_object(self): # real signature unknown; restored from __doc__
        """ dup_object(self) -> GData.FreebaseTopicObject """
        pass
