...
class GContactJot(Parsable):
    """
    :Constructors:
    
    ::
    
        GContactJot(**properties)
        new(content:str, relation_type:str) -> GData.GContactJot
    """
    ...
    def new(self, content, relation_type): # real signature unknown; restored from __doc__
        """ new(content:str, relation_type:str) -> GData.GContactJot """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1377610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GContactJot), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGContactJot (94233464620880)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_content': gi.FunctionInfo(get_content), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'set_content': gi.FunctionInfo(set_content), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'parent': <property object at 0x7fd5e17b2ae0>, 'priv': <property object at 0x7fd5e17b2bd0>})"
    __gdoc__ = 'Object GDataGContactJot\n\nProperties from GDataGContactJot:\n  content -> gchararray: Content\n    The content of the jot.\n  relation-type -> gchararray: Relation type\n    A programmatic value that identifies the type of jot.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGContactJot (94233464620880)>'
    __info__ = ObjectInfo(GContactJot)
