...
class DocumentsPdf(DocumentsDocument):
    """
    :Constructors:
    
    ::
    
        DocumentsPdf(**properties)
        new(id:str=None) -> GData.DocumentsPdf
    """
