...
class GContactExternalID(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        GContactExternalID(**properties)
        new(value:str, relation_type:str=None, label:str=None) -> GData.GContactExternalID
    """
    ...
    def new(self, value, relation_type=None, label=None): # real signature unknown; restored from __doc__
        """ new(value:str, relation_type:str=None, label:str=None) -> GData.GContactExternalID """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e151d640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GContactExternalID), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGContactExternalID (94233464607232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_label': gi.FunctionInfo(get_label), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'get_value': gi.FunctionInfo(get_value), 'set_label': gi.FunctionInfo(set_label), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'set_value': gi.FunctionInfo(set_value), 'parent': <property object at 0x7fd5e17b23b0>, 'priv': <property object at 0x7fd5e17b24a0>})"
    __gdoc__ = 'Object GDataGContactExternalID\n\nProperties from GDataGContactExternalID:\n  value -> gchararray: Value\n    The value of the external ID.\n  relation-type -> gchararray: Relation type\n    A programmatic value that identifies the type of external ID.\n  label -> gchararray: Label\n    A free-form string that identifies the type of external ID.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGContactExternalID (94233464607232)>'
    __info__ = ObjectInfo(GContactExternalID)
