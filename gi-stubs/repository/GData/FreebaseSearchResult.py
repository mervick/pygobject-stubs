...
class FreebaseSearchResult(FreebaseResult):
    """
    :Constructors:
    
    ::
    
        FreebaseSearchResult(**properties)
        new() -> GData.FreebaseSearchResult
    """
    ...
    def get_item(self, i): # real signature unknown; restored from __doc__
        """ get_item(self, i:int) -> GData.FreebaseSearchResultItem or None """
        pass
    ...
    def get_num_items(self): # real signature unknown; restored from __doc__
        """ get_num_items(self) -> int """
        return 0
    ...
    def get_total_hits(self): # real signature unknown; restored from __doc__
        """ get_total_hits(self) -> int """
        return 0
