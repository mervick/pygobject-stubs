...
class CalendarQuery(Query):
    ...
    ::
        ...
        CalendarQuery(**properties)
        new(q:str=None) -> GData.CalendarQuery
        new_with_limits(q:str=None, start_min:int, start_max:int) -> GData.CalendarQuery
    """
    ...
    def get_future_events(self): # real signature unknown; restored from __doc__
        """ get_future_events(self) -> bool """
        return False

    def get_max_attendees(self): # real signature unknown; restored from __doc__
        """ get_max_attendees(self) -> int """
        return 0
    ...
    def get_recurrence_expansion_end(self): # real signature unknown; restored from __doc__
        """ get_recurrence_expansion_end(self) -> int """
        return 0

    def get_recurrence_expansion_start(self): # real signature unknown; restored from __doc__
        """ get_recurrence_expansion_start(self) -> int """
        return 0

    def get_single_events(self): # real signature unknown; restored from __doc__
        """ get_single_events(self) -> bool """
        return False
    ...
    def get_start_max(self): # real signature unknown; restored from __doc__
        """ get_start_max(self) -> int """
        return 0

    def get_start_min(self): # real signature unknown; restored from __doc__
        """ get_start_min(self) -> int """
        return 0
    ...
    def new_with_limits(self, q=None, start_min, start_max): # real signature unknown; restored from __doc__
        """ new_with_limits(q:str=None, start_min:int, start_max:int) -> GData.CalendarQuery """
        pass
    ...
    def set_future_events(self, future_events): # real signature unknown; restored from __doc__
        """ set_future_events(self, future_events:bool) """
        pass
    ...
    def set_max_attendees(self, max_attendees): # real signature unknown; restored from __doc__
        """ set_max_attendees(self, max_attendees:int) """
        pass
    ...
    def set_recurrence_expansion_end(self, end): # real signature unknown; restored from __doc__
        """ set_recurrence_expansion_end(self, end:int) """
        pass

    def set_recurrence_expansion_start(self, start): # real signature unknown; restored from __doc__
        """ set_recurrence_expansion_start(self, start:int) """
        pass
    ...
    def set_single_events(self, single_events): # real signature unknown; restored from __doc__
        """ set_single_events(self, single_events:bool) """
        pass
    ...
    def set_start_max(self, start_max): # real signature unknown; restored from __doc__
        """ set_start_max(self, start_max:int) """
        pass

    def set_start_min(self, start_min): # real signature unknown; restored from __doc__
        """ set_start_min(self, start_min:int) """
        pass

    def set_timezone(self, _timezone=None): # real signature unknown; restored from __doc__
        """ set_timezone(self, _timezone:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e170d610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CalendarQuery), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataCalendarQuery (94233464353600)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_limits': gi.FunctionInfo(new_with_limits), 'get_future_events': gi.FunctionInfo(get_future_events), 'get_max_attendees': gi.FunctionInfo(get_max_attendees), 'get_order_by': gi.FunctionInfo(get_order_by), 'get_recurrence_expansion_end': gi.FunctionInfo(get_recurrence_expansion_end), 'get_recurrence_expansion_start': gi.FunctionInfo(get_recurrence_expansion_start), 'get_single_events': gi.FunctionInfo(get_single_events), 'get_sort_order': gi.FunctionInfo(get_sort_order), 'get_start_max': gi.FunctionInfo(get_start_max), 'get_start_min': gi.FunctionInfo(get_start_min), 'get_timezone': gi.FunctionInfo(get_timezone), 'set_future_events': gi.FunctionInfo(set_future_events), 'set_max_attendees': gi.FunctionInfo(set_max_attendees), 'set_order_by': gi.FunctionInfo(set_order_by), 'set_recurrence_expansion_end': gi.FunctionInfo(set_recurrence_expansion_end), 'set_recurrence_expansion_start': gi.FunctionInfo(set_recurrence_expansion_start), 'set_show_deleted': gi.FunctionInfo(set_show_deleted), 'set_single_events': gi.FunctionInfo(set_single_events), 'set_sort_order': gi.FunctionInfo(set_sort_order), 'set_start_max': gi.FunctionInfo(set_start_max), 'set_start_min': gi.FunctionInfo(set_start_min), 'set_timezone': gi.FunctionInfo(set_timezone), 'show_deleted': gi.FunctionInfo(show_deleted), 'parent': <property object at 0x7fd5e1775db0>, 'priv': <property object at 0x7fd5e1775ea0>})"
    __gdoc__ = 'Object GDataCalendarQuery\n\nProperties from GDataCalendarQuery:\n  future-events -> gboolean: Future events?\n    A shortcut to request all events scheduled for the future.\n  order-by -> gchararray: Order by\n    Specifies order of entries in a feed.\n  recurrence-expansion-start -> gint64: Recurrence expansion start\n    Specifies start of period to expand recurrences for.\n  recurrence-expansion-end -> gint64: Recurrence expansion end\n    Specifies end of period to expand recurrences for.\n  single-events -> gboolean: Single events?\n    Indicates whether recurring events should be expanded.\n  sort-order -> gchararray: Sort order\n    Specifies direction of sorting.\n  start-min -> gint64: Start min\n    A timespan such that only events within the timespan are returned.\n  start-max -> gint64: Start max\n    A timespan such that only events within the timespan are returned.\n  timezone -> gchararray: Timezone\n    The current timezone.\n  max-attendees -> guint: Max attendee count\n    Specifies the maximum number of attendees to list for an event.\n  show-deleted -> gboolean: Show deleted?\n    Whether to include deleted/cancelled events in the query feed.\n\nProperties from GDataQuery:\n  q -> gchararray: Query terms\n    Query terms for which to search.\n  categories -> gchararray: Category string\n    Category search string.\n  author -> gchararray: Author\n    Author search string.\n  updated-min -> gint64: Minimum update date\n    Minimum date for updates on returned entries.\n  updated-max -> gint64: Maximum update date\n    Maximum date for updates on returned entries.\n  published-min -> gint64: Minimum publish date\n    Minimum date for returned entries to be published.\n  published-max -> gint64: Maximum publish date\n    Maximum date for returned entries to be published.\n  start-index -> guint: Start index\n    One-based result start index.\n  is-strict -> gboolean: Strict?\n    Should the server be strict about the query?\n  max-results -> guint: Maximum number of results\n    The maximum number of entries to return.\n  etag -> gchararray: ETag\n    An ETag against which to check.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataCalendarQuery (94233464353600)>'
    __info__ = ObjectInfo(CalendarQuery)
