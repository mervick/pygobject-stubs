...
class GoaAuthorizerClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(GoaAuthorizerClass), '__module__': 'gi.repository.GData', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'GoaAuthorizerClass' objects>, '__weakref__': <attribute '__weakref__' of 'GoaAuthorizerClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fd5e174a130>, '_g_reserved0': <property object at 0x7fd5e174a220>, '_g_reserved1': <property object at 0x7fd5e174a310>})"
