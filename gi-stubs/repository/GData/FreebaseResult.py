...
class FreebaseResult(Entry):
    """
    :Constructors:
    
    ::
    
        FreebaseResult(**properties)
        new() -> GData.FreebaseResult
    """
