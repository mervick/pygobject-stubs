...
class DocumentsQuery(Query):
    ...
    ::
        ...
        DocumentsQuery(**properties)
        new(q:str=None) -> GData.DocumentsQuery
        new_with_limits(q:str=None, start_index:int, max_results:int) -> GData.DocumentsQuery
    """
    def add_collaborator(self, email_address): # real signature unknown; restored from __doc__
        """ add_collaborator(self, email_address:str) """
        pass

    def add_reader(self, email_address): # real signature unknown; restored from __doc__
        """ add_reader(self, email_address:str) """
        pass
    ...
    def get_collaborator_addresses(self): # real signature unknown; restored from __doc__
        """ get_collaborator_addresses(self) -> list """
        return []
    ...
    def get_exact_title(self): # real signature unknown; restored from __doc__
        """ get_exact_title(self) -> bool """
        return False

    def get_folder_id(self): # real signature unknown; restored from __doc__
        """ get_folder_id(self) -> str """
        return ""
    ...
    def get_reader_addresses(self): # real signature unknown; restored from __doc__
        """ get_reader_addresses(self) -> list """
        return []
    ...
    def set_folder_id(self, folder_id=None): # real signature unknown; restored from __doc__
        """ set_folder_id(self, folder_id:str=None) """
        pass
    ...
    def set_show_folders(self, show_folders): # real signature unknown; restored from __doc__
        """ set_show_folders(self, show_folders:bool) """
        pass
    ...
    def set_title(self, title=None, exact_title): # real signature unknown; restored from __doc__
        """ set_title(self, title:str=None, exact_title:bool) """
        pass
    ...
    def show_folders(self): # real signature unknown; restored from __doc__
        """ show_folders(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e15901c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DocumentsQuery), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataDocumentsQuery (94233464478416)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_limits': gi.FunctionInfo(new_with_limits), 'add_collaborator': gi.FunctionInfo(add_collaborator), 'add_reader': gi.FunctionInfo(add_reader), 'get_collaborator_addresses': gi.FunctionInfo(get_collaborator_addresses), 'get_exact_title': gi.FunctionInfo(get_exact_title), 'get_folder_id': gi.FunctionInfo(get_folder_id), 'get_reader_addresses': gi.FunctionInfo(get_reader_addresses), 'get_title': gi.FunctionInfo(get_title), 'set_folder_id': gi.FunctionInfo(set_folder_id), 'set_show_deleted': gi.FunctionInfo(set_show_deleted), 'set_show_folders': gi.FunctionInfo(set_show_folders), 'set_title': gi.FunctionInfo(set_title), 'show_deleted': gi.FunctionInfo(show_deleted), 'show_folders': gi.FunctionInfo(show_folders), 'parent': <property object at 0x7fd5e1799220>, 'priv': <property object at 0x7fd5e1799310>})"
    __gdoc__ = 'Object GDataDocumentsQuery\n\nProperties from GDataDocumentsQuery:\n  show-deleted -> gboolean: Show deleted?\n    A shortcut to request all documents that have been deleted.\n  show-folders -> gboolean: Show folders?\n    Specifies if the request also returns folders.\n  exact-title -> gboolean: Exact title?\n    Specifies whether the query should search for an exact title match.\n  folder-id -> gchararray: Folder ID\n    Specifies the ID of the folder in which to search.\n  title -> gchararray: Title\n    A title (or title fragment) to be searched for.\n\nProperties from GDataQuery:\n  q -> gchararray: Query terms\n    Query terms for which to search.\n  categories -> gchararray: Category string\n    Category search string.\n  author -> gchararray: Author\n    Author search string.\n  updated-min -> gint64: Minimum update date\n    Minimum date for updates on returned entries.\n  updated-max -> gint64: Maximum update date\n    Maximum date for updates on returned entries.\n  published-min -> gint64: Minimum publish date\n    Minimum date for returned entries to be published.\n  published-max -> gint64: Maximum publish date\n    Maximum date for returned entries to be published.\n  start-index -> guint: Start index\n    One-based result start index.\n  is-strict -> gboolean: Strict?\n    Should the server be strict about the query?\n  max-results -> guint: Maximum number of results\n    The maximum number of entries to return.\n  etag -> gchararray: ETag\n    An ETag against which to check.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataDocumentsQuery (94233464478416)>'
    __info__ = ObjectInfo(DocumentsQuery)
