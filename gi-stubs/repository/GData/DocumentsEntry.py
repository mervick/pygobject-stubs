...
class DocumentsEntry(Entry, AccessHandler):
    """
    :Constructors:
    
    ::
    
        DocumentsEntry(**properties)
    """
    ...
    def add_documents_property(self, property): # real signature unknown; restored from __doc__
        """ add_documents_property(self, property:GData.DocumentsProperty) -> bool """
        return False
    ...
    def get_document_id(self): # real signature unknown; restored from __doc__
        """ get_document_id(self) -> str """
        return ""

    def get_document_properties(self): # real signature unknown; restored from __doc__
        """ get_document_properties(self) -> list """
        return []
    ...
    def get_file_size(self): # real signature unknown; restored from __doc__
    ...
    def get_last_modified_by(self): # real signature unknown; restored from __doc__
        """ get_last_modified_by(self) -> GData.Author """
        pass

    def get_last_viewed(self): # real signature unknown; restored from __doc__
        """ get_last_viewed(self) -> int """
        return 0
    ...
    def get_quota_used(self): # real signature unknown; restored from __doc__
        """ get_quota_used(self) -> int """
        return 0

    def get_resource_id(self): # real signature unknown; restored from __doc__
        """ get_resource_id(self) -> str """
        return ""
    ...
    def remove_documents_property(self, property): # real signature unknown; restored from __doc__
        """ remove_documents_property(self, property:GData.DocumentsProperty) -> bool """
        return False
    ...
    def set_writers_can_invite(self, writers_can_invite): # real signature unknown; restored from __doc__
        """ set_writers_can_invite(self, writers_can_invite:bool) """
        pass
    ...
    def writers_can_invite(self): # real signature unknown; restored from __doc__
        """ writers_can_invite(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e2357b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DocumentsEntry), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataDocumentsEntry (94233464311792)>, '__doc__': None, '__gsignals__': {}, 'add_documents_property': gi.FunctionInfo(add_documents_property), 'get_document_id': gi.FunctionInfo(get_document_id), 'get_document_properties': gi.FunctionInfo(get_document_properties), 'get_edited': gi.FunctionInfo(get_edited), 'get_file_size': gi.FunctionInfo(get_file_size), 'get_last_modified_by': gi.FunctionInfo(get_last_modified_by), 'get_last_viewed': gi.FunctionInfo(get_last_viewed), 'get_path': gi.FunctionInfo(get_path), 'get_quota_used': gi.FunctionInfo(get_quota_used), 'get_resource_id': gi.FunctionInfo(get_resource_id), 'is_deleted': gi.FunctionInfo(is_deleted), 'remove_documents_property': gi.FunctionInfo(remove_documents_property), 'set_writers_can_invite': gi.FunctionInfo(set_writers_can_invite), 'writers_can_invite': gi.FunctionInfo(writers_can_invite), 'parent': <property object at 0x7fd5e178bdb0>, 'priv': <property object at 0x7fd5e178bea0>})"
    __gdoc__ = 'Object GDataDocumentsEntry\n\nProperties from GDataDocumentsEntry:\n  edited -> gint64: Edited\n    The last time the document was edited.\n  last-viewed -> gint64: Last viewed\n    The last time the document was viewed.\n  document-id -> gchararray: Document ID\n    The document ID of the document.\n  last-modified-by -> GDataAuthor: Last modified by\n    Indicates the author of the last modification.\n  is-deleted -> gboolean: Deleted?\n    Indicates whether the document entry has been deleted.\n  writers-can-invite -> gboolean: Writers can invite?\n    Indicates whether writers can invite others to edit.\n  resource-id -> gchararray: Resource ID\n    The resource ID of the document.\n  quota-used -> gint64: Quota used\n    The amount of user quota the document is occupying.\n  file-size -> gint64: File size\n    The size of the document.\n\nProperties from GDataEntry:\n  title -> gchararray: Title\n    A human-readable title for the entry.\n  summary -> gchararray: Summary\n    A short summary, abstract, or excerpt of the entry.\n  etag -> gchararray: ETag\n    An identifier for a particular version of the entry.\n  id -> gchararray: ID\n    A permanent, universally unique identifier for the entry, in IRI form.\n  updated -> gint64: Updated\n    The date and time when the entry was most recently updated significantly.\n  published -> gint64: Published\n    The date and time the entry was first published or made available.\n  content -> gchararray: Content\n    The content of the entry.\n  is-inserted -> gboolean: Inserted?\n    Whether the entry has been inserted on the server.\n  rights -> gchararray: Rights\n    The ownership rights pertaining to the entry.\n  content-uri -> gchararray: Content URI\n    A URI pointing to the location of the content of the entry.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataDocumentsEntry (94233464311792)>'
    __info__ = ObjectInfo(DocumentsEntry)
