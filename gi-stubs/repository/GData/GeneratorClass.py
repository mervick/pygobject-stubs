...
class GeneratorClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(GeneratorClass), '__module__': 'gi.repository.GData', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'GeneratorClass' objects>, '__weakref__': <attribute '__weakref__' of 'GeneratorClass' objects>, '__doc__': None, 'parent': <property object at 0x7fd5e17459a0>, '_g_reserved0': <property object at 0x7fd5e1745a90>, '_g_reserved1': <property object at 0x7fd5e1745b80>})"
