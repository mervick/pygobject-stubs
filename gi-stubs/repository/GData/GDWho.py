...
class GDWho(Parsable, Comparable):
    """
    :Constructors:
    ...
    ::
        ...
        GDWho(**properties)
        new(relation_type:str=None, value_string:str=None, email_address:str=None) -> GData.GDWho
    """
    ...
    def new(self, relation_type=None, value_string=None, email_address=None): # real signature unknown; restored from __doc__
        """ new(relation_type:str=None, value_string:str=None, email_address:str=None) -> GData.GDWho """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1365100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GDWho), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGDWho (94233464695600)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_email_address': gi.FunctionInfo(get_email_address), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'get_value_string': gi.FunctionInfo(get_value_string), 'set_email_address': gi.FunctionInfo(set_email_address), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'set_value_string': gi.FunctionInfo(set_value_string), 'parent': <property object at 0x7fd5e1743f90>, 'priv': <property object at 0x7fd5e17450e0>})"
    __gdoc__ = 'Object GDataGDWho\n\nProperties from GDataGDWho:\n  relation-type -> gchararray: Relation type\n    Specifies the relationship between the container and the containee.\n  value-string -> gchararray: Value string\n    A simple string representation of this person.\n  email-address -> gchararray: E-mail address\n    The e-mail address of the person represented by the #GDataGDWho.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGDWho (94233464695600)>'
    __info__ = ObjectInfo(GDWho)
