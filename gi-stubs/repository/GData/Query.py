...
class Query(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e16e1f70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Query), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataQuery (94233464353232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_limits': gi.FunctionInfo(new_with_limits), 'get_author': gi.FunctionInfo(get_author), 'get_categories': gi.FunctionInfo(get_categories), 'get_etag': gi.FunctionInfo(get_etag), 'get_max_results': gi.FunctionInfo(get_max_results), 'get_published_max': gi.FunctionInfo(get_published_max), 'get_published_min': gi.FunctionInfo(get_published_min), 'get_q': gi.FunctionInfo(get_q), 'get_query_uri': gi.FunctionInfo(get_query_uri), 'get_start_index': gi.FunctionInfo(get_start_index), 'get_updated_max': gi.FunctionInfo(get_updated_max), 'get_updated_min': gi.FunctionInfo(get_updated_min), 'is_strict': gi.FunctionInfo(is_strict), 'next_page': gi.FunctionInfo(next_page), 'previous_page': gi.FunctionInfo(previous_page), 'set_author': gi.FunctionInfo(set_author), 'set_categories': gi.FunctionInfo(set_categories), 'set_etag': gi.FunctionInfo(set_etag), 'set_is_strict': gi.FunctionInfo(set_is_strict), 'set_max_results': gi.FunctionInfo(set_max_results), 'set_published_max': gi.FunctionInfo(set_published_max), 'set_published_min': gi.FunctionInfo(set_published_min), 'set_q': gi.FunctionInfo(set_q), 'set_start_index': gi.FunctionInfo(set_start_index), 'set_updated_max': gi.FunctionInfo(set_updated_max), 'set_updated_min': gi.FunctionInfo(set_updated_min), 'do_get_query_uri': gi.VFuncInfo(get_query_uri), 'parent': <property object at 0x7fd5e17757c0>, 'priv': <property object at 0x7fd5e17758b0>})"
    __gdoc__ = 'Object GDataQuery\n\nProperties from GDataQuery:\n  q -> gchararray: Query terms\n    Query terms for which to search.\n  categories -> gchararray: Category string\n    Category search string.\n  author -> gchararray: Author\n    Author search string.\n  updated-min -> gint64: Minimum update date\n    Minimum date for updates on returned entries.\n  updated-max -> gint64: Maximum update date\n    Maximum date for updates on returned entries.\n  published-min -> gint64: Minimum publish date\n    Minimum date for returned entries to be published.\n  published-max -> gint64: Maximum publish date\n    Maximum date for returned entries to be published.\n  start-index -> guint: Start index\n    One-based result start index.\n  is-strict -> gboolean: Strict?\n    Should the server be strict about the query?\n  max-results -> guint: Maximum number of results\n    The maximum number of entries to return.\n  etag -> gchararray: ETag\n    An ETag against which to check.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataQuery (94233464353232)>'
    __info__ = ObjectInfo(Query)
