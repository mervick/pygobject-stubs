...
class CalendarCalendar(Entry, AccessHandler):
    """
    :Constructors:
    
    ::
    
        CalendarCalendar(**properties)
        new(id:str=None) -> GData.CalendarCalendar
    """
    ...
    def get_access_level(self): # real signature unknown; restored from __doc__
        """ get_access_level(self) -> str """
        return ""
    ...
    def get_color(self): # real signature unknown; restored from __doc__
        """ get_color(self) -> color:GData.Color """
        pass
    ...
    def set_color(self, color): # real signature unknown; restored from __doc__
        """ set_color(self, color:GData.Color) """
        pass
    ...
    def set_is_selected(self, is_selected): # real signature unknown; restored from __doc__
        """ set_is_selected(self, is_selected:bool) """
        pass
