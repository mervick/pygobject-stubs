...
class PicasaWebComment(Comment):
    """
    :Constructors:
    
    ::
    
        PicasaWebComment(**properties)
        new(id:str) -> GData.PicasaWebComment
    """
