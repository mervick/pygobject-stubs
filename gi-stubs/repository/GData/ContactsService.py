...
class ContactsService(Service, Batchable):
    """
    :Constructors:
    
    ::
    
        ContactsService(**properties)
        new(authorizer:GData.Authorizer=None) -> GData.ContactsService
    """
    ...
    def insert_contact(self, contact, cancellable=None): # real signature unknown; restored from __doc__
        """ insert_contact(self, contact:GData.ContactsContact, cancellable:Gio.Cancellable=None) -> GData.ContactsContact """
        pass

    def insert_contact_async(self, contact, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ insert_contact_async(self, contact:GData.ContactsContact, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def insert_group(self, group, cancellable=None): # real signature unknown; restored from __doc__
        """ insert_group(self, group:GData.ContactsGroup, cancellable:Gio.Cancellable=None) -> GData.ContactsGroup """
        pass

    def insert_group_async(self, group, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ insert_group_async(self, group:GData.ContactsGroup, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def query_contacts(self, query=None, cancellable=None, progress_callback=None, progress_user_data=None): # real signature unknown; restored from __doc__
        """ query_contacts(self, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None) -> GData.Feed """
        pass

    def query_contacts_async(self, query=None, cancellable=None, progress_callback=None, progress_user_data=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ query_contacts_async(self, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def query_groups(self, query=None, cancellable=None, progress_callback=None, progress_user_data=None): # real signature unknown; restored from __doc__
        """ query_groups(self, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None) -> GData.Feed """
        pass

    def query_groups_async(self, query=None, cancellable=None, progress_callback=None, progress_user_data=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ query_groups_async(self, query:GData.Query=None, cancellable:Gio.Cancellable=None, progress_callback:GData.QueryProgressCallback=None, progress_user_data=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e16e1280>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ContactsService), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataContactsService (94233464417120)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_primary_authorization_domain': gi.FunctionInfo(get_primary_authorization_domain), 'insert_contact': gi.FunctionInfo(insert_contact), 'insert_contact_async': gi.FunctionInfo(insert_contact_async), 'insert_group': gi.FunctionInfo(insert_group), 'insert_group_async': gi.FunctionInfo(insert_group_async), 'query_contacts': gi.FunctionInfo(query_contacts), 'query_contacts_async': gi.FunctionInfo(query_contacts_async), 'query_groups': gi.FunctionInfo(query_groups), 'query_groups_async': gi.FunctionInfo(query_groups_async), 'parent': <property object at 0x7fd5e1789c70>})"
    __gdoc__ = 'Object GDataContactsService\n\nProperties from GDataService:\n  proxy-uri -> SoupURI: Proxy URI\n    The proxy URI used internally for all network requests.\n  timeout -> guint: Timeout\n    A timeout, in seconds, for network operations.\n  locale -> gchararray: Locale\n    The locale to use for network requests, in Unix locale format.\n  authorizer -> GDataAuthorizer: Authorizer\n    An authorizer object to provide an authorization token for each request.\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    A GProxyResolver used to determine a proxy URI.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataContactsService (94233464417120)>'
    __info__ = ObjectInfo(ContactsService)
