...
class GContactWebsite(Parsable, Comparable):
    """
    :Constructors:
    
    ::
    
        GContactWebsite(**properties)
        new(uri:str, relation_type:str, label:str=None, is_primary:bool) -> GData.GContactWebsite
    """
    ...
    def new(self, uri, relation_type, label=None, is_primary): # real signature unknown; restored from __doc__
        """ new(uri:str, relation_type:str, label:str=None, is_primary:bool) -> GData.GContactWebsite """
        pass
    ...
    def set_relation_type(self, relation_type): # real signature unknown; restored from __doc__
        """ set_relation_type(self, relation_type:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e134e490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GContactWebsite), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGContactWebsite (94233464640432)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_label': gi.FunctionInfo(get_label), 'get_relation_type': gi.FunctionInfo(get_relation_type), 'get_uri': gi.FunctionInfo(get_uri), 'is_primary': gi.FunctionInfo(is_primary), 'set_is_primary': gi.FunctionInfo(set_is_primary), 'set_label': gi.FunctionInfo(set_label), 'set_relation_type': gi.FunctionInfo(set_relation_type), 'set_uri': gi.FunctionInfo(set_uri), 'parent': <property object at 0x7fd5e1738130>, 'priv': <property object at 0x7fd5e1738220>})"
    __gdoc__ = 'Object GDataGContactWebsite\n\nProperties from GDataGContactWebsite:\n  uri -> gchararray: URI\n    The URI of the website.\n  relation-type -> gchararray: Relation type\n    A programmatic value that identifies the type of website.\n  label -> gchararray: Label\n    A simple string value used to name this website.\n  is-primary -> gboolean: Primary?\n    Indicates which website out of a group is primary.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGContactWebsite (94233464640432)>'
    __info__ = ObjectInfo(GContactWebsite)
