...
class GDWhen(Parsable, Comparable):
    """
    :Constructors:
    ...
    ::
        ...
        GDWhen(**properties)
        new(start_time:int, end_time:int, is_date:bool) -> GData.GDWhen
    """
    def add_reminder(self, reminder): # real signature unknown; restored from __doc__
        """ add_reminder(self, reminder:GData.GDReminder) """
        pass
    ...
    def get_reminders(self): # real signature unknown; restored from __doc__
        """ get_reminders(self) -> list """
        return []
    ...
    def get_value_string(self): # real signature unknown; restored from __doc__
        """ get_value_string(self) -> str """
        return ""
    ...
    def new(self, start_time, end_time, is_date): # real signature unknown; restored from __doc__
        """ new(start_time:int, end_time:int, is_date:bool) -> GData.GDWhen """
        pass
    ...
    def set_end_time(self, end_time): # real signature unknown; restored from __doc__
        """ set_end_time(self, end_time:int) """
        pass
    ...
    def set_start_time(self, start_time): # real signature unknown; restored from __doc__
        """ set_start_time(self, start_time:int) """
        pass

    def set_value_string(self, value_string=None): # real signature unknown; restored from __doc__
        """ set_value_string(self, value_string:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e134e760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GDWhen), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataGDWhen (94233464676096)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_reminder': gi.FunctionInfo(add_reminder), 'get_end_time': gi.FunctionInfo(get_end_time), 'get_reminders': gi.FunctionInfo(get_reminders), 'get_start_time': gi.FunctionInfo(get_start_time), 'get_value_string': gi.FunctionInfo(get_value_string), 'is_date': gi.FunctionInfo(is_date), 'set_end_time': gi.FunctionInfo(set_end_time), 'set_is_date': gi.FunctionInfo(set_is_date), 'set_start_time': gi.FunctionInfo(set_start_time), 'set_value_string': gi.FunctionInfo(set_value_string), 'parent': <property object at 0x7fd5e1743130>, 'priv': <property object at 0x7fd5e1743220>})"
    __gdoc__ = 'Object GDataGDWhen\n\nProperties from GDataGDWhen:\n  start-time -> gint64: Start time\n    The name of the when.\n  end-time -> gint64: End time\n    The title of a person within the when.\n  is-date -> gboolean: Date?\n    A programmatic value that identifies the type of when.\n  value-string -> gchararray: Value string\n    A simple string value used to name this when.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataGDWhen (94233464676096)>'
    __info__ = ObjectInfo(GDWhen)
