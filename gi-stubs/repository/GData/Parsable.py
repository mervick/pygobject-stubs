...
class Parsable(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e170d310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Parsable), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataParsable (94233464144016)>, '__doc__': None, '__gsignals__': {}, 'new_from_json': gi.FunctionInfo(new_from_json), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'get_content_type': gi.FunctionInfo(get_content_type), 'get_json': gi.FunctionInfo(get_json), 'get_xml': gi.FunctionInfo(get_xml), 'do_get_json': gi.VFuncInfo(get_json), 'do_get_namespaces': gi.VFuncInfo(get_namespaces), 'do_get_xml': gi.VFuncInfo(get_xml), 'do_parse_json': gi.VFuncInfo(parse_json), 'do_parse_xml': gi.VFuncInfo(parse_xml), 'do_post_parse_json': gi.VFuncInfo(post_parse_json), 'do_post_parse_xml': gi.VFuncInfo(post_parse_xml), 'do_pre_get_xml': gi.VFuncInfo(pre_get_xml), 'do_pre_parse_xml': gi.VFuncInfo(pre_parse_xml), 'parent': <property object at 0x7fd5e2379220>, 'priv': <property object at 0x7fd5e2379270>})"
    __gdoc__ = 'Object GDataParsable\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataParsable (94233464144016)>'
    __info__ = ObjectInfo(Parsable)
