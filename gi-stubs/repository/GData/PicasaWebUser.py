...
class PicasaWebUser(Entry):
    """
    :Constructors:
    
    ::
    
        PicasaWebUser(**properties)
    """
    ...
    def get_max_photos_per_album(self): # real signature unknown; restored from __doc__
        """ get_max_photos_per_album(self) -> int """
        return 0
    ...
    def get_quota_current(self): # real signature unknown; restored from __doc__
        """ get_quota_current(self) -> int """
        return 0

    def get_quota_limit(self): # real signature unknown; restored from __doc__
        """ get_quota_limit(self) -> int """
        return 0
