...
class MediaCategory(Parsable):
    ...
    ::
        ...
        new(category:str, scheme:str=None, label:str=None) -> GData.MediaCategory
    """
    ...
    def new(self, category, scheme=None, label=None): # real signature unknown; restored from __doc__
        """ new(category:str, scheme:str=None, label:str=None) -> GData.MediaCategory """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fd5e1365190>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaCategory), '__module__': 'gi.repository.GData', '__gtype__': <GType GDataMediaCategory (94233464515696)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_category': gi.FunctionInfo(get_category), 'get_label': gi.FunctionInfo(get_label), 'get_scheme': gi.FunctionInfo(get_scheme), 'set_category': gi.FunctionInfo(set_category), 'set_label': gi.FunctionInfo(set_label), 'set_scheme': gi.FunctionInfo(set_scheme), 'parent': <property object at 0x7fd5e174ad60>, 'priv': <property object at 0x7fd5e174ae50>})"
    __gdoc__ = 'Object GDataMediaCategory\n\nProperties from GDataMediaCategory:\n  category -> gchararray: Category\n    The category name.\n  scheme -> gchararray: Scheme\n    A URI that identifies the categorization scheme.\n  label -> gchararray: Label\n    A human-readable label that can be displayed in end-user applications.\n\nProperties from GDataParsable:\n  constructed-from-xml -> gboolean: Constructed from XML?\n    Specifies whether the object was constructed by parsing XML or manually.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataMediaCategory (94233464515696)>'
    __info__ = ObjectInfo(MediaCategory)
