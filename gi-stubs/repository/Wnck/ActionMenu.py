...
class ActionMenu(__gi_overrides_Gtk.Menu):
    """
    :Constructors:
    ...
    ::
        ...
        new(window:Wnck.Window) -> Gtk.Widget
    """
    ...
    def new(self, window): # real signature unknown; restored from __doc__
        """ new(window:Wnck.Window) -> Gtk.Widget """
        pass
