...
class ImageMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    def make_label_bold(self): # real signature unknown; restored from __doc__
        """ make_label_bold(self) """
        pass

    def make_label_normal(self): # real signature unknown; restored from __doc__
        """ make_label_normal(self) """
        pass
    ...
    def set_image_from_icon_pixbuf(self, pixbuf): # real signature unknown; restored from __doc__
        """ set_image_from_icon_pixbuf(self, pixbuf:GdkPixbuf.Pixbuf) """
        pass

    def set_image_from_window(self, window): # real signature unknown; restored from __doc__
        """ set_image_from_window(self, window:Wnck.Window) """
        pass
