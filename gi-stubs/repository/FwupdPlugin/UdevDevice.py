...
class UdevDevice(Device):
    ...
    ::
        ...
        UdevDevice(**properties)
        new(udev_device:GObject.Object) -> FwupdPlugin.UdevDevice
    """
    ...
    def emit_changed(self): # real signature unknown; restored from __doc__
        """ emit_changed(self) """
        pass
    ...
    def get_dev(self): # real signature unknown; restored from __doc__
        """ get_dev(self) -> GObject.Object """
        pass

    def get_device_file(self): # real signature unknown; restored from __doc__
        """ get_device_file(self) -> str """
        return ""
    ...
    def get_slot_depth(self, subsystem): # real signature unknown; restored from __doc__
        """ get_slot_depth(self, subsystem:str) -> int """
        return 0
    ...
    def get_subsystem(self): # real signature unknown; restored from __doc__
        """ get_subsystem(self) -> str """
        return ""
    ...
    def get_sysfs_path(self): # real signature unknown; restored from __doc__
        """ get_sysfs_path(self) -> str """
        return ""
    ...
    def ioctl(self, request, buf): # real signature unknown; restored from __doc__
        """ ioctl(self, request:int, buf:int) -> bool, rc:int """
        return False
    ...
    def new(self, udev_device): # real signature unknown; restored from __doc__
        """ new(udev_device:GObject.Object) -> FwupdPlugin.UdevDevice """
        pass
    ...
    def pread(self, port): # real signature unknown; restored from __doc__
        """ pread(self, port:int) -> bool, data:int """
        return False
    ...
    def pwrite(self, port, data): # real signature unknown; restored from __doc__
        """ pwrite(self, port:int, data:int) -> bool """
        return False
    ...
    def set_fd(self, fd): # real signature unknown; restored from __doc__
        """ set_fd(self, fd:int) """
        pass
    ...
    def set_flags(self, flags): # real signature unknown; restored from __doc__
        """ set_flags(self, flags:FwupdPlugin.UdevDeviceFlags) """
        pass
    ...
    def set_physical_id(self, subsystems): # real signature unknown; restored from __doc__
        """ set_physical_id(self, subsystems:str) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feb1a3624f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UdevDevice), '__module__': 'gi.repository.FwupdPlugin', '__gtype__': <GType void (4)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'emit_changed': gi.FunctionInfo(emit_changed), 'get_dev': gi.FunctionInfo(get_dev), 'get_device_file': gi.FunctionInfo(get_device_file), 'get_fd': gi.FunctionInfo(get_fd), 'get_model': gi.FunctionInfo(get_model), 'get_revision': gi.FunctionInfo(get_revision), 'get_slot_depth': gi.FunctionInfo(get_slot_depth), 'get_subsystem': gi.FunctionInfo(get_subsystem), 'get_sysfs_path': gi.FunctionInfo(get_sysfs_path), 'get_vendor': gi.FunctionInfo(get_vendor), 'ioctl': gi.FunctionInfo(ioctl), 'pread': gi.FunctionInfo(pread), 'pwrite': gi.FunctionInfo(pwrite), 'set_fd': gi.FunctionInfo(set_fd), 'set_flags': gi.FunctionInfo(set_flags), 'set_physical_id': gi.FunctionInfo(set_physical_id), 'set_readonly': gi.FunctionInfo(set_readonly), 'do_close': gi.VFuncInfo(close), 'do_open': gi.VFuncInfo(open), 'do_probe': gi.VFuncInfo(probe), 'parent_instance': <property object at 0x7feb1a35eea0>})"
    __gdoc__ = 'void\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = ObjectInfo(UdevDevice)
