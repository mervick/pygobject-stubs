...
class DfuFirmware(Firmware):
    """
    :Constructors:
    
    ::
    
        DfuFirmware(**properties)
    ...
    def set_vid(self, vid): # real signature unknown; restored from __doc__
        """ set_vid(self, vid:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feb1a2ea490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DfuFirmware), '__module__': 'gi.repository.FwupdPlugin', '__gtype__': <GType void (4)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_pid': gi.FunctionInfo(get_pid), 'get_release': gi.FunctionInfo(get_release), 'get_version': gi.FunctionInfo(get_version), 'get_vid': gi.FunctionInfo(get_vid), 'set_pid': gi.FunctionInfo(set_pid), 'set_release': gi.FunctionInfo(set_release), 'set_version': gi.FunctionInfo(set_version), 'set_vid': gi.FunctionInfo(set_vid), 'parent_instance': <property object at 0x7feb1afdf3b0>})"
    __gdoc__ = 'void\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = ObjectInfo(DfuFirmware)
