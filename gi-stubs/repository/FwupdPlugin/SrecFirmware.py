...
class SrecFirmware(Firmware):
    """
    :Constructors:
    
    ::
    
        SrecFirmware(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feb1a2eaee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SrecFirmware), '__module__': 'gi.repository.FwupdPlugin', '__gtype__': <GType void (4)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_records': gi.FunctionInfo(get_records)})"
    __gdoc__ = 'void\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = ObjectInfo(SrecFirmware)
