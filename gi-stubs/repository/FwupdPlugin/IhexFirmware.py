...
class IhexFirmware(Firmware):
    """
    :Constructors:
    
    ::
    
        IhexFirmware(**properties)
    ...
    def get_records(self): # real signature unknown; restored from __doc__
        """ get_records(self) -> list """
        return []
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feb1afab5b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IhexFirmware), '__module__': 'gi.repository.FwupdPlugin', '__gtype__': <GType void (4)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_records': gi.FunctionInfo(get_records)})"
    __gdoc__ = 'void\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = ObjectInfo(IhexFirmware)
