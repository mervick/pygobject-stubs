...
class UsbDevice(Device):
    ...
    ::
        ...
        new(usb_device:GUsb.Device) -> FwupdPlugin.UsbDevice
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feb1a3629d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UsbDevice), '__module__': 'gi.repository.FwupdPlugin', '__gtype__': <GType void (4)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'find_udev_device': gi.FunctionInfo(find_udev_device), 'get_dev': gi.FunctionInfo(get_dev), 'get_pid': gi.FunctionInfo(get_pid), 'get_platform_id': gi.FunctionInfo(get_platform_id), 'get_spec': gi.FunctionInfo(get_spec), 'get_vid': gi.FunctionInfo(get_vid), 'is_open': gi.FunctionInfo(is_open), 'set_dev': gi.FunctionInfo(set_dev), 'do_close': gi.VFuncInfo(close), 'do_open': gi.VFuncInfo(open), 'do_probe': gi.VFuncInfo(probe), 'parent_instance': <property object at 0x7feb1afe2cc0>})"
    __gdoc__ = 'void\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = ObjectInfo(UsbDevice)
