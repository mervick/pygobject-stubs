# encoding: utf-8
# module gi.repository.DbusmenuGtk3
# from /usr/lib64/girepository-1.0/DbusmenuGtk3-0.4.typelib
# by generator 1.147
"""
...
import gi.repository.Dbusmenu as __gi_repository_Dbusmenu
...
def gtk_parse_get_cached_item(widget): # real signature unknown; restored from __doc__
    """ gtk_parse_get_cached_item(widget:Gtk.Widget) -> Dbusmenu.Menuitem """
    pass

def gtk_parse_menu_structure(widget): # real signature unknown; restored from __doc__
    """ gtk_parse_menu_structure(widget:Gtk.Widget) -> Dbusmenu.Menuitem """
    pass

def menuitem_property_get_image(menuitem, property): # real signature unknown; restored from __doc__
    """ menuitem_property_get_image(menuitem:Dbusmenu.Menuitem, property:str) -> GdkPixbuf.Pixbuf """
    pass

def menuitem_property_get_shortcut(menuitem): # real signature unknown; restored from __doc__
    """ menuitem_property_get_shortcut(menuitem:Dbusmenu.Menuitem) -> key:int, modifier:Gdk.ModifierType """
    pass

def menuitem_property_set_image(menuitem, property, data): # real signature unknown; restored from __doc__
    """ menuitem_property_set_image(menuitem:Dbusmenu.Menuitem, property:str, data:GdkPixbuf.Pixbuf) -> bool """
    return False

def menuitem_property_set_shortcut(menuitem, key, modifier): # real signature unknown; restored from __doc__
    """ menuitem_property_set_shortcut(menuitem:Dbusmenu.Menuitem, key:int, modifier:Gdk.ModifierType) -> bool """
    return False

def menuitem_property_set_shortcut_menuitem(menuitem, gmi): # real signature unknown; restored from __doc__
    """ menuitem_property_set_shortcut_menuitem(menuitem:Dbusmenu.Menuitem, gmi:Gtk.MenuItem) -> bool """
    return False

def menuitem_property_set_shortcut_string(menuitem, shortcut): # real signature unknown; restored from __doc__
    """ menuitem_property_set_shortcut_string(menuitem:Dbusmenu.Menuitem, shortcut:str) -> bool """
    return False
...
class Client(__gi_repository_Dbusmenu.Client):
    """
    :Constructors:
    ...
    ::
        ...
        Client(**properties)
        new(dbus_name:str, dbus_object:str) -> DbusmenuGtk3.Client
    """
    def add_type_handler(self, type, newfunc): # real signature unknown; restored from __doc__
        """ add_type_handler(self, type:str, newfunc:Dbusmenu.ClientTypeHandler) -> bool """
        return False

    def add_type_handler_full(self, type, newfunc, user_data=None): # real signature unknown; restored from __doc__
        """ add_type_handler_full(self, type:str, newfunc:Dbusmenu.ClientTypeHandler, user_data=None) -> bool """
        return False
    ...
    def get_icon_paths(self): # real signature unknown; restored from __doc__
        """ get_icon_paths(self) -> list """
        return []
    ...
    def menuitem_get(self, item): # real signature unknown; restored from __doc__
        """ menuitem_get(self, item:Dbusmenu.Menuitem) -> Gtk.MenuItem """
        pass

    def menuitem_get_submenu(self, item): # real signature unknown; restored from __doc__
        """ menuitem_get_submenu(self, item:Dbusmenu.Menuitem) -> Gtk.Menu """
        pass

    def new(self, dbus_name, dbus_object): # real signature unknown; restored from __doc__
        """ new(dbus_name:str, dbus_object:str) -> DbusmenuGtk3.Client """
        pass

    def newitem_base(self, item, gmi, parent): # real signature unknown; restored from __doc__
        """ newitem_base(self, item:Dbusmenu.Menuitem, gmi:Gtk.MenuItem, parent:Dbusmenu.Menuitem) """
        pass
    ...
    def set_accel_group(self, agroup): # real signature unknown; restored from __doc__
        """ set_accel_group(self, agroup:Gtk.AccelGroup) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe57ce98970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Client), '__module__': 'gi.repository.DbusmenuGtk3', '__gtype__': <GType DbusmenuGtkClient (94459972334080)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_accel_group': gi.FunctionInfo(get_accel_group), 'menuitem_get': gi.FunctionInfo(menuitem_get), 'menuitem_get_submenu': gi.FunctionInfo(menuitem_get_submenu), 'newitem_base': gi.FunctionInfo(newitem_base), 'set_accel_group': gi.FunctionInfo(set_accel_group), 'parent': <property object at 0x7fe57cee1180>, 'priv': <property object at 0x7fe57cee11d0>})"
    __gdoc__ = "Object DbusmenuGtkClient\n\nSignals from DbusmenuClient:\n  layout-updated ()\n  root-changed (GObject)\n  new-menuitem (GObject)\n  item-activate (GObject, guint)\n  event-result (GObject, gchararray, GVariant, guint, gpointer)\n  icon-theme-dirs-changed (gpointer)\n\nProperties from DbusmenuClient:\n  dbus-object -> gchararray: DBus Object we represent\n    The Object on the client that we're getting our data from.\n  dbus-name -> gchararray: DBus Client we connect to\n    Name of the DBus client we're connecting to.\n  status -> DbusmenuStatus: Status of viewing the menus\n    Whether the menus should be given special visuals\n  text-direction -> DbusmenuTextDirection: Direction text values have\n    Signals which direction the default text direction is for the menus\n  group-events -> gboolean: Whether or not multiple events should be grouped\n    Event grouping lowers the number of messages on DBus and will be set automatically based on the version to optimize traffic.  It can be disabled for testing or other purposes.\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DbusmenuGtkClient (94459972334080)>'
...
class ClientClass(__gi.Struct):
    ...
    root_changed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ClientClass), '__module__': 'gi.repository.DbusmenuGtk3', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ClientClass' objects>, '__weakref__': <attribute '__weakref__' of 'ClientClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fe57cee1360>, 'root_changed': <property object at 0x7fe57cee1450>, 'reserved1': <property object at 0x7fe57cee1540>, 'reserved2': <property object at 0x7fe57cee1630>, 'reserved3': <property object at 0x7fe57cee1720>, 'reserved4': <property object at 0x7fe57cee1810>, 'reserved5': <property object at 0x7fe57cee1900>, 'reserved6': <property object at 0x7fe57cee19f0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ClientClass)


class ClientPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ClientPrivate), '__module__': 'gi.repository.DbusmenuGtk3', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ClientPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'ClientPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ClientPrivate)


class Menu(__gi_overrides_Gtk.Menu):
    """
    :Constructors:
    ...
    ::
        ...
        Menu(**properties)
        new(dbus_name:str, dbus_object:str) -> DbusmenuGtk3.Menu
    """
    ...
    def get_client(self): # real signature unknown; restored from __doc__
        """ get_client(self) -> DbusmenuGtk3.Client """
        pass
...
class MenuClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MenuClass), '__module__': 'gi.repository.DbusmenuGtk3', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'MenuClass' objects>, '__weakref__': <attribute '__weakref__' of 'MenuClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fe57cee1ef0>, 'reserved1': <property object at 0x7fe57ce2f040>, 'reserved2': <property object at 0x7fe57ce2f130>, 'reserved3': <property object at 0x7fe57ce2f220>, 'reserved4': <property object at 0x7fe57ce2f310>, 'reserved5': <property object at 0x7fe57ce2f400>, 'reserved6': <property object at 0x7fe57ce2f4f0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class MenuPrivate(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MenuPrivate), '__module__': 'gi.repository.DbusmenuGtk3', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'MenuPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'MenuPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7fe57e2671f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7fe57e267280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7fe57e267310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7fe57e2673a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7fe57eea3d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/DbusmenuGtk3-0.4.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.DbusmenuGtk3', loader=<gi.importer.DynamicImporter object at 0x7fe57eea3d00>)"
