...
class VideoItem(AudioItem, VisualItem):
    """
    :Constructors:
    
    ::
    
        VideoItem(**properties)
        new(id:str, parent:RygelServer.MediaContainer, title:str, upnp_class:str) -> RygelServer.VideoItem
    """
    ...
    def get_subtitles(self): # real signature unknown; restored from __doc__
        """ get_subtitles(self) -> Gee.ArrayList """
        pass
    ...
    def set_author(self, value): # real signature unknown; restored from __doc__
        """ set_author(self, value:str) """
        pass
    ...
    def set_subtitles(self, value): # real signature unknown; restored from __doc__
        """ set_subtitles(self, value:Gee.ArrayList) """
        pass
