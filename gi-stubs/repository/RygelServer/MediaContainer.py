...
class MediaContainer(MediaObject):
    ...
    MUSIC_GENRE = '(null)'
    PLAYLIST = '(null)'
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe1d200cc40>'
    STORAGE_FOLDER = '(null)'
    UPNP_CLASS = 'object.container'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaContainer), '__module__': 'gi.repository.RygelServer', '__gtype__': <GType RygelMediaContainer (94219762469840)>, '__doc__': None, '__gsignals__': {}, 'equal_func': gi.FunctionInfo(equal_func), 'get_children': gi.FunctionInfo(get_children), 'get_children_finish': gi.FunctionInfo(get_children_finish), 'find_object': gi.FunctionInfo(find_object), 'find_object_finish': gi.FunctionInfo(find_object_finish), 'updated': gi.FunctionInfo(updated), 'get_child_count': gi.FunctionInfo(get_child_count), 'set_child_count': gi.FunctionInfo(set_child_count), 'get_empty_child_count': gi.FunctionInfo(get_empty_child_count), 'set_empty_child_count': gi.FunctionInfo(set_empty_child_count), 'get_all_child_count': gi.FunctionInfo(get_all_child_count), 'get_create_mode_enabled': gi.FunctionInfo(get_create_mode_enabled), 'set_create_mode_enabled': gi.FunctionInfo(set_create_mode_enabled), 'get_sort_criteria': gi.FunctionInfo(get_sort_criteria), 'set_sort_criteria': gi.FunctionInfo(set_sort_criteria), 'ANY': 'DLNA.ORG_AnyContainer', 'UPNP_CLASS': 'object.container', 'STORAGE_FOLDER': '(null)', 'MUSIC_ALBUM': '(null)', 'MUSIC_ARTIST': '(null)', 'MUSIC_GENRE': '(null)', 'PLAYLIST': '(null)', 'ALBUM_SORT_CRITERIA': '(null)', 'do_get_children': gi.VFuncInfo(get_children), 'do_get_children_finish': gi.VFuncInfo(get_children_finish), 'do_find_object': gi.VFuncInfo(find_object), 'do_find_object_finish': gi.VFuncInfo(find_object_finish), 'parent_instance': <property object at 0x7fe1d166f090>, 'priv': <property object at 0x7fe1d166f180>, 'update_id': <property object at 0x7fe1d166f270>, 'storage_used': <property object at 0x7fe1d166f360>, 'total_deleted_child_count': <property object at 0x7fe1d166f4a0>})"
    __gdoc__ = 'Object RygelMediaContainer\n\nSignals from RygelMediaContainer:\n  container-updated (RygelMediaContainer, RygelMediaObject, RygelObjectEventType, gboolean)\n  sub-tree-updates-finished (RygelMediaObject)\n\nProperties from RygelMediaContainer:\n  child-count -> gint: child-count\n    child-count\n  empty-child-count -> gint: empty-child-count\n    empty-child-count\n  all-child-count -> gint: all-child-count\n    all-child-count\n  create-mode-enabled -> gboolean: create-mode-enabled\n    create-mode-enabled\n  sort-criteria -> gchararray: sort-criteria\n    sort-criteria\n  ocm-flags -> GUPnPOCMFlags: ocm-flags\n    ocm-flags\n\nProperties from RygelMediaObject:\n  id -> gchararray: id\n    id\n  ref-id -> gchararray: ref-id\n    ref-id\n  upnp-class -> gchararray: upnp-class\n    upnp-class\n  date -> gchararray: date\n    date\n  creator -> gchararray: creator\n    creator\n  modified -> guint64: modified\n    modified\n  object-update-id -> guint: object-update-id\n    object-update-id\n  artist -> gchararray: artist\n    artist\n  genre -> gchararray: genre\n    genre\n  parent -> RygelMediaContainer: parent\n    parent\n  parent-ref -> RygelMediaContainer: parent-ref\n    parent-ref\n  title -> gchararray: title\n    title\n  ocm-flags -> GUPnPOCMFlags: ocm-flags\n    ocm-flags\n  restricted -> gboolean: restricted\n    restricted\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelMediaContainer (94219762469840)>'
    __info__ = ObjectInfo(MediaContainer)
