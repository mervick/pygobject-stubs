...
class PhotoItem(ImageItem):
    ...
    ::
        ...
        PhotoItem(**properties)
        new(id:str, parent:RygelServer.MediaContainer, title:str, upnp_class:str) -> RygelServer.PhotoItem
    """
