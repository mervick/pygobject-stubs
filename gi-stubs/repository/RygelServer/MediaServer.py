...
class MediaServer(__gi_repository_RygelCore.MediaDevice):
    """
    :Constructors:
    ...
    ::
        ...
        new(title:str, root_container:RygelServer.MediaContainer, capabilities:RygelCore.PluginCapabilities) -> RygelServer.MediaServer
    """
    ...
    def new(self, title, root_container, capabilities): # real signature unknown; restored from __doc__
        """ new(title:str, root_container:RygelServer.MediaContainer, capabilities:RygelCore.PluginCapabilities) -> RygelServer.MediaServer """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe1d2020f70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaServer), '__module__': 'gi.repository.RygelServer', '__gtype__': <GType RygelMediaServer (94219762608928)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fe1d167d630>, 'priv': <property object at 0x7fe1d167d720>})"
    __gdoc__ = 'Object RygelMediaServer\n\nProperties from RygelMediaServer:\n  root-container -> RygelMediaContainer: root-container\n    root-container\n\nProperties from RygelMediaDevice:\n  plugin -> RygelPlugin: plugin\n    plugin\n  title -> gchararray: title\n    title\n  capabilities -> RygelPluginCapabilities: capabilities\n    capabilities\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelMediaServer (94219762608928)>'
    __info__ = ObjectInfo(MediaServer)
