...
class MediaItem(MediaObject):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe1d16938e0>'
    UPNP_CLASS = 'objec.item'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaItem), '__module__': 'gi.repository.RygelServer', '__gtype__': <GType RygelMediaItem (94219762271872)>, '__doc__': None, '__gsignals__': {}, 'get_description': gi.FunctionInfo(get_description), 'set_description': gi.FunctionInfo(set_description), 'UPNP_CLASS': 'objec.item', 'parent_instance': <property object at 0x7fe1d344bc20>, 'priv': <property object at 0x7fe1d203b180>})"
    __gdoc__ = 'Object RygelMediaItem\n\nProperties from RygelMediaItem:\n  description -> gchararray: description\n    description\n\nProperties from RygelMediaObject:\n  id -> gchararray: id\n    id\n  ref-id -> gchararray: ref-id\n    ref-id\n  upnp-class -> gchararray: upnp-class\n    upnp-class\n  date -> gchararray: date\n    date\n  creator -> gchararray: creator\n    creator\n  modified -> guint64: modified\n    modified\n  object-update-id -> guint: object-update-id\n    object-update-id\n  artist -> gchararray: artist\n    artist\n  genre -> gchararray: genre\n    genre\n  parent -> RygelMediaContainer: parent\n    parent\n  parent-ref -> RygelMediaContainer: parent-ref\n    parent-ref\n  title -> gchararray: title\n    title\n  ocm-flags -> GUPnPOCMFlags: ocm-flags\n    ocm-flags\n  restricted -> gboolean: restricted\n    restricted\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelMediaItem (94219762271872)>'
    __info__ = ObjectInfo(MediaItem)
