...
class PlaylistItem(MediaFileItem):
    """
    :Constructors:
    ...
    ::
        ...
        new(id:str, parent:RygelServer.MediaContainer, title:str, upnp_class:str) -> RygelServer.PlaylistItem
    """
