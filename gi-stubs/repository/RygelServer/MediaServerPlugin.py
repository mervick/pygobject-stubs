...
class MediaServerPlugin(__gi_repository_RygelCore.Plugin):
    """
    :Constructors:
    
    ::
    
        MediaServerPlugin(**properties)
    """
    ...
    def do_get_search_caps(self, *args, **kwargs): # real signature unknown
        """ get_search_caps(self) -> str """
        pass
    ...
    def get_root_container(self): # real signature unknown; restored from __doc__
        """ get_root_container(self) -> RygelServer.MediaContainer """
        pass

    def get_search_caps(self): # real signature unknown; restored from __doc__
        """ get_search_caps(self) -> str """
        return ""
    ...
    def get_upload_profiles(self): # real signature unknown; restored from __doc__
        """ get_upload_profiles(self) -> list """
        return []
    ...
    def new(self, desc_path, name, title=None, description=None, capabilities): # real signature unknown; restored from __doc__
        """ new(desc_path:str, name:str, title:str=None, description:str=None, capabilities:RygelCore.PluginCapabilities) -> RygelCore.Plugin """
        pass
    ...
    def set_upload_profiles(self, value): # real signature unknown; restored from __doc__
        """ set_upload_profiles(self, value:list) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe1d205d7c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaServerPlugin), '__module__': 'gi.repository.RygelServer', '__gtype__': <GType RygelMediaServerPlugin (94219762490928)>, '__doc__': None, '__gsignals__': {}, 'get_root_container': gi.FunctionInfo(get_root_container), 'get_search_caps': gi.FunctionInfo(get_search_caps), 'get_upload_profiles': gi.FunctionInfo(get_upload_profiles), 'set_upload_profiles': gi.FunctionInfo(set_upload_profiles), 'get_supported_profiles': gi.FunctionInfo(get_supported_profiles), 'set_supported_profiles': gi.FunctionInfo(set_supported_profiles), 'do_get_search_caps': gi.VFuncInfo(get_search_caps), 'parent_instance': <property object at 0x7fe1d1680450>, 'priv': <property object at 0x7fe1d1680540>})"
    __gdoc__ = 'Object RygelMediaServerPlugin\n\nProperties from RygelMediaServerPlugin:\n  root-container -> RygelMediaContainer: root-container\n    root-container\n  search-caps -> gchararray: search-caps\n    search-caps\n  upload-profiles -> gpointer: upload-profiles\n    upload-profiles\n  supported-profiles -> gpointer: supported-profiles\n    supported-profiles\n\nProperties from RygelPlugin:\n  capabilities -> RygelPluginCapabilities: capabilities\n    capabilities\n  name -> gchararray: name\n    name\n  title -> gchararray: title\n    title\n  description -> gchararray: description\n    description\n  desc-path -> gchararray: desc-path\n    desc-path\n  active -> gboolean: active\n    active\n  resource-infos -> GeeArrayList: resource-infos\n    resource-infos\n  icon-infos -> GeeArrayList: icon-infos\n    icon-infos\n  default-icons -> GeeArrayList: default-icons\n    default-icons\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelMediaServerPlugin (94219762490928)>'
    __info__ = ObjectInfo(MediaServerPlugin)
