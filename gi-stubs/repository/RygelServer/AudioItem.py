...
class AudioItem(MediaFileItem):
    ...
    ::
        ...
        new(id:str, parent:RygelServer.MediaContainer, title:str, upnp_class:str) -> RygelServer.AudioItem
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe1d2020610>'
    UPNP_CLASS = 'object.item.audioItem'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AudioItem), '__module__': 'gi.repository.RygelServer', '__gtype__': <GType RygelAudioItem (94219762279904)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_duration': gi.FunctionInfo(get_duration), 'set_duration': gi.FunctionInfo(set_duration), 'get_bitrate': gi.FunctionInfo(get_bitrate), 'set_bitrate': gi.FunctionInfo(set_bitrate), 'get_sample_freq': gi.FunctionInfo(get_sample_freq), 'set_sample_freq': gi.FunctionInfo(set_sample_freq), 'get_bits_per_sample': gi.FunctionInfo(get_bits_per_sample), 'set_bits_per_sample': gi.FunctionInfo(set_bits_per_sample), 'get_channels': gi.FunctionInfo(get_channels), 'set_channels': gi.FunctionInfo(set_channels), 'get_album': gi.FunctionInfo(get_album), 'set_album': gi.FunctionInfo(set_album), 'UPNP_CLASS': 'object.item.audioItem', 'parent_instance': <property object at 0x7fe1d203bc20>, 'priv': <property object at 0x7fe1d203bd10>})"
    __gdoc__ = 'Object RygelAudioItem\n\nProperties from RygelAudioItem:\n  duration -> glong: duration\n    duration\n  bitrate -> gint: bitrate\n    bitrate\n  sample-freq -> gint: sample-freq\n    sample-freq\n  bits-per-sample -> gint: bits-per-sample\n    bits-per-sample\n  channels -> gint: channels\n    channels\n  album -> gchararray: album\n    album\n\nProperties from RygelMediaFileItem:\n  mime-type -> gchararray: mime-type\n    mime-type\n  dlna-profile -> gchararray: dlna-profile\n    dlna-profile\n  size -> gint64: size\n    size\n  place-holder -> gboolean: place-holder\n    place-holder\n  ocm-flags -> GUPnPOCMFlags: ocm-flags\n    ocm-flags\n\nProperties from RygelMediaItem:\n  description -> gchararray: description\n    description\n\nProperties from RygelMediaObject:\n  id -> gchararray: id\n    id\n  ref-id -> gchararray: ref-id\n    ref-id\n  upnp-class -> gchararray: upnp-class\n    upnp-class\n  date -> gchararray: date\n    date\n  creator -> gchararray: creator\n    creator\n  modified -> guint64: modified\n    modified\n  object-update-id -> guint: object-update-id\n    object-update-id\n  artist -> gchararray: artist\n    artist\n  genre -> gchararray: genre\n    genre\n  parent -> RygelMediaContainer: parent\n    parent\n  parent-ref -> RygelMediaContainer: parent-ref\n    parent-ref\n  title -> gchararray: title\n    title\n  ocm-flags -> GUPnPOCMFlags: ocm-flags\n    ocm-flags\n  restricted -> gboolean: restricted\n    restricted\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelAudioItem (94219762279904)>'
    __info__ = ObjectInfo(AudioItem)
