...
class MusicItem(AudioItem):
    """
    :Constructors:
    
    ::
    
        MusicItem(**properties)
        new(id:str, parent:RygelServer.MediaContainer, title:str, upnp_class:str) -> RygelServer.MusicItem
    """
    ...
    def get_album_art(self): # real signature unknown; restored from __doc__
        """ get_album_art(self) -> RygelServer.Thumbnail """
        pass
    ...
    def lookup_album_art(self): # real signature unknown; restored from __doc__
        """ lookup_album_art(self) """
        pass

    def new(self, id, parent, title, upnp_class): # real signature unknown; restored from __doc__
        """ new(id:str, parent:RygelServer.MediaContainer, title:str, upnp_class:str) -> RygelServer.MusicItem """
        pass
    ...
    def set_album(self, value): # real signature unknown; restored from __doc__
        """ set_album(self, value:str) """
        pass

    def set_album_art(self, value): # real signature unknown; restored from __doc__
        """ set_album_art(self, value:RygelServer.Thumbnail) """
        pass
    ...
    def set_channels(self, value): # real signature unknown; restored from __doc__
        """ set_channels(self, value:int) """
        pass
    ...
    def set_track_number(self, value): # real signature unknown; restored from __doc__
        """ set_track_number(self, value:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe1d205d8b0>'
    UPNP_CLASS = 'object.item.audioItem.musicTrack'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MusicItem), '__module__': 'gi.repository.RygelServer', '__gtype__': <GType RygelMusicItem (94219762491328)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'lookup_album_art': gi.FunctionInfo(lookup_album_art), 'get_track_number': gi.FunctionInfo(get_track_number), 'set_track_number': gi.FunctionInfo(set_track_number), 'get_album_art': gi.FunctionInfo(get_album_art), 'set_album_art': gi.FunctionInfo(set_album_art), 'UPNP_CLASS': 'object.item.audioItem.musicTrack', 'parent_instance': <property object at 0x7fe1d1680b80>, 'priv': <property object at 0x7fe1d1680c70>})"
    __gdoc__ = 'Object RygelMusicItem\n\nProperties from RygelMusicItem:\n  track-number -> gint: track-number\n    track-number\n  album-art -> RygelThumbnail: album-art\n    album-art\n\nProperties from RygelAudioItem:\n  duration -> glong: duration\n    duration\n  bitrate -> gint: bitrate\n    bitrate\n  sample-freq -> gint: sample-freq\n    sample-freq\n  bits-per-sample -> gint: bits-per-sample\n    bits-per-sample\n  channels -> gint: channels\n    channels\n  album -> gchararray: album\n    album\n\nProperties from RygelMediaFileItem:\n  mime-type -> gchararray: mime-type\n    mime-type\n  dlna-profile -> gchararray: dlna-profile\n    dlna-profile\n  size -> gint64: size\n    size\n  place-holder -> gboolean: place-holder\n    place-holder\n  ocm-flags -> GUPnPOCMFlags: ocm-flags\n    ocm-flags\n\nProperties from RygelMediaItem:\n  description -> gchararray: description\n    description\n\nProperties from RygelMediaObject:\n  id -> gchararray: id\n    id\n  ref-id -> gchararray: ref-id\n    ref-id\n  upnp-class -> gchararray: upnp-class\n    upnp-class\n  date -> gchararray: date\n    date\n  creator -> gchararray: creator\n    creator\n  modified -> guint64: modified\n    modified\n  object-update-id -> guint: object-update-id\n    object-update-id\n  artist -> gchararray: artist\n    artist\n  genre -> gchararray: genre\n    genre\n  parent -> RygelMediaContainer: parent\n    parent\n  parent-ref -> RygelMediaContainer: parent-ref\n    parent-ref\n  title -> gchararray: title\n    title\n  ocm-flags -> GUPnPOCMFlags: ocm-flags\n    ocm-flags\n  restricted -> gboolean: restricted\n    restricted\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelMusicItem (94219762491328)>'
    __info__ = ObjectInfo(MusicItem)
