...
class DIDLLiteContainer(DIDLLiteObject):
    """
    :Constructors:
    
    ::
    
        DIDLLiteContainer(**properties)
    """
    ...
    def add_create_class(self, create_class): # real signature unknown; restored from __doc__
        """ add_create_class(self, create_class:str) """
        pass

    def add_create_class_full(self, create_class, include_derived): # real signature unknown; restored from __doc__
        """ add_create_class_full(self, create_class:str, include_derived:bool) """
        pass
    ...
    def add_search_class(self, search_class): # real signature unknown; restored from __doc__
        """ add_search_class(self, search_class:str) """
        pass

    def add_search_class_full(self, search_class, include_derived): # real signature unknown; restored from __doc__
        """ add_search_class_full(self, search_class:str, include_derived:bool) """
        pass
    ...
    def container_update_id_is_set(self): # real signature unknown; restored from __doc__
        """ container_update_id_is_set(self) -> bool """
        return False
    ...
    def get_container_update_id(self): # real signature unknown; restored from __doc__
        """ get_container_update_id(self) -> int """
        return 0

    def get_create_classes(self): # real signature unknown; restored from __doc__
        """ get_create_classes(self) -> list """
        return []

    def get_create_classes_full(self): # real signature unknown; restored from __doc__
        """ get_create_classes_full(self) -> list """
        return []
    ...
    def get_searchable(self): # real signature unknown; restored from __doc__
        """ get_searchable(self) -> bool """
        return False

    def get_search_classes(self): # real signature unknown; restored from __doc__
        """ get_search_classes(self) -> list """
        return []

    def get_storage_used(self): # real signature unknown; restored from __doc__
        """ get_storage_used(self) -> int """
        return 0
    ...
    def get_total_deleted_child_count(self): # real signature unknown; restored from __doc__
        """ get_total_deleted_child_count(self) -> int """
        return 0
    ...
    def set_child_count(self, child_count): # real signature unknown; restored from __doc__
        """ set_child_count(self, child_count:int) """
        pass

    def set_container_update_id(self, update_id): # real signature unknown; restored from __doc__
        """ set_container_update_id(self, update_id:int) """
        pass
    ...
    def set_searchable(self, searchable): # real signature unknown; restored from __doc__
        """ set_searchable(self, searchable:bool) """
        pass

    def set_storage_used(self, storage_used): # real signature unknown; restored from __doc__
        """ set_storage_used(self, storage_used:int) """
        pass
    ...
    def set_total_deleted_child_count(self, count): # real signature unknown; restored from __doc__
        """ set_total_deleted_child_count(self, count:int) """
        pass
    ...
    def total_deleted_child_count_is_set(self): # real signature unknown; restored from __doc__
        """ total_deleted_child_count_is_set(self) -> bool """
        return False
    ...
    def unset_container_update_id(self): # real signature unknown; restored from __doc__
        """ unset_container_update_id(self) """
        pass

    def unset_total_deleted_child_count(self): # real signature unknown; restored from __doc__
        """ unset_total_deleted_child_count(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fda4df672b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DIDLLiteContainer), '__module__': 'gi.repository.GUPnPAV', '__gtype__': <GType GUPnPDIDLLiteContainer (94653147325856)>, '__doc__': None, '__gsignals__': {}, 'add_create_class': gi.FunctionInfo(add_create_class), 'add_create_class_full': gi.FunctionInfo(add_create_class_full), 'add_search_class': gi.FunctionInfo(add_search_class), 'add_search_class_full': gi.FunctionInfo(add_search_class_full), 'container_update_id_is_set': gi.FunctionInfo(container_update_id_is_set), 'get_child_count': gi.FunctionInfo(get_child_count), 'get_container_update_id': gi.FunctionInfo(get_container_update_id), 'get_create_classes': gi.FunctionInfo(get_create_classes), 'get_create_classes_full': gi.FunctionInfo(get_create_classes_full), 'get_search_classes': gi.FunctionInfo(get_search_classes), 'get_searchable': gi.FunctionInfo(get_searchable), 'get_storage_used': gi.FunctionInfo(get_storage_used), 'get_total_deleted_child_count': gi.FunctionInfo(get_total_deleted_child_count), 'set_child_count': gi.FunctionInfo(set_child_count), 'set_container_update_id': gi.FunctionInfo(set_container_update_id), 'set_searchable': gi.FunctionInfo(set_searchable), 'set_storage_used': gi.FunctionInfo(set_storage_used), 'set_total_deleted_child_count': gi.FunctionInfo(set_total_deleted_child_count), 'total_deleted_child_count_is_set': gi.FunctionInfo(total_deleted_child_count_is_set), 'unset_container_update_id': gi.FunctionInfo(unset_container_update_id), 'unset_total_deleted_child_count': gi.FunctionInfo(unset_total_deleted_child_count), 'parent': <property object at 0x7fda4e178c70>})"
    __gdoc__ = "Object GUPnPDIDLLiteContainer\n\nProperties from GUPnPDIDLLiteContainer:\n  searchable -> gboolean: Searchable\n    Whether this container is searchable.\n  child-count -> gint: ChildCount\n    The child count of this container.\n  storage-used -> gint64: Storage Used\n    The Number of bytes used by all child items of this container.\n  container-update-id -> guint: ContainerUpdateID\n    Update ID of this container.\n  total-deleted-child-count -> guint: TotalDeletedChildCOunt\n    Total deleted child count of this container.\n\nProperties from GUPnPDIDLLiteObject:\n  xml-node -> gpointer: XMLNode\n    The pointer to object node in XML document.\n  xml-doc -> GUPnPAVXMLDoc: XMLDoc\n    The reference to XML document containing this object.\n  upnp-namespace -> gpointer: XML namespace\n    Pointer to the UPnP XML namespace registered with the XML document containing this object.\n  dc-namespace -> gpointer: XML namespace\n    Pointer to the Dublin Core XML namespace registered with the XML document containing this object.\n  dlna-namespace -> gpointer: XML namespace\n    Pointer to the DLNA metadata namespace registered with the XML document containing this object.\n  pv-namespace -> gpointer: XML namespace\n    Pointer to the PV metadata namespace registered with the XML document containing this object.\n  id -> gchararray: ID\n    The ID of this object.\n  parent-id -> gchararray: ParentID\n    The ID of the parent container of this object.\n  restricted -> gboolean: Restricted\n    Whether this object is restricted.\n  title -> gchararray: Title\n    The title of this object.\n  upnp-class -> gchararray: UPnPClassName\n    The UPnP class of this object.\n  creator -> gchararray: Creator\n    The creator of this object.\n  artist -> gchararray: Artist\n    The artist of this object.\n  author -> gchararray: Author\n    The author of this object.\n  genre -> gchararray: Genre\n    The genre of this object.\n  write-status -> gchararray: WriteStatus\n    The write status of this object.\n  album -> gchararray: Album\n    The album of this object.\n  album-art -> gchararray: AlbumArt\n    The URI to album art of this object.\n  description -> gchararray: Description\n    The description of this object.\n  date -> gchararray: Date\n    The date of this object.\n  track-number -> gint: TrackNumber\n    The original track number of this  object.\n  dlna-managed -> GUPnPOCMFlags: DLNAManaged\n    The 'dlna:dlnaManaged' attribute\n  update-id -> guint: UpdateID\n    Update ID of this object.\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GUPnPDIDLLiteContainer (94653147325856)>'
    __info__ = ObjectInfo(DIDLLiteContainer)
