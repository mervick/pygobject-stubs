...
class DIDLLiteObject(__gi_overrides_GObject.Object):
    """
    :Constructors:
    
    ::
    
        DIDLLiteObject(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fda4df67520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DIDLLiteObject), '__module__': 'gi.repository.GUPnPAV', '__gtype__': <GType GUPnPDIDLLiteObject (94653147306896)>, '__doc__': None, '__gsignals__': {}, 'add_artist': gi.FunctionInfo(add_artist), 'add_author': gi.FunctionInfo(add_author), 'add_creator': gi.FunctionInfo(add_creator), 'add_descriptor': gi.FunctionInfo(add_descriptor), 'add_resource': gi.FunctionInfo(add_resource), 'apply_fragments': gi.FunctionInfo(apply_fragments), 'get_album': gi.FunctionInfo(get_album), 'get_album_art': gi.FunctionInfo(get_album_art), 'get_album_xml_string': gi.FunctionInfo(get_album_xml_string), 'get_artist': gi.FunctionInfo(get_artist), 'get_artists': gi.FunctionInfo(get_artists), 'get_artists_xml_string': gi.FunctionInfo(get_artists_xml_string), 'get_author': gi.FunctionInfo(get_author), 'get_authors': gi.FunctionInfo(get_authors), 'get_compat_resource': gi.FunctionInfo(get_compat_resource), 'get_creator': gi.FunctionInfo(get_creator), 'get_creators': gi.FunctionInfo(get_creators), 'get_date': gi.FunctionInfo(get_date), 'get_date_xml_string': gi.FunctionInfo(get_date_xml_string), 'get_dc_namespace': gi.FunctionInfo(get_dc_namespace), 'get_description': gi.FunctionInfo(get_description), 'get_descriptors': gi.FunctionInfo(get_descriptors), 'get_dlna_managed': gi.FunctionInfo(get_dlna_managed), 'get_dlna_namespace': gi.FunctionInfo(get_dlna_namespace), 'get_genre': gi.FunctionInfo(get_genre), 'get_id': gi.FunctionInfo(get_id), 'get_parent_id': gi.FunctionInfo(get_parent_id), 'get_properties': gi.FunctionInfo(get_properties), 'get_pv_namespace': gi.FunctionInfo(get_pv_namespace), 'get_resources': gi.FunctionInfo(get_resources), 'get_restricted': gi.FunctionInfo(get_restricted), 'get_title': gi.FunctionInfo(get_title), 'get_title_xml_string': gi.FunctionInfo(get_title_xml_string), 'get_track_number': gi.FunctionInfo(get_track_number), 'get_track_number_xml_string': gi.FunctionInfo(get_track_number_xml_string), 'get_update_id': gi.FunctionInfo(get_update_id), 'get_upnp_class': gi.FunctionInfo(get_upnp_class), 'get_upnp_class_xml_string': gi.FunctionInfo(get_upnp_class_xml_string), 'get_upnp_namespace': gi.FunctionInfo(get_upnp_namespace), 'get_write_status': gi.FunctionInfo(get_write_status), 'get_xml_node': gi.FunctionInfo(get_xml_node), 'get_xml_string': gi.FunctionInfo(get_xml_string), 'is_restricted_set': gi.FunctionInfo(is_restricted_set), 'set_album': gi.FunctionInfo(set_album), 'set_album_art': gi.FunctionInfo(set_album_art), 'set_artist': gi.FunctionInfo(set_artist), 'set_author': gi.FunctionInfo(set_author), 'set_creator': gi.FunctionInfo(set_creator), 'set_date': gi.FunctionInfo(set_date), 'set_description': gi.FunctionInfo(set_description), 'set_dlna_managed': gi.FunctionInfo(set_dlna_managed), 'set_genre': gi.FunctionInfo(set_genre), 'set_id': gi.FunctionInfo(set_id), 'set_parent_id': gi.FunctionInfo(set_parent_id), 'set_restricted': gi.FunctionInfo(set_restricted), 'set_title': gi.FunctionInfo(set_title), 'set_track_number': gi.FunctionInfo(set_track_number), 'set_update_id': gi.FunctionInfo(set_update_id), 'set_upnp_class': gi.FunctionInfo(set_upnp_class), 'set_write_status': gi.FunctionInfo(set_write_status), 'unset_artists': gi.FunctionInfo(unset_artists), 'unset_update_id': gi.FunctionInfo(unset_update_id), 'update_id_is_set': gi.FunctionInfo(update_id_is_set), 'parent': <property object at 0x7fda4e1784f0>, 'priv': <property object at 0x7fda4e1785e0>})"
    __gdoc__ = "Object GUPnPDIDLLiteObject\n\nProperties from GUPnPDIDLLiteObject:\n  xml-node -> gpointer: XMLNode\n    The pointer to object node in XML document.\n  xml-doc -> GUPnPAVXMLDoc: XMLDoc\n    The reference to XML document containing this object.\n  upnp-namespace -> gpointer: XML namespace\n    Pointer to the UPnP XML namespace registered with the XML document containing this object.\n  dc-namespace -> gpointer: XML namespace\n    Pointer to the Dublin Core XML namespace registered with the XML document containing this object.\n  dlna-namespace -> gpointer: XML namespace\n    Pointer to the DLNA metadata namespace registered with the XML document containing this object.\n  pv-namespace -> gpointer: XML namespace\n    Pointer to the PV metadata namespace registered with the XML document containing this object.\n  id -> gchararray: ID\n    The ID of this object.\n  parent-id -> gchararray: ParentID\n    The ID of the parent container of this object.\n  restricted -> gboolean: Restricted\n    Whether this object is restricted.\n  title -> gchararray: Title\n    The title of this object.\n  upnp-class -> gchararray: UPnPClassName\n    The UPnP class of this object.\n  creator -> gchararray: Creator\n    The creator of this object.\n  artist -> gchararray: Artist\n    The artist of this object.\n  author -> gchararray: Author\n    The author of this object.\n  genre -> gchararray: Genre\n    The genre of this object.\n  write-status -> gchararray: WriteStatus\n    The write status of this object.\n  album -> gchararray: Album\n    The album of this object.\n  album-art -> gchararray: AlbumArt\n    The URI to album art of this object.\n  description -> gchararray: Description\n    The description of this object.\n  date -> gchararray: Date\n    The date of this object.\n  track-number -> gint: TrackNumber\n    The original track number of this  object.\n  dlna-managed -> GUPnPOCMFlags: DLNAManaged\n    The 'dlna:dlnaManaged' attribute\n  update-id -> guint: UpdateID\n    Update ID of this object.\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GUPnPDIDLLiteObject (94653147306896)>'
    __info__ = ObjectInfo(DIDLLiteObject)
