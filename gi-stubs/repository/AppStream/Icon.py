...
class Icon(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    def get_kind(self): # real signature unknown; restored from __doc__
        """ get_kind(self) -> AppStream.IconKind """
        pass
    ...
    def kind_from_string(self, kind_str): # real signature unknown; restored from __doc__
        """ kind_from_string(kind_str:str) -> AppStream.IconKind """
        pass

    def kind_to_string(self, kind): # real signature unknown; restored from __doc__
        """ kind_to_string(kind:AppStream.IconKind) -> str """
        return ""
    ...
    def set_kind(self, kind): # real signature unknown; restored from __doc__
        """ set_kind(self, kind:AppStream.IconKind) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f75429ce220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Icon), '__module__': 'gi.repository.AppStream', '__gtype__': <GType AsIcon (94779631070032)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'kind_from_string': gi.FunctionInfo(kind_from_string), 'kind_to_string': gi.FunctionInfo(kind_to_string), 'get_filename': gi.FunctionInfo(get_filename), 'get_height': gi.FunctionInfo(get_height), 'get_kind': gi.FunctionInfo(get_kind), 'get_name': gi.FunctionInfo(get_name), 'get_scale': gi.FunctionInfo(get_scale), 'get_url': gi.FunctionInfo(get_url), 'get_width': gi.FunctionInfo(get_width), 'set_filename': gi.FunctionInfo(set_filename), 'set_height': gi.FunctionInfo(set_height), 'set_kind': gi.FunctionInfo(set_kind), 'set_name': gi.FunctionInfo(set_name), 'set_scale': gi.FunctionInfo(set_scale), 'set_url': gi.FunctionInfo(set_url), 'set_width': gi.FunctionInfo(set_width), 'parent_instance': <property object at 0x7f75429eb9f0>})"
    __gdoc__ = 'Object AsIcon\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AsIcon (94779631070032)>'
    __info__ = ObjectInfo(Icon)
