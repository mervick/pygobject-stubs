...
class Image(__gi_overrides_GObject.Object):
    ...
    def get_kind(self): # real signature unknown; restored from __doc__
        """ get_kind(self) -> AppStream.ImageKind """
        pass
    ...
    def kind_from_string(self, kind): # real signature unknown; restored from __doc__
        """ kind_from_string(kind:str) -> AppStream.ImageKind """
        pass

    def kind_to_string(self, kind): # real signature unknown; restored from __doc__
        """ kind_to_string(kind:AppStream.ImageKind) -> str """
        return ""
    ...
    def set_kind(self, kind): # real signature unknown; restored from __doc__
        """ set_kind(self, kind:AppStream.ImageKind) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Image), '__module__': 'gi.repository.AppStream', '__gtype__': <GType AsImage (94779631079376)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'kind_from_string': gi.FunctionInfo(kind_from_string), 'kind_to_string': gi.FunctionInfo(kind_to_string), 'get_height': gi.FunctionInfo(get_height), 'get_kind': gi.FunctionInfo(get_kind), 'get_locale': gi.FunctionInfo(get_locale), 'get_url': gi.FunctionInfo(get_url), 'get_width': gi.FunctionInfo(get_width), 'set_height': gi.FunctionInfo(set_height), 'set_kind': gi.FunctionInfo(set_kind), 'set_locale': gi.FunctionInfo(set_locale), 'set_url': gi.FunctionInfo(set_url), 'set_width': gi.FunctionInfo(set_width), 'parent_instance': <property object at 0x7f75429ed630>})"
    __gdoc__ = 'Object AsImage\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AsImage (94779631079376)>'
