# encoding: utf-8
# module gi.repository.GtkClutter
# from /usr/lib64/girepository-1.0/GtkClutter-1.0.typelib
# by generator 1.147
"""
...
def init(argv=None): # real signature unknown; restored from __doc__
    """ init(argv:list=None) -> Clutter.InitError, argv:list """
    pass

def init_with_args(argv=None, parameter_string=None, entries=None, translation_domain=None): # real signature unknown; restored from __doc__
    """ init_with_args(argv:list=None, parameter_string:str=None, entries:list=None, translation_domain:str=None) -> Clutter.InitError, argv:list """
    pass
...
class Actor(__gi_repository_Clutter.Actor):
    """
    :Constructors:
    ...
    ::
        ...
        Actor(**properties)
        new() -> Clutter.Actor
        new_with_contents(contents:Gtk.Widget) -> Clutter.Actor
    """
    ...
    def new_with_contents(self, contents): # real signature unknown; restored from __doc__
        """ new_with_contents(contents:Gtk.Widget) -> Clutter.Actor """
        pass
...
class ActorClass(__gi.Struct):
    ...
    _clutter_gtk_reserved1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _clutter_gtk_reserved2 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _clutter_gtk_reserved3 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _clutter_gtk_reserved4 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _clutter_gtk_reserved5 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _clutter_gtk_reserved6 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ActorClass), '__module__': 'gi.repository.GtkClutter', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ActorClass' objects>, '__weakref__': <attribute '__weakref__' of 'ActorClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fdc45d80e50>, '_clutter_gtk_reserved1': <property object at 0x7fdc45d80f90>, '_clutter_gtk_reserved2': <property object at 0x7fdc45d83130>, '_clutter_gtk_reserved3': <property object at 0x7fdc45d83270>, '_clutter_gtk_reserved4': <property object at 0x7fdc45d833b0>, '_clutter_gtk_reserved5': <property object at 0x7fdc45d834f0>, '_clutter_gtk_reserved6': <property object at 0x7fdc45d83630>})"
...
class ActorPrivate(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ActorPrivate), '__module__': 'gi.repository.GtkClutter', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ActorPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'ActorPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ActorPrivate)


class Embed(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    def get_use_layout_size(self): # real signature unknown; restored from __doc__
        """ get_use_layout_size(self) -> bool """
        return False
    ...
    def set_use_layout_size(self, use_layout_size): # real signature unknown; restored from __doc__
        """ set_use_layout_size(self, use_layout_size:bool) """
        pass
...
class EmbedClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(EmbedClass), '__module__': 'gi.repository.GtkClutter', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'EmbedClass' objects>, '__weakref__': <attribute '__weakref__' of 'EmbedClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fdc45d83b80>, '_clutter_gtk_reserved1': <property object at 0x7fdc45d83cc0>, '_clutter_gtk_reserved2': <property object at 0x7fdc45d83db0>, '_clutter_gtk_reserved3': <property object at 0x7fdc45d83ea0>, '_clutter_gtk_reserved4': <property object at 0x7fdc45d83f90>, '_clutter_gtk_reserved5': <property object at 0x7fdc45d840e0>, '_clutter_gtk_reserved6': <property object at 0x7fdc45d841d0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(EmbedClass)


class EmbedPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(EmbedPrivate), '__module__': 'gi.repository.GtkClutter', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'EmbedPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'EmbedPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(EmbedPrivate)


class Texture(__gi_repository_Clutter.Texture):
    """
    :Constructors:
    ...
    def set_from_icon_name(self, widget=None, icon_name, icon_size): # real signature unknown; restored from __doc__
        """ set_from_icon_name(self, widget:Gtk.Widget=None, icon_name:str, icon_size:Gtk.IconSize) -> bool """
        return False

    def set_from_pixbuf(self, pixbuf): # real signature unknown; restored from __doc__
        """ set_from_pixbuf(self, pixbuf:GdkPixbuf.Pixbuf) -> bool """
        return False
    ...
    def set_from_stock(self, widget, stock_id, icon_size): # real signature unknown; restored from __doc__
        """ set_from_stock(self, widget:Gtk.Widget, stock_id:str, icon_size:Gtk.IconSize) -> bool """
        return False
...
class TextureClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TextureClass), '__module__': 'gi.repository.GtkClutter', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TextureClass' objects>, '__weakref__': <attribute '__weakref__' of 'TextureClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fdc45d84e00>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(TextureClass)


class TextureError(__gobject.GEnum):
    # no doc
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GtkClutter', '__dict__': <attribute '__dict__' of 'TextureError' objects>, '__doc__': None, '__gtype__': <GType PyGtkClutterTextureError (94390929661264)>, '__enum_values__': {0: <enum GTK_CLUTTER_TEXTURE_ERROR_INVALID_STOCK_ID of type GtkClutter.TextureError>}, '__info__': gi.EnumInfo(TextureError), 'TEXTURE_ERROR_INVALID_STOCK_ID': <enum GTK_CLUTTER_TEXTURE_ERROR_INVALID_STOCK_ID of type GtkClutter.TextureError>})"
    __enum_values__ = {
        0: 0,
    }
    __gtype__ = None # (!) real value is '<GType PyGtkClutterTextureError (94390929661264)>'
    __info__ = gi.EnumInfo(TextureError)
...
class WindowClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(WindowClass), '__module__': 'gi.repository.GtkClutter', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'WindowClass' objects>, '__weakref__': <attribute '__weakref__' of 'WindowClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fdc45d863b0>, '_clutter_gtk_reserved1': <property object at 0x7fdc45d864f0>, '_clutter_gtk_reserved2': <property object at 0x7fdc45d865e0>, '_clutter_gtk_reserved3': <property object at 0x7fdc45d866d0>, '_clutter_gtk_reserved4': <property object at 0x7fdc45d867c0>, '_clutter_gtk_reserved5': <property object at 0x7fdc45d868b0>, '_clutter_gtk_reserved6': <property object at 0x7fdc45d869a0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class WindowPrivate(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(WindowPrivate), '__module__': 'gi.repository.GtkClutter', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'WindowPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'WindowPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7fdc4723b1f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7fdc4723b280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7fdc4723b310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7fdc4723b3a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7fdc47e77d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/GtkClutter-1.0.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.GtkClutter', loader=<gi.importer.DynamicImporter object at 0x7fdc47e77d00>)"
