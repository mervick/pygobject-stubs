...
class Attach(Object):
    ...
    def get_is_url(self): # real signature unknown; restored from __doc__
        """ get_is_url(self) -> bool """
        return False
    ...
    def new_from_bytes(self, bytes): # real signature unknown; restored from __doc__
        """ new_from_bytes(bytes:GLib.Bytes) -> ICalGLib.Attach """
        pass

    def new_from_data(self, data, free_fn=None, free_fn_data=None): # real signature unknown; restored from __doc__
        """ new_from_data(data:str, free_fn:GLib.Func=None, free_fn_data=None) -> ICalGLib.Attach """
        pass

    def new_from_url(self, url): # real signature unknown; restored from __doc__
        """ new_from_url(url:str) -> ICalGLib.Attach """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13543ce490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Attach), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalAttach (94403188130448)>, '__doc__': None, '__gsignals__': {}, 'new_from_bytes': gi.FunctionInfo(new_from_bytes), 'new_from_data': gi.FunctionInfo(new_from_data), 'new_from_url': gi.FunctionInfo(new_from_url), 'get_data': gi.FunctionInfo(get_data), 'get_is_url': gi.FunctionInfo(get_is_url), 'get_url': gi.FunctionInfo(get_url)})"
    __gdoc__ = 'Object ICalAttach\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalAttach (94403188130448)>'
    __info__ = ObjectInfo(Attach)
