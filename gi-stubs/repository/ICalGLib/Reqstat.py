...
class Reqstat(Object):
    ...
    def get_code(self): # real signature unknown; restored from __doc__
        """ get_code(self) -> ICalGLib.RequestStatus """
        pass
    ...
    def get_desc(self): # real signature unknown; restored from __doc__
        """ get_desc(self) -> str """
        return ""
    ...
    def set_code(self, code): # real signature unknown; restored from __doc__
        """ set_code(self, code:ICalGLib.RequestStatus) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f1352080070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Reqstat), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalReqstat (94403188540320)>, '__doc__': None, '__gsignals__': {}, 'new_from_string': gi.FunctionInfo(new_from_string), 'get_code': gi.FunctionInfo(get_code), 'get_debug': gi.FunctionInfo(get_debug), 'get_desc': gi.FunctionInfo(get_desc), 'set_code': gi.FunctionInfo(set_code), 'to_string': gi.FunctionInfo(to_string)})"
    __gdoc__ = 'Object ICalReqstat\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalReqstat (94403188540320)>'
    __info__ = ObjectInfo(Reqstat)
