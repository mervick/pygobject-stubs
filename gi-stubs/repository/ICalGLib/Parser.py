...
class Parser(Object):
    ...
    def add_line(self, p_str=None): # real signature unknown; restored from __doc__
        """ add_line(self, str:str=None) -> ICalGLib.Component or None """
        pass
    ...
    def clean(self): # real signature unknown; restored from __doc__
        """ clean(self) -> ICalGLib.Component or None """
        pass
    ...
    def get_line(self, func, user_data=None): # real signature unknown; restored from __doc__
        """ get_line(self, func:ICalGLib.ParserLineGenFunc, user_data=None) -> str """
        return ""
    ...
    def get_state(self): # real signature unknown; restored from __doc__
        """ get_state(self) -> ICalGLib.ParserState """
        pass
    ...
    def parse(self, func, user_data=None): # real signature unknown; restored from __doc__
        """ parse(self, func:ICalGLib.ParserLineGenFunc, user_data=None) -> ICalGLib.Component """
        pass

    def parse_string(self, p_str): # real signature unknown; restored from __doc__
        """ parse_string(str:str) -> ICalGLib.Component """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f1351fd45e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Parser), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalParser (94403188279968)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parse_string': gi.FunctionInfo(parse_string), 'add_line': gi.FunctionInfo(add_line), 'clean': gi.FunctionInfo(clean), 'free': gi.FunctionInfo(free), 'get_line': gi.FunctionInfo(get_line), 'get_state': gi.FunctionInfo(get_state), 'parse': gi.FunctionInfo(parse)})"
    __gdoc__ = 'Object ICalParser\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalParser (94403188279968)>'
