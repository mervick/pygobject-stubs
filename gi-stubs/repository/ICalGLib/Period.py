...
class Period(Object):
    ...
    def is_null_period(self): # real signature unknown; restored from __doc__
        """ is_null_period(self) -> bool """
        return False

    def is_valid_period(self): # real signature unknown; restored from __doc__
        """ is_valid_period(self) -> bool """
        return False
    ...
    def new_null_period(self): # real signature unknown; restored from __doc__
        """ new_null_period() -> ICalGLib.Period """
        pass
    ...
    def set_end(self, end): # real signature unknown; restored from __doc__
        """ set_end(self, end:ICalGLib.Time) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f1351fd49d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Period), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalPeriod (94403188378000)>, '__doc__': None, '__gsignals__': {}, 'new_from_string': gi.FunctionInfo(new_from_string), 'new_null_period': gi.FunctionInfo(new_null_period), 'as_ical_string': gi.FunctionInfo(as_ical_string), 'get_duration': gi.FunctionInfo(get_duration), 'get_end': gi.FunctionInfo(get_end), 'get_start': gi.FunctionInfo(get_start), 'is_null_period': gi.FunctionInfo(is_null_period), 'is_valid_period': gi.FunctionInfo(is_valid_period), 'set_duration': gi.FunctionInfo(set_duration), 'set_end': gi.FunctionInfo(set_end), 'set_start': gi.FunctionInfo(set_start)})"
    __gdoc__ = 'Object ICalPeriod\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalPeriod (94403188378000)>'
    __info__ = ObjectInfo(Period)
