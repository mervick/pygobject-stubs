...
class Array(Object):
    ...
    def remove_element_at(self, position): # real signature unknown; restored from __doc__
        """ remove_element_at(self, position:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13520804c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Array), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalArray (94403187760320)>, '__doc__': None, '__gsignals__': {}, 'copy': gi.FunctionInfo(copy), 'remove_element_at': gi.FunctionInfo(remove_element_at), 'size': gi.FunctionInfo(size)})"
    __gdoc__ = 'Object ICalArray\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalArray (94403187760320)>'
    __info__ = ObjectInfo(Array)
