...
class TimeSpan(Object):
    ...
    def contains(self, container): # real signature unknown; restored from __doc__
        """ contains(self, container:ICalGLib.TimeSpan) -> int """
        return 0
    ...
    def new(self, dtstart, dtend, is_busy): # real signature unknown; restored from __doc__
        """ new(dtstart:ICalGLib.Time, dtend:ICalGLib.Time, is_busy:int) -> ICalGLib.TimeSpan """
        pass
    ...
    def new_timet(self, start, end, is_busy): # real signature unknown; restored from __doc__
        """ new_timet(start:int, end:int, is_busy:bool) -> ICalGLib.TimeSpan """
        pass
    ...
    def overlaps(self, s2): # real signature unknown; restored from __doc__
        """ overlaps(self, s2:ICalGLib.TimeSpan) -> int """
        return 0
    ...
    def set_end(self, end): # real signature unknown; restored from __doc__
        """ set_end(self, end:int) """
        pass

    def set_is_busy(self, is_busy): # real signature unknown; restored from __doc__
        """ set_is_busy(self, is_busy:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f1351ed1070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TimeSpan), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalTimeSpan (94403188565440)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_timet': gi.FunctionInfo(new_timet), 'clone': gi.FunctionInfo(clone), 'contains': gi.FunctionInfo(contains), 'get_end': gi.FunctionInfo(get_end), 'get_is_busy': gi.FunctionInfo(get_is_busy), 'get_start': gi.FunctionInfo(get_start), 'overlaps': gi.FunctionInfo(overlaps), 'set_end': gi.FunctionInfo(set_end), 'set_is_busy': gi.FunctionInfo(set_is_busy), 'set_start': gi.FunctionInfo(set_start)})"
    __gdoc__ = 'Object ICalTimeSpan\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalTimeSpan (94403188565440)>'
    __info__ = ObjectInfo(TimeSpan)
