...
class Trigger(Object):
    ...
    def is_bad_trigger(self): # real signature unknown; restored from __doc__
        """ is_bad_trigger(self) -> bool """
        return False
    ...
    def is_null_trigger(self): # real signature unknown; restored from __doc__
        """ is_null_trigger(self) -> bool """
        return False
    ...
    def new_from_int(self, reltime): # real signature unknown; restored from __doc__
        """ new_from_int(reltime:int) -> ICalGLib.Trigger """
        pass
    ...
    def set_time(self, time): # real signature unknown; restored from __doc__
        """ set_time(self, time:ICalGLib.Time) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f1351d6c040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Trigger), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalTrigger (94403188586064)>, '__doc__': None, '__gsignals__': {}, 'new_from_int': gi.FunctionInfo(new_from_int), 'new_from_string': gi.FunctionInfo(new_from_string), 'get_duration': gi.FunctionInfo(get_duration), 'get_time': gi.FunctionInfo(get_time), 'is_bad_trigger': gi.FunctionInfo(is_bad_trigger), 'is_null_trigger': gi.FunctionInfo(is_null_trigger), 'set_duration': gi.FunctionInfo(set_duration), 'set_time': gi.FunctionInfo(set_time)})"
    __gdoc__ = 'Object ICalTrigger\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalTrigger (94403188586064)>'
    __info__ = ObjectInfo(Trigger)
