...
class CompIter(Object):
    ...
    def deref(self): # real signature unknown; restored from __doc__
        """ deref(self) -> ICalGLib.Component """
        pass
    ...
    def prior(self): # real signature unknown; restored from __doc__
        """ prior(self) -> ICalGLib.Component """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f1352080310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CompIter), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalCompIter (94403187767136)>, '__doc__': None, '__gsignals__': {}, 'deref': gi.FunctionInfo(deref), 'next': gi.FunctionInfo(next), 'prior': gi.FunctionInfo(prior)})"
    __gdoc__ = 'Object ICalCompIter\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalCompIter (94403187767136)>'
    __info__ = ObjectInfo(CompIter)
