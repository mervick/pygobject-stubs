...
class RecurIterator(Object):
    ...
    def new(self, rule, dtstart): # real signature unknown; restored from __doc__
        """ new(rule:ICalGLib.Recurrence, dtstart:ICalGLib.Time) -> ICalGLib.RecurIterator """
        pass
    ...
    def set_start(self, start): # real signature unknown; restored from __doc__
        """ set_start(self, start:ICalGLib.Time) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f135435a3a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecurIterator), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalRecurIterator (94403188518336)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'next': gi.FunctionInfo(next), 'set_start': gi.FunctionInfo(set_start)})"
    __gdoc__ = 'Object ICalRecurIterator\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalRecurIterator (94403188518336)>'
    __info__ = ObjectInfo(RecurIterator)
