...
class Geo(Object):
    ...
    def get_lat(self): # real signature unknown; restored from __doc__
        """ get_lat(self) -> float """
        return 0.0

    def get_lon(self): # real signature unknown; restored from __doc__
        """ get_lon(self) -> float """
        return 0.0
    ...
    def new(self, lat, lon): # real signature unknown; restored from __doc__
        """ new(lat:float, lon:float) -> ICalGLib.Geo """
        pass
    ...
    def set_lat(self, lat): # real signature unknown; restored from __doc__
        """ set_lat(self, lat:float) """
        pass

    def set_lon(self, lon): # real signature unknown; restored from __doc__
        """ set_lon(self, lon:float) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13543ce880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Geo), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalGeo (94403188118672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'clone': gi.FunctionInfo(clone), 'get_lat': gi.FunctionInfo(get_lat), 'get_lon': gi.FunctionInfo(get_lon), 'set_lat': gi.FunctionInfo(set_lat), 'set_lon': gi.FunctionInfo(set_lon)})"
    __gdoc__ = 'Object ICalGeo\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalGeo (94403188118672)>'
    __info__ = ObjectInfo(Geo)
