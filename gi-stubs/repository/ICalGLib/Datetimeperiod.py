...
class Datetimeperiod(Object):
    ...
    def get_period(self): # real signature unknown; restored from __doc__
        """ get_period(self) -> ICalGLib.Period """
        pass
    ...
    def set_period(self, period): # real signature unknown; restored from __doc__
        """ set_period(self, period:ICalGLib.Period) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13543c5640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Datetimeperiod), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalDatetimeperiod (94403187727792)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_period': gi.FunctionInfo(get_period), 'get_time': gi.FunctionInfo(get_time), 'set_period': gi.FunctionInfo(set_period), 'set_time': gi.FunctionInfo(set_time)})"
    __gdoc__ = 'Object ICalDatetimeperiod\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalDatetimeperiod (94403187727792)>'
    __info__ = ObjectInfo(Datetimeperiod)
