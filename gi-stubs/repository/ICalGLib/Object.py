...
class Object(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13543bae50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Object), '__module__': 'gi.repository.ICalGLib', '__gtype__': <GType ICalObject (94403187670528)>, '__doc__': None, '__gsignals__': {}, 'free_global_objects': gi.FunctionInfo(free_global_objects), 'add_depender': gi.FunctionInfo(add_depender), 'get_is_global_memory': gi.FunctionInfo(get_is_global_memory), 'ref_owner': gi.FunctionInfo(ref_owner), 'remove_depender': gi.FunctionInfo(remove_depender), 'remove_owner': gi.FunctionInfo(remove_owner), 'set_native_destroy_func': gi.FunctionInfo(set_native_destroy_func), 'set_owner': gi.FunctionInfo(set_owner), 'steal_native': gi.FunctionInfo(steal_native), 'parent': <property object at 0x7f135439b5e0>, 'priv': <property object at 0x7f135439b630>})"
    __gdoc__ = 'Object ICalObject\n\nProperties from ICalObject:\n  native -> gpointer: Native\n    Native libical structure\n  native-destroy-func -> gpointer: Native-Destroy-Func\n    GDestroyNotify function to use to destroy the native libical structure\n  is-global-memory -> gboolean: Is-Global-Memory\n    Whether the native libical structure is from a global shared memory\n  owner -> GObject: Owner\n    The native libical structure owner\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ICalObject (94403187670528)>'
