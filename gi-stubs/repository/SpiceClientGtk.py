# encoding: utf-8
# module gi.repository.SpiceClientGtk
# from /usr/lib64/girepository-1.0/SpiceClientGtk-3.0.typelib
# by generator 1.147
"""
...
class Display(__gi_repository_Gtk.EventBox):
    """
    :Constructors:
    ...
    ::
        ...
        Display(**properties)
        new(session:SpiceClientGLib.Session, channel_id:int) -> SpiceClientGtk.Display
        new_with_monitor(session:SpiceClientGLib.Session, channel_id:int, monitor_id:int) -> SpiceClientGtk.Display
    """
    ...
    def get_grab_keys(self): # real signature unknown; restored from __doc__
        """ get_grab_keys(self) -> SpiceClientGtk.GrabSequence """
        pass
    ...
    def mouse_ungrab(self): # real signature unknown; restored from __doc__
        """ mouse_ungrab(self) """
        pass

    def new(self, session, channel_id): # real signature unknown; restored from __doc__
        """ new(session:SpiceClientGLib.Session, channel_id:int) -> SpiceClientGtk.Display """
        pass
    ...
    def new_with_monitor(self, session, channel_id, monitor_id): # real signature unknown; restored from __doc__
        """ new_with_monitor(session:SpiceClientGLib.Session, channel_id:int, monitor_id:int) -> SpiceClientGtk.Display """
        pass
    ...
    def send_keys(self, keyvals, kind): # real signature unknown; restored from __doc__
        """ send_keys(self, keyvals:list, kind:SpiceClientGtk.DisplayKeyEvent) """
        pass
    ...
    def set_grab_keys(self, seq): # real signature unknown; restored from __doc__
        """ set_grab_keys(self, seq:SpiceClientGtk.GrabSequence) """
        pass
...
class DisplayClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(DisplayClass), '__module__': 'gi.repository.SpiceClientGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'DisplayClass' objects>, '__weakref__': <attribute '__weakref__' of 'DisplayClass' objects>, '__doc__': None})"
...
class DisplayKeyEvent(__gobject.GEnum):
    ...
    RELEASE = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.SpiceClientGtk', '__dict__': <attribute '__dict__' of 'DisplayKeyEvent' objects>, '__doc__': None, '__gtype__': <GType SpiceDisplayKeyEvent (93904665405952)>, '__enum_values__': {1: <enum SPICE_DISPLAY_KEY_EVENT_PRESS of type SpiceClientGtk.DisplayKeyEvent>, 2: <enum SPICE_DISPLAY_KEY_EVENT_RELEASE of type SpiceClientGtk.DisplayKeyEvent>, 3: <enum SPICE_DISPLAY_KEY_EVENT_CLICK of type SpiceClientGtk.DisplayKeyEvent>}, '__info__': gi.EnumInfo(DisplayKeyEvent), 'PRESS': <enum SPICE_DISPLAY_KEY_EVENT_PRESS of type SpiceClientGtk.DisplayKeyEvent>, 'RELEASE': <enum SPICE_DISPLAY_KEY_EVENT_RELEASE of type SpiceClientGtk.DisplayKeyEvent>, 'CLICK': <enum SPICE_DISPLAY_KEY_EVENT_CLICK of type SpiceClientGtk.DisplayKeyEvent>})"
    __enum_values__ = {
        1: 1,
        2: 2,
        3: 3,
    }
    __gtype__ = None # (!) real value is '<GType SpiceDisplayKeyEvent (93904665405952)>'
...
class GrabSequence(__gi.Boxed):
    ...
    ::
        ...
        new(keysyms:list) -> SpiceClientGtk.GrabSequence
        new_from_string(str:str) -> SpiceClientGtk.GrabSequence
    """
    ...
    def copy(self): # real signature unknown; restored from __doc__
        """ copy(self) -> SpiceClientGtk.GrabSequence """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(GrabSequence), '__module__': 'gi.repository.SpiceClientGtk', '__gtype__': <GType SpiceGrabSequence (93904665407216)>, '__dict__': <attribute '__dict__' of 'GrabSequence' objects>, '__weakref__': <attribute '__weakref__' of 'GrabSequence' objects>, '__doc__': None, 'new': gi.FunctionInfo(new), 'new_from_string': gi.FunctionInfo(new_from_string), 'as_string': gi.FunctionInfo(as_string), 'copy': gi.FunctionInfo(copy), 'free': gi.FunctionInfo(free), '__new__': <staticmethod object at 0x7efcd7430160>, '__init__': <function nothing at 0x7efcd88b6ee0>})"
    __gtype__ = None # (!) real value is '<GType SpiceGrabSequence (93904665407216)>'
    __info__ = StructInfo(GrabSequence)


class GtkSession(__gi_overrides_GObject.Object):
    """
    :Constructors:
    
    ::
    
        GtkSession(**properties)
    """
    def bind_property(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def copy_to_guest(self): # real signature unknown; restored from __doc__
        """ copy_to_guest(self) """
        pass
    ...
    def get(self, session): # real signature unknown; restored from __doc__
        """ get(session:SpiceClientGLib.Session) -> SpiceClientGtk.GtkSession """
        pass
    ...
    def paste_from_guest(self): # real signature unknown; restored from __doc__
        """ paste_from_guest(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7efcd7430f40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GtkSession), '__module__': 'gi.repository.SpiceClientGtk', '__gtype__': <GType SpiceGtkSession (93904664841472)>, '__doc__': None, '__gsignals__': {}, 'get': gi.FunctionInfo(get), 'copy_to_guest': gi.FunctionInfo(copy_to_guest), 'paste_from_guest': gi.FunctionInfo(paste_from_guest)})"
    __gdoc__ = 'Object SpiceGtkSession\n\nProperties from SpiceGtkSession:\n  session -> SpiceSession: Session\n    SpiceSession\n  auto-clipboard -> gboolean: Auto clipboard\n    Automatically relay clipboard changes between host and guest.\n  auto-usbredir -> gboolean: Auto USB Redirection\n    Automatically redirect newly plugged in USBDevices to the guest.\n  pointer-grabbed -> gboolean: Pointer grabbed\n    Whether the pointer is grabbed\n  sync-modifiers -> gboolean: Sync modifiers\n    Automatically sync modifiers\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceGtkSession (93904664841472)>'
    __info__ = ObjectInfo(GtkSession)


class GtkSessionClass(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(GtkSessionClass), '__module__': 'gi.repository.SpiceClientGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'GtkSessionClass' objects>, '__weakref__': <attribute '__weakref__' of 'GtkSessionClass' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(GtkSessionClass)


class UsbDeviceWidget(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        UsbDeviceWidget(**properties)
        new(session:SpiceClientGLib.Session, device_format_string:str=None) -> Gtk.Widget
    """
    def activate(self): # real signature unknown; restored from __doc__
        """ activate(self) -> bool """
        return False
    ...
    def new(self, session, device_format_string=None): # real signature unknown; restored from __doc__
        """ new(session:SpiceClientGLib.Session, device_format_string:str=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7efcd74873a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UsbDeviceWidget), '__module__': 'gi.repository.SpiceClientGtk', '__gtype__': <GType SpiceUsbDeviceWidget (93904665409360)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    __gdoc__ = "Object SpiceUsbDeviceWidget\n\nSignals from SpiceUsbDeviceWidget:\n  connect-failed (SpiceUsbDevice, GError)\n\nProperties from SpiceUsbDeviceWidget:\n  session -> SpiceSession: Session\n    SpiceSession\n  device-format-string -> gchararray: Device format string\n    Format string for device description\n\nProperties from GtkBox:\n  spacing -> gint: Spacing\n    The amount of space between children\n  homogeneous -> gboolean: Homogeneous\n    Whether the children should all be the same size\n  baseline-position -> GtkBaselinePosition: Baseline position\n    The position of the baseline aligned widgets if extra space is available\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-changed (GtkStateType)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  direction-changed (GtkTextDirection)\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SpiceUsbDeviceWidget (93904665409360)>'
    __info__ = ObjectInfo(UsbDeviceWidget)


class UsbDeviceWidgetClass(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(UsbDeviceWidgetClass), '__module__': 'gi.repository.SpiceClientGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'UsbDeviceWidgetClass' objects>, '__weakref__': <attribute '__weakref__' of 'UsbDeviceWidgetClass' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(UsbDeviceWidgetClass)


class UsbDeviceWidgetPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(UsbDeviceWidgetPrivate), '__module__': 'gi.repository.SpiceClientGtk', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'UsbDeviceWidgetPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'UsbDeviceWidgetPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(UsbDeviceWidgetPrivate)
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7efcd88b81f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7efcd88b8280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7efcd88b8310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7efcd88b83a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7efcd94f4d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/SpiceClientGtk-3.0.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.SpiceClientGtk', loader=<gi.importer.DynamicImporter object at 0x7efcd94f4d00>)"
