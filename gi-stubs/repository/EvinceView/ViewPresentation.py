...
class ViewPresentation(__gi_overrides_Gtk.Widget):
    """
    :Constructors:
    
    ::
    
        ViewPresentation(**properties)
        new(document:EvinceDocument.Document, current_page:int, rotation:int, inverted_colors:bool) -> Gtk.Widget
    """
    ...
    def new(self, document, current_page, rotation, inverted_colors): # real signature unknown; restored from __doc__
        """ new(document:EvinceDocument.Document, current_page:int, rotation:int, inverted_colors:bool) -> Gtk.Widget """
        pass
