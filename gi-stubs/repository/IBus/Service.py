...
class Service(Object):
    ...
    def new(self, connection, path): # real signature unknown; restored from __doc__
        """ new(connection:Gio.DBusConnection, path:str) -> IBus.Service """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b11d53d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Service), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusService (94061789270640)>, '__doc__': None, '__gsignals__': {}, 'add_interfaces': <classmethod object at 0x7f59b14cc490>, 'new': gi.FunctionInfo(new), 'emit_signal': gi.FunctionInfo(emit_signal), 'get_connection': gi.FunctionInfo(get_connection), 'get_object_path': gi.FunctionInfo(get_object_path), 'register': gi.FunctionInfo(register), 'unregister': gi.FunctionInfo(unregister), 'do_service_get_property': gi.VFuncInfo(service_get_property), 'do_service_method_call': gi.VFuncInfo(service_method_call), 'do_service_set_property': gi.VFuncInfo(service_set_property), 'parent': <property object at 0x7f59b14ce4a0>, 'priv': <property object at 0x7f59b14ce680>})"
    __gdoc__ = 'Object IBusService\n\nProperties from IBusService:\n  object-path -> gchararray: object path\n    The path of service object\n  connection -> GDBusConnection: connection\n    The connection of service object\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusService (94061789270640)>'
