...
class ExtensionEvent(Serializable):
    ...
    def is_extension(self): # real signature unknown; restored from __doc__
        """ is_extension(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b11d57f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ExtensionEvent), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusExtensionEvent (94061789737552)>, '__doc__': None, '__gsignals__': {}, 'get_name': gi.FunctionInfo(get_name), 'get_params': gi.FunctionInfo(get_params), 'get_version': gi.FunctionInfo(get_version), 'is_enabled': gi.FunctionInfo(is_enabled), 'is_extension': gi.FunctionInfo(is_extension), 'parent': <property object at 0x7f59b12b1e50>, 'priv': <property object at 0x7f59b12b1f40>})"
    __gdoc__ = 'Object IBusExtensionEvent\n\nProperties from IBusExtensionEvent:\n  version -> guint: version\n    version\n  name -> gchararray: name\n    name of the extension\n  is-enabled -> gboolean: is enabled\n    if the extension is enabled\n  is-extension -> gboolean: is extension\n    if the event is called by an extension\n  params -> gchararray: params\n    Parameters to enable the extension\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusExtensionEvent (94061789737552)>'
    __info__ = ObjectInfo(ExtensionEvent)
