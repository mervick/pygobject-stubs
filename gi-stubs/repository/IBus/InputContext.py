...
class InputContext(Proxy):
    ...
    def cancel_hand_writing(self, n_strokes): # real signature unknown; restored from __doc__
    ...
    def get_engine(self): # real signature unknown; restored from __doc__
        """ get_engine(self) -> IBus.EngineDesc """
        pass

    def get_engine_async(self, timeout_msec, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_engine_async(self, timeout_msec:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_engine_async_finish(self, res): # real signature unknown; restored from __doc__
        """ get_engine_async_finish(self, res:Gio.AsyncResult) -> IBus.EngineDesc """
        pass
    ...
    def get_input_context(self, path, connection): # real signature unknown; restored from __doc__
        """ get_input_context(path:str, connection:Gio.DBusConnection) -> IBus.InputContext """
        pass

    def get_input_context_async(self, path, connection, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_input_context_async(path:str, connection:Gio.DBusConnection, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_input_context_async_finish(self, res): # real signature unknown; restored from __doc__
        """ get_input_context_async_finish(res:Gio.AsyncResult) -> IBus.InputContext """
        pass
    ...
    def needs_surrounding_text(self): # real signature unknown; restored from __doc__
        """ needs_surrounding_text(self) -> bool """
        return False

    def new(self, path, connection, cancellable=None): # real signature unknown; restored from __doc__
        """ new(path:str, connection:Gio.DBusConnection, cancellable:Gio.Cancellable=None) -> IBus.InputContext """
        pass
    ...
    def new_async(self, path, connection, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ new_async(path:str, connection:Gio.DBusConnection, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def new_async_finish(self, res): # real signature unknown; restored from __doc__
        """ new_async_finish(res:Gio.AsyncResult) -> IBus.InputContext """
        pass
    ...
    def process_hand_writing_event(self, coordinates, coordinates_len): # real signature unknown; restored from __doc__
        """ process_hand_writing_event(self, coordinates:float, coordinates_len:int) """
        pass

    def process_key_event(self, keyval, keycode, state): # real signature unknown; restored from __doc__
        """ process_key_event(self, keyval:int, keycode:int, state:int) -> bool """
        return False

    def process_key_event_async(self, keyval, keycode, state, timeout_msec, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ process_key_event_async(self, keyval:int, keycode:int, state:int, timeout_msec:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def process_key_event_async_finish(self, res): # real signature unknown; restored from __doc__
        """ process_key_event_async_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def property_activate(self, prop_name, state): # real signature unknown; restored from __doc__
        """ property_activate(self, prop_name:str, state:int) """
        pass
    ...
    def set_capabilities(self, capabilities): # real signature unknown; restored from __doc__
        """ set_capabilities(self, capabilities:int) """
        pass

    def set_client_commit_preedit(self, client_commit): # real signature unknown; restored from __doc__
        """ set_client_commit_preedit(self, client_commit:bool) """
        pass

    def set_content_type(self, purpose, hints): # real signature unknown; restored from __doc__
        """ set_content_type(self, purpose:int, hints:int) """
        pass

    def set_cursor_location(self, x, y, w, h): # real signature unknown; restored from __doc__
        """ set_cursor_location(self, x:int, y:int, w:int, h:int) """
        pass

    def set_cursor_location_relative(self, x, y, w, h): # real signature unknown; restored from __doc__
    ...
    def set_engine(self, name): # real signature unknown; restored from __doc__
        """ set_engine(self, name:str) """
        pass
    ...
    def set_surrounding_text(self, text, cursor_pos, anchor_pos): # real signature unknown; restored from __doc__
        """ set_surrounding_text(self, text:IBus.Text, cursor_pos:int, anchor_pos:int) """
        pass
    ...
    own = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b11d5310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputContext), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusInputContext (94061789323824)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_async_finish': gi.FunctionInfo(new_async_finish), 'get_input_context': gi.FunctionInfo(get_input_context), 'get_input_context_async': gi.FunctionInfo(get_input_context_async), 'get_input_context_async_finish': gi.FunctionInfo(get_input_context_async_finish), 'new_async': gi.FunctionInfo(new_async), 'cancel_hand_writing': gi.FunctionInfo(cancel_hand_writing), 'focus_in': gi.FunctionInfo(focus_in), 'focus_out': gi.FunctionInfo(focus_out), 'get_engine': gi.FunctionInfo(get_engine), 'get_engine_async': gi.FunctionInfo(get_engine_async), 'get_engine_async_finish': gi.FunctionInfo(get_engine_async_finish), 'needs_surrounding_text': gi.FunctionInfo(needs_surrounding_text), 'process_hand_writing_event': gi.FunctionInfo(process_hand_writing_event), 'process_key_event': gi.FunctionInfo(process_key_event), 'process_key_event_async': gi.FunctionInfo(process_key_event_async), 'process_key_event_async_finish': gi.FunctionInfo(process_key_event_async_finish), 'property_activate': gi.FunctionInfo(property_activate), 'reset': gi.FunctionInfo(reset), 'set_capabilities': gi.FunctionInfo(set_capabilities), 'set_client_commit_preedit': gi.FunctionInfo(set_client_commit_preedit), 'set_content_type': gi.FunctionInfo(set_content_type), 'set_cursor_location': gi.FunctionInfo(set_cursor_location), 'set_cursor_location_relative': gi.FunctionInfo(set_cursor_location_relative), 'set_engine': gi.FunctionInfo(set_engine), 'set_surrounding_text': gi.FunctionInfo(set_surrounding_text), 'parent': <property object at 0x7f59b12ba3b0>})"
    __gdoc__ = 'Object IBusInputContext\n\nSignals from IBusInputContext:\n  enabled ()\n  disabled ()\n  commit-text (IBusText)\n  forward-key-event (guint, guint, guint)\n  delete-surrounding-text (gint, guint)\n  update-preedit-text (IBusText, guint, gboolean)\n  update-preedit-text-with-mode (IBusText, guint, gboolean, guint)\n  show-preedit-text ()\n  hide-preedit-text ()\n  update-auxiliary-text (IBusText, gboolean)\n  show-auxiliary-text ()\n  hide-auxiliary-text ()\n  update-lookup-table (IBusLookupTable, gboolean)\n  show-lookup-table ()\n  hide-lookup-table ()\n  page-up-lookup-table ()\n  page-down-lookup-table ()\n  cursor-up-lookup-table ()\n  cursor-down-lookup-table ()\n  register-properties (IBusPropList)\n  update-property (IBusProperty)\n\nSignals from IBusProxy:\n  destroy ()\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusInputContext (94061789323824)>'
    __info__ = ObjectInfo(InputContext)
