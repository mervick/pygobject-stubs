...
class Config(Config):
    ...
    def get_value(self, section, name, default=None): # reliably restored by inspect
        # no doc
        pass

    def get_values(self, section): # real signature unknown; restored from __doc__
        """ get_values(self, section:str) -> GLib.Variant """
        pass

    def get_values_async(self, section, timeout_ms, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_values_async(self, section:str, timeout_ms:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_values_async_finish(self, result): # real signature unknown; restored from __doc__
        """ get_values_async_finish(self, result:Gio.AsyncResult) -> GLib.Variant """
        pass

    def get_value_async(self, section, name, timeout_ms, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_value_async(self, section:str, name:str, timeout_ms:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_value_async_finish(self, result): # real signature unknown; restored from __doc__
        """ get_value_async_finish(self, result:Gio.AsyncResult) -> GLib.Variant """
        pass
    ...
    def new_async(self, connection, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ new_async(connection:Gio.DBusConnection, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def set_value(self, section, name, value): # reliably restored by inspect
        # no doc
        pass

    def set_value_async(self, section, name, value, timeout_ms, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ set_value_async(self, section:str, name:str, value:GLib.Variant, timeout_ms:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def set_value_async_finish(self, result): # real signature unknown; restored from __doc__
        """ set_value_async_finish(self, result:Gio.AsyncResult) -> bool """
        return False
    ...
    def unset(self, section, name): # real signature unknown; restored from __doc__
        """ unset(self, section:str, name:str) -> bool """
        return False

    def unwatch(self, section=None, name=None): # real signature unknown; restored from __doc__
        """ unwatch(self, section:str=None, name:str=None) -> bool """
        return False

    def watch(self, section=None, name=None): # real signature unknown; restored from __doc__
        """ watch(self, section:str=None, name:str=None) -> bool """
        return False
