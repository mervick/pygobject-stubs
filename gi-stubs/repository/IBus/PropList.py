...
class PropList(Serializable):
    ...
    ::
        ...
        new() -> IBus.PropList
    """
    def append(self, prop): # real signature unknown; restored from __doc__
        """ append(self, prop:IBus.Property) """
        pass
    ...
    def get(self, index): # real signature unknown; restored from __doc__
        """ get(self, index:int) -> IBus.Property """
        pass
    ...
    def update_property(self, prop): # real signature unknown; restored from __doc__
        """ update_property(self, prop:IBus.Property) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b10dbb50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PropList), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusPropList (94061790363424)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'append': gi.FunctionInfo(append), 'get': gi.FunctionInfo(get), 'update_property': gi.FunctionInfo(update_property), 'parent': <property object at 0x7f59b12d51d0>, 'properties': <property object at 0x7f59b12d52c0>})"
    __gdoc__ = 'Object IBusPropList\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusPropList (94061790363424)>'
    __info__ = ObjectInfo(PropList)
