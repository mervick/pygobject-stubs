...
class Serializable(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b1306340>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Serializable), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusSerializable (94061789239408)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'deserialize_object': gi.FunctionInfo(deserialize_object), 'copy': gi.FunctionInfo(copy), 'get_qattachment': gi.FunctionInfo(get_qattachment), 'remove_qattachment': gi.FunctionInfo(remove_qattachment), 'serialize_object': gi.FunctionInfo(serialize_object), 'set_qattachment': gi.FunctionInfo(set_qattachment), 'do_copy': gi.VFuncInfo(copy), 'do_deserialize': gi.VFuncInfo(deserialize), 'do_serialize': gi.VFuncInfo(serialize), 'parent': <property object at 0x7f59b14bfb30>, 'priv': <property object at 0x7f59b14bfc20>})"
    __gdoc__ = 'Object IBusSerializable\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusSerializable (94061789239408)>'
    __info__ = ObjectInfo(Serializable)
