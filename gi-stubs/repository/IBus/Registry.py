...
class Registry(Serializable):
    ...
    def load_cache(self, is_user): # real signature unknown; restored from __doc__
        """ load_cache(self, is_user:bool) -> bool """
        return False

    def load_cache_file(self, filename): # real signature unknown; restored from __doc__
        """ load_cache_file(self, filename:str) -> bool """
        return False

    def load_in_dir(self, dirname): # real signature unknown; restored from __doc__
        """ load_in_dir(self, dirname:str) """
        pass
    ...
    def save_cache(self, is_user): # real signature unknown; restored from __doc__
        """ save_cache(self, is_user:bool) -> bool """
        return False

    def save_cache_file(self, filename): # real signature unknown; restored from __doc__
        """ save_cache_file(self, filename:str) -> bool """
        return False
    ...
    def start_monitor_changes(self): # real signature unknown; restored from __doc__
        """ start_monitor_changes(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b10dbe20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Registry), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusRegistry (94061790369504)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'check_modification': gi.FunctionInfo(check_modification), 'get_components': gi.FunctionInfo(get_components), 'get_observed_paths': gi.FunctionInfo(get_observed_paths), 'load': gi.FunctionInfo(load), 'load_cache': gi.FunctionInfo(load_cache), 'load_cache_file': gi.FunctionInfo(load_cache_file), 'load_in_dir': gi.FunctionInfo(load_in_dir), 'output': gi.FunctionInfo(output), 'save_cache': gi.FunctionInfo(save_cache), 'save_cache_file': gi.FunctionInfo(save_cache_file), 'start_monitor_changes': gi.FunctionInfo(start_monitor_changes), 'parent': <property object at 0x7f59b12d8220>, 'priv': <property object at 0x7f59b12d8310>})"
    __gdoc__ = 'Object IBusRegistry\n\nSignals from IBusRegistry:\n  changed ()\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusRegistry (94061790369504)>'
