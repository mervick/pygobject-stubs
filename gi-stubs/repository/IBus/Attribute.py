...
class Attribute(Attribute):
    ...
    def get_attr_type(self): # real signature unknown; restored from __doc__
        """ get_attr_type(self) -> int """
        return 0
    ...
    def new(self, type, value, start_index, end_index): # real signature unknown; restored from __doc__
        """ new(type:int, value:int, start_index:int, end_index:int) -> IBus.Attribute """
        pass
    ...
    def __new__(cls, type=0, value=0, start_index=0, end_index=0): # reliably restored by inspect
        # no doc
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b12358e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.IBus', '__new__': <staticmethod object at 0x7f59b22878b0>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object IBusAttribute\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusAttribute (94061789239728)>'
