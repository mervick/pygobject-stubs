...
class ObservedPath(Serializable):
    ...
    def new(self, path, fill_stat): # real signature unknown; restored from __doc__
        """ new(path:str, fill_stat:bool) -> IBus.ObservedPath """
        pass
    ...
    def new_from_xml_node(self, node, fill_stat): # real signature unknown; restored from __doc__
        """ new_from_xml_node(node:IBus.XML, fill_stat:bool) -> IBus.ObservedPath """
        pass
    ...
    def traverse(self, dir_only): # real signature unknown; restored from __doc__
        """ traverse(self, dir_only:bool) -> list """
        return []
    ...
    is_dir = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    is_exist = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b11484f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ObservedPath), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusObservedPath (94061790142400)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml_node': gi.FunctionInfo(new_from_xml_node), 'check_modification': gi.FunctionInfo(check_modification), 'output': gi.FunctionInfo(output), 'traverse': gi.FunctionInfo(traverse), 'parent': <property object at 0x7f59b12cd7c0>, 'path': <property object at 0x7f59b12cd8b0>, 'mtime': <property object at 0x7f59b12cd9a0>, 'is_dir': <property object at 0x7f59b12cda90>, 'is_exist': <property object at 0x7f59b12cdb80>})"
    __gdoc__ = 'Object IBusObservedPath\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusObservedPath (94061790142400)>'
    __info__ = ObjectInfo(ObservedPath)
