...
class UnicodeData(Serializable):
    ...
    def get_block_name(self): # real signature unknown; restored from __doc__
    ...
    def load(self, path, p_object=None): # real signature unknown; restored from __doc__
        """ load(path:str, object:GObject.Object=None) -> list """
        return []

    def load_async(self, path, p_object=None, cancellable=None, callback, user_data=None): # real signature unknown; restored from __doc__
        """ load_async(path:str, object:GObject.Object=None, cancellable:Gio.Cancellable=None, callback:IBus.UnicodeDataLoadAsyncFinish, user_data=None) """
        pass
    ...
    def save(self, path, p_list): # real signature unknown; restored from __doc__
        """ save(path:str, list:list) """
        pass
    ...
    def set_block_name(self, block_name): # real signature unknown; restored from __doc__
        """ set_block_name(self, block_name:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b11d53a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UnicodeData), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusUnicodeData (94061790162992)>, '__doc__': None, '__gsignals__': {}, 'load': gi.FunctionInfo(load), 'load_async': gi.FunctionInfo(load_async), 'save': gi.FunctionInfo(save), 'get_alias': gi.FunctionInfo(get_alias), 'get_block_name': gi.FunctionInfo(get_block_name), 'get_code': gi.FunctionInfo(get_code), 'get_name': gi.FunctionInfo(get_name), 'set_block_name': gi.FunctionInfo(set_block_name), 'parent': <property object at 0x7f59b12d9e50>, 'priv': <property object at 0x7f59b12d9f40>})"
    __gdoc__ = 'Object IBusUnicodeData\n\nProperties from IBusUnicodeData:\n  code -> guint: code point\n    The Unicode code point\n  name -> gchararray: name\n    The Unicode name\n  alias -> gchararray: alias name\n    The Unicode alias name\n  block-name -> gchararray: block name\n    The Unicode block name\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusUnicodeData (94061790162992)>'
    __info__ = ObjectInfo(UnicodeData)
