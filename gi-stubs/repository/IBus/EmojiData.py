...
class EmojiData(Serializable):
    ...
    def get_annotations(self): # real signature unknown; restored from __doc__
        """ get_annotations(self) -> list """
        return []
    ...
    def get_emoji(self): # real signature unknown; restored from __doc__
        """ get_emoji(self) -> str """
        return ""
    ...
    def set_annotations(self, annotations): # real signature unknown; restored from __doc__
        """ set_annotations(self, annotations:list) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b11d52e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EmojiData), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusEmojiData (94061789360144)>, '__doc__': None, '__gsignals__': {}, 'load': gi.FunctionInfo(load), 'save': gi.FunctionInfo(save), 'get_annotations': gi.FunctionInfo(get_annotations), 'get_category': gi.FunctionInfo(get_category), 'get_description': gi.FunctionInfo(get_description), 'get_emoji': gi.FunctionInfo(get_emoji), 'set_annotations': gi.FunctionInfo(set_annotations), 'set_description': gi.FunctionInfo(set_description), 'parent': <property object at 0x7f59b12aa590>, 'priv': <property object at 0x7f59b12aa6d0>})"
    __gdoc__ = 'Object IBusEmojiData\n\nProperties from IBusEmojiData:\n  emoji -> gchararray: emoji character\n    The emoji character UTF-8\n  annotations -> gpointer: emoji annotations\n    The emoji annotation list\n  description -> gchararray: emoji description\n    The emoji description\n  category -> gchararray: emoji category\n    The emoji category\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusEmojiData (94061789360144)>'
    __info__ = ObjectInfo(EmojiData)
