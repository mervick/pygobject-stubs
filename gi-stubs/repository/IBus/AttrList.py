...
class AttrList(Serializable):
    ...
    ::
        ...
        new() -> IBus.AttrList
    """
    def append(self, attr): # real signature unknown; restored from __doc__
        """ append(self, attr:IBus.Attribute) """
        pass
    ...
    def get(self, index): # real signature unknown; restored from __doc__
        """ get(self, index:int) -> IBus.Attribute """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b12fee80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AttrList), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusAttrList (94061789463616)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'append': gi.FunctionInfo(append), 'get': gi.FunctionInfo(get), 'parent': <property object at 0x7f59b12a5220>, 'attributes': <property object at 0x7f59b12a5270>})"
    __gdoc__ = 'Object IBusAttrList\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusAttrList (94061789463616)>'
    __info__ = ObjectInfo(AttrList)
