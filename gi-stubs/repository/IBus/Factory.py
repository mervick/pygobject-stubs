...
class Factory(Factory):
    ...
    """
    def add_engine(self, engine_name, engine_type): # real signature unknown; restored from __doc__
        """ add_engine(self, engine_name:str, engine_type:GType) """
        pass
    ...
    def create_engine(self, engine_name): # real signature unknown; restored from __doc__
        """ create_engine(self, engine_name:str) -> IBus.Engine """
        pass
    ...
    def do_create_engine(self, *args, **kwargs): # real signature unknown
        """ create_engine(self, engine_name:str) -> IBus.Engine """
        pass
    ...
    def __init__(self, bus=None, **kwargs): # reliably restored by inspect
        # no doc
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b12fe850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.IBus', '__init__': <function Factory.__init__ at 0x7f59b14ca430>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object IBusFactory\n\nSignals from IBusFactory:\n  create-engine (gchararray) -> IBusEngine\n\nProperties from IBusService:\n  object-path -> gchararray: object path\n    The path of service object\n  connection -> GDBusConnection: connection\n    The connection of service object\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusFactory (94061789270864)>'
    __info__ = ObjectInfo(Factory)
