...
class Property(Property):
    ...
    def get_prop_type(self): # real signature unknown; restored from __doc__
        """ get_prop_type(self) -> IBus.PropType """
        pass
    ...
    def get_state(self): # real signature unknown; restored from __doc__
        """ get_state(self) -> IBus.PropState """
        pass

    def get_sub_props(self): # real signature unknown; restored from __doc__
        """ get_sub_props(self) -> IBus.PropList """
        pass

    def get_symbol(self): # real signature unknown; restored from __doc__
        """ get_symbol(self) -> IBus.Text """
        pass

    def get_tooltip(self): # real signature unknown; restored from __doc__
        """ get_tooltip(self) -> IBus.Text """
        pass
    ...
    def new(self, key, type, label, icon=None, tooltip, sensitive, visible, state, prop_list=None): # real signature unknown; restored from __doc__
        """ new(key:str, type:IBus.PropType, label:IBus.Text, icon:str=None, tooltip:IBus.Text, sensitive:bool, visible:bool, state:IBus.PropState, prop_list:IBus.PropList=None) -> IBus.Property """
        pass
    ...
    def set_label(self, label): # real signature unknown; restored from __doc__
        """ set_label(self, label:IBus.Text) """
        pass
    ...
    def set_state(self, state): # real signature unknown; restored from __doc__
        """ set_state(self, state:IBus.PropState) """
        pass

    def set_sub_props(self, prop_list): # real signature unknown; restored from __doc__
        """ set_sub_props(self, prop_list:IBus.PropList) """
        pass

    def set_symbol(self, symbol): # real signature unknown; restored from __doc__
        """ set_symbol(self, symbol:IBus.Text) """
        pass

    def set_tooltip(self, tooltip): # real signature unknown; restored from __doc__
        """ set_tooltip(self, tooltip:IBus.Text) """
        pass
    ...
    def update(self, prop_update): # real signature unknown; restored from __doc__
        """ update(self, prop_update:IBus.Property) -> bool """
        return False
    ...
    def __init__(self, key=None, type=0, label=None, icon=None, tooltip=None, sensitive=True, visible=True, state=0, symbol=None, **kwargs): # reliably restored by inspect
        # no doc
        pass
