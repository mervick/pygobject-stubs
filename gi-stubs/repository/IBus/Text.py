...
class Text(Text):
    ...
    """
    def append_attribute(self, type, value, start_index, end_index): # real signature unknown; restored from __doc__
        """ append_attribute(self, type:int, value:int, start_index:int, end_index:int) """
        pass
    ...
    def get_attributes(self): # real signature unknown; restored from __doc__
        """ get_attributes(self) -> IBus.AttrList """
        pass
    ...
    def new_from_ucs4(self, p_str): # real signature unknown; restored from __doc__
        """ new_from_ucs4(str:str) -> IBus.Text """
        pass

    def new_from_unichar(self, c): # real signature unknown; restored from __doc__
        """ new_from_unichar(c:str) -> IBus.Text """
        pass
    ...
    def set_attributes(self, attrs): # real signature unknown; restored from __doc__
        """ set_attributes(self, attrs:IBus.AttrList) """
        pass
    ...
    def __new__(cls, string=None, attrs=None): # reliably restored by inspect
        # no doc
        pass
    ...
    is_static = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b1235490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.IBus', '__new__': <staticmethod object at 0x7f59b14cc9a0>, '__init__': <function Text.__init__ at 0x7f59b14ca940>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object IBusText\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusText (94061789299536)>'
