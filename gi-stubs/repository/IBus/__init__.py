...
def accelerator_name(accelerator_key, accelerator_mods): # real signature unknown; restored from __doc__
    """ accelerator_name(accelerator_key:int, accelerator_mods:IBus.ModifierType) -> str """
    return ""

def accelerator_parse(accelerator): # real signature unknown; restored from __doc__
    """ accelerator_parse(accelerator:str) -> accelerator_key:int, accelerator_mods:IBus.ModifierType """
    pass

def accelerator_valid(keyval, modifiers): # real signature unknown; restored from __doc__
    """ accelerator_valid(keyval:int, modifiers:IBus.ModifierType) -> bool """
    return False

def attr_background_new(color, start_index, end_index): # real signature unknown; restored from __doc__
    """ attr_background_new(color:int, start_index:int, end_index:int) -> IBus.Attribute """
    pass

def attr_foreground_new(color, start_index, end_index): # real signature unknown; restored from __doc__
    """ attr_foreground_new(color:int, start_index:int, end_index:int) -> IBus.Attribute """
    pass

def attr_underline_new(underline_type, start_index, end_index): # real signature unknown; restored from __doc__
    """ attr_underline_new(underline_type:int, start_index:int, end_index:int) -> IBus.Attribute """
    pass

def emoji_dict_load(path): # real signature unknown; restored from __doc__
    """ emoji_dict_load(path:str) -> dict """
    return {}

def emoji_dict_lookup(dict, emoji): # real signature unknown; restored from __doc__
    """ emoji_dict_lookup(dict:dict, emoji:str) -> IBus.EmojiData """
    pass

def emoji_dict_save(path, dict): # real signature unknown; restored from __doc__
    """ emoji_dict_save(path:str, dict:dict) """
    pass
...
def free_strv(strv): # real signature unknown; restored from __doc__
    """ free_strv(strv:str) """
    pass

def get_address(): # real signature unknown; restored from __doc__
    """ get_address() -> str """
    return ""

def get_daemon_uid(): # real signature unknown; restored from __doc__
    """ get_daemon_uid() -> int """
    return 0

def get_language_name(_locale): # real signature unknown; restored from __doc__
    """ get_language_name(_locale:str) -> str """
    return ""

def get_local_machine_id(): # real signature unknown; restored from __doc__
    """ get_local_machine_id() -> str """
    return ""

def get_socket_path(): # real signature unknown; restored from __doc__
    """ get_socket_path() -> str """
    return ""

def get_timeout(): # real signature unknown; restored from __doc__
    """ get_timeout() -> int """
    return 0

def get_untranslated_language_name(_locale): # real signature unknown; restored from __doc__
    """ get_untranslated_language_name(_locale:str) -> str """
    return ""
...
def keyval_to_unicode(keyval): # real signature unknown; restored from __doc__
    """ keyval_to_unicode(keyval:int) -> str """
    return ""
...
def key_event_from_string(string, keyval, modifiers): # real signature unknown; restored from __doc__
    """ key_event_from_string(string:str, keyval:int, modifiers:int) -> bool """
    return False

def key_event_to_string(keyval, modifiers): # real signature unknown; restored from __doc__
    """ key_event_to_string(keyval:int, modifiers:int) -> str """
    return ""
...
def set_display(display): # real signature unknown; restored from __doc__
    """ set_display(display:str) """
    pass

def set_log_handler(verbose): # real signature unknown; restored from __doc__
    """ set_log_handler(verbose:bool) """
    pass

def unicode_to_keyval(wc): # real signature unknown; restored from __doc__
    """ unicode_to_keyval(wc:str) -> int """
    return 0

def unset_log_handler(): # real signature unknown; restored from __doc__
    """ unset_log_handler() """
    pass

def write_address(address): # real signature unknown; restored from __doc__
    """ write_address(address:str) """
    pass

def xml_parse_buffer(buffer): # real signature unknown; restored from __doc__
    """ xml_parse_buffer(buffer:str) -> IBus.XML """
    pass

def xml_parse_file(name): # real signature unknown; restored from __doc__
    """ xml_parse_file(name:str) -> IBus.XML """
    pass
...
from .AttributeClass import AttributeClass
from .AttrList import AttrList
from .AttrListClass import AttrListClass
from .AttrType import AttrType
from .AttrUnderline import AttrUnderline
from .Bus import Bus
from .BusClass import BusClass
from .BusNameFlag import BusNameFlag
from .BusPrivate import BusPrivate
from .BusRequestNameReply import BusRequestNameReply
from .BusStartServiceByNameReply import BusStartServiceByNameReply
from .Capabilite import Capabilite
...
from .ConfigServiceClass import ConfigServiceClass
from .EmojiData import EmojiData
from .EmojiDataClass import EmojiDataClass
from .EmojiDataPrivate import EmojiDataPrivate
from .Engine import Engine
from .EngineClass import EngineClass
from .EngineDesc import EngineDesc
from .EngineDescClass import EngineDescClass
from .EngineDescPrivate import EngineDescPrivate
from .EnginePrivate import EnginePrivate
from .EngineSimple import EngineSimple
from .EngineSimpleClass import EngineSimpleClass
from .EngineSimplePrivate import EngineSimplePrivate
from .Error import Error
from .ExtensionEvent import ExtensionEvent
from .ExtensionEventClass import ExtensionEventClass
from .ExtensionEventPrivate import ExtensionEventPrivate
from .Factory import Factory
from .FactoryClass import FactoryClass
from .FactoryPrivate import FactoryPrivate
from .HotkeyProfile import HotkeyProfile
from .HotkeyProfileClass import HotkeyProfileClass
from .InputContext import InputContext
from .InputContextClass import InputContextClass
from .InputHints import InputHints
from .InputPurpose import InputPurpose
from .Keymap import Keymap
from .KeymapClass import KeymapClass
from .LookupTable import LookupTable
from .LookupTableClass import LookupTableClass
...
from .ObservedPath import ObservedPath
from .ObservedPathClass import ObservedPathClass
from .Orientation import Orientation
from .PanelService import PanelService
from .PanelServiceClass import PanelServiceClass
from .PreeditFocusMode import PreeditFocusMode
from .ProcessKeyEventData import ProcessKeyEventData
from .Property import Property
from .PropertyClass import PropertyClass
from .PropertyPrivate import PropertyPrivate
from .PropList import PropList
from .PropListClass import PropListClass
from .PropState import PropState
...
from .SerializablePrivate import SerializablePrivate
from .ServiceClass import ServiceClass
from .ServicePrivate import ServicePrivate
from .Text import Text
from .TextClass import TextClass
from .UnicodeBlock import UnicodeBlock
from .UnicodeBlockClass import UnicodeBlockClass
from .UnicodeBlockPrivate import UnicodeBlockPrivate
from .UnicodeData import UnicodeData
from .UnicodeDataClass import UnicodeDataClass
from .UnicodeDataPrivate import UnicodeDataPrivate
from .XEvent import XEvent
from .XEventClass import XEventClass
from .XEventPrivate import XEventPrivate
from .XEventType import XEventType
from .XML import XML
from .__class__ import __class__
# variables with complex values

_introspection_module = None # (!) real value is "<IntrospectionModule 'IBus' from '/usr/lib64/girepository-1.0/IBus-1.0.typelib'>"

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7f59b2287d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/IBus-1.0.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.IBus', loader=<gi.importer.DynamicImporter object at 0x7f59b2287d00>)"
