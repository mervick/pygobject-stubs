...
class UnicodeBlock(Serializable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b10db1c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UnicodeBlock), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusUnicodeBlock (94061789370736)>, '__doc__': None, '__gsignals__': {}, 'load': gi.FunctionInfo(load), 'save': gi.FunctionInfo(save), 'get_end': gi.FunctionInfo(get_end), 'get_name': gi.FunctionInfo(get_name), 'get_start': gi.FunctionInfo(get_start), 'parent': <property object at 0x7f59b12d9900>, 'priv': <property object at 0x7f59b12d99f0>})"
    __gdoc__ = 'Object IBusUnicodeBlock\n\nProperties from IBusUnicodeBlock:\n  name -> gchararray: name\n    The Unicode name\n  start -> guint: start code point\n    The Unicode start code point\n  end -> guint: end code point\n    The Unicode end code point\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusUnicodeBlock (94061789370736)>'
    __info__ = ObjectInfo(UnicodeBlock)
