...
class ConfigService(Service):
    ...
    def do_get_value(self, *args, **kwargs): # real signature unknown
        """ get_value(self, section:str, name:str) -> GLib.Variant """
        pass
    ...
    def do_set_value(self, *args, **kwargs): # real signature unknown
        """ set_value(self, section:str, name:str, value:GLib.Variant) -> bool """
        pass

    def do_unset_value(self, *args, **kwargs): # real signature unknown
        """ unset_value(self, section:str, name:str) -> bool """
        pass
    ...
    def value_changed(self, section, name, value): # real signature unknown; restored from __doc__
        """ value_changed(self, section:str, name:str, value:GLib.Variant) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f59b1327520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ConfigService), '__module__': 'gi.repository.IBus', '__gtype__': <GType IBusConfigService (94061789756384)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'value_changed': gi.FunctionInfo(value_changed), 'do_get_value': gi.VFuncInfo(get_value), 'do_get_values': gi.VFuncInfo(get_values), 'do_set_value': gi.VFuncInfo(set_value), 'do_unset_value': gi.VFuncInfo(unset_value), 'parent': <property object at 0x7f59b12a7e00>})"
    __gdoc__ = 'Object IBusConfigService\n\nProperties from IBusService:\n  object-path -> gchararray: object path\n    The path of service object\n  connection -> GDBusConnection: connection\n    The connection of service object\n\nSignals from IBusObject:\n  destroy ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType IBusConfigService (94061789756384)>'
    __info__ = ObjectInfo(ConfigService)
