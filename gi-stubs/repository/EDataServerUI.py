# encoding: utf-8
# module gi.repository.EDataServerUI
# from /usr/lib64/girepository-1.0/EDataServerUI-1.2.typelib
# by generator 1.147
"""
...
def trust_prompt_describe_certificate_errors(flags): # real signature unknown; restored from __doc__
    """ trust_prompt_describe_certificate_errors(flags:Gio.TlsCertificateFlags) -> str """
    return ""

def trust_prompt_run_for_source(parent, source, certificate_pem, certificate_errors, error_text=None, allow_source_save, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
    """ trust_prompt_run_for_source(parent:Gtk.Window, source:EDataServer.Source, certificate_pem:str, certificate_errors:Gio.TlsCertificateFlags, error_text:str=None, allow_source_save:bool, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
    pass

def trust_prompt_run_for_source_finish(source, result, response): # real signature unknown; restored from __doc__
    """ trust_prompt_run_for_source_finish(source:EDataServer.Source, result:Gio.AsyncResult, response:EDataServer.TrustPromptResponse) -> bool """
    return False

def trust_prompt_run_modal(parent, source_extension=None, source_display_name=None, host, certificate_pem, certificate_errors, error_text=None): # real signature unknown; restored from __doc__
    """ trust_prompt_run_modal(parent:Gtk.Window, source_extension:str=None, source_display_name:str=None, host:str, certificate_pem:str, certificate_errors:Gio.TlsCertificateFlags, error_text:str=None) -> EDataServer.TrustPromptResponse """
    pass

def webdav_discover_content_get_base_url(content): # real signature unknown; restored from __doc__
    """ webdav_discover_content_get_base_url(content:Gtk.Widget) -> str """
    return ""

def webdav_discover_content_get_multiselect(content): # real signature unknown; restored from __doc__
    """ webdav_discover_content_get_multiselect(content:Gtk.Widget) -> bool """
    return False

def webdav_discover_content_get_selected(content, index): # real signature unknown; restored from __doc__
    """ webdav_discover_content_get_selected(content:Gtk.Widget, index:int) -> bool, out_href:str, out_supports:int, out_display_name:str, out_color:str """
    return False

def webdav_discover_content_get_tree_selection(content): # real signature unknown; restored from __doc__
    """ webdav_discover_content_get_tree_selection(content:Gtk.Widget) -> Gtk.TreeSelection """
    pass

def webdav_discover_content_get_user_address(content): # real signature unknown; restored from __doc__
    """ webdav_discover_content_get_user_address(content:Gtk.Widget) -> str """
    return ""

def webdav_discover_content_new(credentials_prompter, source=None, base_url=None, supports_filter): # real signature unknown; restored from __doc__
    """ webdav_discover_content_new(credentials_prompter:EDataServerUI.CredentialsPrompter, source:EDataServer.Source=None, base_url:str=None, supports_filter:int) -> Gtk.Widget """
    pass

def webdav_discover_content_refresh(content, display_name=None, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
    """ webdav_discover_content_refresh(content:Gtk.Widget, display_name:str=None, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
    pass

def webdav_discover_content_refresh_finish(content, result): # real signature unknown; restored from __doc__
    """ webdav_discover_content_refresh_finish(content:Gtk.Widget, result:Gio.AsyncResult) -> bool """
    return False

def webdav_discover_content_set_base_url(content, base_url): # real signature unknown; restored from __doc__
    """ webdav_discover_content_set_base_url(content:Gtk.Widget, base_url:str) """
    pass

def webdav_discover_content_set_multiselect(content, multiselect): # real signature unknown; restored from __doc__
    """ webdav_discover_content_set_multiselect(content:Gtk.Widget, multiselect:bool) """
    pass

def webdav_discover_content_show_error(content, error=None): # real signature unknown; restored from __doc__
    """ webdav_discover_content_show_error(content:Gtk.Widget, error:error=None) """
    pass

def webdav_discover_dialog_get_content(dialog): # real signature unknown; restored from __doc__
    """ webdav_discover_dialog_get_content(dialog:Gtk.Dialog) -> Gtk.Widget """
    pass

def webdav_discover_dialog_new(parent, title, credentials_prompter, source, base_url=None, supports_filter): # real signature unknown; restored from __doc__
    """ webdav_discover_dialog_new(parent:Gtk.Window, title:str, credentials_prompter:EDataServerUI.CredentialsPrompter, source:EDataServer.Source, base_url:str=None, supports_filter:int) -> Gtk.Dialog """
    pass

def webdav_discover_dialog_refresh(dialog): # real signature unknown; restored from __doc__
    """ webdav_discover_dialog_refresh(dialog:Gtk.Dialog) """
    pass
...
class CellRendererColorClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CellRendererColorClass), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CellRendererColorClass' objects>, '__weakref__': <attribute '__weakref__' of 'CellRendererColorClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7feac6853220>, '_gtk_reserved1': <property object at 0x7feac6853310>, '_gtk_reserved2': <property object at 0x7feac6853400>, '_gtk_reserved3': <property object at 0x7feac68534f0>, '_gtk_reserved4': <property object at 0x7feac68535e0>})"
...
class CellRendererColorPrivate(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CellRendererColorPrivate), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CellRendererColorPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'CellRendererColorPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CellRendererColorPrivate)


class CredentialsPrompter(__gi_overrides_GObject.Object, __gi_repository_EDataServer.Extensible):
    """
    :Constructors:
    
    ::
    
        CredentialsPrompter(**properties)
        new(registry:EDataServer.SourceRegistry) -> EDataServerUI.CredentialsPrompter
    """
    def bind_property(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def complete_prompt_call(self, async_result, source, credentials=None, error=None): # real signature unknown; restored from __doc__
        """ complete_prompt_call(self, async_result:Gio.SimpleAsyncResult, source:EDataServer.Source, credentials:EDataServer.NamedParameters=None, error:error=None) """
        pass
    ...
    def do_get_dialog_parent(self, *args, **kwargs): # real signature unknown
        """ get_dialog_parent(self) -> Gtk.Window """
        pass
    ...
    def get_auto_prompt(self): # real signature unknown; restored from __doc__
        """ get_auto_prompt(self) -> bool """
        return False

    def get_auto_prompt_disabled_for(self, source): # real signature unknown; restored from __doc__
        """ get_auto_prompt_disabled_for(self, source:EDataServer.Source) -> bool """
        return False
    ...
    def get_dialog_parent(self): # real signature unknown; restored from __doc__
        """ get_dialog_parent(self) -> Gtk.Window """
        pass
    ...
    def get_provider(self): # real signature unknown; restored from __doc__
        """ get_provider(self) -> EDataServer.SourceCredentialsProvider """
        pass
    ...
    def loop_prompt_sync(self, source, flags, func, user_data=None, cancellable=None): # real signature unknown; restored from __doc__
        """ loop_prompt_sync(self, source:EDataServer.Source, flags:EDataServerUI.CredentialsPrompterPromptFlags, func:EDataServerUI.CredentialsPrompterLoopPromptFunc, user_data=None, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def process_awaiting_credentials(self): # real signature unknown; restored from __doc__
        """ process_awaiting_credentials(self) """
        pass

    def process_source(self, source): # real signature unknown; restored from __doc__
        """ process_source(self, source:EDataServer.Source) -> bool """
        return False

    def prompt(self, source, error_text=None, flags, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ prompt(self, source:EDataServer.Source, error_text:str=None, flags:EDataServerUI.CredentialsPrompterPromptFlags, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def prompt_finish(self, result, out_source=None, out_credentials): # real signature unknown; restored from __doc__
        """ prompt_finish(self, result:Gio.AsyncResult, out_source:EDataServer.Source=None, out_credentials:EDataServer.NamedParameters) -> bool """
        return False
    ...
    def register_impl(self, authentication_method=None, prompter_impl): # real signature unknown; restored from __doc__
        """ register_impl(self, authentication_method:str=None, prompter_impl:EDataServerUI.CredentialsPrompterImpl) -> bool """
        return False
    ...
    def set_auto_prompt(self, auto_prompt): # real signature unknown; restored from __doc__
        """ set_auto_prompt(self, auto_prompt:bool) """
        pass

    def set_auto_prompt_disabled_for(self, source, is_disabled): # real signature unknown; restored from __doc__
        """ set_auto_prompt_disabled_for(self, source:EDataServer.Source, is_disabled:bool) """
        pass
    ...
    def unregister_impl(self, authentication_method=None, prompter_impl): # real signature unknown; restored from __doc__
        """ unregister_impl(self, authentication_method:str=None, prompter_impl:EDataServerUI.CredentialsPrompterImpl) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feac685c3d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CredentialsPrompter), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType ECredentialsPrompter (94353339347760)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'complete_prompt_call': gi.FunctionInfo(complete_prompt_call), 'get_auto_prompt': gi.FunctionInfo(get_auto_prompt), 'get_auto_prompt_disabled_for': gi.FunctionInfo(get_auto_prompt_disabled_for), 'get_dialog_parent': gi.FunctionInfo(get_dialog_parent), 'get_provider': gi.FunctionInfo(get_provider), 'get_registry': gi.FunctionInfo(get_registry), 'loop_prompt_sync': gi.FunctionInfo(loop_prompt_sync), 'process_awaiting_credentials': gi.FunctionInfo(process_awaiting_credentials), 'process_source': gi.FunctionInfo(process_source), 'prompt': gi.FunctionInfo(prompt), 'prompt_finish': gi.FunctionInfo(prompt_finish), 'register_impl': gi.FunctionInfo(register_impl), 'set_auto_prompt': gi.FunctionInfo(set_auto_prompt), 'set_auto_prompt_disabled_for': gi.FunctionInfo(set_auto_prompt_disabled_for), 'unregister_impl': gi.FunctionInfo(unregister_impl), 'do_get_dialog_parent': gi.VFuncInfo(get_dialog_parent), 'parent': <property object at 0x7feac6853a90>, 'priv': <property object at 0x7feac6853bd0>})"
    __gdoc__ = 'Object ECredentialsPrompter\n\nSignals from ECredentialsPrompter:\n  get-dialog-parent () -> GtkWindow\n\nProperties from ECredentialsPrompter:\n  auto-prompt -> gboolean: Auto Prompt\n    Whether can response to credential requests automatically\n  registry -> ESourceRegistry: Registry\n    An ESourceRegistry\n  provider -> ESourceCredentialsProvider: Provider\n    An ESourceCredentialsProvider\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ECredentialsPrompter (94353339347760)>'
    __info__ = ObjectInfo(CredentialsPrompter)


class CredentialsPrompterClass(__gi.Struct):
    """
    :Constructors:
    
    ::
    
        CredentialsPrompterClass()
    """
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    get_dialog_parent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CredentialsPrompterClass), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CredentialsPrompterClass' objects>, '__weakref__': <attribute '__weakref__' of 'CredentialsPrompterClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7feac6853d60>, 'get_dialog_parent': <property object at 0x7feac6853ea0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CredentialsPrompterClass)


class CredentialsPrompterImpl(__gi_repository_EDataServer.Extension):
    """
    :Constructors:
    
    ::
    
        CredentialsPrompterImpl(**properties)
    """
    def bind_property(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def cancel_prompt(self, prompt_id=None): # real signature unknown; restored from __doc__
        """ cancel_prompt(self, prompt_id=None) """
        pass
    ...
    def do_cancel_prompt(self, *args, **kwargs): # real signature unknown
        """ cancel_prompt(self, prompt_id=None) """
        pass

    def do_process_prompt(self, *args, **kwargs): # real signature unknown
        """ process_prompt(self, prompt_id=None, auth_source:EDataServer.Source, cred_source:EDataServer.Source, error_text:str, credentials:EDataServer.NamedParameters) """
        pass

    def do_prompt_finished(self, *args, **kwargs): # real signature unknown
        """ prompt_finished(self, prompt_id=None, credentials:EDataServer.NamedParameters) """
        pass
    ...
    def get_credentials_prompter(self): # real signature unknown; restored from __doc__
        """ get_credentials_prompter(self) """
        pass
    ...
    def prompt(self, prompt_id=None, auth_source, cred_source, error_text=None, credentials): # real signature unknown; restored from __doc__
        """ prompt(self, prompt_id=None, auth_source:EDataServer.Source, cred_source:EDataServer.Source, error_text:str=None, credentials:EDataServer.NamedParameters) """
        pass

    def prompt_finish(self, prompt_id=None, credentials=None): # real signature unknown; restored from __doc__
        """ prompt_finish(self, prompt_id=None, credentials:EDataServer.NamedParameters=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feac68b97f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CredentialsPrompterImpl), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType ECredentialsPrompterImpl (94353339354912)>, '__doc__': None, '__gsignals__': {}, 'cancel_prompt': gi.FunctionInfo(cancel_prompt), 'get_credentials_prompter': gi.FunctionInfo(get_credentials_prompter), 'prompt': gi.FunctionInfo(prompt), 'prompt_finish': gi.FunctionInfo(prompt_finish), 'do_cancel_prompt': gi.VFuncInfo(cancel_prompt), 'do_process_prompt': gi.VFuncInfo(process_prompt), 'do_prompt_finished': gi.VFuncInfo(prompt_finished), 'parent': <property object at 0x7feac6855400>, 'priv': <property object at 0x7feac68554f0>})"
    __gdoc__ = 'Object ECredentialsPrompterImpl\n\nSignals from ECredentialsPrompterImpl:\n  prompt-finished (gpointer, ENamedParameters)\n\nProperties from EExtension:\n  extensible -> EExtensible: Extensible Object\n    The object being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ECredentialsPrompterImpl (94353339354912)>'
    __info__ = ObjectInfo(CredentialsPrompterImpl)


class CredentialsPrompterImplClass(__gi.Struct):
    """
    :Constructors:
    
    ::
    
        CredentialsPrompterImplClass()
    """
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    authentication_methods = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    cancel_prompt = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    process_prompt = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    prompt_finished = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CredentialsPrompterImplClass), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CredentialsPrompterImplClass' objects>, '__weakref__': <attribute '__weakref__' of 'CredentialsPrompterImplClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7feac6855680>, 'authentication_methods': <property object at 0x7feac68557c0>, 'process_prompt': <property object at 0x7feac68558b0>, 'cancel_prompt': <property object at 0x7feac68559a0>, 'prompt_finished': <property object at 0x7feac6855a90>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CredentialsPrompterImplClass)


class CredentialsPrompterImplOAuth2(CredentialsPrompterImpl):
    """
    :Constructors:
    
    ::
    
        CredentialsPrompterImplOAuth2(**properties)
        new() -> EDataServerUI.CredentialsPrompterImpl
    """
    def bind_property(self, *args, **kwargs): # real signature unknown
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feac68a7a90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CredentialsPrompterImplOAuth2), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType ECredentialsPrompterImplOAuth2 (94353339367232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7feac6855c20>, 'priv': <property object at 0x7feac6855d10>})"
    __gdoc__ = 'Object ECredentialsPrompterImplOAuth2\n\nSignals from ECredentialsPrompterImpl:\n  prompt-finished (gpointer, ENamedParameters)\n\nProperties from EExtension:\n  extensible -> EExtensible: Extensible Object\n    The object being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ECredentialsPrompterImplOAuth2 (94353339367232)>'
    __info__ = ObjectInfo(CredentialsPrompterImplOAuth2)


class CredentialsPrompterImplOAuth2Class(__gi.Struct):
    """
    :Constructors:
    
    ::
    
        CredentialsPrompterImplOAuth2Class()
    """
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CredentialsPrompterImplOAuth2Class), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CredentialsPrompterImplOAuth2Class' objects>, '__weakref__': <attribute '__weakref__' of 'CredentialsPrompterImplOAuth2Class' objects>, '__doc__': None, 'parent_class': <property object at 0x7feac6855ea0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CredentialsPrompterImplOAuth2Class)


class CredentialsPrompterImplOAuth2Private(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CredentialsPrompterImplOAuth2Private), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CredentialsPrompterImplOAuth2Private' objects>, '__weakref__': <attribute '__weakref__' of 'CredentialsPrompterImplOAuth2Private' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CredentialsPrompterImplOAuth2Private)


class CredentialsPrompterImplPassword(CredentialsPrompterImpl):
    """
    :Constructors:
    
    ::
    
        CredentialsPrompterImplPassword(**properties)
        new() -> EDataServerUI.CredentialsPrompterImpl
    """
    def bind_property(self, *args, **kwargs): # real signature unknown
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7feac6937fa0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CredentialsPrompterImplPassword), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType ECredentialsPrompterImplPassword (94353339372544)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7feac6857130>, 'priv': <property object at 0x7feac6857220>})"
    __gdoc__ = 'Object ECredentialsPrompterImplPassword\n\nSignals from ECredentialsPrompterImpl:\n  prompt-finished (gpointer, ENamedParameters)\n\nProperties from EExtension:\n  extensible -> EExtensible: Extensible Object\n    The object being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ECredentialsPrompterImplPassword (94353339372544)>'
    __info__ = ObjectInfo(CredentialsPrompterImplPassword)


class CredentialsPrompterImplPasswordClass(__gi.Struct):
    """
    :Constructors:
    
    ::
    
        CredentialsPrompterImplPasswordClass()
    """
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CredentialsPrompterImplPasswordClass), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CredentialsPrompterImplPasswordClass' objects>, '__weakref__': <attribute '__weakref__' of 'CredentialsPrompterImplPasswordClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7feac68573b0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CredentialsPrompterImplPasswordClass)


class CredentialsPrompterImplPasswordPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CredentialsPrompterImplPasswordPrivate), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CredentialsPrompterImplPasswordPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'CredentialsPrompterImplPasswordPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CredentialsPrompterImplPasswordPrivate)


class CredentialsPrompterImplPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CredentialsPrompterImplPrivate), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CredentialsPrompterImplPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'CredentialsPrompterImplPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CredentialsPrompterImplPrivate)


class CredentialsPrompterPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(CredentialsPrompterPrivate), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'CredentialsPrompterPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'CredentialsPrompterPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(CredentialsPrompterPrivate)


class CredentialsPrompterPromptFlags(__gobject.GFlags):
    # no doc
    ...
    NONE = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.EDataServerUI', '__dict__': <attribute '__dict__' of 'CredentialsPrompterPromptFlags' objects>, '__doc__': None, '__gtype__': <GType PyEDataServerUICredentialsPrompterPromptFlags (94353339379456)>, '__flags_values__': {0: <flags 0 of type EDataServerUI.CredentialsPrompterPromptFlags>, 1: <flags E_CREDENTIALS_PROMPTER_PROMPT_FLAG_ALLOW_SOURCE_SAVE of type EDataServerUI.CredentialsPrompterPromptFlags>, 2: <flags E_CREDENTIALS_PROMPTER_PROMPT_FLAG_ALLOW_STORED_CREDENTIALS of type EDataServerUI.CredentialsPrompterPromptFlags>}, '__info__': gi.EnumInfo(CredentialsPrompterPromptFlags), 'NONE': <flags 0 of type EDataServerUI.CredentialsPrompterPromptFlags>, 'ALLOW_SOURCE_SAVE': <flags E_CREDENTIALS_PROMPTER_PROMPT_FLAG_ALLOW_SOURCE_SAVE of type EDataServerUI.CredentialsPrompterPromptFlags>, 'ALLOW_STORED_CREDENTIALS': <flags E_CREDENTIALS_PROMPTER_PROMPT_FLAG_ALLOW_STORED_CREDENTIALS of type EDataServerUI.CredentialsPrompterPromptFlags>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType PyEDataServerUICredentialsPrompterPromptFlags (94353339379456)>'
    __info__ = gi.EnumInfo(CredentialsPrompterPromptFlags)


class RemindersWidget(__gi_repository_Gtk.Grid, __gi_repository_EDataServer.Extensible):
    """
    :Constructors:
    
    ::
    
        RemindersWidget(**properties)
        new(watcher:ECal.ReminderWatcher) -> EDataServerUI.RemindersWidget
    """
    ...
    def do_activated(self, *args, **kwargs): # real signature unknown
        """ activated(self, rd:ECal.ReminderData) -> bool """
        pass
    ...
    def get_settings(self): # real signature unknown; restored from __doc__
        """ get_settings(self) -> Gio.Settings """
        pass
    ...
    def get_watcher(self): # real signature unknown; restored from __doc__
        """ get_watcher(self) -> ECal.ReminderWatcher """
        pass
    ...
    def new(self, watcher): # real signature unknown; restored from __doc__
        """ new(watcher:ECal.ReminderWatcher) -> EDataServerUI.RemindersWidget """
        pass
    ...
    def report_error(self, prefix=None, error=None): # real signature unknown; restored from __doc__
        """ report_error(self, prefix:str=None, error:error=None) """
        pass
...
class RemindersWidgetClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(RemindersWidgetClass), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'RemindersWidgetClass' objects>, '__weakref__': <attribute '__weakref__' of 'RemindersWidgetClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7feac685b270>, 'changed': <property object at 0x7feac685b360>, 'activated': <property object at 0x7feac685b450>, 'reserved': <property object at 0x7feac685b540>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(RemindersWidgetClass)


class RemindersWidgetPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(RemindersWidgetPrivate), '__module__': 'gi.repository.EDataServerUI', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'RemindersWidgetPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'RemindersWidgetPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(RemindersWidgetPrivate)
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7feac7d341f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7feac7d34280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7feac7d34310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7feac7d343a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7feac8970d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/EDataServerUI-1.2.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.EDataServerUI', loader=<gi.importer.DynamicImporter object at 0x7feac8970d00>)"
