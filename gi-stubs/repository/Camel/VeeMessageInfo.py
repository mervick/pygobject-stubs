...
class VeeMessageInfo(MessageInfo):
    """
    :Constructors:
    
    ::
    
        VeeMessageInfo(**properties)
        new(summary:Camel.FolderSummary, original_summary:Camel.FolderSummary, vuid:str) -> Camel.MessageInfo
    """
    ...
    def get_original_folder(self): # real signature unknown; restored from __doc__
        """ get_original_folder(self) -> Camel.Folder """
        pass

    def get_original_summary(self): # real signature unknown; restored from __doc__
        """ get_original_summary(self) -> Camel.FolderSummary """
        pass
    ...
    def new(self, summary, original_summary, vuid): # real signature unknown; restored from __doc__
        """ new(summary:Camel.FolderSummary, original_summary:Camel.FolderSummary, vuid:str) -> Camel.MessageInfo """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b348cd5b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VeeMessageInfo), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelVeeMessageInfo (94124524431120)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_original_folder': gi.FunctionInfo(get_original_folder), 'get_original_summary': gi.FunctionInfo(get_original_summary), 'parent': <property object at 0x7f7b34efdcc0>, 'priv': <property object at 0x7f7b34efddb0>})"
    __gdoc__ = 'Object CamelVeeMessageInfo\n\nProperties from CamelMessageInfo:\n  summary -> CamelFolderSummary: Summary\n  dirty -> gboolean: Dirty\n  folder-flagged -> gboolean: Folder Flagged\n  folder-flagged-stamp -> guint: Folder Flagged Stamp\n  abort-notifications -> gboolean: Abort Notifications\n  uid -> gchararray: UID\n  flags -> guint: Flags\n  user-flags -> CamelNamedFlags: User Flags\n  user-tags -> CamelNameValueArray: User tags\n  subject -> gchararray: Subject\n  from -> gchararray: From\n  to -> gchararray: To\n  cc -> gchararray: CC\n  mlist -> gchararray: mlist\n  size -> guint: Size\n  date-sent -> gint64: Date Sent\n  date-received -> gint64: Date Received\n  message-id -> guint64: Message ID\n  references -> GArray: References\n  headers -> CamelNameValueArray: Headers\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelVeeMessageInfo (94124524431120)>'
    __info__ = ObjectInfo(VeeMessageInfo)
