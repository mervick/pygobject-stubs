...
class MimePart(Medium):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34c04670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MimePart), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelMimePart (94124523759344)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'construct_content_from_parser': gi.FunctionInfo(construct_content_from_parser), 'construct_from_parser': gi.FunctionInfo(construct_from_parser), 'construct_from_parser_finish': gi.FunctionInfo(construct_from_parser_finish), 'construct_from_parser_sync': gi.FunctionInfo(construct_from_parser_sync), 'get_content_disposition': gi.FunctionInfo(get_content_disposition), 'get_content_id': gi.FunctionInfo(get_content_id), 'get_content_languages': gi.FunctionInfo(get_content_languages), 'get_content_location': gi.FunctionInfo(get_content_location), 'get_content_md5': gi.FunctionInfo(get_content_md5), 'get_content_type': gi.FunctionInfo(get_content_type), 'get_description': gi.FunctionInfo(get_description), 'get_disposition': gi.FunctionInfo(get_disposition), 'get_encoding': gi.FunctionInfo(get_encoding), 'get_filename': gi.FunctionInfo(get_filename), 'set_content': gi.FunctionInfo(set_content), 'set_content_id': gi.FunctionInfo(set_content_id), 'set_content_languages': gi.FunctionInfo(set_content_languages), 'set_content_location': gi.FunctionInfo(set_content_location), 'set_content_md5': gi.FunctionInfo(set_content_md5), 'set_content_type': gi.FunctionInfo(set_content_type), 'set_description': gi.FunctionInfo(set_description), 'set_disposition': gi.FunctionInfo(set_disposition), 'set_encoding': gi.FunctionInfo(set_encoding), 'set_filename': gi.FunctionInfo(set_filename), 'do_construct_from_parser_sync': gi.VFuncInfo(construct_from_parser_sync), 'parent': <property object at 0x7f7b34f96270>, 'priv': <property object at 0x7f7b34f963b0>})"
    __gdoc__ = 'Object CamelMimePart\n\nProperties from CamelMimePart:\n  content-id -> gchararray: Content ID\n  content-md5 -> gchararray: Content MD5\n  description -> gchararray: Description\n  disposition -> gchararray: Disposition\n\nProperties from CamelMedium:\n  content -> CamelDataWrapper: Content\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelMimePart (94124523759344)>'
    __info__ = ObjectInfo(MimePart)
