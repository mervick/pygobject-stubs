...
class StreamNull(Stream):
    """
    :Constructors:
    
    ::
    
        StreamNull(**properties)
        new() -> Camel.Stream
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b348cd460>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamNull), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelStreamNull (94124523963232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_bytes_written': gi.FunctionInfo(get_bytes_written), 'get_ends_with_crlf': gi.FunctionInfo(get_ends_with_crlf), 'parent': <property object at 0x7f7b34f68a40>, 'priv': <property object at 0x7f7b34f68b30>})"
    __gdoc__ = 'Object CamelStreamNull\n\nProperties from CamelStream:\n  base-stream -> GIOStream: Base Stream\n    The base GIOStream\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelStreamNull (94124523963232)>'
    __info__ = ObjectInfo(StreamNull)
