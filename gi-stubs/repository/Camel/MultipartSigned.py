...
class MultipartSigned(Multipart):
    ...
    ::
        ...
        MultipartSigned(**properties)
        new() -> Camel.MultipartSigned
    """
    ...
    def get_content_stream(self): # real signature unknown; restored from __doc__
        """ get_content_stream(self) -> Camel.Stream """
        pass
    ...
    def set_content_stream(self, content_stream): # real signature unknown; restored from __doc__
        """ set_content_stream(self, content_stream:Camel.Stream) """
        pass
    ...
    def set_signature(self, signature): # real signature unknown; restored from __doc__
        """ set_signature(self, signature:Camel.MimePart) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34adf190>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MultipartSigned), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelMultipartSigned (94124524016976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_content_stream': gi.FunctionInfo(get_content_stream), 'set_content_stream': gi.FunctionInfo(set_content_stream), 'set_signature': gi.FunctionInfo(set_signature), 'parent': <property object at 0x7f7b34f9e9f0>, 'priv': <property object at 0x7f7b34f9eae0>})"
    __gdoc__ = 'Object CamelMultipartSigned\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelMultipartSigned (94124524016976)>'
    __info__ = ObjectInfo(MultipartSigned)
