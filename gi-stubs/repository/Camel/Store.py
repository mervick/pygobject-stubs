...
class Store(Service):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34d217c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Store), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelStore (94124524058496)>, '__doc__': None, '__gsignals__': {}, 'error_quark': gi.FunctionInfo(error_quark), 'can_refresh_folder': gi.FunctionInfo(can_refresh_folder), 'create_folder': gi.FunctionInfo(create_folder), 'create_folder_finish': gi.FunctionInfo(create_folder_finish), 'create_folder_sync': gi.FunctionInfo(create_folder_sync), 'delete_cached_folder': gi.FunctionInfo(delete_cached_folder), 'delete_folder': gi.FunctionInfo(delete_folder), 'delete_folder_finish': gi.FunctionInfo(delete_folder_finish), 'delete_folder_sync': gi.FunctionInfo(delete_folder_sync), 'dup_opened_folders': gi.FunctionInfo(dup_opened_folders), 'folder_created': gi.FunctionInfo(folder_created), 'folder_deleted': gi.FunctionInfo(folder_deleted), 'folder_info_stale': gi.FunctionInfo(folder_info_stale), 'folder_opened': gi.FunctionInfo(folder_opened), 'folder_renamed': gi.FunctionInfo(folder_renamed), 'get_db': gi.FunctionInfo(get_db), 'get_flags': gi.FunctionInfo(get_flags), 'get_folder': gi.FunctionInfo(get_folder), 'get_folder_finish': gi.FunctionInfo(get_folder_finish), 'get_folder_info': gi.FunctionInfo(get_folder_info), 'get_folder_info_finish': gi.FunctionInfo(get_folder_info_finish), 'get_folder_info_sync': gi.FunctionInfo(get_folder_info_sync), 'get_folder_sync': gi.FunctionInfo(get_folder_sync), 'get_folders_bag': gi.FunctionInfo(get_folders_bag), 'get_inbox_folder': gi.FunctionInfo(get_inbox_folder), 'get_inbox_folder_finish': gi.FunctionInfo(get_inbox_folder_finish), 'get_inbox_folder_sync': gi.FunctionInfo(get_inbox_folder_sync), 'get_junk_folder': gi.FunctionInfo(get_junk_folder), 'get_junk_folder_finish': gi.FunctionInfo(get_junk_folder_finish), 'get_junk_folder_sync': gi.FunctionInfo(get_junk_folder_sync), 'get_permissions': gi.FunctionInfo(get_permissions), 'get_trash_folder': gi.FunctionInfo(get_trash_folder), 'get_trash_folder_finish': gi.FunctionInfo(get_trash_folder_finish), 'get_trash_folder_sync': gi.FunctionInfo(get_trash_folder_sync), 'initial_setup': gi.FunctionInfo(initial_setup), 'initial_setup_finish': gi.FunctionInfo(initial_setup_finish), 'initial_setup_sync': gi.FunctionInfo(initial_setup_sync), 'maybe_run_db_maintenance': gi.FunctionInfo(maybe_run_db_maintenance), 'rename_folder': gi.FunctionInfo(rename_folder), 'rename_folder_finish': gi.FunctionInfo(rename_folder_finish), 'rename_folder_sync': gi.FunctionInfo(rename_folder_sync), 'set_flags': gi.FunctionInfo(set_flags), 'set_permissions': gi.FunctionInfo(set_permissions), 'synchronize': gi.FunctionInfo(synchronize), 'synchronize_finish': gi.FunctionInfo(synchronize_finish), 'synchronize_sync': gi.FunctionInfo(synchronize_sync), 'do_can_refresh_folder': gi.VFuncInfo(can_refresh_folder), 'do_create_folder_sync': gi.VFuncInfo(create_folder_sync), 'do_delete_folder_sync': gi.VFuncInfo(delete_folder_sync), 'do_folder_created': gi.VFuncInfo(folder_created), 'do_folder_deleted': gi.VFuncInfo(folder_deleted), 'do_folder_info_stale': gi.VFuncInfo(folder_info_stale), 'do_folder_opened': gi.VFuncInfo(folder_opened), 'do_folder_renamed': gi.VFuncInfo(folder_renamed), 'do_get_folder_info_sync': gi.VFuncInfo(get_folder_info_sync), 'do_get_folder_sync': gi.VFuncInfo(get_folder_sync), 'do_get_inbox_folder_sync': gi.VFuncInfo(get_inbox_folder_sync), 'do_get_junk_folder_sync': gi.VFuncInfo(get_junk_folder_sync), 'do_get_trash_folder_sync': gi.VFuncInfo(get_trash_folder_sync), 'do_initial_setup_sync': gi.VFuncInfo(initial_setup_sync), 'do_rename_folder_sync': gi.VFuncInfo(rename_folder_sync), 'do_synchronize_sync': gi.VFuncInfo(synchronize_sync), 'parent': <property object at 0x7f7b34f2dae0>, 'priv': <property object at 0x7f7b34f2db80>})"
    __gdoc__ = 'Object CamelStore\n\nSignals from CamelStore:\n  folder-created (CamelFolderInfo)\n  folder-deleted (CamelFolderInfo)\n  folder-info-stale ()\n  folder-opened (CamelFolder)\n  folder-renamed (gchararray, CamelFolderInfo)\n\nProperties from CamelService:\n  connection-status -> CamelServiceConnectionStatus: Connection Status\n    The connection status for the service\n  display-name -> gchararray: Display Name\n    The display name for the service\n  password -> gchararray: Password\n    The password for the service\n  provider -> CamelProvider: Provider\n    The CamelProvider for the service\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    The proxy resolver for the service\n  session -> CamelSession: Session\n    A CamelSession instance\n  settings -> CamelSettings: Settings\n    A CamelSettings instance\n  uid -> gchararray: UID\n    The unique identity of the service\n\nProperties from CamelObject:\n  state-filename -> gchararray: State Filename\n    File containing persistent property values\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelStore (94124524058496)>'
