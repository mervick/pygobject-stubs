...
class OfflineFolder(Folder):
    """
    :Constructors:
    
    ::
    
        OfflineFolder(**properties)
    """
    ...
    def can_downsync(self): # real signature unknown; restored from __doc__
        """ can_downsync(self) -> bool """
        return False
    ...
    def downsync(self, expression, io_priority, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ downsync(self, expression:str, io_priority:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def downsync_finish(self, result): # real signature unknown; restored from __doc__
        """ downsync_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def downsync_sync(self, expression, cancellable=None): # real signature unknown; restored from __doc__
        """ downsync_sync(self, expression:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def do_downsync_sync(self, *args, **kwargs): # real signature unknown
        """ downsync_sync(self, expression:str, cancellable:Gio.Cancellable=None) -> bool """
        pass
    ...
    def get_offline_sync(self): # real signature unknown; restored from __doc__
        """ get_offline_sync(self) -> Camel.ThreeState """
        pass
    ...
    def set_offline_sync(self, offline_sync): # real signature unknown; restored from __doc__
        """ set_offline_sync(self, offline_sync:Camel.ThreeState) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34c04700>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OfflineFolder), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelOfflineFolder (94124524052224)>, '__doc__': None, '__gsignals__': {}, 'can_downsync': gi.FunctionInfo(can_downsync), 'downsync': gi.FunctionInfo(downsync), 'downsync_finish': gi.FunctionInfo(downsync_finish), 'downsync_sync': gi.FunctionInfo(downsync_sync), 'get_offline_sync': gi.FunctionInfo(get_offline_sync), 'set_offline_sync': gi.FunctionInfo(set_offline_sync), 'do_downsync_sync': gi.VFuncInfo(downsync_sync), 'parent': <property object at 0x7f7b34fa6860>, 'priv': <property object at 0x7f7b34fa6950>})"
    __gdoc__ = "Object CamelOfflineFolder\n\nProperties from CamelOfflineFolder:\n  offline-sync -> CamelThreeState: Offline Sync\n    Copy folder content locally for _offline operation\n\nSignals from CamelFolder:\n  changed (CamelFolderChangeInfo)\n  deleted ()\n  renamed (gchararray)\n\nProperties from CamelFolder:\n  description -> gchararray: Description\n    The folder's description\n  display-name -> gchararray: Display Name\n    The folder's display name\n  full-name -> gchararray: Full Name\n    The folder's fully qualified name\n  parent-store -> CamelStore: Parent Store\n    The store to which the folder belongs\n  mark-seen -> CamelThreeState: Mark Seen\n    Mark messages as read after N seconds\n  mark-seen-timeout -> gint: Mark Seen Timeout\n    Mark seen timeout\n\nProperties from CamelObject:\n  state-filename -> gchararray: State Filename\n    File containing persistent property values\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelOfflineFolder (94124524052224)>'
    __info__ = ObjectInfo(OfflineFolder)
