...
class DataWrapper(__gi_overrides_GObject.Object):
    """
    :Constructors:
    
    ::
    
        DataWrapper(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34f18940>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DataWrapper), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelDataWrapper (94124523605360)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'calculate_decoded_size_sync': gi.FunctionInfo(calculate_decoded_size_sync), 'calculate_size_sync': gi.FunctionInfo(calculate_size_sync), 'construct_from_input_stream': gi.FunctionInfo(construct_from_input_stream), 'construct_from_input_stream_finish': gi.FunctionInfo(construct_from_input_stream_finish), 'construct_from_input_stream_sync': gi.FunctionInfo(construct_from_input_stream_sync), 'construct_from_stream': gi.FunctionInfo(construct_from_stream), 'construct_from_stream_finish': gi.FunctionInfo(construct_from_stream_finish), 'construct_from_stream_sync': gi.FunctionInfo(construct_from_stream_sync), 'decode_to_output_stream': gi.FunctionInfo(decode_to_output_stream), 'decode_to_output_stream_finish': gi.FunctionInfo(decode_to_output_stream_finish), 'decode_to_output_stream_sync': gi.FunctionInfo(decode_to_output_stream_sync), 'decode_to_stream': gi.FunctionInfo(decode_to_stream), 'decode_to_stream_finish': gi.FunctionInfo(decode_to_stream_finish), 'decode_to_stream_sync': gi.FunctionInfo(decode_to_stream_sync), 'get_byte_array': gi.FunctionInfo(get_byte_array), 'get_encoding': gi.FunctionInfo(get_encoding), 'get_mime_type': gi.FunctionInfo(get_mime_type), 'get_mime_type_field': gi.FunctionInfo(get_mime_type_field), 'is_offline': gi.FunctionInfo(is_offline), 'set_encoding': gi.FunctionInfo(set_encoding), 'set_mime_type': gi.FunctionInfo(set_mime_type), 'set_mime_type_field': gi.FunctionInfo(set_mime_type_field), 'set_offline': gi.FunctionInfo(set_offline), 'take_mime_type_field': gi.FunctionInfo(take_mime_type_field), 'write_to_output_stream': gi.FunctionInfo(write_to_output_stream), 'write_to_output_stream_finish': gi.FunctionInfo(write_to_output_stream_finish), 'write_to_output_stream_sync': gi.FunctionInfo(write_to_output_stream_sync), 'write_to_stream': gi.FunctionInfo(write_to_stream), 'write_to_stream_finish': gi.FunctionInfo(write_to_stream_finish), 'write_to_stream_sync': gi.FunctionInfo(write_to_stream_sync), 'do_construct_from_input_stream_sync': gi.VFuncInfo(construct_from_input_stream_sync), 'do_construct_from_stream_sync': gi.VFuncInfo(construct_from_stream_sync), 'do_decode_to_output_stream_sync': gi.VFuncInfo(decode_to_output_stream_sync), 'do_decode_to_stream_sync': gi.VFuncInfo(decode_to_stream_sync), 'do_get_mime_type': gi.VFuncInfo(get_mime_type), 'do_get_mime_type_field': gi.VFuncInfo(get_mime_type_field), 'do_is_offline': gi.VFuncInfo(is_offline), 'do_set_mime_type': gi.VFuncInfo(set_mime_type), 'do_set_mime_type_field': gi.VFuncInfo(set_mime_type_field), 'do_write_to_output_stream_sync': gi.VFuncInfo(write_to_output_stream_sync), 'do_write_to_stream_sync': gi.VFuncInfo(write_to_stream_sync), 'parent': <property object at 0x7f7b34fb6130>, 'priv': <property object at 0x7f7b34fb6310>})"
    __gdoc__ = 'Object CamelDataWrapper\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelDataWrapper (94124523605360)>'
    __info__ = ObjectInfo(DataWrapper)
