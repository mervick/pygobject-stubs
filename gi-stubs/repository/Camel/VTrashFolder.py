...
class VTrashFolder(VeeFolder):
    """
    :Constructors:
    
    ::
    
        VTrashFolder(**properties)
        new(parent_store:Camel.Store, type:Camel.VTrashFolderType) -> Camel.Folder
    """
    ...
    def get_folder_type(self): # real signature unknown; restored from __doc__
        """ get_folder_type(self) -> Camel.VTrashFolderType """
        pass
    ...
    def new(self, parent_store, type): # real signature unknown; restored from __doc__
        """ new(parent_store:Camel.Store, type:Camel.VTrashFolderType) -> Camel.Folder """
        pass
