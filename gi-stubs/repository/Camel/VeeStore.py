...
class VeeStore(Store):
    ...
    def get_unmatched_enabled(self): # real signature unknown; restored from __doc__
        """ get_unmatched_enabled(self) -> bool """
        return False

    def get_unmatched_folder(self): # real signature unknown; restored from __doc__
        """ get_unmatched_folder(self) """
        pass
    ...
    def get_vee_data_cache(self): # real signature unknown; restored from __doc__
        """ get_vee_data_cache(self) -> Camel.VeeFolder """
        pass
    ...
    def note_subfolder_unused(self, subfolder, unused_by): # real signature unknown; restored from __doc__
        """ note_subfolder_unused(self, subfolder:Camel.Folder, unused_by:Camel.VeeFolder) """
        pass

    def note_subfolder_used(self, subfolder, used_by): # real signature unknown; restored from __doc__
        """ note_subfolder_used(self, subfolder:Camel.Folder, used_by:Camel.VeeFolder) """
        pass

    def note_vuid_unused(self, mi_data, unused_by): # real signature unknown; restored from __doc__
        """ note_vuid_unused(self, mi_data:Camel.VeeMessageInfoData, unused_by:Camel.VeeFolder) """
        pass

    def note_vuid_used(self, mi_data, used_by): # real signature unknown; restored from __doc__
        """ note_vuid_used(self, mi_data:Camel.VeeMessageInfoData, used_by:Camel.VeeFolder) """
        pass
    ...
    def rebuild_unmatched_folder(self, cancellable=None): # real signature unknown; restored from __doc__
        """ rebuild_unmatched_folder(self, cancellable:Gio.Cancellable=None) """
        pass
    ...
    def set_unmatched_enabled(self, is_enabled): # real signature unknown; restored from __doc__
        """ set_unmatched_enabled(self, is_enabled:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34a0b880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VeeStore), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelVeeStore (94124524427120)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_unmatched_enabled': gi.FunctionInfo(get_unmatched_enabled), 'get_unmatched_folder': gi.FunctionInfo(get_unmatched_folder), 'get_vee_data_cache': gi.FunctionInfo(get_vee_data_cache), 'note_subfolder_unused': gi.FunctionInfo(note_subfolder_unused), 'note_subfolder_used': gi.FunctionInfo(note_subfolder_used), 'note_vuid_unused': gi.FunctionInfo(note_vuid_unused), 'note_vuid_used': gi.FunctionInfo(note_vuid_used), 'rebuild_unmatched_folder': gi.FunctionInfo(rebuild_unmatched_folder), 'set_unmatched_enabled': gi.FunctionInfo(set_unmatched_enabled), 'parent': <property object at 0x7f7b34effd10>, 'priv': <property object at 0x7f7b34effe00>})"
    __gdoc__ = 'Object CamelVeeStore\n\nProperties from CamelVeeStore:\n  unmatched-enabled -> gboolean: Unmatched Enabled\n    Enable _Unmatched folder\n\nSignals from CamelStore:\n  folder-created (CamelFolderInfo)\n  folder-deleted (CamelFolderInfo)\n  folder-info-stale ()\n  folder-opened (CamelFolder)\n  folder-renamed (gchararray, CamelFolderInfo)\n\nProperties from CamelService:\n  connection-status -> CamelServiceConnectionStatus: Connection Status\n    The connection status for the service\n  display-name -> gchararray: Display Name\n    The display name for the service\n  password -> gchararray: Password\n    The password for the service\n  provider -> CamelProvider: Provider\n    The CamelProvider for the service\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    The proxy resolver for the service\n  session -> CamelSession: Session\n    A CamelSession instance\n  settings -> CamelSettings: Settings\n    A CamelSettings instance\n  uid -> gchararray: UID\n    The unique identity of the service\n\nProperties from CamelObject:\n  state-filename -> gchararray: State Filename\n    File containing persistent property values\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelVeeStore (94124524427120)>'
    __info__ = ObjectInfo(VeeStore)
