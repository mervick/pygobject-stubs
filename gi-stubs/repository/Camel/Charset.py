...
class Charset(__gi.Struct):
    ...
    ::
        ...
        Charset()
    """
    def best(self, in_): # real signature unknown; restored from __doc__
        """ best(in_:list) -> str or None """
        return ""
    ...
    def step(self, in_): # real signature unknown; restored from __doc__
        """ step(self, in_:list) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Charset), '__module__': 'gi.repository.Camel', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Charset' objects>, '__weakref__': <attribute '__weakref__' of 'Charset' objects>, '__doc__': None, 'mask': <property object at 0x7f7b37532c70>, 'level': <property object at 0x7f7b37532d60>, 'best_name': gi.FunctionInfo(best_name), 'init': gi.FunctionInfo(init), 'step': gi.FunctionInfo(step), 'best': gi.FunctionInfo(best), 'iso_to_windows': gi.FunctionInfo(iso_to_windows)})"
