...
class MultipartEncrypted(Multipart):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34c2dac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MultipartEncrypted), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelMultipartEncrypted (94124524016704)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7f7b34f9e220>, 'priv': <property object at 0x7f7b34f9e310>})"
    __gdoc__ = 'Object CamelMultipartEncrypted\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelMultipartEncrypted (94124524016704)>'
