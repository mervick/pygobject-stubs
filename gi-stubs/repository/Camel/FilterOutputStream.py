...
class FilterOutputStream(__gi_repository_Gio.FilterOutputStream):
    """
    :Constructors:
    ...
    ::
        ...
        new(base_stream:Gio.OutputStream, filter:Camel.MimeFilter) -> Gio.OutputStream
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FilterOutputStream), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelFilterOutputStream (94124523638768)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_filter': gi.FunctionInfo(get_filter), 'parent': <property object at 0x7f7b34fc2130>, 'priv': <property object at 0x7f7b34fc2220>})"
    __gdoc__ = 'Object CamelFilterOutputStream\n\nProperties from CamelFilterOutputStream:\n  filter -> CamelMimeFilter: Filter\n    The MIME filter object\n\nProperties from GFilterOutputStream:\n  base-stream -> GOutputStream: The Filter Base Stream\n    The underlying base stream on which the io ops will be done.\n  close-base-stream -> gboolean: Close Base Stream\n    If the base stream should be closed when the filter stream is closed.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelFilterOutputStream (94124523638768)>'
