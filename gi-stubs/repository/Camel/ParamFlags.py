...
class ParamFlags(__gobject.GFlags):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Camel', '__dict__': <attribute '__dict__' of 'ParamFlags' objects>, '__doc__': None, '__gtype__': <GType PyCamelParamFlags (94124524078704)>, '__flags_values__': {256: <flags CAMEL_PARAM_PERSISTENT of type Camel.ParamFlags>}, '__info__': gi.EnumInfo(ParamFlags), 'PARAM_PERSISTENT': <flags CAMEL_PARAM_PERSISTENT of type Camel.ParamFlags>})"
    __flags_values__ = {
        256: 256,
    }
    __gtype__ = None # (!) real value is '<GType PyCamelParamFlags (94124524078704)>'
