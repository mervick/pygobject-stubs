...
class Object(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34f29d90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Object), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelObject (94124523646208)>, '__doc__': None, '__gsignals__': {}, 'get_state_filename': gi.FunctionInfo(get_state_filename), 'set_state_filename': gi.FunctionInfo(set_state_filename), 'state_read': gi.FunctionInfo(state_read), 'state_write': gi.FunctionInfo(state_write), 'do_state_read': gi.VFuncInfo(state_read), 'do_state_write': gi.VFuncInfo(state_write), 'parent': <property object at 0x7f7b34fc2860>, 'priv': <property object at 0x7f7b34fc2950>})"
    __gdoc__ = 'Object CamelObject\n\nProperties from CamelObject:\n  state-filename -> gchararray: State Filename\n    File containing persistent property values\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelObject (94124523646208)>'
