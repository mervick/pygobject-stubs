...
class FilterInputStream(__gi_repository_Gio.FilterInputStream):
    """
    :Constructors:
    ...
    ::
        ...
        new(base_stream:Gio.InputStream, filter:Camel.MimeFilter) -> Gio.InputStream
    """
    ...
    def get_filter(self): # real signature unknown; restored from __doc__
        """ get_filter(self) -> Camel.MimeFilter """
        pass
    ...
    def new(self, base_stream, filter): # real signature unknown; restored from __doc__
        """ new(base_stream:Gio.InputStream, filter:Camel.MimeFilter) -> Gio.InputStream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34e2bc40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FilterInputStream), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelFilterInputStream (94124523631392)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_filter': gi.FunctionInfo(get_filter), 'parent': <property object at 0x7f7b34fbf310>, 'priv': <property object at 0x7f7b34fbf400>})"
    __gdoc__ = 'Object CamelFilterInputStream\n\nProperties from CamelFilterInputStream:\n  filter -> CamelMimeFilter: Filter\n    The MIME filter object\n\nProperties from GFilterInputStream:\n  base-stream -> GInputStream: The Filter Base Stream\n    The underlying base stream on which the io ops will be done.\n  close-base-stream -> gboolean: Close Base Stream\n    If the base stream should be closed when the filter stream is closed.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelFilterInputStream (94124523631392)>'
