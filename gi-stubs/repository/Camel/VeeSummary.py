...
class VeeSummary(FolderSummary):
    """
    :Constructors:
    
    ::
    
        VeeSummary(**properties)
        new(parent:Camel.Folder) -> Camel.FolderSummary
    """
    def add(self, mi_data): # real signature unknown; restored from __doc__
        """ add(self, mi_data:Camel.VeeMessageInfoData) -> Camel.VeeMessageInfo """
        pass
    ...
    def get_uids_for_subfolder(self, subfolder): # real signature unknown; restored from __doc__
        """ get_uids_for_subfolder(self, subfolder:Camel.Folder) -> dict """
        return {}
    ...
    def remove(self, vuid, subfolder): # real signature unknown; restored from __doc__
        """ remove(self, vuid:str, subfolder:Camel.Folder) """
        pass
    ...
    def replace_flags(self, uid): # real signature unknown; restored from __doc__
        """ replace_flags(self, uid:str) """
        pass
