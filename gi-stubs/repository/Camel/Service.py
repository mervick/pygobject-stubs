...
class Service(Object, __gi_repository_Gio.Initable):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7b34c2dd30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Service), '__module__': 'gi.repository.Camel', '__gtype__': <GType CamelService (94124524043424)>, '__doc__': None, '__gsignals__': {}, 'error_quark': gi.FunctionInfo(error_quark), 'authenticate': gi.FunctionInfo(authenticate), 'authenticate_finish': gi.FunctionInfo(authenticate_finish), 'authenticate_sync': gi.FunctionInfo(authenticate_sync), 'connect': gi.FunctionInfo(connect), 'connect_finish': gi.FunctionInfo(connect_finish), 'connect_sync': gi.FunctionInfo(connect_sync), 'disconnect': gi.FunctionInfo(disconnect), 'disconnect_finish': gi.FunctionInfo(disconnect_finish), 'disconnect_sync': gi.FunctionInfo(disconnect_sync), 'dup_display_name': gi.FunctionInfo(dup_display_name), 'dup_password': gi.FunctionInfo(dup_password), 'get_connection_status': gi.FunctionInfo(get_connection_status), 'get_display_name': gi.FunctionInfo(get_display_name), 'get_name': gi.FunctionInfo(get_name), 'get_password': gi.FunctionInfo(get_password), 'get_provider': gi.FunctionInfo(get_provider), 'get_uid': gi.FunctionInfo(get_uid), 'get_user_cache_dir': gi.FunctionInfo(get_user_cache_dir), 'get_user_data_dir': gi.FunctionInfo(get_user_data_dir), 'migrate_files': gi.FunctionInfo(migrate_files), 'new_camel_url': gi.FunctionInfo(new_camel_url), 'query_auth_types': gi.FunctionInfo(query_auth_types), 'query_auth_types_finish': gi.FunctionInfo(query_auth_types_finish), 'query_auth_types_sync': gi.FunctionInfo(query_auth_types_sync), 'queue_task': gi.FunctionInfo(queue_task), 'ref_proxy_resolver': gi.FunctionInfo(ref_proxy_resolver), 'ref_session': gi.FunctionInfo(ref_session), 'ref_settings': gi.FunctionInfo(ref_settings), 'set_display_name': gi.FunctionInfo(set_display_name), 'set_password': gi.FunctionInfo(set_password), 'set_proxy_resolver': gi.FunctionInfo(set_proxy_resolver), 'set_settings': gi.FunctionInfo(set_settings), 'do_authenticate_sync': gi.VFuncInfo(authenticate_sync), 'do_connect_sync': gi.VFuncInfo(connect_sync), 'do_disconnect_sync': gi.VFuncInfo(disconnect_sync), 'do_get_name': gi.VFuncInfo(get_name), 'do_query_auth_types_sync': gi.VFuncInfo(query_auth_types_sync), 'parent': <property object at 0x7f7b34faabd0>, 'priv': <property object at 0x7f7b34faad10>})"
    __gdoc__ = 'Object CamelService\n\nProperties from CamelService:\n  connection-status -> CamelServiceConnectionStatus: Connection Status\n    The connection status for the service\n  display-name -> gchararray: Display Name\n    The display name for the service\n  password -> gchararray: Password\n    The password for the service\n  provider -> CamelProvider: Provider\n    The CamelProvider for the service\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    The proxy resolver for the service\n  session -> CamelSession: Session\n    A CamelSession instance\n  settings -> CamelSettings: Settings\n    A CamelSettings instance\n  uid -> gchararray: UID\n    The unique identity of the service\n\nProperties from CamelObject:\n  state-filename -> gchararray: State Filename\n    File containing persistent property values\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CamelService (94124524043424)>'
