...
class Simple(__gi_overrides_GObject.Object, __gi_repository_Gio.AsyncInitable):
    """
    :Constructors:
    ...
    def get_client(self): # real signature unknown; restored from __doc__
        """ get_client(self) -> Geoclue.ClientProxy """
        pass
    ...
    def new(self, desktop_id, accuracy_level, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
    ...
    def new_sync(self, desktop_id, accuracy_level, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(desktop_id:str, accuracy_level:Geoclue.AccuracyLevel, cancellable:Gio.Cancellable=None) -> Geoclue.Simple """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fec082ee880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Simple), '__module__': 'gi.repository.Geoclue', '__gtype__': <GType GClueSimple (94908882144512)>, '__doc__': None, '__gsignals__': {}, 'new_finish': gi.FunctionInfo(new_finish), 'new_sync': gi.FunctionInfo(new_sync), 'new': gi.FunctionInfo(new), 'get_client': gi.FunctionInfo(get_client), 'get_location': gi.FunctionInfo(get_location), 'parent': <property object at 0x7fec083d6590>, 'priv': <property object at 0x7fec083d6680>})"
    __gdoc__ = 'Object GClueSimple\n\nProperties from GClueSimple:\n  desktop-id -> gchararray: DesktopID\n    Desktop ID\n  accuracy-level -> GClueAccuracyLevel: AccuracyLevel\n    Requested accuracy level\n  client -> GClueClientProxy: Client\n    Client proxy\n  location -> GClueLocationProxy: Location\n    Location proxy\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GClueSimple (94908882144512)>'
    __info__ = ObjectInfo(Simple)
