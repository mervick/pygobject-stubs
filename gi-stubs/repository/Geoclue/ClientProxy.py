...
class ClientProxy(__gi_overrides_Gio.DBusProxy, Client):
    """
    :Constructors:
    ...
    def call_start(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_start(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def call_start_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ call_start_sync(self, cancellable:Gio.Cancellable=None) """
        pass

    def call_stop(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_stop(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def call_stop_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ call_stop_sync(self, cancellable:Gio.Cancellable=None) """
        pass
    ...
    def create(self, desktop_id, accuracy_level, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ create(desktop_id:str, accuracy_level:Geoclue.AccuracyLevel, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def create_finish(self, result): # real signature unknown; restored from __doc__
        """ create_finish(result:Gio.AsyncResult) -> Geoclue.ClientProxy """
        pass

    def create_full(self, desktop_id, accuracy_level, flags, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ create_full(desktop_id:str, accuracy_level:Geoclue.AccuracyLevel, flags:Geoclue.ClientProxyCreateFlags, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def create_full_finish(self, result): # real signature unknown; restored from __doc__
        """ create_full_finish(result:Gio.AsyncResult) -> Geoclue.ClientProxy """
        pass

    def create_full_sync(self, desktop_id, accuracy_level, flags, cancellable=None): # real signature unknown; restored from __doc__
        """ create_full_sync(desktop_id:str, accuracy_level:Geoclue.AccuracyLevel, flags:Geoclue.ClientProxyCreateFlags, cancellable:Gio.Cancellable=None) -> Geoclue.ClientProxy """
        pass

    def create_sync(self, desktop_id, accuracy_level, cancellable=None): # real signature unknown; restored from __doc__
        """ create_sync(desktop_id:str, accuracy_level:Geoclue.AccuracyLevel, cancellable:Gio.Cancellable=None) -> Geoclue.ClientProxy """
        pass
    ...
    def emit_location_updated(self, arg_old, arg_new): # real signature unknown; restored from __doc__
        """ emit_location_updated(self, arg_old:str, arg_new:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fec083d9af0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ClientProxy), '__module__': 'gi.repository.Geoclue', '__gtype__': <GType GClueClientProxy (94908881982160)>, '__doc__': None, '__gsignals__': {}, 'new_finish': gi.FunctionInfo(new_finish), 'new_for_bus_finish': gi.FunctionInfo(new_for_bus_finish), 'new_for_bus_sync': gi.FunctionInfo(new_for_bus_sync), 'new_sync': gi.FunctionInfo(new_sync), 'create': gi.FunctionInfo(create), 'create_finish': gi.FunctionInfo(create_finish), 'create_full': gi.FunctionInfo(create_full), 'create_full_finish': gi.FunctionInfo(create_full_finish), 'create_full_sync': gi.FunctionInfo(create_full_sync), 'create_sync': gi.FunctionInfo(create_sync), 'new': gi.FunctionInfo(new), 'new_for_bus': gi.FunctionInfo(new_for_bus), 'parent_instance': <property object at 0x7fec0840c9f0>, 'priv': <property object at 0x7fec0840cae0>})"
    __gdoc__ = 'Object GClueClientProxy\n\nSignals from GClueClient:\n  handle-start (GDBusMethodInvocation) -> gboolean\n  handle-stop (GDBusMethodInvocation) -> gboolean\n  location-updated (gchararray, gchararray)\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GClueClientProxy (94908881982160)>'
    __info__ = ObjectInfo(ClientProxy)
