...
class ClientSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Client):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fec083ba700>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ClientSkeleton), '__module__': 'gi.repository.Geoclue', '__gtype__': <GType GClueClientSkeleton (94908881949696)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fec083cf450>, 'priv': <property object at 0x7fec083cf590>})"
    __gdoc__ = 'Object GClueClientSkeleton\n\nSignals from GClueClient:\n  handle-start (GDBusMethodInvocation) -> gboolean\n  handle-stop (GDBusMethodInvocation) -> gboolean\n  location-updated (gchararray, gchararray)\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GClueClientSkeleton (94908881949696)>'
    __info__ = ObjectInfo(ClientSkeleton)
