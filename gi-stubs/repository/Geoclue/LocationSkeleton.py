...
class LocationSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Location):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fec083af0a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LocationSkeleton), '__module__': 'gi.repository.Geoclue', '__gtype__': <GType GClueLocationSkeleton (94908882061824)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fec083d3810>, 'priv': <property object at 0x7fec083d3950>})"
    __gdoc__ = 'Object GClueLocationSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GClueLocationSkeleton (94908882061824)>'
    __info__ = ObjectInfo(LocationSkeleton)
