...
class FontMetrics(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(FontMetrics), '__module__': 'gi.repository.Pango', '__gtype__': <GType PangoFontMetrics (94187429248656)>, '__dict__': <attribute '__dict__' of 'FontMetrics' objects>, '__weakref__': <attribute '__weakref__' of 'FontMetrics' objects>, '__doc__': None, 'ref_count': <property object at 0x7f85178996d0>, 'ascent': <property object at 0x7f85178997c0>, 'descent': <property object at 0x7f85178998b0>, 'height': <property object at 0x7f85178999a0>, 'approximate_char_width': <property object at 0x7f8517899ae0>, 'approximate_digit_width': <property object at 0x7f8517899c20>, 'underline_position': <property object at 0x7f8517899d60>, 'underline_thickness': <property object at 0x7f8517899ea0>, 'strikethrough_position': <property object at 0x7f851789a040>, 'strikethrough_thickness': <property object at 0x7f851789a180>, 'get_approximate_char_width': gi.FunctionInfo(get_approximate_char_width), 'get_approximate_digit_width': gi.FunctionInfo(get_approximate_digit_width), 'get_ascent': gi.FunctionInfo(get_ascent), 'get_descent': gi.FunctionInfo(get_descent), 'get_height': gi.FunctionInfo(get_height), 'get_strikethrough_position': gi.FunctionInfo(get_strikethrough_position), 'get_strikethrough_thickness': gi.FunctionInfo(get_strikethrough_thickness), 'get_underline_position': gi.FunctionInfo(get_underline_position), 'get_underline_thickness': gi.FunctionInfo(get_underline_thickness), 'ref': gi.FunctionInfo(ref), 'unref': gi.FunctionInfo(unref)})"
    __gtype__ = None # (!) real value is '<GType PangoFontMetrics (94187429248656)>'
