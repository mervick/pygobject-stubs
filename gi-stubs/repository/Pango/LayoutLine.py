...
class LayoutLine(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(LayoutLine), '__module__': 'gi.repository.Pango', '__gtype__': <GType PangoLayoutLine (94187429492304)>, '__dict__': <attribute '__dict__' of 'LayoutLine' objects>, '__weakref__': <attribute '__weakref__' of 'LayoutLine' objects>, '__doc__': None, 'layout': <property object at 0x7f85178a1f40>, 'start_index': <property object at 0x7f85178a4090>, 'length': <property object at 0x7f85178a4180>, 'runs': <property object at 0x7f85178a4270>, 'is_paragraph_start': <property object at 0x7f85178a43b0>, 'resolved_dir': <property object at 0x7f85178a44a0>, 'get_extents': gi.FunctionInfo(get_extents), 'get_height': gi.FunctionInfo(get_height), 'get_pixel_extents': gi.FunctionInfo(get_pixel_extents), 'get_x_ranges': gi.FunctionInfo(get_x_ranges), 'index_to_x': gi.FunctionInfo(index_to_x), 'ref': gi.FunctionInfo(ref), 'unref': gi.FunctionInfo(unref), 'x_to_index': gi.FunctionInfo(x_to_index)})"
    __gtype__ = None # (!) real value is '<GType PangoLayoutLine (94187429492304)>'
