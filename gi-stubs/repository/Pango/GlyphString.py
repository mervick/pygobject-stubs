...
class GlyphString(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(GlyphString), '__module__': 'gi.repository.Pango', '__gtype__': <GType PangoGlyphString (94187429472016)>, '__dict__': <attribute '__dict__' of 'GlyphString' objects>, '__weakref__': <attribute '__weakref__' of 'GlyphString' objects>, '__doc__': None, 'num_glyphs': <property object at 0x7f851789e590>, 'glyphs': <property object at 0x7f851789e680>, 'log_clusters': <property object at 0x7f851789e770>, 'space': <property object at 0x7f851789e860>, 'new': gi.FunctionInfo(new), 'copy': gi.FunctionInfo(copy), 'extents': gi.FunctionInfo(extents), 'extents_range': gi.FunctionInfo(extents_range), 'free': gi.FunctionInfo(free), 'get_logical_widths': gi.FunctionInfo(get_logical_widths), 'get_width': gi.FunctionInfo(get_width), 'index_to_x': gi.FunctionInfo(index_to_x), 'set_size': gi.FunctionInfo(set_size), 'x_to_index': gi.FunctionInfo(x_to_index), '__new__': <staticmethod object at 0x7f8517895fd0>, '__init__': <function nothing at 0x7f8517c2dee0>})"
    __gtype__ = None # (!) real value is '<GType PangoGlyphString (94187429472016)>'
