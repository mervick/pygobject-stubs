...
class LayoutIter(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(LayoutIter), '__module__': 'gi.repository.Pango', '__gtype__': <GType PangoLayoutIter (94752681062704)>, '__dict__': <attribute '__dict__' of 'LayoutIter' objects>, '__weakref__': <attribute '__weakref__' of 'LayoutIter' objects>, '__doc__': None, 'at_last_line': gi.FunctionInfo(at_last_line), 'copy': gi.FunctionInfo(copy), 'free': gi.FunctionInfo(free), 'get_baseline': gi.FunctionInfo(get_baseline), 'get_char_extents': gi.FunctionInfo(get_char_extents), 'get_cluster_extents': gi.FunctionInfo(get_cluster_extents), 'get_index': gi.FunctionInfo(get_index), 'get_layout': gi.FunctionInfo(get_layout), 'get_layout_extents': gi.FunctionInfo(get_layout_extents), 'get_line': gi.FunctionInfo(get_line), 'get_line_extents': gi.FunctionInfo(get_line_extents), 'get_line_readonly': gi.FunctionInfo(get_line_readonly), 'get_line_yrange': gi.FunctionInfo(get_line_yrange), 'get_run': gi.FunctionInfo(get_run), 'get_run_extents': gi.FunctionInfo(get_run_extents), 'get_run_readonly': gi.FunctionInfo(get_run_readonly), 'next_char': gi.FunctionInfo(next_char), 'next_cluster': gi.FunctionInfo(next_cluster), 'next_line': gi.FunctionInfo(next_line), 'next_run': gi.FunctionInfo(next_run)})"
    __gtype__ = None # (!) real value is '<GType PangoLayoutIter (94752681062704)>'
