...
class EngineInfo(__gi.Struct):
    ...
    engine_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    n_scripts = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    render_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
