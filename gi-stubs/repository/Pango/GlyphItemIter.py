...
class GlyphItemIter(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(GlyphItemIter), '__module__': 'gi.repository.Pango', '__gtype__': <GType PangoGlyphItemIter (94187429462896)>, '__dict__': <attribute '__dict__' of 'GlyphItemIter' objects>, '__weakref__': <attribute '__weakref__' of 'GlyphItemIter' objects>, '__doc__': None, 'glyph_item': <property object at 0x7f851789bc70>, 'text': <property object at 0x7f851789bd60>, 'start_glyph': <property object at 0x7f851789be50>, 'start_index': <property object at 0x7f851789bf40>, 'start_char': <property object at 0x7f851789e090>, 'end_glyph': <property object at 0x7f851789e180>, 'end_index': <property object at 0x7f851789e270>, 'end_char': <property object at 0x7f851789e360>, 'copy': gi.FunctionInfo(copy), 'free': gi.FunctionInfo(free), 'init_end': gi.FunctionInfo(init_end), 'init_start': gi.FunctionInfo(init_start), 'next_cluster': gi.FunctionInfo(next_cluster), 'prev_cluster': gi.FunctionInfo(prev_cluster)})"
    __gtype__ = None # (!) real value is '<GType PangoGlyphItemIter (94187429462896)>'
