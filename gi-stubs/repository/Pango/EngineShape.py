...
class EngineShape(Engine):
    ...
    def do_covers(self, *args, **kwargs): # real signature unknown
        """ covers(self, font:Pango.Font, language:Pango.Language, wc:str) -> Pango.CoverageLevel """
        pass

    def do_script_shape(self, *args, **kwargs): # real signature unknown
        """ script_shape(self, font:Pango.Font, item_text:str, item_length:int, analysis:Pango.Analysis, glyphs:Pango.GlyphString, paragraph_text:str, paragraph_length:int) """
        pass
