...
class Matrix(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Matrix), '__module__': 'gi.repository.Pango', '__gtype__': <GType PangoMatrix (94187429506448)>, '__dict__': <attribute '__dict__' of 'Matrix' objects>, '__weakref__': <attribute '__weakref__' of 'Matrix' objects>, '__doc__': None, 'xx': <property object at 0x7f85178a57c0>, 'xy': <property object at 0x7f85178a58b0>, 'yx': <property object at 0x7f85178a59a0>, 'yy': <property object at 0x7f85178a5a90>, 'x0': <property object at 0x7f85178a5b80>, 'y0': <property object at 0x7f85178a5c70>, 'concat': gi.FunctionInfo(concat), 'copy': gi.FunctionInfo(copy), 'free': gi.FunctionInfo(free), 'get_font_scale_factor': gi.FunctionInfo(get_font_scale_factor), 'get_font_scale_factors': gi.FunctionInfo(get_font_scale_factors), 'rotate': gi.FunctionInfo(rotate), 'scale': gi.FunctionInfo(scale), 'transform_distance': gi.FunctionInfo(transform_distance), 'transform_pixel_rectangle': gi.FunctionInfo(transform_pixel_rectangle), 'transform_point': gi.FunctionInfo(transform_point), 'transform_rectangle': gi.FunctionInfo(transform_rectangle), 'translate': gi.FunctionInfo(translate)})"
    __gtype__ = None # (!) real value is '<GType PangoMatrix (94187429506448)>'
