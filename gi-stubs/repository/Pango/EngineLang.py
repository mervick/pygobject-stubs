...
class EngineLang(Engine):
    ...
    def do_script_break(self, *args, **kwargs): # real signature unknown
        """ script_break(self, text:str, len:int, analysis:Pango.Analysis, attrs:Pango.LogAttr, attrs_len:int) """
        pass
