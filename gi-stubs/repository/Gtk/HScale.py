...
class HScale(Scale):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63935f100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HScale), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHScale (93897368666720)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_range': gi.FunctionInfo(new_with_range), 'scale': <property object at 0x7fc63a7414f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHScale (93897368666720)>'
