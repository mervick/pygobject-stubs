...
class HScale(Scale):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HScale), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHScale (94846038452832)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_range': gi.FunctionInfo(new_with_range), 'scale': <property object at 0x7fe83102c720>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHScale (94846038452832)>'
