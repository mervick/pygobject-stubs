...
class SwitchAccessible(WidgetAccessible, __gi_repository_Atk.Action):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6380664c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SwitchAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSwitchAccessible (93897369551552)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a694d10>, 'priv': <property object at 0x7fc63a694e50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSwitchAccessible (93897369551552)>'
