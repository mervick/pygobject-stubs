...
class SwitchAccessible(WidgetAccessible, __gi_repository_Atk.Action):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SwitchAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSwitchAccessible (94846039073520)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830f7e270>, 'priv': <property object at 0x7fe830f7e3b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSwitchAccessible (94846039073520)>'
