...
class CellRendererSpin(CellRendererText):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639d4b4f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererSpin), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererSpin (93897368281808)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fc63a7de8b0>, 'priv': <property object at 0x7fc63a7de9f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererSpin (93897368281808)>'
