...
class CellRendererSpin(CellRendererText):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8305f74f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererSpin), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererSpin (94846038066880)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fe8310c89a0>, 'priv': <property object at 0x7fe8310c8ae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererSpin (94846038066880)>'
