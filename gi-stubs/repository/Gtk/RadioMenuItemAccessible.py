...
class RadioMenuItemAccessible(CheckMenuItemAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fdfd280>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioMenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioMenuItemAccessible (94846038329904)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830fa8130>, 'priv': <property object at 0x7fe830fa8270>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioMenuItemAccessible (94846038329904)>'
