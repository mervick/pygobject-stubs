...
class RadioMenuItemAccessible(CheckMenuItemAccessible):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioMenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioMenuItemAccessible (93897368545840)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6bcef0>, 'priv': <property object at 0x7fc63a6bf090>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioMenuItemAccessible (93897368545840)>'
