...
class AppChooserButton(__gi_overrides_Gtk.ComboBox, AppChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e14eb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AppChooserButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAppChooserButton (94846036815680)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'append_custom_item': gi.FunctionInfo(append_custom_item), 'append_separator': gi.FunctionInfo(append_separator), 'get_heading': gi.FunctionInfo(get_heading), 'get_show_default_item': gi.FunctionInfo(get_show_default_item), 'get_show_dialog_item': gi.FunctionInfo(get_show_dialog_item), 'set_active_custom_item': gi.FunctionInfo(set_active_custom_item), 'set_heading': gi.FunctionInfo(set_heading), 'set_show_default_item': gi.FunctionInfo(set_show_default_item), 'set_show_dialog_item': gi.FunctionInfo(set_show_dialog_item), 'do_custom_item_activated': gi.VFuncInfo(custom_item_activated), 'parent': <property object at 0x7fe83110b770>, 'priv': <property object at 0x7fe83110b8b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAppChooserButton (94846036815680)>'
