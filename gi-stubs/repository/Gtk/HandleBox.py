...
class HandleBox(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e38160>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HandleBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHandleBox (94846038497280)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_child_detached': gi.FunctionInfo(get_child_detached), 'get_handle_position': gi.FunctionInfo(get_handle_position), 'get_shadow_type': gi.FunctionInfo(get_shadow_type), 'get_snap_edge': gi.FunctionInfo(get_snap_edge), 'set_handle_position': gi.FunctionInfo(set_handle_position), 'set_shadow_type': gi.FunctionInfo(set_shadow_type), 'set_snap_edge': gi.FunctionInfo(set_snap_edge), 'do_child_attached': gi.VFuncInfo(child_attached), 'do_child_detached': gi.VFuncInfo(child_detached), 'bin': <property object at 0x7fe8310314a0>, 'priv': <property object at 0x7fe831031590>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHandleBox (94846038497280)>'
