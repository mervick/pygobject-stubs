...
class FontButton(__gi_overrides_Gtk.Button, FontChooser):
    ...
    def new_with_font(self, fontname): # real signature unknown; restored from __doc__
        """ new_with_font(fontname:str) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8305f7b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontButton (94846038354768)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_font': gi.FunctionInfo(new_with_font), 'get_font_name': gi.FunctionInfo(get_font_name), 'get_show_size': gi.FunctionInfo(get_show_size), 'get_show_style': gi.FunctionInfo(get_show_style), 'get_title': gi.FunctionInfo(get_title), 'get_use_font': gi.FunctionInfo(get_use_font), 'get_use_size': gi.FunctionInfo(get_use_size), 'set_font_name': gi.FunctionInfo(set_font_name), 'set_show_size': gi.FunctionInfo(set_show_size), 'set_show_style': gi.FunctionInfo(set_show_style), 'set_title': gi.FunctionInfo(set_title), 'set_use_font': gi.FunctionInfo(set_use_font), 'set_use_size': gi.FunctionInfo(set_use_size), 'do_font_set': gi.VFuncInfo(font_set), 'button': <property object at 0x7fe831095770>, 'priv': <property object at 0x7fe831095810>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontButton (94846038354768)>'
