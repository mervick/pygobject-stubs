...
class FontButton(__gi_overrides_Gtk.Button, FontChooser):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontButton (93897368571648)>'
