...
class Fixed(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830ac24f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Fixed), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFixed (94846038318000)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'move': gi.FunctionInfo(move), 'put': gi.FunctionInfo(put), 'container': <property object at 0x7fe83108e4f0>, 'priv': <property object at 0x7fe83108e5e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFixed (94846038318000)>'
