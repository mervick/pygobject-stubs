...
class FlowBoxAccessible(ContainerAccessible, __gi_repository_Atk.Selection):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FlowBoxAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFlowBoxAccessible (94846038000400)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe83108f720>, 'priv': <property object at 0x7fe83108f860>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBoxAccessible (94846038000400)>'
