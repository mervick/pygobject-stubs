...
class FontSelection(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830cfae20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontSelection), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontSelection (94846038389248)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_face': gi.FunctionInfo(get_face), 'get_face_list': gi.FunctionInfo(get_face_list), 'get_family': gi.FunctionInfo(get_family), 'get_family_list': gi.FunctionInfo(get_family_list), 'get_font_name': gi.FunctionInfo(get_font_name), 'get_preview_entry': gi.FunctionInfo(get_preview_entry), 'get_preview_text': gi.FunctionInfo(get_preview_text), 'get_size': gi.FunctionInfo(get_size), 'get_size_entry': gi.FunctionInfo(get_size_entry), 'get_size_list': gi.FunctionInfo(get_size_list), 'set_font_name': gi.FunctionInfo(set_font_name), 'set_preview_text': gi.FunctionInfo(set_preview_text), 'parent_instance': <property object at 0x7fe83109c630>, 'priv': <property object at 0x7fe83109c720>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontSelection (94846038389248)>'
