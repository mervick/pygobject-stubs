...
class ListBoxRowAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a667700>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ListBoxRowAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkListBoxRowAccessible (93897368889888)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6f5b30>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkListBoxRowAccessible (93897368889888)>'
