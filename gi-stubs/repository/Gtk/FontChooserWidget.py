...
class FontChooserWidget(__gi_overrides_Gtk.Box, FontChooser):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontChooserWidget (93897368597952)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fc63a7b05e0>, 'priv': <property object at 0x7fc63a7b06d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontChooserWidget (93897368597952)>'
