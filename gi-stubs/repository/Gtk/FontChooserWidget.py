...
class FontChooserWidget(__gi_overrides_Gtk.Box, FontChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe83113bac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontChooserWidget (94846038371104)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fe8310998b0>, 'priv': <property object at 0x7fe8310999a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontChooserWidget (94846038371104)>'
