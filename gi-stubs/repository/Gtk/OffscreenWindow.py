...
class OffscreenWindow(__gi_overrides_Gtk.Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc638b9f3a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OffscreenWindow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkOffscreenWindow (93897369009712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_pixbuf': gi.FunctionInfo(get_pixbuf), 'get_surface': gi.FunctionInfo(get_surface), 'parent_object': <property object at 0x7fc63a714e50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkOffscreenWindow (93897369009712)>'
