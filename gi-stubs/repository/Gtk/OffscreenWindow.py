...
class OffscreenWindow(__gi_overrides_Gtk.Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82f61cbb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OffscreenWindow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkOffscreenWindow (94846038794896)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_pixbuf': gi.FunctionInfo(get_pixbuf), 'get_surface': gi.FunctionInfo(get_surface), 'parent_object': <property object at 0x7fe830ffff90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkOffscreenWindow (94846038794896)>'
