...
class ComboBoxText(__gi_overrides_Gtk.ComboBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830576ca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ComboBoxText), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkComboBoxText (94846038139456)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_entry': gi.FunctionInfo(new_with_entry), 'append': gi.FunctionInfo(append), 'append_text': gi.FunctionInfo(append_text), 'get_active_text': gi.FunctionInfo(get_active_text), 'insert': gi.FunctionInfo(insert), 'insert_text': gi.FunctionInfo(insert_text), 'prepend': gi.FunctionInfo(prepend), 'prepend_text': gi.FunctionInfo(prepend_text), 'remove': gi.FunctionInfo(remove), 'remove_all': gi.FunctionInfo(remove_all), 'parent_instance': <property object at 0x7fe831061040>, 'priv': <property object at 0x7fe831061130>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkComboBoxText (94846038139456)>'
