...
class EntryAccessible(WidgetAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.EditableText, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830576fd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EntryAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEntryAccessible (94846038195904)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe831076360>, 'priv': <property object at 0x7fe8310764a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEntryAccessible (94846038195904)>'
