...
class VScale(Scale):
    ...
    def new(self, adjustment): # real signature unknown; restored from __doc__
        """ new(adjustment:Gtk.Adjustment) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e8d60a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VScale), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVScale (94846039605840)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_range': gi.FunctionInfo(new_with_range), 'scale': <property object at 0x7fe830f3ea40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVScale (94846039605840)>'
