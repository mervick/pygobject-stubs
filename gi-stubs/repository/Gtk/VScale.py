...
class VScale(Scale):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc637df1f70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VScale), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVScale (93897369808064)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_range': gi.FunctionInfo(new_with_range), 'scale': <property object at 0x7fc63a658220>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVScale (93897369808064)>'
