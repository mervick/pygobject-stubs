...
class FontChooserDialog(__gi_overrides_Gtk.Dialog, FontChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e141f0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontChooserDialog (94846038186736)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fe831097180>, 'priv': <property object at 0x7fe831097270>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontChooserDialog (94846038186736)>'
