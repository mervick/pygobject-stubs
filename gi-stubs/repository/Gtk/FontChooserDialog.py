...
class FontChooserDialog(__gi_overrides_Gtk.Dialog, FontChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a60f640>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontChooserDialog (93897368569664)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fc63a7a9e50>, 'priv': <property object at 0x7fc63a7a9f40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontChooserDialog (93897368569664)>'
