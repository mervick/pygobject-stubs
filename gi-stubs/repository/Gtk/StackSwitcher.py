...
class StackSwitcher(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc638243d90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StackSwitcher), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStackSwitcher (93897369462480)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_stack': gi.FunctionInfo(get_stack), 'set_stack': gi.FunctionInfo(set_stack), 'widget': <property object at 0x7fc63a67eb80>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStackSwitcher (93897369462480)>'
