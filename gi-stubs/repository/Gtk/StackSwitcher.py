...
class StackSwitcher(__gi_overrides_Gtk.Box):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StackSwitcher), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStackSwitcher (94846039275520)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_stack': gi.FunctionInfo(get_stack), 'set_stack': gi.FunctionInfo(set_stack), 'widget': <property object at 0x7fe830f69e50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStackSwitcher (94846039275520)>'
