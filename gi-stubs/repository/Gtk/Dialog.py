...
class Dialog(Dialog, __gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830f51fd0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '_old_arg_names': ('title', 'parent', 'flags', 'buttons', '_buttons_property'), '_init': <function deprecated_init.<locals>.new_init at 0x7fe831222280>, '__init__': <function Dialog.__init__ at 0x7fe831222310>, 'run': <function Dialog.run at 0x7fe8312223a0>, 'action_area': <property object at 0x7fe831226770>, 'vbox': <property object at 0x7fe8312267c0>, 'add_buttons': <function Dialog.add_buttons at 0x7fe831222550>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkDialog (94846036878304)>'
