...
class Dialog(Dialog, __gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a60f940>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '_old_arg_names': ('title', 'parent', 'flags', 'buttons', '_buttons_property'), '_init': <function deprecated_init.<locals>.new_init at 0x7fc63b4a8a60>, '__init__': <function Dialog.__init__ at 0x7fc63b4a8af0>, 'run': <function Dialog.run at 0x7fc63b4a8b80>, 'action_area': <property object at 0x7fc63a9416d0>, 'vbox': <property object at 0x7fc63a941720>, 'add_buttons': <function Dialog.add_buttons at 0x7fc63b4a8d30>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkDialog (93897366879824)>'
