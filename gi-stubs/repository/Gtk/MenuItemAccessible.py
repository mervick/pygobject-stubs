...
class MenuItemAccessible(ContainerAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe83052bd90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuItemAccessible (94846037237488)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe8310d1f90>, 'priv': <property object at 0x7fe8310d40e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuItemAccessible (94846037237488)>'
