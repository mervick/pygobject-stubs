...
class MenuItemAccessible(ContainerAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639c841f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuItemAccessible (93897367428064)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a7e6ef0>, 'priv': <property object at 0x7fc63a7e8040>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuItemAccessible (93897367428064)>'
