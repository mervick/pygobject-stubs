...
class StatusbarAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6394a82e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StatusbarAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStatusbarAccessible (93897369502512)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6879a0>, 'priv': <property object at 0x7fc63a687ae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStatusbarAccessible (93897369502512)>'
