...
class StatusbarAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82f4793a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StatusbarAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStatusbarAccessible (94846039300784)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830f70cc0>, 'priv': <property object at 0x7fe830f70e00>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStatusbarAccessible (94846039300784)>'
