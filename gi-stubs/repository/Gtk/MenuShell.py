...
class MenuShell(__gi_overrides_Gtk.Container):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuShell (94846037152192)>'
