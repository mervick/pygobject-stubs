...
class CheckButton(ToggleButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8307c0790>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CheckButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCheckButton (94846038089152)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_label': gi.FunctionInfo(new_with_label), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic), 'do_draw_indicator': gi.VFuncInfo(draw_indicator), 'toggle_button': <property object at 0x7fe8310d1220>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckButton (94846038089152)>'
