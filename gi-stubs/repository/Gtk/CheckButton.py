...
class CheckButton(ToggleButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639d4b820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CheckButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCheckButton (93897368303952)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_label': gi.FunctionInfo(new_with_label), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic), 'do_draw_indicator': gi.VFuncInfo(draw_indicator), 'toggle_button': <property object at 0x7fc63a7e61d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckButton (93897368303952)>'
