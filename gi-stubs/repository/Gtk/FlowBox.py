...
class FlowBox(__gi_overrides_Gtk.Container, Orientable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBox (93897368218544)>'
