...
class CellRenderer(__gi_repository_GObject.InitiallyUnowned):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRenderer (93897367751712)>'
