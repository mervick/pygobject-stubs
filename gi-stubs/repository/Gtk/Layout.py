...
class Layout(__gi_overrides_Gtk.Container, Scrollable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a60fdf0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Layout), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLayout (93897368840912)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_bin_window': gi.FunctionInfo(get_bin_window), 'get_hadjustment': gi.FunctionInfo(get_hadjustment), 'get_size': gi.FunctionInfo(get_size), 'get_vadjustment': gi.FunctionInfo(get_vadjustment), 'move': gi.FunctionInfo(move), 'put': gi.FunctionInfo(put), 'set_hadjustment': gi.FunctionInfo(set_hadjustment), 'set_size': gi.FunctionInfo(set_size), 'set_vadjustment': gi.FunctionInfo(set_vadjustment), 'container': <property object at 0x7fc63a76a450>, 'priv': <property object at 0x7fc63a76a540>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLayout (93897368840912)>'
