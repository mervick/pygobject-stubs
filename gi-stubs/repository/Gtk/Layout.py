...
class Layout(__gi_overrides_Gtk.Container, Scrollable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLayout (94846038625856)>'
