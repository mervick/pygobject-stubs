...
class ColorChooserDialog(__gi_overrides_Gtk.Dialog, ColorChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8307c0df0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorChooserDialog (94846037980032)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fe8310d5f40>, 'priv': <property object at 0x7fe8310d8090>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorChooserDialog (94846037980032)>'
