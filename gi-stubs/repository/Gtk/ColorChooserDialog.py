...
class ColorChooserDialog(__gi_overrides_Gtk.Dialog, ColorChooser):
    ...
    def new(self, title=None, parent=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, parent:Gtk.Window=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639c849d0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorChooserDialog (93897368195168)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fc63a7ece00>, 'priv': <property object at 0x7fc63a7ecef0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorChooserDialog (93897368195168)>'
