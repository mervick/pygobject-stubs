...
class AboutDialog(__gi_overrides_Gtk.Dialog):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830f51a00>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAboutDialog (94846037337120)>'
