...
class AboutDialog(__gi_overrides_Gtk.Dialog):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a52b640>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAboutDialog (93897367562896)>'
