...
class ButtonAccessible(ContainerAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8307c03d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkButtonAccessible (94846037647456)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe8310ac360>, 'priv': <property object at 0x7fe8310ac4a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkButtonAccessible (94846037647456)>'
