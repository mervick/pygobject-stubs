...
class ImageMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    def new_from_stock(self, stock_id, accel_group=None): # real signature unknown; restored from __doc__
        """ new_from_stock(stock_id:str, accel_group:Gtk.AccelGroup=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e38430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkImageMenuItem (94846038588016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_stock': gi.FunctionInfo(new_from_stock), 'new_with_label': gi.FunctionInfo(new_with_label), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic), 'get_always_show_image': gi.FunctionInfo(get_always_show_image), 'get_image': gi.FunctionInfo(get_image), 'get_use_stock': gi.FunctionInfo(get_use_stock), 'set_accel_group': gi.FunctionInfo(set_accel_group), 'set_always_show_image': gi.FunctionInfo(set_always_show_image), 'set_image': gi.FunctionInfo(set_image), 'set_use_stock': gi.FunctionInfo(set_use_stock), 'menu_item': <property object at 0x7fe831048860>, 'priv': <property object at 0x7fe831048950>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkImageMenuItem (94846038588016)>'
