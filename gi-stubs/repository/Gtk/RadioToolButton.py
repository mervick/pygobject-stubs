...
class RadioToolButton(ToggleToolButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63896a970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioToolButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioToolButton (93897368553600)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_stock': gi.FunctionInfo(new_from_stock), 'new_from_widget': gi.FunctionInfo(new_from_widget), 'new_with_stock_from_widget': gi.FunctionInfo(new_with_stock_from_widget), 'get_group': gi.FunctionInfo(get_group), 'set_group': gi.FunctionInfo(set_group), 'parent': <property object at 0x7fc63a6bff40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioToolButton (93897368553600)>'
