...
class RecentChooserWidget(__gi_overrides_Gtk.Box, RecentChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639c849a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentChooserWidget (93897369036624)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_manager': gi.FunctionInfo(new_for_manager), 'parent_instance': <property object at 0x7fc63a6d01d0>, 'priv': <property object at 0x7fc63a6d02c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentChooserWidget (93897369036624)>'
