...
class AccelLabel(__gi_overrides_Gtk.Label):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a444160>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AccelLabel), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAccelLabel (93897367937888)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_accel': gi.FunctionInfo(get_accel), 'get_accel_widget': gi.FunctionInfo(get_accel_widget), 'get_accel_width': gi.FunctionInfo(get_accel_width), 'refetch': gi.FunctionInfo(refetch), 'set_accel': gi.FunctionInfo(set_accel), 'set_accel_closure': gi.FunctionInfo(set_accel_closure), 'set_accel_widget': gi.FunctionInfo(set_accel_widget), 'label': <property object at 0x7fc63a7fb810>, 'priv': <property object at 0x7fc63a7fb900>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAccelLabel (93897367937888)>'
