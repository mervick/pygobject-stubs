...
class Switch(__gi_overrides_Gtk.Widget, Actionable, Activatable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82eb5f5b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Switch), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSwitch (94846039310128)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_active': gi.FunctionInfo(get_active), 'get_state': gi.FunctionInfo(get_state), 'set_active': gi.FunctionInfo(set_active), 'set_state': gi.FunctionInfo(set_state), 'do_activate': gi.VFuncInfo(activate), 'do_state_set': gi.VFuncInfo(state_set), 'parent_instance': <property object at 0x7fe830f7cf90>, 'priv': <property object at 0x7fe830f7e130>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSwitch (94846039310128)>'
