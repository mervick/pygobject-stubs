...
class EntryCompletion(__gi_overrides_GObject.Object, Buildable, CellLayout):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEntryCompletion (93897368416128)>'
