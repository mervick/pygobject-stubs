...
class HSV(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fc53910>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HSV), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHSV (94846038118288)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'to_rgb': gi.FunctionInfo(to_rgb), 'get_color': gi.FunctionInfo(get_color), 'get_metrics': gi.FunctionInfo(get_metrics), 'is_adjusting': gi.FunctionInfo(is_adjusting), 'set_color': gi.FunctionInfo(set_color), 'set_metrics': gi.FunctionInfo(set_metrics), 'do_changed': gi.VFuncInfo(changed), 'do_move': gi.VFuncInfo(move), 'parent_instance': <property object at 0x7fe83102b9a0>, 'priv': <property object at 0x7fe83102ba90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHSV (94846038118288)>'
