...
class Paned(Paned):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'pack1': <function Paned.pack1 at 0x7fe8311e13a0>, 'pack2': <function Paned.pack2 at 0x7fe8311e1430>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPaned (94846037125888)>'
