...
class Statusbar(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fd972e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Statusbar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStatusbar (94846039282368)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_context_id': gi.FunctionInfo(get_context_id), 'get_message_area': gi.FunctionInfo(get_message_area), 'pop': gi.FunctionInfo(pop), 'push': gi.FunctionInfo(push), 'remove': gi.FunctionInfo(remove), 'remove_all': gi.FunctionInfo(remove_all), 'do_text_popped': gi.VFuncInfo(text_popped), 'do_text_pushed': gi.VFuncInfo(text_pushed), 'parent_widget': <property object at 0x7fe830f70a90>, 'priv': <property object at 0x7fe830f70b80>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStatusbar (94846039282368)>'
