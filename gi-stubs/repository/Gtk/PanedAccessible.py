...
class PanedAccessible(ContainerAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc638b9fbb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PanedAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPanedAccessible (93897369044608)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a71f1d0>, 'priv': <property object at 0x7fc63a71f2c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPanedAccessible (93897369044608)>'
