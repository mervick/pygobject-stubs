...
class ComboBoxAccessible(ContainerAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a0b8b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ComboBoxAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkComboBoxAccessible (93897368348528)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a775180>, 'priv': <property object at 0x7fc63a7752c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkComboBoxAccessible (93897368348528)>'
