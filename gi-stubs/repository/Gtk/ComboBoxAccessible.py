...
class ComboBoxAccessible(ContainerAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.Selection):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ComboBoxAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkComboBoxAccessible (94846038133680)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe8310dd270>, 'priv': <property object at 0x7fe8310dd3b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkComboBoxAccessible (94846038133680)>'
