...
class Application(__gi_overrides_Gio.Application, __gi_overrides_Gio.ActionMap):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a52b220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Application), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkApplication (93897367500288)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_accelerator': gi.FunctionInfo(add_accelerator), 'add_window': gi.FunctionInfo(add_window), 'get_accels_for_action': gi.FunctionInfo(get_accels_for_action), 'get_actions_for_accel': gi.FunctionInfo(get_actions_for_accel), 'get_active_window': gi.FunctionInfo(get_active_window), 'get_app_menu': gi.FunctionInfo(get_app_menu), 'get_menu_by_id': gi.FunctionInfo(get_menu_by_id), 'get_menubar': gi.FunctionInfo(get_menubar), 'get_window_by_id': gi.FunctionInfo(get_window_by_id), 'get_windows': gi.FunctionInfo(get_windows), 'inhibit': gi.FunctionInfo(inhibit), 'is_inhibited': gi.FunctionInfo(is_inhibited), 'list_action_descriptions': gi.FunctionInfo(list_action_descriptions), 'prefers_app_menu': gi.FunctionInfo(prefers_app_menu), 'remove_accelerator': gi.FunctionInfo(remove_accelerator), 'remove_window': gi.FunctionInfo(remove_window), 'set_accels_for_action': gi.FunctionInfo(set_accels_for_action), 'set_app_menu': gi.FunctionInfo(set_app_menu), 'set_menubar': gi.FunctionInfo(set_menubar), 'uninhibit': gi.FunctionInfo(uninhibit), 'do_window_added': gi.VFuncInfo(window_added), 'do_window_removed': gi.VFuncInfo(window_removed), 'parent': <property object at 0x7fc63a826450>, 'priv': <property object at 0x7fc63a826540>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkApplication (93897367500288)>'
