...
class CellRendererText(CellRenderer):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8307c0670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererText), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererText (94846038042448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'set_fixed_height_from_font': gi.FunctionInfo(set_fixed_height_from_font), 'do_edited': gi.VFuncInfo(edited), 'parent': <property object at 0x7fe8310be720>, 'priv': <property object at 0x7fe8310be810>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererText (94846038042448)>'
