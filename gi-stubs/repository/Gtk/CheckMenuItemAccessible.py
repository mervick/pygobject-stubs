...
class CheckMenuItemAccessible(MenuItemAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8305761f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CheckMenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCheckMenuItemAccessible (94846038095552)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe8310d4220>, 'priv': <property object at 0x7fe8310d4360>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckMenuItemAccessible (94846038095552)>'
