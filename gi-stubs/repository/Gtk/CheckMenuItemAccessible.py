...
class CheckMenuItemAccessible(MenuItemAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639c844c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CheckMenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCheckMenuItemAccessible (93897368310352)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a7e8180>, 'priv': <property object at 0x7fc63a7e82c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckMenuItemAccessible (93897368310352)>'
