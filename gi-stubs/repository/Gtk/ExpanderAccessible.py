...
class ExpanderAccessible(ContainerAccessible, __gi_repository_Atk.Action):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a1d9c70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ExpanderAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkExpanderAccessible (93897368486272)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a79a0e0>, 'priv': <property object at 0x7fc63a79a220>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkExpanderAccessible (93897368486272)>'
