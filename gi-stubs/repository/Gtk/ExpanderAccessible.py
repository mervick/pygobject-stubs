...
class ExpanderAccessible(ContainerAccessible, __gi_repository_Atk.Action):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8305f7400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ExpanderAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkExpanderAccessible (94846038272032)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe831083400>, 'priv': <property object at 0x7fe831083540>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkExpanderAccessible (94846038272032)>'
