...
class GesturePan(GestureDrag):
    ...
    def new(self, widget, orientation): # real signature unknown; restored from __doc__
        """ new(widget:Gtk.Widget, orientation:Gtk.Orientation) -> Gtk.Gesture """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a60f1c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GesturePan), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGesturePan (93897368642576)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_orientation': gi.FunctionInfo(get_orientation), 'set_orientation': gi.FunctionInfo(set_orientation)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGesturePan (93897368642576)>'
