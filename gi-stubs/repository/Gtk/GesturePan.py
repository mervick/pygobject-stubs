...
class GesturePan(GestureDrag):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830c356d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GesturePan), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGesturePan (94846038428816)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_orientation': gi.FunctionInfo(get_orientation), 'set_orientation': gi.FunctionInfo(set_orientation)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGesturePan (94846038428816)>'
