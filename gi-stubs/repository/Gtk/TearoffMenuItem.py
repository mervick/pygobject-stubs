...
class TearoffMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6381706a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TearoffMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTearoffMenuItem (93897369579360)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'menu_item': <property object at 0x7fc63a69c630>, 'priv': <property object at 0x7fc63a69c720>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTearoffMenuItem (93897369579360)>'
