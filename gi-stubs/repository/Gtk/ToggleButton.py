...
class ToggleButton(__gi_overrides_Gtk.Button):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe83088c730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToggleButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToggleButton (94846038088800)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_label': gi.FunctionInfo(new_with_label), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic), 'get_active': gi.FunctionInfo(get_active), 'get_inconsistent': gi.FunctionInfo(get_inconsistent), 'get_mode': gi.FunctionInfo(get_mode), 'set_active': gi.FunctionInfo(set_active), 'set_inconsistent': gi.FunctionInfo(set_inconsistent), 'set_mode': gi.FunctionInfo(set_mode), 'toggled': gi.FunctionInfo(toggled), 'do_toggled': gi.VFuncInfo(toggled), 'button': <property object at 0x7fe8310cef40>, 'priv': <property object at 0x7fe8310d1090>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToggleButton (94846038088800)>'
