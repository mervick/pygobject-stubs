...
class CheckMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639d4bdc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CheckMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCheckMenuItem (93897368308416)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_label': gi.FunctionInfo(new_with_label), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic), 'get_active': gi.FunctionInfo(get_active), 'get_draw_as_radio': gi.FunctionInfo(get_draw_as_radio), 'get_inconsistent': gi.FunctionInfo(get_inconsistent), 'set_active': gi.FunctionInfo(set_active), 'set_draw_as_radio': gi.FunctionInfo(set_draw_as_radio), 'set_inconsistent': gi.FunctionInfo(set_inconsistent), 'toggled': gi.FunctionInfo(toggled), 'do_draw_indicator': gi.VFuncInfo(draw_indicator), 'do_toggled': gi.VFuncInfo(toggled), 'menu_item': <property object at 0x7fc63a7e69f0>, 'priv': <property object at 0x7fc63a7e6ae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckMenuItem (93897368308416)>'
