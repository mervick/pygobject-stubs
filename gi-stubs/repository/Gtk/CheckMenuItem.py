...
class CheckMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckMenuItem (94846038093616)>'
