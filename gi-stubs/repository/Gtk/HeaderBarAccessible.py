...
class HeaderBarAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639bb8c70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HeaderBarAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHeaderBarAccessible (93897368717904)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a748180>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHeaderBarAccessible (93897368717904)>'
