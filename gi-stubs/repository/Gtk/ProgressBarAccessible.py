...
class ProgressBarAccessible(WidgetAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6394a8b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProgressBarAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkProgressBarAccessible (93897367490672)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a733e00>, 'priv': <property object at 0x7fc63a733f40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkProgressBarAccessible (93897367490672)>'
