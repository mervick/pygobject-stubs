...
class PrintOperation(__gi_overrides_GObject.Object, PrintOperationPreview):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPrintOperation (93897367226080)>'
