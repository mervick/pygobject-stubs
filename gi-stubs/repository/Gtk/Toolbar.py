...
class Toolbar(__gi_overrides_Gtk.Container, Orientable, ToolShell):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToolbar (94846037237296)>'
