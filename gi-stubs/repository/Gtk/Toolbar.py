...
class Toolbar(__gi_overrides_Gtk.Container, Orientable, ToolShell):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToolbar (93897369080672)>'
