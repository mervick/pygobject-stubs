...
class DrawingArea(__gi_overrides_Gtk.Widget):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawingArea), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkDrawingArea (93897368394560)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'widget': <property object at 0x7fc63a783540>, 'dummy': <property object at 0x7fc63a783630>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkDrawingArea (93897368394560)>'
