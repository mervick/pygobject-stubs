...
class DrawingArea(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830702c10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawingArea), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkDrawingArea (94846038179712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'widget': <property object at 0x7fe83106e680>, 'dummy': <property object at 0x7fe83106e7c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkDrawingArea (94846038179712)>'
