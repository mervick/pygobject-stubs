...
class AspectFrame(Frame):
    ...
    def new(self, label=None, xalign, yalign, ratio, obey_child): # real signature unknown; restored from __doc__
        """ new(label:str=None, xalign:float, yalign:float, ratio:float, obey_child:bool) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830ac2940>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AspectFrame), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAspectFrame (94846037623136)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'set': gi.FunctionInfo(set), 'frame': <property object at 0x7fe831117270>, 'priv': <property object at 0x7fe8311173b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAspectFrame (94846037623136)>'
