...
class AspectFrame(Frame):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AspectFrame), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAspectFrame (93897367829936)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'set': gi.FunctionInfo(set), 'frame': <property object at 0x7fc63a82e090>, 'priv': <property object at 0x7fc63a82e1d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAspectFrame (93897367829936)>'
