...
class Popover(Bin):
    ...
    def new(self, relative_to=None): # real signature unknown; restored from __doc__
        """ new(relative_to:Gtk.Widget=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc638b861c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Popover), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPopover (93897369067760)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_model': gi.FunctionInfo(new_from_model), 'bind_model': gi.FunctionInfo(bind_model), 'get_constrain_to': gi.FunctionInfo(get_constrain_to), 'get_default_widget': gi.FunctionInfo(get_default_widget), 'get_modal': gi.FunctionInfo(get_modal), 'get_pointing_to': gi.FunctionInfo(get_pointing_to), 'get_position': gi.FunctionInfo(get_position), 'get_relative_to': gi.FunctionInfo(get_relative_to), 'get_transitions_enabled': gi.FunctionInfo(get_transitions_enabled), 'popdown': gi.FunctionInfo(popdown), 'popup': gi.FunctionInfo(popup), 'set_constrain_to': gi.FunctionInfo(set_constrain_to), 'set_default_widget': gi.FunctionInfo(set_default_widget), 'set_modal': gi.FunctionInfo(set_modal), 'set_pointing_to': gi.FunctionInfo(set_pointing_to), 'set_position': gi.FunctionInfo(set_position), 'set_relative_to': gi.FunctionInfo(set_relative_to), 'set_transitions_enabled': gi.FunctionInfo(set_transitions_enabled), 'do_closed': gi.VFuncInfo(closed), 'parent_instance': <property object at 0x7fc63a728270>, 'priv': <property object at 0x7fc63a728360>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPopover (93897369067760)>'
