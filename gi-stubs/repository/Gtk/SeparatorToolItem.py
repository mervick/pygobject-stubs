...
class SeparatorToolItem(ToolItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fdfd130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SeparatorToolItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSeparatorToolItem (94846038465440)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_draw': gi.FunctionInfo(get_draw), 'set_draw': gi.FunctionInfo(set_draw), 'parent': <property object at 0x7fe830fd62c0>, 'priv': <property object at 0x7fe830fd63b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSeparatorToolItem (94846038465440)>'
