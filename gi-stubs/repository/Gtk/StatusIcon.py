...
class StatusIcon(__gi_overrides_GObject.Object):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStatusIcon (93897368982000)>'
