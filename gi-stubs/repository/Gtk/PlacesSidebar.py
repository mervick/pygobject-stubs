...
class PlacesSidebar(__gi_overrides_Gtk.ScrolledWindow):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPlacesSidebar (93897369071504)>'
