...
class VPaned(__gi_overrides_Gtk.Paned):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e973ac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VPaned), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVPaned (94846039603632)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'paned': <property object at 0x7fe830f3e770>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVPaned (94846039603632)>'
