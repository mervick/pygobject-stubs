...
class VPaned(__gi_overrides_Gtk.Paned):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc638243550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VPaned), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVPaned (93897369805856)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'paned': <property object at 0x7fc63a654e50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVPaned (93897369805856)>'
