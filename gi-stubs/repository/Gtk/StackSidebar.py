...
class StackSidebar(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fd3f970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StackSidebar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStackSidebar (94846039261024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_stack': gi.FunctionInfo(get_stack), 'set_stack': gi.FunctionInfo(set_stack), 'parent': <property object at 0x7fe830f69630>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStackSidebar (94846039261024)>'
