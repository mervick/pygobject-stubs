...
class StackSidebar(Bin):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StackSidebar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStackSidebar (93897369086048)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_stack': gi.FunctionInfo(get_stack), 'set_stack': gi.FunctionInfo(set_stack), 'parent': <property object at 0x7fc63a67e360>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStackSidebar (93897369086048)>'
