...
class LockButtonAccessible(ButtonAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a60fa60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LockButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLockButtonAccessible (93897368902224)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6f7cc0>, 'priv': <property object at 0x7fc63a6f7e00>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLockButtonAccessible (93897368902224)>'
