...
class LockButtonAccessible(ButtonAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe83052b1f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LockButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLockButtonAccessible (94846038687712)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830fe1c20>, 'priv': <property object at 0x7fe830fe1d60>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLockButtonAccessible (94846038687712)>'
