...
class ToggleButtonAccessible(ButtonAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639e03970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToggleButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToggleButtonAccessible (93897368923696)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6fd310>, 'priv': <property object at 0x7fc63a6fd450>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToggleButtonAccessible (93897368923696)>'
