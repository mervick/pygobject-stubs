...
class ToggleButtonAccessible(ButtonAccessible):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToggleButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToggleButtonAccessible (94846038711008)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830fe8270>, 'priv': <property object at 0x7fe830fe83b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToggleButtonAccessible (94846038711008)>'
