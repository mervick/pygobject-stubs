...
class Alignment(Bin):
    ...
    def new(self, xalign, yalign, xscale, yscale): # real signature unknown; restored from __doc__
        """ new(xalign:float, yalign:float, xscale:float, yscale:float) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830f51820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Alignment), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAlignment (94846037726192)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_padding': gi.FunctionInfo(get_padding), 'set': gi.FunctionInfo(set), 'set_padding': gi.FunctionInfo(set_padding), 'bin': <property object at 0x7fe8310f1ae0>, 'priv': <property object at 0x7fe8310f1bd0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAlignment (94846037726192)>'
