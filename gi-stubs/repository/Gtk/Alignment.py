...
class Alignment(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a342550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Alignment), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAlignment (93897367600160)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_padding': gi.FunctionInfo(get_padding), 'set': gi.FunctionInfo(set), 'set_padding': gi.FunctionInfo(set_padding), 'bin': <property object at 0x7fc63a8069f0>, 'priv': <property object at 0x7fc63a806ae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAlignment (93897367600160)>'
