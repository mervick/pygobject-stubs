...
class LockButton(__gi_overrides_Gtk.Button):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8305f72b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LockButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLockButton (94846038685520)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_permission': gi.FunctionInfo(get_permission), 'set_permission': gi.FunctionInfo(set_permission), 'parent': <property object at 0x7fe830fe19a0>, 'priv': <property object at 0x7fe830fe1ae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLockButton (94846038685520)>'
