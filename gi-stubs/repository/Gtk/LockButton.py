...
class LockButton(__gi_overrides_Gtk.Button):
    ...
    def new(self, permission=None): # real signature unknown; restored from __doc__
        """ new(permission:Gio.Permission=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639e03d60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LockButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLockButton (93897368901984)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_permission': gi.FunctionInfo(get_permission), 'set_permission': gi.FunctionInfo(set_permission), 'parent': <property object at 0x7fc63a6f7a90>, 'priv': <property object at 0x7fc63a6f7b80>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLockButton (93897368901984)>'
