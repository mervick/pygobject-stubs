...
class Scale(Range):
    ...
    def new(self, orientation, adjustment=None): # real signature unknown; restored from __doc__
        """ new(orientation:Gtk.Orientation, adjustment:Gtk.Adjustment=None) -> Gtk.Widget """
        pass
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScale (93897368668912)>'
