...
class ToolPalette(__gi_overrides_Gtk.Container, Orientable, Scrollable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToolPalette (93897369677600)>'
