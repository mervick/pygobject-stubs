...
class ProgressBar(__gi_overrides_Gtk.Widget, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82f384c40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProgressBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkProgressBar (94846038906304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_ellipsize': gi.FunctionInfo(get_ellipsize), 'get_fraction': gi.FunctionInfo(get_fraction), 'get_inverted': gi.FunctionInfo(get_inverted), 'get_pulse_step': gi.FunctionInfo(get_pulse_step), 'get_show_text': gi.FunctionInfo(get_show_text), 'get_text': gi.FunctionInfo(get_text), 'pulse': gi.FunctionInfo(pulse), 'set_ellipsize': gi.FunctionInfo(set_ellipsize), 'set_fraction': gi.FunctionInfo(set_fraction), 'set_inverted': gi.FunctionInfo(set_inverted), 'set_pulse_step': gi.FunctionInfo(set_pulse_step), 'set_show_text': gi.FunctionInfo(set_show_text), 'set_text': gi.FunctionInfo(set_text), 'parent': <property object at 0x7fe83101ce00>, 'priv': <property object at 0x7fe83101cef0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkProgressBar (94846038906304)>'
