...
class Scrollbar(Range):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63925e2b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Scrollbar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScrollbar (93897367294480)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'range': <property object at 0x7fc63a8faf90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScrollbar (93897367294480)>'
