...
class Scrollbar(Range):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fd3f610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Scrollbar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScrollbar (94846037113872)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'range': <property object at 0x7fe8311e40e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScrollbar (94846037113872)>'
