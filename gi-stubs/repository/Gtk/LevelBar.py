...
class LevelBar(__gi_overrides_Gtk.Widget, Orientable):
    ...
    def new_for_interval(self, min_value, max_value): # real signature unknown; restored from __doc__
        """ new_for_interval(min_value:float, max_value:float) -> Gtk.Widget """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LevelBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLevelBar (93897368845152)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_interval': gi.FunctionInfo(new_for_interval), 'add_offset_value': gi.FunctionInfo(add_offset_value), 'get_inverted': gi.FunctionInfo(get_inverted), 'get_max_value': gi.FunctionInfo(get_max_value), 'get_min_value': gi.FunctionInfo(get_min_value), 'get_mode': gi.FunctionInfo(get_mode), 'get_offset_value': gi.FunctionInfo(get_offset_value), 'get_value': gi.FunctionInfo(get_value), 'remove_offset_value': gi.FunctionInfo(remove_offset_value), 'set_inverted': gi.FunctionInfo(set_inverted), 'set_max_value': gi.FunctionInfo(set_max_value), 'set_min_value': gi.FunctionInfo(set_min_value), 'set_mode': gi.FunctionInfo(set_mode), 'set_value': gi.FunctionInfo(set_value), 'do_offset_changed': gi.VFuncInfo(offset_changed), 'parent': <property object at 0x7fc63a76aef0>, 'priv': <property object at 0x7fc63a76c040>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLevelBar (93897368845152)>'
