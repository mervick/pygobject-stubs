...
class LevelBar(__gi_overrides_Gtk.Widget, Orientable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLevelBar (94846038635952)>'
