...
class ContainerCellAccessible(CellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639ecbc70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ContainerCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkContainerCellAccessible (93897368360608)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_child': gi.FunctionInfo(add_child), 'get_children': gi.FunctionInfo(get_children), 'remove_child': gi.FunctionInfo(remove_child), 'parent': <property object at 0x7fc63a777cc0>, 'priv': <property object at 0x7fc63a777db0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkContainerCellAccessible (93897368360608)>'
