...
class Plug(__gi_overrides_Gtk.Window):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Plug), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPlug (93897369074800)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_display': gi.FunctionInfo(new_for_display), 'construct': gi.FunctionInfo(construct), 'construct_for_display': gi.FunctionInfo(construct_for_display), 'get_embedded': gi.FunctionInfo(get_embedded), 'get_id': gi.FunctionInfo(get_id), 'get_socket_window': gi.FunctionInfo(get_socket_window), 'do_embedded': gi.VFuncInfo(embedded), 'window': <property object at 0x7fc63a725450>, 'priv': <property object at 0x7fc63a725540>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPlug (93897369074800)>'
