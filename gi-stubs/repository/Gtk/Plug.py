...
class Plug(__gi_overrides_Gtk.Window):
    """
    :Constructors:
    ...
    def construct(self, socket_id): # real signature unknown; restored from __doc__
    ...
    def construct_for_display(self, display, socket_id): # real signature unknown; restored from __doc__
    ...
    def do_embedded(self, *args, **kwargs): # real signature unknown
        """ embedded(self) """
        pass
    ...
    def get_socket_window(self): # real signature unknown; restored from __doc__
        """ get_socket_window(self) -> Gdk.Window or None """
        pass
    ...
    def new(self, socket_id): # real signature unknown; restored from __doc__
        """ new(socket_id:int) -> Gtk.Widget """
        pass
    ...
    def new_for_display(self, display, socket_id): # real signature unknown; restored from __doc__
        """ new_for_display(display:Gdk.Display, socket_id:int) -> Gtk.Widget """
        pass
