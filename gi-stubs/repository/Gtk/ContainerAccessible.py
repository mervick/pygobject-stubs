...
class ContainerAccessible(WidgetAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639ecb250>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ContainerAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkContainerAccessible (93897367437472)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a7bef90>, 'priv': <property object at 0x7fc63a7c00e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkContainerAccessible (93897367437472)>'
