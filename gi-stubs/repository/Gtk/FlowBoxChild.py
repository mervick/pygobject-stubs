...
class FlowBoxChild(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a60f820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FlowBoxChild), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFlowBoxChild (93897368535712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'changed': gi.FunctionInfo(changed), 'get_index': gi.FunctionInfo(get_index), 'is_selected': gi.FunctionInfo(is_selected), 'do_activate': gi.VFuncInfo(activate), 'parent_instance': <property object at 0x7fc63a7a6950>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBoxChild (93897368535712)>'
