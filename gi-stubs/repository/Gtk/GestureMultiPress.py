...
class GestureMultiPress(GestureSingle):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830ee7400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureMultiPress), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureMultiPress (94846038426624)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_area': gi.FunctionInfo(get_area), 'set_area': gi.FunctionInfo(set_area)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureMultiPress (94846038426624)>'
