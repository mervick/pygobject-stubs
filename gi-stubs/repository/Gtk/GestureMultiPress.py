...
class GestureMultiPress(GestureSingle):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureMultiPress), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureMultiPress (93897368640384)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_area': gi.FunctionInfo(get_area), 'set_area': gi.FunctionInfo(set_area)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureMultiPress (93897368640384)>'
