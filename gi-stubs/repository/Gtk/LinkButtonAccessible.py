...
class LinkButtonAccessible(ButtonAccessible, __gi_repository_Atk.HyperlinkImpl):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LinkButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLinkButtonAccessible (93897368868112)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a76f6d0>, 'priv': <property object at 0x7fc63a76f7c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLinkButtonAccessible (93897368868112)>'
