...
class LinkButtonAccessible(ButtonAccessible, __gi_repository_Atk.HyperlinkImpl):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830ac2a60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LinkButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLinkButtonAccessible (94846038608256)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe831059860>, 'priv': <property object at 0x7fe831059950>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLinkButtonAccessible (94846038608256)>'
