...
class ScaleButtonAccessible(ButtonAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e14a30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScaleButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScaleButtonAccessible (94846039111312)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830fc9680>, 'priv': <property object at 0x7fe830fc97c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleButtonAccessible (94846039111312)>'
