...
class ScaleButtonAccessible(ButtonAccessible, __gi_repository_Atk.Value):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScaleButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScaleButtonAccessible (93897369317616)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6df130>, 'priv': <property object at 0x7fc63a6df270>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleButtonAccessible (93897369317616)>'
