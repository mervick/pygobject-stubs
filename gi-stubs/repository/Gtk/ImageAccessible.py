...
class ImageAccessible(WidgetAccessible, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e383a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkImageAccessible (94846038575888)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe8310446d0>, 'priv': <property object at 0x7fe831044810>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkImageAccessible (94846038575888)>'
