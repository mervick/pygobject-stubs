...
class ImageAccessible(WidgetAccessible, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a2cf9d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkImageAccessible (93897368773488)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a75b450>, 'priv': <property object at 0x7fc63a75b590>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkImageAccessible (93897368773488)>'
