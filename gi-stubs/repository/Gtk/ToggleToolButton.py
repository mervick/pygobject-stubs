...
class ToggleToolButton(__gi_overrides_Gtk.ToolButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82f384430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToggleToolButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToggleToolButton (94846038338048)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_stock': gi.FunctionInfo(new_from_stock), 'get_active': gi.FunctionInfo(get_active), 'set_active': gi.FunctionInfo(set_active), 'do_toggled': gi.VFuncInfo(toggled), 'parent': <property object at 0x7fe830fa8ea0>, 'priv': <property object at 0x7fe830fa8f90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToggleToolButton (94846038338048)>'
