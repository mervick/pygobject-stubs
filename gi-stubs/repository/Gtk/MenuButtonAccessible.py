...
class MenuButtonAccessible(ToggleButtonAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63943cac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuButtonAccessible (93897368923968)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6fd590>, 'priv': <property object at 0x7fc63a6fd6d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuButtonAccessible (93897368923968)>'
