...
class Spinner(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639536850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Spinner), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinner (93897369446272)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'start': gi.FunctionInfo(start), 'stop': gi.FunctionInfo(stop), 'parent': <property object at 0x7fc63a67b950>, 'priv': <property object at 0x7fc63a67ba40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinner (93897369446272)>'
