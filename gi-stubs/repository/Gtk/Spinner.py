...
class Spinner(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82eb5f5e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Spinner), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinner (94846039242576)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'start': gi.FunctionInfo(start), 'stop': gi.FunctionInfo(stop), 'parent': <property object at 0x7fe830f65cc0>, 'priv': <property object at 0x7fe830f65db0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinner (94846039242576)>'
