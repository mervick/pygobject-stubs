...
class RadioMenuItem(CheckMenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fdfd0d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioMenuItem (94846038302016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_widget': gi.FunctionInfo(new_from_widget), 'new_with_label': gi.FunctionInfo(new_with_label), 'new_with_label_from_widget': gi.FunctionInfo(new_with_label_from_widget), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic), 'new_with_mnemonic_from_widget': gi.FunctionInfo(new_with_mnemonic_from_widget), 'get_group': gi.FunctionInfo(get_group), 'join_group': gi.FunctionInfo(join_group), 'set_group': gi.FunctionInfo(set_group), 'do_group_changed': gi.VFuncInfo(group_changed), 'check_menu_item': <property object at 0x7fe830fa6e50>, 'priv': <property object at 0x7fe830fa6f40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioMenuItem (94846038302016)>'
