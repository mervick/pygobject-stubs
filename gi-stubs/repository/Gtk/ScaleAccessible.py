...
class ScaleAccessible(RangeAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a1d9430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScaleAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScaleAccessible (93897369033968)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6dc8b0>, 'priv': <property object at 0x7fc63a6dc9a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleAccessible (93897369033968)>'
