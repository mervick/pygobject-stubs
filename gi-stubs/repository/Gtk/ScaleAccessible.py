...
class ScaleAccessible(RangeAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe83052b910>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScaleAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScaleAccessible (94846038819056)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830fc4e50>, 'priv': <property object at 0x7fe830fc4f40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleAccessible (94846038819056)>'
