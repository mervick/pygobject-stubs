...
class SearchEntry(Entry):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a5fc220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SearchEntry), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSearchEntry (93897369327488)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'handle_event': gi.FunctionInfo(handle_event), 'do_next_match': gi.VFuncInfo(next_match), 'do_previous_match': gi.VFuncInfo(previous_match), 'do_search_changed': gi.VFuncInfo(search_changed), 'do_stop_search': gi.VFuncInfo(stop_search), 'parent': <property object at 0x7fc63a6e82c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSearchEntry (93897369327488)>'
