...
class ScrolledWindowAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a667e20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScrolledWindowAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScrolledWindowAccessible (93897369327056)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6e5b30>, 'priv': <property object at 0x7fc63a6e5c70>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScrolledWindowAccessible (93897369327056)>'
