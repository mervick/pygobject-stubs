...
class Socket(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    def add_id(self, window): # real signature unknown; restored from __doc__
    ...
    def do_plug_added(self, *args, **kwargs): # real signature unknown
        """ plug_added(self) """
        pass

    def do_plug_removed(self, *args, **kwargs): # real signature unknown
        """ plug_removed(self) -> bool """
        pass
    ...
    def get_plug_window(self): # real signature unknown; restored from __doc__
        """ get_plug_window(self) -> Gdk.Window or None """
        pass
