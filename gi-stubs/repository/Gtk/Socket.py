...
class Socket(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6388650a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Socket), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSocket (93897369430016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_id': gi.FunctionInfo(add_id), 'get_id': gi.FunctionInfo(get_id), 'get_plug_window': gi.FunctionInfo(get_plug_window), 'do_plug_added': gi.VFuncInfo(plug_added), 'do_plug_removed': gi.VFuncInfo(plug_removed), 'container': <property object at 0x7fc63a6752c0>, 'priv': <property object at 0x7fc63a6753b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSocket (93897369430016)>'
