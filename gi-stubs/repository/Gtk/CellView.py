...
class CellView(__gi_overrides_Gtk.Widget, CellLayout, Orientable):
    ...
    def new_with_context(self, area, context): # real signature unknown; restored from __doc__
        """ new_with_context(area:Gtk.CellArea, context:Gtk.CellAreaContext) -> Gtk.Widget """
        pass

    def new_with_markup(self, markup): # real signature unknown; restored from __doc__
        """ new_with_markup(markup:str) -> Gtk.Widget """
        pass

    def new_with_pixbuf(self, pixbuf): # real signature unknown; restored from __doc__
        """ new_with_pixbuf(pixbuf:GdkPixbuf.Pixbuf) -> Gtk.Widget """
        pass

    def new_with_text(self, text): # real signature unknown; restored from __doc__
        """ new_with_text(text:str) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a0b8730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellView), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellView (93897368298544)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_context': gi.FunctionInfo(new_with_context), 'new_with_markup': gi.FunctionInfo(new_with_markup), 'new_with_pixbuf': gi.FunctionInfo(new_with_pixbuf), 'new_with_text': gi.FunctionInfo(new_with_text), 'get_displayed_row': gi.FunctionInfo(get_displayed_row), 'get_draw_sensitive': gi.FunctionInfo(get_draw_sensitive), 'get_fit_model': gi.FunctionInfo(get_fit_model), 'get_model': gi.FunctionInfo(get_model), 'get_size_of_row': gi.FunctionInfo(get_size_of_row), 'set_background_color': gi.FunctionInfo(set_background_color), 'set_background_rgba': gi.FunctionInfo(set_background_rgba), 'set_displayed_row': gi.FunctionInfo(set_displayed_row), 'set_draw_sensitive': gi.FunctionInfo(set_draw_sensitive), 'set_fit_model': gi.FunctionInfo(set_fit_model), 'set_model': gi.FunctionInfo(set_model), 'parent_instance': <property object at 0x7fc63a7e4540>, 'priv': <property object at 0x7fc63a7e4630>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellView (93897368298544)>'
