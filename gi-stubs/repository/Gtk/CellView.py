...
class CellView(__gi_overrides_Gtk.Widget, CellLayout, Orientable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellView (94846038083744)>'
