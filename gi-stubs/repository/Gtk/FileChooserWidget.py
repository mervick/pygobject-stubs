...
class FileChooserWidget(__gi_overrides_Gtk.Box, FileChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830cfa550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFileChooserWidget (94846038023168)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fe83108c180>, 'priv': <property object at 0x7fe83108c270>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFileChooserWidget (94846038023168)>'
