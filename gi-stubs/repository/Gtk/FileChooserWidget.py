...
class FileChooserWidget(__gi_overrides_Gtk.Box, FileChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a841d30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFileChooserWidget (93897368508256)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fc63a79ed10>, 'priv': <property object at 0x7fc63a79ee00>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFileChooserWidget (93897368508256)>'
