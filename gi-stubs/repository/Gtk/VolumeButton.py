...
class VolumeButton(ScaleButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6394a89d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VolumeButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVolumeButton (93897369808688)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fc63a6591d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVolumeButton (93897369808688)>'
