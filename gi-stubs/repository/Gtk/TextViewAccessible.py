...
class TextViewAccessible(ContainerAccessible, __gi_repository_Atk.EditableText, __gi_repository_Atk.StreamableContent, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e8a3490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextViewAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTextViewAccessible (94846039421728)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830f95f40>, 'priv': <property object at 0x7fe830f980e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextViewAccessible (94846039421728)>'
