...
class Misc(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e14850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Misc), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMisc (94846037079984)>, '__doc__': None, '__gsignals__': {}, 'get_alignment': gi.FunctionInfo(get_alignment), 'get_padding': gi.FunctionInfo(get_padding), 'set_alignment': gi.FunctionInfo(set_alignment), 'set_padding': gi.FunctionInfo(set_padding), 'widget': <property object at 0x7fe831257900>, 'priv': <property object at 0x7fe8312579f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMisc (94846037079984)>'
