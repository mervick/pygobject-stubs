...
class CellRendererCombo(CellRendererText):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639e03d00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererCombo), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererCombo (93897368269072)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fc63a7d99f0>, 'priv': <property object at 0x7fc63a7d9ae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererCombo (93897368269072)>'
