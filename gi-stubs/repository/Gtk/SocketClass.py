...
class SocketClass(__gi.Struct):
    ...
    plug_added = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    plug_removed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
