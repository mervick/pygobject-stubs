...
class Bin(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a5fc3d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Bin), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkBin (93897367007072)>, '__doc__': None, '__gsignals__': {}, 'get_child': gi.FunctionInfo(get_child), 'container': <property object at 0x7fc63b4a7b30>, 'priv': <property object at 0x7fc63b4a7c20>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkBin (93897367007072)>'
