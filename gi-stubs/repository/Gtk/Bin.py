...
class Bin(__gi_overrides_Gtk.Container):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Bin), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkBin (94846036802288)>, '__doc__': None, '__gsignals__': {}, 'get_child': gi.FunctionInfo(get_child), 'container': <property object at 0x7fe831d8cc20>, 'priv': <property object at 0x7fe831d8cd10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkBin (94846036802288)>'
