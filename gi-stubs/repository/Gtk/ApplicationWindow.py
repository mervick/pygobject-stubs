...
class ApplicationWindow(__gi_overrides_Gtk.Window, __gi_repository_Gio.ActionGroup, __gi_overrides_Gio.ActionMap):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a5fc8b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ApplicationWindow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkApplicationWindow (93897367604448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_help_overlay': gi.FunctionInfo(get_help_overlay), 'get_id': gi.FunctionInfo(get_id), 'get_show_menubar': gi.FunctionInfo(get_show_menubar), 'set_help_overlay': gi.FunctionInfo(set_help_overlay), 'set_show_menubar': gi.FunctionInfo(set_show_menubar), 'parent_instance': <property object at 0x7fc63a829130>, 'priv': <property object at 0x7fc63a829220>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkApplicationWindow (93897367604448)>'
