...
class VBox(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e973040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVBox (94846039593760)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'box': <property object at 0x7fe830f3e040>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVBox (94846039593760)>'
