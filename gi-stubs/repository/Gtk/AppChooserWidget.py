...
class AppChooserWidget(__gi_overrides_Gtk.Box, AppChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a5fca60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AppChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAppChooserWidget (93897367574288)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_default_text': gi.FunctionInfo(get_default_text), 'get_show_all': gi.FunctionInfo(get_show_all), 'get_show_default': gi.FunctionInfo(get_show_default), 'get_show_fallback': gi.FunctionInfo(get_show_fallback), 'get_show_other': gi.FunctionInfo(get_show_other), 'get_show_recommended': gi.FunctionInfo(get_show_recommended), 'set_default_text': gi.FunctionInfo(set_default_text), 'set_show_all': gi.FunctionInfo(set_show_all), 'set_show_default': gi.FunctionInfo(set_show_default), 'set_show_fallback': gi.FunctionInfo(set_show_fallback), 'set_show_other': gi.FunctionInfo(set_show_other), 'set_show_recommended': gi.FunctionInfo(set_show_recommended), 'do_application_activated': gi.VFuncInfo(application_activated), 'do_application_selected': gi.VFuncInfo(application_selected), 'do_populate_popup': gi.VFuncInfo(populate_popup), 'parent': <property object at 0x7fc63a825720>, 'priv': <property object at 0x7fc63a8258b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAppChooserWidget (93897367574288)>'
