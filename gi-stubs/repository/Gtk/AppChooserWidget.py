...
class AppChooserWidget(__gi_overrides_Gtk.Box, AppChooser):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAppChooserWidget (94846037887616)>'
