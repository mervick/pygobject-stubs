...
class HBox(__gi_overrides_Gtk.Box):
    ...
    def new(self, homogeneous, spacing): # real signature unknown; restored from __doc__
        """ new(homogeneous:bool, spacing:int) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63943c1f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHBox (93897368655696)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'box': <property object at 0x7fc63a73ec70>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHBox (93897368655696)>'
