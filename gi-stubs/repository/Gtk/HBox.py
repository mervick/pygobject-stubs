...
class HBox(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830ee7670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHBox (94846038441808)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'box': <property object at 0x7fe831029ef0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHBox (94846038441808)>'
