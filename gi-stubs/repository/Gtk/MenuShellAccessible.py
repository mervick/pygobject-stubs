...
class MenuShellAccessible(ContainerAccessible, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a2cfa30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuShellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuShellAccessible (93897367459952)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6f8d60>, 'priv': <property object at 0x7fc63a6f8e50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuShellAccessible (93897367459952)>'
