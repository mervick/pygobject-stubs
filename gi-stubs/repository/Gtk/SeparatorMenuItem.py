...
class SeparatorMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8305f7700>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SeparatorMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSeparatorMenuItem (94846039164784)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'menu_item': <property object at 0x7fe830fd4a90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSeparatorMenuItem (94846039164784)>'
