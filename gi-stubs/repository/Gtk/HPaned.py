...
class HPaned(__gi_overrides_Gtk.Paned):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830f51880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HPaned), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHPaned (94846038111920)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'paned': <property object at 0x7fe83102b630>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHPaned (94846038111920)>'
