...
class HPaned(__gi_overrides_Gtk.Paned):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a52b610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HPaned), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHPaned (93897368326768)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'paned': <property object at 0x7fc63a73f3b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHPaned (93897368326768)>'
