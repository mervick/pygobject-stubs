...
class ToolItemGroup(__gi_overrides_Gtk.Container, ToolShell):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToolItemGroup (94846039486320)>'
