...
class FrameAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe83113b1c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FrameAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFrameAccessible (94846038398896)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe83109d5e0>, 'priv': <property object at 0x7fe83109d720>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFrameAccessible (94846038398896)>'
