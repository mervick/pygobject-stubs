...
class SpinButtonAccessible(EntryAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6394a87f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SpinButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinButtonAccessible (93897369441488)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a679360>, 'priv': <property object at 0x7fc63a6794a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinButtonAccessible (93897369441488)>'
