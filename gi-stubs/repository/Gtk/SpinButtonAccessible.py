...
class SpinButtonAccessible(EntryAccessible, __gi_repository_Atk.Value):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SpinButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinButtonAccessible (94846039231152)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830f61680>, 'priv': <property object at 0x7fe830f617c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinButtonAccessible (94846039231152)>'
