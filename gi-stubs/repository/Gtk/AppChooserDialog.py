...
class AppChooserDialog(__gi_overrides_Gtk.Dialog, AppChooser):
    ...
    def new(self, parent=None, flags, file): # real signature unknown; restored from __doc__
        """ new(parent:Gtk.Window=None, flags:Gtk.DialogFlags, file:Gio.File) -> Gtk.Widget """
        pass
    ...
    def new_for_content_type(self, parent=None, flags, content_type): # real signature unknown; restored from __doc__
        """ new_for_content_type(parent:Gtk.Window=None, flags:Gtk.DialogFlags, content_type:str) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e38fd0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AppChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAppChooserDialog (94846037358080)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_content_type': gi.FunctionInfo(new_for_content_type), 'get_heading': gi.FunctionInfo(get_heading), 'get_widget': gi.FunctionInfo(get_widget), 'set_heading': gi.FunctionInfo(set_heading), 'parent': <property object at 0x7fe83110bf90>, 'priv': <property object at 0x7fe83110d0e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAppChooserDialog (94846037358080)>'
