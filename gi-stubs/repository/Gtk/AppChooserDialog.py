...
class AppChooserDialog(__gi_overrides_Gtk.Dialog, AppChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a1d9340>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AppChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAppChooserDialog (93897367778752)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_content_type': gi.FunctionInfo(new_for_content_type), 'get_heading': gi.FunctionInfo(get_heading), 'get_widget': gi.FunctionInfo(get_widget), 'set_heading': gi.FunctionInfo(set_heading), 'parent': <property object at 0x7fc63a808e50>, 'priv': <property object at 0x7fc63a808f40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAppChooserDialog (93897367778752)>'
