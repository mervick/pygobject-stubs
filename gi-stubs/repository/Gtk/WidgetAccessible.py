...
class WidgetAccessible(Accessible, __gi_repository_Atk.Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830c35c40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WidgetAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkWidgetAccessible (94846037195536)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe831113ae0>, 'priv': <property object at 0x7fe831113bd0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkWidgetAccessible (94846037195536)>'
