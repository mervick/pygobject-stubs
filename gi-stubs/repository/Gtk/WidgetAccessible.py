...
class WidgetAccessible(Accessible, __gi_repository_Atk.Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a60f070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WidgetAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkWidgetAccessible (93897367407680)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a829900>, 'priv': <property object at 0x7fc63a8299f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkWidgetAccessible (93897367407680)>'
