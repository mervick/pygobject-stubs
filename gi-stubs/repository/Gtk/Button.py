...
class Button(Button, __gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a1d9d30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '_init': <function deprecated_init.<locals>.new_init at 0x7fc63a9721f0>, '__init__': <function Button.__init__ at 0x7fc63a972280>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkButton (93897367261952)>'
