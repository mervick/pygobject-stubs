...
class HeaderBar(__gi_overrides_Gtk.Container):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHeaderBar (94846038500128)>'
