...
class Revealer(Bin):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Revealer), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRevealer (94846039083024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_child_revealed': gi.FunctionInfo(get_child_revealed), 'get_reveal_child': gi.FunctionInfo(get_reveal_child), 'get_transition_duration': gi.FunctionInfo(get_transition_duration), 'get_transition_type': gi.FunctionInfo(get_transition_type), 'set_reveal_child': gi.FunctionInfo(set_reveal_child), 'set_transition_duration': gi.FunctionInfo(set_transition_duration), 'set_transition_type': gi.FunctionInfo(set_transition_type), 'parent_instance': <property object at 0x7fe830fc2db0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRevealer (94846039083024)>'
