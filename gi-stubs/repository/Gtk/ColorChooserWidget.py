...
class ColorChooserWidget(__gi_overrides_Gtk.Box, ColorChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe83052bd00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorChooserWidget (94846037981984)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fe8310d8f40>, 'priv': <property object at 0x7fe8310db090>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorChooserWidget (94846037981984)>'
