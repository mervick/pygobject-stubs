...
class ColorChooserWidget(__gi_overrides_Gtk.Box, ColorChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639e03f10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorChooserWidget (93897368197120)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fc63a7eee00>, 'priv': <property object at 0x7fc63a7eeef0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorChooserWidget (93897368197120)>'
