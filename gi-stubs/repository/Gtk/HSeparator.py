...
class HSeparator(Separator):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HSeparator), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHSeparator (93897368705280)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'separator': <property object at 0x7fc63a741cc0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHSeparator (93897368705280)>'
