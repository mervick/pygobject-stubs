...
class HSeparator(Separator):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fc53b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HSeparator), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHSeparator (94846038491392)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'separator': <property object at 0x7fe83102cef0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHSeparator (94846038491392)>'
