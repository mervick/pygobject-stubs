...
class RecentChooserMenu(__gi_overrides_Gtk.Menu, Activatable, RecentChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82f255730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentChooserMenu), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentChooserMenu (94846038896304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_manager': gi.FunctionInfo(new_for_manager), 'get_show_numbers': gi.FunctionInfo(get_show_numbers), 'set_show_numbers': gi.FunctionInfo(set_show_numbers), 'parent_instance': <property object at 0x7fe830fb7e50>, 'priv': <property object at 0x7fe830fb7f40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentChooserMenu (94846038896304)>'
