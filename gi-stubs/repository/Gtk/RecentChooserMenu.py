...
class RecentChooserMenu(__gi_overrides_Gtk.Menu, Activatable, RecentChooser):
    ...
    def new_for_manager(self, manager): # real signature unknown; restored from __doc__
        """ new_for_manager(manager:Gtk.RecentManager) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a667a90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentChooserMenu), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentChooserMenu (93897369251632)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_manager': gi.FunctionInfo(new_for_manager), 'get_show_numbers': gi.FunctionInfo(get_show_numbers), 'set_show_numbers': gi.FunctionInfo(set_show_numbers), 'parent_instance': <property object at 0x7fc63a6cd860>, 'priv': <property object at 0x7fc63a6cd950>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentChooserMenu (93897369251632)>'
