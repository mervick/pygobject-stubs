...
class VSeparator(Separator):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e8a3070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VSeparator), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVSeparator (94846039610128)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'separator': <property object at 0x7fe830f3ef90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVSeparator (94846039610128)>'
