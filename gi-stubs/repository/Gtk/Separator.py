...
class Separator(__gi_overrides_Gtk.Widget, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63925ecd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Separator), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSeparator (93897368704880)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'widget': <property object at 0x7fc63a741a90>, 'priv': <property object at 0x7fc63a741b80>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSeparator (93897368704880)>'
