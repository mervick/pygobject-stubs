...
class MenuButton(ToggleButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830bb6880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuButton (94846038707040)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_align_widget': gi.FunctionInfo(get_align_widget), 'get_direction': gi.FunctionInfo(get_direction), 'get_menu_model': gi.FunctionInfo(get_menu_model), 'get_popover': gi.FunctionInfo(get_popover), 'get_popup': gi.FunctionInfo(get_popup), 'get_use_popover': gi.FunctionInfo(get_use_popover), 'set_align_widget': gi.FunctionInfo(set_align_widget), 'set_direction': gi.FunctionInfo(set_direction), 'set_menu_model': gi.FunctionInfo(set_menu_model), 'set_popover': gi.FunctionInfo(set_popover), 'set_popup': gi.FunctionInfo(set_popup), 'set_use_popover': gi.FunctionInfo(set_use_popover), 'parent': <property object at 0x7fe830fe5f90>, 'priv': <property object at 0x7fe830fe80e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuButton (94846038707040)>'
