...
class ActionBar(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a60ff40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ActionBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkActionBar (93897367578496)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_center_widget': gi.FunctionInfo(get_center_widget), 'pack_end': gi.FunctionInfo(pack_end), 'pack_start': gi.FunctionInfo(pack_start), 'set_center_widget': gi.FunctionInfo(set_center_widget), 'bin': <property object at 0x7fc63a801220>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkActionBar (93897367578496)>'
