...
class ImageCellAccessible(RendererCellAccessible, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830ee7a30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkImageCellAccessible (94846038580896)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe831044cc0>, 'priv': <property object at 0x7fe831044db0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkImageCellAccessible (94846038580896)>'
