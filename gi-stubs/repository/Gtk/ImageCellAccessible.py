...
class ImageCellAccessible(RendererCellAccessible, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63935f490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkImageCellAccessible (93897368759152)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a75b9a0>, 'priv': <property object at 0x7fc63a75bae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkImageCellAccessible (93897368759152)>'
