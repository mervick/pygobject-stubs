...
class Overlay(Bin):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Overlay), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkOverlay (94846038746320)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_overlay': gi.FunctionInfo(add_overlay), 'get_overlay_pass_through': gi.FunctionInfo(get_overlay_pass_through), 'reorder_overlay': gi.FunctionInfo(reorder_overlay), 'set_overlay_pass_through': gi.FunctionInfo(set_overlay_pass_through), 'do_get_child_position': gi.VFuncInfo(get_child_position), 'parent': <property object at 0x7fe831001a90>, 'priv': <property object at 0x7fe831001bd0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkOverlay (94846038746320)>'
