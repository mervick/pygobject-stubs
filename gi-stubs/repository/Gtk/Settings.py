...
class Settings(__gi_overrides_GObject.Object, StyleProvider):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fb4e100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Settings), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSettings (94846038471056)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default), 'get_for_screen': gi.FunctionInfo(get_for_screen), 'install_property': gi.FunctionInfo(install_property), 'install_property_parser': gi.FunctionInfo(install_property_parser), 'reset_property': gi.FunctionInfo(reset_property), 'set_double_property': gi.FunctionInfo(set_double_property), 'set_long_property': gi.FunctionInfo(set_long_property), 'set_property_value': gi.FunctionInfo(set_property_value), 'set_string_property': gi.FunctionInfo(set_string_property), 'parent_instance': <property object at 0x7fe830fd6d10>, 'priv': <property object at 0x7fe830fd6e00>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSettings (94846038471056)>'
