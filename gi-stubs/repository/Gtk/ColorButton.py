...
class ColorButton(__gi_overrides_Gtk.Button, ColorChooser):
    ...
    def new_with_rgba(self, rgba): # real signature unknown; restored from __doc__
        """ new_with_rgba(rgba:Gdk.RGBA) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639c842b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorButton (93897368321600)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_color': gi.FunctionInfo(new_with_color), 'new_with_rgba': gi.FunctionInfo(new_with_rgba), 'get_alpha': gi.FunctionInfo(get_alpha), 'get_color': gi.FunctionInfo(get_color), 'get_title': gi.FunctionInfo(get_title), 'get_use_alpha': gi.FunctionInfo(get_use_alpha), 'set_alpha': gi.FunctionInfo(set_alpha), 'set_color': gi.FunctionInfo(set_color), 'set_title': gi.FunctionInfo(set_title), 'set_use_alpha': gi.FunctionInfo(set_use_alpha), 'do_color_set': gi.VFuncInfo(color_set), 'button': <property object at 0x7fc63a7ec400>, 'priv': <property object at 0x7fc63a7ec4f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorButton (93897368321600)>'
