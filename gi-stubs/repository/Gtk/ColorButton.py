...
class ColorButton(__gi_overrides_Gtk.Button, ColorChooser):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorButton (94846038106752)>'
