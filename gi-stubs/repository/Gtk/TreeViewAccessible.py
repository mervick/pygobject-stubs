...
class TreeViewAccessible(ContainerAccessible, __gi_repository_Atk.Selection, __gi_repository_Atk.Table, CellAccessibleParent):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6380665b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TreeViewAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTreeViewAccessible (93897369760624)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a64bea0>, 'priv': <property object at 0x7fc63a64f040>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeViewAccessible (93897369760624)>'
