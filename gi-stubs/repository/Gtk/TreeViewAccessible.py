...
class TreeViewAccessible(ContainerAccessible, __gi_repository_Atk.Selection, __gi_repository_Atk.Table, CellAccessibleParent):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e6f6280>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TreeViewAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTreeViewAccessible (94846038766864)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830f357c0>, 'priv': <property object at 0x7fe830f35900>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeViewAccessible (94846038766864)>'
