...
class ModelButton(__gi_overrides_Gtk.Button):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a342b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModelButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkModelButton (93897368962880)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkModelButton (93897368962880)>'
