...
class RangeAccessible(WidgetAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63896a070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RangeAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRangeAccessible (93897368550112)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6c26d0>, 'priv': <property object at 0x7fc63a6c2810>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRangeAccessible (93897368550112)>'
