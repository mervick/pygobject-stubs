...
class RangeAccessible(WidgetAccessible, __gi_repository_Atk.Value):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RangeAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRangeAccessible (94846038334144)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830fab8b0>, 'priv': <property object at 0x7fe830fab9f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRangeAccessible (94846038334144)>'
