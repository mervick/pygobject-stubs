...
class CellArea(__gi_repository_GObject.InitiallyUnowned, Buildable, CellLayout):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellArea (94846037898656)>'
