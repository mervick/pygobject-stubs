...
class TextCellAccessible(RendererCellAccessible, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc638243be0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTextCellAccessible (93897369587568)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6a4680>, 'priv': <property object at 0x7fc63a6a4770>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextCellAccessible (93897369587568)>'
