...
class TextCellAccessible(RendererCellAccessible, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e8d6850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTextCellAccessible (94846039385920)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830f8de00>, 'priv': <property object at 0x7fe830f8def0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextCellAccessible (94846039385920)>'
