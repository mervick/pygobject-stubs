...
class Window(Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a8503a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__init__': <function Window.__init__ at 0x7fc63b4a8940>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkWindow (93897367061056)>'
