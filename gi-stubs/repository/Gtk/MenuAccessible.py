...
class MenuAccessible(MenuShellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639bb8f10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuAccessible (93897368902496)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6f8f90>, 'priv': <property object at 0x7fc63a6fc130>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuAccessible (93897368902496)>'
