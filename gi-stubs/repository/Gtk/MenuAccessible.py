...
class MenuAccessible(MenuShellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8305f7820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuAccessible (94846038694496)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830fe4ef0>, 'priv': <property object at 0x7fe830fe5090>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuAccessible (94846038694496)>'
