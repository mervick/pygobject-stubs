...
class EventBox(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639d4bbb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventBox (93897368378720)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_above_child': gi.FunctionInfo(get_above_child), 'get_visible_window': gi.FunctionInfo(get_visible_window), 'set_above_child': gi.FunctionInfo(set_above_child), 'set_visible_window': gi.FunctionInfo(set_visible_window), 'bin': <property object at 0x7fc63a7926d0>, 'priv': <property object at 0x7fc63a7927c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventBox (93897368378720)>'
