...
class EventBox(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8305760d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventBox (94846038210128)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_above_child': gi.FunctionInfo(get_above_child), 'get_visible_window': gi.FunctionInfo(get_visible_window), 'set_above_child': gi.FunctionInfo(set_above_child), 'set_visible_window': gi.FunctionInfo(set_visible_window), 'bin': <property object at 0x7fe83107d950>, 'priv': <property object at 0x7fe83107da40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventBox (94846038210128)>'
