...
class CellAccessible(Accessible, __gi_repository_Atk.Action, __gi_repository_Atk.Component, __gi_repository_Atk.TableCell):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a0b8400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellAccessible (93897367855600)>, '__doc__': None, '__gsignals__': {}, 'do_update_cache': gi.VFuncInfo(update_cache), 'parent': <property object at 0x7fc63a7b75e0>, 'priv': <property object at 0x7fc63a7b76d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellAccessible (93897367855600)>'
