...
class TextView(__gi_overrides_Gtk.Container, Scrollable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextView (93897369619200)>'
