...
class TextView(__gi_overrides_Gtk.Container, Scrollable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextView (94846039421376)>'
