...
class HButtonBox(ButtonBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a2cfc10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HButtonBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHButtonBox (93897368662864)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'button_box': <property object at 0x7fc63a73f040>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHButtonBox (93897368662864)>'
