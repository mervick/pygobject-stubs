...
class VButtonBox(ButtonBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc638243220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VButtonBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVButtonBox (93897369796304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'button_box': <property object at 0x7fc63a654ae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVButtonBox (93897369796304)>'
