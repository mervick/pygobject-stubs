...
class VButtonBox(ButtonBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e8a3220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VButtonBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVButtonBox (94846039601504)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'button_box': <property object at 0x7fe830f3e400>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVButtonBox (94846039601504)>'
