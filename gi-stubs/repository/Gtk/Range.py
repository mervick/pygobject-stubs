...
class Range(__gi_overrides_Gtk.Widget, Orientable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRange (93897367320432)>'
