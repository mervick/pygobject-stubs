...
class ColorSelection(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639c84310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorSelection), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorSelection (93897368341136)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'palette_from_string': gi.FunctionInfo(palette_from_string), 'palette_to_string': gi.FunctionInfo(palette_to_string), 'get_current_alpha': gi.FunctionInfo(get_current_alpha), 'get_current_color': gi.FunctionInfo(get_current_color), 'get_current_rgba': gi.FunctionInfo(get_current_rgba), 'get_has_opacity_control': gi.FunctionInfo(get_has_opacity_control), 'get_has_palette': gi.FunctionInfo(get_has_palette), 'get_previous_alpha': gi.FunctionInfo(get_previous_alpha), 'get_previous_color': gi.FunctionInfo(get_previous_color), 'get_previous_rgba': gi.FunctionInfo(get_previous_rgba), 'is_adjusting': gi.FunctionInfo(is_adjusting), 'set_current_alpha': gi.FunctionInfo(set_current_alpha), 'set_current_color': gi.FunctionInfo(set_current_color), 'set_current_rgba': gi.FunctionInfo(set_current_rgba), 'set_has_opacity_control': gi.FunctionInfo(set_has_opacity_control), 'set_has_palette': gi.FunctionInfo(set_has_palette), 'set_previous_alpha': gi.FunctionInfo(set_previous_alpha), 'set_previous_color': gi.FunctionInfo(set_previous_color), 'set_previous_rgba': gi.FunctionInfo(set_previous_rgba), 'do_color_changed': gi.VFuncInfo(color_changed), 'parent_instance': <property object at 0x7fc63a7f00e0>, 'private_data': <property object at 0x7fc63a7f01d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorSelection (93897368341136)>'
