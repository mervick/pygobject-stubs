...
class ColorSelection(__gi_overrides_Gtk.Box):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorSelection (94846038126288)>'
