...
class RadioButton(CheckButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6394a8c40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioButton (93897369157296)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_widget': gi.FunctionInfo(new_from_widget), 'new_with_label': gi.FunctionInfo(new_with_label), 'new_with_label_from_widget': gi.FunctionInfo(new_with_label_from_widget), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic), 'new_with_mnemonic_from_widget': gi.FunctionInfo(new_with_mnemonic_from_widget), 'get_group': gi.FunctionInfo(get_group), 'join_group': gi.FunctionInfo(join_group), 'set_group': gi.FunctionInfo(set_group), 'do_group_changed': gi.VFuncInfo(group_changed), 'check_button': <property object at 0x7fc63a6bac70>, 'priv': <property object at 0x7fc63a6bad60>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioButton (93897369157296)>'
