...
class RadioButton(CheckButton):
    ...
    def new(self, group=None): # real signature unknown; restored from __doc__
        """ new(group:list=None) -> Gtk.Widget """
        pass
    ...
    def new_from_widget(self, radio_group_member=None): # real signature unknown; restored from __doc__
        """ new_from_widget(radio_group_member:Gtk.RadioButton=None) -> Gtk.Widget """
        pass

    def new_with_label(self, group=None, label): # real signature unknown; restored from __doc__
        """ new_with_label(group:list=None, label:str) -> Gtk.Widget """
        pass

    def new_with_label_from_widget(self, radio_group_member=None, label): # real signature unknown; restored from __doc__
        """ new_with_label_from_widget(radio_group_member:Gtk.RadioButton=None, label:str) -> Gtk.Widget """
        pass

    def new_with_mnemonic(self, group=None, label): # real signature unknown; restored from __doc__
        """ new_with_mnemonic(group:list=None, label:str) -> Gtk.Widget """
        pass

    def new_with_mnemonic_from_widget(self, radio_group_member=None, label): # real signature unknown; restored from __doc__
        """ new_with_mnemonic_from_widget(radio_group_member:Gtk.RadioButton=None, label:str) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fdfda00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioButton (94846038955280)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_widget': gi.FunctionInfo(new_from_widget), 'new_with_label': gi.FunctionInfo(new_with_label), 'new_with_label_from_widget': gi.FunctionInfo(new_with_label_from_widget), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic), 'new_with_mnemonic_from_widget': gi.FunctionInfo(new_with_mnemonic_from_widget), 'get_group': gi.FunctionInfo(get_group), 'join_group': gi.FunctionInfo(join_group), 'set_group': gi.FunctionInfo(set_group), 'do_group_changed': gi.VFuncInfo(group_changed), 'check_button': <property object at 0x7fe830fa4ea0>, 'priv': <property object at 0x7fe830fa4f90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioButton (94846038955280)>'
