...
class RendererCellAccessible(CellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e382e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RendererCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRendererCellAccessible (94846037636464)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fe8310a2950>, 'priv': <property object at 0x7fe8310a2a90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRendererCellAccessible (94846037636464)>'
