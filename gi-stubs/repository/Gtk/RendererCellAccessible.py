...
class RendererCellAccessible(CellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a1d9c10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RendererCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRendererCellAccessible (93897367872000)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fc63a7b7810>, 'priv': <property object at 0x7fc63a7b7950>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRendererCellAccessible (93897367872000)>'
