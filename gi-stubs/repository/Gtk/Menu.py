...
class Menu(Menu):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a342820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'popup': <function Menu.popup at 0x7fc63a905160>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenu (93897367363232)>'
