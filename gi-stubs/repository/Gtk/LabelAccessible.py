...
class LabelAccessible(WidgetAccessible, __gi_repository_Atk.Hypertext, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e384c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LabelAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLabelAccessible (94846038620368)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe83104f310>, 'priv': <property object at 0x7fe83104f400>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLabelAccessible (94846038620368)>'
