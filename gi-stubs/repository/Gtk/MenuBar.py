...
class MenuBar(MenuShell):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a444760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuBar (93897368908656)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_model': gi.FunctionInfo(new_from_model), 'get_child_pack_direction': gi.FunctionInfo(get_child_pack_direction), 'get_pack_direction': gi.FunctionInfo(get_pack_direction), 'set_child_pack_direction': gi.FunctionInfo(set_child_pack_direction), 'set_pack_direction': gi.FunctionInfo(set_pack_direction), 'menu_shell': <property object at 0x7fc63a6fc6d0>, 'priv': <property object at 0x7fc63a6fc7c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuBar (93897368908656)>'
