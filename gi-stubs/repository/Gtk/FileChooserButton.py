...
class FileChooserButton(__gi_overrides_Gtk.Box, FileChooser):
    ...
    def new_with_dialog(self, dialog): # real signature unknown; restored from __doc__
        """ new_with_dialog(dialog:Gtk.Dialog) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830cfa4f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileChooserButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFileChooserButton (94846038282368)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_dialog': gi.FunctionInfo(new_with_dialog), 'get_focus_on_click': gi.FunctionInfo(get_focus_on_click), 'get_title': gi.FunctionInfo(get_title), 'get_width_chars': gi.FunctionInfo(get_width_chars), 'set_focus_on_click': gi.FunctionInfo(set_focus_on_click), 'set_title': gi.FunctionInfo(set_title), 'set_width_chars': gi.FunctionInfo(set_width_chars), 'do_file_set': gi.VFuncInfo(file_set), 'parent': <property object at 0x7fe831087590>, 'priv': <property object at 0x7fe8310876d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFileChooserButton (94846038282368)>'
