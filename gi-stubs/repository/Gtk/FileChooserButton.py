...
class FileChooserButton(__gi_overrides_Gtk.Box, FileChooser):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFileChooserButton (93897368499680)>'
