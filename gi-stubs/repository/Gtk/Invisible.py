...
class Invisible(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63935fb80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Invisible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkInvisible (93897368768176)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_screen': gi.FunctionInfo(new_for_screen), 'get_screen': gi.FunctionInfo(get_screen), 'set_screen': gi.FunctionInfo(set_screen), 'widget': <property object at 0x7fc63a761450>, 'priv': <property object at 0x7fc63a761cc0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkInvisible (93897368768176)>'
