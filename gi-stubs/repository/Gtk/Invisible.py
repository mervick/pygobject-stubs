...
class Invisible(__gi_overrides_Gtk.Widget):
    ...
    def new_for_screen(self, screen): # real signature unknown; restored from __doc__
        """ new_for_screen(screen:Gdk.Screen) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e146a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Invisible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkInvisible (94846038572208)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_screen': gi.FunctionInfo(new_for_screen), 'get_screen': gi.FunctionInfo(get_screen), 'set_screen': gi.FunctionInfo(set_screen), 'widget': <property object at 0x7fe83104cf90>, 'priv': <property object at 0x7fe83104e0e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkInvisible (94846038572208)>'
