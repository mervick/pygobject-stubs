...
class CellRendererAccel(CellRendererText):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639e03070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererAccel), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererAccel (93897368257664)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'do_accel_cleared': gi.VFuncInfo(accel_cleared), 'do_accel_edited': gi.VFuncInfo(accel_edited), 'parent': <property object at 0x7fc63a7d4900>, 'priv': <property object at 0x7fc63a7d49f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererAccel (93897368257664)>'
