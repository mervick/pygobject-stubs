...
class CellRendererAccel(CellRendererText):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe8307025e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererAccel), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererAccel (94846038042736)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'do_accel_cleared': gi.VFuncInfo(accel_cleared), 'do_accel_edited': gi.VFuncInfo(accel_edited), 'parent': <property object at 0x7fe8310be9f0>, 'priv': <property object at 0x7fe8310beae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererAccel (94846038042736)>'
