...
class StackAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc6395369a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StackAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStackAccessible (93897369464672)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a67dd60>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStackAccessible (93897369464672)>'
