...
class SpinnerAccessible(WidgetAccessible, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63925ed30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SpinnerAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinnerAccessible (93897369454176)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a67bb80>, 'priv': <property object at 0x7fc63a67bcc0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinnerAccessible (93897369454176)>'
