...
class SpinnerAccessible(WidgetAccessible, __gi_repository_Atk.Image):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SpinnerAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinnerAccessible (94846039250336)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe830f65ef0>, 'priv': <property object at 0x7fe830f66090>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinnerAccessible (94846039250336)>'
