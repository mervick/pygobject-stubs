...
class BooleanCellAccessible(RendererCellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a1d9370>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BooleanCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkBooleanCellAccessible (93897367872224)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a7b7a90>, 'priv': <property object at 0x7fc63a7b7bd0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkBooleanCellAccessible (93897367872224)>'
