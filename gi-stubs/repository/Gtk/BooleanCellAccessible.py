...
class BooleanCellAccessible(RendererCellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830c35be0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BooleanCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkBooleanCellAccessible (94846037962480)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe8310a2bd0>, 'priv': <property object at 0x7fe8310a2d10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkBooleanCellAccessible (94846037962480)>'
