...
class InfoBar(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639bb8970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InfoBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkInfoBar (93897368812384)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_action_widget': gi.FunctionInfo(add_action_widget), 'add_button': gi.FunctionInfo(add_button), 'get_action_area': gi.FunctionInfo(get_action_area), 'get_content_area': gi.FunctionInfo(get_content_area), 'get_message_type': gi.FunctionInfo(get_message_type), 'get_revealed': gi.FunctionInfo(get_revealed), 'get_show_close_button': gi.FunctionInfo(get_show_close_button), 'response': gi.FunctionInfo(response), 'set_default_response': gi.FunctionInfo(set_default_response), 'set_message_type': gi.FunctionInfo(set_message_type), 'set_response_sensitive': gi.FunctionInfo(set_response_sensitive), 'set_revealed': gi.FunctionInfo(set_revealed), 'set_show_close_button': gi.FunctionInfo(set_show_close_button), 'do_close': gi.VFuncInfo(close), 'do_response': gi.VFuncInfo(response), 'parent': <property object at 0x7fc63a75f400>, 'priv': <property object at 0x7fc63a75f4f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkInfoBar (93897368812384)>'
