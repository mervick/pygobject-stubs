...
class TextTag(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e8d6310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextTag), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTextTag (94846039326464)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'changed': gi.FunctionInfo(changed), 'event': gi.FunctionInfo(event), 'get_priority': gi.FunctionInfo(get_priority), 'set_priority': gi.FunctionInfo(set_priority), 'do_event': gi.VFuncInfo(event), 'parent_instance': <property object at 0x7fe830f6e1d0>, 'priv': <property object at 0x7fe830f91d10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextTag (94846039326464)>'
