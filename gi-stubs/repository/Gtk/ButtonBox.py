...
class ButtonBox(__gi_overrides_Gtk.Box):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ButtonBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkButtonBox (94846037991584)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_child_non_homogeneous': gi.FunctionInfo(get_child_non_homogeneous), 'get_child_secondary': gi.FunctionInfo(get_child_secondary), 'get_layout': gi.FunctionInfo(get_layout), 'set_child_non_homogeneous': gi.FunctionInfo(set_child_non_homogeneous), 'set_child_secondary': gi.FunctionInfo(set_child_secondary), 'set_layout': gi.FunctionInfo(set_layout), 'box': <property object at 0x7fe8310ac9f0>, 'priv': <property object at 0x7fe8310acae0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkButtonBox (94846037991584)>'
