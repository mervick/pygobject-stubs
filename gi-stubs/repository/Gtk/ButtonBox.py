...
class ButtonBox(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc639ecbf40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ButtonBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkButtonBox (93897368206448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_child_non_homogeneous': gi.FunctionInfo(get_child_non_homogeneous), 'get_child_secondary': gi.FunctionInfo(get_child_secondary), 'get_layout': gi.FunctionInfo(get_layout), 'set_child_non_homogeneous': gi.FunctionInfo(set_child_non_homogeneous), 'set_child_secondary': gi.FunctionInfo(set_child_secondary), 'set_layout': gi.FunctionInfo(set_layout), 'box': <property object at 0x7fc63a7c0900>, 'priv': <property object at 0x7fc63a7c09f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkButtonBox (93897368206448)>'
