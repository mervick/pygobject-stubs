...
class FlowBoxChildAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a0b8370>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FlowBoxChildAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFlowBoxChildAccessible (93897368222288)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a7a6a90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBoxChildAccessible (93897368222288)>'
