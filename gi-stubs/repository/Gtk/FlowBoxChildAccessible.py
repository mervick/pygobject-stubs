...
class FlowBoxChildAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e381c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FlowBoxChildAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFlowBoxChildAccessible (94846038007776)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fe83108fe50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBoxChildAccessible (94846038007776)>'
