...
class WindowAccessible(ContainerAccessible, __gi_repository_Atk.Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc637ef24c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WindowAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkWindowAccessible (93897367480192)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fc63a6661d0>, 'priv': <property object at 0x7fc63a6662c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkWindowAccessible (93897367480192)>'
