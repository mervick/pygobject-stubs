...
class Entry(__gi_overrides_Gtk.Widget, CellEditable, __gi_overrides_Gtk.Editable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEntry (94846038184048)>'
