...
class ListBoxRow(Bin, Actionable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830e143d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ListBoxRow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkListBoxRow (94846038673120)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'changed': gi.FunctionInfo(changed), 'get_activatable': gi.FunctionInfo(get_activatable), 'get_header': gi.FunctionInfo(get_header), 'get_index': gi.FunctionInfo(get_index), 'get_selectable': gi.FunctionInfo(get_selectable), 'is_selected': gi.FunctionInfo(is_selected), 'set_activatable': gi.FunctionInfo(set_activatable), 'set_header': gi.FunctionInfo(set_header), 'set_selectable': gi.FunctionInfo(set_selectable), 'do_activate': gi.VFuncInfo(activate), 'parent_instance': <property object at 0x7fe8310996d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkListBoxRow (94846038673120)>'
