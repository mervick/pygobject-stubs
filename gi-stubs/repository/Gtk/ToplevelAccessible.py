...
class ToplevelAccessible(__gi_repository_Atk.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82e6f66a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToplevelAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToplevelAccessible (94846037280416)>, '__doc__': None, '__gsignals__': {}, 'get_children': gi.FunctionInfo(get_children), 'parent': <property object at 0x7fe830f2d270>, 'priv': <property object at 0x7fe830f2d360>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToplevelAccessible (94846037280416)>'
