...
class Expander(Bin):
    ...
    def new_with_mnemonic(self, label=None): # real signature unknown; restored from __doc__
        """ new_with_mnemonic(label:str=None) -> Gtk.Widget """
        pass
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkExpander (93897368484464)>'
