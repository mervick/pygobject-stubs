...
class GestureSwipe(GestureSingle):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a2cf400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureSwipe), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureSwipe (93897368652944)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_velocity': gi.FunctionInfo(get_velocity)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureSwipe (93897368652944)>'
