...
class Grid(__gi_overrides_Gtk.Container, Orientable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGrid (93897368655392)>'
