...
class ScaleButton(__gi_overrides_Gtk.Button, Orientable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleButton (93897369034240)>'
