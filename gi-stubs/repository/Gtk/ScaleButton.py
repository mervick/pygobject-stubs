...
class ScaleButton(__gi_overrides_Gtk.Button, Orientable):
    ...
    def new(self, size, min, max, step, icons=None): # real signature unknown; restored from __doc__
        """ new(size:int, min:float, max:float, step:float, icons:list=None) -> Gtk.Widget """
        pass
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleButton (94846039120752)>'
