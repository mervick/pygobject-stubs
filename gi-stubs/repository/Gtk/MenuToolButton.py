...
class MenuToolButton(__gi_overrides_Gtk.ToolButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe830702100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuToolButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuToolButton (94846038733424)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_stock': gi.FunctionInfo(new_from_stock), 'get_menu': gi.FunctionInfo(get_menu), 'set_arrow_tooltip_markup': gi.FunctionInfo(set_arrow_tooltip_markup), 'set_arrow_tooltip_text': gi.FunctionInfo(set_arrow_tooltip_text), 'set_menu': gi.FunctionInfo(set_menu), 'do_show_menu': gi.VFuncInfo(show_menu), 'parent': <property object at 0x7fe830ff11d0>, 'priv': <property object at 0x7fe830ff12c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuToolButton (94846038733424)>'
