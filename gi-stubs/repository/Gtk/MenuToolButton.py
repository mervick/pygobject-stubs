...
class MenuToolButton(__gi_overrides_Gtk.ToolButton):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuToolButton (93897368941328)>'
