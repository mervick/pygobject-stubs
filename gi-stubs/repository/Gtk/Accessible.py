...
class Accessible(__gi_repository_Atk.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63a3424f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Accessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAccessible (93897367381552)>, '__doc__': None, '__gsignals__': {}, 'connect_widget_destroyed': gi.FunctionInfo(connect_widget_destroyed), 'get_widget': gi.FunctionInfo(get_widget), 'set_widget': gi.FunctionInfo(set_widget), 'do_connect_widget_destroyed': gi.VFuncInfo(connect_widget_destroyed), 'do_widget_set': gi.VFuncInfo(widget_set), 'do_widget_unset': gi.VFuncInfo(widget_unset), 'parent': <property object at 0x7fc63a7ff810>, 'priv': <property object at 0x7fc63a7ff900>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAccessible (93897367381552)>'
