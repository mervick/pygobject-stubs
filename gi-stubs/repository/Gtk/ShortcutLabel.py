...
class ShortcutLabel(__gi_overrides_Gtk.Box):
    ...
    def new(self, accelerator): # real signature unknown; restored from __doc__
        """ new(accelerator:str) -> Gtk.Widget """
        pass
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkShortcutLabel (94846038473520)>'
