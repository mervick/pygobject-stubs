...
class ShortcutLabel(__gi_overrides_Gtk.Box):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkShortcutLabel (93897368680288)>'
