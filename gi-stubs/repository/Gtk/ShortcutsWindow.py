...
class ShortcutsWindow(__gi_overrides_Gtk.Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe82fc53580>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ShortcutsWindow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkShortcutsWindow (94846039221360)>, '__doc__': None, '__gsignals__': {}, 'do_close': gi.VFuncInfo(close), 'do_search': gi.VFuncInfo(search), 'window': <property object at 0x7fe830fdc720>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkShortcutsWindow (94846039221360)>'
