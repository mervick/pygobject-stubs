...
class ShortcutsWindow(__gi_overrides_Gtk.Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc63935feb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ShortcutsWindow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkShortcutsWindow (93897369424880)>, '__doc__': None, '__gsignals__': {}, 'do_close': gi.VFuncInfo(close), 'do_search': gi.VFuncInfo(search), 'window': <property object at 0x7fc63a6f3400>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkShortcutsWindow (93897369424880)>'
