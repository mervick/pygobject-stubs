...
class SettingVxlan(Setting):
    ...
    def get_l2_miss(self): # real signature unknown; restored from __doc__
        """ get_l2_miss(self) -> bool """
        return False

    def get_l3_miss(self): # real signature unknown; restored from __doc__
        """ get_l3_miss(self) -> bool """
        return False
    ...
    def get_source_port_max(self): # real signature unknown; restored from __doc__
        """ get_source_port_max(self) -> int """
        return 0

    def get_source_port_min(self): # real signature unknown; restored from __doc__
        """ get_source_port_min(self) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b7e90760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingVxlan), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingVxlan (94741104573072)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_ageing': gi.FunctionInfo(get_ageing), 'get_destination_port': gi.FunctionInfo(get_destination_port), 'get_id': gi.FunctionInfo(get_id), 'get_l2_miss': gi.FunctionInfo(get_l2_miss), 'get_l3_miss': gi.FunctionInfo(get_l3_miss), 'get_learning': gi.FunctionInfo(get_learning), 'get_limit': gi.FunctionInfo(get_limit), 'get_local': gi.FunctionInfo(get_local), 'get_parent': gi.FunctionInfo(get_parent), 'get_proxy': gi.FunctionInfo(get_proxy), 'get_remote': gi.FunctionInfo(get_remote), 'get_rsc': gi.FunctionInfo(get_rsc), 'get_source_port_max': gi.FunctionInfo(get_source_port_max), 'get_source_port_min': gi.FunctionInfo(get_source_port_min), 'get_tos': gi.FunctionInfo(get_tos), 'get_ttl': gi.FunctionInfo(get_ttl), 'parent': <property object at 0x7fb9b848d0e0>})"
    __gdoc__ = 'Object NMSettingVxlan\n\nProperties from NMSettingVxlan:\n  parent -> gchararray: \n    \n  id -> guint: \n    \n  local -> gchararray: \n    \n  remote -> gchararray: \n    \n  source-port-min -> guint: \n    \n  source-port-max -> guint: \n    \n  destination-port -> guint: \n    \n  tos -> guint: \n    \n  ttl -> guint: \n    \n  ageing -> guint: \n    \n  limit -> guint: \n    \n  learning -> gboolean: \n    \n  proxy -> gboolean: \n    \n  rsc -> gboolean: \n    \n  l2-miss -> gboolean: \n    \n  l3-miss -> gboolean: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingVxlan (94741104573072)>'
    __info__ = ObjectInfo(SettingVxlan)
