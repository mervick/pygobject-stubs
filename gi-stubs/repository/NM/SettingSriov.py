...
class SettingSriov(Setting):
    ...
    ::
        ...
        new() -> NM.Setting
    """
    def add_vf(self, vf): # real signature unknown; restored from __doc__
        """ add_vf(self, vf:NM.SriovVF) """
        pass
    ...
    def clear_vfs(self): # real signature unknown; restored from __doc__
        """ clear_vfs(self) """
        pass
    ...
    def get_autoprobe_drivers(self): # real signature unknown; restored from __doc__
        """ get_autoprobe_drivers(self) -> NM.Ternary """
        pass
    ...
    def get_num_vfs(self): # real signature unknown; restored from __doc__
        """ get_num_vfs(self) -> int """
        return 0
    ...
    def get_total_vfs(self): # real signature unknown; restored from __doc__
        """ get_total_vfs(self) -> int """
        return 0

    def get_vf(self, idx): # real signature unknown; restored from __doc__
        """ get_vf(self, idx:int) -> NM.SriovVF """
        pass
    ...
    def remove_vf(self, idx): # real signature unknown; restored from __doc__
        """ remove_vf(self, idx:int) """
        pass

    def remove_vf_by_index(self, index): # real signature unknown; restored from __doc__
        """ remove_vf_by_index(self, index:int) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b7e90520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingSriov), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingSriov (94741104540112)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_vf': gi.FunctionInfo(add_vf), 'clear_vfs': gi.FunctionInfo(clear_vfs), 'get_autoprobe_drivers': gi.FunctionInfo(get_autoprobe_drivers), 'get_num_vfs': gi.FunctionInfo(get_num_vfs), 'get_total_vfs': gi.FunctionInfo(get_total_vfs), 'get_vf': gi.FunctionInfo(get_vf), 'remove_vf': gi.FunctionInfo(remove_vf), 'remove_vf_by_index': gi.FunctionInfo(remove_vf_by_index)})"
    __gdoc__ = 'Object NMSettingSriov\n\nProperties from NMSettingSriov:\n  total-vfs -> guint: \n    \n  vfs -> GPtrArray: \n    \n  autoprobe-drivers -> NMTernary: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingSriov (94741104540112)>'
    __info__ = ObjectInfo(SettingSriov)
