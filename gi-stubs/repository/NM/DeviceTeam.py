...
class DeviceTeam(Device):
    ...
    def get_slaves(self): # real signature unknown; restored from __doc__
        """ get_slaves(self) -> list """
        return []
