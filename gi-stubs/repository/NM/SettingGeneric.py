...
class SettingGeneric(Setting):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingGeneric), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingGeneric (94741104460448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fb9b84eea40>})"
    __gdoc__ = 'Object NMSettingGeneric\n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingGeneric (94741104460448)>'
    __info__ = ObjectInfo(SettingGeneric)
