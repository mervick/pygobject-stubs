...
class SettingTun(Setting):
    ...
    def get_mode(self): # real signature unknown; restored from __doc__
        """ get_mode(self) -> NM.SettingTunMode """
        pass

    def get_multi_queue(self): # real signature unknown; restored from __doc__
        """ get_multi_queue(self) -> bool """
        return False
    ...
    def get_pi(self): # real signature unknown; restored from __doc__
        """ get_pi(self) -> bool """
        return False
    ...
    def get_vnet_hdr(self): # real signature unknown; restored from __doc__
        """ get_vnet_hdr(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8200f40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingTun), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingTun (94741104542512)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_group': gi.FunctionInfo(get_group), 'get_mode': gi.FunctionInfo(get_mode), 'get_multi_queue': gi.FunctionInfo(get_multi_queue), 'get_owner': gi.FunctionInfo(get_owner), 'get_pi': gi.FunctionInfo(get_pi), 'get_vnet_hdr': gi.FunctionInfo(get_vnet_hdr), 'parent': <property object at 0x7fb9b8506bd0>})"
    __gdoc__ = 'Object NMSettingTun\n\nProperties from NMSettingTun:\n  mode -> guint: \n    \n  owner -> gchararray: \n    \n  group -> gchararray: \n    \n  pi -> gboolean: \n    \n  vnet-hdr -> gboolean: \n    \n  multi-queue -> gboolean: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingTun (94741104542512)>'
    __info__ = ObjectInfo(SettingTun)
