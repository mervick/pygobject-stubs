...
class SettingEthtool(Setting):
    ...
    def clear_features(self): # real signature unknown; restored from __doc__
        """ clear_features(self) """
        pass
    ...
    def get_feature(self, optname): # real signature unknown; restored from __doc__
        """ get_feature(self, optname:str) -> NM.Ternary """
        pass
    ...
    def get_optnames(self): # real signature unknown; restored from __doc__
        """ get_optnames(self) -> list, out_length:int """
        return []
    ...
    def set_feature(self, optname, value): # real signature unknown; restored from __doc__
        """ set_feature(self, optname:str, value:NM.Ternary) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b82836d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingEthtool), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingEthtool (94741104458288)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'clear_features': gi.FunctionInfo(clear_features), 'get_feature': gi.FunctionInfo(get_feature), 'get_optnames': gi.FunctionInfo(get_optnames), 'set_feature': gi.FunctionInfo(set_feature)})"
    __gdoc__ = 'Object NMSettingEthtool\n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingEthtool (94741104458288)>'
    __info__ = ObjectInfo(SettingEthtool)
