...
class SettingAdsl(Setting):
    ...
    def get_encapsulation(self): # real signature unknown; restored from __doc__
        """ get_encapsulation(self) -> str """
        return ""
    ...
    def get_vci(self): # real signature unknown; restored from __doc__
        """ get_vci(self) -> int """
        return 0

    def get_vpi(self): # real signature unknown; restored from __doc__
        """ get_vpi(self) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b80c2e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingAdsl), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingAdsl (94741104267936)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_encapsulation': gi.FunctionInfo(get_encapsulation), 'get_password': gi.FunctionInfo(get_password), 'get_password_flags': gi.FunctionInfo(get_password_flags), 'get_protocol': gi.FunctionInfo(get_protocol), 'get_username': gi.FunctionInfo(get_username), 'get_vci': gi.FunctionInfo(get_vci), 'get_vpi': gi.FunctionInfo(get_vpi), 'parent': <property object at 0x7fb9b8cbcdb0>})"
    __gdoc__ = 'Object NMSettingAdsl\n\nProperties from NMSettingAdsl:\n  username -> gchararray: \n    \n  password -> gchararray: \n    \n  password-flags -> NMSettingSecretFlags: \n    \n  protocol -> gchararray: \n    \n  encapsulation -> gchararray: \n    \n  vpi -> guint: \n    \n  vci -> guint: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingAdsl (94741104267936)>'
    __info__ = ObjectInfo(SettingAdsl)
