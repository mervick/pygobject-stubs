...
class VpnServicePlugin(__gi_overrides_GObject.Object, __gi_repository_Gio.Initable):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b7caa370>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VpnServicePlugin), '__module__': 'gi.repository.NM', '__gtype__': <GType NMVpnServicePlugin (94741104724992)>, '__doc__': None, '__gsignals__': {}, 'get_secret_flags': gi.FunctionInfo(get_secret_flags), 'read_vpn_details': gi.FunctionInfo(read_vpn_details), 'disconnect': gi.FunctionInfo(disconnect), 'failure': gi.FunctionInfo(failure), 'get_connection': gi.FunctionInfo(get_connection), 'secrets_required': gi.FunctionInfo(secrets_required), 'set_config': gi.FunctionInfo(set_config), 'set_ip4_config': gi.FunctionInfo(set_ip4_config), 'set_ip6_config': gi.FunctionInfo(set_ip6_config), 'set_login_banner': gi.FunctionInfo(set_login_banner), 'shutdown': gi.FunctionInfo(shutdown), 'do_config': gi.VFuncInfo(config), 'do_connect': gi.VFuncInfo(connect), 'do_connect_interactive': gi.VFuncInfo(connect_interactive), 'do_disconnect': gi.VFuncInfo(disconnect), 'do_failure': gi.VFuncInfo(failure), 'do_ip4_config': gi.VFuncInfo(ip4_config), 'do_ip6_config': gi.VFuncInfo(ip6_config), 'do_login_banner': gi.VFuncInfo(login_banner), 'do_need_secrets': gi.VFuncInfo(need_secrets), 'do_new_secrets': gi.VFuncInfo(new_secrets), 'do_quit': gi.VFuncInfo(quit), 'do_state_changed': gi.VFuncInfo(state_changed), 'parent': <property object at 0x7fb9b84ae130>})"
    __gdoc__ = 'Object NMVpnServicePlugin\n\nSignals from NMVpnServicePlugin:\n  ip4-config (GVariant)\n  ip6-config (GVariant)\n  state-changed (guint)\n  config (GVariant)\n  secrets-required (gchararray, GStrv)\n  login-banner (gchararray)\n  failure (guint)\n  quit ()\n\nProperties from NMVpnServicePlugin:\n  service-name -> gchararray: \n    \n  watch-peer -> gboolean: \n    \n  state -> NMVpnServiceState: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMVpnServicePlugin (94741104724992)>'
    __info__ = ObjectInfo(VpnServicePlugin)
