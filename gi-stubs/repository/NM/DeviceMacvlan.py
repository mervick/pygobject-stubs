...
class DeviceMacvlan(Device):
    ...
    def get_no_promisc(self): # real signature unknown; restored from __doc__
        """ get_no_promisc(self) -> bool """
        return False
