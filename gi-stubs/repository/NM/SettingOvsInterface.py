...
class SettingOvsInterface(Setting):
    ...
    def get_interface_type(self): # real signature unknown; restored from __doc__
        """ get_interface_type(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b7e90340>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingOvsInterface), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingOvsInterface (94741104516064)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_interface_type': gi.FunctionInfo(get_interface_type)})"
    __gdoc__ = 'Object NMSettingOvsInterface\n\nProperties from NMSettingOvsInterface:\n  type -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingOvsInterface (94741104516064)>'
    __info__ = ObjectInfo(SettingOvsInterface)
