...
class DeviceVlan(Device):
    ...
    def get_vlan_id(self): # real signature unknown; restored from __doc__
        """ get_vlan_id(self) -> int """
        return 0
