...
class DeviceWifi(Device):
    ...
    def get_access_points(self): # real signature unknown; restored from __doc__
        """ get_access_points(self) -> list """
        return []

    def get_access_point_by_path(self, path): # real signature unknown; restored from __doc__
        """ get_access_point_by_path(self, path:str) -> NM.AccessPoint """
        pass

    def get_active_access_point(self): # real signature unknown; restored from __doc__
        """ get_active_access_point(self) -> NM.AccessPoint """
        pass
    ...
    def get_capabilities(self): # real signature unknown; restored from __doc__
        """ get_capabilities(self) -> NM.DeviceWifiCapabilities """
        pass
    ...
    def get_last_scan(self): # real signature unknown; restored from __doc__
        """ get_last_scan(self) -> int """
        return 0
    ...
    def get_permanent_hw_address(self): # real signature unknown; restored from __doc__
        """ get_permanent_hw_address(self) -> str """
        return ""
    ...
    def request_scan(self, cancellable=None): # real signature unknown; restored from __doc__
        """ request_scan(self, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def request_scan_async(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ request_scan_async(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def request_scan_finish(self, result): # real signature unknown; restored from __doc__
        """ request_scan_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def request_scan_options(self, options, cancellable=None): # real signature unknown; restored from __doc__
        """ request_scan_options(self, options:GLib.Variant, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def request_scan_options_async(self, options, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ request_scan_options_async(self, options:GLib.Variant, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b828c550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceWifi), '__module__': 'gi.repository.NM', '__gtype__': <GType NMDeviceWifi (94741104284656)>, '__doc__': None, '__gsignals__': {}, 'get_access_point_by_path': gi.FunctionInfo(get_access_point_by_path), 'get_access_points': gi.FunctionInfo(get_access_points), 'get_active_access_point': gi.FunctionInfo(get_active_access_point), 'get_bitrate': gi.FunctionInfo(get_bitrate), 'get_capabilities': gi.FunctionInfo(get_capabilities), 'get_hw_address': gi.FunctionInfo(get_hw_address), 'get_last_scan': gi.FunctionInfo(get_last_scan), 'get_mode': gi.FunctionInfo(get_mode), 'get_permanent_hw_address': gi.FunctionInfo(get_permanent_hw_address), 'request_scan': gi.FunctionInfo(request_scan), 'request_scan_async': gi.FunctionInfo(request_scan_async), 'request_scan_finish': gi.FunctionInfo(request_scan_finish), 'request_scan_options': gi.FunctionInfo(request_scan_options), 'request_scan_options_async': gi.FunctionInfo(request_scan_options_async)})"
    __gdoc__ = 'Object NMDeviceWifi\n\nSignals from NMDeviceWifi:\n  access-point-added (GObject)\n  access-point-removed (GObject)\n\nProperties from NMDeviceWifi:\n  hw-address -> gchararray: \n    \n  perm-hw-address -> gchararray: \n    \n  mode -> NM80211Mode: \n    \n  bitrate -> guint: \n    \n  access-points -> GPtrArray: \n    \n  active-access-point -> NMAccessPoint: \n    \n  wireless-capabilities -> NMDeviceWifiCapabilities: \n    \n  last-scan -> gint64: \n    \n\nSignals from NMDevice:\n  state-changed (guint, guint, guint)\n\nProperties from NMDevice:\n  interface -> gchararray: \n    \n  udi -> gchararray: \n    \n  driver -> gchararray: \n    \n  driver-version -> gchararray: \n    \n  firmware-version -> gchararray: \n    \n  capabilities -> NMDeviceCapabilities: \n    \n  real -> gboolean: \n    \n  managed -> gboolean: \n    \n  autoconnect -> gboolean: \n    \n  firmware-missing -> gboolean: \n    \n  nm-plugin-missing -> gboolean: \n    \n  ip4-config -> NMIPConfig: \n    \n  dhcp4-config -> NMDhcpConfig: \n    \n  ip6-config -> NMIPConfig: \n    \n  state -> NMDeviceState: \n    \n  state-reason -> guint: \n    \n  product -> gchararray: \n    \n  vendor -> gchararray: \n    \n  dhcp6-config -> NMDhcpConfig: \n    \n  ip-interface -> gchararray: \n    \n  device-type -> NMDeviceType: \n    \n  active-connection -> NMActiveConnection: \n    \n  available-connections -> GPtrArray: \n    \n  physical-port-id -> gchararray: \n    \n  mtu -> guint: \n    \n  metered -> guint: \n    \n  lldp-neighbors -> GPtrArray: \n    \n  ip4-connectivity -> NMConnectivityState: \n    \n  ip6-connectivity -> NMConnectivityState: \n    \n  interface-flags -> guint: \n    \n\nProperties from NMObject:\n  path -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMDeviceWifi (94741104284656)>'
    __info__ = ObjectInfo(DeviceWifi)
