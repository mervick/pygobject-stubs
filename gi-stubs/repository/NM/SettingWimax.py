...
class SettingWimax(Setting):
    ...
    def get_network_name(self): # real signature unknown; restored from __doc__
        """ get_network_name(self) -> str """
        return ""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingWimax), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingWimax (94741104184512)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_mac_address': gi.FunctionInfo(get_mac_address), 'get_network_name': gi.FunctionInfo(get_network_name), 'parent': <property object at 0x7fb9b848d720>})"
    __gdoc__ = 'Object NMSettingWimax\n\nProperties from NMSettingWimax:\n  network-name -> gchararray: \n    \n  mac-address -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingWimax (94741104184512)>'
    __info__ = ObjectInfo(SettingWimax)
