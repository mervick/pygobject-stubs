...
class SettingOvsPort(Setting):
    ...
    def get_bond_downdelay(self): # real signature unknown; restored from __doc__
        """ get_bond_downdelay(self) -> int """
        return 0

    def get_bond_mode(self): # real signature unknown; restored from __doc__
        """ get_bond_mode(self) -> str """
        return ""

    def get_bond_updelay(self): # real signature unknown; restored from __doc__
        """ get_bond_updelay(self) -> int """
        return 0
    ...
    def get_lacp(self): # real signature unknown; restored from __doc__
        """ get_lacp(self) -> str """
        return ""
    ...
    def get_vlan_mode(self): # real signature unknown; restored from __doc__
        """ get_vlan_mode(self) -> str """
        return ""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingOvsPort), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingOvsPort (94741104520368)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_bond_downdelay': gi.FunctionInfo(get_bond_downdelay), 'get_bond_mode': gi.FunctionInfo(get_bond_mode), 'get_bond_updelay': gi.FunctionInfo(get_bond_updelay), 'get_lacp': gi.FunctionInfo(get_lacp), 'get_tag': gi.FunctionInfo(get_tag), 'get_vlan_mode': gi.FunctionInfo(get_vlan_mode)})"
    __gdoc__ = 'Object NMSettingOvsPort\n\nProperties from NMSettingOvsPort:\n  vlan-mode -> gchararray: \n    \n  tag -> guint: \n    \n  lacp -> gchararray: \n    \n  bond-mode -> gchararray: \n    \n  bond-updelay -> guint: \n    \n  bond-downdelay -> guint: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingOvsPort (94741104520368)>'
    __info__ = ObjectInfo(SettingOvsPort)
