...
class DeviceMacsec(Device):
    ...
    def get_cipher_suite(self): # real signature unknown; restored from __doc__
        """ get_cipher_suite(self) -> int """
        return 0
    ...
    def get_encoding_sa(self): # real signature unknown; restored from __doc__
        """ get_encoding_sa(self) -> int """
        return 0

    def get_encrypt(self): # real signature unknown; restored from __doc__
        """ get_encrypt(self) -> bool """
        return False

    def get_es(self): # real signature unknown; restored from __doc__
        """ get_es(self) -> bool """
        return False
    ...
    def get_icv_length(self): # real signature unknown; restored from __doc__
        """ get_icv_length(self) -> int """
        return 0
    ...
    def get_include_sci(self): # real signature unknown; restored from __doc__
        """ get_include_sci(self) -> bool """
        return False
    ...
    def get_protect(self): # real signature unknown; restored from __doc__
        """ get_protect(self) -> bool """
        return False
    ...
    def get_replay_protect(self): # real signature unknown; restored from __doc__
        """ get_replay_protect(self) -> bool """
        return False

    def get_scb(self): # real signature unknown; restored from __doc__
        """ get_scb(self) -> bool """
        return False

    def get_sci(self): # real signature unknown; restored from __doc__
        """ get_sci(self) -> int """
        return 0
    ...
    def get_validation(self): # real signature unknown; restored from __doc__
        """ get_validation(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b841dbb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceMacsec), '__module__': 'gi.repository.NM', '__gtype__': <GType NMDeviceMacsec (94741104238048)>, '__doc__': None, '__gsignals__': {}, 'get_cipher_suite': gi.FunctionInfo(get_cipher_suite), 'get_encoding_sa': gi.FunctionInfo(get_encoding_sa), 'get_encrypt': gi.FunctionInfo(get_encrypt), 'get_es': gi.FunctionInfo(get_es), 'get_hw_address': gi.FunctionInfo(get_hw_address), 'get_icv_length': gi.FunctionInfo(get_icv_length), 'get_include_sci': gi.FunctionInfo(get_include_sci), 'get_parent': gi.FunctionInfo(get_parent), 'get_protect': gi.FunctionInfo(get_protect), 'get_replay_protect': gi.FunctionInfo(get_replay_protect), 'get_scb': gi.FunctionInfo(get_scb), 'get_sci': gi.FunctionInfo(get_sci), 'get_validation': gi.FunctionInfo(get_validation), 'get_window': gi.FunctionInfo(get_window)})"
    __gdoc__ = 'Object NMDeviceMacsec\n\nProperties from NMDeviceMacsec:\n  parent -> NMDevice: \n    \n  hw-address -> gchararray: \n    \n  sci -> guint64: \n    \n  cipher-suite -> guint64: \n    \n  icv-length -> guchar: \n    \n  window -> guint: \n    \n  encoding-sa -> guchar: \n    \n  encrypt -> gboolean: \n    \n  protect -> gboolean: \n    \n  include-sci -> gboolean: \n    \n  es -> gboolean: \n    \n  scb -> gboolean: \n    \n  replay-protect -> gboolean: \n    \n  validation -> gchararray: \n    \n\nSignals from NMDevice:\n  state-changed (guint, guint, guint)\n\nProperties from NMDevice:\n  interface -> gchararray: \n    \n  udi -> gchararray: \n    \n  driver -> gchararray: \n    \n  driver-version -> gchararray: \n    \n  firmware-version -> gchararray: \n    \n  capabilities -> NMDeviceCapabilities: \n    \n  real -> gboolean: \n    \n  managed -> gboolean: \n    \n  autoconnect -> gboolean: \n    \n  firmware-missing -> gboolean: \n    \n  nm-plugin-missing -> gboolean: \n    \n  ip4-config -> NMIPConfig: \n    \n  dhcp4-config -> NMDhcpConfig: \n    \n  ip6-config -> NMIPConfig: \n    \n  state -> NMDeviceState: \n    \n  state-reason -> guint: \n    \n  product -> gchararray: \n    \n  vendor -> gchararray: \n    \n  dhcp6-config -> NMDhcpConfig: \n    \n  ip-interface -> gchararray: \n    \n  device-type -> NMDeviceType: \n    \n  active-connection -> NMActiveConnection: \n    \n  available-connections -> GPtrArray: \n    \n  physical-port-id -> gchararray: \n    \n  mtu -> guint: \n    \n  metered -> guint: \n    \n  lldp-neighbors -> GPtrArray: \n    \n  ip4-connectivity -> NMConnectivityState: \n    \n  ip6-connectivity -> NMConnectivityState: \n    \n  interface-flags -> guint: \n    \n\nProperties from NMObject:\n  path -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMDeviceMacsec (94741104238048)>'
    __info__ = ObjectInfo(DeviceMacsec)
