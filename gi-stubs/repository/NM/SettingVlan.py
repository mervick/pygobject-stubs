...
class SettingVlan(Setting):
    ...
    ::
        ...
        new() -> NM.Setting
    """
    def add_priority(self, map, from_, to): # real signature unknown; restored from __doc__
        """ add_priority(self, map:NM.VlanPriorityMap, from_:int, to:int) -> bool """
        return False

    def add_priority_str(self, map, p_str): # real signature unknown; restored from __doc__
        """ add_priority_str(self, map:NM.VlanPriorityMap, str:str) -> bool """
        return False
    ...
    def clear_priorities(self, map): # real signature unknown; restored from __doc__
        """ clear_priorities(self, map:NM.VlanPriorityMap) """
        pass
    ...
    def get_num_priorities(self, map): # real signature unknown; restored from __doc__
        """ get_num_priorities(self, map:NM.VlanPriorityMap) -> int """
        return 0
    ...
    def get_priority(self, map, idx): # real signature unknown; restored from __doc__
        """ get_priority(self, map:NM.VlanPriorityMap, idx:int) -> bool, out_from:int, out_to:int """
        return False
    ...
    def remove_priority(self, map, idx): # real signature unknown; restored from __doc__
        """ remove_priority(self, map:NM.VlanPriorityMap, idx:int) """
        pass

    def remove_priority_by_value(self, map, from_, to): # real signature unknown; restored from __doc__
        """ remove_priority_by_value(self, map:NM.VlanPriorityMap, from_:int, to:int) -> bool """
        return False

    def remove_priority_str_by_value(self, map, p_str): # real signature unknown; restored from __doc__
        """ remove_priority_str_by_value(self, map:NM.VlanPriorityMap, str:str) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b80c22e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingVlan), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingVlan (94741104561472)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_priority': gi.FunctionInfo(add_priority), 'add_priority_str': gi.FunctionInfo(add_priority_str), 'clear_priorities': gi.FunctionInfo(clear_priorities), 'get_flags': gi.FunctionInfo(get_flags), 'get_id': gi.FunctionInfo(get_id), 'get_num_priorities': gi.FunctionInfo(get_num_priorities), 'get_parent': gi.FunctionInfo(get_parent), 'get_priority': gi.FunctionInfo(get_priority), 'remove_priority': gi.FunctionInfo(remove_priority), 'remove_priority_by_value': gi.FunctionInfo(remove_priority_by_value), 'remove_priority_str_by_value': gi.FunctionInfo(remove_priority_str_by_value), 'parent': <property object at 0x7fb9b848b590>})"
    __gdoc__ = 'Object NMSettingVlan\n\nProperties from NMSettingVlan:\n  parent -> gchararray: \n    \n  id -> guint: \n    \n  flags -> NMVlanFlags: \n    \n  ingress-priority-map -> GStrv: \n    \n  egress-priority-map -> GStrv: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingVlan (94741104561472)>'
    __info__ = ObjectInfo(SettingVlan)
