...
class VpnConnection(ActiveConnection):
    ...
    def get_banner(self): # real signature unknown; restored from __doc__
        """ get_banner(self) -> str """
        return ""
    ...
    def get_vpn_state(self): # real signature unknown; restored from __doc__
        """ get_vpn_state(self) -> NM.VpnConnectionState """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b7e90e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VpnConnection), '__module__': 'gi.repository.NM', '__gtype__': <GType NMVpnConnection (94741104688672)>, '__doc__': None, '__gsignals__': {}, 'get_banner': gi.FunctionInfo(get_banner), 'get_vpn_state': gi.FunctionInfo(get_vpn_state)})"
    __gdoc__ = 'Object NMVpnConnection\n\nSignals from NMVpnConnection:\n  vpn-state-changed (guint, guint)\n\nProperties from NMVpnConnection:\n  vpn-state -> NMVpnConnectionState: \n    \n  banner -> gchararray: \n    \n\nSignals from NMActiveConnection:\n  state-changed (guint, guint)\n\nProperties from NMActiveConnection:\n  connection -> NMRemoteConnection: \n    \n  id -> gchararray: \n    \n  uuid -> gchararray: \n    \n  type -> gchararray: \n    \n  specific-object-path -> gchararray: \n    \n  devices -> GPtrArray: \n    \n  state -> NMActiveConnectionState: \n    \n  state-flags -> guint: \n    \n  default -> gboolean: \n    \n  ip4-config -> NMIPConfig: \n    \n  dhcp4-config -> NMDhcpConfig: \n    \n  default6 -> gboolean: \n    \n  ip6-config -> NMIPConfig: \n    \n  dhcp6-config -> NMDhcpConfig: \n    \n  vpn -> gboolean: \n    \n  master -> NMDevice: \n    \n\nProperties from NMObject:\n  path -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMVpnConnection (94741104688672)>'
    __info__ = ObjectInfo(VpnConnection)
