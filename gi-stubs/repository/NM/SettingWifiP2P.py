...
class SettingWifiP2P(Setting):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8200070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingWifiP2P), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingWifiP2P (94741104576368)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_peer': gi.FunctionInfo(get_peer), 'get_wfd_ies': gi.FunctionInfo(get_wfd_ies), 'get_wps_method': gi.FunctionInfo(get_wps_method)})"
    __gdoc__ = 'Object NMSettingWifiP2P\n\nProperties from NMSettingWifiP2P:\n  peer -> gchararray: \n    \n  wps-method -> guint: \n    \n  wfd-ies -> GBytes: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingWifiP2P (94741104576368)>'
    __info__ = ObjectInfo(SettingWifiP2P)
