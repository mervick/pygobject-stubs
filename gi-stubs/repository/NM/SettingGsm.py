...
class SettingGsm(Setting):
    ...
    def get_auto_config(self): # real signature unknown; restored from __doc__
        """ get_auto_config(self) -> bool """
        return False
    ...
    def get_device_id(self): # real signature unknown; restored from __doc__
        """ get_device_id(self) -> str """
        return ""

    def get_home_only(self): # real signature unknown; restored from __doc__
        """ get_home_only(self) -> bool """
        return False
    ...
    def get_network_id(self): # real signature unknown; restored from __doc__
        """ get_network_id(self) -> str """
        return ""
    ...
    def get_sim_id(self): # real signature unknown; restored from __doc__
        """ get_sim_id(self) -> str """
        return ""

    def get_sim_operator_id(self): # real signature unknown; restored from __doc__
        """ get_sim_operator_id(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8283400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingGsm), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingGsm (94741104462592)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_apn': gi.FunctionInfo(get_apn), 'get_auto_config': gi.FunctionInfo(get_auto_config), 'get_device_id': gi.FunctionInfo(get_device_id), 'get_home_only': gi.FunctionInfo(get_home_only), 'get_mtu': gi.FunctionInfo(get_mtu), 'get_network_id': gi.FunctionInfo(get_network_id), 'get_number': gi.FunctionInfo(get_number), 'get_password': gi.FunctionInfo(get_password), 'get_password_flags': gi.FunctionInfo(get_password_flags), 'get_pin': gi.FunctionInfo(get_pin), 'get_pin_flags': gi.FunctionInfo(get_pin_flags), 'get_sim_id': gi.FunctionInfo(get_sim_id), 'get_sim_operator_id': gi.FunctionInfo(get_sim_operator_id), 'get_username': gi.FunctionInfo(get_username), 'parent': <property object at 0x7fb9b84eeef0>})"
    __gdoc__ = 'Object NMSettingGsm\n\nProperties from NMSettingGsm:\n  auto-config -> gboolean: \n    \n  number -> gchararray: \n    \n  username -> gchararray: \n    \n  password -> gchararray: \n    \n  password-flags -> NMSettingSecretFlags: \n    \n  apn -> gchararray: \n    \n  network-id -> gchararray: \n    \n  pin -> gchararray: \n    \n  pin-flags -> NMSettingSecretFlags: \n    \n  home-only -> gboolean: \n    \n  device-id -> gchararray: \n    \n  sim-id -> gchararray: \n    \n  sim-operator-id -> gchararray: \n    \n  mtu -> guint: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingGsm (94741104462592)>'
    __info__ = ObjectInfo(SettingGsm)
