...
class DeviceIPTunnel(Device):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b84a8e20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceIPTunnel), '__module__': 'gi.repository.NM', '__gtype__': <GType NMDeviceIPTunnel (94741104231216)>, '__doc__': None, '__gsignals__': {}, 'get_encapsulation_limit': gi.FunctionInfo(get_encapsulation_limit), 'get_flags': gi.FunctionInfo(get_flags), 'get_flow_label': gi.FunctionInfo(get_flow_label), 'get_input_key': gi.FunctionInfo(get_input_key), 'get_local': gi.FunctionInfo(get_local), 'get_mode': gi.FunctionInfo(get_mode), 'get_output_key': gi.FunctionInfo(get_output_key), 'get_parent': gi.FunctionInfo(get_parent), 'get_path_mtu_discovery': gi.FunctionInfo(get_path_mtu_discovery), 'get_remote': gi.FunctionInfo(get_remote), 'get_tos': gi.FunctionInfo(get_tos), 'get_ttl': gi.FunctionInfo(get_ttl)})"
    __gdoc__ = 'Object NMDeviceIPTunnel\n\nProperties from NMDeviceIPTunnel:\n  mode -> guint: \n    \n  parent -> NMDevice: \n    \n  local -> gchararray: \n    \n  remote -> gchararray: \n    \n  ttl -> guchar: \n    \n  tos -> guchar: \n    \n  path-mtu-discovery -> gboolean: \n    \n  input-key -> gchararray: \n    \n  output-key -> gchararray: \n    \n  encapsulation-limit -> guchar: \n    \n  flow-label -> guint: \n    \n  flags -> guint: \n    \n\nSignals from NMDevice:\n  state-changed (guint, guint, guint)\n\nProperties from NMDevice:\n  interface -> gchararray: \n    \n  udi -> gchararray: \n    \n  driver -> gchararray: \n    \n  driver-version -> gchararray: \n    \n  firmware-version -> gchararray: \n    \n  capabilities -> NMDeviceCapabilities: \n    \n  real -> gboolean: \n    \n  managed -> gboolean: \n    \n  autoconnect -> gboolean: \n    \n  firmware-missing -> gboolean: \n    \n  nm-plugin-missing -> gboolean: \n    \n  ip4-config -> NMIPConfig: \n    \n  dhcp4-config -> NMDhcpConfig: \n    \n  ip6-config -> NMIPConfig: \n    \n  state -> NMDeviceState: \n    \n  state-reason -> guint: \n    \n  product -> gchararray: \n    \n  vendor -> gchararray: \n    \n  dhcp6-config -> NMDhcpConfig: \n    \n  ip-interface -> gchararray: \n    \n  device-type -> NMDeviceType: \n    \n  active-connection -> NMActiveConnection: \n    \n  available-connections -> GPtrArray: \n    \n  physical-port-id -> gchararray: \n    \n  mtu -> guint: \n    \n  metered -> guint: \n    \n  lldp-neighbors -> GPtrArray: \n    \n  ip4-connectivity -> NMConnectivityState: \n    \n  ip6-connectivity -> NMConnectivityState: \n    \n  interface-flags -> guint: \n    \n\nProperties from NMObject:\n  path -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMDeviceIPTunnel (94741104231216)>'
    __info__ = ObjectInfo(DeviceIPTunnel)
