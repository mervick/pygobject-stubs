...
class SettingTeamPort(Setting):
    ...
    def get_lacp_key(self): # real signature unknown; restored from __doc__
        """ get_lacp_key(self) -> int """
        return 0

    def get_lacp_prio(self): # real signature unknown; restored from __doc__
        """ get_lacp_prio(self) -> int """
        return 0
    ...
    def get_queue_id(self): # real signature unknown; restored from __doc__
        """ get_queue_id(self) -> int """
        return 0
    ...
    def get_sticky(self): # real signature unknown; restored from __doc__
        """ get_sticky(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b7e90970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingTeamPort), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingTeamPort (94741104548864)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_link_watcher': gi.FunctionInfo(add_link_watcher), 'clear_link_watchers': gi.FunctionInfo(clear_link_watchers), 'get_config': gi.FunctionInfo(get_config), 'get_lacp_key': gi.FunctionInfo(get_lacp_key), 'get_lacp_prio': gi.FunctionInfo(get_lacp_prio), 'get_link_watcher': gi.FunctionInfo(get_link_watcher), 'get_num_link_watchers': gi.FunctionInfo(get_num_link_watchers), 'get_prio': gi.FunctionInfo(get_prio), 'get_queue_id': gi.FunctionInfo(get_queue_id), 'get_sticky': gi.FunctionInfo(get_sticky), 'remove_link_watcher': gi.FunctionInfo(remove_link_watcher), 'remove_link_watcher_by_value': gi.FunctionInfo(remove_link_watcher_by_value), 'parent': <property object at 0x7fb9b8506770>})"
    __gdoc__ = 'Object NMSettingTeamPort\n\nProperties from NMSettingTeamPort:\n  config -> gchararray: \n    \n  link-watchers -> GPtrArray: \n    \n  queue-id -> gint: \n    \n  prio -> gint: \n    \n  sticky -> gboolean: \n    \n  lacp-prio -> gint: \n    \n  lacp-key -> gint: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingTeamPort (94741104548864)>'
    __info__ = ObjectInfo(SettingTeamPort)
