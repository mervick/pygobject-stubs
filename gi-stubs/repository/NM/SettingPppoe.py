...
class SettingPppoe(Setting):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b841d130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingPppoe), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingPppoe (94741104527184)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_parent': gi.FunctionInfo(get_parent), 'get_password': gi.FunctionInfo(get_password), 'get_password_flags': gi.FunctionInfo(get_password_flags), 'get_service': gi.FunctionInfo(get_service), 'get_username': gi.FunctionInfo(get_username), 'parent': <property object at 0x7fb9b8501180>})"
    __gdoc__ = 'Object NMSettingPppoe\n\nProperties from NMSettingPppoe:\n  parent -> gchararray: \n    \n  service -> gchararray: \n    \n  username -> gchararray: \n    \n  password -> gchararray: \n    \n  password-flags -> NMSettingSecretFlags: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingPppoe (94741104527184)>'
    __info__ = ObjectInfo(SettingPppoe)
