...
class SettingMacvlan(Setting):
    ...
    def get_mode(self): # real signature unknown; restored from __doc__
        """ get_mode(self) -> NM.SettingMacvlanMode """
        pass
    ...
    def get_promiscuous(self): # real signature unknown; restored from __doc__
        """ get_promiscuous(self) -> bool """
        return False
    ...
    def get_tap(self): # real signature unknown; restored from __doc__
        """ get_tap(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b82002b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingMacvlan), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingMacvlan (94741104501584)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_mode': gi.FunctionInfo(get_mode), 'get_parent': gi.FunctionInfo(get_parent), 'get_promiscuous': gi.FunctionInfo(get_promiscuous), 'get_tap': gi.FunctionInfo(get_tap), 'parent': <property object at 0x7fb9b84fa310>})"
    __gdoc__ = 'Object NMSettingMacvlan\n\nProperties from NMSettingMacvlan:\n  parent -> gchararray: \n    \n  mode -> guint: \n    \n  promiscuous -> gboolean: \n    \n  tap -> gboolean: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingMacvlan (94741104501584)>'
    __info__ = ObjectInfo(SettingMacvlan)
