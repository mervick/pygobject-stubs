...
class SettingOvsBridge(Setting):
    ...
    def get_datapath_type(self): # real signature unknown; restored from __doc__
        """ get_datapath_type(self) -> str """
        return ""
    ...
    def get_fail_mode(self): # real signature unknown; restored from __doc__
        """ get_fail_mode(self) -> str """
        return ""

    def get_mcast_snooping_enable(self): # real signature unknown; restored from __doc__
        """ get_mcast_snooping_enable(self) -> bool """
        return False
    ...
    def get_rstp_enable(self): # real signature unknown; restored from __doc__
        """ get_rstp_enable(self) -> bool """
        return False
    ...
    def get_stp_enable(self): # real signature unknown; restored from __doc__
        """ get_stp_enable(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b841d1f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingOvsBridge), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingOvsBridge (94741104510608)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_datapath_type': gi.FunctionInfo(get_datapath_type), 'get_fail_mode': gi.FunctionInfo(get_fail_mode), 'get_mcast_snooping_enable': gi.FunctionInfo(get_mcast_snooping_enable), 'get_rstp_enable': gi.FunctionInfo(get_rstp_enable), 'get_stp_enable': gi.FunctionInfo(get_stp_enable)})"
    __gdoc__ = 'Object NMSettingOvsBridge\n\nProperties from NMSettingOvsBridge:\n  fail-mode -> gchararray: \n    \n  mcast-snooping-enable -> gboolean: \n    \n  rstp-enable -> gboolean: \n    \n  stp-enable -> gboolean: \n    \n  datapath-type -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingOvsBridge (94741104510608)>'
    __info__ = ObjectInfo(SettingOvsBridge)
