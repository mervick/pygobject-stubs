...
class Device(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8467fa0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Device), '__module__': 'gi.repository.NM', '__gtype__': <GType NMDevice (94741104192064)>, '__doc__': None, '__gsignals__': {}, 'disambiguate_names': gi.FunctionInfo(disambiguate_names), 'connection_compatible': gi.FunctionInfo(connection_compatible), 'connection_valid': gi.FunctionInfo(connection_valid), 'delete': gi.FunctionInfo(delete), 'delete_async': gi.FunctionInfo(delete_async), 'delete_finish': gi.FunctionInfo(delete_finish), 'disconnect': gi.FunctionInfo(disconnect), 'disconnect_async': gi.FunctionInfo(disconnect_async), 'disconnect_finish': gi.FunctionInfo(disconnect_finish), 'filter_connections': gi.FunctionInfo(filter_connections), 'get_active_connection': gi.FunctionInfo(get_active_connection), 'get_applied_connection': gi.FunctionInfo(get_applied_connection), 'get_applied_connection_async': gi.FunctionInfo(get_applied_connection_async), 'get_applied_connection_finish': gi.FunctionInfo(get_applied_connection_finish), 'get_autoconnect': gi.FunctionInfo(get_autoconnect), 'get_available_connections': gi.FunctionInfo(get_available_connections), 'get_capabilities': gi.FunctionInfo(get_capabilities), 'get_connectivity': gi.FunctionInfo(get_connectivity), 'get_description': gi.FunctionInfo(get_description), 'get_device_type': gi.FunctionInfo(get_device_type), 'get_dhcp4_config': gi.FunctionInfo(get_dhcp4_config), 'get_dhcp6_config': gi.FunctionInfo(get_dhcp6_config), 'get_driver': gi.FunctionInfo(get_driver), 'get_driver_version': gi.FunctionInfo(get_driver_version), 'get_firmware_missing': gi.FunctionInfo(get_firmware_missing), 'get_firmware_version': gi.FunctionInfo(get_firmware_version), 'get_hw_address': gi.FunctionInfo(get_hw_address), 'get_iface': gi.FunctionInfo(get_iface), 'get_interface_flags': gi.FunctionInfo(get_interface_flags), 'get_ip4_config': gi.FunctionInfo(get_ip4_config), 'get_ip6_config': gi.FunctionInfo(get_ip6_config), 'get_ip_iface': gi.FunctionInfo(get_ip_iface), 'get_lldp_neighbors': gi.FunctionInfo(get_lldp_neighbors), 'get_managed': gi.FunctionInfo(get_managed), 'get_metered': gi.FunctionInfo(get_metered), 'get_mtu': gi.FunctionInfo(get_mtu), 'get_nm_plugin_missing': gi.FunctionInfo(get_nm_plugin_missing), 'get_physical_port_id': gi.FunctionInfo(get_physical_port_id), 'get_product': gi.FunctionInfo(get_product), 'get_setting_type': gi.FunctionInfo(get_setting_type), 'get_state': gi.FunctionInfo(get_state), 'get_state_reason': gi.FunctionInfo(get_state_reason), 'get_type_description': gi.FunctionInfo(get_type_description), 'get_udi': gi.FunctionInfo(get_udi), 'get_vendor': gi.FunctionInfo(get_vendor), 'is_real': gi.FunctionInfo(is_real), 'is_software': gi.FunctionInfo(is_software), 'reapply': gi.FunctionInfo(reapply), 'reapply_async': gi.FunctionInfo(reapply_async), 'reapply_finish': gi.FunctionInfo(reapply_finish), 'set_autoconnect': gi.FunctionInfo(set_autoconnect), 'set_managed': gi.FunctionInfo(set_managed)})"
    __gdoc__ = 'Object NMDevice\n\nSignals from NMDevice:\n  state-changed (guint, guint, guint)\n\nProperties from NMDevice:\n  interface -> gchararray: \n    \n  udi -> gchararray: \n    \n  driver -> gchararray: \n    \n  driver-version -> gchararray: \n    \n  firmware-version -> gchararray: \n    \n  capabilities -> NMDeviceCapabilities: \n    \n  real -> gboolean: \n    \n  managed -> gboolean: \n    \n  autoconnect -> gboolean: \n    \n  firmware-missing -> gboolean: \n    \n  nm-plugin-missing -> gboolean: \n    \n  ip4-config -> NMIPConfig: \n    \n  dhcp4-config -> NMDhcpConfig: \n    \n  ip6-config -> NMIPConfig: \n    \n  state -> NMDeviceState: \n    \n  state-reason -> guint: \n    \n  product -> gchararray: \n    \n  vendor -> gchararray: \n    \n  dhcp6-config -> NMDhcpConfig: \n    \n  ip-interface -> gchararray: \n    \n  device-type -> NMDeviceType: \n    \n  active-connection -> NMActiveConnection: \n    \n  available-connections -> GPtrArray: \n    \n  physical-port-id -> gchararray: \n    \n  mtu -> guint: \n    \n  metered -> guint: \n    \n  lldp-neighbors -> GPtrArray: \n    \n  ip4-connectivity -> NMConnectivityState: \n    \n  ip6-connectivity -> NMConnectivityState: \n    \n  interface-flags -> guint: \n    \n\nProperties from NMObject:\n  path -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMDevice (94741104192064)>'
