...
class DeviceTun(Device):
    ...
    def get_no_pi(self): # real signature unknown; restored from __doc__
        """ get_no_pi(self) -> bool """
        return False
