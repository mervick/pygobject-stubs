...
class SettingWpan(Setting):
    ...
    def get_pan_id(self): # real signature unknown; restored from __doc__
        """ get_pan_id(self) -> int """
        return 0
    ...
    def get_short_address(self): # real signature unknown; restored from __doc__
        """ get_short_address(self) -> int """
        return 0
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingWpan), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingWpan (94741104274352)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_channel': gi.FunctionInfo(get_channel), 'get_mac_address': gi.FunctionInfo(get_mac_address), 'get_page': gi.FunctionInfo(get_page), 'get_pan_id': gi.FunctionInfo(get_pan_id), 'get_short_address': gi.FunctionInfo(get_short_address)})"
    __gdoc__ = 'Object NMSettingWpan\n\nProperties from NMSettingWpan:\n  mac-address -> gchararray: \n    \n  pan-id -> guint: \n    \n  short-address -> guint: \n    \n  page -> gint: \n    \n  channel -> gint: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingWpan (94741104274352)>'
    __info__ = ObjectInfo(SettingWpan)
