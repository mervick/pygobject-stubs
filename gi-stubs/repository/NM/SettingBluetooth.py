...
class SettingBluetooth(Setting):
    ...
    def get_bdaddr(self): # real signature unknown; restored from __doc__
        """ get_bdaddr(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b80c2a30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingBluetooth), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingBluetooth (94741104270080)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_bdaddr': gi.FunctionInfo(get_bdaddr), 'get_connection_type': gi.FunctionInfo(get_connection_type), 'parent': <property object at 0x7fb9b84e1180>})"
    __gdoc__ = 'Object NMSettingBluetooth\n\nProperties from NMSettingBluetooth:\n  bdaddr -> gchararray: \n    \n  type -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingBluetooth (94741104270080)>'
    __info__ = ObjectInfo(SettingBluetooth)
