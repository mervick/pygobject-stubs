...
class Setting6Lowpan(Setting):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b80c2af0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Setting6Lowpan), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSetting6Lowpan (94741104346160)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_parent': gi.FunctionInfo(get_parent)})"
    __gdoc__ = 'Object NMSetting6Lowpan\n\nProperties from NMSetting6Lowpan:\n  parent -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSetting6Lowpan (94741104346160)>'
    __info__ = ObjectInfo(Setting6Lowpan)
