...
class SettingBridgePort(Setting):
    ...
    def get_hairpin_mode(self): # real signature unknown; restored from __doc__
        """ get_hairpin_mode(self) -> bool """
        return False
    ...
    def get_path_cost(self): # real signature unknown; restored from __doc__
        """ get_path_cost(self) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b80c2400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingBridgePort), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingBridgePort (94741104252448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_vlan': gi.FunctionInfo(add_vlan), 'clear_vlans': gi.FunctionInfo(clear_vlans), 'get_hairpin_mode': gi.FunctionInfo(get_hairpin_mode), 'get_num_vlans': gi.FunctionInfo(get_num_vlans), 'get_path_cost': gi.FunctionInfo(get_path_cost), 'get_priority': gi.FunctionInfo(get_priority), 'get_vlan': gi.FunctionInfo(get_vlan), 'remove_vlan': gi.FunctionInfo(remove_vlan), 'remove_vlan_by_vid': gi.FunctionInfo(remove_vlan_by_vid), 'parent': <property object at 0x7fb9b84e4220>})"
    __gdoc__ = 'Object NMSettingBridgePort\n\nProperties from NMSettingBridgePort:\n  priority -> guint: \n    \n  path-cost -> guint: \n    \n  hairpin-mode -> gboolean: \n    \n  vlans -> GPtrArray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingBridgePort (94741104252448)>'
    __info__ = ObjectInfo(SettingBridgePort)
