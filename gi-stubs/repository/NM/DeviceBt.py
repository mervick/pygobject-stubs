...
class DeviceBt(Device):
    ...
    def get_capabilities(self): # real signature unknown; restored from __doc__
        """ get_capabilities(self) -> NM.BluetoothCapabilities """
        pass
