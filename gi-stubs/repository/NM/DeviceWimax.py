...
class DeviceWimax(Device):
    ...
    def get_active_nsp(self): # real signature unknown; restored from __doc__
        """ get_active_nsp(self) -> NM.WimaxNsp """
        pass
    ...
    def get_bsid(self): # real signature unknown; restored from __doc__
        """ get_bsid(self) -> str """
        return ""
    ...
    def get_center_frequency(self): # real signature unknown; restored from __doc__
        """ get_center_frequency(self) -> int """
        return 0

    def get_cinr(self): # real signature unknown; restored from __doc__
        """ get_cinr(self) -> int """
        return 0
    ...
    def get_nsps(self): # real signature unknown; restored from __doc__
        """ get_nsps(self) -> list """
        return []

    def get_nsp_by_path(self, path): # real signature unknown; restored from __doc__
        """ get_nsp_by_path(self, path:str) -> NM.WimaxNsp """
        pass
    ...
    def get_rssi(self): # real signature unknown; restored from __doc__
        """ get_rssi(self) -> int """
        return 0
