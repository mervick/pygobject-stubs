...
class DeviceModem(Device):
    ...
    def get_current_capabilities(self): # real signature unknown; restored from __doc__
        """ get_current_capabilities(self) -> NM.DeviceModemCapabilities """
        pass
    ...
    def get_modem_capabilities(self): # real signature unknown; restored from __doc__
        """ get_modem_capabilities(self) -> NM.DeviceModemCapabilities """
        pass
