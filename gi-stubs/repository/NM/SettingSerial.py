...
class SettingSerial(Setting):
    ...
    def get_bits(self): # real signature unknown; restored from __doc__
        """ get_bits(self) -> int """
        return 0
    ...
    def get_parity(self): # real signature unknown; restored from __doc__
        """ get_parity(self) -> NM.SettingSerialParity """
        pass
    ...
    def get_send_delay(self): # real signature unknown; restored from __doc__
        """ get_send_delay(self) -> int """
        return 0

    def get_stopbits(self): # real signature unknown; restored from __doc__
        """ get_stopbits(self) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8200d00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingSerial), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingSerial (94741104535888)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_baud': gi.FunctionInfo(get_baud), 'get_bits': gi.FunctionInfo(get_bits), 'get_parity': gi.FunctionInfo(get_parity), 'get_send_delay': gi.FunctionInfo(get_send_delay), 'get_stopbits': gi.FunctionInfo(get_stopbits), 'parent': <property object at 0x7fb9b8503040>})"
    __gdoc__ = 'Object NMSettingSerial\n\nProperties from NMSettingSerial:\n  baud -> guint: \n    \n  bits -> guint: \n    \n  parity -> NMSettingSerialParity: \n    \n  stopbits -> guint: \n    \n  send-delay -> guint64: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingSerial (94741104535888)>'
    __info__ = ObjectInfo(SettingSerial)
