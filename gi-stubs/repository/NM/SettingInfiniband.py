...
class SettingInfiniband(Setting):
    ...
    def get_p_key(self): # real signature unknown; restored from __doc__
        """ get_p_key(self) -> int """
        return 0
    ...
    def get_transport_mode(self): # real signature unknown; restored from __doc__
        """ get_transport_mode(self) -> str """
        return ""

    def get_virtual_interface_name(self): # real signature unknown; restored from __doc__
        """ get_virtual_interface_name(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8200e80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingInfiniband), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingInfiniband (94741104486672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_mac_address': gi.FunctionInfo(get_mac_address), 'get_mtu': gi.FunctionInfo(get_mtu), 'get_p_key': gi.FunctionInfo(get_p_key), 'get_parent': gi.FunctionInfo(get_parent), 'get_transport_mode': gi.FunctionInfo(get_transport_mode), 'get_virtual_interface_name': gi.FunctionInfo(get_virtual_interface_name), 'parent': <property object at 0x7fb9b84f63b0>})"
    __gdoc__ = 'Object NMSettingInfiniband\n\nProperties from NMSettingInfiniband:\n  mac-address -> gchararray: \n    \n  mtu -> guint: \n    \n  transport-mode -> gchararray: \n    \n  p-key -> gint: \n    \n  parent -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingInfiniband (94741104486672)>'
    __info__ = ObjectInfo(SettingInfiniband)
