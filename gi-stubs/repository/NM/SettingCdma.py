...
class SettingCdma(Setting):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8283c10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingCdma), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingCdma (94741104277280)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_mtu': gi.FunctionInfo(get_mtu), 'get_number': gi.FunctionInfo(get_number), 'get_password': gi.FunctionInfo(get_password), 'get_password_flags': gi.FunctionInfo(get_password_flags), 'get_username': gi.FunctionInfo(get_username), 'parent': <property object at 0x7fb9b84e4630>})"
    __gdoc__ = 'Object NMSettingCdma\n\nProperties from NMSettingCdma:\n  number -> gchararray: \n    \n  username -> gchararray: \n    \n  password -> gchararray: \n    \n  password-flags -> NMSettingSecretFlags: \n    \n  mtu -> guint: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingCdma (94741104277280)>'
    __info__ = ObjectInfo(SettingCdma)
