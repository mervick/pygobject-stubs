...
class SettingProxy(Setting):
    ...
    def get_browser_only(self): # real signature unknown; restored from __doc__
        """ get_browser_only(self) -> bool """
        return False
    ...
    def get_method(self): # real signature unknown; restored from __doc__
        """ get_method(self) -> NM.SettingProxyMethod """
        pass
    ...
    def get_pac_script(self): # real signature unknown; restored from __doc__
        """ get_pac_script(self) -> str """
        return ""

    def get_pac_url(self): # real signature unknown; restored from __doc__
        """ get_pac_url(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b805ad00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingProxy), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingProxy (94741104529568)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_browser_only': gi.FunctionInfo(get_browser_only), 'get_method': gi.FunctionInfo(get_method), 'get_pac_script': gi.FunctionInfo(get_pac_script), 'get_pac_url': gi.FunctionInfo(get_pac_url), 'parent': <property object at 0x7fb9b8501630>})"
    __gdoc__ = 'Object NMSettingProxy\n\nProperties from NMSettingProxy:\n  method -> gint: \n    \n  browser-only -> gboolean: \n    \n  pac-url -> gchararray: \n    \n  pac-script -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingProxy (94741104529568)>'
    __info__ = ObjectInfo(SettingProxy)
