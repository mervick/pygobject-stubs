...
class DeviceVxlan(Device):
    ...
    def get_ageing(self): # real signature unknown; restored from __doc__
        """ get_ageing(self) -> int """
        return 0
    ...
    def get_carrier(self): # real signature unknown; restored from __doc__
        """ get_carrier(self) -> bool """
        return False
    ...
    def get_dst_port(self): # real signature unknown; restored from __doc__
        """ get_dst_port(self) -> int """
        return 0
    ...
    def get_l2miss(self): # real signature unknown; restored from __doc__
        """ get_l2miss(self) -> bool """
        return False

    def get_l3miss(self): # real signature unknown; restored from __doc__
        """ get_l3miss(self) -> bool """
        return False

    def get_learning(self): # real signature unknown; restored from __doc__
        """ get_learning(self) -> bool """
        return False
    ...
    def get_rsc(self): # real signature unknown; restored from __doc__
        """ get_rsc(self) -> bool """
        return False
    ...
    def get_src_port_max(self): # real signature unknown; restored from __doc__
        """ get_src_port_max(self) -> int """
        return 0

    def get_src_port_min(self): # real signature unknown; restored from __doc__
        """ get_src_port_min(self) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b828cb50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceVxlan), '__module__': 'gi.repository.NM', '__gtype__': <GType NMDeviceVxlan (94741104284336)>, '__doc__': None, '__gsignals__': {}, 'get_ageing': gi.FunctionInfo(get_ageing), 'get_carrier': gi.FunctionInfo(get_carrier), 'get_dst_port': gi.FunctionInfo(get_dst_port), 'get_group': gi.FunctionInfo(get_group), 'get_hw_address': gi.FunctionInfo(get_hw_address), 'get_id': gi.FunctionInfo(get_id), 'get_l2miss': gi.FunctionInfo(get_l2miss), 'get_l3miss': gi.FunctionInfo(get_l3miss), 'get_learning': gi.FunctionInfo(get_learning), 'get_limit': gi.FunctionInfo(get_limit), 'get_local': gi.FunctionInfo(get_local), 'get_parent': gi.FunctionInfo(get_parent), 'get_proxy': gi.FunctionInfo(get_proxy), 'get_rsc': gi.FunctionInfo(get_rsc), 'get_src_port_max': gi.FunctionInfo(get_src_port_max), 'get_src_port_min': gi.FunctionInfo(get_src_port_min), 'get_tos': gi.FunctionInfo(get_tos), 'get_ttl': gi.FunctionInfo(get_ttl)})"
    __gdoc__ = 'Object NMDeviceVxlan\n\nProperties from NMDeviceVxlan:\n  hw-address -> gchararray: \n    \n  carrier -> gboolean: \n    \n  parent -> NMDevice: \n    \n  id -> guint: \n    \n  group -> gchararray: \n    \n  local -> gchararray: \n    \n  tos -> guchar: \n    \n  ttl -> guchar: \n    \n  limit -> guint: \n    \n  learning -> gboolean: \n    \n  ageing -> guint: \n    \n  dst-port -> guint: \n    \n  src-port-min -> guint: \n    \n  src-port-max -> guint: \n    \n  proxy -> gboolean: \n    \n  rsc -> gboolean: \n    \n  l2miss -> gboolean: \n    \n  l3miss -> gboolean: \n    \n\nSignals from NMDevice:\n  state-changed (guint, guint, guint)\n\nProperties from NMDevice:\n  interface -> gchararray: \n    \n  udi -> gchararray: \n    \n  driver -> gchararray: \n    \n  driver-version -> gchararray: \n    \n  firmware-version -> gchararray: \n    \n  capabilities -> NMDeviceCapabilities: \n    \n  real -> gboolean: \n    \n  managed -> gboolean: \n    \n  autoconnect -> gboolean: \n    \n  firmware-missing -> gboolean: \n    \n  nm-plugin-missing -> gboolean: \n    \n  ip4-config -> NMIPConfig: \n    \n  dhcp4-config -> NMDhcpConfig: \n    \n  ip6-config -> NMIPConfig: \n    \n  state -> NMDeviceState: \n    \n  state-reason -> guint: \n    \n  product -> gchararray: \n    \n  vendor -> gchararray: \n    \n  dhcp6-config -> NMDhcpConfig: \n    \n  ip-interface -> gchararray: \n    \n  device-type -> NMDeviceType: \n    \n  active-connection -> NMActiveConnection: \n    \n  available-connections -> GPtrArray: \n    \n  physical-port-id -> gchararray: \n    \n  mtu -> guint: \n    \n  metered -> guint: \n    \n  lldp-neighbors -> GPtrArray: \n    \n  ip4-connectivity -> NMConnectivityState: \n    \n  ip6-connectivity -> NMConnectivityState: \n    \n  interface-flags -> guint: \n    \n\nProperties from NMObject:\n  path -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMDeviceVxlan (94741104284336)>'
    __info__ = ObjectInfo(DeviceVxlan)
