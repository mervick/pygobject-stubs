...
class Setting(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8cc9ee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Setting), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSetting (94741104343248)>, '__doc__': None, '__gsignals__': {}, 'lookup_type': gi.FunctionInfo(lookup_type), 'compare': gi.FunctionInfo(compare), 'diff': gi.FunctionInfo(diff), 'duplicate': gi.FunctionInfo(duplicate), 'enumerate_values': gi.FunctionInfo(enumerate_values), 'get_dbus_property_type': gi.FunctionInfo(get_dbus_property_type), 'get_name': gi.FunctionInfo(get_name), 'get_secret_flags': gi.FunctionInfo(get_secret_flags), 'set_secret_flags': gi.FunctionInfo(set_secret_flags), 'to_string': gi.FunctionInfo(to_string), 'verify': gi.FunctionInfo(verify), 'verify_secrets': gi.FunctionInfo(verify_secrets), 'do_aggregate': gi.VFuncInfo(aggregate), 'do_get_secret_flags': gi.VFuncInfo(get_secret_flags), 'do_init_from_dbus': gi.VFuncInfo(init_from_dbus), 'do_set_secret_flags': gi.VFuncInfo(set_secret_flags), 'do_update_one_secret': gi.VFuncInfo(update_one_secret), 'do_verify': gi.VFuncInfo(verify), 'do_verify_secrets': gi.VFuncInfo(verify_secrets), 'parent': <property object at 0x7fb9b84d9680>})"
    __gdoc__ = 'Object NMSetting\n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSetting (94741104343248)>'
    __info__ = ObjectInfo(Setting)
