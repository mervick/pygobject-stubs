...
class SettingUser(Setting):
    ...
    def check_key(self, key): # real signature unknown; restored from __doc__
        """ check_key(key:str) -> bool """
        return False

    def check_val(self, val): # real signature unknown; restored from __doc__
    ...
    def get_keys(self): # real signature unknown; restored from __doc__
        """ get_keys(self) -> list, out_len:int """
        return []
    ...
    def set_data(self, key, val=None): # real signature unknown; restored from __doc__
        """ set_data(self, key:str, val:str=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b82003d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingUser), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingUser (94741104559024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'check_key': gi.FunctionInfo(check_key), 'check_val': gi.FunctionInfo(check_val), 'get_data': gi.FunctionInfo(get_data), 'get_keys': gi.FunctionInfo(get_keys), 'set_data': gi.FunctionInfo(set_data)})"
    __gdoc__ = 'Object NMSettingUser\n\nProperties from NMSettingUser:\n  data -> GHashTable: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingUser (94741104559024)>'
    __info__ = ObjectInfo(SettingUser)
