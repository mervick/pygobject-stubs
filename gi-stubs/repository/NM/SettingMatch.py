...
class SettingMatch(Setting):
    ...
    ::
        ...
        new() -> NM.Setting
    """
    def add_interface_name(self, interface_name): # real signature unknown; restored from __doc__
        """ add_interface_name(self, interface_name:str) """
        pass
    ...
    def clear_interface_names(self): # real signature unknown; restored from __doc__
        """ clear_interface_names(self) """
        pass
    ...
    def get_interface_name(self, idx): # real signature unknown; restored from __doc__
        """ get_interface_name(self, idx:int) -> str """
        return ""

    def get_interface_names(self): # real signature unknown; restored from __doc__
        """ get_interface_names(self) -> list, length:int """
        return []
    ...
    def get_num_interface_names(self): # real signature unknown; restored from __doc__
        """ get_num_interface_names(self) -> int """
        return 0
    ...
    def remove_interface_name(self, idx): # real signature unknown; restored from __doc__
        """ remove_interface_name(self, idx:int) """
        pass

    def remove_interface_name_by_value(self, interface_name): # real signature unknown; restored from __doc__
        """ remove_interface_name_by_value(self, interface_name:str) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8200970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingMatch), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingMatch (94741104505552)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_interface_name': gi.FunctionInfo(add_interface_name), 'clear_interface_names': gi.FunctionInfo(clear_interface_names), 'get_interface_name': gi.FunctionInfo(get_interface_name), 'get_interface_names': gi.FunctionInfo(get_interface_names), 'get_num_interface_names': gi.FunctionInfo(get_num_interface_names), 'remove_interface_name': gi.FunctionInfo(remove_interface_name), 'remove_interface_name_by_value': gi.FunctionInfo(remove_interface_name_by_value)})"
    __gdoc__ = 'Object NMSettingMatch\n\nProperties from NMSettingMatch:\n  interface-name -> GStrv: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingMatch (94741104505552)>'
    __info__ = ObjectInfo(SettingMatch)
