...
class SettingOvsPatch(Setting):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b805a1c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingOvsPatch), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingOvsPatch (94741104518272)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_peer': gi.FunctionInfo(get_peer)})"
    __gdoc__ = 'Object NMSettingOvsPatch\n\nProperties from NMSettingOvsPatch:\n  peer -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingOvsPatch (94741104518272)>'
    __info__ = ObjectInfo(SettingOvsPatch)
