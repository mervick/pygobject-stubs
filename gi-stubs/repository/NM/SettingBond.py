...
class SettingBond(Setting):
    ...
    ::
        ...
        new() -> NM.Setting
    """
    def add_option(self, name, value): # real signature unknown; restored from __doc__
        """ add_option(self, name:str, value:str) -> bool """
        return False
    ...
    def get_num_options(self): # real signature unknown; restored from __doc__
        """ get_num_options(self) -> int """
        return 0

    def get_option(self, idx): # real signature unknown; restored from __doc__
        """ get_option(self, idx:int) -> bool, out_name:str, out_value:str """
        return False

    def get_option_by_name(self, name): # real signature unknown; restored from __doc__
        """ get_option_by_name(self, name:str) -> str """
        return ""

    def get_option_default(self, name): # real signature unknown; restored from __doc__
        """ get_option_default(self, name:str) -> str """
        return ""
    ...
    def get_valid_options(self): # real signature unknown; restored from __doc__
        """ get_valid_options(self) -> list """
        return []
    ...
    def remove_option(self, name): # real signature unknown; restored from __doc__
        """ remove_option(self, name:str) -> bool """
        return False
    ...
    def validate_option(self, name, value): # real signature unknown; restored from __doc__
        """ validate_option(name:str, value:str) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8200a90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingBond), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingBond (94741104260944)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'validate_option': gi.FunctionInfo(validate_option), 'add_option': gi.FunctionInfo(add_option), 'get_num_options': gi.FunctionInfo(get_num_options), 'get_option': gi.FunctionInfo(get_option), 'get_option_by_name': gi.FunctionInfo(get_option_by_name), 'get_option_default': gi.FunctionInfo(get_option_default), 'get_valid_options': gi.FunctionInfo(get_valid_options), 'remove_option': gi.FunctionInfo(remove_option), 'parent': <property object at 0x7fb9b84e16d0>})"
    __gdoc__ = 'Object NMSettingBond\n\nProperties from NMSettingBond:\n  options -> GHashTable: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingBond (94741104260944)>'
    __info__ = ObjectInfo(SettingBond)
