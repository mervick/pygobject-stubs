...
class SettingDummy(Setting):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b80c2fa0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingDummy), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingDummy (94741104455552)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fb9b84ee450>})"
    __gdoc__ = 'Object NMSettingDummy\n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingDummy (94741104455552)>'
    __info__ = ObjectInfo(SettingDummy)
