...
class DeviceWifiP2P(Device):
    ...
    def get_peers(self): # real signature unknown; restored from __doc__
        """ get_peers(self) -> list """
        return []

    def get_peer_by_path(self, path): # real signature unknown; restored from __doc__
        """ get_peer_by_path(self, path:str) -> NM.WifiP2PPeer """
        pass
    ...
    def start_find(self, options=None, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ start_find(self, options:GLib.Variant=None, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def start_find_finish(self, result): # real signature unknown; restored from __doc__
        """ start_find_finish(self, result:Gio.AsyncResult) -> bool """
        return False
    ...
    def stop_find(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ stop_find(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def stop_find_finish(self, result): # real signature unknown; restored from __doc__
        """ stop_find_finish(self, result:Gio.AsyncResult) -> bool """
        return False
