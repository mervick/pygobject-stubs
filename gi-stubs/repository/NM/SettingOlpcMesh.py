...
class SettingOlpcMesh(Setting):
    ...
    def get_dhcp_anycast_address(self): # real signature unknown; restored from __doc__
        """ get_dhcp_anycast_address(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b80c2730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingOlpcMesh), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingOlpcMesh (94741104508464)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_channel': gi.FunctionInfo(get_channel), 'get_dhcp_anycast_address': gi.FunctionInfo(get_dhcp_anycast_address), 'get_ssid': gi.FunctionInfo(get_ssid), 'parent': <property object at 0x7fb9b8c92a90>})"
    __gdoc__ = 'Object NMSettingOlpcMesh\n\nProperties from NMSettingOlpcMesh:\n  ssid -> GBytes: \n    \n  channel -> guint: \n    \n  dhcp-anycast-address -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingOlpcMesh (94741104508464)>'
    __info__ = ObjectInfo(SettingOlpcMesh)
