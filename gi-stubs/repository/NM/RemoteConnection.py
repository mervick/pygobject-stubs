...
class RemoteConnection(Object, Connection):
    ...
    def commit_changes(self, save_to_disk, cancellable=None): # real signature unknown; restored from __doc__
        """ commit_changes(self, save_to_disk:bool, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def commit_changes_async(self, save_to_disk, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ commit_changes_async(self, save_to_disk:bool, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def commit_changes_finish(self, result): # real signature unknown; restored from __doc__
        """ commit_changes_finish(self, result:Gio.AsyncResult) -> bool """
        return False
    ...
    def get_flags(self): # real signature unknown; restored from __doc__
        """ get_flags(self) -> NM.SettingsConnectionFlags """
        pass
    ...
    def get_secrets(self, setting_name, cancellable=None): # real signature unknown; restored from __doc__
        """ get_secrets(self, setting_name:str, cancellable:Gio.Cancellable=None) -> GLib.Variant """
        pass

    def get_secrets_async(self, setting_name, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_secrets_async(self, setting_name:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_secrets_finish(self, result): # real signature unknown; restored from __doc__
        """ get_secrets_finish(self, result:Gio.AsyncResult) -> GLib.Variant """
        pass
    ...
    def get_unsaved(self): # real signature unknown; restored from __doc__
        """ get_unsaved(self) -> bool """
        return False
    ...
    def save(self, cancellable=None): # real signature unknown; restored from __doc__
        """ save(self, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def save_async(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ save_async(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def update2(self, settings=None, flags, args=None, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ update2(self, settings:GLib.Variant=None, flags:NM.SettingsUpdate2Flags, args:GLib.Variant=None, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def update2_finish(self, result): # real signature unknown; restored from __doc__
        """ update2_finish(self, result:Gio.AsyncResult) -> GLib.Variant """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8283220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RemoteConnection), '__module__': 'gi.repository.NM', '__gtype__': <GType NMRemoteConnection (94741104214384)>, '__doc__': None, '__gsignals__': {}, 'commit_changes': gi.FunctionInfo(commit_changes), 'commit_changes_async': gi.FunctionInfo(commit_changes_async), 'commit_changes_finish': gi.FunctionInfo(commit_changes_finish), 'delete': gi.FunctionInfo(delete), 'delete_async': gi.FunctionInfo(delete_async), 'delete_finish': gi.FunctionInfo(delete_finish), 'get_filename': gi.FunctionInfo(get_filename), 'get_flags': gi.FunctionInfo(get_flags), 'get_secrets': gi.FunctionInfo(get_secrets), 'get_secrets_async': gi.FunctionInfo(get_secrets_async), 'get_secrets_finish': gi.FunctionInfo(get_secrets_finish), 'get_unsaved': gi.FunctionInfo(get_unsaved), 'get_visible': gi.FunctionInfo(get_visible), 'save': gi.FunctionInfo(save), 'save_async': gi.FunctionInfo(save_async), 'save_finish': gi.FunctionInfo(save_finish), 'update2': gi.FunctionInfo(update2), 'update2_finish': gi.FunctionInfo(update2_finish)})"
    __gdoc__ = 'Object NMRemoteConnection\n\nProperties from NMRemoteConnection:\n  unsaved -> gboolean: \n    \n  flags -> guint: \n    \n  filename -> gchararray: \n    \n  visible -> gboolean: \n    \n\nSignals from NMConnection:\n  secrets-updated (gchararray)\n  secrets-cleared ()\n  changed ()\n\nProperties from NMObject:\n  path -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMRemoteConnection (94741104214384)>'
    __info__ = ObjectInfo(RemoteConnection)
