...
class SettingOvsDpdk(Setting):
    ...
    def get_devargs(self): # real signature unknown; restored from __doc__
        """ get_devargs(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b8283550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingOvsDpdk), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingOvsDpdk (94741104513920)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_devargs': gi.FunctionInfo(get_devargs)})"
    __gdoc__ = 'Object NMSettingOvsDpdk\n\nProperties from NMSettingOvsDpdk:\n  devargs -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingOvsDpdk (94741104513920)>'
    __info__ = ObjectInfo(SettingOvsDpdk)
