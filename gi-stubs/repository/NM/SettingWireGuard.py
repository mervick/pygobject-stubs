...
class SettingWireGuard(Setting):
    ...
    ::
        ...
        new() -> NM.Setting
    """
    def append_peer(self, peer): # real signature unknown; restored from __doc__
        """ append_peer(self, peer:NM.WireGuardPeer) """
        pass
    ...
    def clear_peers(self): # real signature unknown; restored from __doc__
        """ clear_peers(self) -> int """
        return 0
    ...
    def get_ip4_auto_default_route(self): # real signature unknown; restored from __doc__
        """ get_ip4_auto_default_route(self) -> NM.Ternary """
        pass

    def get_ip6_auto_default_route(self): # real signature unknown; restored from __doc__
        """ get_ip6_auto_default_route(self) -> NM.Ternary """
        pass
    ...
    def get_peer(self, idx): # real signature unknown; restored from __doc__
        """ get_peer(self, idx:int) -> NM.WireGuardPeer """
        pass

    def get_peers_len(self): # real signature unknown; restored from __doc__
        """ get_peers_len(self) -> int """
        return 0

    def get_peer_by_public_key(self, public_key): # real signature unknown; restored from __doc__
        """ get_peer_by_public_key(self, public_key:str) -> NM.WireGuardPeer, out_idx:int """
        pass

    def get_peer_routes(self): # real signature unknown; restored from __doc__
        """ get_peer_routes(self) -> bool """
        return False

    def get_private_key(self): # real signature unknown; restored from __doc__
        """ get_private_key(self) -> str """
        return ""

    def get_private_key_flags(self): # real signature unknown; restored from __doc__
        """ get_private_key_flags(self) -> NM.SettingSecretFlags """
        pass
    ...
    def remove_peer(self, idx): # real signature unknown; restored from __doc__
        """ remove_peer(self, idx:int) -> bool """
        return False
    ...
    def set_peer(self, peer, idx): # real signature unknown; restored from __doc__
        """ set_peer(self, peer:NM.WireGuardPeer, idx:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b7e90490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingWireGuard), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingWireGuard (94741104185712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'append_peer': gi.FunctionInfo(append_peer), 'clear_peers': gi.FunctionInfo(clear_peers), 'get_fwmark': gi.FunctionInfo(get_fwmark), 'get_ip4_auto_default_route': gi.FunctionInfo(get_ip4_auto_default_route), 'get_ip6_auto_default_route': gi.FunctionInfo(get_ip6_auto_default_route), 'get_listen_port': gi.FunctionInfo(get_listen_port), 'get_mtu': gi.FunctionInfo(get_mtu), 'get_peer': gi.FunctionInfo(get_peer), 'get_peer_by_public_key': gi.FunctionInfo(get_peer_by_public_key), 'get_peer_routes': gi.FunctionInfo(get_peer_routes), 'get_peers_len': gi.FunctionInfo(get_peers_len), 'get_private_key': gi.FunctionInfo(get_private_key), 'get_private_key_flags': gi.FunctionInfo(get_private_key_flags), 'remove_peer': gi.FunctionInfo(remove_peer), 'set_peer': gi.FunctionInfo(set_peer)})"
    __gdoc__ = 'Object NMSettingWireGuard\n\nProperties from NMSettingWireGuard:\n  fwmark -> guint: \n    \n  ip4-auto-default-route -> NMTernary: \n    \n  ip6-auto-default-route -> NMTernary: \n    \n  listen-port -> guint: \n    \n  mtu -> guint: \n    \n  peer-routes -> gboolean: \n    \n  private-key -> gchararray: \n    \n  private-key-flags -> NMSettingSecretFlags: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingWireGuard (94741104185712)>'
    __info__ = ObjectInfo(SettingWireGuard)
