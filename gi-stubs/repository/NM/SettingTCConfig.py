...
class SettingTCConfig(Setting):
    ...
    ::
        ...
        new() -> NM.Setting
    """
    def add_qdisc(self, qdisc): # real signature unknown; restored from __doc__
        """ add_qdisc(self, qdisc:NM.TCQdisc) -> bool """
        return False

    def add_tfilter(self, tfilter): # real signature unknown; restored from __doc__
        """ add_tfilter(self, tfilter:NM.TCTfilter) -> bool """
        return False
    ...
    def clear_qdiscs(self): # real signature unknown; restored from __doc__
        """ clear_qdiscs(self) """
        pass

    def clear_tfilters(self): # real signature unknown; restored from __doc__
        """ clear_tfilters(self) """
        pass
    ...
    def get_num_qdiscs(self): # real signature unknown; restored from __doc__
        """ get_num_qdiscs(self) -> int """
        return 0

    def get_num_tfilters(self): # real signature unknown; restored from __doc__
        """ get_num_tfilters(self) -> int """
        return 0
    ...
    def get_qdisc(self, idx): # real signature unknown; restored from __doc__
        """ get_qdisc(self, idx:int) -> NM.TCQdisc """
        pass
    ...
    def get_tfilter(self, idx): # real signature unknown; restored from __doc__
        """ get_tfilter(self, idx:int) -> NM.TCTfilter """
        pass
    ...
    def remove_qdisc(self, idx): # real signature unknown; restored from __doc__
        """ remove_qdisc(self, idx:int) """
        pass

    def remove_qdisc_by_value(self, qdisc): # real signature unknown; restored from __doc__
        """ remove_qdisc_by_value(self, qdisc:NM.TCQdisc) -> bool """
        return False

    def remove_tfilter(self, idx): # real signature unknown; restored from __doc__
        """ remove_tfilter(self, idx:int) """
        pass

    def remove_tfilter_by_value(self, tfilter): # real signature unknown; restored from __doc__
        """ remove_tfilter_by_value(self, tfilter:NM.TCTfilter) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b7e90dc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingTCConfig), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingTCConfig (94741104542256)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_qdisc': gi.FunctionInfo(add_qdisc), 'add_tfilter': gi.FunctionInfo(add_tfilter), 'clear_qdiscs': gi.FunctionInfo(clear_qdiscs), 'clear_tfilters': gi.FunctionInfo(clear_tfilters), 'get_num_qdiscs': gi.FunctionInfo(get_num_qdiscs), 'get_num_tfilters': gi.FunctionInfo(get_num_tfilters), 'get_qdisc': gi.FunctionInfo(get_qdisc), 'get_tfilter': gi.FunctionInfo(get_tfilter), 'remove_qdisc': gi.FunctionInfo(remove_qdisc), 'remove_qdisc_by_value': gi.FunctionInfo(remove_qdisc_by_value), 'remove_tfilter': gi.FunctionInfo(remove_tfilter), 'remove_tfilter_by_value': gi.FunctionInfo(remove_tfilter_by_value)})"
    __gdoc__ = 'Object NMSettingTCConfig\n\nProperties from NMSettingTCConfig:\n  qdiscs -> GPtrArray: \n    \n  tfilters -> GPtrArray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingTCConfig (94741104542256)>'
    __info__ = ObjectInfo(SettingTCConfig)
