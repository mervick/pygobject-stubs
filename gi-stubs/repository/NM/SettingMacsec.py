...
class SettingMacsec(Setting):
    ...
    def get_mka_cak(self): # real signature unknown; restored from __doc__
        """ get_mka_cak(self) -> str """
        return ""

    def get_mka_cak_flags(self): # real signature unknown; restored from __doc__
        """ get_mka_cak_flags(self) -> NM.SettingSecretFlags """
        pass

    def get_mka_ckn(self): # real signature unknown; restored from __doc__
        """ get_mka_ckn(self) -> str """
        return ""

    def get_mode(self): # real signature unknown; restored from __doc__
        """ get_mode(self) -> NM.SettingMacsecMode """
        pass
    ...
    def get_send_sci(self): # real signature unknown; restored from __doc__
        """ get_send_sci(self) -> bool """
        return False

    def get_validation(self): # real signature unknown; restored from __doc__
        """ get_validation(self) -> NM.SettingMacsecValidation """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b805a160>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingMacsec), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingMacsec (94741104300624)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_encrypt': gi.FunctionInfo(get_encrypt), 'get_mka_cak': gi.FunctionInfo(get_mka_cak), 'get_mka_cak_flags': gi.FunctionInfo(get_mka_cak_flags), 'get_mka_ckn': gi.FunctionInfo(get_mka_ckn), 'get_mode': gi.FunctionInfo(get_mode), 'get_parent': gi.FunctionInfo(get_parent), 'get_port': gi.FunctionInfo(get_port), 'get_send_sci': gi.FunctionInfo(get_send_sci), 'get_validation': gi.FunctionInfo(get_validation), 'parent': <property object at 0x7fb9b84f6a90>})"
    __gdoc__ = 'Object NMSettingMacsec\n\nProperties from NMSettingMacsec:\n  parent -> gchararray: \n    \n  mode -> gint: \n    \n  encrypt -> gboolean: \n    \n  mka-cak -> gchararray: \n    \n  mka-cak-flags -> NMSettingSecretFlags: \n    \n  mka-ckn -> gchararray: \n    \n  port -> gint: \n    \n  validation -> gint: \n    \n  send-sci -> gboolean: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingMacsec (94741104300624)>'
    __info__ = ObjectInfo(SettingMacsec)
