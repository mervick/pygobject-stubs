...
class SettingIP4Config(SettingIPConfig):
    ...
    def get_dhcp_client_id(self): # real signature unknown; restored from __doc__
        """ get_dhcp_client_id(self) -> str """
        return ""

    def get_dhcp_fqdn(self): # real signature unknown; restored from __doc__
        """ get_dhcp_fqdn(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b82007c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingIP4Config), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingIP4Config (94741104465664)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_dhcp_client_id': gi.FunctionInfo(get_dhcp_client_id), 'get_dhcp_fqdn': gi.FunctionInfo(get_dhcp_fqdn), 'parent': <property object at 0x7fb9b84f1d60>})"
    __gdoc__ = 'Object NMSettingIP4Config\n\nProperties from NMSettingIP4Config:\n  dhcp-client-id -> gchararray: \n    \n  dhcp-fqdn -> gchararray: \n    \n\nProperties from NMSettingIPConfig:\n  method -> gchararray: \n    \n  dns -> GStrv: \n    \n  dns-search -> GStrv: \n    \n  dns-options -> GStrv: \n    \n  dns-priority -> gint: \n    \n  addresses -> GPtrArray: \n    \n  gateway -> gchararray: \n    \n  routes -> GPtrArray: \n    \n  route-metric -> gint64: \n    \n  route-table -> guint: \n    \n  ignore-auto-routes -> gboolean: \n    \n  ignore-auto-dns -> gboolean: \n    \n  dhcp-hostname -> gchararray: \n    \n  dhcp-hostname-flags -> guint: \n    \n  dhcp-send-hostname -> gboolean: \n    \n  never-default -> gboolean: \n    \n  may-fail -> gboolean: \n    \n  dad-timeout -> gint: \n    \n  dhcp-timeout -> gint: \n    \n  dhcp-iaid -> gchararray: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingIP4Config (94741104465664)>'
    __info__ = ObjectInfo(SettingIP4Config)
