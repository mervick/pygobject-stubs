...
class SettingWireless(Setting):
    ...
    def add_seen_bssid(self, bssid): # real signature unknown; restored from __doc__
        """ add_seen_bssid(self, bssid:str) -> bool """
        return False

    def ap_security_compatible(self, s_wireless_sec, ap_flags, ap_wpa, ap_rsn, ap_mode): # real signature unknown; restored from __doc__
        """ ap_security_compatible(self, s_wireless_sec:NM.SettingWirelessSecurity, ap_flags:NM.80211ApFlags, ap_wpa:NM.80211ApSecurityFlags, ap_rsn:NM.80211ApSecurityFlags, ap_mode:NM.80211Mode) -> bool """
        return False
    ...
    def get_band(self): # real signature unknown; restored from __doc__
        """ get_band(self) -> str """
        return ""

    def get_bssid(self): # real signature unknown; restored from __doc__
        """ get_bssid(self) -> str """
        return ""

    def get_channel(self): # real signature unknown; restored from __doc__
        """ get_channel(self) -> int """
        return 0
    ...
    def get_mac_address_randomization(self): # real signature unknown; restored from __doc__
        """ get_mac_address_randomization(self) -> NM.SettingMacRandomization """
        pass
    ...
    def get_num_seen_bssids(self): # real signature unknown; restored from __doc__
        """ get_num_seen_bssids(self) -> int """
        return 0

    def get_powersave(self): # real signature unknown; restored from __doc__
        """ get_powersave(self) -> int """
        return 0
    ...
    def get_seen_bssid(self, i): # real signature unknown; restored from __doc__
        """ get_seen_bssid(self, i:int) -> str """
        return ""

    def get_ssid(self): # real signature unknown; restored from __doc__
        """ get_ssid(self) -> GLib.Bytes """
        pass

    def get_tx_power(self): # real signature unknown; restored from __doc__
        """ get_tx_power(self) -> int """
        return 0

    def get_wake_on_wlan(self): # real signature unknown; restored from __doc__
        """ get_wake_on_wlan(self) -> NM.SettingWirelessWakeOnWLan """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb9b80c2d00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingWireless), '__module__': 'gi.repository.NM', '__gtype__': <GType NMSettingWireless (94741104512688)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_mac_blacklist_item': gi.FunctionInfo(add_mac_blacklist_item), 'add_seen_bssid': gi.FunctionInfo(add_seen_bssid), 'ap_security_compatible': gi.FunctionInfo(ap_security_compatible), 'clear_mac_blacklist_items': gi.FunctionInfo(clear_mac_blacklist_items), 'get_band': gi.FunctionInfo(get_band), 'get_bssid': gi.FunctionInfo(get_bssid), 'get_channel': gi.FunctionInfo(get_channel), 'get_cloned_mac_address': gi.FunctionInfo(get_cloned_mac_address), 'get_generate_mac_address_mask': gi.FunctionInfo(get_generate_mac_address_mask), 'get_hidden': gi.FunctionInfo(get_hidden), 'get_mac_address': gi.FunctionInfo(get_mac_address), 'get_mac_address_blacklist': gi.FunctionInfo(get_mac_address_blacklist), 'get_mac_address_randomization': gi.FunctionInfo(get_mac_address_randomization), 'get_mac_blacklist_item': gi.FunctionInfo(get_mac_blacklist_item), 'get_mode': gi.FunctionInfo(get_mode), 'get_mtu': gi.FunctionInfo(get_mtu), 'get_num_mac_blacklist_items': gi.FunctionInfo(get_num_mac_blacklist_items), 'get_num_seen_bssids': gi.FunctionInfo(get_num_seen_bssids), 'get_powersave': gi.FunctionInfo(get_powersave), 'get_rate': gi.FunctionInfo(get_rate), 'get_seen_bssid': gi.FunctionInfo(get_seen_bssid), 'get_ssid': gi.FunctionInfo(get_ssid), 'get_tx_power': gi.FunctionInfo(get_tx_power), 'get_wake_on_wlan': gi.FunctionInfo(get_wake_on_wlan), 'remove_mac_blacklist_item': gi.FunctionInfo(remove_mac_blacklist_item), 'remove_mac_blacklist_item_by_value': gi.FunctionInfo(remove_mac_blacklist_item_by_value), 'parent': <property object at 0x7fb9b8491ef0>})"
    __gdoc__ = 'Object NMSettingWireless\n\nProperties from NMSettingWireless:\n  ssid -> GBytes: \n    \n  mode -> gchararray: \n    \n  band -> gchararray: \n    \n  channel -> guint: \n    \n  bssid -> gchararray: \n    \n  rate -> guint: \n    \n  tx-power -> guint: \n    \n  mac-address -> gchararray: \n    \n  cloned-mac-address -> gchararray: \n    \n  generate-mac-address-mask -> gchararray: \n    \n  mac-address-blacklist -> GStrv: \n    \n  mtu -> guint: \n    \n  seen-bssids -> GStrv: \n    \n  hidden -> gboolean: \n    \n  powersave -> guint: \n    \n  mac-address-randomization -> guint: \n    \n  wake-on-wlan -> guint: \n    \n\nProperties from NMSetting:\n  name -> gchararray: \n    \n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType NMSettingWireless (94741104512688)>'
    __info__ = ObjectInfo(SettingWireless)
