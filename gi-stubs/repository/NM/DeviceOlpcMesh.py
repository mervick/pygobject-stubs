...
class DeviceOlpcMesh(Device):
    ...
    def get_active_channel(self): # real signature unknown; restored from __doc__
        """ get_active_channel(self) -> int """
        return 0
    ...
    def get_companion(self): # real signature unknown; restored from __doc__
        """ get_companion(self) -> NM.DeviceWifi """
        pass
