...
class HSTSEnforcerDB(HSTSEnforcer):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8e47db95b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HSTSEnforcerDB), '__module__': 'gi.repository.Soup', '__gtype__': <GType SoupHSTSEnforcerDB (94750594766576)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7f8e47ed6d60>, 'priv': <property object at 0x7f8e47ed6e50>})"
    __gdoc__ = 'Object SoupHSTSEnforcerDB\n\nProperties from SoupHSTSEnforcerDB:\n  filename -> gchararray: Filename\n    HSTS policy storage filename\n\nSignals from SoupHSTSEnforcer:\n  changed (SoupHSTSPolicy, SoupHSTSPolicy)\n  hsts-enforced (SoupMessage)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SoupHSTSEnforcerDB (94750594766576)>'
    __info__ = ObjectInfo(HSTSEnforcerDB)
