...
class MultipartInputStream(__gi_repository_Gio.FilterInputStream, __gi_repository_Gio.PollableInputStream):
    """
    :Constructors:
    ...
    def get_headers(self): # real signature unknown; restored from __doc__
        """ get_headers(self) -> Soup.MessageHeaders or None """
        pass
    ...
    def new(self, msg, base_stream): # real signature unknown; restored from __doc__
        """ new(msg:Soup.Message, base_stream:Gio.InputStream) -> Soup.MultipartInputStream """
        pass
    ...
    def next_part(self, cancellable=None): # real signature unknown; restored from __doc__
        """ next_part(self, cancellable:Gio.Cancellable=None) -> Gio.InputStream or None """
        pass

    def next_part_async(self, io_priority, cancellable=None, callback=None, data=None): # real signature unknown; restored from __doc__
        """ next_part_async(self, io_priority:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, data=None) """
        pass

    def next_part_finish(self, result): # real signature unknown; restored from __doc__
        """ next_part_finish(self, result:Gio.AsyncResult) -> Gio.InputStream or None """
        pass
    ...
    def read_nonblocking(self, buffer, cancellable=None): # real signature unknown; restored from __doc__
        """ read_nonblocking(self, buffer:list, cancellable:Gio.Cancellable=None) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8e47e8ddf0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MultipartInputStream), '__module__': 'gi.repository.Soup', '__gtype__': <GType SoupMultipartInputStream (94750594838112)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_headers': gi.FunctionInfo(get_headers), 'next_part': gi.FunctionInfo(next_part), 'next_part_async': gi.FunctionInfo(next_part_async), 'next_part_finish': gi.FunctionInfo(next_part_finish), 'parent_instance': <property object at 0x7f8e47ee79a0>, 'priv': <property object at 0x7f8e47ee7a90>})"
    __gdoc__ = 'Object SoupMultipartInputStream\n\nProperties from SoupMultipartInputStream:\n  message -> SoupMessage: Message\n    The SoupMessage\n\nProperties from GFilterInputStream:\n  base-stream -> GInputStream: The Filter Base Stream\n    The underlying base stream on which the io ops will be done.\n  close-base-stream -> gboolean: Close Base Stream\n    If the base stream should be closed when the filter stream is closed.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SoupMultipartInputStream (94750594838112)>'
    __info__ = ObjectInfo(MultipartInputStream)
