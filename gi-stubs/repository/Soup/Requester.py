...
class Requester(__gi_overrides_GObject.Object, SessionFeature):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Requester), '__module__': 'gi.repository.Soup', '__gtype__': <GType SoupRequester (94750594744208)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'request': gi.FunctionInfo(request), 'request_uri': gi.FunctionInfo(request_uri), 'parent': <property object at 0x7f8e47ef4770>, 'priv': <property object at 0x7f8e47ef4860>})"
    __gdoc__ = 'Object SoupRequester\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SoupRequester (94750594744208)>'
    __info__ = ObjectInfo(Requester)
