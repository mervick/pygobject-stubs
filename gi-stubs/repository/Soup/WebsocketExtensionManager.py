...
class WebsocketExtensionManager(__gi_overrides_GObject.Object, SessionFeature):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8e47c215b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WebsocketExtensionManager), '__module__': 'gi.repository.Soup', '__gtype__': <GType SoupWebsocketExtensionManager (94750595000640)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f8e47f0b810>})"
    __gdoc__ = 'Object SoupWebsocketExtensionManager\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SoupWebsocketExtensionManager (94750595000640)>'
    __info__ = ObjectInfo(WebsocketExtensionManager)
