...
class ContentDecoder(__gi_overrides_GObject.Object, SessionFeature):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8e47e9c130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ContentDecoder), '__module__': 'gi.repository.Soup', '__gtype__': <GType SoupContentDecoder (94750594720800)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f8e48612450>, 'priv': <property object at 0x7f8e48612540>})"
    __gdoc__ = 'Object SoupContentDecoder\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SoupContentDecoder (94750594720800)>'
    __info__ = ObjectInfo(ContentDecoder)
