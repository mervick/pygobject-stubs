...
class AuthDigest(Auth):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8e485d8460>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AuthDigest), '__module__': 'gi.repository.Soup', '__gtype__': <GType SoupAuthDigest (94750594514976)>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object SoupAuthDigest\n\nProperties from SoupAuth:\n  scheme-name -> gchararray: Scheme name\n    Authentication scheme name\n  realm -> gchararray: Realm\n    Authentication realm\n  host -> gchararray: Host\n    Authentication host\n  is-for-proxy -> gboolean: For Proxy\n    Whether or not the auth is for a proxy server\n  is-authenticated -> gboolean: Authenticated\n    Whether or not the auth is authenticated\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SoupAuthDigest (94750594514976)>'
    __info__ = ObjectInfo(AuthDigest)
