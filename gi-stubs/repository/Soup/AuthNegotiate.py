...
class AuthNegotiate(Auth):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8e4863f3a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AuthNegotiate), '__module__': 'gi.repository.Soup', '__gtype__': <GType SoupAuthNegotiate (94750594557088)>, '__doc__': None, '__gsignals__': {}, 'supported': gi.FunctionInfo(supported)})"
    __gdoc__ = 'Object SoupAuthNegotiate\n\nProperties from SoupAuth:\n  scheme-name -> gchararray: Scheme name\n    Authentication scheme name\n  realm -> gchararray: Realm\n    Authentication realm\n  host -> gchararray: Host\n    Authentication host\n  is-for-proxy -> gboolean: For Proxy\n    Whether or not the auth is for a proxy server\n  is-authenticated -> gboolean: Authenticated\n    Whether or not the auth is authenticated\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SoupAuthNegotiate (94750594557088)>'
    __info__ = ObjectInfo(AuthNegotiate)
