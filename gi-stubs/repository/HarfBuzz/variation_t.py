...
class variation_t(__gi.Struct):
    ...
    ::
        ...
        variation_t()
    """
    def _string(self, buf, size): # real signature unknown; restored from __doc__
        """ _string(self, buf:str, size:int) """
        pass
