...
class BookCache(__gi_repository_EBackend.Cache, __gi_repository_EDataServer.Extensible):
    """
    :Constructors:
    
    ::
    
        BookCache(**properties)
        new(filename:str, source:EDataServer.Source=None, cancellable:Gio.Cancellable=None) -> EDataBook.BookCache or None
        new_full(filename:str, source:EDataServer.Source=None, setup:EBookContacts.SourceBackendSummarySetup=None, cancellable:Gio.Cancellable=None) -> EDataBook.BookCache or None
    """
    ...
    def cursor_calculate(self, cursor, cancellable=None): # real signature unknown; restored from __doc__
        """ cursor_calculate(self, cursor:EDataBook.BookCacheCursor, cancellable:Gio.Cancellable=None) -> bool, out_total:int, out_position:int """
        return False

    def cursor_compare_contact(self, cursor, contact): # real signature unknown; restored from __doc__
        """ cursor_compare_contact(self, cursor:EDataBook.BookCacheCursor, contact:EBookContacts.Contact) -> int, out_matches_sexp:bool """
        return 0

    def cursor_free(self, cursor): # real signature unknown; restored from __doc__
        """ cursor_free(self, cursor:EDataBook.BookCacheCursor) """
        pass

    def cursor_set_sexp(self, cursor, sexp): # real signature unknown; restored from __doc__
        """ cursor_set_sexp(self, cursor:EDataBook.BookCacheCursor, sexp:str) -> bool """
        return False

    def cursor_set_target_alphabetic_index(self, cursor, idx): # real signature unknown; restored from __doc__
        """ cursor_set_target_alphabetic_index(self, cursor:EDataBook.BookCacheCursor, idx:int) """
        pass

    def cursor_step(self, cursor, flags, origin, count, cancellable=None): # real signature unknown; restored from __doc__
        """ cursor_step(self, cursor:EDataBook.BookCacheCursor, flags:EDataBook.BookCacheCursorStepFlags, origin:EDataBook.BookCacheCursorOrigin, count:int, cancellable:Gio.Cancellable=None) -> int, out_results:list """
        return 0
    ...
    def do_dup_contact_revision(self, *args, **kwargs): # real signature unknown
        """ dup_contact_revision(self, contact:EBookContacts.Contact) -> str """
        pass

    def do_e164_changed(self, *args, **kwargs): # real signature unknown
        """ e164_changed(self, contact:EBookContacts.Contact, is_replace:bool) """
        pass
    ...
    def dup_contact_revision(self, contact): # real signature unknown; restored from __doc__
        """ dup_contact_revision(self, contact:EBookContacts.Contact) -> str """
        return ""
    ...
    def get_contact(self, uid, meta_contact, cancellable=None): # real signature unknown; restored from __doc__
        """ get_contact(self, uid:str, meta_contact:bool, cancellable:Gio.Cancellable=None) -> bool, out_contact:EBookContacts.Contact """
        return False

    def get_contact_custom_flags(self, uid, cancellable=None): # real signature unknown; restored from __doc__
        """ get_contact_custom_flags(self, uid:str, cancellable:Gio.Cancellable=None) -> bool, out_custom_flags:int """
        return False

    def get_contact_extra(self, uid, cancellable=None): # real signature unknown; restored from __doc__
        """ get_contact_extra(self, uid:str, cancellable:Gio.Cancellable=None) -> bool, out_extra:str """
        return False
    ...
    def get_uids_with_extra(self, extra, cancellable=None): # real signature unknown; restored from __doc__
        """ get_uids_with_extra(self, extra:str, cancellable:Gio.Cancellable=None) -> bool, out_uids:list """
        return False

    def get_vcard(self, uid, meta_contact, cancellable=None): # real signature unknown; restored from __doc__
        """ get_vcard(self, uid:str, meta_contact:bool, cancellable:Gio.Cancellable=None) -> bool, out_vcard:str """
        return False
    ...
    def new(self, filename, source=None, cancellable=None): # real signature unknown; restored from __doc__
        """ new(filename:str, source:EDataServer.Source=None, cancellable:Gio.Cancellable=None) -> EDataBook.BookCache or None """
        pass
    ...
    def new_full(self, filename, source=None, setup=None, cancellable=None): # real signature unknown; restored from __doc__
        """ new_full(filename:str, source:EDataServer.Source=None, setup:EBookContacts.SourceBackendSummarySetup=None, cancellable:Gio.Cancellable=None) -> EDataBook.BookCache or None """
        pass
    ...
    def put_contact(self, contact, extra=None, custom_flags, offline_flag, cancellable=None): # real signature unknown; restored from __doc__
        """ put_contact(self, contact:EBookContacts.Contact, extra:str=None, custom_flags:int, offline_flag:EBackend.CacheOfflineFlag, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def put_contacts(self, contacts, extras=None, custom_flags=None, offline_flag, cancellable=None): # real signature unknown; restored from __doc__
        """ put_contacts(self, contacts:list, extras:list=None, custom_flags:list=None, offline_flag:EBackend.CacheOfflineFlag, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def remove_contact(self, uid, custom_flags, offline_flag, cancellable=None): # real signature unknown; restored from __doc__
        """ remove_contact(self, uid:str, custom_flags:int, offline_flag:EBackend.CacheOfflineFlag, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def remove_contacts(self, uids, custom_flags=None, offline_flag, cancellable=None): # real signature unknown; restored from __doc__
        """ remove_contacts(self, uids:list, custom_flags:list=None, offline_flag:EBackend.CacheOfflineFlag, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def search(self, sexp=None, meta_contacts, cancellable=None): # real signature unknown; restored from __doc__
        """ search(self, sexp:str=None, meta_contacts:bool, cancellable:Gio.Cancellable=None) -> bool, out_list:list """
        return False

    def search_uids(self, sexp=None, cancellable=None): # real signature unknown; restored from __doc__
        """ search_uids(self, sexp:str=None, cancellable:Gio.Cancellable=None) -> bool, out_list:list """
        return False
    ...
    def search_with_callback(self, sexp=None, func=None, user_data=None, cancellable=None): # real signature unknown; restored from __doc__
        """ search_with_callback(self, sexp:str=None, func:EDataBook.BookCacheSearchFunc=None, user_data=None, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def set_contact_custom_flags(self, uid, custom_flags, cancellable=None): # real signature unknown; restored from __doc__
        """ set_contact_custom_flags(self, uid:str, custom_flags:int, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def set_contact_extra(self, uid, extra=None, cancellable=None): # real signature unknown; restored from __doc__
        """ set_contact_extra(self, uid:str, extra:str=None, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f09d0c2c160>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BookCache), '__module__': 'gi.repository.EDataBook', '__gtype__': <GType EBookCache (94654337886368)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_full': gi.FunctionInfo(new_full), 'cursor_calculate': gi.FunctionInfo(cursor_calculate), 'cursor_compare_contact': gi.FunctionInfo(cursor_compare_contact), 'cursor_free': gi.FunctionInfo(cursor_free), 'cursor_set_sexp': gi.FunctionInfo(cursor_set_sexp), 'cursor_set_target_alphabetic_index': gi.FunctionInfo(cursor_set_target_alphabetic_index), 'cursor_step': gi.FunctionInfo(cursor_step), 'dup_contact_revision': gi.FunctionInfo(dup_contact_revision), 'dup_locale': gi.FunctionInfo(dup_locale), 'get_contact': gi.FunctionInfo(get_contact), 'get_contact_custom_flags': gi.FunctionInfo(get_contact_custom_flags), 'get_contact_extra': gi.FunctionInfo(get_contact_extra), 'get_uids_with_extra': gi.FunctionInfo(get_uids_with_extra), 'get_vcard': gi.FunctionInfo(get_vcard), 'put_contact': gi.FunctionInfo(put_contact), 'put_contacts': gi.FunctionInfo(put_contacts), 'ref_collator': gi.FunctionInfo(ref_collator), 'ref_source': gi.FunctionInfo(ref_source), 'remove_contact': gi.FunctionInfo(remove_contact), 'remove_contacts': gi.FunctionInfo(remove_contacts), 'search': gi.FunctionInfo(search), 'search_uids': gi.FunctionInfo(search_uids), 'search_with_callback': gi.FunctionInfo(search_with_callback), 'set_contact_custom_flags': gi.FunctionInfo(set_contact_custom_flags), 'set_contact_extra': gi.FunctionInfo(set_contact_extra), 'set_locale': gi.FunctionInfo(set_locale), 'do_dup_contact_revision': gi.VFuncInfo(dup_contact_revision), 'do_e164_changed': gi.VFuncInfo(e164_changed), 'parent': <property object at 0x7f09d41b20e0>, 'priv': <property object at 0x7f09d41b2220>})"
    __gdoc__ = 'Object EBookCache\n\nSignals from EBookCache:\n  e164-changed (EContact, gboolean)\n  dup-contact-revision (EContact) -> gchararray\n\nProperties from EBookCache:\n  locale -> gchararray: Locate\n    The locale currently being used\n\nSignals from ECache:\n  before-put (gchararray, gchararray, gchararray, ECacheColumnValues, gboolean, GCancellable, gpointer) -> gboolean\n  before-remove (gchararray, GCancellable, gpointer) -> gboolean\n  revision-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EBookCache (94654337886368)>'
    __info__ = ObjectInfo(BookCache)
