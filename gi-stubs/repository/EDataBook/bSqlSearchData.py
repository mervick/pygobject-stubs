...
class bSqlSearchData(__gi.Struct):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(bSqlSearchData), '__module__': 'gi.repository.EDataBook', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'bSqlSearchData' objects>, '__weakref__': <attribute '__weakref__' of 'bSqlSearchData' objects>, '__doc__': None, 'uid': <property object at 0x7f09d0c20680>, 'vcard': <property object at 0x7f09d0c20770>, 'extra': <property object at 0x7f09d0c20860>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(bSqlSearchData)
