...
class Context(Object):
    ...
    ::
        ...
        Context(**properties)
        new(display:Cogl.Display=None) -> Cogl.Context
    """
    def get_display(self): # real signature unknown; restored from __doc__
        """ get_display(self) -> Cogl.Display """
        pass
    ...
    def new(self, display=None): # real signature unknown; restored from __doc__
        """ new(display:Cogl.Display=None) -> Cogl.Context """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Context), '__module__': 'gi.repository.Cogl', '__gtype__': <GType CoglContext (93970931623584)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_display': gi.FunctionInfo(get_display), 'get_renderer': gi.FunctionInfo(get_renderer)})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CoglContext (93970931623584)>'
