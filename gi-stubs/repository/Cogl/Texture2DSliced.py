...
class Texture2DSliced(Object, Texture):
    """
    :Constructors:
    
    ::
    
        Texture2DSliced(**properties)
        new_from_bitmap(bmp:Cogl.Bitmap, max_waste:int) -> Cogl.Texture2DSliced
        new_from_data(ctx:Cogl.Context, width:int, height:int, max_waste:int, format:Cogl.PixelFormat, rowstride:int, data:int) -> Cogl.Texture2DSliced
        new_from_file(ctx:Cogl.Context, filename:str, max_waste:int) -> Cogl.Texture2DSliced
        new_with_size(ctx:Cogl.Context, width:int, height:int, max_waste:int) -> Cogl.Texture2DSliced
    """
    ...
    def new_from_bitmap(self, bmp, max_waste): # real signature unknown; restored from __doc__
        """ new_from_bitmap(bmp:Cogl.Bitmap, max_waste:int) -> Cogl.Texture2DSliced """
        pass

    def new_from_data(self, ctx, width, height, max_waste, format, rowstride, data): # real signature unknown; restored from __doc__
        """ new_from_data(ctx:Cogl.Context, width:int, height:int, max_waste:int, format:Cogl.PixelFormat, rowstride:int, data:int) -> Cogl.Texture2DSliced """
        pass

    def new_from_file(self, ctx, filename, max_waste): # real signature unknown; restored from __doc__
        """ new_from_file(ctx:Cogl.Context, filename:str, max_waste:int) -> Cogl.Texture2DSliced """
        pass

    def new_with_size(self, ctx, width, height, max_waste): # real signature unknown; restored from __doc__
        """ new_with_size(ctx:Cogl.Context, width:int, height:int, max_waste:int) -> Cogl.Texture2DSliced """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Texture2DSliced), '__module__': 'gi.repository.Cogl', '__gtype__': <GType CoglTexture2DSliced (93970932299392)>, '__doc__': None, '__gsignals__': {}, 'new_from_bitmap': gi.FunctionInfo(new_from_bitmap), 'new_from_data': gi.FunctionInfo(new_from_data), 'new_from_file': gi.FunctionInfo(new_from_file), 'new_with_size': gi.FunctionInfo(new_with_size)})"
    __gdoc__ = 'CoglTexture2DSliced\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CoglTexture2DSliced (93970932299392)>'
    __info__ = ObjectInfo(Texture2DSliced)
