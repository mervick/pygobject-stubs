...
class FrameInfo(Object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FrameInfo), '__module__': 'gi.repository.Cogl', '__gtype__': <GType CoglFrameInfo (93970932116432)>, '__doc__': None, '__gsignals__': {}, 'get_frame_counter': gi.FunctionInfo(get_frame_counter), 'get_output': gi.FunctionInfo(get_output), 'get_presentation_time': gi.FunctionInfo(get_presentation_time), 'get_refresh_rate': gi.FunctionInfo(get_refresh_rate)})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CoglFrameInfo (93970932116432)>'
    __info__ = ObjectInfo(FrameInfo)
