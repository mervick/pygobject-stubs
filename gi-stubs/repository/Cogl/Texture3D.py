...
class Texture3D(Object, Texture):
    """
    :Constructors:
    ...
    ::
        ...
        new_from_bitmap(bitmap:Cogl.Bitmap, height:int, depth:int) -> Cogl.Texture3D
        new_from_data(context:Cogl.Context, width:int, height:int, depth:int, format:Cogl.PixelFormat, rowstride:int, image_stride:int, data:int) -> Cogl.Texture3D
        new_with_size(context:Cogl.Context, width:int, height:int, depth:int) -> Cogl.Texture3D
    """
    ...
    def new_from_bitmap(self, bitmap, height, depth): # real signature unknown; restored from __doc__
        """ new_from_bitmap(bitmap:Cogl.Bitmap, height:int, depth:int) -> Cogl.Texture3D """
        pass

    def new_from_data(self, context, width, height, depth, format, rowstride, image_stride, data): # real signature unknown; restored from __doc__
        """ new_from_data(context:Cogl.Context, width:int, height:int, depth:int, format:Cogl.PixelFormat, rowstride:int, image_stride:int, data:int) -> Cogl.Texture3D """
        pass

    def new_with_size(self, context, width, height, depth): # real signature unknown; restored from __doc__
        """ new_with_size(context:Cogl.Context, width:int, height:int, depth:int) -> Cogl.Texture3D """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Texture3D), '__module__': 'gi.repository.Cogl', '__gtype__': <GType CoglTexture3D (93970932300704)>, '__doc__': None, '__gsignals__': {}, 'new_from_bitmap': gi.FunctionInfo(new_from_bitmap), 'new_from_data': gi.FunctionInfo(new_from_data), 'new_with_size': gi.FunctionInfo(new_with_size)})"
    __gdoc__ = 'CoglTexture3D\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CoglTexture3D (93970932300704)>'
    __info__ = ObjectInfo(Texture3D)
