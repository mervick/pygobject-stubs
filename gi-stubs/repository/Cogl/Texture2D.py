...
class Texture2D(Object, Texture):
    """
    :Constructors:
    ...
    ::
        ...
        gl_new_from_foreign(ctx:Cogl.Context, gl_handle:int, width:int, height:int, format:Cogl.PixelFormat) -> Cogl.Texture2D
        new_from_bitmap(bitmap:Cogl.Bitmap) -> Cogl.Texture2D
        new_from_data(ctx:Cogl.Context, width:int, height:int, format:Cogl.PixelFormat, rowstride:int, data:int) -> Cogl.Texture2D
        new_from_file(ctx:Cogl.Context, filename:str) -> Cogl.Texture2D
        new_with_size(ctx:Cogl.Context, width:int, height:int) -> Cogl.Texture2D
    """
    ...
    def gl_new_from_foreign(self, ctx, gl_handle, width, height, format): # real signature unknown; restored from __doc__
        """ gl_new_from_foreign(ctx:Cogl.Context, gl_handle:int, width:int, height:int, format:Cogl.PixelFormat) -> Cogl.Texture2D """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Texture2D), '__module__': 'gi.repository.Cogl', '__gtype__': <GType CoglTexture2D (93970932296864)>, '__doc__': None, '__gsignals__': {}, 'gl_new_from_foreign': gi.FunctionInfo(gl_new_from_foreign), 'new_from_bitmap': gi.FunctionInfo(new_from_bitmap), 'new_from_data': gi.FunctionInfo(new_from_data), 'new_from_file': gi.FunctionInfo(new_from_file), 'new_with_size': gi.FunctionInfo(new_with_size)})"
    __gdoc__ = 'CoglTexture2D\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CoglTexture2D (93970932296864)>'
    __info__ = ObjectInfo(Texture2D)
