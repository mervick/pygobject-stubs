...
class VideoAggregatorConvertPad(VideoAggregatorPad):
    ...
    def do_create_conversion_info(self, *args, **kwargs): # real signature unknown
    ...
    def update_conversion_info(self): # real signature unknown; restored from __doc__
        """ update_conversion_info(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f930d23c130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VideoAggregatorConvertPad), '__module__': 'gi.repository.GstVideo', '__gtype__': <GType GstVideoAggregatorConvertPad (94743668772464)>, '__doc__': None, '__gsignals__': {}, 'update_conversion_info': gi.FunctionInfo(update_conversion_info), 'do_create_conversion_info': gi.VFuncInfo(create_conversion_info), 'parent': <property object at 0x7f930d6054f0>, 'priv': <property object at 0x7f930d6055e0>, '_gst_reserved': <property object at 0x7f930d6056d0>})"
    __gdoc__ = 'Object GstVideoAggregatorConvertPad\n\nProperties from GstVideoAggregatorPad:\n  zorder -> guint: Z-Order\n    Z Order of the picture\n  repeat-after-eos -> gboolean: Repeat After EOS\n    Repeat the last frame after EOS until all pads are EOS\n\nProperties from GstAggregatorPad:\n  emit-signals -> gboolean: Emit signals\n    Send signals to signal data consumption\n\nSignals from GstPad:\n  linked (GstPad)\n  unlinked (GstPad)\n\nProperties from GstPad:\n  direction -> GstPadDirection: Direction\n    The direction of the pad\n  template -> GstPadTemplate: Template\n    The GstPadTemplate of this pad\n  offset -> gint64: Offset\n    The running time offset of the pad\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstVideoAggregatorConvertPad (94743668772464)>'
    __info__ = ObjectInfo(VideoAggregatorConvertPad)
