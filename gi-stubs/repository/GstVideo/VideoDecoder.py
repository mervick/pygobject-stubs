...
class VideoDecoder(__gi_repository_Gst.Element):
    """
    :Constructors:
    ...
    def add_to_frame(self, n_bytes): # real signature unknown; restored from __doc__
        """ add_to_frame(self, n_bytes:int) """
        pass

    def allocate_output_buffer(self): # real signature unknown; restored from __doc__
        """ allocate_output_buffer(self) -> Gst.Buffer """
        pass

    def allocate_output_frame(self, frame): # real signature unknown; restored from __doc__
        """ allocate_output_frame(self, frame:GstVideo.VideoCodecFrame) -> Gst.FlowReturn """
        pass

    def allocate_output_frame_with_params(self, frame, params): # real signature unknown; restored from __doc__
        """ allocate_output_frame_with_params(self, frame:GstVideo.VideoCodecFrame, params:Gst.BufferPoolAcquireParams) -> Gst.FlowReturn """
        pass
    ...
    def do_drain(self, *args, **kwargs): # real signature unknown
        """ drain(self) -> Gst.FlowReturn """
        pass

    def do_finish(self, *args, **kwargs): # real signature unknown
    ...
    def do_getcaps(self, *args, **kwargs): # real signature unknown
    ...
    def do_handle_frame(self, *args, **kwargs): # real signature unknown
    ...
    def drop_frame(self, frame): # real signature unknown; restored from __doc__
        """ drop_frame(self, frame:GstVideo.VideoCodecFrame) -> Gst.FlowReturn """
        pass
    ...
    def finish_frame(self, frame): # real signature unknown; restored from __doc__
        """ finish_frame(self, frame:GstVideo.VideoCodecFrame) -> Gst.FlowReturn """
        pass
    ...
    def get_estimate_rate(self): # real signature unknown; restored from __doc__
        """ get_estimate_rate(self) -> int """
        return 0
    ...
    def get_frame(self, frame_number): # real signature unknown; restored from __doc__
        """ get_frame(self, frame_number:int) -> GstVideo.VideoCodecFrame """
        pass

    def get_frames(self): # real signature unknown; restored from __doc__
        """ get_frames(self) -> list """
        return []
    ...
    def get_latency(self): # real signature unknown; restored from __doc__
        """ get_latency(self) -> min_latency:int, max_latency:int """
        pass

    def get_max_decode_time(self, frame): # real signature unknown; restored from __doc__
        """ get_max_decode_time(self, frame:GstVideo.VideoCodecFrame) -> int """
        return 0

    def get_max_errors(self): # real signature unknown; restored from __doc__
        """ get_max_errors(self) -> int """
        return 0
    ...
    def get_needs_format(self): # real signature unknown; restored from __doc__
        """ get_needs_format(self) -> bool """
        return False

    def get_oldest_frame(self): # real signature unknown; restored from __doc__
        """ get_oldest_frame(self) -> GstVideo.VideoCodecFrame """
        pass

    def get_output_state(self): # real signature unknown; restored from __doc__
        """ get_output_state(self) -> GstVideo.VideoCodecState """
        pass

    def get_packetized(self): # real signature unknown; restored from __doc__
        """ get_packetized(self) -> bool """
        return False
    ...
    def get_pending_frame_size(self): # real signature unknown; restored from __doc__
        """ get_pending_frame_size(self) -> int """
        return 0
    ...
    def get_qos_proportion(self): # real signature unknown; restored from __doc__
        """ get_qos_proportion(self) -> float """
        return 0.0
    ...
    def have_frame(self): # real signature unknown; restored from __doc__
        """ have_frame(self) -> Gst.FlowReturn """
        pass
    ...
    def negotiate(self): # real signature unknown; restored from __doc__
        """ negotiate(self) -> bool """
        return False
    ...
    def proxy_getcaps(self, caps=None, filter=None): # real signature unknown; restored from __doc__
        """ proxy_getcaps(self, caps:Gst.Caps=None, filter:Gst.Caps=None) -> Gst.Caps """
        pass
    ...
    def release_frame(self, frame): # real signature unknown; restored from __doc__
        """ release_frame(self, frame:GstVideo.VideoCodecFrame) """
        pass
    ...
    def set_estimate_rate(self, enabled): # real signature unknown; restored from __doc__
        """ set_estimate_rate(self, enabled:bool) """
        pass

    def set_interlaced_output_state(self, fmt, mode, width, height, reference=None): # real signature unknown; restored from __doc__
        """ set_interlaced_output_state(self, fmt:GstVideo.VideoFormat, mode:GstVideo.VideoInterlaceMode, width:int, height:int, reference:GstVideo.VideoCodecState=None) -> GstVideo.VideoCodecState """
        pass
    ...
    def set_max_errors(self, num): # real signature unknown; restored from __doc__
        """ set_max_errors(self, num:int) """
        pass
    ...
    def set_needs_format(self, enabled): # real signature unknown; restored from __doc__
        """ set_needs_format(self, enabled:bool) """
        pass

    def set_output_state(self, fmt, width, height, reference=None): # real signature unknown; restored from __doc__
        """ set_output_state(self, fmt:GstVideo.VideoFormat, width:int, height:int, reference:GstVideo.VideoCodecState=None) -> GstVideo.VideoCodecState """
        pass

    def set_packetized(self, packetized): # real signature unknown; restored from __doc__
        """ set_packetized(self, packetized:bool) """
        pass
    ...
    def set_use_default_pad_acceptcaps(self, use): # real signature unknown; restored from __doc__
        """ set_use_default_pad_acceptcaps(self, use:bool) """
        pass
    ...
    input_segment = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    output_segment = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    stream_lock = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f930d23cee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VideoDecoder), '__module__': 'gi.repository.GstVideo', '__gtype__': <GType GstVideoDecoder (94743669101072)>, '__doc__': None, '__gsignals__': {}, 'add_to_frame': gi.FunctionInfo(add_to_frame), 'allocate_output_buffer': gi.FunctionInfo(allocate_output_buffer), 'allocate_output_frame': gi.FunctionInfo(allocate_output_frame), 'allocate_output_frame_with_params': gi.FunctionInfo(allocate_output_frame_with_params), 'drop_frame': gi.FunctionInfo(drop_frame), 'finish_frame': gi.FunctionInfo(finish_frame), 'get_allocator': gi.FunctionInfo(get_allocator), 'get_buffer_pool': gi.FunctionInfo(get_buffer_pool), 'get_estimate_rate': gi.FunctionInfo(get_estimate_rate), 'get_frame': gi.FunctionInfo(get_frame), 'get_frames': gi.FunctionInfo(get_frames), 'get_latency': gi.FunctionInfo(get_latency), 'get_max_decode_time': gi.FunctionInfo(get_max_decode_time), 'get_max_errors': gi.FunctionInfo(get_max_errors), 'get_needs_format': gi.FunctionInfo(get_needs_format), 'get_oldest_frame': gi.FunctionInfo(get_oldest_frame), 'get_output_state': gi.FunctionInfo(get_output_state), 'get_packetized': gi.FunctionInfo(get_packetized), 'get_pending_frame_size': gi.FunctionInfo(get_pending_frame_size), 'get_qos_proportion': gi.FunctionInfo(get_qos_proportion), 'have_frame': gi.FunctionInfo(have_frame), 'merge_tags': gi.FunctionInfo(merge_tags), 'negotiate': gi.FunctionInfo(negotiate), 'proxy_getcaps': gi.FunctionInfo(proxy_getcaps), 'release_frame': gi.FunctionInfo(release_frame), 'set_estimate_rate': gi.FunctionInfo(set_estimate_rate), 'set_interlaced_output_state': gi.FunctionInfo(set_interlaced_output_state), 'set_latency': gi.FunctionInfo(set_latency), 'set_max_errors': gi.FunctionInfo(set_max_errors), 'set_needs_format': gi.FunctionInfo(set_needs_format), 'set_output_state': gi.FunctionInfo(set_output_state), 'set_packetized': gi.FunctionInfo(set_packetized), 'set_use_default_pad_acceptcaps': gi.FunctionInfo(set_use_default_pad_acceptcaps), 'do_close': gi.VFuncInfo(close), 'do_decide_allocation': gi.VFuncInfo(decide_allocation), 'do_drain': gi.VFuncInfo(drain), 'do_finish': gi.VFuncInfo(finish), 'do_flush': gi.VFuncInfo(flush), 'do_getcaps': gi.VFuncInfo(getcaps), 'do_handle_frame': gi.VFuncInfo(handle_frame), 'do_negotiate': gi.VFuncInfo(negotiate), 'do_open': gi.VFuncInfo(open), 'do_parse': gi.VFuncInfo(parse), 'do_propose_allocation': gi.VFuncInfo(propose_allocation), 'do_reset': gi.VFuncInfo(reset), 'do_set_format': gi.VFuncInfo(set_format), 'do_sink_event': gi.VFuncInfo(sink_event), 'do_sink_query': gi.VFuncInfo(sink_query), 'do_src_event': gi.VFuncInfo(src_event), 'do_src_query': gi.VFuncInfo(src_query), 'do_start': gi.VFuncInfo(start), 'do_stop': gi.VFuncInfo(stop), 'do_transform_meta': gi.VFuncInfo(transform_meta), 'element': <property object at 0x7f930d274310>, 'sinkpad': <property object at 0x7f930d2743b0>, 'srcpad': <property object at 0x7f930d2744a0>, 'stream_lock': <property object at 0x7f930d274590>, 'input_segment': <property object at 0x7f930d274680>, 'output_segment': <property object at 0x7f930d274770>, 'priv': <property object at 0x7f930d274810>, 'padding': <property object at 0x7f930d274900>})"
    __gdoc__ = 'Object GstVideoDecoder\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstVideoDecoder (94743669101072)>'
    __info__ = ObjectInfo(VideoDecoder)
