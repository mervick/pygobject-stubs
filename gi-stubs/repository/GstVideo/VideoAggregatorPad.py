...
class VideoAggregatorPad(__gi_repository_GstBase.AggregatorPad):
    """
    :Constructors:
    ...
    def do_clean_frame(self, *args, **kwargs): # real signature unknown
    ...
    def do_prepare_frame(self, *args, **kwargs): # real signature unknown
        """ prepare_frame(self, videoaggregator:GstVideo.VideoAggregator, buffer:Gst.Buffer, prepared_frame:GstVideo.VideoFrame) -> bool """
        pass

    def do_skip_buffer(self, *args, **kwargs): # real signature unknown
    ...
    def do_update_conversion_info(self, *args, **kwargs): # real signature unknown
        """ update_conversion_info(self) """
        pass

    def drop_buffer(self): # real signature unknown; restored from __doc__
        """ drop_buffer(self) -> bool """
        return False
    ...
    def get_current_buffer(self): # real signature unknown; restored from __doc__
        """ get_current_buffer(self) -> Gst.Buffer """
        pass
    ...
    def get_prepared_frame(self): # real signature unknown; restored from __doc__
        """ get_prepared_frame(self) -> GstVideo.VideoFrame """
        pass
    ...
    def has_buffer(self): # real signature unknown; restored from __doc__
        """ has_buffer(self) -> bool """
        return False

    def has_current_buffer(self): # real signature unknown; restored from __doc__
        """ has_current_buffer(self) -> bool """
        return False
    ...
    def pop_buffer(self): # real signature unknown; restored from __doc__
        """ pop_buffer(self) -> Gst.Buffer """
        pass
    ...
    def set_needs_alpha(self, needs_alpha): # real signature unknown; restored from __doc__
        """ set_needs_alpha(self, needs_alpha:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f930d25bb20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VideoAggregatorPad), '__module__': 'gi.repository.GstVideo', '__gtype__': <GType GstVideoAggregatorPad (94743669271216)>, '__doc__': None, '__gsignals__': {}, 'get_current_buffer': gi.FunctionInfo(get_current_buffer), 'get_prepared_frame': gi.FunctionInfo(get_prepared_frame), 'has_current_buffer': gi.FunctionInfo(has_current_buffer), 'set_needs_alpha': gi.FunctionInfo(set_needs_alpha), 'do_clean_frame': gi.VFuncInfo(clean_frame), 'do_prepare_frame': gi.VFuncInfo(prepare_frame), 'do_update_conversion_info': gi.VFuncInfo(update_conversion_info), 'parent': <property object at 0x7f930d603f90>, 'info': <property object at 0x7f930d6050e0>, 'priv': <property object at 0x7f930d6051d0>, '_gst_reserved': <property object at 0x7f930d6052c0>})"
    __gdoc__ = 'Object GstVideoAggregatorPad\n\nProperties from GstVideoAggregatorPad:\n  zorder -> guint: Z-Order\n    Z Order of the picture\n  repeat-after-eos -> gboolean: Repeat After EOS\n    Repeat the last frame after EOS until all pads are EOS\n\nProperties from GstAggregatorPad:\n  emit-signals -> gboolean: Emit signals\n    Send signals to signal data consumption\n\nSignals from GstPad:\n  linked (GstPad)\n  unlinked (GstPad)\n\nProperties from GstPad:\n  direction -> GstPadDirection: Direction\n    The direction of the pad\n  template -> GstPadTemplate: Template\n    The GstPadTemplate of this pad\n  offset -> gint64: Offset\n    The running time offset of the pad\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstVideoAggregatorPad (94743669271216)>'
    __info__ = ObjectInfo(VideoAggregatorPad)
