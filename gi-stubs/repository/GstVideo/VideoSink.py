...
class VideoSink(__gi_repository_GstBase.BaseSink):
    """
    :Constructors:
    ...
    def center_rect(self, src, dst, result, scaling): # real signature unknown; restored from __doc__
        """ center_rect(src:GstVideo.VideoRectangle, dst:GstVideo.VideoRectangle, result:GstVideo.VideoRectangle, scaling:bool) """
        pass
    ...
    def do_show_frame(self, *args, **kwargs): # real signature unknown
