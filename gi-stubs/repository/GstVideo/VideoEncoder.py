...
class VideoEncoder(__gi_repository_Gst.Element, __gi_repository_Gst.Preset):
    """
    :Constructors:
    ...
    def allocate_output_buffer(self, size): # real signature unknown; restored from __doc__
        """ allocate_output_buffer(self, size:int) -> Gst.Buffer """
        pass

    def allocate_output_frame(self, frame, size): # real signature unknown; restored from __doc__
        """ allocate_output_frame(self, frame:GstVideo.VideoCodecFrame, size:int) -> Gst.FlowReturn """
        pass
    ...
    def do_pre_push(self, *args, **kwargs): # real signature unknown
    ...
    def get_max_encode_time(self, frame): # real signature unknown; restored from __doc__
        """ get_max_encode_time(self, frame:GstVideo.VideoCodecFrame) -> int """
        return 0
    ...
    def set_headers(self, headers): # real signature unknown; restored from __doc__
        """ set_headers(self, headers:list) """
        pass
    ...
    def set_min_pts(self, min_pts): # real signature unknown; restored from __doc__
        """ set_min_pts(self, min_pts:int) """
        pass
    ...
    def set_output_state(self, caps, reference=None): # real signature unknown; restored from __doc__
        """ set_output_state(self, caps:Gst.Caps, reference:GstVideo.VideoCodecState=None) -> GstVideo.VideoCodecState """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f930d25b280>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VideoEncoder), '__module__': 'gi.repository.GstVideo', '__gtype__': <GType GstVideoEncoder (94743669124912)>, '__doc__': None, '__gsignals__': {}, 'allocate_output_buffer': gi.FunctionInfo(allocate_output_buffer), 'allocate_output_frame': gi.FunctionInfo(allocate_output_frame), 'finish_frame': gi.FunctionInfo(finish_frame), 'get_allocator': gi.FunctionInfo(get_allocator), 'get_frame': gi.FunctionInfo(get_frame), 'get_frames': gi.FunctionInfo(get_frames), 'get_latency': gi.FunctionInfo(get_latency), 'get_max_encode_time': gi.FunctionInfo(get_max_encode_time), 'get_oldest_frame': gi.FunctionInfo(get_oldest_frame), 'get_output_state': gi.FunctionInfo(get_output_state), 'is_qos_enabled': gi.FunctionInfo(is_qos_enabled), 'merge_tags': gi.FunctionInfo(merge_tags), 'negotiate': gi.FunctionInfo(negotiate), 'proxy_getcaps': gi.FunctionInfo(proxy_getcaps), 'set_headers': gi.FunctionInfo(set_headers), 'set_latency': gi.FunctionInfo(set_latency), 'set_min_pts': gi.FunctionInfo(set_min_pts), 'set_output_state': gi.FunctionInfo(set_output_state), 'set_qos_enabled': gi.FunctionInfo(set_qos_enabled), 'do_close': gi.VFuncInfo(close), 'do_decide_allocation': gi.VFuncInfo(decide_allocation), 'do_finish': gi.VFuncInfo(finish), 'do_flush': gi.VFuncInfo(flush), 'do_getcaps': gi.VFuncInfo(getcaps), 'do_handle_frame': gi.VFuncInfo(handle_frame), 'do_negotiate': gi.VFuncInfo(negotiate), 'do_open': gi.VFuncInfo(open), 'do_pre_push': gi.VFuncInfo(pre_push), 'do_propose_allocation': gi.VFuncInfo(propose_allocation), 'do_reset': gi.VFuncInfo(reset), 'do_set_format': gi.VFuncInfo(set_format), 'do_sink_event': gi.VFuncInfo(sink_event), 'do_sink_query': gi.VFuncInfo(sink_query), 'do_src_event': gi.VFuncInfo(src_event), 'do_src_query': gi.VFuncInfo(src_query), 'do_start': gi.VFuncInfo(start), 'do_stop': gi.VFuncInfo(stop), 'do_transform_meta': gi.VFuncInfo(transform_meta), 'element': <property object at 0x7f930d277d10>, 'sinkpad': <property object at 0x7f930d277e00>, 'srcpad': <property object at 0x7f930d277ef0>, 'stream_lock': <property object at 0x7f930d27b040>, 'input_segment': <property object at 0x7f930d27b130>, 'output_segment': <property object at 0x7f930d27b220>, 'priv': <property object at 0x7f930d27b310>, 'padding': <property object at 0x7f930d27b400>})"
    __gdoc__ = 'Object GstVideoEncoder\n\nProperties from GstVideoEncoder:\n  qos -> gboolean: Qos\n    Handle Quality-of-Service events from downstream\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstVideoEncoder (94743669124912)>'
    __info__ = ObjectInfo(VideoEncoder)
