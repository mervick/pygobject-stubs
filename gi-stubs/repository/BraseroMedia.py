# encoding: utf-8
# module gi.repository.BraseroMedia
# from /usr/lib64/girepository-1.0/BraseroMedia-3.1.typelib
# by generator 1.147
"""
...
MEDIUM_BDR_RANDOM = 33800
MEDIUM_BDR_SRM = 34824

MEDIUM_BDR_SRM_POW = 38920
...
MEDIUM_DVDRW_PLUS = 16452

MEDIUM_DVDRW_PLUS_DL = 16468

MEDIUM_DVDRW_RESTRICTED = 16644

MEDIUM_DVDR_DL = 32916

MEDIUM_DVDR_JUMP_DL = 33300

MEDIUM_DVDR_PLUS = 32836

MEDIUM_DVDR_PLUS_DL = 32852

MEDIUM_DVD_RAM = 36
MEDIUM_DVD_ROM = 65540

_namespace = 'BraseroMedia'
...
def media_get_option_group(): # real signature unknown; restored from __doc__
    """ media_get_option_group() -> GLib.OptionGroup """
    pass

def media_library_start(): # real signature unknown; restored from __doc__
    """ media_library_start() """
    pass

def media_library_stop(): # real signature unknown; restored from __doc__
    """ media_library_stop() """
    pass

def media_quark(): # real signature unknown; restored from __doc__
    """ media_quark() -> int """
    return 0

def units_get_time_string(time, with_unit, round): # real signature unknown; restored from __doc__
    """ units_get_time_string(time:int, with_unit:bool, round:bool) -> str """
    return ""

def units_get_time_string_from_size(size, with_unit, round): # real signature unknown; restored from __doc__
    """ units_get_time_string_from_size(size:int, with_unit:bool, round:bool) -> str """
    return ""
...
class Drive(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    def cancel_current_operation(self): # real signature unknown; restored from __doc__
        """ cancel_current_operation(self) """
        pass
    ...
    def can_use_exclusively(self): # real signature unknown; restored from __doc__
        """ can_use_exclusively(self) -> bool """
        return False

    def can_write(self): # real signature unknown; restored from __doc__
        """ can_write(self) -> bool """
        return False

    def can_write_media(self, media): # real signature unknown; restored from __doc__
        """ can_write_media(self, media:BraseroMedia.Media) -> bool """
        return False
    ...
    def do_medium_added(self, *args, **kwargs): # real signature unknown
        """ medium_added(self, medium:BraseroMedia.Medium) """
        pass

    def do_medium_removed(self, *args, **kwargs): # real signature unknown
        """ medium_removed(self, medium:BraseroMedia.Medium) """
        pass

    def eject(self, wait): # real signature unknown; restored from __doc__
        """ eject(self, wait:bool) -> bool """
        return False
    ...
    def get_block_device(self): # real signature unknown; restored from __doc__
        """ get_block_device(self) -> str """
        return ""

    def get_bus_target_lun_string(self): # real signature unknown; restored from __doc__
        """ get_bus_target_lun_string(self) -> str """
        return ""

    def get_caps(self): # real signature unknown; restored from __doc__
        """ get_caps(self) -> BraseroMedia.DriveCaps """
        pass
    ...
    def get_medium(self): # real signature unknown; restored from __doc__
        """ get_medium(self) -> BraseroMedia.Medium """
        pass
    ...
    def is_door_open(self): # real signature unknown; restored from __doc__
        """ is_door_open(self) -> bool """
        return False
    ...
    def is_locked(self, reason): # real signature unknown; restored from __doc__
        """ is_locked(self, reason:str) -> bool """
        return False
    ...
    def lock(self, reason, reason_for_failure): # real signature unknown; restored from __doc__
        """ lock(self, reason:str, reason_for_failure:str) -> bool """
        return False
    ...
    def reprobe(self): # real signature unknown; restored from __doc__
        """ reprobe(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2b5ee3e4c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Drive), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType BraseroDrive (94039158536032)>, '__doc__': None, '__gsignals__': {}, 'can_eject': gi.FunctionInfo(can_eject), 'can_use_exclusively': gi.FunctionInfo(can_use_exclusively), 'can_write': gi.FunctionInfo(can_write), 'can_write_media': gi.FunctionInfo(can_write_media), 'cancel_current_operation': gi.FunctionInfo(cancel_current_operation), 'eject': gi.FunctionInfo(eject), 'get_block_device': gi.FunctionInfo(get_block_device), 'get_bus_target_lun_string': gi.FunctionInfo(get_bus_target_lun_string), 'get_caps': gi.FunctionInfo(get_caps), 'get_device': gi.FunctionInfo(get_device), 'get_display_name': gi.FunctionInfo(get_display_name), 'get_medium': gi.FunctionInfo(get_medium), 'get_udi': gi.FunctionInfo(get_udi), 'is_door_open': gi.FunctionInfo(is_door_open), 'is_fake': gi.FunctionInfo(is_fake), 'is_locked': gi.FunctionInfo(is_locked), 'lock': gi.FunctionInfo(lock), 'reprobe': gi.FunctionInfo(reprobe), 'unlock': gi.FunctionInfo(unlock), 'do_medium_added': gi.VFuncInfo(medium_added), 'do_medium_removed': gi.VFuncInfo(medium_removed), 'parent_instance': <property object at 0x7f2b5ee7b400>})"
    __gdoc__ = 'Object BraseroDrive\n\nSignals from BraseroDrive:\n  medium-added (BraseroMedium)\n  medium-removed (BraseroMedium)\n\nProperties from BraseroDrive:\n  device -> gchararray: Device\n    Device path for the drive\n  gdrive -> GDrive: GDrive\n    A GDrive object for the drive\n  udi -> gchararray: udi\n    HAL udi as a string (Deprecated)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroDrive (94039158536032)>'
    __info__ = ObjectInfo(Drive)


class DriveCaps(__gobject.GFlags):
    # no doc
    ...
    NONE = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.BraseroMedia', '__dict__': <attribute '__dict__' of 'DriveCaps' objects>, '__doc__': None, '__gtype__': <GType PyBraseroMediaDriveCaps (94039159210976)>, '__flags_values__': {0: <flags 0 of type BraseroMedia.DriveCaps>, 1: <flags BRASERO_DRIVE_CAPS_CDR of type BraseroMedia.DriveCaps>, 2: <flags BRASERO_DRIVE_CAPS_CDRW of type BraseroMedia.DriveCaps>, 4: <flags BRASERO_DRIVE_CAPS_DVDR of type BraseroMedia.DriveCaps>, 8: <flags BRASERO_DRIVE_CAPS_DVDRW of type BraseroMedia.DriveCaps>, 16: <flags BRASERO_DRIVE_CAPS_DVDR_PLUS of type BraseroMedia.DriveCaps>, 32: <flags BRASERO_DRIVE_CAPS_DVDRW_PLUS of type BraseroMedia.DriveCaps>, 64: <flags BRASERO_DRIVE_CAPS_DVDR_PLUS_DL of type BraseroMedia.DriveCaps>, 128: <flags BRASERO_DRIVE_CAPS_DVDRW_PLUS_DL of type BraseroMedia.DriveCaps>, 1024: <flags BRASERO_DRIVE_CAPS_DVDRAM of type BraseroMedia.DriveCaps>, 256: <flags BRASERO_DRIVE_CAPS_BDR of type BraseroMedia.DriveCaps>, 512: <flags BRASERO_DRIVE_CAPS_BDRW of type BraseroMedia.DriveCaps>}, '__info__': gi.EnumInfo(DriveCaps), 'NONE': <flags 0 of type BraseroMedia.DriveCaps>, 'CDR': <flags BRASERO_DRIVE_CAPS_CDR of type BraseroMedia.DriveCaps>, 'CDRW': <flags BRASERO_DRIVE_CAPS_CDRW of type BraseroMedia.DriveCaps>, 'DVDR': <flags BRASERO_DRIVE_CAPS_DVDR of type BraseroMedia.DriveCaps>, 'DVDRW': <flags BRASERO_DRIVE_CAPS_DVDRW of type BraseroMedia.DriveCaps>, 'DVDR_PLUS': <flags BRASERO_DRIVE_CAPS_DVDR_PLUS of type BraseroMedia.DriveCaps>, 'DVDRW_PLUS': <flags BRASERO_DRIVE_CAPS_DVDRW_PLUS of type BraseroMedia.DriveCaps>, 'DVDR_PLUS_DL': <flags BRASERO_DRIVE_CAPS_DVDR_PLUS_DL of type BraseroMedia.DriveCaps>, 'DVDRW_PLUS_DL': <flags BRASERO_DRIVE_CAPS_DVDRW_PLUS_DL of type BraseroMedia.DriveCaps>, 'DVDRAM': <flags BRASERO_DRIVE_CAPS_DVDRAM of type BraseroMedia.DriveCaps>, 'BDR': <flags BRASERO_DRIVE_CAPS_BDR of type BraseroMedia.DriveCaps>, 'BDRW': <flags BRASERO_DRIVE_CAPS_BDRW of type BraseroMedia.DriveCaps>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType PyBraseroMediaDriveCaps (94039159210976)>'
    __info__ = gi.EnumInfo(DriveCaps)


class DriveClass(__gi.Struct):
    """
    :Constructors:
    ...
    medium_added = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    medium_removed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(DriveClass), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'DriveClass' objects>, '__weakref__': <attribute '__weakref__' of 'DriveClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2b5ee7bd10>, 'medium_added': <property object at 0x7f2b5ee7bd60>, 'medium_removed': <property object at 0x7f2b5ee7bdb0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(DriveClass)


class DriveSelection(__gi_overrides_Gtk.ComboBox):
    """
    :Constructors:
    
    ::
    
        DriveSelection(**properties)
        new() -> Gtk.Widget
    """
    ...
    def do_drive_changed(self, *args, **kwargs): # real signature unknown
        """ drive_changed(self, drive:BraseroMedia.Drive) """
        pass
    ...
    def set_active(self, drive): # real signature unknown; restored from __doc__
        """ set_active(self, drive:BraseroMedia.Drive) -> bool """
        return False
    ...
    def show_type(self, type): # real signature unknown; restored from __doc__
        """ show_type(self, type:BraseroMedia.DriveType) """
        pass
...
class DriveSelectionClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(DriveSelectionClass), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'DriveSelectionClass' objects>, '__weakref__': <attribute '__weakref__' of 'DriveSelectionClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2b5edca180>, 'drive_changed': <property object at 0x7f2b5edca270>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(DriveSelectionClass)


class DriveType(__gobject.GFlags):
    # no doc
    def as_integer_ratio(self): # real signature unknown; restored from __doc__
        """
        Return integer ratio.
    ...
    WRITER = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.BraseroMedia', '__dict__': <attribute '__dict__' of 'DriveType' objects>, '__doc__': None, '__gtype__': <GType PyBraseroMediaDriveType (94039159323088)>, '__flags_values__': {0: <flags 0 of type BraseroMedia.DriveType>, 1: <flags BRASERO_DRIVE_TYPE_FILE of type BraseroMedia.DriveType>, 2: <flags BRASERO_DRIVE_TYPE_WRITER of type BraseroMedia.DriveType>, 4: <flags BRASERO_DRIVE_TYPE_READER of type BraseroMedia.DriveType>, 254: <flags BRASERO_DRIVE_TYPE_WRITER | BRASERO_DRIVE_TYPE_READER | BRASERO_DRIVE_TYPE_ALL_BUT_FILE of type BraseroMedia.DriveType>, 255: <flags BRASERO_DRIVE_TYPE_FILE | BRASERO_DRIVE_TYPE_WRITER | BRASERO_DRIVE_TYPE_READER | BRASERO_DRIVE_TYPE_ALL_BUT_FILE | BRASERO_DRIVE_TYPE_ALL of type BraseroMedia.DriveType>}, '__info__': gi.EnumInfo(DriveType), 'NONE': <flags 0 of type BraseroMedia.DriveType>, 'FILE': <flags BRASERO_DRIVE_TYPE_FILE of type BraseroMedia.DriveType>, 'WRITER': <flags BRASERO_DRIVE_TYPE_WRITER of type BraseroMedia.DriveType>, 'READER': <flags BRASERO_DRIVE_TYPE_READER of type BraseroMedia.DriveType>, 'ALL_BUT_FILE': <flags BRASERO_DRIVE_TYPE_WRITER | BRASERO_DRIVE_TYPE_READER | BRASERO_DRIVE_TYPE_ALL_BUT_FILE of type BraseroMedia.DriveType>, 'ALL': <flags BRASERO_DRIVE_TYPE_FILE | BRASERO_DRIVE_TYPE_WRITER | BRASERO_DRIVE_TYPE_READER | BRASERO_DRIVE_TYPE_ALL_BUT_FILE | BRASERO_DRIVE_TYPE_ALL of type BraseroMedia.DriveType>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType PyBraseroMediaDriveType (94039159323088)>'
    __info__ = gi.EnumInfo(DriveType)


class Media(__gobject.GFlags):
    # no doc
    def as_integer_ratio(self): # real signature unknown; restored from __doc__
        """
        Return integer ratio.
    ...
    SRM = 2048
    UNFORMATTED = 1048576
    UNSUPPORTED = 18446744073709551614
    WRITABLE = 32768
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.BraseroMedia', '__dict__': <attribute '__dict__' of 'Media' objects>, '__doc__': None, '__gtype__': <GType PyBraseroMediaMedia (94039159041680)>, '__flags_values__': {4294967294: <flags BRASERO_MEDIUM_UNSUPPORTED | BRASERO_MEDIUM_CD | BRASERO_MEDIUM_DVD | BRASERO_MEDIUM_BD | BRASERO_MEDIUM_DUAL_L | BRASERO_MEDIUM_RAM | BRASERO_MEDIUM_PLUS | BRASERO_MEDIUM_SEQUENTIAL | BRASERO_MEDIUM_RESTRICTED | BRASERO_MEDIUM_JUMP | BRASERO_MEDIUM_RANDOM | BRASERO_MEDIUM_SRM | BRASERO_MEDIUM_POW | BRASERO_MEDIUM_REWRITABLE | BRASERO_MEDIUM_WRITABLE | BRASERO_MEDIUM_ROM | BRASERO_MEDIUM_BLANK | BRASERO_MEDIUM_CLOSED | BRASERO_MEDIUM_APPENDABLE | BRASERO_MEDIUM_UNFORMATTED | BRASERO_MEDIUM_PROTECTED | BRASERO_MEDIUM_HAS_DATA | BRASERO_MEDIUM_HAS_AUDIO of type BraseroMedia.Media>, 4294967295: <flags BRASERO_MEDIUM_UNSUPPORTED | BRASERO_MEDIUM_BUSY | BRASERO_MEDIUM_FILE | BRASERO_MEDIUM_CD | BRASERO_MEDIUM_DVD | BRASERO_MEDIUM_BD | BRASERO_MEDIUM_DUAL_L | BRASERO_MEDIUM_RAM | BRASERO_MEDIUM_PLUS | BRASERO_MEDIUM_SEQUENTIAL | BRASERO_MEDIUM_RESTRICTED | BRASERO_MEDIUM_JUMP | BRASERO_MEDIUM_RANDOM | BRASERO_MEDIUM_SRM | BRASERO_MEDIUM_POW | BRASERO_MEDIUM_REWRITABLE | BRASERO_MEDIUM_WRITABLE | BRASERO_MEDIUM_ROM | BRASERO_MEDIUM_BLANK | BRASERO_MEDIUM_CLOSED | BRASERO_MEDIUM_APPENDABLE | BRASERO_MEDIUM_UNFORMATTED | BRASERO_MEDIUM_PROTECTED | BRASERO_MEDIUM_HAS_DATA | BRASERO_MEDIUM_HAS_AUDIO of type BraseroMedia.Media>, 0: <flags 0 of type BraseroMedia.Media>, 1: <flags BRASERO_MEDIUM_FILE of type BraseroMedia.Media>, 2: <flags BRASERO_MEDIUM_CD of type BraseroMedia.Media>, 4: <flags BRASERO_MEDIUM_DVD of type BraseroMedia.Media>, 8: <flags BRASERO_MEDIUM_BD of type BraseroMedia.Media>, 16: <flags BRASERO_MEDIUM_DUAL_L of type BraseroMedia.Media>, 32: <flags BRASERO_MEDIUM_RAM of type BraseroMedia.Media>, 64: <flags BRASERO_MEDIUM_PLUS of type BraseroMedia.Media>, 128: <flags BRASERO_MEDIUM_SEQUENTIAL of type BraseroMedia.Media>, 256: <flags BRASERO_MEDIUM_RESTRICTED of type BraseroMedia.Media>, 512: <flags BRASERO_MEDIUM_JUMP of type BraseroMedia.Media>, 1024: <flags BRASERO_MEDIUM_RANDOM of type BraseroMedia.Media>, 2048: <flags BRASERO_MEDIUM_SRM of type BraseroMedia.Media>, 4096: <flags BRASERO_MEDIUM_POW of type BraseroMedia.Media>, 16384: <flags BRASERO_MEDIUM_REWRITABLE of type BraseroMedia.Media>, 32768: <flags BRASERO_MEDIUM_WRITABLE of type BraseroMedia.Media>, 65536: <flags BRASERO_MEDIUM_ROM of type BraseroMedia.Media>, 131072: <flags BRASERO_MEDIUM_BLANK of type BraseroMedia.Media>, 262144: <flags BRASERO_MEDIUM_CLOSED of type BraseroMedia.Media>, 524288: <flags BRASERO_MEDIUM_APPENDABLE of type BraseroMedia.Media>, 1048576: <flags BRASERO_MEDIUM_UNFORMATTED of type BraseroMedia.Media>, 2097152: <flags BRASERO_MEDIUM_PROTECTED of type BraseroMedia.Media>, 4194304: <flags BRASERO_MEDIUM_HAS_DATA of type BraseroMedia.Media>, 8388608: <flags BRASERO_MEDIUM_HAS_AUDIO of type BraseroMedia.Media>}, '__info__': gi.EnumInfo(Media), 'UNSUPPORTED': <flags BRASERO_MEDIUM_UNSUPPORTED | BRASERO_MEDIUM_CD | BRASERO_MEDIUM_DVD | BRASERO_MEDIUM_BD | BRASERO_MEDIUM_DUAL_L | BRASERO_MEDIUM_RAM | BRASERO_MEDIUM_PLUS | BRASERO_MEDIUM_SEQUENTIAL | BRASERO_MEDIUM_RESTRICTED | BRASERO_MEDIUM_JUMP | BRASERO_MEDIUM_RANDOM | BRASERO_MEDIUM_SRM | BRASERO_MEDIUM_POW | BRASERO_MEDIUM_REWRITABLE | BRASERO_MEDIUM_WRITABLE | BRASERO_MEDIUM_ROM | BRASERO_MEDIUM_BLANK | BRASERO_MEDIUM_CLOSED | BRASERO_MEDIUM_APPENDABLE | BRASERO_MEDIUM_UNFORMATTED | BRASERO_MEDIUM_PROTECTED | BRASERO_MEDIUM_HAS_DATA | BRASERO_MEDIUM_HAS_AUDIO of type BraseroMedia.Media>, 'BUSY': <flags BRASERO_MEDIUM_UNSUPPORTED | BRASERO_MEDIUM_BUSY | BRASERO_MEDIUM_FILE | BRASERO_MEDIUM_CD | BRASERO_MEDIUM_DVD | BRASERO_MEDIUM_BD | BRASERO_MEDIUM_DUAL_L | BRASERO_MEDIUM_RAM | BRASERO_MEDIUM_PLUS | BRASERO_MEDIUM_SEQUENTIAL | BRASERO_MEDIUM_RESTRICTED | BRASERO_MEDIUM_JUMP | BRASERO_MEDIUM_RANDOM | BRASERO_MEDIUM_SRM | BRASERO_MEDIUM_POW | BRASERO_MEDIUM_REWRITABLE | BRASERO_MEDIUM_WRITABLE | BRASERO_MEDIUM_ROM | BRASERO_MEDIUM_BLANK | BRASERO_MEDIUM_CLOSED | BRASERO_MEDIUM_APPENDABLE | BRASERO_MEDIUM_UNFORMATTED | BRASERO_MEDIUM_PROTECTED | BRASERO_MEDIUM_HAS_DATA | BRASERO_MEDIUM_HAS_AUDIO of type BraseroMedia.Media>, 'NONE': <flags 0 of type BraseroMedia.Media>, 'FILE': <flags BRASERO_MEDIUM_FILE of type BraseroMedia.Media>, 'CD': <flags BRASERO_MEDIUM_CD of type BraseroMedia.Media>, 'DVD': <flags BRASERO_MEDIUM_DVD of type BraseroMedia.Media>, 'BD': <flags BRASERO_MEDIUM_BD of type BraseroMedia.Media>, 'DUAL_L': <flags BRASERO_MEDIUM_DUAL_L of type BraseroMedia.Media>, 'RAM': <flags BRASERO_MEDIUM_RAM of type BraseroMedia.Media>, 'PLUS': <flags BRASERO_MEDIUM_PLUS of type BraseroMedia.Media>, 'SEQUENTIAL': <flags BRASERO_MEDIUM_SEQUENTIAL of type BraseroMedia.Media>, 'RESTRICTED': <flags BRASERO_MEDIUM_RESTRICTED of type BraseroMedia.Media>, 'JUMP': <flags BRASERO_MEDIUM_JUMP of type BraseroMedia.Media>, 'RANDOM': <flags BRASERO_MEDIUM_RANDOM of type BraseroMedia.Media>, 'SRM': <flags BRASERO_MEDIUM_SRM of type BraseroMedia.Media>, 'POW': <flags BRASERO_MEDIUM_POW of type BraseroMedia.Media>, 'REWRITABLE': <flags BRASERO_MEDIUM_REWRITABLE of type BraseroMedia.Media>, 'WRITABLE': <flags BRASERO_MEDIUM_WRITABLE of type BraseroMedia.Media>, 'ROM': <flags BRASERO_MEDIUM_ROM of type BraseroMedia.Media>, 'BLANK': <flags BRASERO_MEDIUM_BLANK of type BraseroMedia.Media>, 'CLOSED': <flags BRASERO_MEDIUM_CLOSED of type BraseroMedia.Media>, 'APPENDABLE': <flags BRASERO_MEDIUM_APPENDABLE of type BraseroMedia.Media>, 'UNFORMATTED': <flags BRASERO_MEDIUM_UNFORMATTED of type BraseroMedia.Media>, 'PROTECTED': <flags BRASERO_MEDIUM_PROTECTED of type BraseroMedia.Media>, 'HAS_DATA': <flags BRASERO_MEDIUM_HAS_DATA of type BraseroMedia.Media>, 'HAS_AUDIO': <flags BRASERO_MEDIUM_HAS_AUDIO of type BraseroMedia.Media>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType PyBraseroMediaMedia (94039159041680)>'
    __info__ = gi.EnumInfo(Media)


class MediaError(__gobject.GEnum):
    # no doc
    def as_integer_ratio(self): # real signature unknown; restored from __doc__
        """
        Return integer ratio.
    ...
    NONE = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.BraseroMedia', '__dict__': <attribute '__dict__' of 'MediaError' objects>, '__doc__': None, '__gtype__': <GType PyBraseroMediaMediaError (94039159488576)>, '__enum_values__': {0: <enum BRASERO_MEDIA_ERROR_NONE of type BraseroMedia.MediaError>, 1: <enum BRASERO_MEDIA_ERROR_GENERAL of type BraseroMedia.MediaError>, 2: <enum BRASERO_MEDIA_ERROR_IMAGE_INVALID of type BraseroMedia.MediaError>}, '__info__': gi.EnumInfo(MediaError), 'NONE': <enum BRASERO_MEDIA_ERROR_NONE of type BraseroMedia.MediaError>, 'GENERAL': <enum BRASERO_MEDIA_ERROR_GENERAL of type BraseroMedia.MediaError>, 'IMAGE_INVALID': <enum BRASERO_MEDIA_ERROR_IMAGE_INVALID of type BraseroMedia.MediaError>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType PyBraseroMediaMediaError (94039159488576)>'
    __info__ = gi.EnumInfo(MediaError)


class MediaType(__gobject.GFlags):
    # no doc
    def as_integer_ratio(self): # real signature unknown; restored from __doc__
        """
        Return integer ratio.
    ...
    WRITABLE = 8
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.BraseroMedia', '__dict__': <attribute '__dict__' of 'MediaType' objects>, '__doc__': None, '__gtype__': <GType PyBraseroMediaMediaType (94039159514048)>, '__flags_values__': {0: <flags 0 of type BraseroMedia.MediaType>, 1: <flags BRASERO_MEDIA_TYPE_FILE of type BraseroMedia.MediaType>, 2: <flags BRASERO_MEDIA_TYPE_DATA of type BraseroMedia.MediaType>, 4: <flags BRASERO_MEDIA_TYPE_AUDIO of type BraseroMedia.MediaType>, 8: <flags BRASERO_MEDIA_TYPE_WRITABLE of type BraseroMedia.MediaType>, 16: <flags BRASERO_MEDIA_TYPE_REWRITABLE of type BraseroMedia.MediaType>, 32: <flags BRASERO_MEDIA_TYPE_ANY_IN_BURNER of type BraseroMedia.MediaType>, 64: <flags BRASERO_MEDIA_TYPE_CD of type BraseroMedia.MediaType>, 254: <flags BRASERO_MEDIA_TYPE_DATA | BRASERO_MEDIA_TYPE_AUDIO | BRASERO_MEDIA_TYPE_WRITABLE | BRASERO_MEDIA_TYPE_REWRITABLE | BRASERO_MEDIA_TYPE_ANY_IN_BURNER | BRASERO_MEDIA_TYPE_CD | BRASERO_MEDIA_TYPE_ALL_BUT_FILE of type BraseroMedia.MediaType>, 255: <flags BRASERO_MEDIA_TYPE_FILE | BRASERO_MEDIA_TYPE_DATA | BRASERO_MEDIA_TYPE_AUDIO | BRASERO_MEDIA_TYPE_WRITABLE | BRASERO_MEDIA_TYPE_REWRITABLE | BRASERO_MEDIA_TYPE_ANY_IN_BURNER | BRASERO_MEDIA_TYPE_CD | BRASERO_MEDIA_TYPE_ALL_BUT_FILE | BRASERO_MEDIA_TYPE_ALL of type BraseroMedia.MediaType>}, '__info__': gi.EnumInfo(MediaType), 'NONE': <flags 0 of type BraseroMedia.MediaType>, 'FILE': <flags BRASERO_MEDIA_TYPE_FILE of type BraseroMedia.MediaType>, 'DATA': <flags BRASERO_MEDIA_TYPE_DATA of type BraseroMedia.MediaType>, 'AUDIO': <flags BRASERO_MEDIA_TYPE_AUDIO of type BraseroMedia.MediaType>, 'WRITABLE': <flags BRASERO_MEDIA_TYPE_WRITABLE of type BraseroMedia.MediaType>, 'REWRITABLE': <flags BRASERO_MEDIA_TYPE_REWRITABLE of type BraseroMedia.MediaType>, 'ANY_IN_BURNER': <flags BRASERO_MEDIA_TYPE_ANY_IN_BURNER of type BraseroMedia.MediaType>, 'CD': <flags BRASERO_MEDIA_TYPE_CD of type BraseroMedia.MediaType>, 'ALL_BUT_FILE': <flags BRASERO_MEDIA_TYPE_DATA | BRASERO_MEDIA_TYPE_AUDIO | BRASERO_MEDIA_TYPE_WRITABLE | BRASERO_MEDIA_TYPE_REWRITABLE | BRASERO_MEDIA_TYPE_ANY_IN_BURNER | BRASERO_MEDIA_TYPE_CD | BRASERO_MEDIA_TYPE_ALL_BUT_FILE of type BraseroMedia.MediaType>, 'ALL': <flags BRASERO_MEDIA_TYPE_FILE | BRASERO_MEDIA_TYPE_DATA | BRASERO_MEDIA_TYPE_AUDIO | BRASERO_MEDIA_TYPE_WRITABLE | BRASERO_MEDIA_TYPE_REWRITABLE | BRASERO_MEDIA_TYPE_ANY_IN_BURNER | BRASERO_MEDIA_TYPE_CD | BRASERO_MEDIA_TYPE_ALL_BUT_FILE | BRASERO_MEDIA_TYPE_ALL of type BraseroMedia.MediaType>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType PyBraseroMediaMediaType (94039159514048)>'
    __info__ = gi.EnumInfo(MediaType)


class Medium(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    def can_be_rewritten(self): # real signature unknown; restored from __doc__
        """ can_be_rewritten(self) -> bool """
        return False

    def can_be_written(self): # real signature unknown; restored from __doc__
        """ can_be_written(self) -> bool """
        return False

    def can_use_burnfree(self): # real signature unknown; restored from __doc__
        """ can_use_burnfree(self) -> bool """
        return False

    def can_use_dummy_for_sao(self): # real signature unknown; restored from __doc__
        """ can_use_dummy_for_sao(self) -> bool """
        return False

    def can_use_dummy_for_tao(self): # real signature unknown; restored from __doc__
        """ can_use_dummy_for_tao(self) -> bool """
        return False

    def can_use_sao(self): # real signature unknown; restored from __doc__
        """ can_use_sao(self) -> bool """
        return False

    def can_use_tao(self): # real signature unknown; restored from __doc__
        """ can_use_tao(self) -> bool """
        return False
    ...
    def get_capacity(self, bytes, blocks): # real signature unknown; restored from __doc__
        """ get_capacity(self, bytes:int, blocks:int) """
        pass

    def get_CD_TEXT_title(self): # real signature unknown; restored from __doc__
        """ get_CD_TEXT_title(self) -> str """
        return ""
    ...
    def get_data_size(self, bytes, blocks): # real signature unknown; restored from __doc__
        """ get_data_size(self, bytes:int, blocks:int) """
        pass

    def get_drive(self): # real signature unknown; restored from __doc__
        """ get_drive(self) -> BraseroMedia.Drive """
        pass

    def get_free_space(self, bytes, blocks): # real signature unknown; restored from __doc__
        """ get_free_space(self, bytes:int, blocks:int) """
        pass

    def get_last_data_track_address(self, bytes, sectors): # real signature unknown; restored from __doc__
        """ get_last_data_track_address(self, bytes:int, sectors:int) -> bool """
        return False

    def get_last_data_track_space(self, bytes, sectors): # real signature unknown; restored from __doc__
        """ get_last_data_track_space(self, bytes:int, sectors:int) -> bool """
        return False

    def get_max_write_speed(self): # real signature unknown; restored from __doc__
        """ get_max_write_speed(self) -> int """
        return 0

    def get_next_writable_address(self): # real signature unknown; restored from __doc__
        """ get_next_writable_address(self) -> int """
        return 0
    ...
    def get_status(self): # real signature unknown; restored from __doc__
        """ get_status(self) -> BraseroMedia.Media """
        pass
    ...
    def get_track_address(self, num, bytes, sectors): # real signature unknown; restored from __doc__
        """ get_track_address(self, num:int, bytes:int, sectors:int) -> bool """
        return False

    def get_track_num(self): # real signature unknown; restored from __doc__
        """ get_track_num(self) -> int """
        return 0

    def get_track_space(self, num, bytes, sectors): # real signature unknown; restored from __doc__
        """ get_track_space(self, num:int, bytes:int, sectors:int) -> bool """
        return False
    ...
    def get_write_speeds(self): # real signature unknown; restored from __doc__
        """ get_write_speeds(self) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2b5ee34640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Medium), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType BraseroMedium (94039159522016)>, '__doc__': None, '__gsignals__': {}, 'can_be_rewritten': gi.FunctionInfo(can_be_rewritten), 'can_be_written': gi.FunctionInfo(can_be_written), 'can_use_burnfree': gi.FunctionInfo(can_use_burnfree), 'can_use_dummy_for_sao': gi.FunctionInfo(can_use_dummy_for_sao), 'can_use_dummy_for_tao': gi.FunctionInfo(can_use_dummy_for_tao), 'can_use_sao': gi.FunctionInfo(can_use_sao), 'can_use_tao': gi.FunctionInfo(can_use_tao), 'get_CD_TEXT_title': gi.FunctionInfo(get_CD_TEXT_title), 'get_capacity': gi.FunctionInfo(get_capacity), 'get_data_size': gi.FunctionInfo(get_data_size), 'get_drive': gi.FunctionInfo(get_drive), 'get_free_space': gi.FunctionInfo(get_free_space), 'get_last_data_track_address': gi.FunctionInfo(get_last_data_track_address), 'get_last_data_track_space': gi.FunctionInfo(get_last_data_track_space), 'get_max_write_speed': gi.FunctionInfo(get_max_write_speed), 'get_next_writable_address': gi.FunctionInfo(get_next_writable_address), 'get_status': gi.FunctionInfo(get_status), 'get_tooltip': gi.FunctionInfo(get_tooltip), 'get_track_address': gi.FunctionInfo(get_track_address), 'get_track_num': gi.FunctionInfo(get_track_num), 'get_track_space': gi.FunctionInfo(get_track_space), 'get_type_string': gi.FunctionInfo(get_type_string), 'get_write_speeds': gi.FunctionInfo(get_write_speeds), 'parent_instance': <property object at 0x7f2b5edd04f0>})"
    __gdoc__ = 'Object BraseroMedium\n\nSignals from BraseroMedium:\n  probed ()\n\nProperties from BraseroMedium:\n  drive -> BraseroDrive: Drive\n    Drive in which medium is inserted\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroMedium (94039159522016)>'
...
class MediumClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MediumClass), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'MediumClass' objects>, '__weakref__': <attribute '__weakref__' of 'MediumClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2b5edd0680>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(MediumClass)


class MediumMonitor(__gi_overrides_GObject.Object):
    """
    :Constructors:
    
    ::
    
        MediumMonitor(**properties)
    """
    def bind_property(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def do_drive_added(self, *args, **kwargs): # real signature unknown
        """ drive_added(self, drive:BraseroMedia.Drive) """
        pass

    def do_drive_removed(self, *args, **kwargs): # real signature unknown
        """ drive_removed(self, drive:BraseroMedia.Drive) """
        pass
    ...
    def get_drives(self, type): # real signature unknown; restored from __doc__
        """ get_drives(self, type:BraseroMedia.DriveType) -> list """
        return []

    def get_media(self, type): # real signature unknown; restored from __doc__
        """ get_media(self, type:BraseroMedia.MediaType) -> list """
        return []
    ...
    def is_probing(self): # real signature unknown; restored from __doc__
        """ is_probing(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2b5ede02e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediumMonitor), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType BraseroMediumMonitor (94039159530592)>, '__doc__': None, '__gsignals__': {}, 'get_drives': gi.FunctionInfo(get_drives), 'get_media': gi.FunctionInfo(get_media), 'is_probing': gi.FunctionInfo(is_probing), 'do_drive_added': gi.VFuncInfo(drive_added), 'do_drive_removed': gi.VFuncInfo(drive_removed), 'do_medium_added': gi.VFuncInfo(medium_added), 'do_medium_removed': gi.VFuncInfo(medium_removed), 'parent_instance': <property object at 0x7f2b5edd0860>})"
    __gdoc__ = 'Object BraseroMediumMonitor\n\nSignals from BraseroMediumMonitor:\n  medium-added (BraseroMedium)\n  medium-removed (BraseroMedium)\n  drive-added (BraseroDrive)\n  drive-removed (BraseroDrive)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroMediumMonitor (94039159530592)>'
    __info__ = ObjectInfo(MediumMonitor)


class MediumMonitorClass(__gi.Struct):
    """
    :Constructors:
    ...
    drive_added = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    drive_removed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MediumMonitorClass), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'MediumMonitorClass' objects>, '__weakref__': <attribute '__weakref__' of 'MediumMonitorClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2b5edd09f0>, 'drive_added': <property object at 0x7f2b5edd0ae0>, 'drive_removed': <property object at 0x7f2b5edd0bd0>, 'medium_added': <property object at 0x7f2b5edd0cc0>, 'medium_removed': <property object at 0x7f2b5edd0db0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(MediumMonitorClass)


class MediumSelection(__gi_overrides_Gtk.ComboBox):
    """
    :Constructors:
    
    ::
    
        MediumSelection(**properties)
        new() -> Gtk.Widget
    """
    def activate(self): # real signature unknown; restored from __doc__
        """ activate(self) -> bool """
    ...
    def do_format_medium_string(self, *args, **kwargs): # real signature unknown
        """ format_medium_string(self, medium:BraseroMedia.Medium) -> str """
        pass
    ...
    def do_medium_changed(self, *args, **kwargs): # real signature unknown
        """ medium_changed(self, medium:BraseroMedia.Medium) """
        pass
    ...
    def set_active(self, medium): # real signature unknown; restored from __doc__
        """ set_active(self, medium:BraseroMedia.Medium) -> bool """
        return False
    ...
    def show_media_type(self, type): # real signature unknown; restored from __doc__
        """ show_media_type(self, type:BraseroMedia.MediaType) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2b5ede0d00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediumSelection), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType BraseroMediumSelection (94039159622384)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'set_active': gi.FunctionInfo(set_active), 'show_media_type': gi.FunctionInfo(show_media_type), 'do_format_medium_string': gi.VFuncInfo(format_medium_string), 'do_medium_changed': gi.VFuncInfo(medium_changed), 'parent_instance': <property object at 0x7f2b5edd0ef0>})"
    __gdoc__ = "Object BraseroMediumSelection\n\nSignals from BraseroMediumSelection:\n  medium-changed (BraseroMedium)\n\nProperties from BraseroMediumSelection:\n  medium -> BraseroMedium: Selected medium\n    The currently selected medium\n  media-type -> guint: The type of media\n    The type of media displayed\n\nSignals from GtkCellEditable:\n  editing-done ()\n  remove-widget ()\n\nSignals from GtkComboBox:\n  changed ()\n  move-active (GtkScrollType)\n  popup ()\n  popdown () -> gboolean\n  format-entry-text (gchararray) -> gchararray\n\nProperties from GtkComboBox:\n  model -> GtkTreeModel: ComboBox model\n    The model for the combo box\n  wrap-width -> gint: Wrap width\n    Wrap width for laying out the items in a grid\n  row-span-column -> gint: Row span column\n    TreeModel column containing the row span values\n  column-span-column -> gint: Column span column\n    TreeModel column containing the column span values\n  active -> gint: Active item\n    The item which is currently active\n  add-tearoffs -> gboolean: Add tearoffs to menus\n    Whether dropdowns should have a tearoff menu item\n  tearoff-title -> gchararray: Tearoff Title\n    A title that may be displayed by the window manager when the popup is torn-off\n  has-frame -> gboolean: Has Frame\n    Whether the combo box draws a frame around the child\n  popup-shown -> gboolean: Popup shown\n    Whether the combo's dropdown is shown\n  button-sensitivity -> GtkSensitivityType: Button Sensitivity\n    Whether the dropdown button is sensitive when the model is empty\n  has-entry -> gboolean: Has Entry\n    Whether combo box has an entry\n  entry-text-column -> gint: Entry Text Column\n    The column in the combo box's model to associate with strings from the entry if the combo was created with #GtkComboBox:has-entry = %TRUE\n  popup-fixed-width -> gboolean: Popup Fixed Width\n    Whether the popup's width should be a fixed width matching the allocated width of the combo box\n  id-column -> gint: ID Column\n    The column in the combo box's model that provides string IDs for the values in the model\n  active-id -> gchararray: Active id\n    The value of the id column for the active row\n  cell-area -> GtkCellArea: Cell Area\n    The GtkCellArea used to layout cells\n\nSignals from GtkCellEditable:\n  editing-done ()\n  remove-widget ()\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-changed (GtkStateType)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  direction-changed (GtkTextDirection)\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroMediumSelection (94039159622384)>'
    __info__ = ObjectInfo(MediumSelection)


class MediumSelectionClass(__gi.Struct):
    """
    :Constructors:
    
    ::
    
        MediumSelectionClass()
    """
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    format_medium_string = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    medium_changed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MediumSelectionClass), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'MediumSelectionClass' objects>, '__weakref__': <attribute '__weakref__' of 'MediumSelectionClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2b5edd2130>, 'medium_changed': <property object at 0x7f2b5edd2220>, 'format_medium_string': <property object at 0x7f2b5edd2360>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(MediumSelectionClass)
...
class Volume(Medium):
    ...
    def get_mount_point(self): # real signature unknown; restored from __doc__
        """ get_mount_point(self) -> str """
        return ""
    ...
    def is_mounted(self): # real signature unknown; restored from __doc__
    ...
    def mount(self, parent_window, wait): # real signature unknown; restored from __doc__
        """ mount(self, parent_window:Gtk.Window, wait:bool) -> bool """
        return False
    ...
    def umount(self, wait): # real signature unknown; restored from __doc__
        """ umount(self, wait:bool) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2b5edc9bb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Volume), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType BraseroVolume (94039159410336)>, '__doc__': None, '__gsignals__': {}, 'cancel_current_operation': gi.FunctionInfo(cancel_current_operation), 'get_mount_point': gi.FunctionInfo(get_mount_point), 'get_name': gi.FunctionInfo(get_name), 'is_mounted': gi.FunctionInfo(is_mounted), 'mount': gi.FunctionInfo(mount), 'umount': gi.FunctionInfo(umount), 'parent_instance': <property object at 0x7f2b5edd24a0>})"
    __gdoc__ = 'Object BraseroVolume\n\nSignals from BraseroMedium:\n  probed ()\n\nProperties from BraseroMedium:\n  drive -> BraseroDrive: Drive\n    Drive in which medium is inserted\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroVolume (94039159410336)>'
    __info__ = ObjectInfo(Volume)


class VolumeClass(__gi.Struct):
    """
    :Constructors:
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(VolumeClass), '__module__': 'gi.repository.BraseroMedia', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'VolumeClass' objects>, '__weakref__': <attribute '__weakref__' of 'VolumeClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2b5edd2680>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(VolumeClass)
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7f2b602021f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7f2b60202280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7f2b60202310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7f2b602023a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7f2b60e3ed00>'

__path__ = [
    '/usr/lib64/girepository-1.0/BraseroMedia-3.1.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.BraseroMedia', loader=<gi.importer.DynamicImporter object at 0x7f2b60e3ed00>)"
