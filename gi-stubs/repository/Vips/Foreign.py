...
class Foreign(Operation):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Foreign), '__module__': 'gi.repository.Vips', '__gtype__': <GType VipsForeign (94317410484304)>, '__doc__': None, '__gsignals__': {}, 'find_load': gi.FunctionInfo(find_load), 'find_load_buffer': gi.FunctionInfo(find_load_buffer), 'find_save': gi.FunctionInfo(find_save), 'find_save_buffer': gi.FunctionInfo(find_save_buffer), 'get_suffixes': gi.FunctionInfo(get_suffixes), 'is_a': gi.FunctionInfo(is_a), 'is_a_buffer': gi.FunctionInfo(is_a_buffer), 'map': gi.FunctionInfo(map), 'parent_object': <property object at 0x7f41868db0e0>})"
    __gdoc__ = 'Object VipsForeign\n\nSignals from VipsOperation:\n  invalidate ()\n\nSignals from VipsObject:\n  postbuild () -> gint\n  preclose ()\n  close ()\n  postclose ()\n\nProperties from VipsObject:\n  nickname -> gchararray: Nickname\n    Class nickname\n  description -> gchararray: Description\n    Class description\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType VipsForeign (94317410484304)>'
    __info__ = ObjectInfo(Foreign)
