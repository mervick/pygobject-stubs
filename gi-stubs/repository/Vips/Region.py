...
class Region(Object):
    ...
    ::
        ...
        Region(**properties)
        new(image:Vips.Image) -> Vips.Region
    """
    ...
    def copy(self, dest, r, x, y): # real signature unknown; restored from __doc__
        """ copy(self, dest:Vips.Region, r:Vips.Rect, x:int, y:int) -> dest:Vips.Region """
        pass
    ...
    def equalsregion(self, reg2): # real signature unknown; restored from __doc__
        """ equalsregion(self, reg2:Vips.Region) -> int """
        return 0
    ...
    def new(self, image): # real signature unknown; restored from __doc__
        """ new(image:Vips.Image) -> Vips.Region """
        pass
    ...
    def region_black(self): # real signature unknown; restored from __doc__
        """ region_black(self) """
        pass

    def region_buffer(self, r): # real signature unknown; restored from __doc__
        """ region_buffer(self, r:Vips.Rect) -> int """
        return 0

    def region_fetch(self, left, top, width, height, len): # real signature unknown; restored from __doc__
        """ region_fetch(self, left:int, top:int, width:int, height:int, len:int) -> int """
        return 0

    def region_height(self): # real signature unknown; restored from __doc__
        """ region_height(self) -> int """
        return 0

    def region_image(self, r): # real signature unknown; restored from __doc__
        """ region_image(self, r:Vips.Rect) -> int """
        return 0

    def region_invalidate(self): # real signature unknown; restored from __doc__
        """ region_invalidate(self) """
        pass

    def region_paint(self, r, value): # real signature unknown; restored from __doc__
        """ region_paint(self, r:Vips.Rect, value:int) """
        pass

    def region_paint_pel(self, r, ink): # real signature unknown; restored from __doc__
        """ region_paint_pel(self, r:Vips.Rect, ink:int) """
        pass

    def region_position(self, x, y): # real signature unknown; restored from __doc__
        """ region_position(self, x:int, y:int) -> int """
        return 0

    def region_prepare(self, r): # real signature unknown; restored from __doc__
        """ region_prepare(self, r:Vips.Rect) -> int """
        return 0

    def region_prepare_to(self, dest, r, x, y): # real signature unknown; restored from __doc__
        """ region_prepare_to(self, dest:Vips.Region, r:Vips.Rect, x:int, y:int) -> int, dest:Vips.Region """
        return 0

    def region_region(self, dest, r, x, y): # real signature unknown; restored from __doc__
        """ region_region(self, dest:Vips.Region, r:Vips.Rect, x:int, y:int) -> int """
        return 0

    def region_width(self): # real signature unknown; restored from __doc__
        """ region_width(self) -> int """
        return 0
    ...
    def shrink_method(self, to, target, method): # real signature unknown; restored from __doc__
        """ shrink_method(self, to:Vips.Region, target:Vips.Rect, method:Vips.RegionShrink) -> int, to:Vips.Region """
        return 0
    ...
    bpl = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f41837ac3a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Region), '__module__': 'gi.repository.Vips', '__gtype__': <GType VipsRegion (94317410606592)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'copy': gi.FunctionInfo(copy), 'equalsregion': gi.FunctionInfo(equalsregion), 'region_black': gi.FunctionInfo(region_black), 'region_buffer': gi.FunctionInfo(region_buffer), 'region_fetch': gi.FunctionInfo(region_fetch), 'region_height': gi.FunctionInfo(region_height), 'region_image': gi.FunctionInfo(region_image), 'region_invalidate': gi.FunctionInfo(region_invalidate), 'region_paint': gi.FunctionInfo(region_paint), 'region_paint_pel': gi.FunctionInfo(region_paint_pel), 'region_position': gi.FunctionInfo(region_position), 'region_prepare': gi.FunctionInfo(region_prepare), 'region_prepare_to': gi.FunctionInfo(region_prepare_to), 'region_region': gi.FunctionInfo(region_region), 'region_width': gi.FunctionInfo(region_width), 'shrink_method': gi.FunctionInfo(shrink_method), 'parent_object': <property object at 0x7f41839a94a0>, 'im': <property object at 0x7f41839a9590>, 'valid': <property object at 0x7f41839a9680>, 'type': <property object at 0x7f41839a9770>, 'data': <property object at 0x7f41839a9860>, 'bpl': <property object at 0x7f41839a9950>, 'seq': <property object at 0x7f41839a9a40>, 'thread': <property object at 0x7f41839a9b30>, 'window': <property object at 0x7f41839a9c20>, 'buffer': <property object at 0x7f41839a9d10>, 'invalid': <property object at 0x7f41839a9e00>})"
    __gdoc__ = 'Object VipsRegion\n\nSignals from VipsObject:\n  postbuild () -> gint\n  preclose ()\n  close ()\n  postclose ()\n\nProperties from VipsObject:\n  nickname -> gchararray: Nickname\n    Class nickname\n  description -> gchararray: Description\n    Class description\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType VipsRegion (94317410606592)>'
    __info__ = ObjectInfo(Region)
