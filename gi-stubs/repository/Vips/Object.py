...
class Object(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4183986040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Object), '__module__': 'gi.repository.Vips', '__gtype__': <GType VipsObject (94317410483824)>, '__doc__': None, '__gsignals__': {}, 'install_argument': <classmethod object at 0x7f41868c9be0>, 'new_from_string': gi.FunctionInfo(new_from_string), 'get_property': gi.FunctionInfo(get_property), 'print_all': gi.FunctionInfo(print_all), 'print_summary_class': gi.FunctionInfo(print_summary_class), 'sanity_all': gi.FunctionInfo(sanity_all), 'set_property': gi.FunctionInfo(set_property), 'argument_isset': gi.FunctionInfo(argument_isset), 'argument_needsstring': gi.FunctionInfo(argument_needsstring), 'build': gi.FunctionInfo(build), 'get_argument_flags': gi.FunctionInfo(get_argument_flags), 'get_argument_priority': gi.FunctionInfo(get_argument_priority), 'get_argument_to_string': gi.FunctionInfo(get_argument_to_string), 'get_description': gi.FunctionInfo(get_description), 'local_cb': gi.FunctionInfo(local_cb), 'preclose': <property object at 0x7f41868d9720>, 'print_dump': gi.FunctionInfo(print_dump), 'print_name': gi.FunctionInfo(print_name), 'print_summary': gi.FunctionInfo(print_summary), 'rewind': gi.FunctionInfo(rewind), 'sanity': gi.FunctionInfo(sanity), 'set_argument_from_string': gi.FunctionInfo(set_argument_from_string), 'set_from_string': gi.FunctionInfo(set_from_string), 'set_required': gi.FunctionInfo(set_required), 'set_static': gi.FunctionInfo(set_static), 'unref_outputs': gi.FunctionInfo(unref_outputs), 'do_build': gi.VFuncInfo(build), 'do_close': gi.VFuncInfo(close), 'do_output_to_arg': gi.VFuncInfo(output_to_arg), 'do_postbuild': gi.VFuncInfo(postbuild), 'do_postclose': gi.VFuncInfo(postclose), 'do_preclose': gi.VFuncInfo(preclose), 'do_rewind': gi.VFuncInfo(rewind), 'parent_instance': <property object at 0x7f41868d9180>, 'constructed': <property object at 0x7f41868d9270>, 'static_object': <property object at 0x7f41868d9360>, 'argument_table': <property object at 0x7f41868d9450>, 'nickname': <property object at 0x7f41868d9540>, 'description': <property object at 0x7f41868d9630>, 'close': <property object at 0x7f41868d9810>, 'postclose': <property object at 0x7f41868d9900>, 'local_memory': <property object at 0x7f41868d99f0>})"
    __gdoc__ = 'Object VipsObject\n\nSignals from VipsObject:\n  postbuild () -> gint\n  preclose ()\n  close ()\n  postclose ()\n\nProperties from VipsObject:\n  nickname -> gchararray: Nickname\n    Class nickname\n  description -> gchararray: Description\n    Class description\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType VipsObject (94317410483824)>'
