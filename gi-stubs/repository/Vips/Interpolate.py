...
class Interpolate(Object):
    ...
    ::
        ...
        new(nickname:str) -> Vips.Interpolate
    """
    ...
    def bilinear_static(self): # real signature unknown; restored from __doc__
        """ bilinear_static() -> Vips.Interpolate """
        pass
    ...
    def do_get_window_offset(self, *args, **kwargs): # real signature unknown
        """ get_window_offset(self) -> int """
        pass

    def do_get_window_size(self, *args, **kwargs): # real signature unknown
        """ get_window_size(self) -> int """
        pass

    def do_interpolate(self, *args, **kwargs): # real signature unknown
        """ interpolate(self, out=None, in_:Vips.Region, x:float, y:float) """
        pass
    ...
    def get_window_offset(self): # real signature unknown; restored from __doc__
        """ get_window_offset(self) -> int """
        return 0

    def get_window_size(self): # real signature unknown; restored from __doc__
        """ get_window_size(self) -> int """
        return 0
    ...
    def nearest_static(self): # real signature unknown; restored from __doc__
        """ nearest_static() -> Vips.Interpolate """
        pass

    def new(self, nickname): # real signature unknown; restored from __doc__
        """ new(nickname:str) -> Vips.Interpolate """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f418691fdf0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Interpolate), '__module__': 'gi.repository.Vips', '__gtype__': <GType VipsInterpolate (94317410537024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'bilinear_static': gi.FunctionInfo(bilinear_static), 'nearest_static': gi.FunctionInfo(nearest_static), 'get_window_offset': gi.FunctionInfo(get_window_offset), 'get_window_size': gi.FunctionInfo(get_window_size), 'do_get_window_offset': gi.VFuncInfo(get_window_offset), 'do_get_window_size': gi.VFuncInfo(get_window_size), 'do_interpolate': gi.VFuncInfo(interpolate), 'parent_object': <property object at 0x7f41868ef040>})"
    __gdoc__ = 'Object VipsInterpolate\n\nSignals from VipsObject:\n  postbuild () -> gint\n  preclose ()\n  close ()\n  postclose ()\n\nProperties from VipsObject:\n  nickname -> gchararray: Nickname\n    Class nickname\n  description -> gchararray: Description\n    Class description\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType VipsInterpolate (94317410537024)>'
    __info__ = ObjectInfo(Interpolate)
