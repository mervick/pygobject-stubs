...
class ForeignSave(Foreign):
    """
    :Constructors:
    
    ::
    
        ForeignSave(**properties)
    """
    ...
    page_height = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    strip = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f41839b4130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ForeignSave), '__module__': 'gi.repository.Vips', '__gtype__': <GType VipsForeignSave (94317410503920)>, '__doc__': None, '__gsignals__': {}, 'parent_object': <property object at 0x7f41868e1950>, 'strip': <property object at 0x7f41868e1a40>, 'background': <property object at 0x7f41868e1b30>, 'page_height': <property object at 0x7f41868e1c20>, 'in_': <property object at 0x7f41868e1d10>, 'ready': <property object at 0x7f41868e1e00>})"
    __gdoc__ = 'Object VipsForeignSave\n\nProperties from VipsForeignSave:\n  in -> VipsImage: Input\n    Image to save\n  strip -> gboolean: Strip\n    Strip all metadata from image\n  background -> VipsArrayDouble: Background\n    Background value\n  page-height -> gint: Page height\n    Set page height for multipage save\n\nSignals from VipsOperation:\n  invalidate ()\n\nSignals from VipsObject:\n  postbuild () -> gint\n  preclose ()\n  close ()\n  postclose ()\n\nProperties from VipsObject:\n  nickname -> gchararray: Nickname\n    Class nickname\n  description -> gchararray: Description\n    Class description\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType VipsForeignSave (94317410503920)>'
    __info__ = ObjectInfo(ForeignSave)
