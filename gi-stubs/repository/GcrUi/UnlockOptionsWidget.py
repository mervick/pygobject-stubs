...
class UnlockOptionsWidget(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    
    ::
    
        UnlockOptionsWidget(**properties)
        new() -> GcrUi.UnlockOptionsWidget
    """
    ...
    def get_label(self, option): # real signature unknown; restored from __doc__
        """ get_label(self, option:str) -> str """
        return ""
    ...
    def get_sensitive(self, option): # real signature unknown; restored from __doc__
        """ get_sensitive(self, option:str) -> bool """
        return False
    ...
    def set_choice(self, option): # real signature unknown; restored from __doc__
        """ set_choice(self, option:str) """
        pass
    ...
    def set_label(self, option, text): # real signature unknown; restored from __doc__
        """ set_label(self, option:str, text:str) """
        pass
    ...
    def set_sensitive(self, option, sensitive, reason): # real signature unknown; restored from __doc__
        """ set_sensitive(self, option:str, sensitive:bool, reason:str) """
        pass
