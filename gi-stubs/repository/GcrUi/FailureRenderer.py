...
class FailureRenderer(__gi_overrides_GObject.Object, Renderer):
    """
    :Constructors:
    
    ::
    
        FailureRenderer(**properties)
        new(label:str=None, error:error) -> GcrUi.FailureRenderer
    """
    ...
    def new(self, label=None, error): # real signature unknown; restored from __doc__
        """ new(label:str=None, error:error) -> GcrUi.FailureRenderer """
        pass
    ...
    def new_unsupported(self, label): # real signature unknown; restored from __doc__
        """ new_unsupported(label:str) -> GcrUi.Renderer """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa329629f70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FailureRenderer), '__module__': 'gi.repository.GcrUi', '__gtype__': <GType GcrFailureRenderer (94715180978800)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_unsupported': gi.FunctionInfo(new_unsupported), 'parent': <property object at 0x7fa3298ef270>, 'pv': <property object at 0x7fa3298ef3b0>})"
    __gdoc__ = 'Object GcrFailureRenderer\n\nProperties from GcrFailureRenderer:\n  label -> gchararray: Label\n    Failure Label\n  attributes -> GckAttributes: Attributes\n    Renderer attributes\n\nSignals from GcrRenderer:\n  data-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GcrFailureRenderer (94715180978800)>'
    __info__ = ObjectInfo(FailureRenderer)
