...
class ViewerWidget(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        ViewerWidget(**properties)
        new() -> GcrUi.ViewerWidget
    """
    ...
    def clear_error(self): # real signature unknown; restored from __doc__
        """ clear_error(self) """
        pass
    ...
    def get_parser(self): # real signature unknown; restored from __doc__
        """ get_parser(self) -> Gcr.Parser """
        pass
    ...
    def get_viewer(self): # real signature unknown; restored from __doc__
        """ get_viewer(self) -> GcrUi.Viewer """
        pass
    ...
    def load_bytes(self, display_name=None, data): # real signature unknown; restored from __doc__
        """ load_bytes(self, display_name:str=None, data:GLib.Bytes) """
        pass

    def load_data(self, display_name=None, data): # real signature unknown; restored from __doc__
        """ load_data(self, display_name:str=None, data:list) """
        pass

    def load_file(self, file): # real signature unknown; restored from __doc__
        """ load_file(self, file:Gio.File) """
        pass
    ...
    def show_error(self, message, error=None): # real signature unknown; restored from __doc__
        """ show_error(self, message:str, error:error=None) """
        pass
