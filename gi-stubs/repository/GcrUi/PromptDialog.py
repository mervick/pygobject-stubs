...
class PromptDialog(__gi_overrides_Gtk.Dialog, __gi_repository_Gcr.Prompt):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa329908c10>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
