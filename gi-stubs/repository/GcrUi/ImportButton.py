...
class ImportButton(__gi_overrides_Gtk.Button):
    """
    :Constructors:
    
    ::
    
        ImportButton(**properties)
        new(label:str=None) -> GcrUi.ImportButton
    """
    ...
    def add_parsed(self, parsed): # real signature unknown; restored from __doc__
        """ add_parsed(self, parsed:Gcr.Parsed) """
        pass
    ...
    def do_imported(self, *args, **kwargs): # real signature unknown
        """ imported(self, importer:Gcr.Importer, error:error) """
        pass

    def do_importing(self, *args, **kwargs): # real signature unknown
        """ importing(self, importer:Gcr.Importer) """
        pass
    ...
    def new(self, label=None): # real signature unknown; restored from __doc__
        """ new(label:str=None) -> GcrUi.ImportButton """
        pass
