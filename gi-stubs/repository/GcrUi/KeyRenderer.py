...
class KeyRenderer(__gi_overrides_GObject.Object, Renderer):
    """
    :Constructors:
    
    ::
    
        KeyRenderer(**properties)
        new(label:str=None, attrs:Gck.Attributes=None) -> GcrUi.KeyRenderer
    """
    ...
    def new(self, label=None, attrs=None): # real signature unknown; restored from __doc__
        """ new(label:str=None, attrs:Gck.Attributes=None) -> GcrUi.KeyRenderer """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa3296295e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(KeyRenderer), '__module__': 'gi.repository.GcrUi', '__gtype__': <GType GcrKeyRenderer (94715181197104)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_attributes': gi.FunctionInfo(get_attributes), 'set_attributes': gi.FunctionInfo(set_attributes), 'parent': <property object at 0x7fa3298efea0>, 'pv': <property object at 0x7fa3298f3040>})"
    __gdoc__ = 'Object GcrKeyRenderer\n\nProperties from GcrKeyRenderer:\n  object -> GckObject: Object\n    Key Object\n\nSignals from GcrRenderer:\n  data-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GcrKeyRenderer (94715181197104)>'
    __info__ = ObjectInfo(KeyRenderer)
