...
class CertificateWidget(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    
    ::
    
        CertificateWidget(**properties)
        new(certificate:Gcr.Certificate=None) -> GcrUi.CertificateWidget
    """
    ...
    def get_certificate(self): # real signature unknown; restored from __doc__
        """ get_certificate(self) -> Gcr.Certificate or None """
        pass
    ...
    def new(self, certificate=None): # real signature unknown; restored from __doc__
        """ new(certificate:Gcr.Certificate=None) -> GcrUi.CertificateWidget """
        pass
