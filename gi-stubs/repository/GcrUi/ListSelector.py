...
class ListSelector(__gi_overrides_Gtk.TreeView):
    """
    :Constructors:
    
    ::
    
        ListSelector(**properties)
        new(collection:Gcr.Collection) -> GcrUi.ListSelector
    """
    ...
    def new(self, collection): # real signature unknown; restored from __doc__
        """ new(collection:Gcr.Collection) -> GcrUi.ListSelector """
        pass
    ...
    def set_selected(self, selected): # real signature unknown; restored from __doc__
        """ set_selected(self, selected:list) """
        pass
