...
class ComboSelector(__gi_overrides_Gtk.ComboBox):
    """
    :Constructors:
    
    ::
    
        ComboSelector(**properties)
        new(collection:Gcr.Collection) -> GcrUi.ComboSelector
    """
    ...
    def get_selected(self): # real signature unknown; restored from __doc__
        """ get_selected(self) -> GObject.Object """
        pass
    ...
    def set_selected(self, selected=None): # real signature unknown; restored from __doc__
        """ set_selected(self, selected:GObject.Object=None) """
        pass
