...
class KeyWidget(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    
    ::
    
        KeyWidget(**properties)
        new(attrs:Gck.Attributes=None) -> GcrUi.KeyWidget
    """
    ...
    def new(self, attrs=None): # real signature unknown; restored from __doc__
        """ new(attrs:Gck.Attributes=None) -> GcrUi.KeyWidget """
        pass
