...
class AbstractCollection(__gi_overrides_GObject.Object, Traversable, Iterable, Collection):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87c7beb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AbstractCollection), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeAbstractCollection (94716266408000)>, '__doc__': None, '__gsignals__': {}, 'contains': gi.FunctionInfo(contains), 'add': gi.FunctionInfo(add), 'remove': gi.FunctionInfo(remove), 'clear': gi.FunctionInfo(clear), 'iterator': gi.FunctionInfo(iterator), 'foreach': gi.FunctionInfo(foreach), 'get_size': gi.FunctionInfo(get_size), 'get_read_only': gi.FunctionInfo(get_read_only), 'get_read_only_view': gi.FunctionInfo(get_read_only_view), 'do_contains': gi.VFuncInfo(contains), 'do_add': gi.VFuncInfo(add), 'do_remove': gi.VFuncInfo(remove), 'do_clear': gi.VFuncInfo(clear), 'do_iterator': gi.VFuncInfo(iterator), 'do_foreach': gi.VFuncInfo(foreach), 'do_get_size': gi.VFuncInfo(get_size), 'do_get_read_only': gi.VFuncInfo(get_read_only), 'do_get_read_only_view': gi.VFuncInfo(get_read_only_view), 'parent_instance': <property object at 0x7f6a87c990e0>, 'priv': <property object at 0x7f6a87c99180>})"
    __gdoc__ = 'Object GeeAbstractCollection\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeAbstractCollection (94716266408000)>'
    __info__ = ObjectInfo(AbstractCollection)
