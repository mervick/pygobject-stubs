...
class AbstractBidirSortedMap(AbstractSortedMap, BidirSortedMap):
    """
    :Constructors:
    
    ::
    
        AbstractBidirSortedMap(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87af8490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AbstractBidirSortedMap), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeAbstractBidirSortedMap (94716266794624)>, '__doc__': None, '__gsignals__': {}, 'bidir_map_iterator': gi.FunctionInfo(bidir_map_iterator), 'get_read_only_view': gi.FunctionInfo(get_read_only_view), 'do_bidir_map_iterator': gi.VFuncInfo(bidir_map_iterator), 'do_get_read_only_view': gi.VFuncInfo(get_read_only_view), 'parent_instance': <property object at 0x7f6a87ca0f40>, 'priv': <property object at 0x7f6a87ca3040>})"
    __gdoc__ = 'Object GeeAbstractBidirSortedMap\n\nProperties from GeeAbstractBidirSortedMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeBidirSortedMap: read-only-view\n    read-only-view\n\nProperties from GeeAbstractSortedMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  ascending-keys -> GeeSortedSet: ascending-keys\n    ascending-keys\n  ascending-entries -> GeeSortedSet: ascending-entries\n    ascending-entries\n  read-only-view -> GeeSortedMap: read-only-view\n    read-only-view\n\nProperties from GeeAbstractMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  keys -> GeeSet: keys\n    keys\n  values -> GeeCollection: values\n    values\n  entries -> GeeSet: entries\n    entries\n  read-only-view -> GeeMap: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeAbstractBidirSortedMap (94716266794624)>'
    __info__ = ObjectInfo(AbstractBidirSortedMap)
