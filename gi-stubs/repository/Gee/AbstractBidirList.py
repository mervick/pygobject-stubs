...
class AbstractBidirList(AbstractList, BidirList):
    """
    :Constructors:
    
    ::
    
        AbstractBidirList(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87ce8b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AbstractBidirList), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeAbstractBidirList (94716266450144)>, '__doc__': None, '__gsignals__': {}, 'bidir_list_iterator': gi.FunctionInfo(bidir_list_iterator), 'get_read_only_view': gi.FunctionInfo(get_read_only_view), 'do_bidir_list_iterator': gi.VFuncInfo(bidir_list_iterator), 'do_get_read_only_view': gi.VFuncInfo(get_read_only_view), 'parent_instance': <property object at 0x7f6a87c996d0>, 'priv': <property object at 0x7f6a87c99770>})"
    __gdoc__ = 'Object GeeAbstractBidirList\n\nProperties from GeeAbstractBidirList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeBidirList: read-only-view\n    read-only-view\n\nProperties from GeeAbstractList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeList: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeAbstractBidirList (94716266450144)>'
    __info__ = ObjectInfo(AbstractBidirList)
