...
class ArrayList(AbstractBidirList):
    """
    :Constructors:
    ...
    ::
        ...
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.ArrayList
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87af8310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ArrayList), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeArrayList (94716266928624)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'wrap': gi.FunctionInfo(wrap), 'add_all': gi.FunctionInfo(add_all), 'get_equal_func': gi.FunctionInfo(get_equal_func), 'parent_instance': <property object at 0x7f6a87b3b770>, 'priv': <property object at 0x7f6a87b3b860>})"
    __gdoc__ = 'Object GeeArrayList\n\nProperties from GeeArrayList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n\nProperties from GeeAbstractBidirList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeBidirList: read-only-view\n    read-only-view\n\nProperties from GeeAbstractList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeList: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeArrayList (94716266928624)>'
    __info__ = ObjectInfo(ArrayList)
