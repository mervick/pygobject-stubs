...
class HashMap(AbstractMap):
    ...
    def new(self, k_type, k_dup_func, k_destroy_func, v_type, v_dup_func, v_destroy_func, key_hash_func=None, key_hash_func_target=None, key_equal_func=None, key_equal_func_target=None, value_equal_func=None, value_equal_func_target=None): # real signature unknown; restored from __doc__
        """ new(k_type:GType, k_dup_func:GObject.BoxedCopyFunc, k_destroy_func:GLib.DestroyNotify, v_type:GType, v_dup_func:GObject.BoxedCopyFunc, v_destroy_func:GLib.DestroyNotify, key_hash_func:Gee.HashDataFunc=None, key_hash_func_target=None, key_equal_func:Gee.EqualDataFunc=None, key_equal_func_target=None, value_equal_func:Gee.EqualDataFunc=None, value_equal_func_target=None) -> Gee.HashMap """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87af87f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HashMap), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeHashMap (94716266887248)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_key_hash_func': gi.FunctionInfo(get_key_hash_func), 'get_key_equal_func': gi.FunctionInfo(get_key_equal_func), 'get_value_equal_func': gi.FunctionInfo(get_value_equal_func), 'parent_instance': <property object at 0x7f6a87b49e00>, 'priv': <property object at 0x7f6a87b49ef0>})"
    __gdoc__ = 'Object GeeHashMap\n\nProperties from GeeHashMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  keys -> GeeSet: keys\n    keys\n  values -> GeeCollection: values\n    values\n  entries -> GeeSet: entries\n    entries\n\nProperties from GeeAbstractMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  keys -> GeeSet: keys\n    keys\n  values -> GeeCollection: values\n    values\n  entries -> GeeSet: entries\n    entries\n  read-only-view -> GeeMap: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeHashMap (94716266887248)>'
    __info__ = ObjectInfo(HashMap)
