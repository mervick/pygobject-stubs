...
class PriorityQueue(AbstractQueue):
    ...
    ::
        ...
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, compare_func:GLib.CompareDataFunc=None, compare_func_target=None) -> Gee.PriorityQueue
    """
    ...
    def do_get_capacity(self, *args, **kwargs): # real signature unknown
        """ get_capacity(self) -> int """
        pass

    def do_get_is_full(self, *args, **kwargs): # real signature unknown
    ...
    def do_get_remaining_capacity(self, *args, **kwargs): # real signature unknown
    ...
    def do_peek(self, *args, **kwargs): # real signature unknown
        """ peek(self) """
        pass
    ...
    def get_compare_func(self): # real signature unknown; restored from __doc__
        """ get_compare_func(self) -> GLib.CompareDataFunc, result_target """
        pass
    ...
    def new(self, g_type, g_dup_func, g_destroy_func, compare_func=None, compare_func_target=None): # real signature unknown; restored from __doc__
        """ new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, compare_func:GLib.CompareDataFunc=None, compare_func_target=None) -> Gee.PriorityQueue """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87975d30>'
    UNBOUNDED_CAPACITY = -1
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PriorityQueue), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeePriorityQueue (94716267083264)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'offer': gi.FunctionInfo(offer), 'drain': gi.FunctionInfo(drain), 'get_compare_func': gi.FunctionInfo(get_compare_func), 'parent_instance': <property object at 0x7f6a87b5d360>, 'priv': <property object at 0x7f6a87b5d450>})"
    __gdoc__ = 'Object GeePriorityQueue\n\nProperties from GeePriorityQueue:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  capacity -> gint: capacity\n    capacity\n  remaining-capacity -> gint: remaining-capacity\n    remaining-capacity\n  is-full -> gboolean: is-full\n    is-full\n  read-only -> gboolean: read-only\n    read-only\n  size -> gint: size\n    size\n\nProperties from GeeAbstractQueue:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  capacity -> gint: capacity\n    capacity\n  remaining-capacity -> gint: remaining-capacity\n    remaining-capacity\n  is-full -> gboolean: is-full\n    is-full\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeePriorityQueue (94716267083264)>'
    __info__ = ObjectInfo(PriorityQueue)
