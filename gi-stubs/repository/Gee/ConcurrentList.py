...
class ConcurrentList(AbstractList):
    """
    :Constructors:
    
    ::
    
        ConcurrentList(**properties)
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.ConcurrentList
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87acbeb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ConcurrentList), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeConcurrentList (94716266977200)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_equal_func': gi.FunctionInfo(get_equal_func), 'get_is_empty': gi.FunctionInfo(get_is_empty), 'parent_instance': <property object at 0x7f6a87b45680>, 'priv': <property object at 0x7f6a87b45770>})"
    __gdoc__ = 'Object GeeConcurrentList\n\nProperties from GeeConcurrentList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only -> gboolean: read-only\n    read-only\n  size -> gint: size\n    size\n  is-empty -> gboolean: is-empty\n    is-empty\n\nProperties from GeeAbstractList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeList: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeConcurrentList (94716266977200)>'
    __info__ = ObjectInfo(ConcurrentList)
