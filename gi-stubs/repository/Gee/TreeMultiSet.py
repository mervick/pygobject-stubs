...
class TreeMultiSet(AbstractMultiSet):
    """
    :Constructors:
    
    ::
    
        TreeMultiSet(**properties)
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, compare_func:GLib.CompareDataFunc=None, compare_func_target=None) -> Gee.TreeMultiSet
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87975430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TreeMultiSet), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeTreeMultiSet (94716267119408)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_compare_func': gi.FunctionInfo(get_compare_func), 'parent_instance': <property object at 0x7f6a87b64ae0>, 'priv': <property object at 0x7f6a87b64c20>})"
    __gdoc__ = 'Object GeeTreeMultiSet\n\nProperties from GeeTreeMultiSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n\nProperties from GeeAbstractMultiSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeTreeMultiSet (94716267119408)>'
    __info__ = ObjectInfo(TreeMultiSet)
