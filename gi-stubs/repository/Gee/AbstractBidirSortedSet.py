...
class AbstractBidirSortedSet(AbstractSortedSet, BidirSortedSet):
    """
    :Constructors:
    
    ::
    
        AbstractBidirSortedSet(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87c919d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AbstractBidirSortedSet), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeAbstractBidirSortedSet (94716266699552)>, '__doc__': None, '__gsignals__': {}, 'bidir_iterator': gi.FunctionInfo(bidir_iterator), 'get_read_only_view': gi.FunctionInfo(get_read_only_view), 'do_bidir_iterator': gi.VFuncInfo(bidir_iterator), 'do_get_read_only_view': gi.VFuncInfo(get_read_only_view), 'parent_instance': <property object at 0x7f6a87ca56d0>, 'priv': <property object at 0x7f6a87ca5770>})"
    __gdoc__ = 'Object GeeAbstractBidirSortedSet\n\nProperties from GeeAbstractBidirSortedSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeBidirSortedSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractSortedSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeSortedSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeAbstractBidirSortedSet (94716266699552)>'
    __info__ = ObjectInfo(AbstractBidirSortedSet)
