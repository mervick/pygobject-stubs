...
class TreeSet(AbstractBidirSortedSet):
    """
    :Constructors:
    ...
    ::
        ...
        TreeSet(**properties)
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, compare_func:GLib.CompareDataFunc=None, compare_func_target=None) -> Gee.TreeSet
    """
    ...
    def do_bidir_iterator(self, *args, **kwargs): # real signature unknown
        """ bidir_iterator(self) -> Gee.BidirIterator """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87acb5e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TreeSet), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeTreeSet (94716267127504)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_compare_func': gi.FunctionInfo(get_compare_func), 'parent_instance': <property object at 0x7f6a87b67130>, 'priv': <property object at 0x7f6a87b67220>})"
    __gdoc__ = 'Object GeeTreeSet\n\nProperties from GeeTreeSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n\nProperties from GeeAbstractBidirSortedSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeBidirSortedSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractSortedSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeSortedSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeTreeSet (94716267127504)>'
    __info__ = ObjectInfo(TreeSet)
