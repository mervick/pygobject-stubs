...
class AbstractQueue(AbstractCollection, Queue):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87c725b0>'
    UNBOUNDED_CAPACITY = -1
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AbstractQueue), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeAbstractQueue (94716266900832)>, '__doc__': None, '__gsignals__': {}, 'peek': gi.FunctionInfo(peek), 'poll': gi.FunctionInfo(poll), 'get_capacity': gi.FunctionInfo(get_capacity), 'get_remaining_capacity': gi.FunctionInfo(get_remaining_capacity), 'get_is_full': gi.FunctionInfo(get_is_full), 'do_peek': gi.VFuncInfo(peek), 'do_poll': gi.VFuncInfo(poll), 'do_get_capacity': gi.VFuncInfo(get_capacity), 'do_get_remaining_capacity': gi.VFuncInfo(get_remaining_capacity), 'do_get_is_full': gi.VFuncInfo(get_is_full), 'parent_instance': <property object at 0x7f6a87b34400>, 'priv': <property object at 0x7f6a87b34540>})"
    __gdoc__ = 'Object GeeAbstractQueue\n\nProperties from GeeAbstractQueue:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  capacity -> gint: capacity\n    capacity\n  remaining-capacity -> gint: remaining-capacity\n    remaining-capacity\n  is-full -> gboolean: is-full\n    is-full\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeAbstractQueue (94716266900832)>'
    __info__ = ObjectInfo(AbstractQueue)
