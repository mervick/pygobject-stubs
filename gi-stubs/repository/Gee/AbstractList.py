...
class AbstractList(AbstractCollection, List):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87ce8f40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AbstractList), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeAbstractList (94716266394640)>, '__doc__': None, '__gsignals__': {}, 'list_iterator': gi.FunctionInfo(list_iterator), 'get': gi.FunctionInfo(get), 'set': gi.FunctionInfo(set), 'index_of': gi.FunctionInfo(index_of), 'insert': gi.FunctionInfo(insert), 'remove_at': gi.FunctionInfo(remove_at), 'slice': gi.FunctionInfo(slice), 'get_read_only_view': gi.FunctionInfo(get_read_only_view), 'do_list_iterator': gi.VFuncInfo(list_iterator), 'do_get': gi.VFuncInfo(get), 'do_set': gi.VFuncInfo(set), 'do_index_of': gi.VFuncInfo(index_of), 'do_insert': gi.VFuncInfo(insert), 'do_remove_at': gi.VFuncInfo(remove_at), 'do_slice': gi.VFuncInfo(slice), 'do_get_read_only_view': gi.VFuncInfo(get_read_only_view), 'parent_instance': <property object at 0x7f6a87c993b0>, 'priv': <property object at 0x7f6a87c99360>})"
    __gdoc__ = 'Object GeeAbstractList\n\nProperties from GeeAbstractList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeList: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeAbstractList (94716266394640)>'
    __info__ = ObjectInfo(AbstractList)
