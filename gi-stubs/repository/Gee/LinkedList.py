...
class LinkedList(AbstractBidirList, Queue, Deque):
    """
    :Constructors:
    ...
    ::
        ...
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.LinkedList
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a879bf6a0>'
    UNBOUNDED_CAPACITY = -1
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LinkedList), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeLinkedList (94716267052656)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'first': gi.FunctionInfo(first), 'last': gi.FunctionInfo(last), 'get_equal_func': gi.FunctionInfo(get_equal_func), 'parent_instance': <property object at 0x7f6a87b533b0>, 'priv': <property object at 0x7f6a87b534f0>})"
    __gdoc__ = 'Object GeeLinkedList\n\nProperties from GeeLinkedList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  capacity -> gint: capacity\n    capacity\n  remaining-capacity -> gint: remaining-capacity\n    remaining-capacity\n  is-full -> gboolean: is-full\n    is-full\n\nProperties from GeeAbstractBidirList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeBidirList: read-only-view\n    read-only-view\n\nProperties from GeeAbstractList:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeList: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeLinkedList (94716267052656)>'
    __info__ = ObjectInfo(LinkedList)
