...
class ArrayQueue(AbstractQueue, Deque):
    """
    :Constructors:
    
    ::
    
        ArrayQueue(**properties)
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.ArrayQueue
    """
    ...
    def new(self, g_type, g_dup_func, g_destroy_func, equal_func=None, equal_func_target=None): # real signature unknown; restored from __doc__
        """ new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.ArrayQueue """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87acb0d0>'
    UNBOUNDED_CAPACITY = -1
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ArrayQueue), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeArrayQueue (94716266123776)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_equal_func': gi.FunctionInfo(get_equal_func), 'get_is_empty': gi.FunctionInfo(get_is_empty), 'parent_instance': <property object at 0x7f6a87b3bd60>, 'priv': <property object at 0x7f6a87b3be50>})"
    __gdoc__ = 'Object GeeArrayQueue\n\nProperties from GeeArrayQueue:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  is-empty -> gboolean: is-empty\n    is-empty\n  read-only -> gboolean: read-only\n    read-only\n  capacity -> gint: capacity\n    capacity\n  remaining-capacity -> gint: remaining-capacity\n    remaining-capacity\n  is-full -> gboolean: is-full\n    is-full\n\nProperties from GeeAbstractQueue:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  capacity -> gint: capacity\n    capacity\n  remaining-capacity -> gint: remaining-capacity\n    remaining-capacity\n  is-full -> gboolean: is-full\n    is-full\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeArrayQueue (94716266123776)>'
    __info__ = ObjectInfo(ArrayQueue)
