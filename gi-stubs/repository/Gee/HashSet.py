...
class HashSet(AbstractSet):
    ...
    ::
        ...
        HashSet(**properties)
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, hash_func:Gee.HashDataFunc=None, hash_func_target=None, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.HashSet
    """
    ...
    def do_get_read_only_view(self, *args, **kwargs): # real signature unknown
        """ get_read_only_view(self) -> Gee.Set """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a879bfd60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HashSet), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeHashSet (94716267016192)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_hash_func': gi.FunctionInfo(get_hash_func), 'get_equal_func': gi.FunctionInfo(get_equal_func), 'parent_instance': <property object at 0x7f6a87b4af40>, 'priv': <property object at 0x7f6a87b4e090>})"
    __gdoc__ = 'Object GeeHashSet\n\nProperties from GeeHashSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n\nProperties from GeeAbstractSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeHashSet (94716267016192)>'
    __info__ = ObjectInfo(HashSet)
