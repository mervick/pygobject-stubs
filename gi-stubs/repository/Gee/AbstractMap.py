...
class AbstractMap(__gi_overrides_GObject.Object, Traversable, Iterable, Map):
    """
    :Constructors:
    
    ::
    
        AbstractMap(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a87c91670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AbstractMap), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeAbstractMap (94716266636224)>, '__doc__': None, '__gsignals__': {}, 'has_key': gi.FunctionInfo(has_key), 'has': gi.FunctionInfo(has), 'get': gi.FunctionInfo(get), 'set': gi.FunctionInfo(set), 'unset': gi.FunctionInfo(unset), 'map_iterator': gi.FunctionInfo(map_iterator), 'clear': gi.FunctionInfo(clear), 'foreach': gi.FunctionInfo(foreach), 'stream': gi.FunctionInfo(stream), 'get_size': gi.FunctionInfo(get_size), 'get_read_only': gi.FunctionInfo(get_read_only), 'get_keys': gi.FunctionInfo(get_keys), 'get_values': gi.FunctionInfo(get_values), 'get_entries': gi.FunctionInfo(get_entries), 'get_read_only_view': gi.FunctionInfo(get_read_only_view), 'do_has_key': gi.VFuncInfo(has_key), 'do_has': gi.VFuncInfo(has), 'do_get': gi.VFuncInfo(get), 'do_set': gi.VFuncInfo(set), 'do_unset': gi.VFuncInfo(unset), 'do_map_iterator': gi.VFuncInfo(map_iterator), 'do_clear': gi.VFuncInfo(clear), 'do_foreach': gi.VFuncInfo(foreach), 'do_stream': gi.VFuncInfo(stream), 'do_get_size': gi.VFuncInfo(get_size), 'do_get_read_only': gi.VFuncInfo(get_read_only), 'do_get_keys': gi.VFuncInfo(get_keys), 'do_get_values': gi.VFuncInfo(get_values), 'do_get_entries': gi.VFuncInfo(get_entries), 'do_get_read_only_view': gi.VFuncInfo(get_read_only_view), 'parent_instance': <property object at 0x7f6a87ca0720>, 'priv': <property object at 0x7f6a87ca07c0>})"
    __gdoc__ = 'Object GeeAbstractMap\n\nProperties from GeeAbstractMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  keys -> GeeSet: keys\n    keys\n  values -> GeeCollection: values\n    values\n  entries -> GeeSet: entries\n    entries\n  read-only-view -> GeeMap: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeAbstractMap (94716266636224)>'
    __info__ = ObjectInfo(AbstractMap)
