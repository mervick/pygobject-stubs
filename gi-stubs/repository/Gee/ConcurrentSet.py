...
class ConcurrentSet(AbstractSortedSet):
    """
    :Constructors:
    
    ::
    
        ConcurrentSet(**properties)
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, compare_func:GLib.CompareDataFunc=None, compare_func_target=None) -> Gee.ConcurrentSet
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a879bf1c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ConcurrentSet), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeConcurrentSet (94716266980336)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f6a87b45b80>, 'priv': <property object at 0x7f6a87b45cc0>})"
    __gdoc__ = 'Object GeeConcurrentSet\n\nProperties from GeeConcurrentSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n\nProperties from GeeAbstractSortedSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeSortedSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeSet: read-only-view\n    read-only-view\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeConcurrentSet (94716266980336)>'
    __info__ = ObjectInfo(ConcurrentSet)
