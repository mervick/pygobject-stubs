...
class TreeMap(AbstractBidirSortedMap):
    """
    :Constructors:
    ...
    ::
        ...
        TreeMap(**properties)
        new(k_type:GType, k_dup_func:GObject.BoxedCopyFunc, k_destroy_func:GLib.DestroyNotify, v_type:GType, v_dup_func:GObject.BoxedCopyFunc, v_destroy_func:GLib.DestroyNotify, key_compare_func:GLib.CompareDataFunc=None, key_compare_func_target=None, value_equal_func:Gee.EqualDataFunc=None, value_equal_func_target=None) -> Gee.TreeMap
    """
    ...
    def bidir_map_iterator(self): # real signature unknown; restored from __doc__
        """ bidir_map_iterator(self) -> Gee.BidirMapIterator """
        pass
    ...
    def do_bidir_map_iterator(self, *args, **kwargs): # real signature unknown
        """ bidir_map_iterator(self) -> Gee.BidirMapIterator """
        pass
    ...
    def do_get_read_only_view(self, *args, **kwargs): # real signature unknown
        """ get_read_only_view(self) -> Gee.BidirSortedMap """
        pass
    ...
    def new(self, k_type, k_dup_func, k_destroy_func, v_type, v_dup_func, v_destroy_func, key_compare_func=None, key_compare_func_target=None, value_equal_func=None, value_equal_func_target=None): # real signature unknown; restored from __doc__
        """ new(k_type:GType, k_dup_func:GObject.BoxedCopyFunc, k_destroy_func:GLib.DestroyNotify, v_type:GType, v_dup_func:GObject.BoxedCopyFunc, v_destroy_func:GLib.DestroyNotify, key_compare_func:GLib.CompareDataFunc=None, key_compare_func_target=None, value_equal_func:Gee.EqualDataFunc=None, value_equal_func_target=None) -> Gee.TreeMap """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a878cf640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TreeMap), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeTreeMap (94716267115104)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_key_compare_func': gi.FunctionInfo(get_key_compare_func), 'get_value_equal_func': gi.FunctionInfo(get_value_equal_func), 'parent_instance': <property object at 0x7f6a87b640e0>, 'priv': <property object at 0x7f6a87b641d0>})"
    __gdoc__ = 'Object GeeTreeMap\n\nProperties from GeeTreeMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  keys -> GeeSet: keys\n    keys\n  values -> GeeCollection: values\n    values\n  entries -> GeeSet: entries\n    entries\n  ascending-keys -> GeeSortedSet: ascending-keys\n    ascending-keys\n  ascending-entries -> GeeSortedSet: ascending-entries\n    ascending-entries\n\nProperties from GeeAbstractBidirSortedMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  read-only-view -> GeeBidirSortedMap: read-only-view\n    read-only-view\n\nProperties from GeeAbstractSortedMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  ascending-keys -> GeeSortedSet: ascending-keys\n    ascending-keys\n  ascending-entries -> GeeSortedSet: ascending-entries\n    ascending-entries\n  read-only-view -> GeeSortedMap: read-only-view\n    read-only-view\n\nProperties from GeeAbstractMap:\n  k-type -> GType: type\n    type\n  k-dup-func -> gpointer: dup func\n    dup func\n  k-destroy-func -> gpointer: destroy func\n    destroy func\n  v-type -> GType: type\n    type\n  v-dup-func -> gpointer: dup func\n    dup func\n  v-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  keys -> GeeSet: keys\n    keys\n  values -> GeeCollection: values\n    values\n  entries -> GeeSet: entries\n    entries\n  read-only-view -> GeeMap: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeTreeMap (94716267115104)>'
    __info__ = ObjectInfo(TreeMap)
