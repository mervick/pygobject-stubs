...
class HashMultiSet(AbstractMultiSet):
    ...
    ::
        ...
        HashMultiSet(**properties)
        new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, hash_func:Gee.HashDataFunc=None, hash_func_target=None, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.HashMultiSet
        broken(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, hash_func:Gee.HashDataFunc=None, hash_func_target=None, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.HashMultiSet
    """
    ...
    def broken(self, g_type, g_dup_func, g_destroy_func, hash_func=None, hash_func_target=None, equal_func=None, equal_func_target=None): # real signature unknown; restored from __doc__
        """ broken(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, hash_func:Gee.HashDataFunc=None, hash_func_target=None, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.HashMultiSet """
        pass
    ...
    def count(self, item=None): # real signature unknown; restored from __doc__
        """ count(self, item=None) -> int """
        return 0
    ...
    def do_get_read_only_view(self, *args, **kwargs): # real signature unknown
        """ get_read_only_view(self) -> Gee.MultiSet """
        pass
    ...
    def get_hash_func(self): # real signature unknown; restored from __doc__
        """ get_hash_func(self) -> Gee.HashDataFunc, result_target """
        pass
    ...
    def new(self, g_type, g_dup_func, g_destroy_func, hash_func=None, hash_func_target=None, equal_func=None, equal_func_target=None): # real signature unknown; restored from __doc__
        """ new(g_type:GType, g_dup_func:GObject.BoxedCopyFunc, g_destroy_func:GLib.DestroyNotify, hash_func:Gee.HashDataFunc=None, hash_func_target=None, equal_func:Gee.EqualDataFunc=None, equal_func_target=None) -> Gee.HashMultiSet """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6a879bf8b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HashMultiSet), '__module__': 'gi.repository.Gee', '__gtype__': <GType GeeHashMultiSet (94716267012464)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'broken': gi.FunctionInfo(broken), 'get_hash_func': gi.FunctionInfo(get_hash_func), 'get_equal_func': gi.FunctionInfo(get_equal_func), 'parent_instance': <property object at 0x7f6a87b4a9f0>, 'priv': <property object at 0x7f6a87b4aae0>})"
    __gdoc__ = 'Object GeeHashMultiSet\n\nProperties from GeeHashMultiSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n\nProperties from GeeAbstractMultiSet:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n\nProperties from GeeAbstractCollection:\n  g-type -> GType: type\n    type\n  g-dup-func -> gpointer: dup func\n    dup func\n  g-destroy-func -> gpointer: destroy func\n    destroy func\n  size -> gint: size\n    size\n  read-only -> gboolean: read-only\n    read-only\n  read-only-view -> GeeCollection: read-only-view\n    read-only-view\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeeHashMultiSet (94716267012464)>'
    __info__ = ObjectInfo(HashMultiSet)
