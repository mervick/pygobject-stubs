...
class ClientView(__gi_overrides_GObject.Object, __gi_repository_Gio.Initable):
    """
    :Constructors:
    ...
    def set_fields_of_interest(self, fields_of_interest=None): # real signature unknown; restored from __doc__
        """ set_fields_of_interest(self, fields_of_interest:list=None) """
        pass

    def set_flags(self, flags): # real signature unknown; restored from __doc__
        """ set_flags(self, flags:ECal.ClientViewFlags) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fe5ccddad90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ClientView), '__module__': 'gi.repository.ECal', '__gtype__': <GType ECalClientView (94764814815008)>, '__doc__': None, '__gsignals__': {}, 'get_connection': gi.FunctionInfo(get_connection), 'get_object_path': gi.FunctionInfo(get_object_path), 'is_running': gi.FunctionInfo(is_running), 'ref_client': gi.FunctionInfo(ref_client), 'set_fields_of_interest': gi.FunctionInfo(set_fields_of_interest), 'set_flags': gi.FunctionInfo(set_flags), 'start': gi.FunctionInfo(start), 'stop': gi.FunctionInfo(stop), 'do_complete': gi.VFuncInfo(complete), 'do_progress': gi.VFuncInfo(progress), 'object': <property object at 0x7fe5cce0a360>, 'priv': <property object at 0x7fe5cce0a450>})"
    __gdoc__ = 'Object ECalClientView\n\nSignals from ECalClientView:\n  objects-added (gpointer)\n  objects-modified (gpointer)\n  objects-removed (gpointer)\n  progress (guint, gchararray)\n  complete (GError)\n\nProperties from ECalClientView:\n  client -> ECalClient: Client\n    The ECalClient for the view\n  connection -> GDBusConnection: Connection\n    The GDBusConnection used to create the D-Bus proxy\n  object-path -> gchararray: Object Path\n    The object path used to create the D-Bus proxy\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ECalClientView (94764814815008)>'
    __info__ = ObjectInfo(ClientView)
