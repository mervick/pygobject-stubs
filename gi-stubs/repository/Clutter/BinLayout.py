...
class BinLayout(LayoutManager):
    ...
    ::
        ...
        new(x_align:Clutter.BinAlignment, y_align:Clutter.BinAlignment) -> Clutter.LayoutManager
    """
    def add(self, child, x_align, y_align): # real signature unknown; restored from __doc__
        """ add(self, child:Clutter.Actor, x_align:Clutter.BinAlignment, y_align:Clutter.BinAlignment) """
        pass
    ...
    def get_alignment(self, child=None): # real signature unknown; restored from __doc__
        """ get_alignment(self, child:Clutter.Actor=None) -> x_align:Clutter.BinAlignment, y_align:Clutter.BinAlignment """
        pass
    ...
    def new(self, x_align, y_align): # real signature unknown; restored from __doc__
        """ new(x_align:Clutter.BinAlignment, y_align:Clutter.BinAlignment) -> Clutter.LayoutManager """
        pass
    ...
    def set_alignment(self, child=None, x_align, y_align): # real signature unknown; restored from __doc__
        """ set_alignment(self, child:Clutter.Actor=None, x_align:Clutter.BinAlignment, y_align:Clutter.BinAlignment) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f54134f1790>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BinLayout), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterBinLayout (94911696001152)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add': gi.FunctionInfo(add), 'get_alignment': gi.FunctionInfo(get_alignment), 'set_alignment': gi.FunctionInfo(set_alignment), 'parent_instance': <property object at 0x7f5413db34a0>, 'priv': <property object at 0x7f5413db3590>})"
    __gdoc__ = 'Object ClutterBinLayout\n\nProperties from ClutterBinLayout:\n  x-align -> ClutterBinAlignment: Horizontal Alignment\n    Default horizontal alignment for the actors inside the layout manager\n  y-align -> ClutterBinAlignment: Vertical Alignment\n    Default vertical alignment for the actors inside the layout manager\n\nSignals from ClutterLayoutManager:\n  layout-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterBinLayout (94911696001152)>'
    __info__ = ObjectInfo(BinLayout)
