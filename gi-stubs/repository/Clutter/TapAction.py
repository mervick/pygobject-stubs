...
class TapAction(GestureAction):
    ...
    def do_tap(self, *args, **kwargs): # real signature unknown
        """ tap(self, actor:Clutter.Actor) -> bool """
        pass
