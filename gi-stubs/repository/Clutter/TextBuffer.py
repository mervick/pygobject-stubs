...
class TextBuffer(__gi_overrides_GObject.Object):
    ...
    ::
        ...
        new() -> Clutter.TextBuffer
        new_with_text(text:str=None, text_len:int) -> Clutter.TextBuffer
    """
    ...
    def new_with_text(self, text=None, text_len): # real signature unknown; restored from __doc__
        """ new_with_text(text:str=None, text_len:int) -> Clutter.TextBuffer """
        pass
