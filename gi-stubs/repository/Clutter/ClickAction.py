...
class ClickAction(Action):
    ...
    def do_clicked(self, *args, **kwargs): # real signature unknown
        """ clicked(self, actor:Clutter.Actor) """
        pass

    def do_long_press(self, *args, **kwargs): # real signature unknown
        """ long_press(self, actor:Clutter.Actor, state:Clutter.LongPressState) -> bool """
        pass
    ...
    def get_coords(self): # real signature unknown; restored from __doc__
        """ get_coords(self) -> press_x:float, press_y:float """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f54133041f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ClickAction), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterClickAction (94911696060256)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_button': gi.FunctionInfo(get_button), 'get_coords': gi.FunctionInfo(get_coords), 'get_state': gi.FunctionInfo(get_state), 'release': gi.FunctionInfo(release), 'do_clicked': gi.VFuncInfo(clicked), 'do_long_press': gi.VFuncInfo(long_press), 'parent_instance': <property object at 0x7f5413dc2bd0>, 'priv': <property object at 0x7f5413dc2cc0>})"
    __gdoc__ = 'Object ClutterClickAction\n\nSignals from ClutterClickAction:\n  clicked (ClutterActor)\n  long-press (ClutterActor, ClutterLongPressState) -> gboolean\n\nProperties from ClutterClickAction:\n  held -> gboolean: Held\n    Whether the clickable has a grab\n  pressed -> gboolean: Pressed\n    Whether the clickable should be in pressed state\n  long-press-threshold -> gint: Long Press Threshold\n    The maximum threshold before a long press is cancelled\n  long-press-duration -> gint: Long Press Duration\n    The minimum duration of a long press to recognize the gesture\n\nProperties from ClutterActorMeta:\n  actor -> ClutterActor: Actor\n    The actor attached to the meta\n  name -> gchararray: Name\n    The name of the meta\n  enabled -> gboolean: Enabled\n    Whether the meta is enabled\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterClickAction (94911696060256)>'
    __info__ = ObjectInfo(ClickAction)
