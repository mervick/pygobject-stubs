...
class FixedLayout(LayoutManager):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FixedLayout), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterFixedLayout (94911696143936)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f5413cb1a90>})"
    __gdoc__ = 'Object ClutterFixedLayout\n\nSignals from ClutterLayoutManager:\n  layout-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterFixedLayout (94911696143936)>'
    __info__ = ObjectInfo(FixedLayout)
