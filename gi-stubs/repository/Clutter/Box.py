...
class Box(Actor):
    ...
    ::
        ...
        Box(**properties)
        new(manager:Clutter.LayoutManager) -> Clutter.Actor
    """
    ...
    def new(self, manager): # real signature unknown; restored from __doc__
        """ new(manager:Clutter.LayoutManager) -> Clutter.Actor """
        pass
    ...
    def packv(self, actor, properties, values): # real signature unknown; restored from __doc__
        """ packv(self, actor:Clutter.Actor, properties:list, values:list) """
        pass
    ...
    def set_layout_manager(self, manager): # real signature unknown; restored from __doc__
        """ set_layout_manager(self, manager:Clutter.LayoutManager) """
        pass
