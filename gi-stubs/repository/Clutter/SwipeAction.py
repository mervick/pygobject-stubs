...
class SwipeAction(GestureAction):
    ...
    def do_swept(self, *args, **kwargs): # real signature unknown
        """ swept(self, actor:Clutter.Actor, direction:Clutter.SwipeDirection) """
        pass

    def do_swipe(self, *args, **kwargs): # real signature unknown
        """ swipe(self, actor:Clutter.Actor, direction:Clutter.SwipeDirection) -> bool """
        pass
