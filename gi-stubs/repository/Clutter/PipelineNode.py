...
class PipelineNode(PaintNode):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PipelineNode), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterPipelineNode (94911694350480)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterPipelineNode (94911694350480)>'
    __info__ = ObjectInfo(PipelineNode)
