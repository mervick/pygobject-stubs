...
class Action(ActorMeta):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f54134f1c10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Action), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterAction (94911695357664)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x7f5413c94ea0>})"
    __gdoc__ = 'Object ClutterAction\n\nProperties from ClutterActorMeta:\n  actor -> ClutterActor: Actor\n    The actor attached to the meta\n  name -> gchararray: Name\n    The name of the meta\n  enabled -> gboolean: Enabled\n    Whether the meta is enabled\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterAction (94911695357664)>'
