...
class ColorNode(PipelineNode):
    ...
    ::
        ...
        new(color:Clutter.Color=None) -> Clutter.PaintNode
    """
    ...
    def new(self, color=None): # real signature unknown; restored from __doc__
        """ new(color:Clutter.Color=None) -> Clutter.PaintNode """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorNode), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterColorNode (94911694350720)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterColorNode (94911694350720)>'
    __info__ = ObjectInfo(ColorNode)
