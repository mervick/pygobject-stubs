...
class TextureNode(PipelineNode):
    """
    :Constructors:
    ...
    ::
        ...
        new(texture:Cogl.Texture, color:Clutter.Color=None, min_filter:Clutter.ScalingFilter, mag_filter:Clutter.ScalingFilter) -> Clutter.PaintNode
    """
    ...
    def new(self, texture, color=None, min_filter, mag_filter): # real signature unknown; restored from __doc__
        """ new(texture:Cogl.Texture, color:Clutter.Color=None, min_filter:Clutter.ScalingFilter, mag_filter:Clutter.ScalingFilter) -> Clutter.PaintNode """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextureNode), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterTextureNode (94911696231152)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterTextureNode (94911696231152)>'
    __info__ = ObjectInfo(TextureNode)
