...
class Effect(ActorMeta):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f54133f4fd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Effect), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterEffect (94911695955904)>, '__doc__': None, '__gsignals__': {}, 'queue_repaint': gi.FunctionInfo(queue_repaint), 'do_get_paint_volume': gi.VFuncInfo(get_paint_volume), 'do_paint': gi.VFuncInfo(paint), 'do_pick': gi.VFuncInfo(pick), 'do_post_paint': gi.VFuncInfo(post_paint), 'do_pre_paint': gi.VFuncInfo(pre_paint), 'parent_instance': <property object at 0x7f5413db6130>})"
    __gdoc__ = 'Object ClutterEffect\n\nProperties from ClutterActorMeta:\n  actor -> ClutterActor: Actor\n    The actor attached to the meta\n  name -> gchararray: Name\n    The name of the meta\n  enabled -> gboolean: Enabled\n    Whether the meta is enabled\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterEffect (94911695955904)>'
