...
class PaintNode(object):
    """
    :Constructors:
    
    ::
    
        PaintNode(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PaintNode), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterPaintNode (196)>, '__dict__': <attribute '__dict__' of 'PaintNode' objects>, '__weakref__': <attribute '__weakref__' of 'PaintNode' objects>, '__doc__': None, '__gsignals__': {}, 'add_child': gi.FunctionInfo(add_child), 'add_rectangle': gi.FunctionInfo(add_rectangle), 'add_texture_rectangle': gi.FunctionInfo(add_texture_rectangle), 'ref': gi.FunctionInfo(ref), 'set_name': gi.FunctionInfo(set_name), 'unref': gi.FunctionInfo(unref)})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterPaintNode (196)>'
    __info__ = ObjectInfo(PaintNode)
