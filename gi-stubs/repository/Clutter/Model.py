...
class Model(__gi_overrides_GObject.Object, Scriptable):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f54133f4490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Model), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterModel (94911696051312)>, '__doc__': None, '__gsignals__': {}, 'appendv': gi.FunctionInfo(appendv), 'filter_iter': gi.FunctionInfo(filter_iter), 'filter_row': gi.FunctionInfo(filter_row), 'foreach': gi.FunctionInfo(foreach), 'get_column_name': gi.FunctionInfo(get_column_name), 'get_column_type': gi.FunctionInfo(get_column_type), 'get_filter_set': gi.FunctionInfo(get_filter_set), 'get_first_iter': gi.FunctionInfo(get_first_iter), 'get_iter_at_row': gi.FunctionInfo(get_iter_at_row), 'get_last_iter': gi.FunctionInfo(get_last_iter), 'get_n_columns': gi.FunctionInfo(get_n_columns), 'get_n_rows': gi.FunctionInfo(get_n_rows), 'get_sorting_column': gi.FunctionInfo(get_sorting_column), 'insert_value': gi.FunctionInfo(insert_value), 'insertv': gi.FunctionInfo(insertv), 'prependv': gi.FunctionInfo(prependv), 'remove': gi.FunctionInfo(remove), 'resort': gi.FunctionInfo(resort), 'set_filter': gi.FunctionInfo(set_filter), 'set_names': gi.FunctionInfo(set_names), 'set_sort': gi.FunctionInfo(set_sort), 'set_sorting_column': gi.FunctionInfo(set_sorting_column), 'set_types': gi.FunctionInfo(set_types), 'do_filter_changed': gi.VFuncInfo(filter_changed), 'do_get_column_name': gi.VFuncInfo(get_column_name), 'do_get_column_type': gi.VFuncInfo(get_column_type), 'do_get_iter_at_row': gi.VFuncInfo(get_iter_at_row), 'do_get_n_columns': gi.VFuncInfo(get_n_columns), 'do_get_n_rows': gi.VFuncInfo(get_n_rows), 'do_remove_row': gi.VFuncInfo(remove_row), 'do_row_added': gi.VFuncInfo(row_added), 'do_row_changed': gi.VFuncInfo(row_changed), 'do_row_removed': gi.VFuncInfo(row_removed), 'do_sort_changed': gi.VFuncInfo(sort_changed), 'parent_instance': <property object at 0x7f5413519c20>, 'priv': <property object at 0x7f5413519d10>})"
    __gdoc__ = 'Object ClutterModel\n\nSignals from ClutterModel:\n  row-added (ClutterModelIter)\n  row-removed (ClutterModelIter)\n  row-changed (ClutterModelIter)\n  sort-changed ()\n  filter-changed ()\n\nProperties from ClutterModel:\n  filter-set -> gboolean: Filter Set\n    Whether the model has a filter\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterModel (94911696051312)>'
    __info__ = ObjectInfo(Model)
