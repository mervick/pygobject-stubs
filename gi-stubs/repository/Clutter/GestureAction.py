...
class GestureAction(Action):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f54130dc040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureAction), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterGestureAction (94911696014896)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'cancel': gi.FunctionInfo(cancel), 'get_device': gi.FunctionInfo(get_device), 'get_last_event': gi.FunctionInfo(get_last_event), 'get_motion_coords': gi.FunctionInfo(get_motion_coords), 'get_motion_delta': gi.FunctionInfo(get_motion_delta), 'get_n_current_points': gi.FunctionInfo(get_n_current_points), 'get_n_touch_points': gi.FunctionInfo(get_n_touch_points), 'get_press_coords': gi.FunctionInfo(get_press_coords), 'get_release_coords': gi.FunctionInfo(get_release_coords), 'get_sequence': gi.FunctionInfo(get_sequence), 'get_threshold_trigger_distance': gi.FunctionInfo(get_threshold_trigger_distance), 'get_threshold_trigger_edge': gi.FunctionInfo(get_threshold_trigger_edge), 'get_threshold_trigger_egde': gi.FunctionInfo(get_threshold_trigger_egde), 'get_velocity': gi.FunctionInfo(get_velocity), 'set_n_touch_points': gi.FunctionInfo(set_n_touch_points), 'set_threshold_trigger_distance': gi.FunctionInfo(set_threshold_trigger_distance), 'set_threshold_trigger_edge': gi.FunctionInfo(set_threshold_trigger_edge), 'do_gesture_begin': gi.VFuncInfo(gesture_begin), 'do_gesture_cancel': gi.VFuncInfo(gesture_cancel), 'do_gesture_end': gi.VFuncInfo(gesture_end), 'do_gesture_prepare': gi.VFuncInfo(gesture_prepare), 'do_gesture_progress': gi.VFuncInfo(gesture_progress), 'parent_instance': <property object at 0x7f5413cb84f0>, 'priv': <property object at 0x7f5413cb8630>})"
    __gdoc__ = 'Object ClutterGestureAction\n\nSignals from ClutterGestureAction:\n  gesture-begin (ClutterActor) -> gboolean\n  gesture-progress (ClutterActor) -> gboolean\n  gesture-end (ClutterActor)\n  gesture-cancel (ClutterActor)\n\nProperties from ClutterGestureAction:\n  n-touch-points -> gint: Number touch points\n    Number of touch points\n  threshold-trigger-edge -> ClutterGestureTriggerEdge: Threshold Trigger Edge\n    The trigger edge used by the action\n  threshold-trigger-distance-x -> gfloat: Threshold Trigger Horizontal Distance\n    The horizontal trigger distance used by the action\n  threshold-trigger-distance-y -> gfloat: Threshold Trigger Vertical Distance\n    The vertical trigger distance used by the action\n\nProperties from ClutterActorMeta:\n  actor -> ClutterActor: Actor\n    The actor attached to the meta\n  name -> gchararray: Name\n    The name of the meta\n  enabled -> gboolean: Enabled\n    Whether the meta is enabled\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterGestureAction (94911696014896)>'
    __info__ = ObjectInfo(GestureAction)
