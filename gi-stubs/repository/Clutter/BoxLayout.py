...
class BoxLayout(LayoutManager):
    ...
    def get_alignment(self, actor): # real signature unknown; restored from __doc__
        """ get_alignment(self, actor:Clutter.Actor) -> x_align:Clutter.BoxAlignment, y_align:Clutter.BoxAlignment """
        pass
    ...
    def get_easing_mode(self): # real signature unknown; restored from __doc__
        """ get_easing_mode(self) -> int """
        return 0

    def get_expand(self, actor): # real signature unknown; restored from __doc__
        """ get_expand(self, actor:Clutter.Actor) -> bool """
        return False

    def get_fill(self, actor): # real signature unknown; restored from __doc__
        """ get_fill(self, actor:Clutter.Actor) -> x_fill:bool, y_fill:bool """
        pass
    ...
    def get_orientation(self): # real signature unknown; restored from __doc__
        """ get_orientation(self) -> Clutter.Orientation """
        pass

    def get_pack_start(self): # real signature unknown; restored from __doc__
        """ get_pack_start(self) -> bool """
        return False
    ...
    def get_use_animations(self): # real signature unknown; restored from __doc__
        """ get_use_animations(self) -> bool """
        return False

    def get_vertical(self): # real signature unknown; restored from __doc__
        """ get_vertical(self) -> bool """
        return False
    ...
    def pack(self, actor, expand, x_fill, y_fill, x_align, y_align): # real signature unknown; restored from __doc__
        """ pack(self, actor:Clutter.Actor, expand:bool, x_fill:bool, y_fill:bool, x_align:Clutter.BoxAlignment, y_align:Clutter.BoxAlignment) """
        pass
    ...
    def set_alignment(self, actor, x_align, y_align): # real signature unknown; restored from __doc__
        """ set_alignment(self, actor:Clutter.Actor, x_align:Clutter.BoxAlignment, y_align:Clutter.BoxAlignment) """
        pass
    ...
    def set_easing_mode(self, mode): # real signature unknown; restored from __doc__
        """ set_easing_mode(self, mode:int) """
        pass

    def set_expand(self, actor, expand): # real signature unknown; restored from __doc__
        """ set_expand(self, actor:Clutter.Actor, expand:bool) """
        pass

    def set_fill(self, actor, x_fill, y_fill): # real signature unknown; restored from __doc__
        """ set_fill(self, actor:Clutter.Actor, x_fill:bool, y_fill:bool) """
        pass
    ...
    def set_orientation(self, orientation): # real signature unknown; restored from __doc__
        """ set_orientation(self, orientation:Clutter.Orientation) """
        pass

    def set_pack_start(self, pack_start): # real signature unknown; restored from __doc__
        """ set_pack_start(self, pack_start:bool) """
        pass
    ...
    def set_use_animations(self, animate): # real signature unknown; restored from __doc__
        """ set_use_animations(self, animate:bool) """
        pass

    def set_vertical(self, vertical): # real signature unknown; restored from __doc__
        """ set_vertical(self, vertical:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f54134f1b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BoxLayout), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterBoxLayout (94911695964976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_alignment': gi.FunctionInfo(get_alignment), 'get_easing_duration': gi.FunctionInfo(get_easing_duration), 'get_easing_mode': gi.FunctionInfo(get_easing_mode), 'get_expand': gi.FunctionInfo(get_expand), 'get_fill': gi.FunctionInfo(get_fill), 'get_homogeneous': gi.FunctionInfo(get_homogeneous), 'get_orientation': gi.FunctionInfo(get_orientation), 'get_pack_start': gi.FunctionInfo(get_pack_start), 'get_spacing': gi.FunctionInfo(get_spacing), 'get_use_animations': gi.FunctionInfo(get_use_animations), 'get_vertical': gi.FunctionInfo(get_vertical), 'pack': gi.FunctionInfo(pack), 'set_alignment': gi.FunctionInfo(set_alignment), 'set_easing_duration': gi.FunctionInfo(set_easing_duration), 'set_easing_mode': gi.FunctionInfo(set_easing_mode), 'set_expand': gi.FunctionInfo(set_expand), 'set_fill': gi.FunctionInfo(set_fill), 'set_homogeneous': gi.FunctionInfo(set_homogeneous), 'set_orientation': gi.FunctionInfo(set_orientation), 'set_pack_start': gi.FunctionInfo(set_pack_start), 'set_spacing': gi.FunctionInfo(set_spacing), 'set_use_animations': gi.FunctionInfo(set_use_animations), 'set_vertical': gi.FunctionInfo(set_vertical), 'parent_instance': <property object at 0x7f5413dba5e0>, 'priv': <property object at 0x7f5413dba6d0>})"
    __gdoc__ = 'Object ClutterBoxLayout\n\nProperties from ClutterBoxLayout:\n  spacing -> guint: Spacing\n    Spacing between children\n  vertical -> gboolean: Vertical\n    Whether the layout should be vertical, rather than horizontal\n  homogeneous -> gboolean: Homogeneous\n    Whether the layout should be homogeneous, i.e. all children get the same size\n  pack-start -> gboolean: Pack Start\n    Whether to pack items at the start of the box\n  use-animations -> gboolean: Use Animations\n    Whether layout changes should be animated\n  easing-mode -> gulong: Easing Mode\n    The easing mode of the animations\n  easing-duration -> guint: Easing Duration\n    The duration of the animations\n  orientation -> ClutterOrientation: Orientation\n    The orientation of the layout\n\nSignals from ClutterLayoutManager:\n  layout-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterBoxLayout (94911695964976)>'
    __info__ = ObjectInfo(BoxLayout)
