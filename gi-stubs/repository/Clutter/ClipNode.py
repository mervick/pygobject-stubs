...
class ClipNode(PaintNode):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ClipNode), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterClipNode (94911696064912)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterClipNode (94911696064912)>'
    __info__ = ObjectInfo(ClipNode)
