...
class Rectangle(Actor):
    ...
    ::
        ...
        new() -> Clutter.Actor
        new_with_color(color:Clutter.Color) -> Clutter.Actor
    """
    ...
    def get_border_color(self): # real signature unknown; restored from __doc__
        """ get_border_color(self) -> color:Clutter.Color """
        pass
    ...
    def new_with_color(self, color): # real signature unknown; restored from __doc__
        """ new_with_color(color:Clutter.Color) -> Clutter.Actor """
        pass
    ...
    def set_border_color(self, color): # real signature unknown; restored from __doc__
        """ set_border_color(self, color:Clutter.Color) """
        pass

    def set_border_width(self, width): # real signature unknown; restored from __doc__
        """ set_border_width(self, width:int) """
        pass
