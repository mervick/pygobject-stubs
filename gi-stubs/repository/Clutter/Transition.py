...
class Transition(Timeline):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5413019850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Transition), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterTransition (94911696032976)>, '__doc__': None, '__gsignals__': {}, 'get_animatable': gi.FunctionInfo(get_animatable), 'get_interval': gi.FunctionInfo(get_interval), 'get_remove_on_complete': gi.FunctionInfo(get_remove_on_complete), 'set_animatable': gi.FunctionInfo(set_animatable), 'set_from': gi.FunctionInfo(set_from), 'set_interval': gi.FunctionInfo(set_interval), 'set_remove_on_complete': gi.FunctionInfo(set_remove_on_complete), 'set_to': gi.FunctionInfo(set_to), 'do_attached': gi.VFuncInfo(attached), 'do_compute_value': gi.VFuncInfo(compute_value), 'do_detached': gi.VFuncInfo(detached), 'parent_instance': <property object at 0x7f5413512950>, 'priv': <property object at 0x7f5413512a40>})"
    __gdoc__ = 'Object ClutterTransition\n\nProperties from ClutterTransition:\n  interval -> ClutterInterval: Interval\n    The interval of values to transition\n  animatable -> ClutterAnimatable: Animatable\n    The animatable object\n  remove-on-complete -> gboolean: Remove on Complete\n    Detach the transition when completed\n\nSignals from ClutterTimeline:\n  started ()\n  completed ()\n  new-frame (gint)\n  paused ()\n  marker-reached (gchararray, gint)\n  stopped (gboolean)\n\nProperties from ClutterTimeline:\n  loop -> gboolean: Loop\n    Should the timeline automatically restart\n  delay -> guint: Delay\n    Delay before start\n  duration -> guint: Duration\n    Duration of the timeline in milliseconds\n  direction -> ClutterTimelineDirection: Direction\n    Direction of the timeline\n  auto-reverse -> gboolean: Auto Reverse\n    Whether the direction should be reversed when reaching the end\n  repeat-count -> gint: Repeat Count\n    How many times the timeline should repeat\n  progress-mode -> ClutterAnimationMode: Progress Mode\n    How the timeline should compute the progress\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterTransition (94911696032976)>'
    __info__ = ObjectInfo(Transition)
