...
class PropertyTransition(Transition):
    """
    :Constructors:
    
    ::
    
        PropertyTransition(**properties)
        new(property_name:str=None) -> Clutter.Transition
    """
    ...
    def new(self, property_name=None): # real signature unknown; restored from __doc__
        """ new(property_name:str=None) -> Clutter.Transition """
        pass
