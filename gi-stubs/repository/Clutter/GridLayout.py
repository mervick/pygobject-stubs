...
class GridLayout(LayoutManager):
    ...
    def attach(self, child, left, top, width, height): # real signature unknown; restored from __doc__
        """ attach(self, child:Clutter.Actor, left:int, top:int, width:int, height:int) """
        pass

    def attach_next_to(self, child, sibling=None, side, width, height): # real signature unknown; restored from __doc__
        """ attach_next_to(self, child:Clutter.Actor, sibling:Clutter.Actor=None, side:Clutter.GridPosition, width:int, height:int) """
        pass
    ...
    def get_child_at(self, left, top): # real signature unknown; restored from __doc__
        """ get_child_at(self, left:int, top:int) -> Clutter.Actor """
        pass
    ...
    def insert_next_to(self, sibling, side): # real signature unknown; restored from __doc__
        """ insert_next_to(self, sibling:Clutter.Actor, side:Clutter.GridPosition) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5413204eb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GridLayout), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterGridLayout (94911696151056)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'attach': gi.FunctionInfo(attach), 'attach_next_to': gi.FunctionInfo(attach_next_to), 'get_child_at': gi.FunctionInfo(get_child_at), 'get_column_homogeneous': gi.FunctionInfo(get_column_homogeneous), 'get_column_spacing': gi.FunctionInfo(get_column_spacing), 'get_orientation': gi.FunctionInfo(get_orientation), 'get_row_homogeneous': gi.FunctionInfo(get_row_homogeneous), 'get_row_spacing': gi.FunctionInfo(get_row_spacing), 'insert_column': gi.FunctionInfo(insert_column), 'insert_next_to': gi.FunctionInfo(insert_next_to), 'insert_row': gi.FunctionInfo(insert_row), 'set_column_homogeneous': gi.FunctionInfo(set_column_homogeneous), 'set_column_spacing': gi.FunctionInfo(set_column_spacing), 'set_orientation': gi.FunctionInfo(set_orientation), 'set_row_homogeneous': gi.FunctionInfo(set_row_homogeneous), 'set_row_spacing': gi.FunctionInfo(set_row_spacing), 'parent_instance': <property object at 0x7f5413cb9d60>, 'priv': <property object at 0x7f5413cb9e50>})"
    __gdoc__ = 'Object ClutterGridLayout\n\nProperties from ClutterGridLayout:\n  orientation -> ClutterOrientation: Orientation\n    The orientation of the layout\n  row-spacing -> guint: Row spacing\n    The amount of space between two consecutive rows\n  column-spacing -> guint: Column spacing\n    The amount of space between two consecutive columns\n  row-homogeneous -> gboolean: Row Homogeneous\n    If TRUE, the rows are all the same height\n  column-homogeneous -> gboolean: Column Homogeneous\n    If TRUE, the columns are all the same width\n\nSignals from ClutterLayoutManager:\n  layout-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterGridLayout (94911696151056)>'
    __info__ = ObjectInfo(GridLayout)
