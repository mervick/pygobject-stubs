...
class PanAction(GestureAction):
    """
    :Constructors:
    
    ::
    
        PanAction(**properties)
        new() -> Clutter.Action
    """
    ...
    def do_pan(self, *args, **kwargs): # real signature unknown
        """ pan(self, actor:Clutter.Actor, is_interpolated:bool) -> bool """
        pass

    def do_pan_stopped(self, *args, **kwargs): # real signature unknown
        """ pan_stopped(self, actor:Clutter.Actor) """
        pass
    ...
    def get_acceleration_factor(self): # real signature unknown; restored from __doc__
        """ get_acceleration_factor(self) -> float """
        return 0.0
    ...
    def get_constrained_motion_delta(self, point): # real signature unknown; restored from __doc__
        """ get_constrained_motion_delta(self, point:int) -> float, delta_x:float, delta_y:float """
        return 0.0
    ...
    def get_interpolate(self): # real signature unknown; restored from __doc__
        """ get_interpolate(self) -> bool """
        return False

    def get_interpolated_coords(self): # real signature unknown; restored from __doc__
        """ get_interpolated_coords(self) -> interpolated_x:float, interpolated_y:float """
        pass

    def get_interpolated_delta(self): # real signature unknown; restored from __doc__
        """ get_interpolated_delta(self) -> float, delta_x:float, delta_y:float """
        return 0.0
    ...
    def get_pan_axis(self): # real signature unknown; restored from __doc__
        """ get_pan_axis(self) -> Clutter.PanAxis """
        pass
    ...
    def set_acceleration_factor(self, factor): # real signature unknown; restored from __doc__
        """ set_acceleration_factor(self, factor:float) """
        pass
    ...
    def set_interpolate(self, should_interpolate): # real signature unknown; restored from __doc__
        """ set_interpolate(self, should_interpolate:bool) """
        pass
    ...
    def set_pan_axis(self, axis): # real signature unknown; restored from __doc__
        """ set_pan_axis(self, axis:Clutter.PanAxis) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f54132048e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PanAction), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterPanAction (94911696228480)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_acceleration_factor': gi.FunctionInfo(get_acceleration_factor), 'get_constrained_motion_delta': gi.FunctionInfo(get_constrained_motion_delta), 'get_deceleration': gi.FunctionInfo(get_deceleration), 'get_interpolate': gi.FunctionInfo(get_interpolate), 'get_interpolated_coords': gi.FunctionInfo(get_interpolated_coords), 'get_interpolated_delta': gi.FunctionInfo(get_interpolated_delta), 'get_motion_coords': gi.FunctionInfo(get_motion_coords), 'get_motion_delta': gi.FunctionInfo(get_motion_delta), 'get_pan_axis': gi.FunctionInfo(get_pan_axis), 'set_acceleration_factor': gi.FunctionInfo(set_acceleration_factor), 'set_deceleration': gi.FunctionInfo(set_deceleration), 'set_interpolate': gi.FunctionInfo(set_interpolate), 'set_pan_axis': gi.FunctionInfo(set_pan_axis), 'do_pan': gi.VFuncInfo(pan), 'do_pan_stopped': gi.VFuncInfo(pan_stopped), 'parent_instance': <property object at 0x7f541352b180>, 'priv': <property object at 0x7f541352b270>})"
    __gdoc__ = 'Object ClutterPanAction\n\nSignals from ClutterPanAction:\n  pan (ClutterActor, gboolean) -> gboolean\n  pan-stopped (ClutterActor)\n\nProperties from ClutterPanAction:\n  pan-axis -> ClutterPanAxis: Pan Axis\n    Constraints the panning to an axis\n  interpolate -> gboolean: Interpolate\n    Whether interpolated events emission is enabled.\n  deceleration -> gdouble: Deceleration\n    Rate at which the interpolated panning will decelerate in\n  acceleration-factor -> gdouble: Initial acceleration factor\n    Factor applied to the momentum when starting the interpolated phase\n\nSignals from ClutterGestureAction:\n  gesture-begin (ClutterActor) -> gboolean\n  gesture-progress (ClutterActor) -> gboolean\n  gesture-end (ClutterActor)\n  gesture-cancel (ClutterActor)\n\nProperties from ClutterGestureAction:\n  n-touch-points -> gint: Number touch points\n    Number of touch points\n  threshold-trigger-edge -> ClutterGestureTriggerEdge: Threshold Trigger Edge\n    The trigger edge used by the action\n  threshold-trigger-distance-x -> gfloat: Threshold Trigger Horizontal Distance\n    The horizontal trigger distance used by the action\n  threshold-trigger-distance-y -> gfloat: Threshold Trigger Vertical Distance\n    The vertical trigger distance used by the action\n\nProperties from ClutterActorMeta:\n  actor -> ClutterActor: Actor\n    The actor attached to the meta\n  name -> gchararray: Name\n    The name of the meta\n  enabled -> gboolean: Enabled\n    Whether the meta is enabled\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterPanAction (94911696228480)>'
    __info__ = ObjectInfo(PanAction)
