...
class TableLayout(LayoutManager):
    ...
    def get_alignment(self, actor): # real signature unknown; restored from __doc__
        """ get_alignment(self, actor:Clutter.Actor) -> x_align:Clutter.TableAlignment, y_align:Clutter.TableAlignment """
        pass
    ...
    def get_expand(self, actor): # real signature unknown; restored from __doc__
        """ get_expand(self, actor:Clutter.Actor) -> x_expand:bool, y_expand:bool """
        pass
    ...
    def get_span(self, actor): # real signature unknown; restored from __doc__
        """ get_span(self, actor:Clutter.Actor) -> column_span:int, row_span:int """
        pass
    ...
    def pack(self, actor, column, row): # real signature unknown; restored from __doc__
        """ pack(self, actor:Clutter.Actor, column:int, row:int) """
        pass
    ...
    def set_alignment(self, actor, x_align, y_align): # real signature unknown; restored from __doc__
        """ set_alignment(self, actor:Clutter.Actor, x_align:Clutter.TableAlignment, y_align:Clutter.TableAlignment) """
        pass
    ...
    def set_expand(self, actor, x_expand, y_expand): # real signature unknown; restored from __doc__
        """ set_expand(self, actor:Clutter.Actor, x_expand:bool, y_expand:bool) """
        pass
    ...
    def set_span(self, actor, column_span, row_span): # real signature unknown; restored from __doc__
        """ set_span(self, actor:Clutter.Actor, column_span:int, row_span:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5412d31a00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TableLayout), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterTableLayout (94911696373648)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_alignment': gi.FunctionInfo(get_alignment), 'get_column_count': gi.FunctionInfo(get_column_count), 'get_column_spacing': gi.FunctionInfo(get_column_spacing), 'get_easing_duration': gi.FunctionInfo(get_easing_duration), 'get_easing_mode': gi.FunctionInfo(get_easing_mode), 'get_expand': gi.FunctionInfo(get_expand), 'get_fill': gi.FunctionInfo(get_fill), 'get_row_count': gi.FunctionInfo(get_row_count), 'get_row_spacing': gi.FunctionInfo(get_row_spacing), 'get_span': gi.FunctionInfo(get_span), 'get_use_animations': gi.FunctionInfo(get_use_animations), 'pack': gi.FunctionInfo(pack), 'set_alignment': gi.FunctionInfo(set_alignment), 'set_column_spacing': gi.FunctionInfo(set_column_spacing), 'set_easing_duration': gi.FunctionInfo(set_easing_duration), 'set_easing_mode': gi.FunctionInfo(set_easing_mode), 'set_expand': gi.FunctionInfo(set_expand), 'set_fill': gi.FunctionInfo(set_fill), 'set_row_spacing': gi.FunctionInfo(set_row_spacing), 'set_span': gi.FunctionInfo(set_span), 'set_use_animations': gi.FunctionInfo(set_use_animations), 'parent_instance': <property object at 0x7f54134d7c20>, 'priv': <property object at 0x7f54134d7d10>})"
    __gdoc__ = 'Object ClutterTableLayout\n\nProperties from ClutterTableLayout:\n  row-spacing -> guint: Row Spacing\n    Spacing between rows\n  column-spacing -> guint: Column Spacing\n    Spacing between columns\n  use-animations -> gboolean: Use Animations\n    Whether layout changes should be animated\n  easing-mode -> gulong: Easing Mode\n    The easing mode of the animations\n  easing-duration -> guint: Easing Duration\n    The duration of the animations\n\nSignals from ClutterLayoutManager:\n  layout-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterTableLayout (94911696373648)>'
    __info__ = ObjectInfo(TableLayout)
