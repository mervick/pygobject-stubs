...
class TransitionGroup(Transition):
    """
    :Constructors:
    
    ::
    
        TransitionGroup(**properties)
        new() -> Clutter.Transition
    """
    ...
    def add_transition(self, transition): # real signature unknown; restored from __doc__
        """ add_transition(self, transition:Clutter.Transition) """
        pass
    ...
    def remove_transition(self, transition): # real signature unknown; restored from __doc__
        """ remove_transition(self, transition:Clutter.Transition) """
        pass
