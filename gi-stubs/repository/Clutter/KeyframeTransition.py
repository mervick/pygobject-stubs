...
from .PropertyTransition import PropertyTransition

class KeyframeTransition(PropertyTransition):
    """
    :Constructors:
    
    ::
    
        KeyframeTransition(**properties)
        new(property_name:str) -> Clutter.Transition
    """
    ...
    def do_attached(self, *args, **kwargs): # real signature unknown
        """ attached(self, animatable:Clutter.Animatable) """
        pass
    ...
    def do_compute_value(self, *args, **kwargs): # real signature unknown
        """ compute_value(self, animatable:Clutter.Animatable, interval:Clutter.Interval, progress:float) """
        pass

    def do_detached(self, *args, **kwargs): # real signature unknown
        """ detached(self, animatable:Clutter.Animatable) """
        pass
    ...
    def get_animatable(self): # real signature unknown; restored from __doc__
        """ get_animatable(self) -> Clutter.Animatable """
        pass
    ...
    def get_interval(self): # real signature unknown; restored from __doc__
        """ get_interval(self) -> Clutter.Interval """
        pass

    def get_key_frame(self, index_): # real signature unknown; restored from __doc__
        """ get_key_frame(self, index_:int) -> key:float, mode:Clutter.AnimationMode, value:GObject.Value """
        pass
    ...
    def get_n_key_frames(self): # real signature unknown; restored from __doc__
        """ get_n_key_frames(self) -> int """
        return 0
    ...
    def get_remove_on_complete(self): # real signature unknown; restored from __doc__
        """ get_remove_on_complete(self) -> bool """
        return False
    ...
    def new(self, property_name): # real signature unknown; restored from __doc__
        """ new(property_name:str) -> Clutter.Transition """
        pass
    ...
    def set_animatable(self, animatable=None): # real signature unknown; restored from __doc__
        """ set_animatable(self, animatable:Clutter.Animatable=None) """
        pass
    ...
    def set_from(self, value): # real signature unknown; restored from __doc__
        """ set_from(self, value:GObject.Value) """
        pass
    ...
    def set_interval(self, interval=None): # real signature unknown; restored from __doc__
        """ set_interval(self, interval:Clutter.Interval=None) """
        pass

    def set_key_frame(self, index_, key, mode, value): # real signature unknown; restored from __doc__
        """ set_key_frame(self, index_:int, key:float, mode:Clutter.AnimationMode, value:GObject.Value) """
        pass

    def set_key_frames(self, key_frames): # real signature unknown; restored from __doc__
        """ set_key_frames(self, key_frames:list) """
        pass
    ...
    def set_modes(self, modes): # real signature unknown; restored from __doc__
        """ set_modes(self, modes:list) """
        pass
    ...
    def set_property_name(self, property_name=None): # real signature unknown; restored from __doc__
        """ set_property_name(self, property_name:str=None) """
        pass

    def set_remove_on_complete(self, remove_complete): # real signature unknown; restored from __doc__
        """ set_remove_on_complete(self, remove_complete:bool) """
        pass
    ...
    def set_to(self, value): # real signature unknown; restored from __doc__
        """ set_to(self, value:GObject.Value) """
        pass

    def set_values(self, values): # real signature unknown; restored from __doc__
        """ set_values(self, values:list) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(KeyframeTransition), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterKeyframeTransition (94911696162816)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'clear': gi.FunctionInfo(clear), 'get_key_frame': gi.FunctionInfo(get_key_frame), 'get_n_key_frames': gi.FunctionInfo(get_n_key_frames), 'set_key_frame': gi.FunctionInfo(set_key_frame), 'set_key_frames': gi.FunctionInfo(set_key_frames), 'set_modes': gi.FunctionInfo(set_modes), 'set_values': gi.FunctionInfo(set_values), 'parent_instance': <property object at 0x7f5413512ef0>, 'priv': <property object at 0x7f5413515040>})"
    __gdoc__ = 'Object ClutterKeyframeTransition\n\nProperties from ClutterPropertyTransition:\n  property-name -> gchararray: Property Name\n    The name of the property to animate\n\nProperties from ClutterTransition:\n  interval -> ClutterInterval: Interval\n    The interval of values to transition\n  animatable -> ClutterAnimatable: Animatable\n    The animatable object\n  remove-on-complete -> gboolean: Remove on Complete\n    Detach the transition when completed\n\nSignals from ClutterTimeline:\n  started ()\n  completed ()\n  new-frame (gint)\n  paused ()\n  marker-reached (gchararray, gint)\n  stopped (gboolean)\n\nProperties from ClutterTimeline:\n  loop -> gboolean: Loop\n    Should the timeline automatically restart\n  delay -> guint: Delay\n    Delay before start\n  duration -> guint: Duration\n    Duration of the timeline in milliseconds\n  direction -> ClutterTimelineDirection: Direction\n    Direction of the timeline\n  auto-reverse -> gboolean: Auto Reverse\n    Whether the direction should be reversed when reaching the end\n  repeat-count -> gint: Repeat Count\n    How many times the timeline should repeat\n  progress-mode -> ClutterAnimationMode: Progress Mode\n    How the timeline should compute the progress\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterKeyframeTransition (94911696162816)>'
    __info__ = ObjectInfo(KeyframeTransition)
