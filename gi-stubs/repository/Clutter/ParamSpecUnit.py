...
class ParamSpecUnit(__gi_repository_GObject.ParamSpec):
    """
    :Constructors:
    
    ::
    
        ParamSpecUnit(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecUnit), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterParamSpecUnit (94911696242304)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterParamSpecUnit (94911696242304)>'
    __info__ = ObjectInfo(ParamSpecUnit)
