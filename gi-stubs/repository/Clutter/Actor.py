...
class Actor(__gi_repository_GObject.InitiallyUnowned, __gi_repository_Atk.ImplementorIface, Animatable, Container, Scriptable):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5413e57580>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Actor), '__module__': 'gi.repository.Clutter', '__gtype__': <GType ClutterActor (94911695361968)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_action': gi.FunctionInfo(add_action), 'add_action_with_name': gi.FunctionInfo(add_action_with_name), 'add_child': gi.FunctionInfo(add_child), 'add_constraint': gi.FunctionInfo(add_constraint), 'add_constraint_with_name': gi.FunctionInfo(add_constraint_with_name), 'add_effect': gi.FunctionInfo(add_effect), 'add_effect_with_name': gi.FunctionInfo(add_effect_with_name), 'add_transition': gi.FunctionInfo(add_transition), 'allocate': gi.FunctionInfo(allocate), 'allocate_align_fill': gi.FunctionInfo(allocate_align_fill), 'allocate_available_size': gi.FunctionInfo(allocate_available_size), 'allocate_preferred_size': gi.FunctionInfo(allocate_preferred_size), 'animate_with_alphav': gi.FunctionInfo(animate_with_alphav), 'animate_with_timelinev': gi.FunctionInfo(animate_with_timelinev), 'animatev': gi.FunctionInfo(animatev), 'apply_relative_transform_to_point': gi.FunctionInfo(apply_relative_transform_to_point), 'apply_transform_to_point': gi.FunctionInfo(apply_transform_to_point), 'bind_model': gi.FunctionInfo(bind_model), 'clear_actions': gi.FunctionInfo(clear_actions), 'clear_constraints': gi.FunctionInfo(clear_constraints), 'clear_effects': gi.FunctionInfo(clear_effects), 'contains': gi.FunctionInfo(contains), 'continue_paint': gi.FunctionInfo(continue_paint), 'create_pango_context': gi.FunctionInfo(create_pango_context), 'create_pango_layout': gi.FunctionInfo(create_pango_layout), 'destroy': gi.FunctionInfo(destroy), 'destroy_all_children': gi.FunctionInfo(destroy_all_children), 'detach_animation': gi.FunctionInfo(detach_animation), 'event': gi.FunctionInfo(event), 'get_abs_allocation_vertices': gi.FunctionInfo(get_abs_allocation_vertices), 'get_accessible': gi.FunctionInfo(get_accessible), 'get_action': gi.FunctionInfo(get_action), 'get_actions': gi.FunctionInfo(get_actions), 'get_allocation_box': gi.FunctionInfo(get_allocation_box), 'get_allocation_geometry': gi.FunctionInfo(get_allocation_geometry), 'get_allocation_vertices': gi.FunctionInfo(get_allocation_vertices), 'get_anchor_point': gi.FunctionInfo(get_anchor_point), 'get_anchor_point_gravity': gi.FunctionInfo(get_anchor_point_gravity), 'get_animation': gi.FunctionInfo(get_animation), 'get_background_color': gi.FunctionInfo(get_background_color), 'get_child_at_index': gi.FunctionInfo(get_child_at_index), 'get_child_transform': gi.FunctionInfo(get_child_transform), 'get_children': gi.FunctionInfo(get_children), 'get_clip': gi.FunctionInfo(get_clip), 'get_clip_to_allocation': gi.FunctionInfo(get_clip_to_allocation), 'get_constraint': gi.FunctionInfo(get_constraint), 'get_constraints': gi.FunctionInfo(get_constraints), 'get_content': gi.FunctionInfo(get_content), 'get_content_box': gi.FunctionInfo(get_content_box), 'get_content_gravity': gi.FunctionInfo(get_content_gravity), 'get_content_repeat': gi.FunctionInfo(get_content_repeat), 'get_content_scaling_filters': gi.FunctionInfo(get_content_scaling_filters), 'get_default_paint_volume': gi.FunctionInfo(get_default_paint_volume), 'get_depth': gi.FunctionInfo(get_depth), 'get_easing_delay': gi.FunctionInfo(get_easing_delay), 'get_easing_duration': gi.FunctionInfo(get_easing_duration), 'get_easing_mode': gi.FunctionInfo(get_easing_mode), 'get_effect': gi.FunctionInfo(get_effect), 'get_effects': gi.FunctionInfo(get_effects), 'get_first_child': gi.FunctionInfo(get_first_child), 'get_fixed_position_set': gi.FunctionInfo(get_fixed_position_set), 'get_flags': gi.FunctionInfo(get_flags), 'get_geometry': gi.FunctionInfo(get_geometry), 'get_gid': gi.FunctionInfo(get_gid), 'get_height': gi.FunctionInfo(get_height), 'get_last_child': gi.FunctionInfo(get_last_child), 'get_layout_manager': gi.FunctionInfo(get_layout_manager), 'get_margin': gi.FunctionInfo(get_margin), 'get_margin_bottom': gi.FunctionInfo(get_margin_bottom), 'get_margin_left': gi.FunctionInfo(get_margin_left), 'get_margin_right': gi.FunctionInfo(get_margin_right), 'get_margin_top': gi.FunctionInfo(get_margin_top), 'get_n_children': gi.FunctionInfo(get_n_children), 'get_name': gi.FunctionInfo(get_name), 'get_next_sibling': gi.FunctionInfo(get_next_sibling), 'get_offscreen_redirect': gi.FunctionInfo(get_offscreen_redirect), 'get_opacity': gi.FunctionInfo(get_opacity), 'get_paint_box': gi.FunctionInfo(get_paint_box), 'get_paint_opacity': gi.FunctionInfo(get_paint_opacity), 'get_paint_visibility': gi.FunctionInfo(get_paint_visibility), 'get_paint_volume': gi.FunctionInfo(get_paint_volume), 'get_pango_context': gi.FunctionInfo(get_pango_context), 'get_parent': gi.FunctionInfo(get_parent), 'get_pivot_point': gi.FunctionInfo(get_pivot_point), 'get_pivot_point_z': gi.FunctionInfo(get_pivot_point_z), 'get_position': gi.FunctionInfo(get_position), 'get_preferred_height': gi.FunctionInfo(get_preferred_height), 'get_preferred_size': gi.FunctionInfo(get_preferred_size), 'get_preferred_width': gi.FunctionInfo(get_preferred_width), 'get_previous_sibling': gi.FunctionInfo(get_previous_sibling), 'get_reactive': gi.FunctionInfo(get_reactive), 'get_request_mode': gi.FunctionInfo(get_request_mode), 'get_rotation': gi.FunctionInfo(get_rotation), 'get_rotation_angle': gi.FunctionInfo(get_rotation_angle), 'get_scale': gi.FunctionInfo(get_scale), 'get_scale_center': gi.FunctionInfo(get_scale_center), 'get_scale_gravity': gi.FunctionInfo(get_scale_gravity), 'get_scale_z': gi.FunctionInfo(get_scale_z), 'get_shader': gi.FunctionInfo(get_shader), 'get_size': gi.FunctionInfo(get_size), 'get_stage': gi.FunctionInfo(get_stage), 'get_text_direction': gi.FunctionInfo(get_text_direction), 'get_transform': gi.FunctionInfo(get_transform), 'get_transformation_matrix': gi.FunctionInfo(get_transformation_matrix), 'get_transformed_paint_volume': gi.FunctionInfo(get_transformed_paint_volume), 'get_transformed_position': gi.FunctionInfo(get_transformed_position), 'get_transformed_size': gi.FunctionInfo(get_transformed_size), 'get_transition': gi.FunctionInfo(get_transition), 'get_translation': gi.FunctionInfo(get_translation), 'get_width': gi.FunctionInfo(get_width), 'get_x': gi.FunctionInfo(get_x), 'get_x_align': gi.FunctionInfo(get_x_align), 'get_x_expand': gi.FunctionInfo(get_x_expand), 'get_y': gi.FunctionInfo(get_y), 'get_y_align': gi.FunctionInfo(get_y_align), 'get_y_expand': gi.FunctionInfo(get_y_expand), 'get_z_position': gi.FunctionInfo(get_z_position), 'get_z_rotation_gravity': gi.FunctionInfo(get_z_rotation_gravity), 'grab_key_focus': gi.FunctionInfo(grab_key_focus), 'has_actions': gi.FunctionInfo(has_actions), 'has_allocation': gi.FunctionInfo(has_allocation), 'has_clip': gi.FunctionInfo(has_clip), 'has_constraints': gi.FunctionInfo(has_constraints), 'has_effects': gi.FunctionInfo(has_effects), 'has_key_focus': gi.FunctionInfo(has_key_focus), 'has_overlaps': gi.FunctionInfo(has_overlaps), 'has_pointer': gi.FunctionInfo(has_pointer), 'hide': gi.FunctionInfo(hide), 'hide_all': gi.FunctionInfo(hide_all), 'insert_child_above': gi.FunctionInfo(insert_child_above), 'insert_child_at_index': gi.FunctionInfo(insert_child_at_index), 'insert_child_below': gi.FunctionInfo(insert_child_below), 'is_in_clone_paint': gi.FunctionInfo(is_in_clone_paint), 'is_mapped': gi.FunctionInfo(is_mapped), 'is_realized': gi.FunctionInfo(is_realized), 'is_rotated': gi.FunctionInfo(is_rotated), 'is_scaled': gi.FunctionInfo(is_scaled), 'is_visible': gi.FunctionInfo(is_visible), 'lower': gi.FunctionInfo(lower), 'lower_bottom': gi.FunctionInfo(lower_bottom), 'map': gi.FunctionInfo(map), 'move_anchor_point': gi.FunctionInfo(move_anchor_point), 'move_anchor_point_from_gravity': gi.FunctionInfo(move_anchor_point_from_gravity), 'move_by': gi.FunctionInfo(move_by), 'needs_expand': gi.FunctionInfo(needs_expand), 'paint': gi.FunctionInfo(paint), 'pop_internal': gi.FunctionInfo(pop_internal), 'push_internal': gi.FunctionInfo(push_internal), 'queue_redraw': gi.FunctionInfo(queue_redraw), 'queue_redraw_with_clip': gi.FunctionInfo(queue_redraw_with_clip), 'queue_relayout': gi.FunctionInfo(queue_relayout), 'raise_': gi.FunctionInfo(raise), 'raise_top': gi.FunctionInfo(raise_top), 'realize': gi.FunctionInfo(realize), 'remove_action': gi.FunctionInfo(remove_action), 'remove_action_by_name': gi.FunctionInfo(remove_action_by_name), 'remove_all_children': gi.FunctionInfo(remove_all_children), 'remove_all_transitions': gi.FunctionInfo(remove_all_transitions), 'remove_child': gi.FunctionInfo(remove_child), 'remove_clip': gi.FunctionInfo(remove_clip), 'remove_constraint': gi.FunctionInfo(remove_constraint), 'remove_constraint_by_name': gi.FunctionInfo(remove_constraint_by_name), 'remove_effect': gi.FunctionInfo(remove_effect), 'remove_effect_by_name': gi.FunctionInfo(remove_effect_by_name), 'remove_transition': gi.FunctionInfo(remove_transition), 'reparent': gi.FunctionInfo(reparent), 'replace_child': gi.FunctionInfo(replace_child), 'restore_easing_state': gi.FunctionInfo(restore_easing_state), 'save_easing_state': gi.FunctionInfo(save_easing_state), 'set_allocation': gi.FunctionInfo(set_allocation), 'set_anchor_point': gi.FunctionInfo(set_anchor_point), 'set_anchor_point_from_gravity': gi.FunctionInfo(set_anchor_point_from_gravity), 'set_background_color': gi.FunctionInfo(set_background_color), 'set_child_above_sibling': gi.FunctionInfo(set_child_above_sibling), 'set_child_at_index': gi.FunctionInfo(set_child_at_index), 'set_child_below_sibling': gi.FunctionInfo(set_child_below_sibling), 'set_child_transform': gi.FunctionInfo(set_child_transform), 'set_clip': gi.FunctionInfo(set_clip), 'set_clip_to_allocation': gi.FunctionInfo(set_clip_to_allocation), 'set_content': gi.FunctionInfo(set_content), 'set_content_gravity': gi.FunctionInfo(set_content_gravity), 'set_content_repeat': gi.FunctionInfo(set_content_repeat), 'set_content_scaling_filters': gi.FunctionInfo(set_content_scaling_filters), 'set_depth': gi.FunctionInfo(set_depth), 'set_easing_delay': gi.FunctionInfo(set_easing_delay), 'set_easing_duration': gi.FunctionInfo(set_easing_duration), 'set_easing_mode': gi.FunctionInfo(set_easing_mode), 'set_fixed_position_set': gi.FunctionInfo(set_fixed_position_set), 'set_flags': gi.FunctionInfo(set_flags), 'set_geometry': gi.FunctionInfo(set_geometry), 'set_height': gi.FunctionInfo(set_height), 'set_layout_manager': gi.FunctionInfo(set_layout_manager), 'set_margin': gi.FunctionInfo(set_margin), 'set_margin_bottom': gi.FunctionInfo(set_margin_bottom), 'set_margin_left': gi.FunctionInfo(set_margin_left), 'set_margin_right': gi.FunctionInfo(set_margin_right), 'set_margin_top': gi.FunctionInfo(set_margin_top), 'set_name': gi.FunctionInfo(set_name), 'set_offscreen_redirect': gi.FunctionInfo(set_offscreen_redirect), 'set_opacity': gi.FunctionInfo(set_opacity), 'set_parent': gi.FunctionInfo(set_parent), 'set_pivot_point': gi.FunctionInfo(set_pivot_point), 'set_pivot_point_z': gi.FunctionInfo(set_pivot_point_z), 'set_position': gi.FunctionInfo(set_position), 'set_reactive': gi.FunctionInfo(set_reactive), 'set_request_mode': gi.FunctionInfo(set_request_mode), 'set_rotation': gi.FunctionInfo(set_rotation), 'set_rotation_angle': gi.FunctionInfo(set_rotation_angle), 'set_scale': gi.FunctionInfo(set_scale), 'set_scale_full': gi.FunctionInfo(set_scale_full), 'set_scale_with_gravity': gi.FunctionInfo(set_scale_with_gravity), 'set_scale_z': gi.FunctionInfo(set_scale_z), 'set_shader': gi.FunctionInfo(set_shader), 'set_shader_param': gi.FunctionInfo(set_shader_param), 'set_shader_param_float': gi.FunctionInfo(set_shader_param_float), 'set_shader_param_int': gi.FunctionInfo(set_shader_param_int), 'set_size': gi.FunctionInfo(set_size), 'set_text_direction': gi.FunctionInfo(set_text_direction), 'set_transform': gi.FunctionInfo(set_transform), 'set_translation': gi.FunctionInfo(set_translation), 'set_width': gi.FunctionInfo(set_width), 'set_x': gi.FunctionInfo(set_x), 'set_x_align': gi.FunctionInfo(set_x_align), 'set_x_expand': gi.FunctionInfo(set_x_expand), 'set_y': gi.FunctionInfo(set_y), 'set_y_align': gi.FunctionInfo(set_y_align), 'set_y_expand': gi.FunctionInfo(set_y_expand), 'set_z_position': gi.FunctionInfo(set_z_position), 'set_z_rotation_from_gravity': gi.FunctionInfo(set_z_rotation_from_gravity), 'should_pick_paint': gi.FunctionInfo(should_pick_paint), 'show': gi.FunctionInfo(show), 'show_all': gi.FunctionInfo(show_all), 'transform_stage_point': gi.FunctionInfo(transform_stage_point), 'unmap': gi.FunctionInfo(unmap), 'unparent': gi.FunctionInfo(unparent), 'unrealize': gi.FunctionInfo(unrealize), 'unset_flags': gi.FunctionInfo(unset_flags), 'do_allocate': gi.VFuncInfo(allocate), 'do_apply_transform': gi.VFuncInfo(apply_transform), 'do_button_press_event': gi.VFuncInfo(button_press_event), 'do_button_release_event': gi.VFuncInfo(button_release_event), 'do_captured_event': gi.VFuncInfo(captured_event), 'do_destroy': gi.VFuncInfo(destroy), 'do_enter_event': gi.VFuncInfo(enter_event), 'do_event': gi.VFuncInfo(event), 'do_get_accessible': gi.VFuncInfo(get_accessible), 'do_get_paint_volume': gi.VFuncInfo(get_paint_volume), 'do_get_preferred_height': gi.VFuncInfo(get_preferred_height), 'do_get_preferred_width': gi.VFuncInfo(get_preferred_width), 'do_has_overlaps': gi.VFuncInfo(has_overlaps), 'do_hide': gi.VFuncInfo(hide), 'do_hide_all': gi.VFuncInfo(hide_all), 'do_key_focus_in': gi.VFuncInfo(key_focus_in), 'do_key_focus_out': gi.VFuncInfo(key_focus_out), 'do_key_press_event': gi.VFuncInfo(key_press_event), 'do_key_release_event': gi.VFuncInfo(key_release_event), 'do_leave_event': gi.VFuncInfo(leave_event), 'do_map': gi.VFuncInfo(map), 'do_motion_event': gi.VFuncInfo(motion_event), 'do_paint': gi.VFuncInfo(paint), 'do_paint_node': gi.VFuncInfo(paint_node), 'do_parent_set': gi.VFuncInfo(parent_set), 'do_pick': gi.VFuncInfo(pick), 'do_queue_redraw': gi.VFuncInfo(queue_redraw), 'do_queue_relayout': gi.VFuncInfo(queue_relayout), 'do_realize': gi.VFuncInfo(realize), 'do_scroll_event': gi.VFuncInfo(scroll_event), 'do_show': gi.VFuncInfo(show), 'do_show_all': gi.VFuncInfo(show_all), 'do_touch_event': gi.VFuncInfo(touch_event), 'do_unmap': gi.VFuncInfo(unmap), 'do_unrealize': gi.VFuncInfo(unrealize), 'parent_instance': <property object at 0x7f5413e10810>, 'flags': <property object at 0x7f5413e10900>, 'private_flags': <property object at 0x7f5413e109f0>, 'priv': <property object at 0x7f5413e10ae0>})"
    __gdoc__ = 'Object ClutterActor\n\nSignals from ClutterActor:\n  destroy ()\n  show ()\n  hide ()\n  parent-set (ClutterActor)\n  queue-redraw (ClutterActor)\n  queue-relayout ()\n  event (ClutterEvent) -> gboolean\n  button-press-event (ClutterEvent) -> gboolean\n  button-release-event (ClutterEvent) -> gboolean\n  scroll-event (ClutterEvent) -> gboolean\n  key-press-event (ClutterEvent) -> gboolean\n  key-release-event (ClutterEvent) -> gboolean\n  motion-event (ClutterEvent) -> gboolean\n  key-focus-in ()\n  key-focus-out ()\n  enter-event (ClutterEvent) -> gboolean\n  leave-event (ClutterEvent) -> gboolean\n  captured-event (ClutterEvent) -> gboolean\n  paint ()\n  realize ()\n  unrealize ()\n  pick (ClutterColor)\n  allocation-changed (ClutterActorBox, ClutterAllocationFlags)\n  transitions-completed ()\n  transition-stopped (gchararray, gboolean)\n  touch-event (ClutterEvent) -> gboolean\n\nProperties from ClutterActor:\n  name -> gchararray: Name\n    Name of the actor\n  x -> gfloat: X coordinate\n    X coordinate of the actor\n  y -> gfloat: Y coordinate\n    Y coordinate of the actor\n  width -> gfloat: Width\n    Width of the actor\n  height -> gfloat: Height\n    Height of the actor\n  position -> ClutterPoint: Position\n    The position of the origin of the actor\n  size -> ClutterSize: Size\n    The size of the actor\n  fixed-x -> gfloat: Fixed X\n    Forced X position of the actor\n  fixed-y -> gfloat: Fixed Y\n    Forced Y position of the actor\n  fixed-position-set -> gboolean: Fixed position set\n    Whether to use fixed positioning for the actor\n  min-width -> gfloat: Min Width\n    Forced minimum width request for the actor\n  min-width-set -> gboolean: Minimum width set\n    Whether to use the min-width property\n  min-height -> gfloat: Min Height\n    Forced minimum height request for the actor\n  min-height-set -> gboolean: Minimum height set\n    Whether to use the min-height property\n  natural-width -> gfloat: Natural Width\n    Forced natural width request for the actor\n  natural-width-set -> gboolean: Natural width set\n    Whether to use the natural-width property\n  natural-height -> gfloat: Natural Height\n    Forced natural height request for the actor\n  natural-height-set -> gboolean: Natural height set\n    Whether to use the natural-height property\n  request-mode -> ClutterRequestMode: Request Mode\n    The actor’s request mode\n  allocation -> ClutterActorBox: Allocation\n    The actor’s allocation\n  depth -> gfloat: Depth\n    Position on the Z axis\n  z-position -> gfloat: Z Position\n    The actor’s position on the Z axis\n  clip -> ClutterGeometry: Clip\n    The clip region for the actor\n  clip-rect -> ClutterRect: Clip Rectangle\n    The visible region of the actor\n  has-clip -> gboolean: Has Clip\n    Whether the actor has a clip set\n  clip-to-allocation -> gboolean: Clip to Allocation\n    Sets the clip region to track the actor’s allocation\n  opacity -> guint: Opacity\n    Opacity of an actor\n  offscreen-redirect -> ClutterOffscreenRedirect: Offscreen redirect\n    Flags controlling when to flatten the actor into a single image\n  visible -> gboolean: Visible\n    Whether the actor is visible or not\n  mapped -> gboolean: Mapped\n    Whether the actor will be painted\n  realized -> gboolean: Realized\n    Whether the actor has been realized\n  reactive -> gboolean: Reactive\n    Whether the actor is reactive to events\n  pivot-point -> ClutterPoint: Pivot Point\n    The point around which the scaling and rotation occur\n  pivot-point-z -> gfloat: Pivot Point Z\n    Z component of the pivot point\n  scale-x -> gdouble: Scale X\n    Scale factor on the X axis\n  scale-y -> gdouble: Scale Y\n    Scale factor on the Y axis\n  scale-z -> gdouble: Scale Z\n    Scale factor on the Z axis\n  scale-center-x -> gfloat: Scale Center X\n    Horizontal scale center\n  scale-center-y -> gfloat: Scale Center Y\n    Vertical scale center\n  scale-gravity -> ClutterGravity: Scale Gravity\n    The center of scaling\n  rotation-angle-x -> gdouble: Rotation Angle X\n    The rotation angle on the X axis\n  rotation-angle-y -> gdouble: Rotation Angle Y\n    The rotation angle on the Y axis\n  rotation-angle-z -> gdouble: Rotation Angle Z\n    The rotation angle on the Z axis\n  rotation-center-x -> ClutterVertex: Rotation Center X\n    The rotation center on the X axis\n  rotation-center-y -> ClutterVertex: Rotation Center Y\n    The rotation center on the Y axis\n  rotation-center-z -> ClutterVertex: Rotation Center Z\n    The rotation center on the Z axis\n  rotation-center-z-gravity -> ClutterGravity: Rotation Center Z Gravity\n    Center point for rotation around the Z axis\n  anchor-x -> gfloat: Anchor X\n    X coordinate of the anchor point\n  anchor-y -> gfloat: Anchor Y\n    Y coordinate of the anchor point\n  anchor-gravity -> ClutterGravity: Anchor Gravity\n    The anchor point as a ClutterGravity\n  translation-x -> gfloat: Translation X\n    Translation along the X axis\n  translation-y -> gfloat: Translation Y\n    Translation along the Y axis\n  translation-z -> gfloat: Translation Z\n    Translation along the Z axis\n  transform -> ClutterMatrix: Transform\n    Transformation matrix\n  transform-set -> gboolean: Transform Set\n    Whether the transform property is set\n  child-transform -> ClutterMatrix: Child Transform\n    Children transformation matrix\n  child-transform-set -> gboolean: Child Transform Set\n    Whether the child-transform property is set\n  show-on-set-parent -> gboolean: Show on set parent\n    Whether the actor is shown when parented\n  text-direction -> ClutterTextDirection: Text Direction\n    Direction of the text\n  has-pointer -> gboolean: Has Pointer\n    Whether the actor contains the pointer of an input device\n  actions -> ClutterAction: Actions\n    Adds an action to the actor\n  constraints -> ClutterConstraint: Constraints\n    Adds a constraint to the actor\n  effect -> ClutterEffect: Effect\n    Add an effect to be applied on the actor\n  layout-manager -> ClutterLayoutManager: Layout Manager\n    The object controlling the layout of an actor’s children\n  x-expand -> gboolean: X Expand\n    Whether extra horizontal space should be assigned to the actor\n  y-expand -> gboolean: Y Expand\n    Whether extra vertical space should be assigned to the actor\n  x-align -> ClutterActorAlign: X Alignment\n    The alignment of the actor on the X axis within its allocation\n  y-align -> ClutterActorAlign: Y Alignment\n    The alignment of the actor on the Y axis within its allocation\n  margin-top -> gfloat: Margin Top\n    Extra space at the top\n  margin-bottom -> gfloat: Margin Bottom\n    Extra space at the bottom\n  margin-left -> gfloat: Margin Left\n    Extra space at the left\n  margin-right -> gfloat: Margin Right\n    Extra space at the right\n  background-color -> ClutterColor: Background color\n    The actor’s background color\n  background-color-set -> gboolean: Background Color Set\n    Whether the background color is set\n  first-child -> ClutterActor: First Child\n    The actor’s first child\n  last-child -> ClutterActor: Last Child\n    The actor’s last child\n  content -> ClutterContent: Content\n    Delegate object for painting the actor’s content\n  content-gravity -> ClutterContentGravity: Content Gravity\n    Alignment of the actor’s content\n  content-box -> ClutterActorBox: Content Box\n    The bounding box of the actor’s content\n  minification-filter -> ClutterScalingFilter: Minification Filter\n    The filter used when reducing the size of the content\n  magnification-filter -> ClutterScalingFilter: Magnification Filter\n    The filter used when increasing the size of the content\n  content-repeat -> ClutterContentRepeat: Content Repeat\n    The repeat policy for the actor’s content\n\nSignals from ClutterContainer:\n  actor-added (ClutterActor)\n  actor-removed (ClutterActor)\n  child-notify (ClutterActor, GParam)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ClutterActor (94911695361968)>'
