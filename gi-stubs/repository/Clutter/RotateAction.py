...
class RotateAction(GestureAction):
    """
    :Constructors:
    
    ::
    
        RotateAction(**properties)
        new() -> Clutter.Action
    """
    ...
    def do_rotate(self, *args, **kwargs): # real signature unknown
        """ rotate(self, actor:Clutter.Actor, angle:float) -> bool """
        pass
