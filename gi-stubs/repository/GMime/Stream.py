...
class Stream(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc97050c7f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Stream), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStream (94235496223840)>, '__doc__': None, '__gsignals__': {}, 'buffer_gets': gi.FunctionInfo(buffer_gets), 'buffer_readln': gi.FunctionInfo(buffer_readln), 'close': gi.FunctionInfo(close), 'construct': gi.FunctionInfo(construct), 'eos': gi.FunctionInfo(eos), 'flush': gi.FunctionInfo(flush), 'length': gi.FunctionInfo(length), 'read': gi.FunctionInfo(read), 'reset': gi.FunctionInfo(reset), 'seek': gi.FunctionInfo(seek), 'set_bounds': gi.FunctionInfo(set_bounds), 'substream': gi.FunctionInfo(substream), 'tell': gi.FunctionInfo(tell), 'write': gi.FunctionInfo(write), 'write_string': gi.FunctionInfo(write_string), 'write_to_stream': gi.FunctionInfo(write_to_stream), 'writev': gi.FunctionInfo(writev), 'do_close': gi.VFuncInfo(close), 'do_eos': gi.VFuncInfo(eos), 'do_flush': gi.VFuncInfo(flush), 'do_length': gi.VFuncInfo(length), 'do_read': gi.VFuncInfo(read), 'do_reset': gi.VFuncInfo(reset), 'do_seek': gi.VFuncInfo(seek), 'do_substream': gi.VFuncInfo(substream), 'do_tell': gi.VFuncInfo(tell), 'do_write': gi.VFuncInfo(write), 'parent_object': <property object at 0x7fc970750e50>, 'super_stream': <property object at 0x7fc970750f40>, 'position': <property object at 0x7fc970754090>, 'bound_start': <property object at 0x7fc970754180>, 'bound_end': <property object at 0x7fc970754270>})"
    __gdoc__ = 'Object GMimeStream\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStream (94235496223840)>'
