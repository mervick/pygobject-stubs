...
class StreamNull(Stream):
    ...
    def get_count_newlines(self): # real signature unknown; restored from __doc__
        """ get_count_newlines(self) -> bool """
        return False
    ...
    def set_count_newlines(self, count): # real signature unknown; restored from __doc__
        """ set_count_newlines(self, count:bool) """
        pass
    ...
    count_newlines = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    written = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc97050cca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamNull), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamNull (94235496269648)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_count_newlines': gi.FunctionInfo(get_count_newlines), 'set_count_newlines': gi.FunctionInfo(set_count_newlines), 'parent_object': <property object at 0x7fc97075cb80>, 'written': <property object at 0x7fc97075cc70>, 'newlines': <property object at 0x7fc97075cd60>, 'count_newlines': <property object at 0x7fc97075ce50>})"
    __gdoc__ = 'Object GMimeStreamNull\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamNull (94235496269648)>'
