...
class Pkcs7Context(CryptoContext):
    """
    :Constructors:
    
    ::
    
        Pkcs7Context(**properties)
        new() -> GMime.CryptoContext
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc97071ba00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Pkcs7Context), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimePkcs7Context (94235496192896)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    __gdoc__ = 'Object GMimePkcs7Context\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimePkcs7Context (94235496192896)>'
    __info__ = ObjectInfo(Pkcs7Context)
