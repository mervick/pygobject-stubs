...
class StreamFilter(Stream):
    ...
    ::
        ...
        new(stream:GMime.Stream) -> GMime.Stream
    """
    def add(self, filter): # real signature unknown; restored from __doc__
        """ add(self, filter:GMime.Filter) -> int """
        return 0
    ...
    def new(self, stream): # real signature unknown; restored from __doc__
        """ new(stream:GMime.Stream) -> GMime.Stream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc9705e9dc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamFilter), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamFilter (94235496246144)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add': gi.FunctionInfo(add), 'get_owner': gi.FunctionInfo(get_owner), 'remove': gi.FunctionInfo(remove), 'set_owner': gi.FunctionInfo(set_owner), 'parent_object': <property object at 0x7fc970756590>, 'priv': <property object at 0x7fc970756680>, 'source': <property object at 0x7fc970756770>, 'owner': <property object at 0x7fc970756860>})"
    __gdoc__ = 'Object GMimeStreamFilter\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamFilter (94235496246144)>'
