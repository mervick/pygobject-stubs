...
class MultipartSigned(Multipart):
    ...
    def sign(self, ctx, entity, userid): # real signature unknown; restored from __doc__
        """ sign(ctx:GMime.CryptoContext, entity:GMime.Object, userid:str) -> GMime.MultipartSigned or None """
        pass
    ...
    def verify(self, flags): # real signature unknown; restored from __doc__
        """ verify(self, flags:GMime.VerifyFlags) -> GMime.SignatureList or None """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MultipartSigned), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeMultipartSigned (94235496141936)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'sign': gi.FunctionInfo(sign), 'verify': gi.FunctionInfo(verify), 'parent_object': <property object at 0x7fc970740310>})"
    __gdoc__ = 'Object GMimeMultipartSigned\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeMultipartSigned (94235496141936)>'
