...
class StreamFs(Stream):
    ...
    ::
        ...
        StreamFs(**properties)
        new(fd:int) -> GMime.Stream
        new_with_bounds(fd:int, start:int, end:int) -> GMime.Stream
    """
    ...
    def new(self, fd): # real signature unknown; restored from __doc__
        """ new(fd:int) -> GMime.Stream """
        pass
    ...
    def new_with_bounds(self, fd, start, end): # real signature unknown; restored from __doc__
        """ new_with_bounds(fd:int, start:int, end:int) -> GMime.Stream """
        pass
    ...
    def open(self, path, flags, mode): # real signature unknown; restored from __doc__
        """ open(path:str, flags:int, mode:int) -> GMime.Stream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc97050c0d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamFs), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamFs (94235496253584)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_bounds': gi.FunctionInfo(new_with_bounds), 'open': gi.FunctionInfo(open), 'get_owner': gi.FunctionInfo(get_owner), 'set_owner': gi.FunctionInfo(set_owner), 'parent_object': <property object at 0x7fc970756bd0>, 'owner': <property object at 0x7fc970756cc0>, 'eos': <property object at 0x7fc970756db0>, 'fd': <property object at 0x7fc970756ea0>})"
    __gdoc__ = 'Object GMimeStreamFs\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamFs (94235496253584)>'
