...
class StreamPipe(Stream):
    """
    :Constructors:
    
    ::
    
        StreamPipe(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc97050c820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamPipe), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamPipe (94235496057424)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_owner': gi.FunctionInfo(get_owner), 'set_owner': gi.FunctionInfo(set_owner), 'parent_object': <property object at 0x7fc9706de220>, 'owner': <property object at 0x7fc9706de310>, 'eos': <property object at 0x7fc9706de400>, 'fd': <property object at 0x7fc9706de4f0>})"
    __gdoc__ = 'Object GMimeStreamPipe\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamPipe (94235496057424)>'
    __info__ = ObjectInfo(StreamPipe)
