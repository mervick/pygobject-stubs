...
class TextPart(Part):
    ...
    ::
        ...
        TextPart(**properties)
        new() -> GMime.TextPart
        new_with_subtype(subtype:str) -> GMime.TextPart
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc9706e6ca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextPart), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeTextPart (94235496059520)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_subtype': gi.FunctionInfo(new_with_subtype), 'get_charset': gi.FunctionInfo(get_charset), 'get_text': gi.FunctionInfo(get_text), 'set_charset': gi.FunctionInfo(set_charset), 'set_text': gi.FunctionInfo(set_text), 'parent_object': <property object at 0x7fc9706de860>})"
    __gdoc__ = 'Object GMimeTextPart\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeTextPart (94235496059520)>'
    __info__ = ObjectInfo(TextPart)
