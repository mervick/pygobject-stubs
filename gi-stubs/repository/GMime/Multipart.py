...
class Multipart(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc9708b5bb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Multipart), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeMultipart (94235496016224)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_subtype': gi.FunctionInfo(new_with_subtype), 'add': gi.FunctionInfo(add), 'clear': gi.FunctionInfo(clear), 'contains': gi.FunctionInfo(contains), 'foreach': gi.FunctionInfo(foreach), 'get_boundary': gi.FunctionInfo(get_boundary), 'get_count': gi.FunctionInfo(get_count), 'get_epilogue': gi.FunctionInfo(get_epilogue), 'get_part': gi.FunctionInfo(get_part), 'get_prologue': gi.FunctionInfo(get_prologue), 'get_subpart_from_content_id': gi.FunctionInfo(get_subpart_from_content_id), 'index_of': gi.FunctionInfo(index_of), 'insert': gi.FunctionInfo(insert), 'remove': gi.FunctionInfo(remove), 'remove_at': gi.FunctionInfo(remove_at), 'replace': gi.FunctionInfo(replace), 'set_boundary': gi.FunctionInfo(set_boundary), 'set_epilogue': gi.FunctionInfo(set_epilogue), 'set_prologue': gi.FunctionInfo(set_prologue), 'do_add': gi.VFuncInfo(add), 'do_clear': gi.VFuncInfo(clear), 'do_contains': gi.VFuncInfo(contains), 'do_get_boundary': gi.VFuncInfo(get_boundary), 'do_get_count': gi.VFuncInfo(get_count), 'do_get_part': gi.VFuncInfo(get_part), 'do_index_of': gi.VFuncInfo(index_of), 'do_insert': gi.VFuncInfo(insert), 'do_remove': gi.VFuncInfo(remove), 'do_remove_at': gi.VFuncInfo(remove_at), 'do_set_boundary': gi.VFuncInfo(set_boundary), 'parent_object': <property object at 0x7fc97073cc20>, 'children': <property object at 0x7fc97073cd10>, 'boundary': <property object at 0x7fc97073ce00>, 'prologue': <property object at 0x7fc97073cef0>, 'epilogue': <property object at 0x7fc97073f040>, 'write_end_boundary': <property object at 0x7fc97073f180>})"
    __gdoc__ = 'Object GMimeMultipart\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeMultipart (94235496016224)>'
