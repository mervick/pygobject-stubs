...
class StreamGIO(Stream):
    """
    :Constructors:
    
    ::
    
        StreamGIO(**properties)
        new(file:Gio.File) -> GMime.Stream
        new_with_bounds(file:Gio.File, start:int, end:int) -> GMime.Stream
    """
    ...
    def new_with_bounds(self, file, start, end): # real signature unknown; restored from __doc__
        """ new_with_bounds(file:Gio.File, start:int, end:int) -> GMime.Stream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc9705e9430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamGIO), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamGIO (94235496248192)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_bounds': gi.FunctionInfo(new_with_bounds), 'get_owner': gi.FunctionInfo(get_owner), 'set_owner': gi.FunctionInfo(set_owner), 'parent_object': <property object at 0x7fc97075a220>, 'ostream': <property object at 0x7fc97075a310>, 'istream': <property object at 0x7fc97075a400>, 'file': <property object at 0x7fc97075a4f0>, 'owner': <property object at 0x7fc97075a5e0>, 'eos': <property object at 0x7fc97075a6d0>})"
    __gdoc__ = 'Object GMimeStreamGIO\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamGIO (94235496248192)>'
    __info__ = ObjectInfo(StreamGIO)
