...
class Object(__gi_overrides_GObject.Object):
    ...
    ::
        ...
        Object(**properties)
        new(options:GMime.ParserOptions=None, content_type:GMime.ContentType) -> GMime.Object
    ...
    def new(self, options=None, content_type): # real signature unknown; restored from __doc__
        """ new(options:GMime.ParserOptions=None, content_type:GMime.ContentType) -> GMime.Object """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc970759f40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Object), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeObject (94235495492304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_type': gi.FunctionInfo(new_type), 'register_type': gi.FunctionInfo(register_type), 'type_registry_init': gi.FunctionInfo(type_registry_init), 'type_registry_shutdown': gi.FunctionInfo(type_registry_shutdown), 'append_header': gi.FunctionInfo(append_header), 'encode': gi.FunctionInfo(encode), 'get_content_disposition': gi.FunctionInfo(get_content_disposition), 'get_content_disposition_parameter': gi.FunctionInfo(get_content_disposition_parameter), 'get_content_id': gi.FunctionInfo(get_content_id), 'get_content_type': gi.FunctionInfo(get_content_type), 'get_content_type_parameter': gi.FunctionInfo(get_content_type_parameter), 'get_disposition': gi.FunctionInfo(get_disposition), 'get_header': gi.FunctionInfo(get_header), 'get_header_list': gi.FunctionInfo(get_header_list), 'get_headers': gi.FunctionInfo(get_headers), 'prepend_header': gi.FunctionInfo(prepend_header), 'remove_header': gi.FunctionInfo(remove_header), 'set_content_disposition': gi.FunctionInfo(set_content_disposition), 'set_content_disposition_parameter': gi.FunctionInfo(set_content_disposition_parameter), 'set_content_id': gi.FunctionInfo(set_content_id), 'set_content_type': gi.FunctionInfo(set_content_type), 'set_content_type_parameter': gi.FunctionInfo(set_content_type_parameter), 'set_disposition': gi.FunctionInfo(set_disposition), 'set_header': gi.FunctionInfo(set_header), 'to_string': gi.FunctionInfo(to_string), 'write_to_stream': gi.FunctionInfo(write_to_stream), 'do_encode': gi.VFuncInfo(encode), 'do_get_headers': gi.VFuncInfo(get_headers), 'do_header_added': gi.VFuncInfo(header_added), 'do_header_changed': gi.VFuncInfo(header_changed), 'do_header_removed': gi.VFuncInfo(header_removed), 'do_headers_cleared': gi.VFuncInfo(headers_cleared), 'do_set_content_type': gi.VFuncInfo(set_content_type), 'do_write_to_stream': gi.VFuncInfo(write_to_stream), 'parent_object': <property object at 0x7fc9708c2db0>, 'disposition': <property object at 0x7fc9708c2e00>, 'content_type': <property object at 0x7fc9708c2e50>, 'headers': <property object at 0x7fc9708c2ea0>, 'content_id': <property object at 0x7fc9708c2f90>, 'ensure_newline': <property object at 0x7fc9708bd0e0>})"
    __gdoc__ = 'Object GMimeObject\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeObject (94235495492304)>'
