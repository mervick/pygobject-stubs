...
class StreamCat(Stream):
    ...
    def add_source(self, source): # real signature unknown; restored from __doc__
        """ add_source(self, source:GMime.Stream) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc9705e9a60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamCat), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamCat (94235496239744)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_source': gi.FunctionInfo(add_source), 'parent_object': <property object at 0x7fc970754ef0>, 'sources': <property object at 0x7fc970755040>, 'current': <property object at 0x7fc970755130>})"
    __gdoc__ = 'Object GMimeStreamCat\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamCat (94235496239744)>'
    __info__ = ObjectInfo(StreamCat)
