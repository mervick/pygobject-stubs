...
class StreamFile(Stream):
    ...
    ::
        ...
        new(fp=None) -> GMime.Stream
        new_with_bounds(fp=None, start:int, end:int) -> GMime.Stream
    """
    ...
    def new(self, fp=None): # real signature unknown; restored from __doc__
        """ new(fp=None) -> GMime.Stream """
        pass
    ...
    def new_with_bounds(self, fp=None, start, end): # real signature unknown; restored from __doc__
        """ new_with_bounds(fp=None, start:int, end:int) -> GMime.Stream """
        pass
    ...
    def open(self, path, mode): # real signature unknown; restored from __doc__
        """ open(path:str, mode:str) -> GMime.Stream """
        pass
    ...
    fp = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc9705e9460>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamFile), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamFile (94235496242016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_bounds': gi.FunctionInfo(new_with_bounds), 'open': gi.FunctionInfo(open), 'get_owner': gi.FunctionInfo(get_owner), 'set_owner': gi.FunctionInfo(set_owner), 'parent_object': <property object at 0x7fc970756040>, 'owner': <property object at 0x7fc970756130>, 'fp': <property object at 0x7fc970756220>})"
    __gdoc__ = 'Object GMimeStreamFile\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamFile (94235496242016)>'
    __info__ = ObjectInfo(StreamFile)
