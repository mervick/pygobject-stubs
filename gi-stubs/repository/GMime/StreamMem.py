...
class StreamMem(Stream):
    ...
    ::
        ...
        new() -> GMime.Stream
        new_with_buffer(buffer:list) -> GMime.Stream
        new_with_byte_array(array:list) -> GMime.Stream
    """
    ...
    def new_with_byte_array(self, array): # real signature unknown; restored from __doc__
        """ new_with_byte_array(array:list) -> GMime.Stream """
        pass
    ...
    def set_byte_array(self, array): # real signature unknown; restored from __doc__
        """ set_byte_array(self, array:list) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc970437bb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamMem), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamMem (94235496254976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_buffer': gi.FunctionInfo(new_with_buffer), 'new_with_byte_array': gi.FunctionInfo(new_with_byte_array), 'get_byte_array': gi.FunctionInfo(get_byte_array), 'get_owner': gi.FunctionInfo(get_owner), 'set_byte_array': gi.FunctionInfo(set_byte_array), 'set_owner': gi.FunctionInfo(set_owner), 'parent_object': <property object at 0x7fc971c92270>, 'buffer': <property object at 0x7fc97075ae00>, 'owner': <property object at 0x7fc97075aef0>})"
    __gdoc__ = 'Object GMimeStreamMem\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamMem (94235496254976)>'
