...
class StreamMmap(Stream):
    """
    :Constructors:
    
    ::
    
        StreamMmap(**properties)
        new(fd:int, prot:int, flags:int) -> GMime.Stream
        new_with_bounds(fd:int, prot:int, flags:int, start:int, end:int) -> GMime.Stream
    """
    ...
    def new(self, fd, prot, flags): # real signature unknown; restored from __doc__
        """ new(fd:int, prot:int, flags:int) -> GMime.Stream """
        pass
    ...
    def new_with_bounds(self, fd, prot, flags, start, end): # real signature unknown; restored from __doc__
        """ new_with_bounds(fd:int, prot:int, flags:int, start:int, end:int) -> GMime.Stream """
        pass
    ...
    maplen = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc970437c40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamMmap), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeStreamMmap (94235496255216)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_bounds': gi.FunctionInfo(new_with_bounds), 'get_owner': gi.FunctionInfo(get_owner), 'set_owner': gi.FunctionInfo(set_owner), 'parent_object': <property object at 0x7fc97075c2c0>, 'owner': <property object at 0x7fc97075c3b0>, 'eos': <property object at 0x7fc97075c4a0>, 'fd': <property object at 0x7fc97075c590>, 'map': <property object at 0x7fc97075c680>, 'maplen': <property object at 0x7fc97075c770>})"
    __gdoc__ = 'Object GMimeStreamMmap\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeStreamMmap (94235496255216)>'
    __info__ = ObjectInfo(StreamMmap)
