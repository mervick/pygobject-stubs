...
class MessagePartial(Part):
    ...
    ::
        ...
        new(id:str, number:int, total:int) -> GMime.MessagePartial
    """
    ...
    def new(self, id, number, total): # real signature unknown; restored from __doc__
        """ new(id:str, number:int, total:int) -> GMime.MessagePartial """
        pass
    ...
    def reconstruct_message(self, partials, num): # real signature unknown; restored from __doc__
        """ reconstruct_message(partials:GMime.MessagePartial, num:int) -> GMime.Message """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc97071b160>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MessagePartial), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeMessagePartial (94235496122080)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'reconstruct_message': gi.FunctionInfo(reconstruct_message), 'get_id': gi.FunctionInfo(get_id), 'get_number': gi.FunctionInfo(get_number), 'get_total': gi.FunctionInfo(get_total), 'parent_object': <property object at 0x7fc97073c540>, 'number': <property object at 0x7fc97073c630>, 'total': <property object at 0x7fc97073c720>, 'id': <property object at 0x7fc97073c810>})"
    __gdoc__ = 'Object GMimeMessagePartial\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeMessagePartial (94235496122080)>'
    __info__ = ObjectInfo(MessagePartial)
