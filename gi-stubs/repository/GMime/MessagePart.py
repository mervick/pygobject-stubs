...
class MessagePart(Object):
    ...
    ::
        ...
        new(subtype:str) -> GMime.MessagePart
        new_with_message(subtype:str, message:GMime.Message) -> GMime.MessagePart
    """
    ...
    def get_message(self): # real signature unknown; restored from __doc__
        """ get_message(self) -> GMime.Message """
        pass
    ...
    def new(self, subtype): # real signature unknown; restored from __doc__
        """ new(subtype:str) -> GMime.MessagePart """
        pass
    ...
    def new_with_message(self, subtype, message): # real signature unknown; restored from __doc__
        """ new_with_message(subtype:str, message:GMime.Message) -> GMime.MessagePart """
        pass
    ...
    def set_message(self, message): # real signature unknown; restored from __doc__
        """ set_message(self, message:GMime.Message) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MessagePart), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimeMessagePart (94235496117840)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_message': gi.FunctionInfo(new_with_message), 'get_message': gi.FunctionInfo(get_message), 'set_message': gi.FunctionInfo(set_message), 'parent_object': <property object at 0x7fc97073c040>, 'message': <property object at 0x7fc97073c130>})"
    __gdoc__ = 'Object GMimeMessagePart\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimeMessagePart (94235496117840)>'
    __info__ = ObjectInfo(MessagePart)
