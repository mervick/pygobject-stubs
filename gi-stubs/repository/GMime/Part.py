...
class Part(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc9708961f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Part), '__module__': 'gi.repository.GMime', '__gtype__': <GType GMimePart (94235495496608)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_type': gi.FunctionInfo(new_with_type), 'get_best_content_encoding': gi.FunctionInfo(get_best_content_encoding), 'get_content': gi.FunctionInfo(get_content), 'get_content_description': gi.FunctionInfo(get_content_description), 'get_content_encoding': gi.FunctionInfo(get_content_encoding), 'get_content_id': gi.FunctionInfo(get_content_id), 'get_content_location': gi.FunctionInfo(get_content_location), 'get_content_md5': gi.FunctionInfo(get_content_md5), 'get_filename': gi.FunctionInfo(get_filename), 'get_openpgp_data': gi.FunctionInfo(get_openpgp_data), 'is_attachment': gi.FunctionInfo(is_attachment), 'openpgp_decrypt': gi.FunctionInfo(openpgp_decrypt), 'openpgp_encrypt': gi.FunctionInfo(openpgp_encrypt), 'openpgp_sign': gi.FunctionInfo(openpgp_sign), 'openpgp_verify': gi.FunctionInfo(openpgp_verify), 'set_content': gi.FunctionInfo(set_content), 'set_content_description': gi.FunctionInfo(set_content_description), 'set_content_encoding': gi.FunctionInfo(set_content_encoding), 'set_content_id': gi.FunctionInfo(set_content_id), 'set_content_location': gi.FunctionInfo(set_content_location), 'set_content_md5': gi.FunctionInfo(set_content_md5), 'set_filename': gi.FunctionInfo(set_filename), 'set_openpgp_data': gi.FunctionInfo(set_openpgp_data), 'verify_content_md5': gi.FunctionInfo(verify_content_md5), 'do_set_content': gi.VFuncInfo(set_content), 'parent_object': <property object at 0x7fc9708bd590>, 'encoding': <property object at 0x7fc9708bd680>, 'openpgp': <property object at 0x7fc9708bd770>, 'content_description': <property object at 0x7fc9708bd8b0>, 'content_location': <property object at 0x7fc9708bd9f0>, 'content_md5': <property object at 0x7fc9708bdae0>, 'content': <property object at 0x7fc9708bdbd0>})"
    __gdoc__ = 'Object GMimePart\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMimePart (94235495496608)>'
    __info__ = ObjectInfo(Part)
