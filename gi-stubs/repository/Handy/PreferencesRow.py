...
class PreferencesRow(__gi_repository_Gtk.ListBoxRow):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType HdyPreferencesRow (93893293845312)>'
