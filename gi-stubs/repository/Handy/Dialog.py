...
class Dialog(__gi_overrides_Gtk.Dialog):
    ...
    ::
        ...
        Dialog(**properties)
        new(parent:Gtk.Window) -> Gtk.Widget
    """
    ...
    def get_narrow(self): # real signature unknown; restored from __doc__
        """ get_narrow(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4ea0bceb50>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
