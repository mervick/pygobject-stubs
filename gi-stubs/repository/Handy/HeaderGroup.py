...
class HeaderGroup(__gi_overrides_GObject.Object, __gi_repository_Gtk.Buildable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4ea0d85b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HeaderGroup), '__module__': 'gi.repository.Handy', '__gtype__': <GType HdyHeaderGroup (93893295071360)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_header_bar': gi.FunctionInfo(add_header_bar), 'get_focus': gi.FunctionInfo(get_focus), 'get_header_bars': gi.FunctionInfo(get_header_bars), 'remove_header_bar': gi.FunctionInfo(remove_header_bar), 'set_focus': gi.FunctionInfo(set_focus), 'parent_instance': <property object at 0x7f4ea0d65bd0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType HdyHeaderGroup (93893295071360)>'
