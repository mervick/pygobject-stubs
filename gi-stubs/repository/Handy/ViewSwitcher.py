...
class ViewSwitcher(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType HdyViewSwitcher (93893295297344)>'
