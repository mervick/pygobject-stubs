...
class ViewSwitcherBar(__gi_repository_Gtk.Bin):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType HdyViewSwitcherBar (93893295295344)>'
