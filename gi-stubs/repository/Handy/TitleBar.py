...
class TitleBar(__gi_repository_Gtk.Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4ea079ec40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TitleBar), '__module__': 'gi.repository.Handy', '__gtype__': <GType HdyTitleBar (93893295283056)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_selection_mode': gi.FunctionInfo(get_selection_mode), 'set_selection_mode': gi.FunctionInfo(set_selection_mode)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType HdyTitleBar (93893295283056)>'
