...
class PreferencesGroup(__gi_repository_Gtk.Bin):
    ...
    def get_size_group(self, column): # real signature unknown; restored from __doc__
        """ get_size_group(self, column:int) -> Gtk.SizeGroup """
        pass
    ...
    def refilter(self, spec): # real signature unknown; restored from __doc__
        """ refilter(self, spec:Dazzle.PatternSpec) -> int """
        return 0
