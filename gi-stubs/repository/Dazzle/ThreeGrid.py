...
class ThreeGrid(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    
    ::
    
        ThreeGrid(**properties)
        new() -> Gtk.Widget
    """
