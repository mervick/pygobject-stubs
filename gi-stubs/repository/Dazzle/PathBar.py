...
class PathBar(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def set_path(self, path): # real signature unknown; restored from __doc__
        """ set_path(self, path:Dazzle.Path) """
        pass
    ...
    def set_selected_index(self, index): # real signature unknown; restored from __doc__
        """ set_selected_index(self, index:int) """
        pass
