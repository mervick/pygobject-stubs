...
class ListBox(__gi_repository_Gtk.ListBox):
    """
    :Constructors:
    ...
    ::
        ...
        ListBox(**properties)
        new(row_type:GType, property_name:str) -> Gtk.Widget
    """
    ...
    def get_row_type(self): # real signature unknown; restored from __doc__
        """ get_row_type(self) -> GType """
        pass
    ...
    def new(self, row_type, property_name): # real signature unknown; restored from __doc__
        """ new(row_type:GType, property_name:str) -> Gtk.Widget """
        pass
    ...
    def set_recycle_max(self, recycle_max): # real signature unknown; restored from __doc__
        """ set_recycle_max(self, recycle_max:int) """
        pass
