...
class SimpleLabel(__gi_overrides_Gtk.Widget):
    """
    :Constructors:
    
    ::
    
        SimpleLabel(**properties)
    ...
    def set_width_chars(self, width_chars): # real signature unknown; restored from __doc__
        """ set_width_chars(self, width_chars:int) """
        pass
