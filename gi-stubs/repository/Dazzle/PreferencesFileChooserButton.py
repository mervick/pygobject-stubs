...
class PreferencesFileChooserButton(PreferencesBin):
    """
    :Constructors:
    
    ::
    
        PreferencesFileChooserButton(**properties)
    """
