...
class EmptyState(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    ...
    def set_resource(self, resource): # real signature unknown; restored from __doc__
        """ set_resource(self, resource:str) """
        pass
    ...
    def set_subtitle(self, title): # real signature unknown; restored from __doc__
        """ set_subtitle(self, title:str) """
        pass
