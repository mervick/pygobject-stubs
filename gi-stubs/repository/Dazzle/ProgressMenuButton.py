...
class ProgressMenuButton(__gi_repository_Gtk.MenuButton):
    """
    :Constructors:
    
    ::
    
        ProgressMenuButton(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_show_progress(self): # real signature unknown; restored from __doc__
        """ get_show_progress(self) -> bool """
        return False

    def get_show_theatric(self): # real signature unknown; restored from __doc__
        """ get_show_theatric(self) -> bool """
        return False
    ...
    def reset_theatrics(self): # real signature unknown; restored from __doc__
        """ reset_theatrics(self) """
        pass
    ...
    def set_show_theatric(self, show_theatic): # real signature unknown; restored from __doc__
        """ set_show_theatric(self, show_theatic:bool) """
        pass
