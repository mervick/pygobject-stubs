...
class ProgressIcon(__gi_repository_Gtk.DrawingArea):
    """
    :Constructors:
    
    ::
    
        ProgressIcon(**properties)
        new() -> Gtk.Widget
    """
