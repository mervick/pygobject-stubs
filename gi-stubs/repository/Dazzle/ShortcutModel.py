...
class ShortcutModel(__gi_overrides_Gtk.TreeStore):
    """
    :Constructors:
    
    ::
    
        ShortcutModel(**properties)
    """
    ...
    def set_chord(self, iter, chord): # real signature unknown; restored from __doc__
        """ set_chord(self, iter:Gtk.TreeIter, chord:Dazzle.ShortcutChord) """
        pass
    ...
    def set_manager(self, manager): # real signature unknown; restored from __doc__
        """ set_manager(self, manager:Dazzle.ShortcutManager) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f3b25cb5490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ShortcutModel), '__module__': 'gi.repository.Dazzle', '__gtype__': <GType DzlShortcutModel (93962411714672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_manager': gi.FunctionInfo(get_manager), 'get_theme': gi.FunctionInfo(get_theme), 'rebuild': gi.FunctionInfo(rebuild), 'set_chord': gi.FunctionInfo(set_chord), 'set_manager': gi.FunctionInfo(set_manager), 'set_theme': gi.FunctionInfo(set_theme)})"
    __gdoc__ = 'Object DzlShortcutModel\n\nProperties from DzlShortcutModel:\n  manager -> DzlShortcutManager: Manager\n    Manager\n  theme -> DzlShortcutTheme: Theme\n    Theme\n\nSignals from GtkTreeModel:\n  row-changed (GtkTreePath, GtkTreeIter)\n  row-inserted (GtkTreePath, GtkTreeIter)\n  row-has-child-toggled (GtkTreePath, GtkTreeIter)\n  row-deleted (GtkTreePath)\n  rows-reordered (GtkTreePath, GtkTreeIter, gpointer)\n\nSignals from GtkTreeSortable:\n  sort-column-changed ()\n\nSignals from GtkTreeModel:\n  row-changed (GtkTreePath, GtkTreeIter)\n  row-inserted (GtkTreePath, GtkTreeIter)\n  row-has-child-toggled (GtkTreePath, GtkTreeIter)\n  row-deleted (GtkTreePath)\n  rows-reordered (GtkTreePath, GtkTreeIter, gpointer)\n\nSignals from GtkTreeSortable:\n  sort-column-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DzlShortcutModel (93962411714672)>'
    __info__ = ObjectInfo(ShortcutModel)
