...
class PreferencesEntry(PreferencesBin):
    """
    :Constructors:
    
    ::
    
        PreferencesEntry(**properties)
    """
    ...
    def do_connect(self, *args, **kwargs): # real signature unknown
        """ connect(self, settings:Gio.Settings) """
        pass
    ...
    def do_disconnect(self, *args, **kwargs): # real signature unknown
        """ disconnect(self, settings:Gio.Settings) """
        pass
    ...
    def do_matches(self, *args, **kwargs): # real signature unknown
        """ matches(self, spec:Dazzle.PatternSpec) -> bool """
        pass
    ...
    def get_entry_widget(self): # real signature unknown; restored from __doc__
        """ get_entry_widget(self) -> Gtk.Widget """
        pass
    ...
    def get_title_widget(self): # real signature unknown; restored from __doc__
        """ get_title_widget(self) -> Gtk.Widget """
        pass
