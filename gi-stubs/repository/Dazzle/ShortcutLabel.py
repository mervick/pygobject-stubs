...
class ShortcutLabel(__gi_overrides_Gtk.Box):
    ...
    def get_chord(self): # real signature unknown; restored from __doc__
        """ get_chord(self) -> Dazzle.ShortcutChord or None """
        pass
    ...
    def set_chord(self, chord): # real signature unknown; restored from __doc__
        """ set_chord(self, chord:Dazzle.ShortcutChord) """
        pass
