...
class PreferencesFlowBox(ColumnLayout):
    """
    :Constructors:
    
    ::
    
        PreferencesFlowBox(**properties)
        new() -> Gtk.Widget
    """
