...
class ShortcutSimpleLabel(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        ShortcutSimpleLabel(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_command(self): # real signature unknown; restored from __doc__
    ...
    def set_accel(self, accel): # real signature unknown; restored from __doc__
        """ set_accel(self, accel:str) """
        pass
    ...
    def set_command(self, command): # real signature unknown; restored from __doc__
