...
class SimplePopover(__gi_repository_Gtk.Popover):
    """
    :Constructors:
    ...
    def do_insert_text(self, *args, **kwargs): # real signature unknown
        """ insert_text(self, position:int, chars:str, n_chars:int) -> bool """
        pass
    ...
    def get_button_text(self): # real signature unknown; restored from __doc__
        """ get_button_text(self) -> str """
        return ""
    ...
    def set_button_text(self, button_text): # real signature unknown; restored from __doc__
        """ set_button_text(self, button_text:str) """
        pass
    ...
    def set_ready(self, ready): # real signature unknown; restored from __doc__
        """ set_ready(self, ready:bool) """
        pass
