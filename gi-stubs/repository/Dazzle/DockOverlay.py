...
class DockOverlay(__gi_repository_Gtk.EventBox, Dock, DockItem):
    """
    :Constructors:
    
    ::
    
        DockOverlay(**properties)
        new() -> Gtk.Widget
    """
    ...
    def do_hide_edges(self, *args, **kwargs): # real signature unknown
        """ hide_edges(self) """
        pass
    ...
    def get_edge(self, position): # real signature unknown; restored from __doc__
        """ get_edge(self, position:Gtk.PositionType) -> Dazzle.DockOverlayEdge """
        pass

    def get_edge_adjustment(self, position): # real signature unknown; restored from __doc__
        """ get_edge_adjustment(self, position:Gtk.PositionType) -> Gtk.Adjustment """
        pass
