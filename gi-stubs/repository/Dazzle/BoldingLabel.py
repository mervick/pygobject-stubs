...
class BoldingLabel(__gi_overrides_Gtk.Label):
    """
    :Constructors:
    
    ::
    
        BoldingLabel(**properties)
        new(str:str, bold:bool) -> Dazzle.BoldingLabel
        new_with_mnemonic(str:str, bold:bool) -> Dazzle.BoldingLabel
    """
    ...
    def new(self, p_str, bold): # real signature unknown; restored from __doc__
        """ new(str:str, bold:bool) -> Dazzle.BoldingLabel """
        pass
    ...
    def new_with_mnemonic(self, p_str, bold): # real signature unknown; restored from __doc__
        """ new_with_mnemonic(str:str, bold:bool) -> Dazzle.BoldingLabel """
        pass
    ...
    def set_bold(self, bold): # real signature unknown; restored from __doc__
        """ set_bold(self, bold:bool) """
        pass
