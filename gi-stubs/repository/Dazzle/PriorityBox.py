...
class PriorityBox(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        PriorityBox(**properties)
        new() -> Gtk.Widget
    """
