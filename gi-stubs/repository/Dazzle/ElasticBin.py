...
class ElasticBin(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    
    ::
    
        ElasticBin(**properties)
        new() -> Gtk.Widget
    """
