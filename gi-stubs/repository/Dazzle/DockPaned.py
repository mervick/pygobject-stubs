...
class DockPaned(MultiPaned, DockItem):
    """
    :Constructors:
    
    ::
    
        DockPaned(**properties)
        new() -> Gtk.Widget
    """
