...
class SuggestionRow(ListBoxRow, __gi_repository_Gtk.Orientable):
    """
    :Constructors:
    
    ::
    
        SuggestionRow(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_suggestion(self): # real signature unknown; restored from __doc__
        """ get_suggestion(self) -> Dazzle.Suggestion """
        pass
