...
class MultiPaned(__gi_overrides_Gtk.Container, __gi_repository_Gtk.Orientable):
    """
    :Constructors:
    
    ::
    
        MultiPaned(**properties)
        new() -> Gtk.Widget
    """
    ...
    def do_resize_drag_begin(self, *args, **kwargs): # real signature unknown
        """ resize_drag_begin(self, child:Gtk.Widget) """
        pass

    def do_resize_drag_end(self, *args, **kwargs): # real signature unknown
        """ resize_drag_end(self, child:Gtk.Widget) """
        pass
    ...
    def get_at_point(self, x, y): # real signature unknown; restored from __doc__
        """ get_at_point(self, x:int, y:int) -> Gtk.Widget or None """
        pass
    ...
    def get_nth_child(self, nth): # real signature unknown; restored from __doc__
        """ get_nth_child(self, nth:int) -> Gtk.Widget """
        pass
