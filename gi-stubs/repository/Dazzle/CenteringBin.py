...
class CenteringBin(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    
    ::
    
        CenteringBin(**properties)
        new() -> Gtk.Widget
    """
