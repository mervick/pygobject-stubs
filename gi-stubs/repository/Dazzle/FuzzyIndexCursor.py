...
class FuzzyIndexCursor(__gi_overrides_GObject.Object, __gi_repository_Gio.AsyncInitable, __gi_overrides_Gio.ListModel):
    """
    :Constructors:
    
    ::
    
        FuzzyIndexCursor(**properties)
    """
    ...
    def get_index(self): # real signature unknown; restored from __doc__
        """ get_index(self) -> Dazzle.FuzzyIndex """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f3b248d2f10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FuzzyIndexCursor), '__module__': 'gi.repository.Dazzle', '__gtype__': <GType DzlFuzzyIndexCursor (93962411460176)>, '__doc__': None, '__gsignals__': {}, 'get_index': gi.FunctionInfo(get_index)})"
    __gdoc__ = 'Object DzlFuzzyIndexCursor\n\nProperties from DzlFuzzyIndexCursor:\n  case-sensitive -> gboolean: Case Sensitive\n    Case Sensitive\n  index -> DzlFuzzyIndex: Index\n    The index this cursor is iterating\n  tables -> GVariantDict: Tables\n    The dictionary of character indexes\n  max-matches -> guint: Max Matches\n    The max number of matches to display\n  query -> gchararray: Query\n    The query for the index\n\nSignals from GListModel:\n  items-changed (guint, guint, guint)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DzlFuzzyIndexCursor (93962411460176)>'
    __info__ = ObjectInfo(FuzzyIndexCursor)
