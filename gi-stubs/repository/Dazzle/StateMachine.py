...
class StateMachine(__gi_overrides_GObject.Object, __gi_repository_Gtk.Buildable):
    """
    :Constructors:
    ...
    ::
        ...
        new() -> Dazzle.StateMachine
    """
    def add_binding(self, state, source_object=None, source_property, target_object=None, target_property, flags): # real signature unknown; restored from __doc__
        """ add_binding(self, state:str, source_object=None, source_property:str, target_object=None, target_property:str, flags:GObject.BindingFlags) """
        pass
    ...
    def add_propertyv(self, state, p_object=None, property, value): # real signature unknown; restored from __doc__
        """ add_propertyv(self, state:str, object=None, property:str, value:GObject.Value) """
        pass

    def add_style(self, state, widget, style): # real signature unknown; restored from __doc__
        """ add_style(self, state:str, widget:Gtk.Widget, style:str) """
        pass
    ...
    def create_action(self, name): # real signature unknown; restored from __doc__
        """ create_action(self, name:str) -> Gio.Action """
        pass
    ...
    def is_state(self, state=None): # real signature unknown; restored from __doc__
        """ is_state(self, state:str=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f3b25efe790>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StateMachine), '__module__': 'gi.repository.Dazzle', '__gtype__': <GType DzlStateMachine (93962411777792)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_binding': gi.FunctionInfo(add_binding), 'add_propertyv': gi.FunctionInfo(add_propertyv), 'add_style': gi.FunctionInfo(add_style), 'create_action': gi.FunctionInfo(create_action), 'get_state': gi.FunctionInfo(get_state), 'is_state': gi.FunctionInfo(is_state), 'set_state': gi.FunctionInfo(set_state), 'parent_instance': <property object at 0x7f3b25f62c20>})"
    __gdoc__ = 'Object DzlStateMachine\n\nProperties from DzlStateMachine:\n  state -> gchararray: State\n    The current state of the machine.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DzlStateMachine (93962411777792)>'
    __info__ = ObjectInfo(StateMachine)
