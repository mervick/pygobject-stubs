...
class ApplicationWindow(__gi_repository_Gtk.ApplicationWindow):
    ...
    def do_get_fullscreen(self, *args, **kwargs): # real signature unknown
    ...
    def do_set_fullscreen(self, *args, **kwargs): # real signature unknown
    ...
    def new(self, application): # real signature unknown; restored from __doc__
    ...
    def set_titlebar(self, titlebar): # real signature unknown; restored from __doc__
        """ set_titlebar(self, titlebar:Gtk.Widget) """
        pass
