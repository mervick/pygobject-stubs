...
class Slider(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    def add_slider(self, widget, position): # real signature unknown; restored from __doc__
        """ add_slider(self, widget:Gtk.Widget, position:Dazzle.SliderPosition) """
        pass
    ...
    def get_position(self): # real signature unknown; restored from __doc__
        """ get_position(self) -> Dazzle.SliderPosition """
        pass
    ...
    def set_position(self, position): # real signature unknown; restored from __doc__
        """ set_position(self, position:Dazzle.SliderPosition) """
        pass
