...
class DockStack(__gi_overrides_Gtk.Box, DockItem):
    """
    :Constructors:
    
    ::
    
        DockStack(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_show_pinned_button(self): # real signature unknown; restored from __doc__
        """ get_show_pinned_button(self) -> bool """
        return False
    ...
    def set_show_pinned_button(self, show_pinned_button): # real signature unknown; restored from __doc__
        """ set_show_pinned_button(self, show_pinned_button:bool) """
        pass
