...
class PropertiesGroup(__gi_overrides_GObject.Object, __gi_repository_Gio.ActionGroup):
    """
    :Constructors:
    ...
    ::
        ...
        new(object:GObject.Object) -> Dazzle.PropertiesGroup
        new_for_type(object_type:GType) -> Dazzle.PropertiesGroup
    """
    ...
    def add_all_properties(self): # real signature unknown; restored from __doc__
        """ add_all_properties(self) """
        pass

    def add_property(self, name, property_name): # real signature unknown; restored from __doc__
        """ add_property(self, name:str, property_name:str) """
        pass

    def add_property_full(self, name, property_name, flags): # real signature unknown; restored from __doc__
        """ add_property_full(self, name:str, property_name:str, flags:Dazzle.PropertiesFlags) """
        pass
    ...
    def new(self, p_object): # real signature unknown; restored from __doc__
        """ new(object:GObject.Object) -> Dazzle.PropertiesGroup """
        pass
    ...
    def new_for_type(self, object_type): # real signature unknown; restored from __doc__
        """ new_for_type(object_type:GType) -> Dazzle.PropertiesGroup """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f3b248d2910>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PropertiesGroup), '__module__': 'gi.repository.Dazzle', '__gtype__': <GType DzlPropertiesGroup (93962411625472)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_type': gi.FunctionInfo(new_for_type), 'add_all_properties': gi.FunctionInfo(add_all_properties), 'add_property': gi.FunctionInfo(add_property), 'add_property_full': gi.FunctionInfo(add_property_full), 'remove': gi.FunctionInfo(remove)})"
    __gdoc__ = 'Object DzlPropertiesGroup\n\nProperties from DzlPropertiesGroup:\n  object -> GObject: Object\n    The source object for the properties\n  object-type -> GType: Object Type\n    A type the object must conform to.\n\nSignals from GActionGroup:\n  action-added (gchararray)\n  action-removed (gchararray)\n  action-enabled-changed (gchararray, gboolean)\n  action-state-changed (gchararray, GVariant)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DzlPropertiesGroup (93962411625472)>'
    __info__ = ObjectInfo(PropertiesGroup)
