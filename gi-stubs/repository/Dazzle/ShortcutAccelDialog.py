...
class ShortcutAccelDialog(__gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    
    ::
    
        ShortcutAccelDialog(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_chord(self): # real signature unknown; restored from __doc__
        """ get_chord(self) -> Dazzle.ShortcutChord """
        pass
    ...
    def get_shortcut_title(self): # real signature unknown; restored from __doc__
        """ get_shortcut_title(self) -> str """
        return ""
    ...
    def set_shortcut_title(self, title): # real signature unknown; restored from __doc__
        """ set_shortcut_title(self, title:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f3b25cb5af0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
