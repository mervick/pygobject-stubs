...
class ReadOnlyListModel(__gi_overrides_GObject.Object, __gi_overrides_Gio.ListModel):
    """
    :Constructors:
    
    ::
    
        ReadOnlyListModel(**properties)
    """
    ...
    def new(self, base_model): # real signature unknown; restored from __doc__
        """ new(base_model:Gio.ListModel) -> Gio.ListModel """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f3b272eea00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ReadOnlyListModel), '__module__': 'gi.repository.Dazzle', '__gtype__': <GType DzlReadOnlyListModel (93962411647600)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    __gdoc__ = 'Object DzlReadOnlyListModel\n\nProperties from DzlReadOnlyListModel:\n  base-model -> GListModel: Base Model\n    The list model to be wrapped as read-only\n\nSignals from GListModel:\n  items-changed (guint, guint, guint)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DzlReadOnlyListModel (93962411647600)>'
    __info__ = ObjectInfo(ReadOnlyListModel)
