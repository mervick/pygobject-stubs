...
class FileChooserEntry(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    
    ::
    
        FileChooserEntry(**properties)
    ...
    def new(self, title, action): # real signature unknown; restored from __doc__
        """ new(title:str, action:Gtk.FileChooserAction) -> Gtk.Widget """
        pass
