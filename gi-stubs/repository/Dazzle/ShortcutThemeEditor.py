...
class ShortcutThemeEditor(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    
    ::
    
        ShortcutThemeEditor(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_theme(self): # real signature unknown; restored from __doc__
        """ get_theme(self) -> Dazzle.ShortcutTheme or None """
        pass
