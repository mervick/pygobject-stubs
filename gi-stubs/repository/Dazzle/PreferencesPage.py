...
class PreferencesPage(__gi_repository_Gtk.Bin):
    ...
    def add_group(self, group): # real signature unknown; restored from __doc__
        """ add_group(self, group:Dazzle.PreferencesGroup) """
        pass
    ...
    def get_group(self, group_name): # real signature unknown; restored from __doc__
        """ get_group(self, group_name:str) -> Dazzle.PreferencesGroup or None """
        pass
    ...
    def refilter(self, spec): # real signature unknown; restored from __doc__
        """ refilter(self, spec:Dazzle.PatternSpec) """
        pass
    ...
    def set_map(self, map): # real signature unknown; restored from __doc__
        """ set_map(self, map:dict) """
        pass
