...
class RadioBox(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    ...
    def add_item(self, id, text): # real signature unknown; restored from __doc__
        """ add_item(self, id:str, text:str) """
        pass
    ...
    def remove_item(self, id): # real signature unknown; restored from __doc__
        """ remove_item(self, id:str) """
        pass
    ...
    def set_active_id(self, id): # real signature unknown; restored from __doc__
        """ set_active_id(self, id:str) """
        pass
