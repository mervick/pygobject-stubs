...
class WidgetActionGroup(__gi_overrides_GObject.Object, __gi_repository_Gio.ActionGroup):
    """
    :Constructors:
    
    ::
    
        WidgetActionGroup(**properties)
    """
    ...
    def attach(self, widget, group_name): # real signature unknown; restored from __doc__
        """ attach(widget:Gtk.Widget, group_name:str) """
        pass
    ...
    def new(self, widget): # real signature unknown; restored from __doc__
        """ new(widget:Gtk.Widget) -> Gio.ActionGroup """
        pass
    ...
    def set_action_enabled(self, action_name, enabled): # real signature unknown; restored from __doc__
        """ set_action_enabled(self, action_name:str, enabled:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f3b272ee2e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WidgetActionGroup), '__module__': 'gi.repository.Dazzle', '__gtype__': <GType DzlWidgetActionGroup (93962411632192)>, '__doc__': None, '__gsignals__': {}, 'attach': gi.FunctionInfo(attach), 'new': gi.FunctionInfo(new), 'set_action_enabled': gi.FunctionInfo(set_action_enabled)})"
    __gdoc__ = 'Object DzlWidgetActionGroup\n\nProperties from DzlWidgetActionGroup:\n  widget -> GtkWidget: Widget\n    Widget\n\nSignals from GActionGroup:\n  action-added (gchararray)\n  action-removed (gchararray)\n  action-enabled-changed (gchararray, gboolean)\n  action-state-changed (gchararray, GVariant)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DzlWidgetActionGroup (93962411632192)>'
    __info__ = ObjectInfo(WidgetActionGroup)
