...
class ListStoreAdapter(__gi_overrides_GObject.Object, __gi_overrides_Gtk.TreeModel):
    """
    :Constructors:
    
    ::
    
        ListStoreAdapter(**properties)
        new(model:Gio.ListModel) -> Dazzle.ListStoreAdapter
    """
    ...
    def new(self, model): # real signature unknown; restored from __doc__
        """ new(model:Gio.ListModel) -> Dazzle.ListStoreAdapter """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f3b25ca99d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ListStoreAdapter), '__module__': 'gi.repository.Dazzle', '__gtype__': <GType DzlListStoreAdapter (93962411531776)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_model': gi.FunctionInfo(get_model), 'set_model': gi.FunctionInfo(set_model), 'parent_instance': <property object at 0x7f3b25f2ec70>})"
    __gdoc__ = 'Object DzlListStoreAdapter\n\nProperties from DzlListStoreAdapter:\n  model -> GListModel: Model\n    The model to be adapted\n\nSignals from GtkTreeModel:\n  row-changed (GtkTreePath, GtkTreeIter)\n  row-inserted (GtkTreePath, GtkTreeIter)\n  row-has-child-toggled (GtkTreePath, GtkTreeIter)\n  row-deleted (GtkTreePath)\n  rows-reordered (GtkTreePath, GtkTreeIter, gpointer)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DzlListStoreAdapter (93962411531776)>'
    __info__ = ObjectInfo(ListStoreAdapter)
