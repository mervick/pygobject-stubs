...
class MenuButton(__gi_repository_Gtk.MenuButton):
    """
    :Constructors:
    ...
    ::
        ...
        new_with_model(icon_name:str, model:Gio.MenuModel=None) -> Gtk.Widget
    """
    ...
    def get_model(self): # real signature unknown; restored from __doc__
        """ get_model(self) -> Gio.MenuModel or None """
        pass
    ...
    def get_show_accels(self): # real signature unknown; restored from __doc__
        """ get_show_accels(self) -> bool """
        return False
    ...
    def new_with_model(self, icon_name, model=None): # real signature unknown; restored from __doc__
        """ new_with_model(icon_name:str, model:Gio.MenuModel=None) -> Gtk.Widget """
        pass
    ...
    def set_model(self, model): # real signature unknown; restored from __doc__
        """ set_model(self, model:Gio.MenuModel) """
        pass
    ...
    def set_show_accels(self, show_accels): # real signature unknown; restored from __doc__
        """ set_show_accels(self, show_accels:bool) """
        pass
