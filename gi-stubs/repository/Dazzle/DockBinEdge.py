...
class DockBinEdge(DockRevealer, DockItem):
    """
    :Constructors:
    
    ::
    
        DockBinEdge(**properties)
    """
    ...
    def do_move_to_bin_child(self, *args, **kwargs): # real signature unknown
        """ move_to_bin_child(self) """
        pass
    ...
    def get_edge(self): # real signature unknown; restored from __doc__
        """ get_edge(self) -> Gtk.PositionType """
        pass
