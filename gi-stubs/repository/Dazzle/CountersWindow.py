...
class CountersWindow(__gi_overrides_Gtk.Window):
    """
    :Constructors:
    
    ::
    
        CountersWindow(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_arena(self): # real signature unknown; restored from __doc__
        """ get_arena(self) -> Dazzle.CounterArena or None """
        pass
    ...
    def set_arena(self, arena): # real signature unknown; restored from __doc__
        """ set_arena(self, arena:Dazzle.CounterArena) """
        pass
