...
class SuggestionButton(__gi_repository_Gtk.Stack):
    """
    :Constructors:
    
    ::
    
        SuggestionButton(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_entry(self): # real signature unknown; restored from __doc__
        """ get_entry(self) -> Dazzle.SuggestionEntry """
        pass
