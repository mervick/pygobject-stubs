...
class DockRevealer(Bin):
    """
    :Constructors:
    
    ::
    
        DockRevealer(**properties)
        new() -> Gtk.Widget
    """
    ...
    def animate_to_position(self, position, transition_duration): # real signature unknown; restored from __doc__
        """ animate_to_position(self, position:int, transition_duration:int) """
        pass
    ...
    def get_position_set(self): # real signature unknown; restored from __doc__
        """ get_position_set(self) -> bool """
        return False
    ...
    def get_transition_type(self): # real signature unknown; restored from __doc__
        """ get_transition_type(self) -> Dazzle.DockRevealerTransitionType """
        pass
    ...
    def is_animating(self): # real signature unknown; restored from __doc__
    ...
    def set_position_set(self, position_set): # real signature unknown; restored from __doc__
        """ set_position_set(self, position_set:bool) """
        pass
    ...
    def set_transition_duration(self, transition_duration): # real signature unknown; restored from __doc__
        """ set_transition_duration(self, transition_duration:int) """
        pass

    def set_transition_type(self, transition_type): # real signature unknown; restored from __doc__
        """ set_transition_type(self, transition_type:Dazzle.DockRevealerTransitionType) """
        pass
