...
class SuggestionPopover(__gi_overrides_Gtk.Window):
    """
    :Constructors:
    
    ::
    
        SuggestionPopover(**properties)
        new() -> Gtk.Widget
    """
    ...
    def activate_selected(self): # real signature unknown; restored from __doc__
    ...
    def get_relative_to(self): # real signature unknown; restored from __doc__
        """ get_relative_to(self) -> Gtk.Widget or None """
        pass
    ...
    def get_selected(self): # real signature unknown; restored from __doc__
        """ get_selected(self) -> Dazzle.Suggestion or None """
        pass
    ...
    def move_by(self, amount): # real signature unknown; restored from __doc__
        """ move_by(self, amount:int) """
        pass
    ...
    def set_relative_to(self, widget): # real signature unknown; restored from __doc__
        """ set_relative_to(self, widget:Gtk.Widget) """
        pass
    ...
    def set_selected(self, suggestion): # real signature unknown; restored from __doc__
        """ set_selected(self, suggestion:Dazzle.Suggestion) """
        pass
