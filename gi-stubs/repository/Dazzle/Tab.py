...
class Tab(Bin, __gi_repository_Gtk.Actionable):
    """
    :Constructors:
    ...
    def get_style(self): # real signature unknown; restored from __doc__
        """ get_style(self) -> Dazzle.TabStyle """
        pass
    ...
    def set_can_close(self, can_close): # real signature unknown; restored from __doc__
        """ set_can_close(self, can_close:bool) """
        pass
    ...
    def set_edge(self, edge): # real signature unknown; restored from __doc__
        """ set_edge(self, edge:Gtk.PositionType) """
        pass
    ...
    def set_style(self, style): # real signature unknown; restored from __doc__
        """ set_style(self, style:Dazzle.TabStyle) """
        pass
