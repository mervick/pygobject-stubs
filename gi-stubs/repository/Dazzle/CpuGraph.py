...
class CpuGraph(GraphView):
    ...
    ::
        ...
        CpuGraph(**properties)
        new_full(timespan:int, max_samples:int) -> Gtk.Widget
    """
    ...
    def add_renderer(self, renderer): # real signature unknown; restored from __doc__
        """ add_renderer(self, renderer:Dazzle.GraphRenderer) """
        pass
    ...
    def get_model(self): # real signature unknown; restored from __doc__
        """ get_model(self) -> Dazzle.GraphModel or None """
        pass
    ...
    def new_full(self, timespan, max_samples): # real signature unknown; restored from __doc__
        """ new_full(timespan:int, max_samples:int) -> Gtk.Widget """
        pass
    ...
    def set_model(self, model): # real signature unknown; restored from __doc__
        """ set_model(self, model:Dazzle.GraphModel) """
        pass
