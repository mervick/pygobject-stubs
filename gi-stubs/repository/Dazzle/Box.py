...
class Box(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def get_max_width_request(self): # real signature unknown; restored from __doc__
        """ get_max_width_request(self) -> int """
        return 0
    ...
    def get_nth_child(self, nth): # real signature unknown; restored from __doc__
        """ get_nth_child(self, nth:int) -> Gtk.Widget or None """
        pass
    ...
    def set_max_width_request(self, max_width_request): # real signature unknown; restored from __doc__
        """ set_max_width_request(self, max_width_request:int) """
        pass
