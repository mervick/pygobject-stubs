...
class ColumnLayout(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    def get_max_columns(self): # real signature unknown; restored from __doc__
        """ get_max_columns(self) -> int """
        return 0
    ...
    def set_column_width(self, column_width): # real signature unknown; restored from __doc__
        """ set_column_width(self, column_width:int) """
        pass
    ...
    def set_max_columns(self, max_columns): # real signature unknown; restored from __doc__
        """ set_max_columns(self, max_columns:int) """
        pass
