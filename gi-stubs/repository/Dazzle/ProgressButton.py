...
class ProgressButton(__gi_overrides_Gtk.Button):
    """
    :Constructors:
    ...
    def set_progress(self, percentage): # real signature unknown; restored from __doc__
        """ set_progress(self, percentage:int) """
        pass
