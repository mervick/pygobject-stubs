...
class StackList(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    
    ::
    
        StackList(**properties)
        new() -> Gtk.Widget
    """
    ...
    def do_header_activated(self, *args, **kwargs): # real signature unknown
        """ header_activated(self, row:Gtk.ListBoxRow) """
        pass
    ...
    def push(self, header, model, create_widget_func, user_data=None): # real signature unknown; restored from __doc__
        """ push(self, header:Gtk.Widget, model:Gio.ListModel, create_widget_func:Dazzle.StackListCreateWidgetFunc, user_data=None) """
        pass
