...
class TabStrip(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def add_control(self, widget): # real signature unknown; restored from __doc__
        """ add_control(self, widget:Gtk.Widget) """
        pass
