...
class GdbusModemSimpleProxy(__gi_overrides_Gio.DBusProxy, GdbusModemSimple):
    """
    :Constructors:
    
    ::
    
        GdbusModemSimpleProxy(**properties)
