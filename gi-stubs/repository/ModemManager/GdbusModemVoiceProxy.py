...
class GdbusModemVoiceProxy(__gi_overrides_Gio.DBusProxy, GdbusModemVoice):
    """
    :Constructors:
    
    ::
    
        GdbusModemVoiceProxy(**properties)
