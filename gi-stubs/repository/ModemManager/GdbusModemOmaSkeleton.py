...
class GdbusModemOmaSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModemOma):
    """
    :Constructors:
    
    ::
    
        GdbusModemOmaSkeleton(**properties)
        new() -> ModemManager.GdbusModemOmaSkeleton
    """
