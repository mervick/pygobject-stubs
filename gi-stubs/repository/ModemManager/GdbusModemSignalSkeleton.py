...
class GdbusModemSignalSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModemSignal):
    """
    :Constructors:
    
    ::
    
        GdbusModemSignalSkeleton(**properties)
        new() -> ModemManager.GdbusModemSignalSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694382b880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusModemSignalSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusModemSignalSkeleton (94631948423504)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438f7680>, 'priv': <property object at 0x7f69438f77c0>})"
    __gdoc__ = 'Object MmGdbusModemSignalSkeleton\n\nSignals from MmGdbusModemSignal:\n  handle-setup (GDBusMethodInvocation, guint) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusModemSignalSkeleton (94631948423504)>'
    __info__ = ObjectInfo(GdbusModemSignalSkeleton)
