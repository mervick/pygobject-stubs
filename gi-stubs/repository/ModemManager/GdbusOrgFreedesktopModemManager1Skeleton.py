...
class GdbusOrgFreedesktopModemManager1Skeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusOrgFreedesktopModemManager1):
    """
    :Constructors:
    
    ::
    
        GdbusOrgFreedesktopModemManager1Skeleton(**properties)
        new() -> ModemManager.GdbusOrgFreedesktopModemManager1Skeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694351a190>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusOrgFreedesktopModemManager1Skeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusOrgFreedesktopModemManager1Skeleton (94631948549552)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f694388f0e0>, 'priv': <property object at 0x7f694388f220>})"
    __gdoc__ = 'Object MmGdbusOrgFreedesktopModemManager1Skeleton\n\nSignals from MmGdbusOrgFreedesktopModemManager1:\n  handle-scan-devices (GDBusMethodInvocation) -> gboolean\n  handle-set-logging (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-report-kernel-event (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-inhibit-device (GDBusMethodInvocation, gchararray, gboolean) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusOrgFreedesktopModemManager1Skeleton (94631948549552)>'
    __info__ = ObjectInfo(GdbusOrgFreedesktopModemManager1Skeleton)
