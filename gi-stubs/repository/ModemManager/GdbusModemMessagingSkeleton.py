...
class GdbusModemMessagingSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModemMessaging):
    """
    :Constructors:
    
    ::
    
        GdbusModemMessagingSkeleton(**properties)
        new() -> ModemManager.GdbusModemMessagingSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694371d8e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusModemMessagingSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusModemMessagingSkeleton (94631948384960)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438ef400>, 'priv': <property object at 0x7f69438ef540>})"
    __gdoc__ = 'Object MmGdbusModemMessagingSkeleton\n\nSignals from MmGdbusModemMessaging:\n  handle-list (GDBusMethodInvocation) -> gboolean\n  handle-delete (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-create (GDBusMethodInvocation, GVariant) -> gboolean\n  added (gchararray, gboolean)\n  deleted (gchararray)\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusModemMessagingSkeleton (94631948384960)>'
    __info__ = ObjectInfo(GdbusModemMessagingSkeleton)
