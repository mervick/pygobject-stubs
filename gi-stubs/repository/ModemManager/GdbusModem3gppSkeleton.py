...
class GdbusModem3gppSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModem3gpp):
    """
    :Constructors:
    
    ::
    
        GdbusModem3gppSkeleton(**properties)
        new() -> ModemManager.GdbusModem3gppSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6943a1fd60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusModem3gppSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusModem3gppSkeleton (94631948072784)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438d7450>, 'priv': <property object at 0x7f69438d7540>})"
    __gdoc__ = 'Object MmGdbusModem3gppSkeleton\n\nSignals from MmGdbusModem3gpp:\n  handle-register (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-scan (GDBusMethodInvocation) -> gboolean\n  handle-set-eps-ue-mode-operation (GDBusMethodInvocation, guint) -> gboolean\n  handle-set-initial-eps-bearer-settings (GDBusMethodInvocation, GVariant) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusModem3gppSkeleton (94631948072784)>'
    __info__ = ObjectInfo(GdbusModem3gppSkeleton)
