...
class GdbusObjectProxy(__gi_repository_Gio.DBusObjectProxy, GdbusObject):
    """
    :Constructors:
    
    ::
    
        GdbusObjectProxy(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694351aa90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusObjectProxy), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusObjectProxy (94631948517056)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f6943907cc0>, 'priv': <property object at 0x7f6943907e00>})"
    __gdoc__ = 'Object MmGdbusObjectProxy\n\nSignals from GDBusObject:\n  interface-added (GDBusInterface)\n  interface-removed (GDBusInterface)\n\nProperties from GDBusObjectProxy:\n  g-object-path -> gchararray: Object Path\n    The object path of the proxy\n  g-connection -> GDBusConnection: Connection\n    The connection of the proxy\n\nSignals from GDBusObject:\n  interface-added (GDBusInterface)\n  interface-removed (GDBusInterface)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusObjectProxy (94631948517056)>'
    __info__ = ObjectInfo(GdbusObjectProxy)
