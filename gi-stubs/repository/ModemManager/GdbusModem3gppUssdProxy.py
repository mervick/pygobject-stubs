...
class GdbusModem3gppUssdProxy(__gi_overrides_Gio.DBusProxy, GdbusModem3gppUssd):
    """
    :Constructors:
    
    ::
    
        GdbusModem3gppUssdProxy(**properties)
