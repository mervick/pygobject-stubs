...
class GdbusModemFirmwareProxy(__gi_overrides_Gio.DBusProxy, GdbusModemFirmware):
    """
    :Constructors:
    
    ::
    
        GdbusModemFirmwareProxy(**properties)
