...
class ModemSimple(GdbusModemSimpleProxy):
    """
    :Constructors:
    
    ::
    
        ModemSimple(**properties)
    """
    ...
    def connect(self, properties, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ connect(self, properties:ModemManager.SimpleConnectProperties, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def connect_finish(self, res): # real signature unknown; restored from __doc__
        """ connect_finish(self, res:Gio.AsyncResult) -> ModemManager.Bearer """
        pass
    ...
    def connect_sync(self, properties, cancellable=None): # real signature unknown; restored from __doc__
        """ connect_sync(self, properties:ModemManager.SimpleConnectProperties, cancellable:Gio.Cancellable=None) -> ModemManager.Bearer """
        pass

    def disconnect(self, bearer=None, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ disconnect(self, bearer:str=None, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def disconnect_sync(self, bearer=None, cancellable=None): # real signature unknown; restored from __doc__
        """ disconnect_sync(self, bearer:str=None, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def get_status(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_status(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_status_finish(self, res): # real signature unknown; restored from __doc__
        """ get_status_finish(self, res:Gio.AsyncResult) -> ModemManager.SimpleStatus """
        pass

    def get_status_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ get_status_sync(self, cancellable:Gio.Cancellable=None) -> ModemManager.SimpleStatus """
        pass
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemSimpleProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemSimpleProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemSimpleProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemSimpleProxy """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69432adcd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModemSimple), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMModemSimple (94631948792384)>, '__doc__': None, '__gsignals__': {}, 'connect': gi.FunctionInfo(connect), 'connect_finish': gi.FunctionInfo(connect_finish), 'connect_sync': gi.FunctionInfo(connect_sync), 'disconnect': gi.FunctionInfo(disconnect), 'disconnect_finish': gi.FunctionInfo(disconnect_finish), 'disconnect_sync': gi.FunctionInfo(disconnect_sync), 'dup_path': gi.FunctionInfo(dup_path), 'get_path': gi.FunctionInfo(get_path), 'get_status': gi.FunctionInfo(get_status), 'get_status_finish': gi.FunctionInfo(get_status_finish), 'get_status_sync': gi.FunctionInfo(get_status_sync), 'parent': <property object at 0x7f694384bc20>, 'unused': <property object at 0x7f694384bd10>})"
    __gdoc__ = 'Object MMModemSimple\n\nSignals from MmGdbusModemSimple:\n  handle-connect (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-disconnect (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-get-status (GDBusMethodInvocation) -> gboolean\n\nSignals from MmGdbusModemSimple:\n  handle-connect (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-disconnect (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-get-status (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMModemSimple (94631948792384)>'
    __info__ = ObjectInfo(ModemSimple)
