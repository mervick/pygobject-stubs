...
class ModemMessaging(GdbusModemMessagingProxy):
    """
    :Constructors:
    
    ::
    
        ModemMessaging(**properties)
    """
    ...
    def create(self, properties, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ create(self, properties:ModemManager.SmsProperties, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def create_finish(self, res): # real signature unknown; restored from __doc__
        """ create_finish(self, res:Gio.AsyncResult) -> ModemManager.Sms """
        pass

    def create_sync(self, properties, cancellable=None): # real signature unknown; restored from __doc__
        """ create_sync(self, properties:ModemManager.SmsProperties, cancellable:Gio.Cancellable=None) -> ModemManager.Sms """
        pass

    def delete(self, sms, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ delete(self, sms:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def delete_sync(self, sms, cancellable=None): # real signature unknown; restored from __doc__
        """ delete_sync(self, sms:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def get_default_storage(self): # real signature unknown; restored from __doc__
        """ get_default_storage(self) -> ModemManager.SmsStorage """
        pass
    ...
    def get_supported_storages(self): # real signature unknown; restored from __doc__
        """ get_supported_storages(self) -> bool, storages:list """
        return False
    ...
    def list(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ list(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def list_finish(self, res): # real signature unknown; restored from __doc__
        """ list_finish(self, res:Gio.AsyncResult) -> list """
        return []
    ...
    def list_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ list_sync(self, cancellable:Gio.Cancellable=None) -> list """
        return []
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemMessagingProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemMessagingProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemMessagingProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemMessagingProxy """
        pass
    ...
    def peek_supported_storages(self): # real signature unknown; restored from __doc__
        """ peek_supported_storages(self) -> bool, storages:ModemManager.SmsStorage, n_storages:int """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69434449a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModemMessaging), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMModemMessaging (94631948678656)>, '__doc__': None, '__gsignals__': {}, 'create': gi.FunctionInfo(create), 'create_finish': gi.FunctionInfo(create_finish), 'create_sync': gi.FunctionInfo(create_sync), 'delete': gi.FunctionInfo(delete), 'delete_finish': gi.FunctionInfo(delete_finish), 'delete_sync': gi.FunctionInfo(delete_sync), 'dup_path': gi.FunctionInfo(dup_path), 'get_default_storage': gi.FunctionInfo(get_default_storage), 'get_path': gi.FunctionInfo(get_path), 'get_supported_storages': gi.FunctionInfo(get_supported_storages), 'list': gi.FunctionInfo(list), 'list_finish': gi.FunctionInfo(list_finish), 'list_sync': gi.FunctionInfo(list_sync), 'peek_supported_storages': gi.FunctionInfo(peek_supported_storages), 'parent': <property object at 0x7f69438c58b0>, 'priv': <property object at 0x7f69438c59a0>})"
    __gdoc__ = 'Object MMModemMessaging\n\nSignals from MmGdbusModemMessaging:\n  handle-list (GDBusMethodInvocation) -> gboolean\n  handle-delete (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-create (GDBusMethodInvocation, GVariant) -> gboolean\n  added (gchararray, gboolean)\n  deleted (gchararray)\n\nSignals from MmGdbusModemMessaging:\n  handle-list (GDBusMethodInvocation) -> gboolean\n  handle-delete (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-create (GDBusMethodInvocation, GVariant) -> gboolean\n  added (gchararray, gboolean)\n  deleted (gchararray)\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMModemMessaging (94631948678656)>'
    __info__ = ObjectInfo(ModemMessaging)
