...
class Bearer(GdbusBearerProxy):
    ...
    def call_connect(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_connect(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_connect_finish(self, res): # real signature unknown; restored from __doc__
        """ call_connect_finish(self, res:Gio.AsyncResult) """
        pass

    def call_connect_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ call_connect_sync(self, cancellable:Gio.Cancellable=None) """
        pass

    def call_disconnect(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_disconnect(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def call_disconnect_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ call_disconnect_sync(self, cancellable:Gio.Cancellable=None) """
        pass
    ...
    def complete_connect(self, invocation): # real signature unknown; restored from __doc__
        """ complete_connect(self, invocation:Gio.DBusMethodInvocation) """
        pass
    ...
    def disconnect(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ disconnect(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def disconnect_by_func(self, *args, **kwargs): # real signature unknown
        pass

    def disconnect_finish(self, res): # real signature unknown; restored from __doc__
        """ disconnect_finish(self, res:Gio.AsyncResult) -> bool """
        return False
    ...
    def dup_interface(self): # real signature unknown; restored from __doc__
        """ dup_interface(self) -> str """
        return ""
    ...
    def get_bearer_type(self): # real signature unknown; restored from __doc__
        """ get_bearer_type(self) -> ModemManager.BearerType """
        pass
    ...
    def get_ipv4_config(self): # real signature unknown; restored from __doc__
        """ get_ipv4_config(self) -> ModemManager.BearerIpConfig """
        pass

    def get_ipv6_config(self): # real signature unknown; restored from __doc__
        """ get_ipv6_config(self) -> ModemManager.BearerIpConfig """
        pass

    def get_ip_timeout(self): # real signature unknown; restored from __doc__
        """ get_ip_timeout(self) -> int """
        return 0
    ...
    def get_properties(self): # real signature unknown; restored from __doc__
        """ get_properties(self) -> ModemManager.BearerProperties """
        pass
    ...
    def get_stats(self): # real signature unknown; restored from __doc__
        """ get_stats(self) -> ModemManager.BearerStats """
        pass

    def get_suspended(self): # real signature unknown; restored from __doc__
        """ get_suspended(self) -> bool """
        return False
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusBearerProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusBearerProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusBearerProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusBearerProxy """
        pass
    ...
    def peek_ipv4_config(self): # real signature unknown; restored from __doc__
        """ peek_ipv4_config(self) -> ModemManager.BearerIpConfig """
        pass

    def peek_ipv6_config(self): # real signature unknown; restored from __doc__
        """ peek_ipv6_config(self) -> ModemManager.BearerIpConfig """
        pass

    def peek_properties(self): # real signature unknown; restored from __doc__
        """ peek_properties(self) -> ModemManager.BearerProperties """
        pass

    def peek_stats(self): # real signature unknown; restored from __doc__
        """ peek_stats(self) -> ModemManager.BearerStats """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694380de20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Bearer), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMBearer (94631947827968)>, '__doc__': None, '__gsignals__': {}, 'connect': gi.FunctionInfo(connect), 'connect_finish': gi.FunctionInfo(connect_finish), 'connect_sync': gi.FunctionInfo(connect_sync), 'disconnect': gi.FunctionInfo(disconnect), 'disconnect_finish': gi.FunctionInfo(disconnect_finish), 'disconnect_sync': gi.FunctionInfo(disconnect_sync), 'dup_interface': gi.FunctionInfo(dup_interface), 'dup_path': gi.FunctionInfo(dup_path), 'get_bearer_type': gi.FunctionInfo(get_bearer_type), 'get_connected': gi.FunctionInfo(get_connected), 'get_interface': gi.FunctionInfo(get_interface), 'get_ip_timeout': gi.FunctionInfo(get_ip_timeout), 'get_ipv4_config': gi.FunctionInfo(get_ipv4_config), 'get_ipv6_config': gi.FunctionInfo(get_ipv6_config), 'get_path': gi.FunctionInfo(get_path), 'get_properties': gi.FunctionInfo(get_properties), 'get_stats': gi.FunctionInfo(get_stats), 'get_suspended': gi.FunctionInfo(get_suspended), 'peek_ipv4_config': gi.FunctionInfo(peek_ipv4_config), 'peek_ipv6_config': gi.FunctionInfo(peek_ipv6_config), 'peek_properties': gi.FunctionInfo(peek_properties), 'peek_stats': gi.FunctionInfo(peek_stats), 'parent': <property object at 0x7f6944a4d220>, 'priv': <property object at 0x7f6943a45180>})"
    __gdoc__ = 'Object MMBearer\n\nSignals from MmGdbusBearer:\n  handle-connect (GDBusMethodInvocation) -> gboolean\n  handle-disconnect (GDBusMethodInvocation) -> gboolean\n\nSignals from MmGdbusBearer:\n  handle-connect (GDBusMethodInvocation) -> gboolean\n  handle-disconnect (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMBearer (94631947827968)>'
    __info__ = ObjectInfo(Bearer)
