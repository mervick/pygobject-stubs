...
class GdbusModemVoiceSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModemVoice):
    """
    :Constructors:
    
    ::
    
        GdbusModemVoiceSkeleton(**properties)
        new() -> ModemManager.GdbusModemVoiceSkeleton
    """
