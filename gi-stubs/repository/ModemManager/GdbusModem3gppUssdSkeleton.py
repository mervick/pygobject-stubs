...
class GdbusModem3gppUssdSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModem3gppUssd):
    """
    :Constructors:
    
    ::
    
        GdbusModem3gppUssdSkeleton(**properties)
        new() -> ModemManager.GdbusModem3gppUssdSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694382bcd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusModem3gppUssdSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusModem3gppUssdSkeleton (94631948330336)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438dba90>, 'priv': <property object at 0x7f69438dbbd0>})"
    __gdoc__ = 'Object MmGdbusModem3gppUssdSkeleton\n\nSignals from MmGdbusModem3gppUssd:\n  handle-initiate (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-respond (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-cancel (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusModem3gppUssdSkeleton (94631948330336)>'
    __info__ = ObjectInfo(GdbusModem3gppUssdSkeleton)
