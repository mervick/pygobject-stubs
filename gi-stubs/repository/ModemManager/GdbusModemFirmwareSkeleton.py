...
class GdbusModemFirmwareSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModemFirmware):
    """
    :Constructors:
    
    ::
    
        GdbusModemFirmwareSkeleton(**properties)
        new() -> ModemManager.GdbusModemFirmwareSkeleton
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusModemFirmwareSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusModemFirmwareSkeleton (94631948296464)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438e1770>, 'priv': <property object at 0x7f69438e18b0>})"
    __gdoc__ = 'Object MmGdbusModemFirmwareSkeleton\n\nSignals from MmGdbusModemFirmware:\n  handle-list (GDBusMethodInvocation) -> gboolean\n  handle-select (GDBusMethodInvocation, gchararray) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusModemFirmwareSkeleton (94631948296464)>'
    __info__ = ObjectInfo(GdbusModemFirmwareSkeleton)
