...
class GdbusSms(__gobject.GInterface):
    # no doc
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(GdbusSms), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusSms (94631948366416)>, '__dict__': <attribute '__dict__' of 'GdbusSms' objects>, '__weakref__': <attribute '__weakref__' of 'GdbusSms' objects>, '__doc__': None, '__gsignals__': {}, 'interface_info': gi.FunctionInfo(interface_info), 'override_properties': gi.FunctionInfo(override_properties), 'call_send': gi.FunctionInfo(call_send), 'call_send_finish': gi.FunctionInfo(call_send_finish), 'call_send_sync': gi.FunctionInfo(call_send_sync), 'call_store': gi.FunctionInfo(call_store), 'call_store_finish': gi.FunctionInfo(call_store_finish), 'call_store_sync': gi.FunctionInfo(call_store_sync), 'complete_send': gi.FunctionInfo(complete_send), 'complete_store': gi.FunctionInfo(complete_store)})"
    __gdoc__ = 'Interface MmGdbusSms\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusSms (94631948366416)>'
    __info__ = InterfaceInfo(GdbusSms)
