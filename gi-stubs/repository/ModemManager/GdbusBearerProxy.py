...
class GdbusBearerProxy(__gi_overrides_Gio.DBusProxy, GdbusBearer):
    """
    :Constructors:
    
    ::
    
        GdbusBearerProxy(**properties)
