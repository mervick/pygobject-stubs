...
class GdbusModemCdmaProxy(__gi_overrides_Gio.DBusProxy, GdbusModemCdma):
    """
    :Constructors:
    
    ::
    
        GdbusModemCdmaProxy(**properties)
