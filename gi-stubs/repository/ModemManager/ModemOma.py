...
class ModemOma(GdbusModemOmaProxy):
    """
    :Constructors:
    ...
    ::
        ...
        ModemOma(**properties)
    """
    def accept_network_initiated_session(self, session_id, accept, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ accept_network_initiated_session(self, session_id:int, accept:bool, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def accept_network_initiated_session_finish(self, res): # real signature unknown; restored from __doc__
        """ accept_network_initiated_session_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def accept_network_initiated_session_sync(self, session_id, accept, cancellable=None): # real signature unknown; restored from __doc__
        """ accept_network_initiated_session_sync(self, session_id:int, accept:bool, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def cancel_session(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ cancel_session(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def cancel_session_finish(self, res): # real signature unknown; restored from __doc__
        """ cancel_session_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def cancel_session_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ cancel_session_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def get_features(self): # real signature unknown; restored from __doc__
        """ get_features(self) -> ModemManager.OmaFeature """
        pass
    ...
    def get_session_state(self): # real signature unknown; restored from __doc__
        """ get_session_state(self) -> ModemManager.OmaSessionState """
        pass

    def get_session_type(self): # real signature unknown; restored from __doc__
        """ get_session_type(self) -> ModemManager.OmaSessionType """
        pass
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemOmaProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemOmaProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemOmaProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemOmaProxy """
        pass
    ...
    def setup(self, features, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ setup(self, features:ModemManager.OmaFeature, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def setup_sync(self, features, cancellable=None): # real signature unknown; restored from __doc__
        """ setup_sync(self, features:ModemManager.OmaFeature, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def start_client_initiated_session(self, session_type, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ start_client_initiated_session(self, session_type:ModemManager.OmaSessionType, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def start_client_initiated_session_finish(self, res): # real signature unknown; restored from __doc__
        """ start_client_initiated_session_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def start_client_initiated_session_sync(self, session_type, cancellable=None): # real signature unknown; restored from __doc__
        """ start_client_initiated_session_sync(self, session_type:ModemManager.OmaSessionType, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69434bacd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModemOma), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMModemOma (94631948680864)>, '__doc__': None, '__gsignals__': {}, 'accept_network_initiated_session': gi.FunctionInfo(accept_network_initiated_session), 'accept_network_initiated_session_finish': gi.FunctionInfo(accept_network_initiated_session_finish), 'accept_network_initiated_session_sync': gi.FunctionInfo(accept_network_initiated_session_sync), 'cancel_session': gi.FunctionInfo(cancel_session), 'cancel_session_finish': gi.FunctionInfo(cancel_session_finish), 'cancel_session_sync': gi.FunctionInfo(cancel_session_sync), 'dup_path': gi.FunctionInfo(dup_path), 'get_features': gi.FunctionInfo(get_features), 'get_path': gi.FunctionInfo(get_path), 'get_session_state': gi.FunctionInfo(get_session_state), 'get_session_type': gi.FunctionInfo(get_session_type), 'setup': gi.FunctionInfo(setup), 'setup_finish': gi.FunctionInfo(setup_finish), 'setup_sync': gi.FunctionInfo(setup_sync), 'start_client_initiated_session': gi.FunctionInfo(start_client_initiated_session), 'start_client_initiated_session_finish': gi.FunctionInfo(start_client_initiated_session_finish), 'start_client_initiated_session_sync': gi.FunctionInfo(start_client_initiated_session_sync), 'parent': <property object at 0x7f69438c76d0>, 'priv': <property object at 0x7f69438c77c0>})"
    __gdoc__ = 'Object MMModemOma\n\nSignals from MmGdbusModemOma:\n  handle-setup (GDBusMethodInvocation, guint) -> gboolean\n  handle-start-client-initiated-session (GDBusMethodInvocation, guint) -> gboolean\n  handle-accept-network-initiated-session (GDBusMethodInvocation, guint, gboolean) -> gboolean\n  handle-cancel-session (GDBusMethodInvocation) -> gboolean\n  session-state-changed (gint, gint, guint)\n\nSignals from MmGdbusModemOma:\n  handle-setup (GDBusMethodInvocation, guint) -> gboolean\n  handle-start-client-initiated-session (GDBusMethodInvocation, guint) -> gboolean\n  handle-accept-network-initiated-session (GDBusMethodInvocation, guint, gboolean) -> gboolean\n  handle-cancel-session (GDBusMethodInvocation) -> gboolean\n  session-state-changed (gint, gint, guint)\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMModemOma (94631948680864)>'
    __info__ = ObjectInfo(ModemOma)
