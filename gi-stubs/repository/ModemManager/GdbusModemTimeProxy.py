...
class GdbusModemTimeProxy(__gi_overrides_Gio.DBusProxy, GdbusModemTime):
    """
    :Constructors:
    
    ::
    
        GdbusModemTimeProxy(**properties)
