...
class Sim(GdbusSimProxy):
    ...
    def change_pin(self, old_pin, new_pin, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ change_pin(self, old_pin:str, new_pin:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def change_pin_finish(self, res): # real signature unknown; restored from __doc__
        """ change_pin_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def change_pin_sync(self, old_pin, new_pin, cancellable=None): # real signature unknown; restored from __doc__
        """ change_pin_sync(self, old_pin:str, new_pin:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def disable_pin(self, pin, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ disable_pin(self, pin:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def disable_pin_finish(self, res): # real signature unknown; restored from __doc__
        """ disable_pin_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def disable_pin_sync(self, pin, cancellable=None): # real signature unknown; restored from __doc__
        """ disable_pin_sync(self, pin:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def dup_emergency_numbers(self): # real signature unknown; restored from __doc__
        """ dup_emergency_numbers(self) -> list """
        return []

    def dup_identifier(self): # real signature unknown; restored from __doc__
        """ dup_identifier(self) -> str """
        return ""

    def dup_imsi(self): # real signature unknown; restored from __doc__
        """ dup_imsi(self) -> str """
        return ""

    def dup_operator_identifier(self): # real signature unknown; restored from __doc__
        """ dup_operator_identifier(self) -> str """
        return ""
    ...
    def enable_pin(self, pin, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ enable_pin(self, pin:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def enable_pin_finish(self, res): # real signature unknown; restored from __doc__
        """ enable_pin_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def enable_pin_sync(self, pin, cancellable=None): # real signature unknown; restored from __doc__
        """ enable_pin_sync(self, pin:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def get_emergency_numbers(self): # real signature unknown; restored from __doc__
        """ get_emergency_numbers(self) -> list """
        return []
    ...
    def get_imsi(self): # real signature unknown; restored from __doc__
        """ get_imsi(self) -> str """
        return ""
    ...
    def get_operator_identifier(self): # real signature unknown; restored from __doc__
        """ get_operator_identifier(self) -> str """
        return ""
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusSimProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusSimProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusSimProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusSimProxy """
        pass
    ...
    def send_pin(self, pin, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ send_pin(self, pin:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def send_pin_finish(self, res): # real signature unknown; restored from __doc__
        """ send_pin_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def send_pin_sync(self, pin, cancellable=None): # real signature unknown; restored from __doc__
        """ send_pin_sync(self, pin:str, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def send_puk(self, puk, pin, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ send_puk(self, puk:str, pin:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def send_puk_finish(self, res): # real signature unknown; restored from __doc__
        """ send_puk_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def send_puk_sync(self, puk, pin, cancellable=None): # real signature unknown; restored from __doc__
        """ send_puk_sync(self, puk:str, pin:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694326be50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Sim), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMSim (94631948860848)>, '__doc__': None, '__gsignals__': {}, 'change_pin': gi.FunctionInfo(change_pin), 'change_pin_finish': gi.FunctionInfo(change_pin_finish), 'change_pin_sync': gi.FunctionInfo(change_pin_sync), 'disable_pin': gi.FunctionInfo(disable_pin), 'disable_pin_finish': gi.FunctionInfo(disable_pin_finish), 'disable_pin_sync': gi.FunctionInfo(disable_pin_sync), 'dup_emergency_numbers': gi.FunctionInfo(dup_emergency_numbers), 'dup_identifier': gi.FunctionInfo(dup_identifier), 'dup_imsi': gi.FunctionInfo(dup_imsi), 'dup_operator_identifier': gi.FunctionInfo(dup_operator_identifier), 'dup_operator_name': gi.FunctionInfo(dup_operator_name), 'dup_path': gi.FunctionInfo(dup_path), 'enable_pin': gi.FunctionInfo(enable_pin), 'enable_pin_finish': gi.FunctionInfo(enable_pin_finish), 'enable_pin_sync': gi.FunctionInfo(enable_pin_sync), 'get_emergency_numbers': gi.FunctionInfo(get_emergency_numbers), 'get_identifier': gi.FunctionInfo(get_identifier), 'get_imsi': gi.FunctionInfo(get_imsi), 'get_operator_identifier': gi.FunctionInfo(get_operator_identifier), 'get_operator_name': gi.FunctionInfo(get_operator_name), 'get_path': gi.FunctionInfo(get_path), 'send_pin': gi.FunctionInfo(send_pin), 'send_pin_finish': gi.FunctionInfo(send_pin_finish), 'send_pin_sync': gi.FunctionInfo(send_pin_sync), 'send_puk': gi.FunctionInfo(send_puk), 'send_puk_finish': gi.FunctionInfo(send_puk_finish), 'send_puk_sync': gi.FunctionInfo(send_puk_sync), 'parent': <property object at 0x7f69438c4e00>, 'unused': <property object at 0x7f694385d270>})"
    __gdoc__ = 'Object MMSim\n\nSignals from MmGdbusSim:\n  handle-send-pin (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-send-puk (GDBusMethodInvocation, gchararray, gchararray) -> gboolean\n  handle-enable-pin (GDBusMethodInvocation, gchararray, gboolean) -> gboolean\n  handle-change-pin (GDBusMethodInvocation, gchararray, gchararray) -> gboolean\n\nSignals from MmGdbusSim:\n  handle-send-pin (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-send-puk (GDBusMethodInvocation, gchararray, gchararray) -> gboolean\n  handle-enable-pin (GDBusMethodInvocation, gchararray, gboolean) -> gboolean\n  handle-change-pin (GDBusMethodInvocation, gchararray, gchararray) -> gboolean\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMSim (94631948860848)>'
    __info__ = ObjectInfo(Sim)
