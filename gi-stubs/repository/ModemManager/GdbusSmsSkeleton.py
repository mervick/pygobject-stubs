...
class GdbusSmsSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusSms):
    """
    :Constructors:
    
    ::
    
        GdbusSmsSkeleton(**properties)
        new() -> ModemManager.GdbusSmsSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69434ba8b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusSmsSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusSmsSkeleton (94631948369744)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f6943896d60>, 'priv': <property object at 0x7f6943896ea0>})"
    __gdoc__ = 'Object MmGdbusSmsSkeleton\n\nSignals from MmGdbusSms:\n  handle-send (GDBusMethodInvocation) -> gboolean\n  handle-store (GDBusMethodInvocation, guint) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusSmsSkeleton (94631948369744)>'
    __info__ = ObjectInfo(GdbusSmsSkeleton)
