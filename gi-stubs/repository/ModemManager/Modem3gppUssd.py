...
class Modem3gppUssd(GdbusModem3gppUssdProxy):
    """
    :Constructors:
    
    ::
    
        Modem3gppUssd(**properties)
    """
    ...
    def call_initiate(self, arg_command, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_initiate(self, arg_command:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_initiate_finish(self, res): # real signature unknown; restored from __doc__
        """ call_initiate_finish(self, res:Gio.AsyncResult) -> out_reply:str """
        pass

    def call_initiate_sync(self, arg_command, cancellable=None): # real signature unknown; restored from __doc__
        """ call_initiate_sync(self, arg_command:str, cancellable:Gio.Cancellable=None) -> out_reply:str """
        pass

    def call_respond(self, arg_response, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_respond(self, arg_response:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_respond_finish(self, res): # real signature unknown; restored from __doc__
        """ call_respond_finish(self, res:Gio.AsyncResult) -> out_reply:str """
        pass

    def call_respond_sync(self, arg_response, cancellable=None): # real signature unknown; restored from __doc__
        """ call_respond_sync(self, arg_response:str, cancellable:Gio.Cancellable=None) -> out_reply:str """
        pass
    ...
    def cancel(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ cancel(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def cancel_finish(self, res): # real signature unknown; restored from __doc__
        """ cancel_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def cancel_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ cancel_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def complete_initiate(self, invocation, reply): # real signature unknown; restored from __doc__
        """ complete_initiate(self, invocation:Gio.DBusMethodInvocation, reply:str) """
        pass

    def complete_respond(self, invocation, reply): # real signature unknown; restored from __doc__
        """ complete_respond(self, invocation:Gio.DBusMethodInvocation, reply:str) """
        pass
    ...
    def dup_network_notification(self): # real signature unknown; restored from __doc__
        """ dup_network_notification(self) -> str """
        return ""

    def dup_network_request(self): # real signature unknown; restored from __doc__
        """ dup_network_request(self) -> str """
        return ""
    ...
    def get_network_notification(self): # real signature unknown; restored from __doc__
        """ get_network_notification(self) -> str """
        return ""

    def get_network_request(self): # real signature unknown; restored from __doc__
        """ get_network_request(self) -> str """
        return ""
    ...
    def get_state(self): # real signature unknown; restored from __doc__
        """ get_state(self) -> ModemManager.Modem3gppUssdSessionState """
        pass
    ...
    def initiate(self, command, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ initiate(self, command:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def initiate_finish(self, res): # real signature unknown; restored from __doc__
        """ initiate_finish(self, res:Gio.AsyncResult) -> str """
        return ""

    def initiate_sync(self, command, cancellable=None): # real signature unknown; restored from __doc__
        """ initiate_sync(self, command:str, cancellable:Gio.Cancellable=None) -> str """
        return ""
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModem3gppUssdProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModem3gppUssdProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModem3gppUssdProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModem3gppUssdProxy """
        pass
    ...
    def respond(self, response, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ respond(self, response:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def respond_finish(self, res): # real signature unknown; restored from __doc__
        """ respond_finish(self, res:Gio.AsyncResult) -> str """
        return ""

    def respond_sync(self, response, cancellable=None): # real signature unknown; restored from __doc__
        """ respond_sync(self, response:str, cancellable:Gio.Cancellable=None) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69434ba490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Modem3gppUssd), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMModem3gppUssd (94631948698464)>, '__doc__': None, '__gsignals__': {}, 'cancel': gi.FunctionInfo(cancel), 'cancel_finish': gi.FunctionInfo(cancel_finish), 'cancel_sync': gi.FunctionInfo(cancel_sync), 'dup_network_notification': gi.FunctionInfo(dup_network_notification), 'dup_network_request': gi.FunctionInfo(dup_network_request), 'dup_path': gi.FunctionInfo(dup_path), 'get_network_notification': gi.FunctionInfo(get_network_notification), 'get_network_request': gi.FunctionInfo(get_network_request), 'get_path': gi.FunctionInfo(get_path), 'get_state': gi.FunctionInfo(get_state), 'initiate': gi.FunctionInfo(initiate), 'initiate_finish': gi.FunctionInfo(initiate_finish), 'initiate_sync': gi.FunctionInfo(initiate_sync), 'respond': gi.FunctionInfo(respond), 'respond_finish': gi.FunctionInfo(respond_finish), 'respond_sync': gi.FunctionInfo(respond_sync), 'parent': <property object at 0x7f69438b1130>, 'unused': <property object at 0x7f69438b13b0>})"
    __gdoc__ = 'Object MMModem3gppUssd\n\nSignals from MmGdbusModem3gppUssd:\n  handle-initiate (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-respond (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-cancel (GDBusMethodInvocation) -> gboolean\n\nSignals from MmGdbusModem3gppUssd:\n  handle-initiate (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-respond (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-cancel (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMModem3gppUssd (94631948698464)>'
    __info__ = ObjectInfo(Modem3gppUssd)
