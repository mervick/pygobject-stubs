...
class GdbusObject(__gobject.GInterface):
    # no doc
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(GdbusObject), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusObject (94631948350480)>, '__dict__': <attribute '__dict__' of 'GdbusObject' objects>, '__weakref__': <attribute '__weakref__' of 'GdbusObject' objects>, '__doc__': None, '__gsignals__': {}, 'get_modem': gi.FunctionInfo(get_modem), 'get_modem3gpp': gi.FunctionInfo(get_modem3gpp), 'get_modem3gpp_ussd': gi.FunctionInfo(get_modem3gpp_ussd), 'get_modem_cdma': gi.FunctionInfo(get_modem_cdma), 'get_modem_firmware': gi.FunctionInfo(get_modem_firmware), 'get_modem_location': gi.FunctionInfo(get_modem_location), 'get_modem_messaging': gi.FunctionInfo(get_modem_messaging), 'get_modem_oma': gi.FunctionInfo(get_modem_oma), 'get_modem_signal': gi.FunctionInfo(get_modem_signal), 'get_modem_simple': gi.FunctionInfo(get_modem_simple), 'get_modem_time': gi.FunctionInfo(get_modem_time), 'get_modem_voice': gi.FunctionInfo(get_modem_voice)})"
    __gdoc__ = 'Interface MmGdbusObject\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusObject (94631948350480)>'
    __info__ = InterfaceInfo(GdbusObject)
