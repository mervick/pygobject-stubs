...
class ModemFirmware(GdbusModemFirmwareProxy):
    """
    :Constructors:
    
    ::
    
        ModemFirmware(**properties)
    """
    ...
    def get_update_settings(self): # real signature unknown; restored from __doc__
        """ get_update_settings(self) -> ModemManager.FirmwareUpdateSettings """
        pass
    ...
    def list_finish(self, res): # real signature unknown; restored from __doc__
        """ list_finish(self, res:Gio.AsyncResult) -> bool, selected:ModemManager.FirmwareProperties, installed:list """
        return False
    ...
    def list_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ list_sync(self, cancellable:Gio.Cancellable=None) -> bool, selected:ModemManager.FirmwareProperties, installed:list """
        return False
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemFirmwareProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemFirmwareProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemFirmwareProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemFirmwareProxy """
        pass
    ...
    def peek_update_settings(self): # real signature unknown; restored from __doc__
        """ peek_update_settings(self) -> ModemManager.FirmwareUpdateSettings """
        pass
    ...
    def select(self, unique_id, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ select(self, unique_id:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def select_finish(self, res): # real signature unknown; restored from __doc__
        """ select_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def select_sync(self, unique_id, cancellable=None): # real signature unknown; restored from __doc__
        """ select_sync(self, unique_id:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69436d35b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModemFirmware), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMModemFirmware (94631948709152)>, '__doc__': None, '__gsignals__': {}, 'dup_path': gi.FunctionInfo(dup_path), 'get_path': gi.FunctionInfo(get_path), 'get_update_settings': gi.FunctionInfo(get_update_settings), 'list': gi.FunctionInfo(list), 'list_finish': gi.FunctionInfo(list_finish), 'list_sync': gi.FunctionInfo(list_sync), 'peek_update_settings': gi.FunctionInfo(peek_update_settings), 'select': gi.FunctionInfo(select), 'select_finish': gi.FunctionInfo(select_finish), 'select_sync': gi.FunctionInfo(select_sync), 'parent': <property object at 0x7f69438c1630>, 'priv': <property object at 0x7f69438c1720>})"
    __gdoc__ = 'Object MMModemFirmware\n\nSignals from MmGdbusModemFirmware:\n  handle-list (GDBusMethodInvocation) -> gboolean\n  handle-select (GDBusMethodInvocation, gchararray) -> gboolean\n\nSignals from MmGdbusModemFirmware:\n  handle-list (GDBusMethodInvocation) -> gboolean\n  handle-select (GDBusMethodInvocation, gchararray) -> gboolean\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMModemFirmware (94631948709152)>'
    __info__ = ObjectInfo(ModemFirmware)
