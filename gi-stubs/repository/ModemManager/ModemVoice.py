...
class ModemVoice(GdbusModemVoiceProxy):
    """
    :Constructors:
    
    ::
    
        ModemVoice(**properties)
    """
    ...
    def call_waiting_query(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_waiting_query(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_waiting_query_finish(self, res, status): # real signature unknown; restored from __doc__
        """ call_waiting_query_finish(self, res:Gio.AsyncResult, status:bool) -> bool """
        return False

    def call_waiting_query_sync(self, cancellable=None, status): # real signature unknown; restored from __doc__
        """ call_waiting_query_sync(self, cancellable:Gio.Cancellable=None, status:bool) -> bool """
        return False

    def call_waiting_setup(self, enable, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_waiting_setup(self, enable:bool, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_waiting_setup_finish(self, res): # real signature unknown; restored from __doc__
        """ call_waiting_setup_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def call_waiting_setup_sync(self, enable, cancellable=None): # real signature unknown; restored from __doc__
        """ call_waiting_setup_sync(self, enable:bool, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def create_call(self, properties, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ create_call(self, properties:ModemManager.CallProperties, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def create_call_finish(self, res): # real signature unknown; restored from __doc__
        """ create_call_finish(self, res:Gio.AsyncResult) -> ModemManager.Call """
        pass

    def create_call_sync(self, properties, cancellable=None): # real signature unknown; restored from __doc__
        """ create_call_sync(self, properties:ModemManager.CallProperties, cancellable:Gio.Cancellable=None) -> ModemManager.Call """
        pass

    def delete_call(self, call, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ delete_call(self, call:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def delete_call_finish(self, res): # real signature unknown; restored from __doc__
        """ delete_call_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def delete_call_sync(self, call, cancellable=None): # real signature unknown; restored from __doc__
        """ delete_call_sync(self, call:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def get_emergency_only(self): # real signature unknown; restored from __doc__
        """ get_emergency_only(self) -> bool """
        return False
    ...
    def hangup_all(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ hangup_all(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def hangup_all_finish(self, res): # real signature unknown; restored from __doc__
        """ hangup_all_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def hangup_all_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ hangup_all_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def hangup_and_accept(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ hangup_and_accept(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def hangup_and_accept_finish(self, res): # real signature unknown; restored from __doc__
        """ hangup_and_accept_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def hangup_and_accept_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ hangup_and_accept_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def hold_and_accept(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ hold_and_accept(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def hold_and_accept_finish(self, res): # real signature unknown; restored from __doc__
        """ hold_and_accept_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def hold_and_accept_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ hold_and_accept_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def list_calls(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ list_calls(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def list_calls_finish(self, res): # real signature unknown; restored from __doc__
        """ list_calls_finish(self, res:Gio.AsyncResult) -> list """
        return []

    def list_calls_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ list_calls_sync(self, cancellable:Gio.Cancellable=None) -> list """
        return []
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemVoiceProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemVoiceProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemVoiceProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemVoiceProxy """
        pass
    ...
    def transfer(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ transfer(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def transfer_finish(self, res): # real signature unknown; restored from __doc__
        """ transfer_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def transfer_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ transfer_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69432adb20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModemVoice), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMModemVoice (94631948223504)>, '__doc__': None, '__gsignals__': {}, 'call_waiting_query': gi.FunctionInfo(call_waiting_query), 'call_waiting_query_finish': gi.FunctionInfo(call_waiting_query_finish), 'call_waiting_query_sync': gi.FunctionInfo(call_waiting_query_sync), 'call_waiting_setup': gi.FunctionInfo(call_waiting_setup), 'call_waiting_setup_finish': gi.FunctionInfo(call_waiting_setup_finish), 'call_waiting_setup_sync': gi.FunctionInfo(call_waiting_setup_sync), 'create_call': gi.FunctionInfo(create_call), 'create_call_finish': gi.FunctionInfo(create_call_finish), 'create_call_sync': gi.FunctionInfo(create_call_sync), 'delete_call': gi.FunctionInfo(delete_call), 'delete_call_finish': gi.FunctionInfo(delete_call_finish), 'delete_call_sync': gi.FunctionInfo(delete_call_sync), 'dup_path': gi.FunctionInfo(dup_path), 'get_emergency_only': gi.FunctionInfo(get_emergency_only), 'get_path': gi.FunctionInfo(get_path), 'hangup_all': gi.FunctionInfo(hangup_all), 'hangup_all_finish': gi.FunctionInfo(hangup_all_finish), 'hangup_all_sync': gi.FunctionInfo(hangup_all_sync), 'hangup_and_accept': gi.FunctionInfo(hangup_and_accept), 'hangup_and_accept_finish': gi.FunctionInfo(hangup_and_accept_finish), 'hangup_and_accept_sync': gi.FunctionInfo(hangup_and_accept_sync), 'hold_and_accept': gi.FunctionInfo(hold_and_accept), 'hold_and_accept_finish': gi.FunctionInfo(hold_and_accept_finish), 'hold_and_accept_sync': gi.FunctionInfo(hold_and_accept_sync), 'list_calls': gi.FunctionInfo(list_calls), 'list_calls_finish': gi.FunctionInfo(list_calls_finish), 'list_calls_sync': gi.FunctionInfo(list_calls_sync), 'transfer': gi.FunctionInfo(transfer), 'transfer_finish': gi.FunctionInfo(transfer_finish), 'transfer_sync': gi.FunctionInfo(transfer_sync), 'parent': <property object at 0x7f69438517c0>, 'priv': <property object at 0x7f69438518b0>})"
    __gdoc__ = 'Object MMModemVoice\n\nSignals from MmGdbusModemVoice:\n  handle-list-calls (GDBusMethodInvocation) -> gboolean\n  handle-delete-call (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-create-call (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-hold-and-accept (GDBusMethodInvocation) -> gboolean\n  handle-hangup-and-accept (GDBusMethodInvocation) -> gboolean\n  handle-hangup-all (GDBusMethodInvocation) -> gboolean\n  handle-transfer (GDBusMethodInvocation) -> gboolean\n  handle-call-waiting-setup (GDBusMethodInvocation, gboolean) -> gboolean\n  handle-call-waiting-query (GDBusMethodInvocation) -> gboolean\n  call-added (gchararray)\n  call-deleted (gchararray)\n\nSignals from MmGdbusModemVoice:\n  handle-list-calls (GDBusMethodInvocation) -> gboolean\n  handle-delete-call (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-create-call (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-hold-and-accept (GDBusMethodInvocation) -> gboolean\n  handle-hangup-and-accept (GDBusMethodInvocation) -> gboolean\n  handle-hangup-all (GDBusMethodInvocation) -> gboolean\n  handle-transfer (GDBusMethodInvocation) -> gboolean\n  handle-call-waiting-setup (GDBusMethodInvocation, gboolean) -> gboolean\n  handle-call-waiting-query (GDBusMethodInvocation) -> gboolean\n  call-added (gchararray)\n  call-deleted (gchararray)\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMModemVoice (94631948223504)>'
    __info__ = ObjectInfo(ModemVoice)
