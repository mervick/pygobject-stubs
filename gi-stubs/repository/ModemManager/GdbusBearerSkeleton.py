...
class GdbusBearerSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusBearer):
    """
    :Constructors:
    
    ::
    
        GdbusBearerSkeleton(**properties)
        new() -> ModemManager.GdbusBearerSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694382ba00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusBearerSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusBearerSkeleton (94631948075632)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438d0860>, 'priv': <property object at 0x7f69438d09a0>})"
    __gdoc__ = 'Object MmGdbusBearerSkeleton\n\nSignals from MmGdbusBearer:\n  handle-connect (GDBusMethodInvocation) -> gboolean\n  handle-disconnect (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusBearerSkeleton (94631948075632)>'
    __info__ = ObjectInfo(GdbusBearerSkeleton)
