...
class GdbusModemSimpleSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModemSimple):
    """
    :Constructors:
    
    ::
    
        GdbusModemSimpleSkeleton(**properties)
        new() -> ModemManager.GdbusModemSimpleSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f694382b700>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusModemSimpleSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusModemSimpleSkeleton (94631948446272)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438fc720>, 'priv': <property object at 0x7f69438fc860>})"
    __gdoc__ = 'Object MmGdbusModemSimpleSkeleton\n\nSignals from MmGdbusModemSimple:\n  handle-connect (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-disconnect (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-get-status (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusModemSimpleSkeleton (94631948446272)>'
    __info__ = ObjectInfo(GdbusModemSimpleSkeleton)
