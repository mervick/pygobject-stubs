...
class GdbusModemTimeSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModemTime):
    """
    :Constructors:
    
    ::
    
        GdbusModemTimeSkeleton(**properties)
        new() -> ModemManager.GdbusModemTimeSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6943588e80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusModemTimeSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusModemTimeSkeleton (94631948462672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438fddb0>, 'priv': <property object at 0x7f69438fdef0>})"
    __gdoc__ = 'Object MmGdbusModemTimeSkeleton\n\nSignals from MmGdbusModemTime:\n  handle-get-network-time (GDBusMethodInvocation) -> gboolean\n  network-time-changed (gchararray)\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusModemTimeSkeleton (94631948462672)>'
    __info__ = ObjectInfo(GdbusModemTimeSkeleton)
