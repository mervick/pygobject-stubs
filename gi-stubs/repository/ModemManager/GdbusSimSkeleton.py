...
class GdbusSimSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusSim):
    """
    :Constructors:
    
    ::
    
        GdbusSimSkeleton(**properties)
        new() -> ModemManager.GdbusSimSkeleton
    """
