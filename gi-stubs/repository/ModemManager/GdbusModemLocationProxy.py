...
class GdbusModemLocationProxy(__gi_overrides_Gio.DBusProxy, GdbusModemLocation):
    """
    :Constructors:
    
    ::
    
        GdbusModemLocationProxy(**properties)
