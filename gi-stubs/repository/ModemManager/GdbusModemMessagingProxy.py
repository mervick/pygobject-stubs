...
class GdbusModemMessagingProxy(__gi_overrides_Gio.DBusProxy, GdbusModemMessaging):
    """
    :Constructors:
    
    ::
    
        GdbusModemMessagingProxy(**properties)
