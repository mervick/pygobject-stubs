...
class ModemCdma(GdbusModemCdmaProxy):
    """
    :Constructors:
    
    ::
    
        ModemCdma(**properties)
    """
    def activate(self, carrier, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ activate(self, carrier:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def activate_finish(self, res): # real signature unknown; restored from __doc__
        """ activate_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def activate_manual(self, properties, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ activate_manual(self, properties:ModemManager.CdmaManualActivationProperties, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def activate_manual_finish(self, res): # real signature unknown; restored from __doc__
        """ activate_manual_finish(self, res:Gio.AsyncResult) -> bool """
        return False

    def activate_manual_sync(self, properties, cancellable=None): # real signature unknown; restored from __doc__
        """ activate_manual_sync(self, properties:ModemManager.CdmaManualActivationProperties, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def activate_sync(self, carrier, cancellable=None): # real signature unknown; restored from __doc__
        """ activate_sync(self, carrier:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def dup_esn(self): # real signature unknown; restored from __doc__
        """ dup_esn(self) -> str """
        return ""

    def dup_meid(self): # real signature unknown; restored from __doc__
        """ dup_meid(self) -> str """
        return ""
    ...
    def get_activation_state(self): # real signature unknown; restored from __doc__
        """ get_activation_state(self) -> ModemManager.ModemCdmaActivationState """
        pass
    ...
    def get_cdma1x_registration_state(self): # real signature unknown; restored from __doc__
        """ get_cdma1x_registration_state(self) -> ModemManager.ModemCdmaRegistrationState """
        pass
    ...
    def get_esn(self): # real signature unknown; restored from __doc__
        """ get_esn(self) -> str """
        return ""

    def get_evdo_registration_state(self): # real signature unknown; restored from __doc__
        """ get_evdo_registration_state(self) -> ModemManager.ModemCdmaRegistrationState """
        pass
    ...
    def get_meid(self): # real signature unknown; restored from __doc__
        """ get_meid(self) -> str """
        return ""
    ...
    def get_nid(self): # real signature unknown; restored from __doc__
        """ get_nid(self) -> int """
        return 0
    ...
    def get_sid(self): # real signature unknown; restored from __doc__
        """ get_sid(self) -> int """
        return 0
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemCdmaProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemCdmaProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemCdmaProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemCdmaProxy """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69434ba400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModemCdma), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMModemCdma (94631948716000)>, '__doc__': None, '__gsignals__': {}, 'activate': gi.FunctionInfo(activate), 'activate_finish': gi.FunctionInfo(activate_finish), 'activate_manual': gi.FunctionInfo(activate_manual), 'activate_manual_finish': gi.FunctionInfo(activate_manual_finish), 'activate_manual_sync': gi.FunctionInfo(activate_manual_sync), 'activate_sync': gi.FunctionInfo(activate_sync), 'dup_esn': gi.FunctionInfo(dup_esn), 'dup_meid': gi.FunctionInfo(dup_meid), 'dup_path': gi.FunctionInfo(dup_path), 'get_activation_state': gi.FunctionInfo(get_activation_state), 'get_cdma1x_registration_state': gi.FunctionInfo(get_cdma1x_registration_state), 'get_esn': gi.FunctionInfo(get_esn), 'get_evdo_registration_state': gi.FunctionInfo(get_evdo_registration_state), 'get_meid': gi.FunctionInfo(get_meid), 'get_nid': gi.FunctionInfo(get_nid), 'get_path': gi.FunctionInfo(get_path), 'get_sid': gi.FunctionInfo(get_sid), 'parent': <property object at 0x7f6944e58270>, 'unused': <property object at 0x7f69438b8400>})"
    __gdoc__ = 'Object MMModemCdma\n\nSignals from MmGdbusModemCdma:\n  handle-activate (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-activate-manual (GDBusMethodInvocation, GVariant) -> gboolean\n  activation-state-changed (guint, guint, GVariant)\n\nSignals from MmGdbusModemCdma:\n  handle-activate (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-activate-manual (GDBusMethodInvocation, GVariant) -> gboolean\n  activation-state-changed (guint, guint, GVariant)\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMModemCdma (94631948716000)>'
    __info__ = ObjectInfo(ModemCdma)
