...
class ModemTime(GdbusModemTimeProxy):
    """
    :Constructors:
    
    ::
    
        ModemTime(**properties)
    """
    ...
    def call_get_network_time(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_get_network_time(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_get_network_time_finish(self, res): # real signature unknown; restored from __doc__
        """ call_get_network_time_finish(self, res:Gio.AsyncResult) -> out_time:str """
        pass

    def call_get_network_time_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ call_get_network_time_sync(self, cancellable:Gio.Cancellable=None) -> out_time:str """
        pass
    ...
    def complete_get_network_time(self, invocation, time): # real signature unknown; restored from __doc__
        """ complete_get_network_time(self, invocation:Gio.DBusMethodInvocation, time:str) """
        pass
    ...
    def emit_network_time_changed(self, arg_time): # real signature unknown; restored from __doc__
        """ emit_network_time_changed(self, arg_time:str) """
        pass
    ...
    def get_network_time(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_network_time(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_network_timezone(self): # real signature unknown; restored from __doc__
        """ get_network_timezone(self) -> ModemManager.NetworkTimezone """
        pass

    def get_network_time_finish(self, res): # real signature unknown; restored from __doc__
        """ get_network_time_finish(self, res:Gio.AsyncResult) -> str """
        return ""

    def get_network_time_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ get_network_time_sync(self, cancellable:Gio.Cancellable=None) -> str """
        return ""
    ...
    def new_finish(self, res): # real signature unknown; restored from __doc__
        """ new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemTimeProxy """
        pass
    ...
    def new_for_bus_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_bus_finish(res:Gio.AsyncResult) -> ModemManager.GdbusModemTimeProxy """
        pass

    def new_for_bus_sync(self, bus_type, flags, name, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemTimeProxy """
        pass

    def new_sync(self, connection, flags, name=None, object_path, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusModemTimeProxy """
        pass
    ...
    def peek_network_timezone(self): # real signature unknown; restored from __doc__
        """ peek_network_timezone(self) -> ModemManager.NetworkTimezone """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f69432ada90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModemTime), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MMModemTime (94631948223200)>, '__doc__': None, '__gsignals__': {}, 'dup_path': gi.FunctionInfo(dup_path), 'get_network_time': gi.FunctionInfo(get_network_time), 'get_network_time_finish': gi.FunctionInfo(get_network_time_finish), 'get_network_time_sync': gi.FunctionInfo(get_network_time_sync), 'get_network_timezone': gi.FunctionInfo(get_network_timezone), 'get_path': gi.FunctionInfo(get_path), 'peek_network_timezone': gi.FunctionInfo(peek_network_timezone), 'parent': <property object at 0x7f694384ec70>, 'priv': <property object at 0x7f694384ed60>})"
    __gdoc__ = 'Object MMModemTime\n\nSignals from MmGdbusModemTime:\n  handle-get-network-time (GDBusMethodInvocation) -> gboolean\n  network-time-changed (gchararray)\n\nSignals from MmGdbusModemTime:\n  handle-get-network-time (GDBusMethodInvocation) -> gboolean\n  network-time-changed (gchararray)\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MMModemTime (94631948223200)>'
    __info__ = ObjectInfo(ModemTime)
