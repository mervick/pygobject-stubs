...
class GdbusModem3gppProxy(__gi_overrides_Gio.DBusProxy, GdbusModem3gpp):
    """
    :Constructors:
    
    ::
    
        GdbusModem3gppProxy(**properties)
