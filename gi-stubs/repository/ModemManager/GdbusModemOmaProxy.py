...
class GdbusModemOmaProxy(__gi_overrides_Gio.DBusProxy, GdbusModemOma):
    """
    :Constructors:
    
    ::
    
        GdbusModemOmaProxy(**properties)
