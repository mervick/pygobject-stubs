...
class GdbusModemCdmaSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, GdbusModemCdma):
    """
    :Constructors:
    
    ::
    
        GdbusModemCdmaSkeleton(**properties)
        new() -> ModemManager.GdbusModemCdmaSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6943a3e910>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GdbusModemCdmaSkeleton), '__module__': 'gi.repository.ModemManager', '__gtype__': <GType MmGdbusModemCdmaSkeleton (94631948341424)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f69438df590>, 'priv': <property object at 0x7f69438df6d0>})"
    __gdoc__ = 'Object MmGdbusModemCdmaSkeleton\n\nSignals from MmGdbusModemCdma:\n  handle-activate (GDBusMethodInvocation, gchararray) -> gboolean\n  handle-activate-manual (GDBusMethodInvocation, GVariant) -> gboolean\n  activation-state-changed (guint, guint, GVariant)\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType MmGdbusModemCdmaSkeleton (94631948341424)>'
    __info__ = ObjectInfo(GdbusModemCdmaSkeleton)
