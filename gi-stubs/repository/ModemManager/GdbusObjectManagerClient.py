...
class GdbusObjectManagerClient(__gi_repository_Gio.DBusObjectManagerClient):
    """
    :Constructors:
    
    ::
    
        GdbusObjectManagerClient(**properties)
        new_finish(res:Gio.AsyncResult) -> ModemManager.GdbusObjectManagerClient
        ...
        new_sync(connection:Gio.DBusConnection, flags:Gio.DBusObjectManagerClientFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> ModemManager.GdbusObjectManagerClient
    """
