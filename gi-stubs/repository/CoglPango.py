# encoding: utf-8
# module gi.repository.CoglPango
# from /usr/lib64/girepository-1.0/CoglPango-1.0.typelib
# by generator 1.147
"""
...
def ensure_glyph_cache_for_layout(layout): # real signature unknown; restored from __doc__
    """ ensure_glyph_cache_for_layout(layout:Pango.Layout) """
    pass

def font_map_clear_glyph_cache(font_map): # real signature unknown; restored from __doc__
    """ font_map_clear_glyph_cache(font_map:PangoCairo.FontMap) """
    pass

def font_map_create_context(font_map): # real signature unknown; restored from __doc__
    """ font_map_create_context(font_map:PangoCairo.FontMap) -> Pango.Context """
    pass

def font_map_get_renderer(font_map): # real signature unknown; restored from __doc__
    """ font_map_get_renderer(font_map:PangoCairo.FontMap) -> Pango.Renderer """
    pass

def font_map_get_use_mipmapping(font_map): # real signature unknown; restored from __doc__
    """ font_map_get_use_mipmapping(font_map:PangoCairo.FontMap) -> int """
    return 0
...
def font_map_set_resolution(font_map, dpi): # real signature unknown; restored from __doc__
    """ font_map_set_resolution(font_map:PangoCairo.FontMap, dpi:float) """
    pass

def font_map_set_use_mipmapping(font_map, value): # real signature unknown; restored from __doc__
    """ font_map_set_use_mipmapping(font_map:PangoCairo.FontMap, value:int) """
    pass

def render_layout(layout, x, y, color, flags): # real signature unknown; restored from __doc__
    """ render_layout(layout:Pango.Layout, x:int, y:int, color:Cogl.Color, flags:int) """
    pass

def render_layout_line(line, x, y, color): # real signature unknown; restored from __doc__
    """ render_layout_line(line:Pango.LayoutLine, x:int, y:int, color:Cogl.Color) """
    pass

def render_layout_subpixel(layout, x, y, color, flags): # real signature unknown; restored from __doc__
    """ render_layout_subpixel(layout:Pango.Layout, x:int, y:int, color:Cogl.Color, flags:int) """
    pass

def show_layout(framebuffer, layout, x, y, color): # real signature unknown; restored from __doc__
    """ show_layout(framebuffer:Cogl.Framebuffer, layout:Pango.Layout, x:float, y:float, color:Cogl.Color) """
    pass

def show_layout_line(framebuffer, line, x, y, color): # real signature unknown; restored from __doc__
    """ show_layout_line(framebuffer:Cogl.Framebuffer, line:Pango.LayoutLine, x:float, y:float, color:Cogl.Color) """
    pass
...
class Renderer(__gi_repository_Pango.Renderer):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f975a5b1760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Renderer), '__module__': 'gi.repository.CoglPango', '__gtype__': <GType CoglPangoRenderer (94697710135904)>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object CoglPangoRenderer\n\nProperties from CoglPangoRenderer:\n  context -> gpointer: Context\n    The Cogl Context\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType CoglPangoRenderer (94697710135904)>'
...
class RendererClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(RendererClass), '__module__': 'gi.repository.CoglPango', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'RendererClass' objects>, '__weakref__': <attribute '__weakref__' of 'RendererClass' objects>, '__doc__': None})"
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7f975a9281f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7f975a928280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7f975a928310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7f975a9283a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7f975b564d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/CoglPango-2.0.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.CoglPango', loader=<gi.importer.DynamicImporter object at 0x7f975b564d00>)"
