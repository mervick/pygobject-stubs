# encoding: utf-8
# module gi.repository.GnomeBluetooth
# from /usr/lib64/girepository-1.0/GnomeBluetooth-1.0.typelib
# by generator 1.147
"""
...
CHOOSER_COMBO_FIRST_DEVICE = '00:00:00:00:00:00'
...
UUID_A2DP_SINK = 4363
UUID_A2DP_SOURCE = 4362

UUID_AVRCP_CONTROL = 4366
UUID_AVRCP_TARGET = 4364

UUID_DUN = 4355
UUID_FTP = 4358

UUID_GENERIC_AUDIO = 4611
UUID_GENERIC_NET = 4609
...
UUID_VDP_SOURCE = 4867

_namespace = 'GnomeBluetooth'
...
def appearance_to_type(appearance): # real signature unknown; restored from __doc__
    """ appearance_to_type(appearance:int) -> GnomeBluetooth.Type """
    pass

def class_to_type(class_): # real signature unknown; restored from __doc__
    """ class_to_type(class_:int) -> GnomeBluetooth.Type """
    pass

def send_to_address(address, alias): # real signature unknown; restored from __doc__
    """ send_to_address(address:str, alias:str) """
    pass

def type_to_filter_string(type): # real signature unknown; restored from __doc__
    """ type_to_filter_string(type:int) -> str """
    return ""

def type_to_string(type): # real signature unknown; restored from __doc__
    """ type_to_string(type:int) -> str """
    return ""

def uuid_to_string(uuid): # real signature unknown; restored from __doc__
    """ uuid_to_string(uuid:str) -> str """
    return ""

def verify_address(bdaddr): # real signature unknown; restored from __doc__
    """ verify_address(bdaddr:str) -> bool """
    return False
...
class Category(__gobject.GEnum):
    # no doc
    ...
    TRUSTED = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GnomeBluetooth', '__dict__': <attribute '__dict__' of 'Category' objects>, '__doc__': None, '__gtype__': <GType PyGnomeBluetoothCategory (94371300280480)>, '__enum_values__': {0: <enum BLUETOOTH_CATEGORY_ALL of type GnomeBluetooth.Category>, 1: <enum BLUETOOTH_CATEGORY_PAIRED of type GnomeBluetooth.Category>, 2: <enum BLUETOOTH_CATEGORY_TRUSTED of type GnomeBluetooth.Category>, 3: <enum BLUETOOTH_CATEGORY_NOT_PAIRED_OR_TRUSTED of type GnomeBluetooth.Category>, 4: <enum BLUETOOTH_CATEGORY_PAIRED_OR_TRUSTED of type GnomeBluetooth.Category>}, '__info__': gi.EnumInfo(Category), 'ALL': <enum BLUETOOTH_CATEGORY_ALL of type GnomeBluetooth.Category>, 'PAIRED': <enum BLUETOOTH_CATEGORY_PAIRED of type GnomeBluetooth.Category>, 'TRUSTED': <enum BLUETOOTH_CATEGORY_TRUSTED of type GnomeBluetooth.Category>, 'NOT_PAIRED_OR_TRUSTED': <enum BLUETOOTH_CATEGORY_NOT_PAIRED_OR_TRUSTED of type GnomeBluetooth.Category>, 'PAIRED_OR_TRUSTED': <enum BLUETOOTH_CATEGORY_PAIRED_OR_TRUSTED of type GnomeBluetooth.Category>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType PyGnomeBluetoothCategory (94371300280480)>'
    __info__ = gi.EnumInfo(Category)


class Chooser(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def do_selected_device_activated(self, *args, **kwargs): # real signature unknown
        """ selected_device_activated(self, address:str) """
        pass

    def do_selected_device_changed(self, *args, **kwargs): # real signature unknown
        """ selected_device_changed(self, address:str) """
        pass
    ...
    def dump_selected_device(self): # real signature unknown; restored from __doc__
        """ dump_selected_device(self) """
        pass
    ...
    def get_scrolled_window(self): # real signature unknown; restored from __doc__
        """ get_scrolled_window(self) -> Gtk.Widget """
        pass

    def get_selected_device(self): # real signature unknown; restored from __doc__
        """ get_selected_device(self) -> str """
        return ""

    def get_selected_device_icon(self): # real signature unknown; restored from __doc__
        """ get_selected_device_icon(self) -> str """
        return ""

    def get_selected_device_info(self, field, value): # real signature unknown; restored from __doc__
        """ get_selected_device_info(self, field:str, value:GObject.Value) -> bool """
        return False

    def get_selected_device_is_connected(self): # real signature unknown; restored from __doc__
        """ get_selected_device_is_connected(self) -> bool """
        return False

    def get_selected_device_name(self): # real signature unknown; restored from __doc__
        """ get_selected_device_name(self) -> str """
        return ""

    def get_selected_device_type(self): # real signature unknown; restored from __doc__
        """ get_selected_device_type(self) -> GnomeBluetooth.Type """
        pass
    ...
    def start_discovery(self): # real signature unknown; restored from __doc__
    ...
    def stop_discovery(self): # real signature unknown; restored from __doc__
        """ stop_discovery(self) """
        pass
...
class ChooserButton(__gi_overrides_Gtk.Button):
    ...
    def do_chooser_created(self, *args, **kwargs): # real signature unknown
        """ chooser_created(self, chooser:Gtk.Widget) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8a63e247c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ChooserButton), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType BluetoothChooserButton (94371299436672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'available': gi.FunctionInfo(available), 'do_chooser_created': gi.VFuncInfo(chooser_created)})"
    __gdoc__ = "Object BluetoothChooserButton\n\nSignals from BluetoothChooserButton:\n  chooser-created (GObject)\n\nProperties from BluetoothChooserButton:\n  device -> gchararray: Device\n    The Bluetooth address of the selected device.\n  is-available -> gboolean: Bluetooth is available\n    Whether Bluetooth is available.\n\nSignals from GtkButton:\n  activate ()\n  pressed ()\n  released ()\n  clicked ()\n  enter ()\n  leave ()\n\nProperties from GtkButton:\n  label -> gchararray: Label\n    Text of the label widget inside the button, if the button contains a label widget\n  image -> GtkWidget: Image widget\n    Child widget to appear next to the button text\n  relief -> GtkReliefStyle: Border relief\n    The border relief style\n  use-underline -> gboolean: Use underline\n    If set, an underline in the text indicates the next character should be used for the mnemonic accelerator key\n  use-stock -> gboolean: Use stock\n    If set, the label is used to pick a stock item instead of being displayed\n  xalign -> gfloat: Horizontal alignment for child\n    Horizontal position of child in available space. 0.0 is left aligned, 1.0 is right aligned\n  yalign -> gfloat: Vertical alignment for child\n    Vertical position of child in available space. 0.0 is top aligned, 1.0 is bottom aligned\n  image-position -> GtkPositionType: Image position\n    The position of the image relative to the text\n  always-show-image -> gboolean: Always show image\n    Whether the image will always be shown\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-changed (GtkStateType)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  direction-changed (GtkTextDirection)\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BluetoothChooserButton (94371299436672)>'
    __info__ = ObjectInfo(ChooserButton)


class ChooserButtonClass(__gi.Struct):
    """
    :Constructors:
    ...
    chooser_created = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ChooserButtonClass), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ChooserButtonClass' objects>, '__weakref__': <attribute '__weakref__' of 'ChooserButtonClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f8a63e7e770>, 'chooser_created': <property object at 0x7f8a63e7e7c0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ChooserButtonClass)


class ChooserClass(__gi.Struct):
    """
    :Constructors:
    ...
    selected_device_activated = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    selected_device_changed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ChooserClass), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ChooserClass' objects>, '__weakref__': <attribute '__weakref__' of 'ChooserClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f8a63e7e8b0>, 'selected_device_changed': <property object at 0x7f8a63e7e9f0>, 'selected_device_activated': <property object at 0x7f8a63e7eb30>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ChooserClass)


class ChooserCombo(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        ChooserCombo(**properties)
        new() -> Gtk.Widget
    """
    def activate(self): # real signature unknown; restored from __doc__
        """ activate(self) -> bool """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8a63ddef10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ChooserCombo), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType BluetoothChooserCombo (94371300009472)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'do_chooser_created': gi.VFuncInfo(chooser_created), 'parent': <property object at 0x7f8a63e7ec70>, 'priv': <property object at 0x7f8a63e7edb0>})"
    __gdoc__ = "Object BluetoothChooserCombo\n\nSignals from BluetoothChooserCombo:\n  chooser-created (GObject)\n\nProperties from BluetoothChooserCombo:\n  chooser -> BluetoothChooser: Chooser\n    The #BluetoothChooser used in the widget\n  device -> gchararray: Device\n    The Bluetooth address of the selected device.\n\nProperties from GtkBox:\n  spacing -> gint: Spacing\n    The amount of space between children\n  homogeneous -> gboolean: Homogeneous\n    Whether the children should all be the same size\n  baseline-position -> GtkBaselinePosition: Baseline position\n    The position of the baseline aligned widgets if extra space is available\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-changed (GtkStateType)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  direction-changed (GtkTextDirection)\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BluetoothChooserCombo (94371300009472)>'
    __info__ = ObjectInfo(ChooserCombo)


class ChooserComboClass(__gi.Struct):
    """
    :Constructors:
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ChooserComboClass), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ChooserComboClass' objects>, '__weakref__': <attribute '__weakref__' of 'ChooserComboClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f8a63e7ef40>, 'chooser_created': <property object at 0x7f8a63dcf090>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ChooserComboClass)


class ChooserComboPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ChooserComboPrivate), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ChooserComboPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'ChooserComboPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ChooserComboPrivate)
...
class Client(__gi_overrides_GObject.Object):
    ...
    def connect_service(self, path, connect, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ connect_service(self, path:str, connect:bool, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def connect_service_finish(self, res): # real signature unknown; restored from __doc__
        """ connect_service_finish(self, res:Gio.AsyncResult) -> bool """
        return False
    ...
    def get_adapter_model(self): # real signature unknown; restored from __doc__
        """ get_adapter_model(self) -> Gtk.TreeModel """
        pass
    ...
    def get_device_model(self): # real signature unknown; restored from __doc__
        """ get_device_model(self) -> Gtk.TreeModel """
        pass

    def get_filter_model(self, func, data=None): # real signature unknown; restored from __doc__
        """ get_filter_model(self, func:Gtk.TreeModelFilterVisibleFunc, data=None) -> Gtk.TreeModel """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8a63e2a640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Client), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType BluetoothClient (94371300269216)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'connect_service': gi.FunctionInfo(connect_service), 'connect_service_finish': gi.FunctionInfo(connect_service_finish), 'get_adapter_model': gi.FunctionInfo(get_adapter_model), 'get_device_model': gi.FunctionInfo(get_device_model), 'get_filter_model': gi.FunctionInfo(get_filter_model), 'get_model': gi.FunctionInfo(get_model), 'parent': <property object at 0x7f8a63dcf400>})"
    __gdoc__ = 'Object BluetoothClient\n\nSignals from BluetoothClient:\n  device-removed (gchararray)\n\nProperties from BluetoothClient:\n  default-adapter -> gchararray: default-adapter\n    The D-Bus path of the default adapter\n  default-adapter-powered -> gboolean: default-adapter-powered\n    Whether the default adapter is powered\n  default-adapter-discoverable -> gboolean: default-adapter-discoverable\n    Whether the default adapter is visible by other devices during discovery\n  default-adapter-name -> gchararray: default-adapter-name\n    The human readable name of the default adapter\n  default-adapter-discovering -> gboolean: default-adapter-discovering\n    Whether the default adapter is searching for devices\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BluetoothClient (94371300269216)>'
...
class ClientClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ClientClass), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ClientClass' objects>, '__weakref__': <attribute '__weakref__' of 'ClientClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f8a63dcf590>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ClientClass)


class Column(__gobject.GEnum):
    # no doc
    def as_integer_ratio(self): # real signature unknown; restored from __doc__
        """
        Return integer ratio.
    ...
    UUIDS = 16
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GnomeBluetooth', '__dict__': <attribute '__dict__' of 'Column' objects>, '__doc__': None, '__gtype__': <GType PyGnomeBluetoothColumn (94371299916288)>, '__enum_values__': {0: <enum BLUETOOTH_COLUMN_PROXY of type GnomeBluetooth.Column>, 1: <enum BLUETOOTH_COLUMN_PROPERTIES of type GnomeBluetooth.Column>, 2: <enum BLUETOOTH_COLUMN_ADDRESS of type GnomeBluetooth.Column>, 3: <enum BLUETOOTH_COLUMN_ALIAS of type GnomeBluetooth.Column>, 4: <enum BLUETOOTH_COLUMN_NAME of type GnomeBluetooth.Column>, 5: <enum BLUETOOTH_COLUMN_TYPE of type GnomeBluetooth.Column>, 6: <enum BLUETOOTH_COLUMN_ICON of type GnomeBluetooth.Column>, 7: <enum BLUETOOTH_COLUMN_DEFAULT of type GnomeBluetooth.Column>, 8: <enum BLUETOOTH_COLUMN_PAIRED of type GnomeBluetooth.Column>, 9: <enum BLUETOOTH_COLUMN_TRUSTED of type GnomeBluetooth.Column>, 10: <enum BLUETOOTH_COLUMN_CONNECTED of type GnomeBluetooth.Column>, 11: <enum BLUETOOTH_COLUMN_DISCOVERABLE of type GnomeBluetooth.Column>, 12: <enum BLUETOOTH_COLUMN_DISCOVERING of type GnomeBluetooth.Column>, 13: <enum BLUETOOTH_COLUMN_LEGACYPAIRING of type GnomeBluetooth.Column>, 14: <enum BLUETOOTH_COLUMN_POWERED of type GnomeBluetooth.Column>, 15: <enum BLUETOOTH_COLUMN_SERVICES of type GnomeBluetooth.Column>, 16: <enum BLUETOOTH_COLUMN_UUIDS of type GnomeBluetooth.Column>}, '__info__': gi.EnumInfo(Column), 'PROXY': <enum BLUETOOTH_COLUMN_PROXY of type GnomeBluetooth.Column>, 'PROPERTIES': <enum BLUETOOTH_COLUMN_PROPERTIES of type GnomeBluetooth.Column>, 'ADDRESS': <enum BLUETOOTH_COLUMN_ADDRESS of type GnomeBluetooth.Column>, 'ALIAS': <enum BLUETOOTH_COLUMN_ALIAS of type GnomeBluetooth.Column>, 'NAME': <enum BLUETOOTH_COLUMN_NAME of type GnomeBluetooth.Column>, 'TYPE': <enum BLUETOOTH_COLUMN_TYPE of type GnomeBluetooth.Column>, 'ICON': <enum BLUETOOTH_COLUMN_ICON of type GnomeBluetooth.Column>, 'DEFAULT': <enum BLUETOOTH_COLUMN_DEFAULT of type GnomeBluetooth.Column>, 'PAIRED': <enum BLUETOOTH_COLUMN_PAIRED of type GnomeBluetooth.Column>, 'TRUSTED': <enum BLUETOOTH_COLUMN_TRUSTED of type GnomeBluetooth.Column>, 'CONNECTED': <enum BLUETOOTH_COLUMN_CONNECTED of type GnomeBluetooth.Column>, 'DISCOVERABLE': <enum BLUETOOTH_COLUMN_DISCOVERABLE of type GnomeBluetooth.Column>, 'DISCOVERING': <enum BLUETOOTH_COLUMN_DISCOVERING of type GnomeBluetooth.Column>, 'LEGACYPAIRING': <enum BLUETOOTH_COLUMN_LEGACYPAIRING of type GnomeBluetooth.Column>, 'POWERED': <enum BLUETOOTH_COLUMN_POWERED of type GnomeBluetooth.Column>, 'SERVICES': <enum BLUETOOTH_COLUMN_SERVICES of type GnomeBluetooth.Column>, 'UUIDS': <enum BLUETOOTH_COLUMN_UUIDS of type GnomeBluetooth.Column>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType PyGnomeBluetoothColumn (94371299916288)>'
    __info__ = gi.EnumInfo(Column)


class FilterWidget(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def bind_filter(self, chooser): # real signature unknown; restored from __doc__
        """ bind_filter(self, chooser:GnomeBluetooth.Chooser) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8a63e41430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FilterWidget), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType BluetoothFilterWidget (94371299916400)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'bind_filter': gi.FunctionInfo(bind_filter), 'set_title': gi.FunctionInfo(set_title), 'parent': <property object at 0x7f8a63dcfc70>})"
    __gdoc__ = "Object BluetoothFilterWidget\n\nProperties from BluetoothFilterWidget:\n  show-device-type -> gboolean: show-device-type\n    Whether to show the device type filter\n  show-device-category -> gboolean: show-device-category\n    Whether to show the device category filter\n  device-type-filter -> gint: device-type-filter\n    A bitmask of #BluetoothType to show\n  device-category-filter -> BluetoothCategory: device-category-filter\n    The #BluetoothCategory to show\n  device-service-filter -> gchararray: device-service-filter\n    A string representing the service to filter for\n\nProperties from GtkBox:\n  spacing -> gint: Spacing\n    The amount of space between children\n  homogeneous -> gboolean: Homogeneous\n    Whether the children should all be the same size\n  baseline-position -> GtkBaselinePosition: Baseline position\n    The position of the baseline aligned widgets if extra space is available\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-changed (GtkStateType)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  direction-changed (GtkTextDirection)\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BluetoothFilterWidget (94371299916400)>'
    __info__ = ObjectInfo(FilterWidget)


class FilterWidgetClass(__gi.Struct):
    """
    :Constructors:
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(FilterWidgetClass), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'FilterWidgetClass' objects>, '__weakref__': <attribute '__weakref__' of 'FilterWidgetClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f8a63dcfe50>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(FilterWidgetClass)


class SettingsWidget(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def get_default_adapter_powered(self): # real signature unknown; restored from __doc__
        """ get_default_adapter_powered(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f8a63dde1f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SettingsWidget), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType BluetoothSettingsWidget (94371300188608)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_default_adapter_powered': gi.FunctionInfo(get_default_adapter_powered), 'parent': <property object at 0x7f8a63dd2090>})"
    __gdoc__ = "Object BluetoothSettingsWidget\n\nSignals from BluetoothSettingsWidget:\n  panel-changed (gchararray)\n  adapter-status-changed ()\n\nProperties from GtkBox:\n  spacing -> gint: Spacing\n    The amount of space between children\n  homogeneous -> gboolean: Homogeneous\n    Whether the children should all be the same size\n  baseline-position -> GtkBaselinePosition: Baseline position\n    The position of the baseline aligned widgets if extra space is available\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-changed (GtkStateType)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  direction-changed (GtkTextDirection)\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BluetoothSettingsWidget (94371300188608)>'
    __info__ = ObjectInfo(SettingsWidget)


class SettingsWidgetClass(__gi.Struct):
    """
    :Constructors:
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SettingsWidgetClass), '__module__': 'gi.repository.GnomeBluetooth', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SettingsWidgetClass' objects>, '__weakref__': <attribute '__weakref__' of 'SettingsWidgetClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f8a63dd2220>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(SettingsWidgetClass)
...
class Status(__gobject.GEnum):
    ...
    PLAYING = 4
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GnomeBluetooth', '__dict__': <attribute '__dict__' of 'Status' objects>, '__doc__': None, '__gtype__': <GType PyGnomeBluetoothStatus (94371300322016)>, '__enum_values__': {0: <enum BLUETOOTH_STATUS_INVALID of type GnomeBluetooth.Status>, 1: <enum BLUETOOTH_STATUS_DISCONNECTED of type GnomeBluetooth.Status>, 2: <enum BLUETOOTH_STATUS_CONNECTED of type GnomeBluetooth.Status>, 3: <enum BLUETOOTH_STATUS_CONNECTING of type GnomeBluetooth.Status>, 4: <enum BLUETOOTH_STATUS_PLAYING of type GnomeBluetooth.Status>}, '__info__': gi.EnumInfo(Status), 'INVALID': <enum BLUETOOTH_STATUS_INVALID of type GnomeBluetooth.Status>, 'DISCONNECTED': <enum BLUETOOTH_STATUS_DISCONNECTED of type GnomeBluetooth.Status>, 'CONNECTED': <enum BLUETOOTH_STATUS_CONNECTED of type GnomeBluetooth.Status>, 'CONNECTING': <enum BLUETOOTH_STATUS_CONNECTING of type GnomeBluetooth.Status>, 'PLAYING': <enum BLUETOOTH_STATUS_PLAYING of type GnomeBluetooth.Status>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType PyGnomeBluetoothStatus (94371300322016)>'
    __info__ = gi.EnumInfo(Status)


class Type(__gobject.GFlags):
    # no doc
    def as_integer_ratio(self): # real signature unknown; restored from __doc__
        """
        Return integer ratio.
    ...
    WEARABLE = 262144
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GnomeBluetooth', '__dict__': <attribute '__dict__' of 'Type' objects>, '__doc__': None, '__gtype__': <GType PyGnomeBluetoothType (94371299914816)>, '__flags_values__': {1: <flags BLUETOOTH_TYPE_ANY of type GnomeBluetooth.Type>, 2: <flags BLUETOOTH_TYPE_PHONE of type GnomeBluetooth.Type>, 4: <flags BLUETOOTH_TYPE_MODEM of type GnomeBluetooth.Type>, 8: <flags BLUETOOTH_TYPE_COMPUTER of type GnomeBluetooth.Type>, 16: <flags BLUETOOTH_TYPE_NETWORK of type GnomeBluetooth.Type>, 32: <flags BLUETOOTH_TYPE_HEADSET of type GnomeBluetooth.Type>, 64: <flags BLUETOOTH_TYPE_HEADPHONES of type GnomeBluetooth.Type>, 128: <flags BLUETOOTH_TYPE_OTHER_AUDIO of type GnomeBluetooth.Type>, 256: <flags BLUETOOTH_TYPE_KEYBOARD of type GnomeBluetooth.Type>, 512: <flags BLUETOOTH_TYPE_MOUSE of type GnomeBluetooth.Type>, 1024: <flags BLUETOOTH_TYPE_CAMERA of type GnomeBluetooth.Type>, 2048: <flags BLUETOOTH_TYPE_PRINTER of type GnomeBluetooth.Type>, 4096: <flags BLUETOOTH_TYPE_JOYPAD of type GnomeBluetooth.Type>, 8192: <flags BLUETOOTH_TYPE_TABLET of type GnomeBluetooth.Type>, 16384: <flags BLUETOOTH_TYPE_VIDEO of type GnomeBluetooth.Type>, 32768: <flags BLUETOOTH_TYPE_REMOTE_CONTROL of type GnomeBluetooth.Type>, 65536: <flags BLUETOOTH_TYPE_SCANNER of type GnomeBluetooth.Type>, 131072: <flags BLUETOOTH_TYPE_DISPLAY of type GnomeBluetooth.Type>, 262144: <flags BLUETOOTH_TYPE_WEARABLE of type GnomeBluetooth.Type>, 524288: <flags BLUETOOTH_TYPE_TOY of type GnomeBluetooth.Type>}, '__info__': gi.EnumInfo(Type), 'ANY': <flags BLUETOOTH_TYPE_ANY of type GnomeBluetooth.Type>, 'PHONE': <flags BLUETOOTH_TYPE_PHONE of type GnomeBluetooth.Type>, 'MODEM': <flags BLUETOOTH_TYPE_MODEM of type GnomeBluetooth.Type>, 'COMPUTER': <flags BLUETOOTH_TYPE_COMPUTER of type GnomeBluetooth.Type>, 'NETWORK': <flags BLUETOOTH_TYPE_NETWORK of type GnomeBluetooth.Type>, 'HEADSET': <flags BLUETOOTH_TYPE_HEADSET of type GnomeBluetooth.Type>, 'HEADPHONES': <flags BLUETOOTH_TYPE_HEADPHONES of type GnomeBluetooth.Type>, 'OTHER_AUDIO': <flags BLUETOOTH_TYPE_OTHER_AUDIO of type GnomeBluetooth.Type>, 'KEYBOARD': <flags BLUETOOTH_TYPE_KEYBOARD of type GnomeBluetooth.Type>, 'MOUSE': <flags BLUETOOTH_TYPE_MOUSE of type GnomeBluetooth.Type>, 'CAMERA': <flags BLUETOOTH_TYPE_CAMERA of type GnomeBluetooth.Type>, 'PRINTER': <flags BLUETOOTH_TYPE_PRINTER of type GnomeBluetooth.Type>, 'JOYPAD': <flags BLUETOOTH_TYPE_JOYPAD of type GnomeBluetooth.Type>, 'TABLET': <flags BLUETOOTH_TYPE_TABLET of type GnomeBluetooth.Type>, 'VIDEO': <flags BLUETOOTH_TYPE_VIDEO of type GnomeBluetooth.Type>, 'REMOTE_CONTROL': <flags BLUETOOTH_TYPE_REMOTE_CONTROL of type GnomeBluetooth.Type>, 'SCANNER': <flags BLUETOOTH_TYPE_SCANNER of type GnomeBluetooth.Type>, 'DISPLAY': <flags BLUETOOTH_TYPE_DISPLAY of type GnomeBluetooth.Type>, 'WEARABLE': <flags BLUETOOTH_TYPE_WEARABLE of type GnomeBluetooth.Type>, 'TOY': <flags BLUETOOTH_TYPE_TOY of type GnomeBluetooth.Type>})"
    __flags_values__ = {
        1: 1,
        2: 2,
        4: 4,
    ...
    __gtype__ = None # (!) real value is '<GType PyGnomeBluetoothType (94371299914816)>'
    __info__ = gi.EnumInfo(Type)
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7f8a652051f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7f8a65205280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7f8a65205310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7f8a652053a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7f8a65e41d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/GnomeBluetooth-1.0.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.GnomeBluetooth', loader=<gi.importer.DynamicImporter object at 0x7f8a65e41d00>)"
