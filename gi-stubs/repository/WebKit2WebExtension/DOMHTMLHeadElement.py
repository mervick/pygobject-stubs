...
class DOMHTMLHeadElement(DOMHTMLElement):
    ...
    def set_profile(self, value): # real signature unknown; restored from __doc__
        """ set_profile(self, value:str) """
        pass
