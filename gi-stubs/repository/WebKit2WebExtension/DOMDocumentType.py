...
class DOMDocumentType(DOMNode):
    ...
    def get_entities(self): # real signature unknown; restored from __doc__
        """ get_entities(self) -> WebKit2WebExtension.DOMNamedNodeMap """
        pass
    ...
    def get_internal_subset(self): # real signature unknown; restored from __doc__
        """ get_internal_subset(self) -> str """
        return ""
    ...
    def get_notations(self): # real signature unknown; restored from __doc__
        """ get_notations(self) -> WebKit2WebExtension.DOMNamedNodeMap """
        pass
    ...
    def get_public_id(self): # real signature unknown; restored from __doc__
        """ get_public_id(self) -> str """
        return ""
