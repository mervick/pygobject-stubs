...
class DOMElement(DOMNode):
    ...
    def set_inner_html(self, value): # real signature unknown; restored from __doc__
        """ set_inner_html(self, value:str) """
        pass
    ...
    def set_outer_html(self, value): # real signature unknown; restored from __doc__
        """ set_outer_html(self, value:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f17456018e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DOMElement), '__module__': 'gi.repository.WebKit2WebExtension', '__gtype__': <GType WebKitDOMElement (94252901424608)>, '__doc__': None, '__gsignals__': {}, 'blur': gi.FunctionInfo(blur), 'closest': gi.FunctionInfo(closest), 'focus': gi.FunctionInfo(focus), 'get_attribute': gi.FunctionInfo(get_attribute), 'get_attribute_node': gi.FunctionInfo(get_attribute_node), 'get_attribute_node_ns': gi.FunctionInfo(get_attribute_node_ns), 'get_attribute_ns': gi.FunctionInfo(get_attribute_ns), 'get_attributes': gi.FunctionInfo(get_attributes), 'get_bounding_client_rect': gi.FunctionInfo(get_bounding_client_rect), 'get_child_element_count': gi.FunctionInfo(get_child_element_count), 'get_children': gi.FunctionInfo(get_children), 'get_class_list': gi.FunctionInfo(get_class_list), 'get_class_name': gi.FunctionInfo(get_class_name), 'get_client_height': gi.FunctionInfo(get_client_height), 'get_client_left': gi.FunctionInfo(get_client_left), 'get_client_rects': gi.FunctionInfo(get_client_rects), 'get_client_top': gi.FunctionInfo(get_client_top), 'get_client_width': gi.FunctionInfo(get_client_width), 'get_elements_by_class_name': gi.FunctionInfo(get_elements_by_class_name), 'get_elements_by_class_name_as_html_collection': gi.FunctionInfo(get_elements_by_class_name_as_html_collection), 'get_elements_by_tag_name': gi.FunctionInfo(get_elements_by_tag_name), 'get_elements_by_tag_name_as_html_collection': gi.FunctionInfo(get_elements_by_tag_name_as_html_collection), 'get_elements_by_tag_name_ns': gi.FunctionInfo(get_elements_by_tag_name_ns), 'get_elements_by_tag_name_ns_as_html_collection': gi.FunctionInfo(get_elements_by_tag_name_ns_as_html_collection), 'get_first_element_child': gi.FunctionInfo(get_first_element_child), 'get_id': gi.FunctionInfo(get_id), 'get_inner_html': gi.FunctionInfo(get_inner_html), 'get_last_element_child': gi.FunctionInfo(get_last_element_child), 'get_local_name': gi.FunctionInfo(get_local_name), 'get_namespace_uri': gi.FunctionInfo(get_namespace_uri), 'get_next_element_sibling': gi.FunctionInfo(get_next_element_sibling), 'get_offset_height': gi.FunctionInfo(get_offset_height), 'get_offset_left': gi.FunctionInfo(get_offset_left), 'get_offset_parent': gi.FunctionInfo(get_offset_parent), 'get_offset_top': gi.FunctionInfo(get_offset_top), 'get_offset_width': gi.FunctionInfo(get_offset_width), 'get_outer_html': gi.FunctionInfo(get_outer_html), 'get_prefix': gi.FunctionInfo(get_prefix), 'get_previous_element_sibling': gi.FunctionInfo(get_previous_element_sibling), 'get_scroll_height': gi.FunctionInfo(get_scroll_height), 'get_scroll_left': gi.FunctionInfo(get_scroll_left), 'get_scroll_top': gi.FunctionInfo(get_scroll_top), 'get_scroll_width': gi.FunctionInfo(get_scroll_width), 'get_style': gi.FunctionInfo(get_style), 'get_tag_name': gi.FunctionInfo(get_tag_name), 'get_webkit_region_overset': gi.FunctionInfo(get_webkit_region_overset), 'has_attribute': gi.FunctionInfo(has_attribute), 'has_attribute_ns': gi.FunctionInfo(has_attribute_ns), 'has_attributes': gi.FunctionInfo(has_attributes), 'html_input_element_get_auto_filled': gi.FunctionInfo(html_input_element_get_auto_filled), 'html_input_element_is_user_edited': gi.FunctionInfo(html_input_element_is_user_edited), 'html_input_element_set_auto_filled': gi.FunctionInfo(html_input_element_set_auto_filled), 'html_input_element_set_editing_value': gi.FunctionInfo(html_input_element_set_editing_value), 'insert_adjacent_element': gi.FunctionInfo(insert_adjacent_element), 'insert_adjacent_html': gi.FunctionInfo(insert_adjacent_html), 'insert_adjacent_text': gi.FunctionInfo(insert_adjacent_text), 'matches': gi.FunctionInfo(matches), 'query_selector': gi.FunctionInfo(query_selector), 'query_selector_all': gi.FunctionInfo(query_selector_all), 'remove': gi.FunctionInfo(remove), 'remove_attribute': gi.FunctionInfo(remove_attribute), 'remove_attribute_node': gi.FunctionInfo(remove_attribute_node), 'remove_attribute_ns': gi.FunctionInfo(remove_attribute_ns), 'request_pointer_lock': gi.FunctionInfo(request_pointer_lock), 'scroll_by_lines': gi.FunctionInfo(scroll_by_lines), 'scroll_by_pages': gi.FunctionInfo(scroll_by_pages), 'scroll_into_view': gi.FunctionInfo(scroll_into_view), 'scroll_into_view_if_needed': gi.FunctionInfo(scroll_into_view_if_needed), 'set_attribute': gi.FunctionInfo(set_attribute), 'set_attribute_node': gi.FunctionInfo(set_attribute_node), 'set_attribute_node_ns': gi.FunctionInfo(set_attribute_node_ns), 'set_attribute_ns': gi.FunctionInfo(set_attribute_ns), 'set_class_name': gi.FunctionInfo(set_class_name), 'set_id': gi.FunctionInfo(set_id), 'set_inner_html': gi.FunctionInfo(set_inner_html), 'set_outer_html': gi.FunctionInfo(set_outer_html), 'set_scroll_left': gi.FunctionInfo(set_scroll_left), 'set_scroll_top': gi.FunctionInfo(set_scroll_top), 'webkit_matches_selector': gi.FunctionInfo(webkit_matches_selector), 'webkit_request_fullscreen': gi.FunctionInfo(webkit_request_fullscreen), 'parent_instance': <property object at 0x7f174d0b9900>})"
    __gdoc__ = 'Object WebKitDOMElement\n\nProperties from WebKitDOMElement:\n  tag-name -> gchararray: Element:tag-name\n    read-only gchar* Element:tag-name\n  attributes -> WebKitDOMNamedNodeMap: Element:attributes\n    read-only WebKitDOMNamedNodeMap* Element:attributes\n  style -> WebKitDOMCSSStyleDeclaration: Element:style\n    read-only WebKitDOMCSSStyleDeclaration* Element:style\n  id -> gchararray: Element:id\n    read-write gchar* Element:id\n  namespace-uri -> gchararray: Element:namespace-uri\n    read-only gchar* Element:namespace-uri\n  prefix -> gchararray: Element:prefix\n    read-only gchar* Element:prefix\n  local-name -> gchararray: Element:local-name\n    read-only gchar* Element:local-name\n  offset-left -> gdouble: Element:offset-left\n    read-only gdouble Element:offset-left\n  offset-top -> gdouble: Element:offset-top\n    read-only gdouble Element:offset-top\n  offset-width -> gdouble: Element:offset-width\n    read-only gdouble Element:offset-width\n  offset-height -> gdouble: Element:offset-height\n    read-only gdouble Element:offset-height\n  client-left -> gdouble: Element:client-left\n    read-only gdouble Element:client-left\n  client-top -> gdouble: Element:client-top\n    read-only gdouble Element:client-top\n  client-width -> gdouble: Element:client-width\n    read-only gdouble Element:client-width\n  client-height -> gdouble: Element:client-height\n    read-only gdouble Element:client-height\n  scroll-left -> glong: Element:scroll-left\n    read-write glong Element:scroll-left\n  scroll-top -> glong: Element:scroll-top\n    read-write glong Element:scroll-top\n  scroll-width -> glong: Element:scroll-width\n    read-only glong Element:scroll-width\n  scroll-height -> glong: Element:scroll-height\n    read-only glong Element:scroll-height\n  offset-parent -> WebKitDOMElement: Element:offset-parent\n    read-only WebKitDOMElement* Element:offset-parent\n  inner-html -> gchararray: Element:inner-html\n    read-write gchar* Element:inner-html\n  outer-html -> gchararray: Element:outer-html\n    read-write gchar* Element:outer-html\n  class-name -> gchararray: Element:class-name\n    read-write gchar* Element:class-name\n  class-list -> WebKitDOMDOMTokenList: Element:class-list\n    read-only WebKitDOMDOMTokenList* Element:class-list\n  webkit-region-overset -> gchararray: Element:webkit-region-overset\n    read-only gchar* Element:webkit-region-overset\n  previous-element-sibling -> WebKitDOMElement: Element:previous-element-sibling\n    read-only WebKitDOMElement* Element:previous-element-sibling\n  next-element-sibling -> WebKitDOMElement: Element:next-element-sibling\n    read-only WebKitDOMElement* Element:next-element-sibling\n  children -> WebKitDOMHTMLCollection: Element:children\n    read-only WebKitDOMHTMLCollection* Element:children\n  first-element-child -> WebKitDOMElement: Element:first-element-child\n    read-only WebKitDOMElement* Element:first-element-child\n  last-element-child -> WebKitDOMElement: Element:last-element-child\n    read-only WebKitDOMElement* Element:last-element-child\n  child-element-count -> gulong: Element:child-element-count\n    read-only gulong Element:child-element-count\n\nProperties from WebKitDOMNode:\n  node-name -> gchararray: Node:node-name\n    read-only gchar* Node:node-name\n  node-value -> gchararray: Node:node-value\n    read-write gchar* Node:node-value\n  node-type -> guint: Node:node-type\n    read-only gushort Node:node-type\n  parent-node -> WebKitDOMNode: Node:parent-node\n    read-only WebKitDOMNode* Node:parent-node\n  child-nodes -> WebKitDOMNodeList: Node:child-nodes\n    read-only WebKitDOMNodeList* Node:child-nodes\n  first-child -> WebKitDOMNode: Node:first-child\n    read-only WebKitDOMNode* Node:first-child\n  last-child -> WebKitDOMNode: Node:last-child\n    read-only WebKitDOMNode* Node:last-child\n  previous-sibling -> WebKitDOMNode: Node:previous-sibling\n    read-only WebKitDOMNode* Node:previous-sibling\n  next-sibling -> WebKitDOMNode: Node:next-sibling\n    read-only WebKitDOMNode* Node:next-sibling\n  owner-document -> WebKitDOMDocument: Node:owner-document\n    read-only WebKitDOMDocument* Node:owner-document\n  base-uri -> gchararray: Node:base-uri\n    read-only gchar* Node:base-uri\n  text-content -> gchararray: Node:text-content\n    read-write gchar* Node:text-content\n  parent-element -> WebKitDOMElement: Node:parent-element\n    read-only WebKitDOMElement* Node:parent-element\n\nProperties from WebKitDOMObject:\n  core-object -> gpointer: Core Object\n    The WebCore object the WebKitDOMObject wraps\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType WebKitDOMElement (94252901424608)>'
    __info__ = ObjectInfo(DOMElement)
