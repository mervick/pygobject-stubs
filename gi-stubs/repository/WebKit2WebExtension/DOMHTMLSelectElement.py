...
class DOMHTMLSelectElement(DOMHTMLElement):
    ...
    ::
        ...
        DOMHTMLSelectElement(**properties)
    """
    def add(self, element, before): # real signature unknown; restored from __doc__
        """ add(self, element:WebKit2WebExtension.DOMHTMLElement, before:WebKit2WebExtension.DOMHTMLElement) """
        pass
    ...
    def get_options(self): # real signature unknown; restored from __doc__
        """ get_options(self) -> WebKit2WebExtension.DOMHTMLOptionsCollection """
        pass
    ...
    def get_select_type(self): # real signature unknown; restored from __doc__
        """ get_select_type(self) -> str """
        return ""
    ...
    def item(self, index): # real signature unknown; restored from __doc__
        """ item(self, index:int) -> WebKit2WebExtension.DOMNode """
        pass
    ...
    def named_item(self, name): # real signature unknown; restored from __doc__
        """ named_item(self, name:str) -> WebKit2WebExtension.DOMNode """
        pass
    ...
    def set_length(self, value): # real signature unknown; restored from __doc__
        """ set_length(self, value:int) """
        pass
    ...
    def set_selected_index(self, value): # real signature unknown; restored from __doc__
        """ set_selected_index(self, value:int) """
        pass
