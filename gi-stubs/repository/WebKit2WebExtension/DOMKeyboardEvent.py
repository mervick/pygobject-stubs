...
class DOMKeyboardEvent(DOMUIEvent):
    ...
    def get_alt_graph_key(self): # real signature unknown; restored from __doc__
        """ get_alt_graph_key(self) -> bool """
        return False
    ...
    def get_key_identifier(self): # real signature unknown; restored from __doc__
        """ get_key_identifier(self) -> str """
        return ""

    def get_key_location(self): # real signature unknown; restored from __doc__
        """ get_key_location(self) -> int """
        return 0
    ...
    def get_modifier_state(self, keyIdentifierArg): # real signature unknown; restored from __doc__
        """ get_modifier_state(self, keyIdentifierArg:str) -> bool """
        return False
    ...
    def init_keyboard_event(self, type, canBubble, cancelable, view, keyIdentifier, location, ctrlKey, altKey, shiftKey, metaKey, altGraphKey): # real signature unknown; restored from __doc__
        """ init_keyboard_event(self, type:str, canBubble:bool, cancelable:bool, view:WebKit2WebExtension.DOMDOMWindow, keyIdentifier:str, location:int, ctrlKey:bool, altKey:bool, shiftKey:bool, metaKey:bool, altGraphKey:bool) """
        pass
