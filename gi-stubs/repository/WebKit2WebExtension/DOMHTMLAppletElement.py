...
class DOMHTMLAppletElement(DOMHTMLElement):
    ...
    ::
        ...
        DOMHTMLAppletElement(**properties)
    """
    ...
    def set_object(self, value): # real signature unknown; restored from __doc__
        """ set_object(self, value:str) """
        pass
