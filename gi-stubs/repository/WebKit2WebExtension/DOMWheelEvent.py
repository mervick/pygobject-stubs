...
from .DOMMouseEvent import DOMMouseEvent
...
class DOMWheelEvent(DOMMouseEvent):
    ...
    def get_alt_key(self): # real signature unknown; restored from __doc__
    ...
    def get_client_x(self): # real signature unknown; restored from __doc__
        """ get_client_x(self) -> int """
        return 0

    def get_client_y(self): # real signature unknown; restored from __doc__
        """ get_client_y(self) -> int """
        return 0

    def get_ctrl_key(self): # real signature unknown; restored from __doc__
    ...
    def get_from_element(self): # real signature unknown; restored from __doc__
        """ get_from_element(self) -> WebKit2WebExtension.DOMNode """
        pass
    ...
    def get_meta_key(self): # real signature unknown; restored from __doc__
        """ get_meta_key(self) -> bool """
        return False

    def get_offset_x(self): # real signature unknown; restored from __doc__
        """ get_offset_x(self) -> int """
        return 0

    def get_offset_y(self): # real signature unknown; restored from __doc__
    ...
    def get_related_target(self): # real signature unknown; restored from __doc__
        """ get_related_target(self) -> WebKit2WebExtension.DOMEventTarget """
        pass
    ...
    def get_shift_key(self): # real signature unknown; restored from __doc__
    ...
    def get_to_element(self): # real signature unknown; restored from __doc__
        """ get_to_element(self) -> WebKit2WebExtension.DOMNode """
        pass
    ...
    def get_wheel_delta(self): # real signature unknown; restored from __doc__
        """ get_wheel_delta(self) -> int """
        return 0

    def get_wheel_delta_x(self): # real signature unknown; restored from __doc__
        """ get_wheel_delta_x(self) -> int """
        return 0

    def get_wheel_delta_y(self): # real signature unknown; restored from __doc__
        """ get_wheel_delta_y(self) -> int """
        return 0
    ...
    def init_mouse_event(self, type, canBubble, cancelable, view, detail, screenX, screenY, clientX, clientY, ctrlKey, altKey, shiftKey, metaKey, button, relatedTarget): # real signature unknown; restored from __doc__
        """ init_mouse_event(self, type:str, canBubble:bool, cancelable:bool, view:WebKit2WebExtension.DOMDOMWindow, detail:int, screenX:int, screenY:int, clientX:int, clientY:int, ctrlKey:bool, altKey:bool, shiftKey:bool, metaKey:bool, button:int, relatedTarget:WebKit2WebExtension.DOMEventTarget) """
        pass
    ...
    def init_wheel_event(self, wheelDeltaX, wheelDeltaY, view, screenX, screenY, clientX, clientY, ctrlKey, altKey, shiftKey, metaKey): # real signature unknown; restored from __doc__
        """ init_wheel_event(self, wheelDeltaX:int, wheelDeltaY:int, view:WebKit2WebExtension.DOMDOMWindow, screenX:int, screenY:int, clientX:int, clientY:int, ctrlKey:bool, altKey:bool, shiftKey:bool, metaKey:bool) """
        pass
