...
class DOMHTMLParamElement(DOMHTMLElement):
    ...
    ::
        ...
        DOMHTMLParamElement(**properties)
    """
    ...
    def set_value_type(self, value): # real signature unknown; restored from __doc__
        """ set_value_type(self, value:str) """
        pass
