...
class DOMHTMLHRElement(DOMHTMLElement):
    ...
    def get_no_shade(self): # real signature unknown; restored from __doc__
        """ get_no_shade(self) -> bool """
        return False
    ...
    def set_no_shade(self, value): # real signature unknown; restored from __doc__
        """ set_no_shade(self, value:bool) """
        pass
