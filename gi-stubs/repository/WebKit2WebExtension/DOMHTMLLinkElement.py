...
class DOMHTMLLinkElement(DOMHTMLElement):
    ...
    def get_sheet(self): # real signature unknown; restored from __doc__
        """ get_sheet(self) -> WebKit2WebExtension.DOMStyleSheet """
        pass

    def get_sizes(self): # real signature unknown; restored from __doc__
        """ get_sizes(self) -> WebKit2WebExtension.DOMDOMTokenList """
        pass
    ...
    def set_media(self, value): # real signature unknown; restored from __doc__
        """ set_media(self, value:str) """
        pass
    ...
    def set_sizes(self, value): # real signature unknown; restored from __doc__
        """ set_sizes(self, value:str) """
        pass
