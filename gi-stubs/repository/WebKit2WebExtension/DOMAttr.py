...
class DOMAttr(DOMNode):
    ...
    def get_owner_element(self): # real signature unknown; restored from __doc__
        """ get_owner_element(self) -> WebKit2WebExtension.DOMElement """
        pass
    ...
    def get_specified(self): # real signature unknown; restored from __doc__
        """ get_specified(self) -> bool """
        return False
