...
class DOMHTMLMapElement(DOMHTMLElement):
    ...
    def get_areas(self): # real signature unknown; restored from __doc__
        """ get_areas(self) -> WebKit2WebExtension.DOMHTMLCollection """
        pass
