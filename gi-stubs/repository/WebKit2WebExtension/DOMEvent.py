...
class DOMEvent(DOMObject):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f174d0e0eb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DOMEvent), '__module__': 'gi.repository.WebKit2WebExtension', '__gtype__': <GType WebKitDOMEvent (94252901525568)>, '__doc__': None, '__gsignals__': {}, 'get_bubbles': gi.FunctionInfo(get_bubbles), 'get_cancel_bubble': gi.FunctionInfo(get_cancel_bubble), 'get_cancelable': gi.FunctionInfo(get_cancelable), 'get_current_target': gi.FunctionInfo(get_current_target), 'get_event_phase': gi.FunctionInfo(get_event_phase), 'get_event_type': gi.FunctionInfo(get_event_type), 'get_return_value': gi.FunctionInfo(get_return_value), 'get_src_element': gi.FunctionInfo(get_src_element), 'get_target': gi.FunctionInfo(get_target), 'get_time_stamp': gi.FunctionInfo(get_time_stamp), 'init_event': gi.FunctionInfo(init_event), 'prevent_default': gi.FunctionInfo(prevent_default), 'set_cancel_bubble': gi.FunctionInfo(set_cancel_bubble), 'set_return_value': gi.FunctionInfo(set_return_value), 'stop_propagation': gi.FunctionInfo(stop_propagation), 'parent_instance': <property object at 0x7f174d0bb0e0>})"
    __gdoc__ = 'Object WebKitDOMEvent\n\nProperties from WebKitDOMEvent:\n  type -> gchararray: Event:type\n    read-only gchar* Event:type\n  target -> WebKitDOMEventTarget: Event:target\n    read-only WebKitDOMEventTarget* Event:target\n  current-target -> WebKitDOMEventTarget: Event:current-target\n    read-only WebKitDOMEventTarget* Event:current-target\n  event-phase -> guint: Event:event-phase\n    read-only gushort Event:event-phase\n  bubbles -> gboolean: Event:bubbles\n    read-only gboolean Event:bubbles\n  cancelable -> gboolean: Event:cancelable\n    read-only gboolean Event:cancelable\n  time-stamp -> guint: Event:time-stamp\n    read-only guint32 Event:time-stamp\n  src-element -> WebKitDOMEventTarget: Event:src-element\n    read-only WebKitDOMEventTarget* Event:src-element\n  return-value -> gboolean: Event:return-value\n    read-write gboolean Event:return-value\n  cancel-bubble -> gboolean: Event:cancel-bubble\n    read-write gboolean Event:cancel-bubble\n\nProperties from WebKitDOMObject:\n  core-object -> gpointer: Core Object\n    The WebCore object the WebKitDOMObject wraps\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType WebKitDOMEvent (94252901525568)>'
    __info__ = ObjectInfo(DOMEvent)
