...
class DOMHTMLMetaElement(DOMHTMLElement):
    ...
    def get_http_equiv(self): # real signature unknown; restored from __doc__
        """ get_http_equiv(self) -> str """
        return ""
    ...
    def set_content(self, value): # real signature unknown; restored from __doc__
    ...
    def set_http_equiv(self, value): # real signature unknown; restored from __doc__
        """ set_http_equiv(self, value:str) """
        pass
    ...
    def set_scheme(self, value): # real signature unknown; restored from __doc__
        """ set_scheme(self, value:str) """
        pass
