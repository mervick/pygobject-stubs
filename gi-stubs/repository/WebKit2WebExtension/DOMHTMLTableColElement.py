...
class DOMHTMLTableColElement(DOMHTMLElement):
    ...
    ::
        ...
        DOMHTMLTableColElement(**properties)
    """
    ...
    def set_span(self, value): # real signature unknown; restored from __doc__
        """ set_span(self, value:int) """
        pass
