...
class DOMHTMLFontElement(DOMHTMLElement):
    ...
    def set_color(self, value): # real signature unknown; restored from __doc__
    ...
    def set_face(self, value): # real signature unknown; restored from __doc__
        """ set_face(self, value:str) """
        pass
