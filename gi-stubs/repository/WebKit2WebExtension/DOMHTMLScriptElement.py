...
class DOMHTMLScriptElement(DOMHTMLElement):
    ...
    ::
        ...
        DOMHTMLScriptElement(**properties)
    """
    ...
    def get_defer(self): # real signature unknown; restored from __doc__
        """ get_defer(self) -> bool """
        return False
    ...
    def get_html_for(self): # real signature unknown; restored from __doc__
        """ get_html_for(self) -> str """
        return ""
    ...
    def set_defer(self, value): # real signature unknown; restored from __doc__
        """ set_defer(self, value:bool) """
        pass
    ...
    def set_event(self, value): # real signature unknown; restored from __doc__
        """ set_event(self, value:str) """
        pass
    ...
    def set_html_for(self, value): # real signature unknown; restored from __doc__
        """ set_html_for(self, value:str) """
        pass
