...
class DOMHTMLTableRowElement(DOMHTMLElement):
    ...
    ::
        ...
        DOMHTMLTableRowElement(**properties)
    """
    ...
    def delete_cell(self, index): # real signature unknown; restored from __doc__
        """ delete_cell(self, index:int) """
        pass
    ...
    def get_cells(self): # real signature unknown; restored from __doc__
        """ get_cells(self) -> WebKit2WebExtension.DOMHTMLCollection """
        pass
    ...
    def get_row_index(self): # real signature unknown; restored from __doc__
        """ get_row_index(self) -> int """
        return 0
    ...
    def get_section_row_index(self): # real signature unknown; restored from __doc__
        """ get_section_row_index(self) -> int """
        return 0
    ...
    def insert_cell(self, index): # real signature unknown; restored from __doc__
        """ insert_cell(self, index:int) -> WebKit2WebExtension.DOMHTMLElement """
        pass
