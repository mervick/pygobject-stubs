...
class DOMHTMLAreaElement(DOMHTMLElement):
    ...
    def get_no_href(self): # real signature unknown; restored from __doc__
        """ get_no_href(self) -> bool """
        return False
    ...
    def set_no_href(self, value): # real signature unknown; restored from __doc__
        """ set_no_href(self, value:bool) """
        pass
