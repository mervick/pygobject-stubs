...
class DOMHTMLButtonElement(DOMHTMLElement):
    ...
    ::
        ...
        DOMHTMLButtonElement(**properties)
    """
    ...
    def get_button_type(self): # real signature unknown; restored from __doc__
        """ get_button_type(self) -> str """
        return ""
    ...
    def set_button_type(self, value): # real signature unknown; restored from __doc__
        """ set_button_type(self, value:str) """
        pass
