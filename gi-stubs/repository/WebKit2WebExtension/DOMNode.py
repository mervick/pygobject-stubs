...
class DOMNode(DOMObject, DOMEventTarget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f1745601430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DOMNode), '__module__': 'gi.repository.WebKit2WebExtension', '__gtype__': <GType WebKitDOMNode (94252901431792)>, '__doc__': None, '__gsignals__': {}, 'for_js_value': gi.FunctionInfo(for_js_value), 'append_child': gi.FunctionInfo(append_child), 'clone_node': gi.FunctionInfo(clone_node), 'clone_node_with_error': gi.FunctionInfo(clone_node_with_error), 'compare_document_position': gi.FunctionInfo(compare_document_position), 'contains': gi.FunctionInfo(contains), 'get_base_uri': gi.FunctionInfo(get_base_uri), 'get_child_nodes': gi.FunctionInfo(get_child_nodes), 'get_first_child': gi.FunctionInfo(get_first_child), 'get_last_child': gi.FunctionInfo(get_last_child), 'get_local_name': gi.FunctionInfo(get_local_name), 'get_namespace_uri': gi.FunctionInfo(get_namespace_uri), 'get_next_sibling': gi.FunctionInfo(get_next_sibling), 'get_node_name': gi.FunctionInfo(get_node_name), 'get_node_type': gi.FunctionInfo(get_node_type), 'get_node_value': gi.FunctionInfo(get_node_value), 'get_owner_document': gi.FunctionInfo(get_owner_document), 'get_parent_element': gi.FunctionInfo(get_parent_element), 'get_parent_node': gi.FunctionInfo(get_parent_node), 'get_prefix': gi.FunctionInfo(get_prefix), 'get_previous_sibling': gi.FunctionInfo(get_previous_sibling), 'get_text_content': gi.FunctionInfo(get_text_content), 'has_child_nodes': gi.FunctionInfo(has_child_nodes), 'insert_before': gi.FunctionInfo(insert_before), 'is_default_namespace': gi.FunctionInfo(is_default_namespace), 'is_equal_node': gi.FunctionInfo(is_equal_node), 'is_same_node': gi.FunctionInfo(is_same_node), 'is_supported': gi.FunctionInfo(is_supported), 'lookup_namespace_uri': gi.FunctionInfo(lookup_namespace_uri), 'lookup_prefix': gi.FunctionInfo(lookup_prefix), 'normalize': gi.FunctionInfo(normalize), 'remove_child': gi.FunctionInfo(remove_child), 'replace_child': gi.FunctionInfo(replace_child), 'set_node_value': gi.FunctionInfo(set_node_value), 'set_prefix': gi.FunctionInfo(set_prefix), 'set_text_content': gi.FunctionInfo(set_text_content), 'parent_instance': <property object at 0x7f174d0a1c20>})"
    __gdoc__ = 'Object WebKitDOMNode\n\nProperties from WebKitDOMNode:\n  node-name -> gchararray: Node:node-name\n    read-only gchar* Node:node-name\n  node-value -> gchararray: Node:node-value\n    read-write gchar* Node:node-value\n  node-type -> guint: Node:node-type\n    read-only gushort Node:node-type\n  parent-node -> WebKitDOMNode: Node:parent-node\n    read-only WebKitDOMNode* Node:parent-node\n  child-nodes -> WebKitDOMNodeList: Node:child-nodes\n    read-only WebKitDOMNodeList* Node:child-nodes\n  first-child -> WebKitDOMNode: Node:first-child\n    read-only WebKitDOMNode* Node:first-child\n  last-child -> WebKitDOMNode: Node:last-child\n    read-only WebKitDOMNode* Node:last-child\n  previous-sibling -> WebKitDOMNode: Node:previous-sibling\n    read-only WebKitDOMNode* Node:previous-sibling\n  next-sibling -> WebKitDOMNode: Node:next-sibling\n    read-only WebKitDOMNode* Node:next-sibling\n  owner-document -> WebKitDOMDocument: Node:owner-document\n    read-only WebKitDOMDocument* Node:owner-document\n  base-uri -> gchararray: Node:base-uri\n    read-only gchar* Node:base-uri\n  text-content -> gchararray: Node:text-content\n    read-write gchar* Node:text-content\n  parent-element -> WebKitDOMElement: Node:parent-element\n    read-only WebKitDOMElement* Node:parent-element\n\nProperties from WebKitDOMObject:\n  core-object -> gpointer: Core Object\n    The WebCore object the WebKitDOMObject wraps\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType WebKitDOMNode (94252901431792)>'
    __info__ = ObjectInfo(DOMNode)
