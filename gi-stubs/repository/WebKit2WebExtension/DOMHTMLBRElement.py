...
class DOMHTMLBRElement(DOMHTMLElement):
    ...
    def get_clear(self): # real signature unknown; restored from __doc__
        """ get_clear(self) -> str """
        return ""
    ...
    def set_clear(self, value): # real signature unknown; restored from __doc__
        """ set_clear(self, value:str) """
        pass
