...
class DOMHTMLPreElement(DOMHTMLElement):
    ...
    def set_wrap(self, value): # real signature unknown; restored from __doc__
        """ set_wrap(self, value:bool) """
        pass
