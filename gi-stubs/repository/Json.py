...
# from /usr/lib64/girepository-1.0/Json-1.0.typelib
# by generator 1.147
"""
...
def construct_gobject(gtype, data, length): # real signature unknown; restored from __doc__
    """ construct_gobject(gtype:GType, data:str, length:int) -> GObject.Object """
    pass

def from_string(p_str): # real signature unknown; restored from __doc__
    """ from_string(str:str) -> Json.Node """
    pass
...
def gobject_from_data(gtype, data, length): # real signature unknown; restored from __doc__
    """ gobject_from_data(gtype:GType, data:str, length:int) -> GObject.Object """
    pass
...
def gvariant_deserialize(json_node, signature=None): # real signature unknown; restored from __doc__
    """ gvariant_deserialize(json_node:Json.Node, signature:str=None) -> GLib.Variant """
    pass

def gvariant_deserialize_data(json, length, signature=None): # real signature unknown; restored from __doc__
    """ gvariant_deserialize_data(json:str, length:int, signature:str=None) -> GLib.Variant """
    pass
...
class Array(__gi.Boxed):
    ...
    def add_object_element(self, value): # real signature unknown; restored from __doc__
        """ add_object_element(self, value:Json.Object) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Array), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonArray (93992868611312)>, '__dict__': <attribute '__dict__' of 'Array' objects>, '__weakref__': <attribute '__weakref__' of 'Array' objects>, '__doc__': None, 'new': gi.FunctionInfo(new), 'sized_new': gi.FunctionInfo(sized_new), 'add_array_element': gi.FunctionInfo(add_array_element), 'add_boolean_element': gi.FunctionInfo(add_boolean_element), 'add_double_element': gi.FunctionInfo(add_double_element), 'add_element': gi.FunctionInfo(add_element), 'add_int_element': gi.FunctionInfo(add_int_element), 'add_null_element': gi.FunctionInfo(add_null_element), 'add_object_element': gi.FunctionInfo(add_object_element), 'add_string_element': gi.FunctionInfo(add_string_element), 'dup_element': gi.FunctionInfo(dup_element), 'equal': gi.FunctionInfo(equal), 'foreach_element': gi.FunctionInfo(foreach_element), 'get_array_element': gi.FunctionInfo(get_array_element), 'get_boolean_element': gi.FunctionInfo(get_boolean_element), 'get_double_element': gi.FunctionInfo(get_double_element), 'get_element': gi.FunctionInfo(get_element), 'get_elements': gi.FunctionInfo(get_elements), 'get_int_element': gi.FunctionInfo(get_int_element), 'get_length': gi.FunctionInfo(get_length), 'get_null_element': gi.FunctionInfo(get_null_element), 'get_object_element': gi.FunctionInfo(get_object_element), 'get_string_element': gi.FunctionInfo(get_string_element), 'hash': gi.FunctionInfo(hash), 'is_immutable': gi.FunctionInfo(is_immutable), 'ref': gi.FunctionInfo(ref), 'remove_element': gi.FunctionInfo(remove_element), 'seal': gi.FunctionInfo(seal), 'unref': gi.FunctionInfo(unref), '__new__': <staticmethod object at 0x7faed5022e20>, '__init__': <function nothing at 0x7faed5268ee0>})"
    __gtype__ = None # (!) real value is '<GType JsonArray (93992868611312)>'
...
class Builder(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7faed5017430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Builder), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonBuilder (93992868631744)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_immutable': gi.FunctionInfo(new_immutable), 'add_boolean_value': gi.FunctionInfo(add_boolean_value), 'add_double_value': gi.FunctionInfo(add_double_value), 'add_int_value': gi.FunctionInfo(add_int_value), 'add_null_value': gi.FunctionInfo(add_null_value), 'add_string_value': gi.FunctionInfo(add_string_value), 'add_value': gi.FunctionInfo(add_value), 'begin_array': gi.FunctionInfo(begin_array), 'begin_object': gi.FunctionInfo(begin_object), 'end_array': gi.FunctionInfo(end_array), 'end_object': gi.FunctionInfo(end_object), 'get_root': gi.FunctionInfo(get_root), 'reset': gi.FunctionInfo(reset), 'set_member_name': gi.FunctionInfo(set_member_name), 'parent_instance': <property object at 0x7faed6414f40>, 'priv': <property object at 0x7faed504d770>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType JsonBuilder (93992868631744)>'
...
class BuilderClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(BuilderClass), '__module__': 'gi.repository.Json', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'BuilderClass' objects>, '__weakref__': <attribute '__weakref__' of 'BuilderClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7faed504d860>, '_json_reserved1': <property object at 0x7faed504d6d0>, '_json_reserved2': <property object at 0x7faed5066310>})"
...
class Generator(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7faed5038e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Generator), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonGenerator (93992868777456)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_indent': gi.FunctionInfo(get_indent), 'get_indent_char': gi.FunctionInfo(get_indent_char), 'get_pretty': gi.FunctionInfo(get_pretty), 'get_root': gi.FunctionInfo(get_root), 'set_indent': gi.FunctionInfo(set_indent), 'set_indent_char': gi.FunctionInfo(set_indent_char), 'set_pretty': gi.FunctionInfo(set_pretty), 'set_root': gi.FunctionInfo(set_root), 'to_data': gi.FunctionInfo(to_data), 'to_file': gi.FunctionInfo(to_file), 'to_gstring': gi.FunctionInfo(to_gstring), 'to_stream': gi.FunctionInfo(to_stream), 'parent_instance': <property object at 0x7faed63ffa40>, 'priv': <property object at 0x7faed5066590>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType JsonGenerator (93992868777456)>'
...
class GeneratorClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(GeneratorClass), '__module__': 'gi.repository.Json', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'GeneratorClass' objects>, '__weakref__': <attribute '__weakref__' of 'GeneratorClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7faed5066720>, '_json_reserved1': <property object at 0x7faed5066810>, '_json_reserved2': <property object at 0x7faed5066900>, '_json_reserved3': <property object at 0x7faed50669f0>, '_json_reserved4': <property object at 0x7faed5066ae0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class Node(__gi.Boxed):
    ...
    def set_parent(self, parent): # real signature unknown; restored from __doc__
        """ set_parent(self, parent:Json.Node) """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Node), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonNode (93992868979568)>, '__dict__': <attribute '__dict__' of 'Node' objects>, '__weakref__': <attribute '__weakref__' of 'Node' objects>, '__doc__': None, 'alloc': gi.FunctionInfo(alloc), 'new': gi.FunctionInfo(new), 'copy': gi.FunctionInfo(copy), 'dup_array': gi.FunctionInfo(dup_array), 'dup_object': gi.FunctionInfo(dup_object), 'dup_string': gi.FunctionInfo(dup_string), 'equal': gi.FunctionInfo(equal), 'free': gi.FunctionInfo(free), 'get_array': gi.FunctionInfo(get_array), 'get_boolean': gi.FunctionInfo(get_boolean), 'get_double': gi.FunctionInfo(get_double), 'get_int': gi.FunctionInfo(get_int), 'get_node_type': gi.FunctionInfo(get_node_type), 'get_object': gi.FunctionInfo(get_object), 'get_parent': gi.FunctionInfo(get_parent), 'get_string': gi.FunctionInfo(get_string), 'get_value': gi.FunctionInfo(get_value), 'get_value_type': gi.FunctionInfo(get_value_type), 'hash': gi.FunctionInfo(hash), 'init': gi.FunctionInfo(init), 'init_array': gi.FunctionInfo(init_array), 'init_boolean': gi.FunctionInfo(init_boolean), 'init_double': gi.FunctionInfo(init_double), 'init_int': gi.FunctionInfo(init_int), 'init_null': gi.FunctionInfo(init_null), 'init_object': gi.FunctionInfo(init_object), 'init_string': gi.FunctionInfo(init_string), 'is_immutable': gi.FunctionInfo(is_immutable), 'is_null': gi.FunctionInfo(is_null), 'ref': gi.FunctionInfo(ref), 'seal': gi.FunctionInfo(seal), 'set_array': gi.FunctionInfo(set_array), 'set_boolean': gi.FunctionInfo(set_boolean), 'set_double': gi.FunctionInfo(set_double), 'set_int': gi.FunctionInfo(set_int), 'set_object': gi.FunctionInfo(set_object), 'set_parent': gi.FunctionInfo(set_parent), 'set_string': gi.FunctionInfo(set_string), 'set_value': gi.FunctionInfo(set_value), 'take_array': gi.FunctionInfo(take_array), 'take_object': gi.FunctionInfo(take_object), 'type_name': gi.FunctionInfo(type_name), 'unref': gi.FunctionInfo(unref), '__new__': <staticmethod object at 0x7faed502c160>, '__init__': <function nothing at 0x7faed5268ee0>})"
    __gtype__ = None # (!) real value is '<GType JsonNode (93992868979568)>'
...
class NodeType(__gobject.GEnum):
    ...
    __gtype__ = None # (!) real value is '<GType JsonNodeType (93992869017440)>'
...
class Object(__gi.Boxed):
    ...
    def get_array_member(self, member_name): # real signature unknown; restored from __doc__
        """ get_array_member(self, member_name:str) -> Json.Array """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Object), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonObject (93992868599328)>, '__dict__': <attribute '__dict__' of 'Object' objects>, '__weakref__': <attribute '__weakref__' of 'Object' objects>, '__doc__': None, 'new': gi.FunctionInfo(new), 'add_member': gi.FunctionInfo(add_member), 'dup_member': gi.FunctionInfo(dup_member), 'equal': gi.FunctionInfo(equal), 'foreach_member': gi.FunctionInfo(foreach_member), 'get_array_member': gi.FunctionInfo(get_array_member), 'get_boolean_member': gi.FunctionInfo(get_boolean_member), 'get_double_member': gi.FunctionInfo(get_double_member), 'get_int_member': gi.FunctionInfo(get_int_member), 'get_member': gi.FunctionInfo(get_member), 'get_members': gi.FunctionInfo(get_members), 'get_null_member': gi.FunctionInfo(get_null_member), 'get_object_member': gi.FunctionInfo(get_object_member), 'get_size': gi.FunctionInfo(get_size), 'get_string_member': gi.FunctionInfo(get_string_member), 'get_values': gi.FunctionInfo(get_values), 'has_member': gi.FunctionInfo(has_member), 'hash': gi.FunctionInfo(hash), 'is_immutable': gi.FunctionInfo(is_immutable), 'ref': gi.FunctionInfo(ref), 'remove_member': gi.FunctionInfo(remove_member), 'seal': gi.FunctionInfo(seal), 'set_array_member': gi.FunctionInfo(set_array_member), 'set_boolean_member': gi.FunctionInfo(set_boolean_member), 'set_double_member': gi.FunctionInfo(set_double_member), 'set_int_member': gi.FunctionInfo(set_int_member), 'set_member': gi.FunctionInfo(set_member), 'set_null_member': gi.FunctionInfo(set_null_member), 'set_object_member': gi.FunctionInfo(set_object_member), 'set_string_member': gi.FunctionInfo(set_string_member), 'unref': gi.FunctionInfo(unref), '__new__': <staticmethod object at 0x7faed502c1f0>, '__init__': <function nothing at 0x7faed5268ee0>})"
    __gtype__ = None # (!) real value is '<GType JsonObject (93992868599328)>'
...
class Parser(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7faed5091b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Parser), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonParser (93992868826128)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_immutable': gi.FunctionInfo(new_immutable), 'get_current_line': gi.FunctionInfo(get_current_line), 'get_current_pos': gi.FunctionInfo(get_current_pos), 'get_root': gi.FunctionInfo(get_root), 'has_assignment': gi.FunctionInfo(has_assignment), 'load_from_data': gi.FunctionInfo(load_from_data), 'load_from_file': gi.FunctionInfo(load_from_file), 'load_from_stream': gi.FunctionInfo(load_from_stream), 'load_from_stream_async': gi.FunctionInfo(load_from_stream_async), 'load_from_stream_finish': gi.FunctionInfo(load_from_stream_finish), 'steal_root': gi.FunctionInfo(steal_root), 'do_array_element': gi.VFuncInfo(array_element), 'do_array_end': gi.VFuncInfo(array_end), 'do_array_start': gi.VFuncInfo(array_start), 'do_error': gi.VFuncInfo(error), 'do_object_end': gi.VFuncInfo(object_end), 'do_object_member': gi.VFuncInfo(object_member), 'do_object_start': gi.VFuncInfo(object_start), 'do_parse_end': gi.VFuncInfo(parse_end), 'do_parse_start': gi.VFuncInfo(parse_start), 'parent_instance': <property object at 0x7faed50308b0>, 'priv': <property object at 0x7faed50309a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType JsonParser (93992868826128)>'
...
class ParserClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ParserClass), '__module__': 'gi.repository.Json', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ParserClass' objects>, '__weakref__': <attribute '__weakref__' of 'ParserClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7faed5030b30>, 'parse_start': <property object at 0x7faed5030c20>, 'object_start': <property object at 0x7faed5030d10>, 'object_member': <property object at 0x7faed5030e00>, 'object_end': <property object at 0x7faed5030ef0>, 'array_start': <property object at 0x7faed5032040>, 'array_element': <property object at 0x7faed5032130>, 'array_end': <property object at 0x7faed5032220>, 'parse_end': <property object at 0x7faed5032310>, 'error': <property object at 0x7faed5032400>, '_json_reserved1': <property object at 0x7faed50324f0>, '_json_reserved2': <property object at 0x7faed50325e0>, '_json_reserved3': <property object at 0x7faed50326d0>, '_json_reserved4': <property object at 0x7faed50327c0>, '_json_reserved5': <property object at 0x7faed50328b0>, '_json_reserved6': <property object at 0x7faed50329a0>, '_json_reserved7': <property object at 0x7faed5032a90>, '_json_reserved8': <property object at 0x7faed5032b80>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class ParserError(__gobject.GEnum):
    ...
    UNKNOWN = 7
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Json', '__dict__': <attribute '__dict__' of 'ParserError' objects>, '__doc__': None, '__gtype__': <GType JsonParserError (93992868603424)>, '__enum_values__': {0: <enum JSON_PARSER_ERROR_PARSE of type Json.ParserError>, 1: <enum JSON_PARSER_ERROR_TRAILING_COMMA of type Json.ParserError>, 2: <enum JSON_PARSER_ERROR_MISSING_COMMA of type Json.ParserError>, 3: <enum JSON_PARSER_ERROR_MISSING_COLON of type Json.ParserError>, 4: <enum JSON_PARSER_ERROR_INVALID_BAREWORD of type Json.ParserError>, 5: <enum JSON_PARSER_ERROR_EMPTY_MEMBER_NAME of type Json.ParserError>, 6: <enum JSON_PARSER_ERROR_INVALID_DATA of type Json.ParserError>, 7: <enum JSON_PARSER_ERROR_UNKNOWN of type Json.ParserError>}, '__info__': gi.EnumInfo(ParserError), 'PARSE': <enum JSON_PARSER_ERROR_PARSE of type Json.ParserError>, 'TRAILING_COMMA': <enum JSON_PARSER_ERROR_TRAILING_COMMA of type Json.ParserError>, 'MISSING_COMMA': <enum JSON_PARSER_ERROR_MISSING_COMMA of type Json.ParserError>, 'MISSING_COLON': <enum JSON_PARSER_ERROR_MISSING_COLON of type Json.ParserError>, 'INVALID_BAREWORD': <enum JSON_PARSER_ERROR_INVALID_BAREWORD of type Json.ParserError>, 'EMPTY_MEMBER_NAME': <enum JSON_PARSER_ERROR_EMPTY_MEMBER_NAME of type Json.ParserError>, 'INVALID_DATA': <enum JSON_PARSER_ERROR_INVALID_DATA of type Json.ParserError>, 'UNKNOWN': <enum JSON_PARSER_ERROR_UNKNOWN of type Json.ParserError>, 'quark': gi.FunctionInfo(quark)})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType JsonParserError (93992868603424)>'
...
class Path(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7faed5091220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Path), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonPath (93992868660960)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'query': gi.FunctionInfo(query), 'compile': gi.FunctionInfo(compile), 'match': gi.FunctionInfo(match)})"
    __gdoc__ = 'Object JsonPath\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType JsonPath (93992868660960)>'
...
class PathError(__gobject.GEnum):
    ...
    QUERY = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Json', '__dict__': <attribute '__dict__' of 'PathError' objects>, '__doc__': None, '__gtype__': <GType JsonPathError (93992868658736)>, '__enum_values__': {0: <enum JSON_PATH_ERROR_INVALID_QUERY of type Json.PathError>}, '__info__': gi.EnumInfo(PathError), 'QUERY': <enum JSON_PATH_ERROR_INVALID_QUERY of type Json.PathError>, 'quark': gi.FunctionInfo(quark)})"
    __enum_values__ = {
        0: 0,
    }
    __gtype__ = None # (!) real value is '<GType JsonPathError (93992868658736)>'
...
class Reader(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7faed5038490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Reader), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonReader (93992869043024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'count_elements': gi.FunctionInfo(count_elements), 'count_members': gi.FunctionInfo(count_members), 'end_element': gi.FunctionInfo(end_element), 'end_member': gi.FunctionInfo(end_member), 'get_boolean_value': gi.FunctionInfo(get_boolean_value), 'get_double_value': gi.FunctionInfo(get_double_value), 'get_error': gi.FunctionInfo(get_error), 'get_int_value': gi.FunctionInfo(get_int_value), 'get_member_name': gi.FunctionInfo(get_member_name), 'get_null_value': gi.FunctionInfo(get_null_value), 'get_string_value': gi.FunctionInfo(get_string_value), 'get_value': gi.FunctionInfo(get_value), 'is_array': gi.FunctionInfo(is_array), 'is_object': gi.FunctionInfo(is_object), 'is_value': gi.FunctionInfo(is_value), 'list_members': gi.FunctionInfo(list_members), 'read_element': gi.FunctionInfo(read_element), 'read_member': gi.FunctionInfo(read_member), 'set_root': gi.FunctionInfo(set_root), 'parent_instance': <property object at 0x7faed50334f0>, 'priv': <property object at 0x7faed50335e0>})"
    __gdoc__ = 'Object JsonReader\n\nProperties from JsonReader:\n  root -> JsonNode: Root Node\n    The root of the tree to read\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType JsonReader (93992869043024)>'
...
class ReaderClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ReaderClass), '__module__': 'gi.repository.Json', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ReaderClass' objects>, '__weakref__': <attribute '__weakref__' of 'ReaderClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7faed5033770>, '_json_padding0': <property object at 0x7faed5033860>, '_json_padding1': <property object at 0x7faed5033950>, '_json_padding2': <property object at 0x7faed5033a40>, '_json_padding3': <property object at 0x7faed5033b30>, '_json_padding4': <property object at 0x7faed5033c20>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class ReaderError(__gobject.GEnum):
    ...
    NO_VALUE = 5
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Json', '__dict__': <attribute '__dict__' of 'ReaderError' objects>, '__doc__': None, '__gtype__': <GType JsonReaderError (93992868967184)>, '__enum_values__': {0: <enum JSON_READER_ERROR_NO_ARRAY of type Json.ReaderError>, 1: <enum JSON_READER_ERROR_INVALID_INDEX of type Json.ReaderError>, 2: <enum JSON_READER_ERROR_NO_OBJECT of type Json.ReaderError>, 3: <enum JSON_READER_ERROR_INVALID_MEMBER of type Json.ReaderError>, 4: <enum JSON_READER_ERROR_INVALID_NODE of type Json.ReaderError>, 5: <enum JSON_READER_ERROR_NO_VALUE of type Json.ReaderError>, 6: <enum JSON_READER_ERROR_INVALID_TYPE of type Json.ReaderError>}, '__info__': gi.EnumInfo(ReaderError), 'NO_ARRAY': <enum JSON_READER_ERROR_NO_ARRAY of type Json.ReaderError>, 'INVALID_INDEX': <enum JSON_READER_ERROR_INVALID_INDEX of type Json.ReaderError>, 'NO_OBJECT': <enum JSON_READER_ERROR_NO_OBJECT of type Json.ReaderError>, 'INVALID_MEMBER': <enum JSON_READER_ERROR_INVALID_MEMBER of type Json.ReaderError>, 'INVALID_NODE': <enum JSON_READER_ERROR_INVALID_NODE of type Json.ReaderError>, 'NO_VALUE': <enum JSON_READER_ERROR_NO_VALUE of type Json.ReaderError>, 'INVALID_TYPE': <enum JSON_READER_ERROR_INVALID_TYPE of type Json.ReaderError>, 'quark': gi.FunctionInfo(quark)})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType JsonReaderError (93992868967184)>'
...
class Serializable(__gobject.GInterface):
    ...
    def list_properties(self): # real signature unknown; restored from __doc__
        """ list_properties(self) -> list, n_pspecs:int """
        return []
    ...
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(Serializable), '__module__': 'gi.repository.Json', '__gtype__': <GType JsonSerializable (93992869048192)>, '__dict__': <attribute '__dict__' of 'Serializable' objects>, '__weakref__': <attribute '__weakref__' of 'Serializable' objects>, '__doc__': None, '__gsignals__': {}, 'default_deserialize_property': gi.FunctionInfo(default_deserialize_property), 'default_serialize_property': gi.FunctionInfo(default_serialize_property), 'deserialize_property': gi.FunctionInfo(deserialize_property), 'find_property': gi.FunctionInfo(find_property), 'get_property': gi.FunctionInfo(get_property), 'list_properties': gi.FunctionInfo(list_properties), 'serialize_property': gi.FunctionInfo(serialize_property), 'set_property': gi.FunctionInfo(set_property)})"
    __gdoc__ = 'Interface JsonSerializable\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType JsonSerializable (93992869048192)>'
...
class SerializableIface(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SerializableIface), '__module__': 'gi.repository.Json', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SerializableIface' objects>, '__weakref__': <attribute '__weakref__' of 'SerializableIface' objects>, '__doc__': None, 'g_iface': <property object at 0x7faed5037450>, 'serialize_property': <property object at 0x7faed5037590>, 'deserialize_property': <property object at 0x7faed5037680>, 'find_property': <property object at 0x7faed5037720>, 'list_properties': <property object at 0x7faed5037810>, 'set_property': <property object at 0x7faed5037900>, 'get_property': <property object at 0x7faed50379f0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7faed526a1f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7faed526a280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7faed526a310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7faed526a3a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7faed5ea6d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/Json-1.0.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.Json', loader=<gi.importer.DynamicImporter object at 0x7faed5ea6d00>)"
