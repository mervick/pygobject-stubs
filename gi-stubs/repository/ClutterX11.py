# encoding: utf-8
# module gi.repository.ClutterX11
# from /usr/lib64/girepository-1.0/ClutterX11-1.0.typelib
# by generator 1.147
"""
...
def disable_event_retrieval(): # real signature unknown; restored from __doc__
    """ disable_event_retrieval() """
    pass

def enable_xinput(): # real signature unknown; restored from __doc__
    """ enable_xinput() """
    pass

def event_get_key_group(event): # real signature unknown; restored from __doc__
    """ event_get_key_group(event:Clutter.Event) -> int """
    return 0

def event_sequence_get_touch_detail(sequence): # real signature unknown; restored from __doc__
    """ event_sequence_get_touch_detail(sequence:Clutter.EventSequence) -> int """
    return 0

def get_default_display(): # real signature unknown; restored from __doc__
    """ get_default_display() -> xlib.Display """
    pass

def get_default_screen(): # real signature unknown; restored from __doc__
    """ get_default_screen() -> int """
    return 0

def get_input_devices(): # real signature unknown; restored from __doc__
    """ get_input_devices() -> list """
    return []

def get_stage_from_window(win): # real signature unknown; restored from __doc__
    """ get_stage_from_window(win:int) -> Clutter.Stage """
    pass

def get_use_argb_visual(): # real signature unknown; restored from __doc__
    """ get_use_argb_visual() -> bool """
    return False

def get_use_stereo_stage(): # real signature unknown; restored from __doc__
    """ get_use_stereo_stage() -> bool """
    return False

def handle_event(xevent): # real signature unknown; restored from __doc__
    """ handle_event(xevent:xlib.XEvent) -> ClutterX11.FilterReturn """
    pass

def has_composite_extension(): # real signature unknown; restored from __doc__
    """ has_composite_extension() -> bool """
    return False

def has_event_retrieval(): # real signature unknown; restored from __doc__
    """ has_event_retrieval() -> bool """
    return False

def has_xinput(): # real signature unknown; restored from __doc__
    """ has_xinput() -> bool """
    return False

def set_display(xdpy): # real signature unknown; restored from __doc__
    """ set_display(xdpy:xlib.Display) """
    pass

def set_stage_foreign(stage, xwindow): # real signature unknown; restored from __doc__
    """ set_stage_foreign(stage:Clutter.Stage, xwindow:int) -> bool """
    return False

def set_use_argb_visual(use_argb): # real signature unknown; restored from __doc__
    """ set_use_argb_visual(use_argb:bool) """
    pass

def set_use_stereo_stage(use_stereo): # real signature unknown; restored from __doc__
    """ set_use_stereo_stage(use_stereo:bool) """
    pass

def trap_x_errors(): # real signature unknown; restored from __doc__
    """ trap_x_errors() """
    pass

def untrap_x_errors(): # real signature unknown; restored from __doc__
    """ untrap_x_errors() -> int """
    return 0
...
class FilterReturn(__gobject.GEnum):
    ...
    TRANSLATE = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.ClutterX11', '__dict__': <attribute '__dict__' of 'FilterReturn' objects>, '__doc__': None, '__gtype__': <GType ClutterX11FilterReturn (94411318733728)>, '__enum_values__': {0: <enum CLUTTER_X11_FILTER_CONTINUE of type ClutterX11.FilterReturn>, 1: <enum CLUTTER_X11_FILTER_TRANSLATE of type ClutterX11.FilterReturn>, 2: <enum CLUTTER_X11_FILTER_REMOVE of type ClutterX11.FilterReturn>}, '__info__': gi.EnumInfo(FilterReturn), 'CONTINUE': <enum CLUTTER_X11_FILTER_CONTINUE of type ClutterX11.FilterReturn>, 'TRANSLATE': <enum CLUTTER_X11_FILTER_TRANSLATE of type ClutterX11.FilterReturn>, 'REMOVE': <enum CLUTTER_X11_FILTER_REMOVE of type ClutterX11.FilterReturn>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType ClutterX11FilterReturn (94411318733728)>'
    __info__ = gi.EnumInfo(FilterReturn)


class TexturePixmap(__gi_repository_Clutter.Texture):
    """
    :Constructors:
    
    ::
    
        TexturePixmap(**properties)
        new() -> Clutter.Actor
        new_with_pixmap(pixmap:int) -> Clutter.Actor
        new_with_window(window:int) -> Clutter.Actor
    """
    ...
    def do_update_area(self, *args, **kwargs): # real signature unknown
        """ update_area(self, x:int, y:int, width:int, height:int) """
        pass
    ...
    def new_with_pixmap(self, pixmap): # real signature unknown; restored from __doc__
        """ new_with_pixmap(pixmap:int) -> Clutter.Actor """
        pass

    def new_with_window(self, window): # real signature unknown; restored from __doc__
        """ new_with_window(window:int) -> Clutter.Actor """
        pass
    ...
    def set_automatic(self, setting): # real signature unknown; restored from __doc__
        """ set_automatic(self, setting:bool) """
        pass
    ...
    def set_pixmap(self, pixmap): # real signature unknown; restored from __doc__
        """ set_pixmap(self, pixmap:int) """
        pass
    ...
    def set_window(self, window, automatic): # real signature unknown; restored from __doc__
        """ set_window(self, window:int, automatic:bool) """
        pass
    ...
    def sync_window(self): # real signature unknown; restored from __doc__
        """ sync_window(self) """
        pass
    ...
    def update_area(self, x, y, width, height): # real signature unknown; restored from __doc__
        """ update_area(self, x:int, y:int, width:int, height:int) """
        pass
...
class TexturePixmapClass(__gi.Struct):
    ...
    update_area = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TexturePixmapClass), '__module__': 'gi.repository.ClutterX11', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TexturePixmapClass' objects>, '__weakref__': <attribute '__weakref__' of 'TexturePixmapClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f81108cf1d0>, 'update_area': <property object at 0x7f81108cf2c0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(TexturePixmapClass)


class TexturePixmapPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TexturePixmapPrivate), '__module__': 'gi.repository.ClutterX11', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TexturePixmapPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'TexturePixmapPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(TexturePixmapPrivate)


class XInputDevice(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(XInputDevice), '__module__': 'gi.repository.ClutterX11', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'XInputDevice' objects>, '__weakref__': <attribute '__weakref__' of 'XInputDevice' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(XInputDevice)
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7f8110d491f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7f8110d49280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7f8110d49310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7f8110d493a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7f8111985d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/ClutterX11-1.0.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.ClutterX11', loader=<gi.importer.DynamicImporter object at 0x7f8111985d00>)"
