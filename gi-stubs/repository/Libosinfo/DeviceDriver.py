...
class DeviceDriver(Entity):
    """
    :Constructors:
    
    ::
    
        DeviceDriver(**properties)
    """
    ...
    def get_devices(self): # real signature unknown; restored from __doc__
        """ get_devices(self) -> Libosinfo.DeviceList """
        pass
    ...
    def get_pre_installable(self): # real signature unknown; restored from __doc__
        """ get_pre_installable(self) -> bool """
        return False
    ...
    def get_signed(self): # real signature unknown; restored from __doc__
        """ get_signed(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7153165a30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceDriver), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoDeviceDriver (94407636198928)>, '__doc__': None, '__gsignals__': {}, 'get_architecture': gi.FunctionInfo(get_architecture), 'get_devices': gi.FunctionInfo(get_devices), 'get_files': gi.FunctionInfo(get_files), 'get_location': gi.FunctionInfo(get_location), 'get_pre_installable': gi.FunctionInfo(get_pre_installable), 'get_priority': gi.FunctionInfo(get_priority), 'get_signed': gi.FunctionInfo(get_signed), 'parent_instance': <property object at 0x7f71538eca40>, 'priv': <property object at 0x7f71538ecb30>})"
    __gdoc__ = 'Object OsinfoDeviceDriver\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoDeviceDriver (94407636198928)>'
    __info__ = ObjectInfo(DeviceDriver)
