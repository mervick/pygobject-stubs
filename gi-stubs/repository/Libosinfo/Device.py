...
class Device(Entity):
    ...
    def get_bus_type(self): # real signature unknown; restored from __doc__
        """ get_bus_type(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f71539234f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Device), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoDevice (94407636182896)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_bus_type': gi.FunctionInfo(get_bus_type), 'get_class': gi.FunctionInfo(get_class), 'get_name': gi.FunctionInfo(get_name), 'get_product': gi.FunctionInfo(get_product), 'get_product_id': gi.FunctionInfo(get_product_id), 'get_subsystem': gi.FunctionInfo(get_subsystem), 'get_vendor': gi.FunctionInfo(get_vendor), 'get_vendor_id': gi.FunctionInfo(get_vendor_id), 'parent_instance': <property object at 0x7f71538ec540>, 'priv': <property object at 0x7f71538ec680>})"
    __gdoc__ = 'Object OsinfoDevice\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoDevice (94407636182896)>'
