...
class DeviceLink(Entity):
    ...
    ::
        ...
        DeviceLink(**properties)
        new(target:Libosinfo.Device) -> Libosinfo.DeviceLink
    """
    ...
    def get_target(self): # real signature unknown; restored from __doc__
        """ get_target(self) -> Libosinfo.Device """
        pass
    ...
    def new(self, target): # real signature unknown; restored from __doc__
        """ new(target:Libosinfo.Device) -> Libosinfo.DeviceLink """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceLink), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoDeviceLink (94407636207296)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_driver': gi.FunctionInfo(get_driver), 'get_target': gi.FunctionInfo(get_target), 'parent_instance': <property object at 0x7f71538f06d0>, 'priv': <property object at 0x7f71538f07c0>})"
    __gdoc__ = 'Object OsinfoDeviceLink\n\nProperties from OsinfoDeviceLink:\n  target -> OsinfoDevice: Target\n    Target device\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoDeviceLink (94407636207296)>'
    __info__ = ObjectInfo(DeviceLink)
