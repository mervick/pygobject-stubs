...
class Entity(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f715393ec10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Entity), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoEntity (94407636070240)>, '__doc__': None, '__gsignals__': {}, 'add_param': gi.FunctionInfo(add_param), 'clear_param': gi.FunctionInfo(clear_param), 'get_id': gi.FunctionInfo(get_id), 'get_param_keys': gi.FunctionInfo(get_param_keys), 'get_param_value': gi.FunctionInfo(get_param_value), 'get_param_value_boolean': gi.FunctionInfo(get_param_value_boolean), 'get_param_value_boolean_with_default': gi.FunctionInfo(get_param_value_boolean_with_default), 'get_param_value_enum': gi.FunctionInfo(get_param_value_enum), 'get_param_value_int64': gi.FunctionInfo(get_param_value_int64), 'get_param_value_int64_with_default': gi.FunctionInfo(get_param_value_int64_with_default), 'get_param_value_list': gi.FunctionInfo(get_param_value_list), 'set_param': gi.FunctionInfo(set_param), 'set_param_boolean': gi.FunctionInfo(set_param_boolean), 'set_param_enum': gi.FunctionInfo(set_param_enum), 'set_param_int64': gi.FunctionInfo(set_param_int64), 'parent_instance': <property object at 0x7f71538e82c0>, 'priv': <property object at 0x7f71538e8310>})"
    __gdoc__ = 'Object OsinfoEntity\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoEntity (94407636070240)>'
    __info__ = ObjectInfo(Entity)
