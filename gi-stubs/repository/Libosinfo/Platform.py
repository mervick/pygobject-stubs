...
class Platform(Product):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7152fc4d00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Platform), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoPlatform (94407636529280)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_device': gi.FunctionInfo(add_device), 'get_all_devices': gi.FunctionInfo(get_all_devices), 'get_device_links': gi.FunctionInfo(get_device_links), 'get_devices': gi.FunctionInfo(get_devices), 'parent_instance': <property object at 0x7f7153142c70>, 'priv': <property object at 0x7f7153142d60>})"
    __gdoc__ = 'Object OsinfoPlatform\n\nProperties from OsinfoProduct:\n  codename -> gchararray: Codename\n    Codename\n  name -> gchararray: Name\n    Name\n  short-id -> gchararray: ShortID\n    Short ID\n  vendor -> gchararray: Vendor\n    Vendor\n  version -> gchararray: Version\n    Version\n  logo -> gchararray: Logo\n    URI of the logo\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoPlatform (94407636529280)>'
    __info__ = ObjectInfo(Platform)
