...
class OsVariant(Entity):
    """
    :Constructors:
    
    ::
    
        OsVariant(**properties)
        new(id:str) -> Libosinfo.OsVariant
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f715306c0d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OsVariant), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoOsVariant (94407636513488)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_name': gi.FunctionInfo(get_name), 'parent_instance': <property object at 0x7f7153142090>, 'priv': <property object at 0x7f7153142180>})"
    __gdoc__ = 'Object OsinfoOsVariant\n\nProperties from OsinfoOsVariant:\n  name -> gchararray: Name\n    The name to this variant\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoOsVariant (94407636513488)>'
    __info__ = ObjectInfo(OsVariant)
