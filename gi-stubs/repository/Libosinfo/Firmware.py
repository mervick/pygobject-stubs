...
class Firmware(Entity):
    ...
    ::
        ...
        Firmware(**properties)
        new(id:str, architecture:str, type:str) -> Libosinfo.Firmware
    """
    ...
    def get_firmware_type(self): # real signature unknown; restored from __doc__
        """ get_firmware_type(self) -> str """
        return ""
    ...
    def new(self, id, architecture, type): # real signature unknown; restored from __doc__
        """ new(id:str, architecture:str, type:str) -> Libosinfo.Firmware """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f715306cf10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Firmware), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoFirmware (94407635902480)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_architecture': gi.FunctionInfo(get_architecture), 'get_firmware_type': gi.FunctionInfo(get_firmware_type), 'is_supported': gi.FunctionInfo(is_supported), 'parent_instance': <property object at 0x7f71538f68b0>, 'priv': <property object at 0x7f71538f69a0>})"
    __gdoc__ = 'Object OsinfoFirmware\n\nProperties from OsinfoFirmware:\n  architecture -> gchararray: ARCHITECTURE\n    CPU Architecture\n  type -> gchararray: TYPE\n    The firmware type\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoFirmware (94407635902480)>'
