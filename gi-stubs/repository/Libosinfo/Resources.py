...
class Resources(Entity):
    ...
    ::
        ...
        new(id:str, architecture:str) -> Libosinfo.Resources
    """
    ...
    def get_n_cpus(self): # real signature unknown; restored from __doc__
        """ get_n_cpus(self) -> int """
        return 0
    ...
    def get_ram(self): # real signature unknown; restored from __doc__
        """ get_ram(self) -> int """
        return 0
    ...
    def set_cpu(self, cpu): # real signature unknown; restored from __doc__
        """ set_cpu(self, cpu:int) """
        pass
    ...
    def set_n_cpus(self, n_cpus): # real signature unknown; restored from __doc__
        """ set_n_cpus(self, n_cpus:int) """
        pass
    ...
    def set_ram(self, ram): # real signature unknown; restored from __doc__
        """ set_ram(self, ram:int) """
        pass

    def set_storage(self, storage): # real signature unknown; restored from __doc__
        """ set_storage(self, storage:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7152ebbb20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Resources), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoResources (94407636555200)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_architecture': gi.FunctionInfo(get_architecture), 'get_cpu': gi.FunctionInfo(get_cpu), 'get_n_cpus': gi.FunctionInfo(get_n_cpus), 'get_ram': gi.FunctionInfo(get_ram), 'get_storage': gi.FunctionInfo(get_storage), 'set_cpu': gi.FunctionInfo(set_cpu), 'set_n_cpus': gi.FunctionInfo(set_n_cpus), 'set_ram': gi.FunctionInfo(set_ram), 'set_storage': gi.FunctionInfo(set_storage), 'parent_instance': <property object at 0x7f7153148860>, 'priv': <property object at 0x7f71531489a0>})"
    __gdoc__ = 'Object OsinfoResources\n\nProperties from OsinfoResources:\n  architecture -> gchararray: ARCHITECTURE\n    CPU Architecture\n  cpu -> gint64: CPU\n    CPU frequency in hertz (Hz)\n  n-cpus -> gint: N-CPUs\n    Number of CPUs\n  ram -> gint64: RAM\n    Amount of Random Access Memory (RAM) in bytes\n  storage -> gint64: Storage\n    Amount of storage space in bytes\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoResources (94407636555200)>'
    __info__ = ObjectInfo(Resources)
