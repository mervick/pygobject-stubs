...
class Product(Entity):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7152fc4be0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Product), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoProduct (94407636485936)>, '__doc__': None, '__gsignals__': {}, 'add_related': gi.FunctionInfo(add_related), 'get_codename': gi.FunctionInfo(get_codename), 'get_eol_date': gi.FunctionInfo(get_eol_date), 'get_eol_date_string': gi.FunctionInfo(get_eol_date_string), 'get_logo': gi.FunctionInfo(get_logo), 'get_name': gi.FunctionInfo(get_name), 'get_related': gi.FunctionInfo(get_related), 'get_release_date': gi.FunctionInfo(get_release_date), 'get_release_date_string': gi.FunctionInfo(get_release_date_string), 'get_short_id': gi.FunctionInfo(get_short_id), 'get_short_id_list': gi.FunctionInfo(get_short_id_list), 'get_vendor': gi.FunctionInfo(get_vendor), 'get_version': gi.FunctionInfo(get_version), 'parent_instance': <property object at 0x7f715313cae0>, 'priv': <property object at 0x7f715313cbd0>})"
    __gdoc__ = 'Object OsinfoProduct\n\nProperties from OsinfoProduct:\n  codename -> gchararray: Codename\n    Codename\n  name -> gchararray: Name\n    Name\n  short-id -> gchararray: ShortID\n    Short ID\n  vendor -> gchararray: Vendor\n    Vendor\n  version -> gchararray: Version\n    Version\n  logo -> gchararray: Logo\n    URI of the logo\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoProduct (94407636485936)>'
    __info__ = ObjectInfo(Product)
