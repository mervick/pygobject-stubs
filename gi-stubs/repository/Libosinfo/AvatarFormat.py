...
class AvatarFormat(Entity):
    """
    :Constructors:
    
    ::
    
        AvatarFormat(**properties)
        new() -> Libosinfo.AvatarFormat
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f715314ca30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AvatarFormat), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoAvatarFormat (94407636264224)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_alpha': gi.FunctionInfo(get_alpha), 'get_height': gi.FunctionInfo(get_height), 'get_mime_types': gi.FunctionInfo(get_mime_types), 'get_width': gi.FunctionInfo(get_width), 'parent_instance': <property object at 0x7f71538e8400>})"
    __gdoc__ = 'Object OsinfoAvatarFormat\n\nProperties from OsinfoAvatarFormat:\n  mime-types -> gpointer: MIME Types\n    The allowed mime-types for the avatar\n  width -> gint: Width\n    The required width (in pixels) of the avatar\n  height -> gint: Height\n    The required height (in pixels) of the avatar.\n  alpha -> gboolean: Alpha\n    Whether alpha channel is supported in the avatar.\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoAvatarFormat (94407636264224)>'
    __info__ = ObjectInfo(AvatarFormat)
