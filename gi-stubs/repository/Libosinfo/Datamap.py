...
class Datamap(Entity):
    ...
    def insert(self, inval, outval): # real signature unknown; restored from __doc__
        """ insert(self, inval:str, outval:str) """
        pass
    ...
    def lookup(self, inval): # real signature unknown; restored from __doc__
        """ lookup(self, inval:str) -> str """
        return ""
    ...
    def reverse_lookup(self, outval): # real signature unknown; restored from __doc__
        """ reverse_lookup(self, outval:str) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7153165f40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Datamap), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoDatamap (94407636098000)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'insert': gi.FunctionInfo(insert), 'lookup': gi.FunctionInfo(lookup), 'reverse_lookup': gi.FunctionInfo(reverse_lookup), 'parent_instance': <property object at 0x7f71538e8630>, 'priv': <property object at 0x7f71538e8770>})"
    __gdoc__ = 'Object OsinfoDatamap\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoDatamap (94407636098000)>'
    __info__ = ObjectInfo(Datamap)
