...
class InstallConfigParam(Entity):
    """
    :Constructors:
    
    ::
    
        InstallConfigParam(**properties)
        new(name:str) -> Libosinfo.InstallConfigParam
    """
    ...
    def get_policy(self): # real signature unknown; restored from __doc__
        """ get_policy(self) -> Libosinfo.InstallConfigParamPolicy """
        pass
    ...
    def is_optional(self): # real signature unknown; restored from __doc__
        """ is_optional(self) -> bool """
        return False

    def is_required(self): # real signature unknown; restored from __doc__
    ...
    def set_value_map(self, datamap): # real signature unknown; restored from __doc__
        """ set_value_map(self, datamap:Libosinfo.Datamap) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7153165790>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InstallConfigParam), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoInstallConfigParam (94407636414384)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_name': gi.FunctionInfo(get_name), 'get_policy': gi.FunctionInfo(get_policy), 'is_optional': gi.FunctionInfo(is_optional), 'is_required': gi.FunctionInfo(is_required), 'set_value_map': gi.FunctionInfo(set_value_map), 'parent_instance': <property object at 0x7f715312f130>, 'priv': <property object at 0x7f715312f220>})"
    __gdoc__ = 'Object OsinfoInstallConfigParam\n\nProperties from OsinfoInstallConfigParam:\n  name -> gchararray: Name\n    Parameter name\n  policy -> OsinfoInstallConfigParamPolicy: Policy\n    Parameter policy\n  value-map -> OsinfoDatamap: Value Mapping\n    Parameter Value Mapping\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoInstallConfigParam (94407636414384)>'
    __info__ = ObjectInfo(InstallConfigParam)
