...
class Image(Entity):
    ...
    ::
        ...
        Image(**properties)
        new(id:str, architecture:str, format:str) -> Libosinfo.Image
    """
    ...
    def get_cloud_init(self): # real signature unknown; restored from __doc__
        """ get_cloud_init(self) -> bool """
        return False
    ...
    def new(self, id, architecture, format): # real signature unknown; restored from __doc__
        """ new(id:str, architecture:str, format:str) -> Libosinfo.Image """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7153165460>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Image), '__module__': 'gi.repository.Libosinfo', '__gtype__': <GType OsinfoImage (94407636335312)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_architecture': gi.FunctionInfo(get_architecture), 'get_cloud_init': gi.FunctionInfo(get_cloud_init), 'get_format': gi.FunctionInfo(get_format), 'get_os': gi.FunctionInfo(get_os), 'get_os_variants': gi.FunctionInfo(get_os_variants), 'get_url': gi.FunctionInfo(get_url), 'set_os': gi.FunctionInfo(set_os), 'parent_instance': <property object at 0x7f71538f9770>, 'priv': <property object at 0x7f71538f9860>})"
    __gdoc__ = 'Object OsinfoImage\n\nProperties from OsinfoImage:\n  architecture -> gchararray: ARCHITECTURE\n    CPU Architecture\n  format -> gchararray: FORMAT\n    The image format\n  url -> gchararray: URL\n    The URL to this image\n\nProperties from OsinfoEntity:\n  id -> gchararray: ID\n    Unique identifier\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType OsinfoImage (94407636335312)>'
