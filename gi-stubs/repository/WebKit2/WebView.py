...
class WebView(WebViewBase):
    ...
    ::
        ...
        WebView(**properties)
        new() -> Gtk.Widget
        new_with_context(context:WebKit2.WebContext) -> Gtk.Widget
        new_with_related_view(web_view:WebKit2.WebView) -> Gtk.Widget
        new_with_settings(settings:WebKit2.Settings) -> Gtk.Widget
        new_with_user_content_manager(user_content_manager:WebKit2.UserContentManager) -> Gtk.Widget
    """
    ...
    def can_execute_editing_command(self, command, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ can_execute_editing_command(self, command:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def can_execute_editing_command_finish(self, result): # real signature unknown; restored from __doc__
        """ can_execute_editing_command_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def can_go_back(self): # real signature unknown; restored from __doc__
        """ can_go_back(self) -> bool """
        return False

    def can_go_forward(self): # real signature unknown; restored from __doc__
        """ can_go_forward(self) -> bool """
        return False

    def can_show_mime_type(self, mime_type): # real signature unknown; restored from __doc__
        """ can_show_mime_type(self, mime_type:str) -> bool """
        return False
    ...
    def do_authenticate(self, *args, **kwargs): # real signature unknown
        """ authenticate(self, request:WebKit2.AuthenticationRequest) -> bool """
        pass
    ...
    def do_context_menu(self, *args, **kwargs): # real signature unknown
        """ context_menu(self, context_menu:WebKit2.ContextMenu, event:Gdk.Event, hit_test_result:WebKit2.HitTestResult) -> bool """
        pass

    def do_context_menu_dismissed(self, *args, **kwargs): # real signature unknown
        """ context_menu_dismissed(self) """
        pass
    ...
    def do_decide_policy(self, *args, **kwargs): # real signature unknown
        """ decide_policy(self, decision:WebKit2.PolicyDecision, type:WebKit2.PolicyDecisionType) -> bool """
        pass
    ...
    def do_enter_fullscreen(self, *args, **kwargs): # real signature unknown
        """ enter_fullscreen(self) -> bool """
        pass
    ...
    def do_insecure_content_detected(self, *args, **kwargs): # real signature unknown
        """ insecure_content_detected(self, event:WebKit2.InsecureContentEvent) """
        pass
    ...
    def do_leave_fullscreen(self, *args, **kwargs): # real signature unknown
        """ leave_fullscreen(self) -> bool """
        pass
    ...
    def do_load_changed(self, *args, **kwargs): # real signature unknown
        """ load_changed(self, load_event:WebKit2.LoadEvent) """
        pass

    def do_load_failed(self, *args, **kwargs): # real signature unknown
        """ load_failed(self, load_event:WebKit2.LoadEvent, failing_uri:str, error:error) -> bool """
        pass

    def do_load_failed_with_tls_errors(self, *args, **kwargs): # real signature unknown
        """ load_failed_with_tls_errors(self, failing_uri:str, certificate:Gio.TlsCertificate, errors:Gio.TlsCertificateFlags) -> bool """
        pass
    ...
    def do_mouse_target_changed(self, *args, **kwargs): # real signature unknown
        """ mouse_target_changed(self, hit_test_result:WebKit2.HitTestResult, modifiers:int) """
        pass
    ...
    def do_permission_request(self, *args, **kwargs): # real signature unknown
        """ permission_request(self, permission_request:WebKit2.PermissionRequest) -> bool """
        pass
    ...
    def do_print_(self, *args, **kwargs): # real signature unknown
        """ print_(self, print_operation:WebKit2.PrintOperation) -> bool """
        pass
    ...
    def do_ready_to_show(self, *args, **kwargs): # real signature unknown
        """ ready_to_show(self) """
        pass
    ...
    def do_resource_load_started(self, *args, **kwargs): # real signature unknown
        """ resource_load_started(self, resource:WebKit2.WebResource, request:WebKit2.URIRequest) """
        pass

    def do_run_as_modal(self, *args, **kwargs): # real signature unknown
        """ run_as_modal(self) """
        pass

    def do_run_color_chooser(self, *args, **kwargs): # real signature unknown
        """ run_color_chooser(self, request:WebKit2.ColorChooserRequest) -> bool """
        pass

    def do_run_file_chooser(self, *args, **kwargs): # real signature unknown
        """ run_file_chooser(self, request:WebKit2.FileChooserRequest) -> bool """
        pass
    ...
    def do_script_dialog(self, *args, **kwargs): # real signature unknown
        """ script_dialog(self, dialog:WebKit2.ScriptDialog) -> bool """
        pass
    ...
    def do_show_notification(self, *args, **kwargs): # real signature unknown
        """ show_notification(self, notification:WebKit2.Notification) -> bool """
        pass

    def do_show_option_menu(self, *args, **kwargs): # real signature unknown
        """ show_option_menu(self, rectangle:Gdk.Rectangle, menu:WebKit2.OptionMenu) -> bool """
        pass
    ...
    def do_submit_form(self, *args, **kwargs): # real signature unknown
        """ submit_form(self, request:WebKit2.FormSubmissionRequest) """
        pass
    ...
    def do_web_process_crashed(self, *args, **kwargs): # real signature unknown
        """ web_process_crashed(self) -> bool """
        pass

    def do_web_process_terminated(self, *args, **kwargs): # real signature unknown
        """ web_process_terminated(self, reason:WebKit2.WebProcessTerminationReason) """
        pass
    ...
    def execute_editing_command(self, command): # real signature unknown; restored from __doc__
        """ execute_editing_command(self, command:str) """
        pass

    def execute_editing_command_with_argument(self, command, argument): # real signature unknown; restored from __doc__
        """ execute_editing_command_with_argument(self, command:str, argument:str) """
        pass
    ...
    def get_automation_presentation_type(self): # real signature unknown; restored from __doc__
        """ get_automation_presentation_type(self) -> WebKit2.AutomationBrowsingContextPresentation """
        pass

    def get_background_color(self): # real signature unknown; restored from __doc__
        """ get_background_color(self) -> rgba:Gdk.RGBA """
        pass

    def get_back_forward_list(self): # real signature unknown; restored from __doc__
        """ get_back_forward_list(self) -> WebKit2.BackForwardList """
        pass
    ...
    def get_context(self): # real signature unknown; restored from __doc__
        """ get_context(self) -> WebKit2.WebContext """
        pass
    ...
    def get_custom_charset(self): # real signature unknown; restored from __doc__
        """ get_custom_charset(self) -> str """
        return ""
    ...
    def get_editor_state(self): # real signature unknown; restored from __doc__
        """ get_editor_state(self) -> WebKit2.EditorState """
        pass

    def get_estimated_load_progress(self): # real signature unknown; restored from __doc__
        """ get_estimated_load_progress(self) -> float """
        return 0.0
    ...
    def get_favicon(self): # real signature unknown; restored from __doc__
        """ get_favicon(self) -> cairo.Surface """
        pass

    def get_find_controller(self): # real signature unknown; restored from __doc__
        """ get_find_controller(self) -> WebKit2.FindController """
        pass
    ...
    def get_input_method_context(self): # real signature unknown; restored from __doc__
        """ get_input_method_context(self) -> WebKit2.InputMethodContext or None """
        pass

    def get_inspector(self): # real signature unknown; restored from __doc__
        """ get_inspector(self) -> WebKit2.WebInspector """
        pass
    ...
    def get_main_resource(self): # real signature unknown; restored from __doc__
        """ get_main_resource(self) -> WebKit2.WebResource """
        pass
    ...
    def get_page_id(self): # real signature unknown; restored from __doc__
        """ get_page_id(self) -> int """
        return 0
    ...
    def get_session_state(self): # real signature unknown; restored from __doc__
        """ get_session_state(self) -> WebKit2.WebViewSessionState """
        pass

    def get_settings(self): # real signature unknown; restored from __doc__
        """ get_settings(self) -> WebKit2.Settings """
        pass
    ...
    def get_snapshot(self, region, options, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ get_snapshot(self, region:WebKit2.SnapshotRegion, options:WebKit2.SnapshotOptions, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def get_snapshot_finish(self, result): # real signature unknown; restored from __doc__
        """ get_snapshot_finish(self, result:Gio.AsyncResult) -> cairo.Surface """
        pass
    ...
    def get_tls_info(self): # real signature unknown; restored from __doc__
        """ get_tls_info(self) -> bool, certificate:Gio.TlsCertificate, errors:Gio.TlsCertificateFlags """
        return False
    ...
    def get_user_content_manager(self): # real signature unknown; restored from __doc__
        """ get_user_content_manager(self) -> WebKit2.UserContentManager """
        pass
    ...
    def get_window_properties(self): # real signature unknown; restored from __doc__
        """ get_window_properties(self) -> WebKit2.WindowProperties """
        pass

    def get_zoom_level(self): # real signature unknown; restored from __doc__
        """ get_zoom_level(self) -> float """
        return 0.0

    def go_back(self): # real signature unknown; restored from __doc__
        """ go_back(self) """
        pass

    def go_forward(self): # real signature unknown; restored from __doc__
        """ go_forward(self) """
        pass

    def go_to_back_forward_list_item(self, list_item): # real signature unknown; restored from __doc__
        """ go_to_back_forward_list_item(self, list_item:WebKit2.BackForwardListItem) """
        pass
    ...
    def is_controlled_by_automation(self): # real signature unknown; restored from __doc__
        """ is_controlled_by_automation(self) -> bool """
        return False
    ...
    def is_playing_audio(self): # real signature unknown; restored from __doc__
        """ is_playing_audio(self) -> bool """
        return False
    ...
    def load_alternate_html(self, content, content_uri, base_uri=None): # real signature unknown; restored from __doc__
        """ load_alternate_html(self, content:str, content_uri:str, base_uri:str=None) """
        pass

    def load_bytes(self, bytes, mime_type=None, encoding=None, base_uri=None): # real signature unknown; restored from __doc__
        """ load_bytes(self, bytes:GLib.Bytes, mime_type:str=None, encoding:str=None, base_uri:str=None) """
        pass

    def load_html(self, content, base_uri=None): # real signature unknown; restored from __doc__
        """ load_html(self, content:str, base_uri:str=None) """
        pass

    def load_plain_text(self, plain_text): # real signature unknown; restored from __doc__
        """ load_plain_text(self, plain_text:str) """
        pass

    def load_request(self, request): # real signature unknown; restored from __doc__
        """ load_request(self, request:WebKit2.URIRequest) """
        pass

    def load_uri(self, uri): # real signature unknown; restored from __doc__
        """ load_uri(self, uri:str) """
        pass
    ...
    def new_with_context(self, context): # real signature unknown; restored from __doc__
        """ new_with_context(context:WebKit2.WebContext) -> Gtk.Widget """
        pass

    def new_with_related_view(self, web_view): # real signature unknown; restored from __doc__
        """ new_with_related_view(web_view:WebKit2.WebView) -> Gtk.Widget """
        pass

    def new_with_settings(self, settings): # real signature unknown; restored from __doc__
        """ new_with_settings(settings:WebKit2.Settings) -> Gtk.Widget """
        pass

    def new_with_user_content_manager(self, user_content_manager): # real signature unknown; restored from __doc__
        """ new_with_user_content_manager(user_content_manager:WebKit2.UserContentManager) -> Gtk.Widget """
        pass
    ...
    def reload_bypass_cache(self): # real signature unknown; restored from __doc__
        """ reload_bypass_cache(self) """
        pass
    ...
    def restore_session_state(self, state): # real signature unknown; restored from __doc__
        """ restore_session_state(self, state:WebKit2.WebViewSessionState) """
        pass
    ...
    def run_javascript(self, script, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ run_javascript(self, script:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def run_javascript_finish(self, result): # real signature unknown; restored from __doc__
        """ run_javascript_finish(self, result:Gio.AsyncResult) -> WebKit2.JavascriptResult """
        pass

    def run_javascript_from_gresource(self, resource, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ run_javascript_from_gresource(self, resource:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def run_javascript_from_gresource_finish(self, result): # real signature unknown; restored from __doc__
        """ run_javascript_from_gresource_finish(self, result:Gio.AsyncResult) -> WebKit2.JavascriptResult """
        pass

    def run_javascript_in_world(self, script, world_name, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ run_javascript_in_world(self, script:str, world_name:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def run_javascript_in_world_finish(self, result): # real signature unknown; restored from __doc__
        """ run_javascript_in_world_finish(self, result:Gio.AsyncResult) -> WebKit2.JavascriptResult """
        pass

    def save(self, save_mode, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ save(self, save_mode:WebKit2.SaveMode, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def save_finish(self, result): # real signature unknown; restored from __doc__
        """ save_finish(self, result:Gio.AsyncResult) -> Gio.InputStream """
        pass

    def save_to_file(self, file, save_mode, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ save_to_file(self, file:Gio.File, save_mode:WebKit2.SaveMode, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def send_message_to_page(self, message, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ send_message_to_page(self, message:WebKit2.UserMessage, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def send_message_to_page_finish(self, result): # real signature unknown; restored from __doc__
        """ send_message_to_page_finish(self, result:Gio.AsyncResult) -> WebKit2.UserMessage """
        pass
    ...
    def set_background_color(self, rgba): # real signature unknown; restored from __doc__
        """ set_background_color(self, rgba:Gdk.RGBA) """
        pass
    ...
    def set_custom_charset(self, charset=None): # real signature unknown; restored from __doc__
        """ set_custom_charset(self, charset:str=None) """
        pass
    ...
    def set_input_method_context(self, context=None): # real signature unknown; restored from __doc__
        """ set_input_method_context(self, context:WebKit2.InputMethodContext=None) """
        pass
    ...
    def set_settings(self, settings): # real signature unknown; restored from __doc__
        """ set_settings(self, settings:WebKit2.Settings) """
        pass
    ...
    def set_zoom_level(self, zoom_level): # real signature unknown; restored from __doc__
    ...
    def stop_loading(self): # real signature unknown; restored from __doc__
        """ stop_loading(self) """
        pass
    ...
    def try_close(self): # real signature unknown; restored from __doc__
        """ try_close(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc3e65708e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WebView), '__module__': 'gi.repository.WebKit2', '__gtype__': <GType WebKitWebView (94869775013808)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_with_context': gi.FunctionInfo(new_with_context), 'new_with_related_view': gi.FunctionInfo(new_with_related_view), 'new_with_settings': gi.FunctionInfo(new_with_settings), 'new_with_user_content_manager': gi.FunctionInfo(new_with_user_content_manager), 'can_execute_editing_command': gi.FunctionInfo(can_execute_editing_command), 'can_execute_editing_command_finish': gi.FunctionInfo(can_execute_editing_command_finish), 'can_go_back': gi.FunctionInfo(can_go_back), 'can_go_forward': gi.FunctionInfo(can_go_forward), 'can_show_mime_type': gi.FunctionInfo(can_show_mime_type), 'download_uri': gi.FunctionInfo(download_uri), 'execute_editing_command': gi.FunctionInfo(execute_editing_command), 'execute_editing_command_with_argument': gi.FunctionInfo(execute_editing_command_with_argument), 'get_automation_presentation_type': gi.FunctionInfo(get_automation_presentation_type), 'get_back_forward_list': gi.FunctionInfo(get_back_forward_list), 'get_background_color': gi.FunctionInfo(get_background_color), 'get_context': gi.FunctionInfo(get_context), 'get_custom_charset': gi.FunctionInfo(get_custom_charset), 'get_editor_state': gi.FunctionInfo(get_editor_state), 'get_estimated_load_progress': gi.FunctionInfo(get_estimated_load_progress), 'get_favicon': gi.FunctionInfo(get_favicon), 'get_find_controller': gi.FunctionInfo(get_find_controller), 'get_input_method_context': gi.FunctionInfo(get_input_method_context), 'get_inspector': gi.FunctionInfo(get_inspector), 'get_main_resource': gi.FunctionInfo(get_main_resource), 'get_page_id': gi.FunctionInfo(get_page_id), 'get_session_state': gi.FunctionInfo(get_session_state), 'get_settings': gi.FunctionInfo(get_settings), 'get_snapshot': gi.FunctionInfo(get_snapshot), 'get_snapshot_finish': gi.FunctionInfo(get_snapshot_finish), 'get_title': gi.FunctionInfo(get_title), 'get_tls_info': gi.FunctionInfo(get_tls_info), 'get_uri': gi.FunctionInfo(get_uri), 'get_user_content_manager': gi.FunctionInfo(get_user_content_manager), 'get_website_data_manager': gi.FunctionInfo(get_website_data_manager), 'get_window_properties': gi.FunctionInfo(get_window_properties), 'get_zoom_level': gi.FunctionInfo(get_zoom_level), 'go_back': gi.FunctionInfo(go_back), 'go_forward': gi.FunctionInfo(go_forward), 'go_to_back_forward_list_item': gi.FunctionInfo(go_to_back_forward_list_item), 'is_controlled_by_automation': gi.FunctionInfo(is_controlled_by_automation), 'is_editable': gi.FunctionInfo(is_editable), 'is_ephemeral': gi.FunctionInfo(is_ephemeral), 'is_loading': gi.FunctionInfo(is_loading), 'is_playing_audio': gi.FunctionInfo(is_playing_audio), 'load_alternate_html': gi.FunctionInfo(load_alternate_html), 'load_bytes': gi.FunctionInfo(load_bytes), 'load_html': gi.FunctionInfo(load_html), 'load_plain_text': gi.FunctionInfo(load_plain_text), 'load_request': gi.FunctionInfo(load_request), 'load_uri': gi.FunctionInfo(load_uri), 'reload': gi.FunctionInfo(reload), 'reload_bypass_cache': gi.FunctionInfo(reload_bypass_cache), 'restore_session_state': gi.FunctionInfo(restore_session_state), 'run_javascript': gi.FunctionInfo(run_javascript), 'run_javascript_finish': gi.FunctionInfo(run_javascript_finish), 'run_javascript_from_gresource': gi.FunctionInfo(run_javascript_from_gresource), 'run_javascript_from_gresource_finish': gi.FunctionInfo(run_javascript_from_gresource_finish), 'run_javascript_in_world': gi.FunctionInfo(run_javascript_in_world), 'run_javascript_in_world_finish': gi.FunctionInfo(run_javascript_in_world_finish), 'save': gi.FunctionInfo(save), 'save_finish': gi.FunctionInfo(save_finish), 'save_to_file': gi.FunctionInfo(save_to_file), 'save_to_file_finish': gi.FunctionInfo(save_to_file_finish), 'send_message_to_page': gi.FunctionInfo(send_message_to_page), 'send_message_to_page_finish': gi.FunctionInfo(send_message_to_page_finish), 'set_background_color': gi.FunctionInfo(set_background_color), 'set_custom_charset': gi.FunctionInfo(set_custom_charset), 'set_editable': gi.FunctionInfo(set_editable), 'set_input_method_context': gi.FunctionInfo(set_input_method_context), 'set_settings': gi.FunctionInfo(set_settings), 'set_zoom_level': gi.FunctionInfo(set_zoom_level), 'stop_loading': gi.FunctionInfo(stop_loading), 'try_close': gi.FunctionInfo(try_close), 'do_authenticate': gi.VFuncInfo(authenticate), 'do_close': gi.VFuncInfo(close), 'do_context_menu': gi.VFuncInfo(context_menu), 'do_context_menu_dismissed': gi.VFuncInfo(context_menu_dismissed), 'do_decide_policy': gi.VFuncInfo(decide_policy), 'do_enter_fullscreen': gi.VFuncInfo(enter_fullscreen), 'do_insecure_content_detected': gi.VFuncInfo(insecure_content_detected), 'do_leave_fullscreen': gi.VFuncInfo(leave_fullscreen), 'do_load_changed': gi.VFuncInfo(load_changed), 'do_load_failed': gi.VFuncInfo(load_failed), 'do_load_failed_with_tls_errors': gi.VFuncInfo(load_failed_with_tls_errors), 'do_mouse_target_changed': gi.VFuncInfo(mouse_target_changed), 'do_permission_request': gi.VFuncInfo(permission_request), 'do_print_': gi.VFuncInfo(print), 'do_ready_to_show': gi.VFuncInfo(ready_to_show), 'do_resource_load_started': gi.VFuncInfo(resource_load_started), 'do_run_as_modal': gi.VFuncInfo(run_as_modal), 'do_run_color_chooser': gi.VFuncInfo(run_color_chooser), 'do_run_file_chooser': gi.VFuncInfo(run_file_chooser), 'do_script_dialog': gi.VFuncInfo(script_dialog), 'do_show_notification': gi.VFuncInfo(show_notification), 'do_show_option_menu': gi.VFuncInfo(show_option_menu), 'do_submit_form': gi.VFuncInfo(submit_form), 'do_user_message_received': gi.VFuncInfo(user_message_received), 'do_web_process_crashed': gi.VFuncInfo(web_process_crashed), 'do_web_process_terminated': gi.VFuncInfo(web_process_terminated), 'parent': <property object at 0x7fc3e718dc20>, 'priv': <property object at 0x7fc3e718dd60>})"
    __gdoc__ = "Object WebKitWebView\n\nSignals from WebKitWebView:\n  create (WebKitNavigationAction) -> GtkWidget\n  close ()\n  user-message-received (WebKitUserMessage) -> gboolean\n  load-changed (WebKitLoadEvent)\n  load-failed (WebKitLoadEvent, gchararray, GError) -> gboolean\n  load-failed-with-tls-errors (gchararray, GTlsCertificate, GTlsCertificateFlags) -> gboolean\n  ready-to-show ()\n  run-as-modal ()\n  script-dialog (WebKitScriptDialog) -> gboolean\n  decide-policy (WebKitPolicyDecision, WebKitPolicyDecisionType) -> gboolean\n  permission-request (WebKitPermissionRequest) -> gboolean\n  mouse-target-changed (WebKitHitTestResult, guint)\n  print (WebKitPrintOperation) -> gboolean\n  resource-load-started (WebKitWebResource, WebKitURIRequest)\n  enter-fullscreen () -> gboolean\n  leave-fullscreen () -> gboolean\n  run-file-chooser (WebKitFileChooserRequest) -> gboolean\n  context-menu (WebKitContextMenu, GdkEvent, WebKitHitTestResult) -> gboolean\n  context-menu-dismissed ()\n  submit-form (WebKitFormSubmissionRequest)\n  insecure-content-detected (WebKitInsecureContentEvent)\n  web-process-crashed () -> gboolean\n  web-process-terminated (WebKitWebProcessTerminationReason)\n  authenticate (WebKitAuthenticationRequest) -> gboolean\n  show-notification (WebKitNotification) -> gboolean\n  run-color-chooser (WebKitColorChooserRequest) -> gboolean\n  show-option-menu (WebKitOptionMenu, GdkEvent, GdkRectangle) -> gboolean\n\nProperties from WebKitWebView:\n  web-context -> WebKitWebContext: Web Context\n    The web context for the view\n  related-view -> WebKitWebView: Related WebView\n    The related WebKitWebView used when creating the view to share the same web process\n  settings -> WebKitSettings: WebView settings\n    The WebKitSettings of the view\n  user-content-manager -> WebKitUserContentManager: WebView user content manager\n    The WebKitUserContentManager of the view\n  title -> gchararray: Title\n    Main frame document title\n  estimated-load-progress -> gdouble: Estimated Load Progress\n    An estimate of the percent completion for a document load\n  favicon -> gpointer: Favicon\n    The favicon associated to the view, if any\n  uri -> gchararray: URI\n    The current active URI of the view\n  zoom-level -> gdouble: Zoom level\n    The zoom level of the view content\n  is-loading -> gboolean: Is Loading\n    Whether the view is loading a page\n  is-playing-audio -> gboolean: Is Playing Audio\n    Whether the view is playing audio\n  is-ephemeral -> gboolean: Is Ephemeral\n    Whether the web view is ephemeral\n  is-controlled-by-automation -> gboolean: Is Controlled By Automation\n    Whether the web view is controlled by automation\n  automation-presentation-type -> WebKitAutomationBrowsingContextPresentation: Automation Presentation Type\n    The browsing context presentation type for automation\n  editable -> gboolean: Editable\n    Whether the content can be modified by the user.\n  page-id -> guint64: Page Identifier\n    The page identifier.\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-changed (GtkStateType)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  direction-changed (GtkTextDirection)\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType WebKitWebView (94869775013808)>'
    __info__ = ObjectInfo(WebView)
