...
class PluginClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PluginClass), '__module__': 'gi.repository.WebKit2', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'PluginClass' objects>, '__weakref__': <attribute '__weakref__' of 'PluginClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fc3eec22090>, '_webkit_reserved0': <property object at 0x7fc3eec221d0>, '_webkit_reserved1': <property object at 0x7fc3eec222c0>, '_webkit_reserved2': <property object at 0x7fc3eec223b0>, '_webkit_reserved3': <property object at 0x7fc3eec224a0>})"
