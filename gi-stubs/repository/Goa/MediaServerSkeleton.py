...
class MediaServerSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, MediaServer):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4a9ccd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaServerSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaMediaServerSkeleton (94357270910864)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c28270>, 'priv': <property object at 0x7f37f4c283b0>})"
    __gdoc__ = 'Object GoaMediaServerSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaMediaServerSkeleton (94357270910864)>'
    __info__ = ObjectInfo(MediaServerSkeleton)
