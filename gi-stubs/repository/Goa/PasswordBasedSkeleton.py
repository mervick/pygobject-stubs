...
class PasswordBasedSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, PasswordBased):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4a8e9d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PasswordBasedSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaPasswordBasedSkeleton (94357271085856)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c3b3b0>, 'priv': <property object at 0x7f37f4c3b4f0>})"
    __gdoc__ = 'Object GoaPasswordBasedSkeleton\n\nSignals from GoaPasswordBased:\n  handle-get-password (GDBusMethodInvocation, gchararray) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaPasswordBasedSkeleton (94357271085856)>'
    __info__ = ObjectInfo(PasswordBasedSkeleton)
