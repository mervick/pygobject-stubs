...
class ExchangeSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Exchange):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4c4b820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ExchangeSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaExchangeSkeleton (94357270748624)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4d12040>, 'priv': <property object at 0x7f37f4d12180>})"
    __gdoc__ = 'Object GoaExchangeSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaExchangeSkeleton (94357270748624)>'
    __info__ = ObjectInfo(ExchangeSkeleton)
