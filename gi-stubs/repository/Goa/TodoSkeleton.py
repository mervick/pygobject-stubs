...
class TodoSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Todo):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TodoSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaTodoSkeleton (94357271169888)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c479f0>, 'priv': <property object at 0x7f37f4c47b30>})"
    __gdoc__ = 'Object GoaTodoSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaTodoSkeleton (94357271169888)>'
    __info__ = ObjectInfo(TodoSkeleton)
