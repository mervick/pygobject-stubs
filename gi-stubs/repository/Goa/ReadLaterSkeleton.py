...
class ReadLaterSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, ReadLater):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f498e5e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ReadLaterSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaReadLaterSkeleton (94357271138976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c42bd0>, 'priv': <property object at 0x7f37f4c42d10>})"
    __gdoc__ = 'Object GoaReadLaterSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaReadLaterSkeleton (94357271138976)>'
    __info__ = ObjectInfo(ReadLaterSkeleton)
