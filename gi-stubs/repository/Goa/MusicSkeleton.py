...
class MusicSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Music):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MusicSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaMusicSkeleton (94357271009712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c28f90>, 'priv': <property object at 0x7f37f4c2a130>})"
    __gdoc__ = 'Object GoaMusicSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaMusicSkeleton (94357271009712)>'
    __info__ = ObjectInfo(MusicSkeleton)
