...
class ContactsSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Contacts):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ContactsSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaContactsSkeleton (94357270440560)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4d0c0e0>, 'priv': <property object at 0x7f37f4d0c220>})"
    __gdoc__ = 'Object GoaContactsSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaContactsSkeleton (94357270440560)>'
    __info__ = ObjectInfo(ContactsSkeleton)
