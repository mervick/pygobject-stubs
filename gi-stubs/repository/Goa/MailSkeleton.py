...
class MailSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Mail):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4bddaf0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MailSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaMailSkeleton (94357270943696)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c20310>, 'priv': <property object at 0x7f37f4c20450>})"
    __gdoc__ = 'Object GoaMailSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaMailSkeleton (94357270943696)>'
    __info__ = ObjectInfo(MailSkeleton)
