...
class ManagerSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Manager):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4bc6940>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ManagerSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaManagerSkeleton (94357270966112)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c22540>, 'priv': <property object at 0x7f37f4c22680>})"
    __gdoc__ = 'Object GoaManagerSkeleton\n\nSignals from GoaManager:\n  handle-add-account (GDBusMethodInvocation, gchararray, gchararray, gchararray, GVariant, GVariant) -> gboolean\n  handle-is-supported-provider (GDBusMethodInvocation, gchararray) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaManagerSkeleton (94357270966112)>'
