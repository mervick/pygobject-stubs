...
class PhotosSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Photos):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PhotosSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaPhotosSkeleton (94357270959952)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c3c130>, 'priv': <property object at 0x7f37f4c3c270>})"
    __gdoc__ = 'Object GoaPhotosSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaPhotosSkeleton (94357270959952)>'
    __info__ = ObjectInfo(PhotosSkeleton)
