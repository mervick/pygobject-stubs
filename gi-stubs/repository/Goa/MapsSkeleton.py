...
class MapsSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Maps):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4bdd8b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MapsSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaMapsSkeleton (94357270900928)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c242c0>, 'priv': <property object at 0x7f37f4c24400>})"
    __gdoc__ = 'Object GoaMapsSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaMapsSkeleton (94357270900928)>'
    __info__ = ObjectInfo(MapsSkeleton)
