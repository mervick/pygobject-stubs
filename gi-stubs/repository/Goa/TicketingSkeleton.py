...
class TicketingSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Ticketing):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4bdd640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TicketingSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaTicketingSkeleton (94357270974480)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c46c70>, 'priv': <property object at 0x7f37f4c46db0>})"
    __gdoc__ = 'Object GoaTicketingSkeleton\n\nSignals from GoaTicketing:\n  handle-get-ticket (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaTicketingSkeleton (94357270974480)>'
    __info__ = ObjectInfo(TicketingSkeleton)
