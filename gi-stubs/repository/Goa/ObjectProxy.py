...
class ObjectProxy(__gi_repository_Gio.DBusObjectProxy, Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4c4b3d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ObjectProxy), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaObjectProxy (94357271061920)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c35950>, 'priv': <property object at 0x7f37f4c35a90>})"
    __gdoc__ = 'Object GoaObjectProxy\n\nSignals from GDBusObject:\n  interface-added (GDBusInterface)\n  interface-removed (GDBusInterface)\n\nProperties from GDBusObjectProxy:\n  g-object-path -> gchararray: Object Path\n    The object path of the proxy\n  g-connection -> GDBusConnection: Connection\n    The connection of the proxy\n\nSignals from GDBusObject:\n  interface-added (GDBusInterface)\n  interface-removed (GDBusInterface)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaObjectProxy (94357271061920)>'
