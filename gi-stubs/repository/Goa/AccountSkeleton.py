...
class AccountSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Account):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4cf22b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AccountSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaAccountSkeleton (94357270447696)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4d014a0>, 'priv': <property object at 0x7f37f4d015e0>})"
    __gdoc__ = 'Object GoaAccountSkeleton\n\nSignals from GoaAccount:\n  handle-remove (GDBusMethodInvocation) -> gboolean\n  handle-ensure-credentials (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaAccountSkeleton (94357270447696)>'
    __info__ = ObjectInfo(AccountSkeleton)
