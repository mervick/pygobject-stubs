...
class OAuthBasedSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, OAuthBased):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4a9c9a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OAuthBasedSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaOAuthBasedSkeleton (94357271039136)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c31310>, 'priv': <property object at 0x7f37f4c31450>})"
    __gdoc__ = 'Object GoaOAuthBasedSkeleton\n\nSignals from GoaOAuthBased:\n  handle-get-access-token (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaOAuthBasedSkeleton (94357271039136)>'
    __info__ = ObjectInfo(OAuthBasedSkeleton)
