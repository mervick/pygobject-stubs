...
class OAuth2BasedSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, OAuth2Based):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4a9c8b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OAuth2BasedSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaOAuth2BasedSkeleton (94357271022912)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c2d220>, 'priv': <property object at 0x7f37f4c2d360>})"
    __gdoc__ = 'Object GoaOAuth2BasedSkeleton\n\nSignals from GoaOAuth2Based:\n  handle-get-access-token (GDBusMethodInvocation) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaOAuth2BasedSkeleton (94357271022912)>'
    __info__ = ObjectInfo(OAuth2BasedSkeleton)
