...
class Client(__gi_overrides_GObject.Object, __gi_repository_Gio.AsyncInitable, __gi_repository_Gio.Initable):
    ...
    def get_accounts(self): # real signature unknown; restored from __doc__
        """ get_accounts(self) -> list """
        return []
    ...
    def lookup_by_id(self, id): # real signature unknown; restored from __doc__
        """ lookup_by_id(self, id:str) -> Goa.Object """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4bddfa0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Client), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaClient (94357270813872)>, '__doc__': None, '__gsignals__': {}, 'new_finish': gi.FunctionInfo(new_finish), 'new_sync': gi.FunctionInfo(new_sync), 'new': gi.FunctionInfo(new), 'get_accounts': gi.FunctionInfo(get_accounts), 'get_manager': gi.FunctionInfo(get_manager), 'get_object_manager': gi.FunctionInfo(get_object_manager), 'lookup_by_id': gi.FunctionInfo(lookup_by_id)})"
    __gdoc__ = 'Object GoaClient\n\nSignals from GoaClient:\n  account-added (GoaObject)\n  account-removed (GoaObject)\n  account-changed (GoaObject)\n\nProperties from GoaClient:\n  object-manager -> GDBusObjectManager: object manager\n    The GDBusObjectManager used by the GoaClient\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaClient (94357270813872)>'
