...
class MapsProxy(__gi_overrides_Gio.DBusProxy, Maps):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4bc61f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MapsProxy), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaMapsProxy (94357270898960)>, '__doc__': None, '__gsignals__': {}, 'new_finish': gi.FunctionInfo(new_finish), 'new_for_bus_finish': gi.FunctionInfo(new_for_bus_finish), 'new_for_bus_sync': gi.FunctionInfo(new_for_bus_sync), 'new_sync': gi.FunctionInfo(new_sync), 'new': gi.FunctionInfo(new), 'new_for_bus': gi.FunctionInfo(new_for_bus), 'parent_instance': <property object at 0x7f37f4c22d60>, 'priv': <property object at 0x7f37f4c22e50>})"
    __gdoc__ = 'Object GoaMapsProxy\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaMapsProxy (94357270898960)>'
    __info__ = ObjectInfo(MapsProxy)
