...
class FilesSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Files):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4c4bc70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FilesSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaFilesSkeleton (94357270745728)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4d12f40>, 'priv': <property object at 0x7f37f4c1a0e0>})"
    __gdoc__ = 'Object GoaFilesSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaFilesSkeleton (94357270745728)>'
    __info__ = ObjectInfo(FilesSkeleton)
