...
class PrintersSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Printers):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f37f4a9ca30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PrintersSkeleton), '__module__': 'gi.repository.Goa', '__gtype__': <GType GoaPrintersSkeleton (94357271123984)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f37f4c3ce50>, 'priv': <property object at 0x7f37f4c3cf90>})"
    __gdoc__ = 'Object GoaPrintersSkeleton\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GoaPrintersSkeleton (94357271123984)>'
    __info__ = ObjectInfo(PrintersSkeleton)
