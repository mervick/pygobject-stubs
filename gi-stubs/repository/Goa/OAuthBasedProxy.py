...
class OAuthBasedProxy(__gi_overrides_Gio.DBusProxy, OAuthBased):
    """
    :Constructors:
    ...
    def call_get_access_token_finish(self, res): # real signature unknown; restored from __doc__
        """ call_get_access_token_finish(self, res:Gio.AsyncResult) -> out_access_token:str, out_access_token_secret:str, out_expires_in:int """
        pass

    def call_get_access_token_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ call_get_access_token_sync(self, cancellable:Gio.Cancellable=None) -> out_access_token:str, out_access_token_secret:str, out_expires_in:int """
        pass
    ...
    def complete_get_access_token(self, invocation, access_token, access_token_secret, expires_in): # real signature unknown; restored from __doc__
        """ complete_get_access_token(self, invocation:Gio.DBusMethodInvocation, access_token:str, access_token_secret:str, expires_in:int) """
        pass
