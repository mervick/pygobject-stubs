...
class Aggregator(__gi_repository_Gst.Element):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9fb796b160>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Aggregator), '__module__': 'gi.repository.GstBase', '__gtype__': <GType GstAggregator (94858291095920)>, '__doc__': None, '__gsignals__': {}, 'finish_buffer': gi.FunctionInfo(finish_buffer), 'get_allocator': gi.FunctionInfo(get_allocator), 'get_buffer_pool': gi.FunctionInfo(get_buffer_pool), 'get_latency': gi.FunctionInfo(get_latency), 'set_latency': gi.FunctionInfo(set_latency), 'set_src_caps': gi.FunctionInfo(set_src_caps), 'simple_get_next_time': gi.FunctionInfo(simple_get_next_time), 'do_aggregate': gi.VFuncInfo(aggregate), 'do_clip': gi.VFuncInfo(clip), 'do_decide_allocation': gi.VFuncInfo(decide_allocation), 'do_finish_buffer': gi.VFuncInfo(finish_buffer), 'do_fixate_src_caps': gi.VFuncInfo(fixate_src_caps), 'do_flush': gi.VFuncInfo(flush), 'do_get_next_time': gi.VFuncInfo(get_next_time), 'do_negotiated_src_caps': gi.VFuncInfo(negotiated_src_caps), 'do_propose_allocation': gi.VFuncInfo(propose_allocation), 'do_sink_event': gi.VFuncInfo(sink_event), 'do_sink_query': gi.VFuncInfo(sink_query), 'do_src_activate': gi.VFuncInfo(src_activate), 'do_src_event': gi.VFuncInfo(src_event), 'do_src_query': gi.VFuncInfo(src_query), 'do_start': gi.VFuncInfo(start), 'do_stop': gi.VFuncInfo(stop), 'do_update_src_caps': gi.VFuncInfo(update_src_caps), 'parent': <property object at 0x7f9fb7bab7c0>, 'srcpad': <property object at 0x7f9fb7bab8b0>, 'priv': <property object at 0x7f9fb7bab9a0>, '_gst_reserved': <property object at 0x7f9fb7baba90>})"
    __gdoc__ = 'Object GstAggregator\n\nProperties from GstAggregator:\n  latency -> guint64: Buffer latency\n    Additional latency in live mode to allow upstream to take longer to produce buffers for the current position (in nanoseconds)\n  min-upstream-latency -> guint64: Buffer latency\n    When sources with a higher latency are expected to be plugged in dynamically after the aggregator has started playing, this allows overriding the minimum latency reported by the initial source(s). This is only taken into account when larger than the actually reported minimum latency. (nanoseconds)\n  start-time-selection -> GstAggregatorStartTimeSelection: Start Time Selection\n    Decides which start time is output\n  start-time -> guint64: Start Time\n    Start time to use if start-time-selection=set\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstAggregator (94858291095920)>'
    __info__ = ObjectInfo(Aggregator)
