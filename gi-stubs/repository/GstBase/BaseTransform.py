...
class BaseTransform(__gi_repository_Gst.Element):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9fb796b790>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BaseTransform), '__module__': 'gi.repository.GstBase', '__gtype__': <GType GstBaseTransform (94858291436656)>, '__doc__': None, '__gsignals__': {}, 'get_allocator': gi.FunctionInfo(get_allocator), 'get_buffer_pool': gi.FunctionInfo(get_buffer_pool), 'is_in_place': gi.FunctionInfo(is_in_place), 'is_passthrough': gi.FunctionInfo(is_passthrough), 'is_qos_enabled': gi.FunctionInfo(is_qos_enabled), 'reconfigure_sink': gi.FunctionInfo(reconfigure_sink), 'reconfigure_src': gi.FunctionInfo(reconfigure_src), 'set_gap_aware': gi.FunctionInfo(set_gap_aware), 'set_in_place': gi.FunctionInfo(set_in_place), 'set_passthrough': gi.FunctionInfo(set_passthrough), 'set_prefer_passthrough': gi.FunctionInfo(set_prefer_passthrough), 'set_qos_enabled': gi.FunctionInfo(set_qos_enabled), 'update_qos': gi.FunctionInfo(update_qos), 'update_src_caps': gi.FunctionInfo(update_src_caps), 'do_accept_caps': gi.VFuncInfo(accept_caps), 'do_before_transform': gi.VFuncInfo(before_transform), 'do_copy_metadata': gi.VFuncInfo(copy_metadata), 'do_decide_allocation': gi.VFuncInfo(decide_allocation), 'do_filter_meta': gi.VFuncInfo(filter_meta), 'do_fixate_caps': gi.VFuncInfo(fixate_caps), 'do_generate_output': gi.VFuncInfo(generate_output), 'do_get_unit_size': gi.VFuncInfo(get_unit_size), 'do_prepare_output_buffer': gi.VFuncInfo(prepare_output_buffer), 'do_propose_allocation': gi.VFuncInfo(propose_allocation), 'do_query': gi.VFuncInfo(query), 'do_set_caps': gi.VFuncInfo(set_caps), 'do_sink_event': gi.VFuncInfo(sink_event), 'do_src_event': gi.VFuncInfo(src_event), 'do_start': gi.VFuncInfo(start), 'do_stop': gi.VFuncInfo(stop), 'do_submit_input_buffer': gi.VFuncInfo(submit_input_buffer), 'do_transform': gi.VFuncInfo(transform), 'do_transform_caps': gi.VFuncInfo(transform_caps), 'do_transform_ip': gi.VFuncInfo(transform_ip), 'do_transform_meta': gi.VFuncInfo(transform_meta), 'do_transform_size': gi.VFuncInfo(transform_size), 'element': <property object at 0x7f9fb7bc59f0>, 'sinkpad': <property object at 0x7f9fb7bc5ae0>, 'srcpad': <property object at 0x7f9fb7bc5bd0>, 'have_segment': <property object at 0x7f9fb7bc5cc0>, 'segment': <property object at 0x7f9fb7bc5db0>, 'queued_buf': <property object at 0x7f9fb7bc5ea0>, 'priv': <property object at 0x7f9fb7bc5f90>, '_gst_reserved': <property object at 0x7f9fb7bc80e0>})"
    __gdoc__ = 'Object GstBaseTransform\n\nProperties from GstBaseTransform:\n  qos -> gboolean: QoS\n    Handle Quality-of-Service events\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstBaseTransform (94858291436656)>'
    __info__ = ObjectInfo(BaseTransform)
