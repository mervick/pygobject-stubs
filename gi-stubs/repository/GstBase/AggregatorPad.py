...
class AggregatorPad(__gi_repository_Gst.Pad):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9fb796ba00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AggregatorPad), '__module__': 'gi.repository.GstBase', '__gtype__': <GType GstAggregatorPad (94858291162720)>, '__doc__': None, '__gsignals__': {}, 'drop_buffer': gi.FunctionInfo(drop_buffer), 'has_buffer': gi.FunctionInfo(has_buffer), 'is_eos': gi.FunctionInfo(is_eos), 'peek_buffer': gi.FunctionInfo(peek_buffer), 'pop_buffer': gi.FunctionInfo(pop_buffer), 'do_flush': gi.VFuncInfo(flush), 'do_skip_buffer': gi.VFuncInfo(skip_buffer), 'parent': <property object at 0x7f9fb7bb5950>, 'segment': <property object at 0x7f9fb7bb5a40>, 'priv': <property object at 0x7f9fb7bb5b30>, '_gst_reserved': <property object at 0x7f9fb7bb5c20>})"
    __gdoc__ = 'Object GstAggregatorPad\n\nProperties from GstAggregatorPad:\n  emit-signals -> gboolean: Emit signals\n    Send signals to signal data consumption\n\nSignals from GstPad:\n  linked (GstPad)\n  unlinked (GstPad)\n\nProperties from GstPad:\n  direction -> GstPadDirection: Direction\n    The direction of the pad\n  template -> GstPadTemplate: Template\n    The GstPadTemplate of this pad\n  offset -> gint64: Offset\n    The running time offset of the pad\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstAggregatorPad (94858291162720)>'
    __info__ = ObjectInfo(AggregatorPad)
