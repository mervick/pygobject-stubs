...
class BaseParse(__gi_repository_Gst.Element):
    """
    :Constructors:
    ...
    def add_index_entry(self, offset, ts, key, force): # real signature unknown; restored from __doc__
        """ add_index_entry(self, offset:int, ts:int, key:bool, force:bool) -> bool """
        return False
    ...
    def convert_default(self, src_format, src_value, dest_format): # real signature unknown; restored from __doc__
        """ convert_default(self, src_format:Gst.Format, src_value:int, dest_format:Gst.Format) -> bool, dest_value:int """
        return False
    ...
    def do_convert(self, *args, **kwargs): # real signature unknown
    ...
    def do_detect(self, *args, **kwargs): # real signature unknown
        """ detect(self, buffer:Gst.Buffer) -> Gst.FlowReturn """
        pass

    def do_get_sink_caps(self, *args, **kwargs): # real signature unknown
    ...
    def do_handle_frame(self, *args, **kwargs): # real signature unknown
        """ handle_frame(self, frame:GstBase.BaseParseFrame, skipsize:int) -> Gst.FlowReturn """
        pass
    ...
    def do_pre_push_frame(self, *args, **kwargs): # real signature unknown
    ...
    def do_set_sink_caps(self, *args, **kwargs): # real signature unknown
    ...
    def drain(self): # real signature unknown; restored from __doc__
        """ drain(self) """
        pass
    ...
    def finish_frame(self, frame, size): # real signature unknown; restored from __doc__
        """ finish_frame(self, frame:GstBase.BaseParseFrame, size:int) -> Gst.FlowReturn """
        pass
    ...
    def push_frame(self, frame): # real signature unknown; restored from __doc__
        """ push_frame(self, frame:GstBase.BaseParseFrame) -> Gst.FlowReturn """
        pass
    ...
    def set_average_bitrate(self, bitrate): # real signature unknown; restored from __doc__
        """ set_average_bitrate(self, bitrate:int) """
        pass
    ...
    def set_duration(self, fmt, duration, interval): # real signature unknown; restored from __doc__
        """ set_duration(self, fmt:Gst.Format, duration:int, interval:int) """
        pass

    def set_frame_rate(self, fps_num, fps_den, lead_in, lead_out): # real signature unknown; restored from __doc__
        """ set_frame_rate(self, fps_num:int, fps_den:int, lead_in:int, lead_out:int) """
        pass

    def set_has_timing_info(self, has_timing): # real signature unknown; restored from __doc__
        """ set_has_timing_info(self, has_timing:bool) """
        pass

    def set_infer_ts(self, infer_ts): # real signature unknown; restored from __doc__
        """ set_infer_ts(self, infer_ts:bool) """
        pass
    ...
    def set_min_frame_size(self, min_size): # real signature unknown; restored from __doc__
        """ set_min_frame_size(self, min_size:int) """
        pass
    ...
    def set_pts_interpolation(self, pts_interpolate): # real signature unknown; restored from __doc__
        """ set_pts_interpolation(self, pts_interpolate:bool) """
        pass
    ...
    def set_syncable(self, syncable): # real signature unknown; restored from __doc__
        """ set_syncable(self, syncable:bool) """
        pass

    def set_ts_at_offset(self, offset): # real signature unknown; restored from __doc__
        """ set_ts_at_offset(self, offset:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9fb796b7c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BaseParse), '__module__': 'gi.repository.GstBase', '__gtype__': <GType GstBaseParse (94858291661616)>, '__doc__': None, '__gsignals__': {}, 'add_index_entry': gi.FunctionInfo(add_index_entry), 'convert_default': gi.FunctionInfo(convert_default), 'drain': gi.FunctionInfo(drain), 'finish_frame': gi.FunctionInfo(finish_frame), 'merge_tags': gi.FunctionInfo(merge_tags), 'push_frame': gi.FunctionInfo(push_frame), 'set_average_bitrate': gi.FunctionInfo(set_average_bitrate), 'set_duration': gi.FunctionInfo(set_duration), 'set_frame_rate': gi.FunctionInfo(set_frame_rate), 'set_has_timing_info': gi.FunctionInfo(set_has_timing_info), 'set_infer_ts': gi.FunctionInfo(set_infer_ts), 'set_latency': gi.FunctionInfo(set_latency), 'set_min_frame_size': gi.FunctionInfo(set_min_frame_size), 'set_passthrough': gi.FunctionInfo(set_passthrough), 'set_pts_interpolation': gi.FunctionInfo(set_pts_interpolation), 'set_syncable': gi.FunctionInfo(set_syncable), 'set_ts_at_offset': gi.FunctionInfo(set_ts_at_offset), 'do_convert': gi.VFuncInfo(convert), 'do_detect': gi.VFuncInfo(detect), 'do_get_sink_caps': gi.VFuncInfo(get_sink_caps), 'do_handle_frame': gi.VFuncInfo(handle_frame), 'do_pre_push_frame': gi.VFuncInfo(pre_push_frame), 'do_set_sink_caps': gi.VFuncInfo(set_sink_caps), 'do_sink_event': gi.VFuncInfo(sink_event), 'do_sink_query': gi.VFuncInfo(sink_query), 'do_src_event': gi.VFuncInfo(src_event), 'do_src_query': gi.VFuncInfo(src_query), 'do_start': gi.VFuncInfo(start), 'do_stop': gi.VFuncInfo(stop), 'element': <property object at 0x7f9fb7bb75e0>, 'sinkpad': <property object at 0x7f9fb7bb76d0>, 'srcpad': <property object at 0x7f9fb7bb77c0>, 'flags': <property object at 0x7f9fb7bb78b0>, 'segment': <property object at 0x7f9fb7bb79a0>, '_gst_reserved': <property object at 0x7f9fb7bb7a90>, 'priv': <property object at 0x7f9fb7bb7b80>})"
    __gdoc__ = 'Object GstBaseParse\n\nProperties from GstBaseParse:\n  disable-passthrough -> gboolean: Disable passthrough\n    Force processing (disables passthrough)\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstBaseParse (94858291661616)>'
    __info__ = ObjectInfo(BaseParse)
