...
class PushSrc(BaseSrc):
    ...
    def do_alloc(self, *args, **kwargs): # real signature unknown
        """ alloc(self, buf:Gst.Buffer) -> Gst.FlowReturn """
        pass
    ...
    def do_create(self, *args, **kwargs): # real signature unknown
        """ create(self, buf:Gst.Buffer) -> Gst.FlowReturn """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9fb796b580>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PushSrc), '__module__': 'gi.repository.GstBase', '__gtype__': <GType GstPushSrc (94858291185088)>, '__doc__': None, '__gsignals__': {}, 'do_alloc': gi.VFuncInfo(alloc), 'do_create': gi.VFuncInfo(create), 'do_fill': gi.VFuncInfo(fill), 'parent': <property object at 0x7f9fb7964b80>, '_gst_reserved': <property object at 0x7f9fb7964c70>})"
    __gdoc__ = 'Object GstPushSrc\n\nProperties from GstBaseSrc:\n  blocksize -> guint: Block size\n    Size in bytes to read per buffer (-1 = default)\n  num-buffers -> gint: num-buffers\n    Number of buffers to output before sending EOS (-1 = unlimited)\n  typefind -> gboolean: Typefind\n    Run typefind before negotiating (deprecated, non-functional)\n  do-timestamp -> gboolean: Do timestamp\n    Apply current stream time to buffers\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstPushSrc (94858291185088)>'
    __info__ = ObjectInfo(PushSrc)
