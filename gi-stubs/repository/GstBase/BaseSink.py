...
class BaseSink(__gi_repository_Gst.Element):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9fb7c0dbe0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BaseSink), '__module__': 'gi.repository.GstBase', '__gtype__': <GType GstBaseSink (94858291223696)>, '__doc__': None, '__gsignals__': {}, 'do_preroll': gi.VFuncInfo(preroll), 'get_blocksize': gi.FunctionInfo(get_blocksize), 'get_drop_out_of_segment': gi.FunctionInfo(get_drop_out_of_segment), 'get_last_sample': gi.FunctionInfo(get_last_sample), 'get_latency': gi.FunctionInfo(get_latency), 'get_max_bitrate': gi.FunctionInfo(get_max_bitrate), 'get_max_lateness': gi.FunctionInfo(get_max_lateness), 'get_processing_deadline': gi.FunctionInfo(get_processing_deadline), 'get_render_delay': gi.FunctionInfo(get_render_delay), 'get_sync': gi.FunctionInfo(get_sync), 'get_throttle_time': gi.FunctionInfo(get_throttle_time), 'get_ts_offset': gi.FunctionInfo(get_ts_offset), 'is_async_enabled': gi.FunctionInfo(is_async_enabled), 'is_last_sample_enabled': gi.FunctionInfo(is_last_sample_enabled), 'is_qos_enabled': gi.FunctionInfo(is_qos_enabled), 'query_latency': gi.FunctionInfo(query_latency), 'set_async_enabled': gi.FunctionInfo(set_async_enabled), 'set_blocksize': gi.FunctionInfo(set_blocksize), 'set_drop_out_of_segment': gi.FunctionInfo(set_drop_out_of_segment), 'set_last_sample_enabled': gi.FunctionInfo(set_last_sample_enabled), 'set_max_bitrate': gi.FunctionInfo(set_max_bitrate), 'set_max_lateness': gi.FunctionInfo(set_max_lateness), 'set_processing_deadline': gi.FunctionInfo(set_processing_deadline), 'set_qos_enabled': gi.FunctionInfo(set_qos_enabled), 'set_render_delay': gi.FunctionInfo(set_render_delay), 'set_sync': gi.FunctionInfo(set_sync), 'set_throttle_time': gi.FunctionInfo(set_throttle_time), 'set_ts_offset': gi.FunctionInfo(set_ts_offset), 'wait': gi.FunctionInfo(wait), 'wait_clock': gi.FunctionInfo(wait_clock), 'wait_preroll': gi.FunctionInfo(wait_preroll), 'do_activate_pull': gi.VFuncInfo(activate_pull), 'do_event': gi.VFuncInfo(event), 'do_fixate': gi.VFuncInfo(fixate), 'do_get_caps': gi.VFuncInfo(get_caps), 'do_get_times': gi.VFuncInfo(get_times), 'do_prepare': gi.VFuncInfo(prepare), 'do_prepare_list': gi.VFuncInfo(prepare_list), 'do_propose_allocation': gi.VFuncInfo(propose_allocation), 'do_query': gi.VFuncInfo(query), 'do_render': gi.VFuncInfo(render), 'do_render_list': gi.VFuncInfo(render_list), 'do_set_caps': gi.VFuncInfo(set_caps), 'do_start': gi.VFuncInfo(start), 'do_stop': gi.VFuncInfo(stop), 'do_unlock': gi.VFuncInfo(unlock), 'do_unlock_stop': gi.VFuncInfo(unlock_stop), 'do_wait_event': gi.VFuncInfo(wait_event), 'element': <property object at 0x7f9fb7bbaef0>, 'sinkpad': <property object at 0x7f9fb7bbaf90>, 'pad_mode': <property object at 0x7f9fb7bbe0e0>, 'offset': <property object at 0x7f9fb7bbe1d0>, 'can_activate_pull': <property object at 0x7f9fb7bbe310>, 'can_activate_push': <property object at 0x7f9fb7bbe450>, 'preroll_lock': <property object at 0x7f9fb7bbe540>, 'preroll_cond': <property object at 0x7f9fb7bbe630>, 'eos': <property object at 0x7f9fb7bbe720>, 'need_preroll': <property object at 0x7f9fb7bbe810>, 'have_preroll': <property object at 0x7f9fb7bbe900>, 'playing_async': <property object at 0x7f9fb7bbe9f0>, 'have_newsegment': <property object at 0x7f9fb7bbeae0>, 'segment': <property object at 0x7f9fb7bbebd0>, 'clock_id': <property object at 0x7f9fb7bbecc0>, 'sync': <property object at 0x7f9fb7bbedb0>, 'flushing': <property object at 0x7f9fb7bbeea0>, 'running': <property object at 0x7f9fb7bbef90>, 'max_lateness': <property object at 0x7f9fb7bbf0e0>, 'priv': <property object at 0x7f9fb7bbf1d0>, '_gst_reserved': <property object at 0x7f9fb7bbf2c0>})"
    __gdoc__ = 'Object GstBaseSink\n\nProperties from GstBaseSink:\n  sync -> gboolean: Sync\n    Sync on the clock\n  max-lateness -> gint64: Max Lateness\n    Maximum number of nanoseconds that a buffer can be late before it is dropped (-1 unlimited)\n  qos -> gboolean: Qos\n    Generate Quality-of-Service events upstream\n  async -> gboolean: Async\n    Go asynchronously to PAUSED\n  ts-offset -> gint64: TS Offset\n    Timestamp offset in nanoseconds\n  enable-last-sample -> gboolean: Enable Last Buffer\n    Enable the last-sample property\n  blocksize -> guint: Block size\n    Size in bytes to pull per buffer (0 = default)\n  render-delay -> guint64: Render Delay\n    Additional render delay of the sink in nanoseconds\n  throttle-time -> guint64: Throttle time\n    The time to keep between rendered buffers (0 = disabled)\n  max-bitrate -> guint64: Max Bitrate\n    The maximum bits per second to render (0 = disabled)\n  processing-deadline -> guint64: Processing deadline\n    Maximum processing deadline in nanoseconds\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstBaseSink (94858291223696)>'
    __info__ = ObjectInfo(BaseSink)
