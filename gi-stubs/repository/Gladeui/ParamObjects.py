...
class ParamObjects(__gi_repository_GObject.ParamSpec):
    """
    :Constructors:
    
    ::
    
        ParamObjects(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamObjects), '__module__': 'gi.repository.Gladeui', '__gtype__': <GType GladeParamObjects (94653531129712)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GladeParamObjects (94653531129712)>'
    __info__ = ObjectInfo(ParamObjects)
