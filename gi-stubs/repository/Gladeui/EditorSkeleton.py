...
class EditorSkeleton(__gi_overrides_Gtk.Box, Editable):
    """
    :Constructors:
    
    ::
    
        EditorSkeleton(**properties)
        new() -> Gtk.Widget
    """
    ...
    def add_editor(self, editor): # real signature unknown; restored from __doc__
        """ add_editor(self, editor:Gladeui.Editable) """
        pass
