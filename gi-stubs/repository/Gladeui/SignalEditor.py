...
class SignalEditor(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        SignalEditor(**properties)
        new() -> Gladeui.SignalEditor
    """
    ...
    def enable_dnd(self, enabled): # real signature unknown; restored from __doc__
        """ enable_dnd(self, enabled:bool) """
        pass
