...
class AdaptorChooser(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        AdaptorChooser(**properties)
        new() -> Gtk.Widget
    """
