...
class PropertyShell(__gi_overrides_Gtk.Box, Editable):
    """
    :Constructors:
    
    ::
    
        PropertyShell(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_use_command(self): # real signature unknown; restored from __doc__
        """ get_use_command(self) -> bool """
        return False
    ...
    def set_use_command(self, use_command): # real signature unknown; restored from __doc__
        """ set_use_command(self, use_command:bool) """
        pass
