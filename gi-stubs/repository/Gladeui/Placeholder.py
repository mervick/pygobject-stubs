...
class Placeholder(__gi_overrides_Gtk.Widget, __gi_repository_Gtk.Scrollable):
    """
    :Constructors:
    ...
    def get_parent(self): # real signature unknown; restored from __doc__
        """ get_parent(self) -> Gladeui.Widget or None """
        pass
    ...
    def get_project(self): # real signature unknown; restored from __doc__
        """ get_project(self) -> Gladeui.Project or None """
        pass
    ...
    def packing_actions(self): # real signature unknown; restored from __doc__
        """ packing_actions(self) -> list """
        return []
