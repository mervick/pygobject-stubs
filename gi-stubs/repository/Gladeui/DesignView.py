...
class DesignView(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    ::
        ...
        new(project:Gladeui.Project) -> Gtk.Widget
    """
    ...
    def get_from_project(self, project): # real signature unknown; restored from __doc__
        """ get_from_project(project:Gladeui.Project) -> Gladeui.DesignView or None """
        pass
    ...
    def new(self, project): # real signature unknown; restored from __doc__
        """ new(project:Gladeui.Project) -> Gtk.Widget """
        pass
