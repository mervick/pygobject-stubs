...
class NamedIconChooserDialog(__gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    
    ::
    
        NamedIconChooserDialog(**properties)
    """
    ...
    def do_icon_activated(self, *args, **kwargs): # real signature unknown
        """ icon_activated(self) """
        pass
    ...
    def set_context(self, context): # real signature unknown; restored from __doc__
        """ set_context(self, context:str) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13415b3250>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
