...
class EditorTable(__gi_repository_Gtk.Grid, Editable):
    """
    :Constructors:
    
    ::
    
        EditorTable(**properties)
        new(adaptor:Gladeui.WidgetAdaptor, type:Gladeui.EditorPageType) -> Gtk.Widget
    """
    ...
    def new(self, adaptor, type): # real signature unknown; restored from __doc__
        """ new(adaptor:Gladeui.WidgetAdaptor, type:Gladeui.EditorPageType) -> Gtk.Widget """
        pass
