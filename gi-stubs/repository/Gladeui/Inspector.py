...
class Inspector(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    ::
        ...
        new() -> Gtk.Widget
        new_with_project(project:Gladeui.Project) -> Gtk.Widget
    """
    ...
    def new_with_project(self, project): # real signature unknown; restored from __doc__
        """ new_with_project(project:Gladeui.Project) -> Gtk.Widget """
        pass
