...
# from /usr/lib64/girepository-1.0/GExiv2-0.10.typelib
# by generator 1.147
"""
...
class LogLevel(__gobject.GEnum):
    ...
    WARN = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GExiv2', '__dict__': <attribute '__dict__' of 'LogLevel' objects>, '__doc__': None, '__gtype__': <GType GExiv2LogLevel (94474029885456)>, '__enum_values__': {0: <enum GEXIV2_LOG_LEVEL_DEBUG of type GExiv2.LogLevel>, 1: <enum GEXIV2_LOG_LEVEL_INFO of type GExiv2.LogLevel>, 2: <enum GEXIV2_LOG_LEVEL_WARN of type GExiv2.LogLevel>, 3: <enum GEXIV2_LOG_LEVEL_ERROR of type GExiv2.LogLevel>, 4: <enum GEXIV2_LOG_LEVEL_MUTE of type GExiv2.LogLevel>}, '__info__': gi.EnumInfo(LogLevel), 'DEBUG': <enum GEXIV2_LOG_LEVEL_DEBUG of type GExiv2.LogLevel>, 'INFO': <enum GEXIV2_LOG_LEVEL_INFO of type GExiv2.LogLevel>, 'WARN': <enum GEXIV2_LOG_LEVEL_WARN of type GExiv2.LogLevel>, 'ERROR': <enum GEXIV2_LOG_LEVEL_ERROR of type GExiv2.LogLevel>, 'MUTE': <enum GEXIV2_LOG_LEVEL_MUTE of type GExiv2.LogLevel>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType GExiv2LogLevel (94474029885456)>'
...
class Metadata(__gi_overrides_GObject.Object):
    ...
    def get_exif_tag_rational(self, tag): # real signature unknown; restored from __doc__
    ...
    def open_path(self, path): # real signature unknown; restored from __doc__
    ...
    def save_file(self, path): # real signature unknown; restored from __doc__
    ...
    def set_exif_tag_rational(self, tag, nom, den): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9140b59910>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Metadata), '__module__': 'gi.repository.GExiv2', '__gtype__': <GType GExiv2Metadata (94474030066704)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_tag_description': gi.FunctionInfo(get_tag_description), 'get_tag_label': gi.FunctionInfo(get_tag_label), 'get_tag_type': gi.FunctionInfo(get_tag_type), 'is_exif_tag': gi.FunctionInfo(is_exif_tag), 'is_iptc_tag': gi.FunctionInfo(is_iptc_tag), 'is_xmp_tag': gi.FunctionInfo(is_xmp_tag), 'register_xmp_namespace': gi.FunctionInfo(register_xmp_namespace), 'unregister_all_xmp_namespaces': gi.FunctionInfo(unregister_all_xmp_namespaces), 'unregister_xmp_namespace': gi.FunctionInfo(unregister_xmp_namespace), 'clear': gi.FunctionInfo(clear), 'clear_comment': gi.FunctionInfo(clear_comment), 'clear_exif': gi.FunctionInfo(clear_exif), 'clear_iptc': gi.FunctionInfo(clear_iptc), 'clear_tag': gi.FunctionInfo(clear_tag), 'clear_xmp': gi.FunctionInfo(clear_xmp), 'delete_gps_info': gi.FunctionInfo(delete_gps_info), 'erase_exif_thumbnail': gi.FunctionInfo(erase_exif_thumbnail), 'free': gi.FunctionInfo(free), 'from_app1_segment': gi.FunctionInfo(from_app1_segment), 'from_stream': gi.FunctionInfo(from_stream), 'generate_xmp_packet': gi.FunctionInfo(generate_xmp_packet), 'get_comment': gi.FunctionInfo(get_comment), 'get_exif_tag_rational': gi.FunctionInfo(get_exif_tag_rational), 'get_exif_tags': gi.FunctionInfo(get_exif_tags), 'get_exif_thumbnail': gi.FunctionInfo(get_exif_thumbnail), 'get_exposure_time': gi.FunctionInfo(get_exposure_time), 'get_fnumber': gi.FunctionInfo(get_fnumber), 'get_focal_length': gi.FunctionInfo(get_focal_length), 'get_gps_altitude': gi.FunctionInfo(get_gps_altitude), 'get_gps_info': gi.FunctionInfo(get_gps_info), 'get_gps_latitude': gi.FunctionInfo(get_gps_latitude), 'get_gps_longitude': gi.FunctionInfo(get_gps_longitude), 'get_iptc_tags': gi.FunctionInfo(get_iptc_tags), 'get_iso_speed': gi.FunctionInfo(get_iso_speed), 'get_metadata_pixel_height': gi.FunctionInfo(get_metadata_pixel_height), 'get_metadata_pixel_width': gi.FunctionInfo(get_metadata_pixel_width), 'get_mime_type': gi.FunctionInfo(get_mime_type), 'get_orientation': gi.FunctionInfo(get_orientation), 'get_pixel_height': gi.FunctionInfo(get_pixel_height), 'get_pixel_width': gi.FunctionInfo(get_pixel_width), 'get_preview_image': gi.FunctionInfo(get_preview_image), 'get_preview_properties': gi.FunctionInfo(get_preview_properties), 'get_supports_exif': gi.FunctionInfo(get_supports_exif), 'get_supports_iptc': gi.FunctionInfo(get_supports_iptc), 'get_supports_xmp': gi.FunctionInfo(get_supports_xmp), 'get_tag_interpreted_string': gi.FunctionInfo(get_tag_interpreted_string), 'get_tag_long': gi.FunctionInfo(get_tag_long), 'get_tag_multiple': gi.FunctionInfo(get_tag_multiple), 'get_tag_raw': gi.FunctionInfo(get_tag_raw), 'get_tag_string': gi.FunctionInfo(get_tag_string), 'get_xmp_packet': gi.FunctionInfo(get_xmp_packet), 'get_xmp_tags': gi.FunctionInfo(get_xmp_tags), 'has_exif': gi.FunctionInfo(has_exif), 'has_iptc': gi.FunctionInfo(has_iptc), 'has_tag': gi.FunctionInfo(has_tag), 'has_xmp': gi.FunctionInfo(has_xmp), 'open_buf': gi.FunctionInfo(open_buf), 'open_path': gi.FunctionInfo(open_path), 'save_external': gi.FunctionInfo(save_external), 'save_file': gi.FunctionInfo(save_file), 'set_comment': gi.FunctionInfo(set_comment), 'set_exif_tag_rational': gi.FunctionInfo(set_exif_tag_rational), 'set_exif_thumbnail_from_buffer': gi.FunctionInfo(set_exif_thumbnail_from_buffer), 'set_exif_thumbnail_from_file': gi.FunctionInfo(set_exif_thumbnail_from_file), 'set_gps_info': gi.FunctionInfo(set_gps_info), 'set_metadata_pixel_height': gi.FunctionInfo(set_metadata_pixel_height), 'set_metadata_pixel_width': gi.FunctionInfo(set_metadata_pixel_width), 'set_orientation': gi.FunctionInfo(set_orientation), 'set_tag_long': gi.FunctionInfo(set_tag_long), 'set_tag_multiple': gi.FunctionInfo(set_tag_multiple), 'set_tag_string': gi.FunctionInfo(set_tag_string), 'set_xmp_tag_struct': gi.FunctionInfo(set_xmp_tag_struct), 'update_gps_info': gi.FunctionInfo(update_gps_info), 'parent_instance': <property object at 0x7f9140b93e00>, 'priv': <property object at 0x7f9140b93e50>})"
    __gdoc__ = 'Object GExiv2Metadata\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GExiv2Metadata (94474030066704)>'
...
class MetadataClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MetadataClass), '__module__': 'gi.repository.GExiv2', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'MetadataClass' objects>, '__weakref__': <attribute '__weakref__' of 'MetadataClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f9140b93f40>})"
...
class Orientation(__gobject.GEnum):
    ...
    __gtype__ = None # (!) real value is '<GType GExiv2Orientation (94474030363568)>'
...
class PreviewImage(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9140b65be0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PreviewImage), '__module__': 'gi.repository.GExiv2', '__gtype__': <GType GExiv2PreviewImage (94474030360448)>, '__doc__': None, '__gsignals__': {}, 'free': gi.FunctionInfo(free), 'get_data': gi.FunctionInfo(get_data), 'get_extension': gi.FunctionInfo(get_extension), 'get_height': gi.FunctionInfo(get_height), 'get_mime_type': gi.FunctionInfo(get_mime_type), 'get_width': gi.FunctionInfo(get_width), 'write_file': gi.FunctionInfo(write_file), 'parent_instance': <property object at 0x7f9140b634a0>, 'priv': <property object at 0x7f9140b63590>})"
    __gdoc__ = 'Object GExiv2PreviewImage\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GExiv2PreviewImage (94474030360448)>'
...
class PreviewImageClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PreviewImageClass), '__module__': 'gi.repository.GExiv2', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'PreviewImageClass' objects>, '__weakref__': <attribute '__weakref__' of 'PreviewImageClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f9140b63720>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class PreviewProperties(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f9140b65e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PreviewProperties), '__module__': 'gi.repository.GExiv2', '__gtype__': <GType GExiv2PreviewProperties (94474030108800)>, '__doc__': None, '__gsignals__': {}, 'get_extension': gi.FunctionInfo(get_extension), 'get_height': gi.FunctionInfo(get_height), 'get_mime_type': gi.FunctionInfo(get_mime_type), 'get_size': gi.FunctionInfo(get_size), 'get_width': gi.FunctionInfo(get_width), 'parent_instance': <property object at 0x7f9140b63900>, 'priv': <property object at 0x7f9140b63a40>})"
    __gdoc__ = 'Object GExiv2PreviewProperties\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GExiv2PreviewProperties (94474030108800)>'
...
class PreviewPropertiesClass(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PreviewPropertiesClass), '__module__': 'gi.repository.GExiv2', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'PreviewPropertiesClass' objects>, '__weakref__': <attribute '__weakref__' of 'PreviewPropertiesClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f9140b63bd0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class StructureType(__gobject.GEnum):
    ...
    __gtype__ = None # (!) real value is '<GType GExiv2StructureType (94474029888608)>'
...
class XmpFormatFlags(__gobject.GFlags):
    ...
    __gtype__ = None # (!) real value is '<GType GExiv2XmpFormatFlags (94474030272064)>'
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7f9140da21f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7f9140da2280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7f9140da2310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7f9140da23a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7f91419ded00>'

__path__ = [
    '/usr/lib64/girepository-1.0/GExiv2-0.10.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.GExiv2', loader=<gi.importer.DynamicImporter object at 0x7f91419ded00>)"
