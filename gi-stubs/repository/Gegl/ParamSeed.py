...
class ParamSeed(__gi_repository_GObject.ParamSpecUInt):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSeed), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamSeed (94113950076096)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamSeed (94113950076096)>'
