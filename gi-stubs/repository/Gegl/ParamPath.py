...
class ParamPath(__gi_repository_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamPath), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamPath (94113949592096)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamPath (94113949592096)>'
