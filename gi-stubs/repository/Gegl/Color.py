...
class Color(__gi_overrides_GObject.Object):
    ...
    def get_components(self, format): # real signature unknown; restored from __doc__
        """ get_components(self, format:GObject.Value) -> list, components_length:int """
        return []
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f72398c0df0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Color), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglColor (94113949570192)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'duplicate': gi.FunctionInfo(duplicate), 'get_components': gi.FunctionInfo(get_components), 'get_format': gi.FunctionInfo(get_format), 'get_rgba': gi.FunctionInfo(get_rgba), 'set_components': gi.FunctionInfo(set_components), 'set_rgba': gi.FunctionInfo(set_rgba), 'parent_instance': <property object at 0x7f72398a13b0>, 'priv': <property object at 0x7f72398a14f0>})"
    __gdoc__ = 'Object GeglColor\n\nProperties from GeglColor:\n  string -> gchararray: String\n    A String representation of the GeglColor\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglColor (94113949570192)>'
