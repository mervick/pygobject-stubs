...
class ParamInt(__gi_repository_GObject.ParamSpecInt):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamInt), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamInt (94113949896784)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamInt (94113949896784)>'
