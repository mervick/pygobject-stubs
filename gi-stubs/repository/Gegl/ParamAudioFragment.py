...
class ParamAudioFragment(__gi_repository_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamAudioFragment), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamAudioFragment (94113949874288)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamAudioFragment (94113949874288)>'
