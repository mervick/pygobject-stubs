...
class ParamEnum(__gi_repository_GObject.ParamSpecEnum):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamEnum), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamEnum (94113949907760)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamEnum (94113949907760)>'
