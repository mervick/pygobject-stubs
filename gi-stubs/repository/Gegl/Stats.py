...
class Stats(__gi_overrides_GObject.Object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Stats), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglStats (94113950132896)>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglStats (94113950132896)>'
