...
class Processor(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f72398c0e20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Processor), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglProcessor (94113950110720)>, '__doc__': None, '__gsignals__': {}, 'get_buffer': gi.FunctionInfo(get_buffer), 'set_level': gi.FunctionInfo(set_level), 'set_rectangle': gi.FunctionInfo(set_rectangle), 'set_scale': gi.FunctionInfo(set_scale), 'work': gi.FunctionInfo(work)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglProcessor (94113950110720)>'
