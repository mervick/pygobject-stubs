...
class ParamUri(__gi_repository_GObject.ParamSpecString):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamUri), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamUri (94113950095632)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamUri (94113950095632)>'
