...
class ParamCurve(__gi_repository_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamCurve), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamCurve (94113949883760)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamCurve (94113949883760)>'
