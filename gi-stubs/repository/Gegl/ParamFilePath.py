...
class ParamFilePath(__gi_repository_GObject.ParamSpecString):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamFilePath), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamFilePath (94113949916240)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamFilePath (94113949916240)>'
