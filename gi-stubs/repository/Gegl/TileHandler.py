...
class TileHandler(TileSource):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f7239903190>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TileHandler), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglTileHandler (94113949587600)>, '__doc__': None, '__gsignals__': {}, 'damage_rect': gi.FunctionInfo(damage_rect), 'damage_tile': gi.FunctionInfo(damage_tile), 'lock': gi.FunctionInfo(lock), 'set_source': gi.FunctionInfo(set_source), 'unlock': gi.FunctionInfo(unlock), 'parent_instance': <property object at 0x7f723989e4f0>, 'source': <property object at 0x7f723989e5e0>, 'priv': <property object at 0x7f723989e6d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglTileHandler (94113949587600)>'
