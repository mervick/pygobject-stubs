...
class ParamFormat(__gi_repository_GObject.ParamSpecPointer):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamFormat), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamFormat (94113949916528)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamFormat (94113949916528)>'
