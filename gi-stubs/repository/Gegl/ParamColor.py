...
class ParamColor(__gi_repository_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamColor), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamColor (94113949883488)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamColor (94113949883488)>'
