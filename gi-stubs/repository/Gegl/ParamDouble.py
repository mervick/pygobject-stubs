...
class ParamDouble(__gi_repository_GObject.ParamSpecDouble):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamDouble), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamDouble (94113949899936)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamDouble (94113949899936)>'
