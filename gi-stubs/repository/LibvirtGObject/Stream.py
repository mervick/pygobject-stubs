...
class Stream(__gi_repository_Gio.IOStream):
    """
    :Constructors:
    ...
    ::
        ...
        Stream(**properties)
    """
    def add_watch(self, priority, cond, func, opaque=None): # real signature unknown; restored from __doc__
        """ add_watch(self, priority:int, cond:LibvirtGObject.StreamIOCondition, func:LibvirtGObject.StreamIOFunc, opaque=None) -> int """
        return 0
    ...
    def receive_all(self, cancellable=None, func, user_data=None): # real signature unknown; restored from __doc__
        """ receive_all(self, cancellable:Gio.Cancellable=None, func:LibvirtGObject.StreamSinkFunc, user_data=None) -> int """
        return 0
    ...
    def send(self, buffer, size, cancellable=None): # real signature unknown; restored from __doc__
        """ send(self, buffer:str, size:int, cancellable:Gio.Cancellable=None) -> int """
        return 0

    def send_all(self, cancellable=None, func, user_data=None): # real signature unknown; restored from __doc__
        """ send_all(self, cancellable:Gio.Cancellable=None, func:LibvirtGObject.StreamSourceFunc, user_data=None) -> int """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7ffa6e2b1520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Stream), '__module__': 'gi.repository.LibvirtGObject', '__gtype__': <GType GVirStream (94394875907936)>, '__doc__': None, '__gsignals__': {}, 'add_watch': gi.FunctionInfo(add_watch), 'receive': gi.FunctionInfo(receive), 'receive_all': gi.FunctionInfo(receive_all), 'send': gi.FunctionInfo(send), 'send_all': gi.FunctionInfo(send_all), 'parent_instance': <property object at 0x7ffa6e34a900>, 'priv': <property object at 0x7ffa6e34a9f0>})"
    __gdoc__ = 'Object GVirStream\n\nProperties from GVirStream:\n  handle -> GVirStreamHandle: Handle\n    The stream handle\n\nProperties from GIOStream:\n  input-stream -> GInputStream: Input stream\n    The GInputStream to read from\n  output-stream -> GOutputStream: Output stream\n    The GOutputStream to write to\n  closed -> gboolean: Closed\n    Is the stream closed\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirStream (94394875907936)>'
