...
class UnixSession(__gi_overrides_GObject.Object, __gi_repository_Gio.AsyncInitable, __gi_repository_Gio.Initable, Subject):
    """
    :Constructors:
    
    ::
    
        UnixSession(**properties)
    """
    ...
    def new(self, session_id): # real signature unknown; restored from __doc__
        """ new(session_id:str) -> Polkit.Subject """
        pass
    ...
    def new_for_process(self, pid, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ new_for_process(pid:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def new_for_process_finish(self, res): # real signature unknown; restored from __doc__
        """ new_for_process_finish(res:Gio.AsyncResult) -> Polkit.Subject or None """
        pass

    def new_for_process_sync(self, pid, cancellable=None): # real signature unknown; restored from __doc__
        """ new_for_process_sync(pid:int, cancellable:Gio.Cancellable=None) -> Polkit.Subject or None """
        pass
    ...
    def set_session_id(self, session_id): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f982701be50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UnixSession), '__module__': 'gi.repository.Polkit', '__gtype__': <GType PolkitUnixSession (94810843284016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_process': gi.FunctionInfo(new_for_process), 'new_for_process_finish': gi.FunctionInfo(new_for_process_finish), 'new_for_process_sync': gi.FunctionInfo(new_for_process_sync), 'get_session_id': gi.FunctionInfo(get_session_id), 'set_session_id': gi.FunctionInfo(set_session_id)})"
    __gdoc__ = 'Object PolkitUnixSession\n\nProperties from PolkitUnixSession:\n  session-id -> gchararray: Session ID\n    The UNIX session ID\n  pid -> gint: Process ID\n    Process ID to use for looking up the session\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType PolkitUnixSession (94810843284016)>'
    __info__ = ObjectInfo(UnixSession)
