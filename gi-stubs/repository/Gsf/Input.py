...
class Input(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    def read(self, num_bytes): # real signature unknown; restored from __doc__
        """ read(self, num_bytes:int) -> list, bytes_read:int """
        return []
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c4751f70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Input), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInput (94877076741104)>, '__doc__': None, '__gsignals__': {}, 'mmap_new': gi.FunctionInfo(mmap_new), 'error_id': gi.FunctionInfo(error_id), 'container': <property object at 0x7f95c4993450>, 'copy': gi.FunctionInfo(copy), 'dump': gi.FunctionInfo(dump), 'dup': gi.FunctionInfo(dup), 'eof': gi.FunctionInfo(eof), 'find_vba': gi.FunctionInfo(find_vba), 'get_modtime': gi.FunctionInfo(get_modtime), 'name': <property object at 0x7f95c4993360>, 'read': gi.FunctionInfo(read), 'remaining': gi.FunctionInfo(remaining), 'seek': gi.FunctionInfo(seek), 'seek_emulate': gi.FunctionInfo(seek_emulate), 'set_container': gi.FunctionInfo(set_container), 'set_modtime': gi.FunctionInfo(set_modtime), 'set_modtime_from_stat': gi.FunctionInfo(set_modtime_from_stat), 'set_name': gi.FunctionInfo(set_name), 'set_name_from_filename': gi.FunctionInfo(set_name_from_filename), 'set_size': gi.FunctionInfo(set_size), 'sibling': gi.FunctionInfo(sibling), 'size': <property object at 0x7f95c4993180>, 'tell': gi.FunctionInfo(tell), 'uncompress': gi.FunctionInfo(uncompress), 'do_Dup': gi.VFuncInfo(Dup), 'do_OpenSibling': gi.VFuncInfo(OpenSibling), 'do_Seek': gi.VFuncInfo(Seek), 'g_object': <property object at 0x7f95c4993090>, 'cur_offset': <property object at 0x7f95c4993270>})"
    __gdoc__ = "Object GsfInput\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInput (94877076741104)>'
    __info__ = ObjectInfo(Input)
