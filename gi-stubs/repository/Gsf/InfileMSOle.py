...
class InfileMSOle(Infile):
    """
    :Constructors:
    
    ::
    
        InfileMSOle(**properties)
        new(source:Gsf.Input) -> Gsf.Infile
    """
    ...
    def get_class_id(self, res): # real signature unknown; restored from __doc__
        """ get_class_id(self, res:int) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c4751280>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InfileMSOle), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInfileMSOle (94877076694224)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_class_id': gi.FunctionInfo(get_class_id)})"
    __gdoc__ = "Object GsfInfileMSOle\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInfileMSOle (94877076694224)>'
    __info__ = ObjectInfo(InfileMSOle)
