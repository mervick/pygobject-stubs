...
class InputProxy(Input):
    ...
    ::
        ...
        InputProxy(**properties)
        new(source:Gsf.Input) -> Gsf.Input
        new_section(source:Gsf.Input, offset:int, size:int) -> Gsf.Input
    """
    ...
    def new_section(self, source, offset, size): # real signature unknown; restored from __doc__
        """ new_section(source:Gsf.Input, offset:int, size:int) -> Gsf.Input """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c47276a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputProxy), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInputProxy (94877076812736)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_section': gi.FunctionInfo(new_section)})"
    __gdoc__ = "Object GsfInputProxy\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInputProxy (94877076812736)>'
    __info__ = ObjectInfo(InputProxy)
