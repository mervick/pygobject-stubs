...
class InputHTTP(Input):
    """
    :Constructors:
    
    ::
    
        InputHTTP(**properties)
        new(url:str) -> Gsf.Input
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c47518e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputHTTP), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInputHTTP (94877076796416)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_content_type': gi.FunctionInfo(get_content_type), 'get_url': gi.FunctionInfo(get_url)})"
    __gdoc__ = "Object GsfInputHTTP\n\nProperties from GsfInputHTTP:\n  url -> gchararray: URL\n    HTTP URL accessed by this stream\n  content-type -> gchararray: mime type\n    Content-Type in HTTP header\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInputHTTP (94877076796416)>'
    __info__ = ObjectInfo(InputHTTP)
