...
class InputMemory(Input):
    """
    :Constructors:
    
    ::
    
        InputMemory(**properties)
        new(buf:list, needs_free:bool) -> Gsf.Input
        new_clone(buf:list) -> Gsf.Input
        new_from_bzip(source:Gsf.Input) -> Gsf.Input
        new_from_iochannel(channel:GLib.IOChannel) -> Gsf.Input
    """
    ...
    def new(self, buf, needs_free): # real signature unknown; restored from __doc__
        """ new(buf:list, needs_free:bool) -> Gsf.Input """
        pass
    ...
    def new_clone(self, buf): # real signature unknown; restored from __doc__
        """ new_clone(buf:list) -> Gsf.Input """
        pass

    def new_from_bzip(self, source): # real signature unknown; restored from __doc__
        """ new_from_bzip(source:Gsf.Input) -> Gsf.Input """
        pass

    def new_from_iochannel(self, channel): # real signature unknown; restored from __doc__
        """ new_from_iochannel(channel:GLib.IOChannel) -> Gsf.Input """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c47272b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputMemory), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInputMemory (94877076804256)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_clone': gi.FunctionInfo(new_clone), 'new_from_bzip': gi.FunctionInfo(new_from_bzip), 'new_from_iochannel': gi.FunctionInfo(new_from_iochannel)})"
    __gdoc__ = "Object GsfInputMemory\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInputMemory (94877076804256)>'
    __info__ = ObjectInfo(InputMemory)
