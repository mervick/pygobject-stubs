...
class InfileTar(Infile):
    """
    :Constructors:
    
    ::
    
        InfileTar(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c4751a60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InfileTar), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInfileTar (94877076770816)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    __gdoc__ = "Object GsfInfileTar\n\nProperties from GsfInfileTar:\n  source -> GsfInput: Source\n    The archive being interpreted\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInfileTar (94877076770816)>'
    __info__ = ObjectInfo(InfileTar)
