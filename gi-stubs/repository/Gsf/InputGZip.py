...
class InputGZip(Input):
    """
    :Constructors:
    
    ::
    
        InputGZip(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c47449d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputGZip), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInputGZip (94877076780160)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new)})"
    __gdoc__ = "Object GsfInputGZip\n\nProperties from GsfInputGZip:\n  raw -> gboolean: Raw\n    Whether to read compressed data with no header and no trailer\n  source -> GsfInput: Source\n    Where the compressed data comes from\n  uncompressed-size -> gint64: Size after decompression\n    The source's uncompressed size\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInputGZip (94877076780160)>'
    __info__ = ObjectInfo(InputGZip)
