...
class InputStdio(Input):
    """
    :Constructors:
    
    ::
    
        InputStdio(**properties)
        new(filename:str) -> Gsf.Input
        new_FILE(filename:str, file=None, keep_open:bool) -> Gsf.Input
    """
    ...
    def new_FILE(self, filename, file=None, keep_open): # real signature unknown; restored from __doc__
        """ new_FILE(filename:str, file=None, keep_open:bool) -> Gsf.Input """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c4727850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputStdio), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInputStdio (94877076812992)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_FILE': gi.FunctionInfo(new_FILE)})"
    __gdoc__ = "Object GsfInputStdio\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInputStdio (94877076812992)>'
    __info__ = ObjectInfo(InputStdio)
