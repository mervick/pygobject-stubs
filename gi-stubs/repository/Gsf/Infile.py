...
class Infile(Input):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c4751220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Infile), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInfile (94877076498384)>, '__doc__': None, '__gsignals__': {}, 'child_by_aname': gi.FunctionInfo(child_by_aname), 'child_by_index': gi.FunctionInfo(child_by_index), 'child_by_name': gi.FunctionInfo(child_by_name), 'name_by_index': gi.FunctionInfo(name_by_index), 'num_children': gi.FunctionInfo(num_children), 'do_name_by_index': gi.VFuncInfo(name_by_index), 'do_num_children': gi.VFuncInfo(num_children), 'parent': <property object at 0x7f95c4993630>})"
    __gdoc__ = "Object GsfInfile\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInfile (94877076498384)>'
    __info__ = ObjectInfo(Infile)
