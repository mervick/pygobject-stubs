...
class InputGio(Input):
    ...
    ::
        ...
        InputGio(**properties)
        new(file:Gio.File) -> Gsf.Input
        new_for_path(path:str) -> Gsf.Input
        new_for_uri(uri:str) -> Gsf.Input
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c4751880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputGio), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInputGio (94877076796128)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_for_path': gi.FunctionInfo(new_for_path), 'new_for_uri': gi.FunctionInfo(new_for_uri)})"
    __gdoc__ = "Object GsfInputGio\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInputGio (94877076796128)>'
    __info__ = ObjectInfo(InputGio)
