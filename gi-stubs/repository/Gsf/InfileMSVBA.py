...
class InfileMSVBA(Infile):
    """
    :Constructors:
    
    ::
    
        InfileMSVBA(**properties)
        new(source:Gsf.Infile) -> Gsf.Infile
    """
    ...
    def get_modules(self): # real signature unknown; restored from __doc__
        """ get_modules(self) -> dict or None """
        return {}
    ...
    def steal_modules(self): # real signature unknown; restored from __doc__
        """ steal_modules(self) -> dict or None """
        return {}
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c4966610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InfileMSVBA), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInfileMSVBA (94877075678304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_modules': gi.FunctionInfo(get_modules), 'steal_modules': gi.FunctionInfo(steal_modules)})"
    __gdoc__ = "Object GsfInfileMSVBA\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInfileMSVBA (94877075678304)>'
    __info__ = ObjectInfo(InfileMSVBA)
