...
class InputTextline(Input):
    """
    :Constructors:
    
    ::
    
        InputTextline(**properties)
        new(source:Gsf.Input) -> Gsf.Input or None
    """
    def ascii_gets(self): # real signature unknown; restored from __doc__
        """ ascii_gets(self) -> list or None """
        return []
    ...
    def utf8_gets(self): # real signature unknown; restored from __doc__
        """ utf8_gets(self) -> list or None """
        return []
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f95c49dddc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InputTextline), '__module__': 'gi.repository.Gsf', '__gtype__': <GType GsfInputTextline (94877076793232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'ascii_gets': gi.FunctionInfo(ascii_gets), 'utf8_gets': gi.FunctionInfo(utf8_gets)})"
    __gdoc__ = "Object GsfInputTextline\n\nProperties from GsfInput:\n  name -> gchararray: Name\n    The input's name\n  size -> gint64: Size\n    The input's size\n  eof -> gboolean: EOF\n    End of file\n  remaining -> gint64: Remaining\n    Amount of data remaining\n  position -> gint64: Position\n    The input's current position\n  modtime -> GDateTime: Modification time\n    An optional GDateTime representing the time the input was last changed\n  container -> GsfInfile: Container\n    The parent GsfInfile\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GsfInputTextline (94877076793232)>'
    __info__ = ObjectInfo(InputTextline)
