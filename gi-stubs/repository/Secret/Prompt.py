...
class Prompt(__gi_overrides_Gio.DBusProxy):
    """
    :Constructors:
    ...
    def perform(self, window_id=None, return_type, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ perform(self, window_id:str=None, return_type:GLib.VariantType, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def perform_finish(self, result): # real signature unknown; restored from __doc__
        """ perform_finish(self, result:Gio.AsyncResult) -> GLib.Variant """
        pass

    def perform_sync(self, window_id=None, cancellable=None, return_type): # real signature unknown; restored from __doc__
        """ perform_sync(self, window_id:str=None, cancellable:Gio.Cancellable=None, return_type:GLib.VariantType) -> GLib.Variant """
        pass
    ...
    def run(self, window_id=None, cancellable=None, return_type): # real signature unknown; restored from __doc__
        """ run(self, window_id:str=None, cancellable:Gio.Cancellable=None, return_type:GLib.VariantType) -> GLib.Variant """
        pass
