...
class Item(__gi_overrides_Gio.DBusProxy, Retrievable):
    """
    :Constructors:
    ...
    def create(self, collection, schema=None, attributes, label, value, flags, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ create(collection:Secret.Collection, schema:Secret.Schema=None, attributes:dict, label:str, value:Secret.Value, flags:Secret.ItemCreateFlags, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def create_finish(self, result): # real signature unknown; restored from __doc__
        """ create_finish(result:Gio.AsyncResult) -> Secret.Item """
        pass

    def create_sync(self, collection, schema=None, attributes, label, value, flags, cancellable=None): # real signature unknown; restored from __doc__
        """ create_sync(collection:Secret.Collection, schema:Secret.Schema=None, attributes:dict, label:str, value:Secret.Value, flags:Secret.ItemCreateFlags, cancellable:Gio.Cancellable=None) -> Secret.Item """
        pass

    def delete(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ delete(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def delete_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ delete_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def get_flags(self): # real signature unknown; restored from __doc__
        """ get_flags(self) -> Secret.ItemFlags """
        pass
    ...
    def get_schema_name(self): # real signature unknown; restored from __doc__
        """ get_schema_name(self) -> str or None """
        return ""

    def get_secret(self): # real signature unknown; restored from __doc__
        """ get_secret(self) -> Secret.Value or None """
        pass

    def get_service(self): # real signature unknown; restored from __doc__
        """ get_service(self) -> Secret.Service """
        pass
    ...
    def load_secret(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ load_secret(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def load_secrets(self, items, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ load_secrets(items:list, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def load_secrets_finish(self, result): # real signature unknown; restored from __doc__
        """ load_secrets_finish(result:Gio.AsyncResult) -> bool """
        return False

    def load_secrets_sync(self, items, cancellable=None): # real signature unknown; restored from __doc__
        """ load_secrets_sync(items:list, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def load_secret_finish(self, result): # real signature unknown; restored from __doc__
        """ load_secret_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def load_secret_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ load_secret_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def set_attributes(self, schema=None, attributes, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ set_attributes(self, schema:Secret.Schema=None, attributes:dict, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def set_attributes_finish(self, result): # real signature unknown; restored from __doc__
        """ set_attributes_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def set_attributes_sync(self, schema=None, attributes, cancellable=None): # real signature unknown; restored from __doc__
        """ set_attributes_sync(self, schema:Secret.Schema=None, attributes:dict, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def set_label(self, label, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ set_label(self, label:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def set_label_finish(self, result): # real signature unknown; restored from __doc__
        """ set_label_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def set_label_sync(self, label, cancellable=None): # real signature unknown; restored from __doc__
        """ set_label_sync(self, label:str, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    def set_secret(self, value, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ set_secret(self, value:Secret.Value, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def set_secret_finish(self, result): # real signature unknown; restored from __doc__
        """ set_secret_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def set_secret_sync(self, value, cancellable=None): # real signature unknown; restored from __doc__
        """ set_secret_sync(self, value:Secret.Value, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa0c59595b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Item), '__module__': 'gi.repository.Secret', '__gtype__': <GType SecretItem (93972239429472)>, '__doc__': None, '__gsignals__': {}, 'create': gi.FunctionInfo(create), 'create_finish': gi.FunctionInfo(create_finish), 'create_sync': gi.FunctionInfo(create_sync), 'load_secrets': gi.FunctionInfo(load_secrets), 'load_secrets_finish': gi.FunctionInfo(load_secrets_finish), 'load_secrets_sync': gi.FunctionInfo(load_secrets_sync), 'delete': gi.FunctionInfo(delete), 'delete_finish': gi.FunctionInfo(delete_finish), 'delete_sync': gi.FunctionInfo(delete_sync), 'get_attributes': gi.FunctionInfo(get_attributes), 'get_created': gi.FunctionInfo(get_created), 'get_flags': gi.FunctionInfo(get_flags), 'get_label': gi.FunctionInfo(get_label), 'get_locked': gi.FunctionInfo(get_locked), 'get_modified': gi.FunctionInfo(get_modified), 'get_schema_name': gi.FunctionInfo(get_schema_name), 'get_secret': gi.FunctionInfo(get_secret), 'get_service': gi.FunctionInfo(get_service), 'load_secret': gi.FunctionInfo(load_secret), 'load_secret_finish': gi.FunctionInfo(load_secret_finish), 'load_secret_sync': gi.FunctionInfo(load_secret_sync), 'refresh': gi.FunctionInfo(refresh), 'set_attributes': gi.FunctionInfo(set_attributes), 'set_attributes_finish': gi.FunctionInfo(set_attributes_finish), 'set_attributes_sync': gi.FunctionInfo(set_attributes_sync), 'set_label': gi.FunctionInfo(set_label), 'set_label_finish': gi.FunctionInfo(set_label_finish), 'set_label_sync': gi.FunctionInfo(set_label_sync), 'set_secret': gi.FunctionInfo(set_secret), 'set_secret_finish': gi.FunctionInfo(set_secret_finish), 'set_secret_sync': gi.FunctionInfo(set_secret_sync), 'parent_instance': <property object at 0x7fa0c5979720>, 'pv': <property object at 0x7fa0c5979810>})"
    __gdoc__ = 'Object SecretItem\n\nProperties from SecretItem:\n  service -> SecretService: Service\n    Secret Service\n  flags -> SecretItemFlags: Flags\n    Item flags\n  locked -> gboolean: Locked\n    Item locked\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SecretItem (93972239429472)>'
