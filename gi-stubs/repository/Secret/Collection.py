...
class Collection(__gi_overrides_Gio.DBusProxy):
    """
    :Constructors:
    ...
    def create(self, service=None, label, alias=None, flags, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ create(service:Secret.Service=None, label:str, alias:str=None, flags:Secret.CollectionCreateFlags, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def create_finish(self, result): # real signature unknown; restored from __doc__
        """ create_finish(result:Gio.AsyncResult) -> Secret.Collection """
        pass

    def create_sync(self, service=None, label, alias=None, flags, cancellable=None): # real signature unknown; restored from __doc__
        """ create_sync(service:Secret.Service=None, label:str, alias:str=None, flags:Secret.CollectionCreateFlags, cancellable:Gio.Cancellable=None) -> Secret.Collection """
        pass
    ...
    def for_alias(self, service=None, alias, flags, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ for_alias(service:Secret.Service=None, alias:str, flags:Secret.CollectionFlags, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def for_alias_finish(self, result): # real signature unknown; restored from __doc__
        """ for_alias_finish(result:Gio.AsyncResult) -> Secret.Collection """
        pass

    def for_alias_sync(self, service=None, alias, flags, cancellable=None): # real signature unknown; restored from __doc__
        """ for_alias_sync(service:Secret.Service=None, alias:str, flags:Secret.CollectionFlags, cancellable:Gio.Cancellable=None) -> Secret.Collection """
        pass
    ...
    def get_flags(self): # real signature unknown; restored from __doc__
        """ get_flags(self) -> Secret.CollectionFlags """
        pass
    ...
    def load_items(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ load_items(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def load_items_finish(self, result): # real signature unknown; restored from __doc__
        """ load_items_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def load_items_sync(self, cancellable=None): # real signature unknown; restored from __doc__
        """ load_items_sync(self, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa0c59863a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Collection), '__module__': 'gi.repository.Secret', '__gtype__': <GType SecretCollection (93972239779440)>, '__doc__': None, '__gsignals__': {}, 'create': gi.FunctionInfo(create), 'create_finish': gi.FunctionInfo(create_finish), 'create_sync': gi.FunctionInfo(create_sync), 'for_alias': gi.FunctionInfo(for_alias), 'for_alias_finish': gi.FunctionInfo(for_alias_finish), 'for_alias_sync': gi.FunctionInfo(for_alias_sync), 'delete': gi.FunctionInfo(delete), 'delete_finish': gi.FunctionInfo(delete_finish), 'delete_sync': gi.FunctionInfo(delete_sync), 'get_created': gi.FunctionInfo(get_created), 'get_flags': gi.FunctionInfo(get_flags), 'get_items': gi.FunctionInfo(get_items), 'get_label': gi.FunctionInfo(get_label), 'get_locked': gi.FunctionInfo(get_locked), 'get_modified': gi.FunctionInfo(get_modified), 'get_service': gi.FunctionInfo(get_service), 'load_items': gi.FunctionInfo(load_items), 'load_items_finish': gi.FunctionInfo(load_items_finish), 'load_items_sync': gi.FunctionInfo(load_items_sync), 'refresh': gi.FunctionInfo(refresh), 'search': gi.FunctionInfo(search), 'search_finish': gi.FunctionInfo(search_finish), 'search_sync': gi.FunctionInfo(search_sync), 'set_label': gi.FunctionInfo(set_label), 'set_label_finish': gi.FunctionInfo(set_label_finish), 'set_label_sync': gi.FunctionInfo(set_label_sync), 'parent': <property object at 0x7fa0c59b6810>, 'pv': <property object at 0x7fa0c59b6900>})"
    __gdoc__ = 'Object SecretCollection\n\nProperties from SecretCollection:\n  service -> SecretService: Service\n    Secret Service\n  flags -> SecretCollectionFlags: Flags\n    Collection flags\n  items -> SecretObjectList: Items\n    Items in collection\n  label -> gchararray: Label\n    Item label\n  locked -> gboolean: Locked\n    Item locked\n  created -> guint64: Created\n    Item creation date\n  modified -> guint64: Modified\n    Item modified date\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType SecretCollection (93972239779440)>'
    __info__ = ObjectInfo(Collection)
