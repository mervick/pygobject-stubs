# encoding: utf-8
# module gi.repository.RygelRendererGst
# from /usr/lib64/girepository-1.0/RygelRendererGst-2.6.typelib
# by generator 1.147
"""
...
import gi.repository.RygelRenderer as __gi_repository_RygelRenderer
import gobject as __gobject


# Variables with simple values

_namespace = 'RygelRendererGst'
...
class PlaybinPlayer(__gi_overrides_GObject.Object, __gi_repository_RygelRenderer.MediaPlayer):
    """
    :Constructors:
    
    ::
    
        PlaybinPlayer(**properties)
    """
    ...
    def get_playbin(self): # real signature unknown; restored from __doc__
        """ get_playbin(self) -> Gst.Element """
        pass
    ...
    def instance(self): # real signature unknown; restored from __doc__
        """ instance() -> RygelRendererGst.PlaybinPlayer """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fae0ccc58e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PlaybinPlayer), '__module__': 'gi.repository.RygelRendererGst', '__gtype__': <GType RygelPlaybinPlayer (94597091424368)>, '__doc__': None, '__gsignals__': {}, 'instance': gi.FunctionInfo(instance), 'get_playbin': gi.FunctionInfo(get_playbin), 'get_supported_profiles': gi.FunctionInfo(get_supported_profiles), 'parent_instance': <property object at 0x7fae0ccf65e0>, 'priv': <property object at 0x7fae0ccf66d0>})"
    __gdoc__ = 'Object RygelPlaybinPlayer\n\nProperties from RygelPlaybinPlayer:\n  playbin -> GstElement: playbin\n    playbin\n  playback-state -> gchararray: playback-state\n    playback-state\n  allowed-playback-speeds -> GStrv: allowed-playback-speeds\n    allowed-playback-speeds\n  playback-speed -> gchararray: playback-speed\n    playback-speed\n  uri -> gchararray: uri\n    uri\n  mime-type -> gchararray: mime-type\n    mime-type\n  metadata -> gchararray: metadata\n    metadata\n  can-seek -> gboolean: can-seek\n    can-seek\n  can-seek-bytes -> gboolean: can-seek-bytes\n    can-seek-bytes\n  user-agent -> gchararray: user-agent\n    user-agent\n  content-features -> gchararray: content-features\n    content-features\n  volume -> gdouble: volume\n    volume\n  duration -> gint64: duration\n    duration\n  size -> gint64: size\n    size\n  position -> gint64: position\n    position\n  byte-position -> gint64: byte-position\n    byte-position\n  supported-profiles -> gpointer: supported-profiles\n    supported-profiles\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelPlaybinPlayer (94597091424368)>'
    __info__ = ObjectInfo(PlaybinPlayer)


class PlaybinPlayerClass(__gi.Struct):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PlaybinPlayerClass), '__module__': 'gi.repository.RygelRendererGst', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'PlaybinPlayerClass' objects>, '__weakref__': <attribute '__weakref__' of 'PlaybinPlayerClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fae0cda04a0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(PlaybinPlayerClass)


class PlaybinPlayerPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PlaybinPlayerPrivate), '__module__': 'gi.repository.RygelRendererGst', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'PlaybinPlayerPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'PlaybinPlayerPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(PlaybinPlayerPrivate)


class PlaybinRenderer(__gi_repository_RygelRenderer.MediaRenderer):
    """
    :Constructors:
    
    ::
    
        PlaybinRenderer(**properties)
        new(title:str) -> RygelRendererGst.PlaybinRenderer
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fae0ccbc730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PlaybinRenderer), '__module__': 'gi.repository.RygelRendererGst', '__gtype__': <GType RygelPlaybinRenderer (94597091531712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_playbin': gi.FunctionInfo(get_playbin), 'parent_instance': <property object at 0x7fae0ccca0e0>, 'priv': <property object at 0x7fae0ccca220>})"
    __gdoc__ = 'Object RygelPlaybinRenderer\n\nProperties from RygelMediaRenderer:\n  player -> RygelMediaPlayer: player\n    player\n\nProperties from RygelMediaDevice:\n  plugin -> RygelPlugin: plugin\n    plugin\n  title -> gchararray: title\n    title\n  capabilities -> RygelPluginCapabilities: capabilities\n    capabilities\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelPlaybinRenderer (94597091531712)>'
    __info__ = ObjectInfo(PlaybinRenderer)


class PlaybinRendererClass(__gi.Struct):
    """
    :Constructors:
    
    ::
    
        PlaybinRendererClass()
    """
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PlaybinRendererClass), '__module__': 'gi.repository.RygelRendererGst', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'PlaybinRendererClass' objects>, '__weakref__': <attribute '__weakref__' of 'PlaybinRendererClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7fae0ccca3b0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(PlaybinRendererClass)


class PlaybinRendererPrivate(__gi.Struct):
    # no doc
    def __delattr__(self, *args, **kwargs): # real signature unknown
        """ Implement delattr(self, name). """
        pass
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PlaybinRendererPrivate), '__module__': 'gi.repository.RygelRendererGst', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'PlaybinRendererPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'PlaybinRendererPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(PlaybinRendererPrivate)


class PlayerError(__gobject.GEnum):
    # no doc
    ...
    NO_ELEMENT = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.RygelRendererGst', '__dict__': <attribute '__dict__' of 'PlayerError' objects>, '__doc__': None, '__gtype__': <GType PyRygelRendererGstPlayerError (94597091540944)>, '__enum_values__': {0: <enum RYGEL_PLAYBIN_PLAYER_ERROR_NO_ELEMENT of type RygelRendererGst.PlayerError>}, '__info__': gi.EnumInfo(PlayerError), 'NO_ELEMENT': <enum RYGEL_PLAYBIN_PLAYER_ERROR_NO_ELEMENT of type RygelRendererGst.PlayerError>})"
    __enum_values__ = {
        0: 0,
    }
    __gtype__ = None # (!) real value is '<GType PyRygelRendererGstPlayerError (94597091540944)>'
    __info__ = gi.EnumInfo(PlayerError)
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7fae0cf781f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7fae0cf78280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7fae0cf78310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7fae0cf783a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7fae0dbb4d00>'

__path__ = [
    '/usr/lib64/girepository-1.0/RygelRendererGst-2.6.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.RygelRendererGst', loader=<gi.importer.DynamicImporter object at 0x7fae0dbb4d00>)"
