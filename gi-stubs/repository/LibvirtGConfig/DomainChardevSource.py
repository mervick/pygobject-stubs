...
class DomainChardevSource(Object):
    """
    :Constructors:
    
    ::
    
        DomainChardevSource(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf13dac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainChardevSource), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainChardevSource (94643613126016)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7fa8bf3c4770>, 'priv': <property object at 0x7fa8bf3c4860>})"
    __gdoc__ = 'Object GVirConfigDomainChardevSource\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainChardevSource (94643613126016)>'
    __info__ = ObjectInfo(DomainChardevSource)
