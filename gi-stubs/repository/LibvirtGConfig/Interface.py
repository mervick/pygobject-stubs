...
class Interface(Object):
    ...
    ::
        ...
        new() -> LibvirtGConfig.Interface
        new_from_xml(xml:str) -> LibvirtGConfig.Interface
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bec8ab50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Interface), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigInterface (94643613981392)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'parent': <property object at 0x7fa8bf1b1ae0>, 'priv': <property object at 0x7fa8bf1b1bd0>})"
    __gdoc__ = 'Object GVirConfigInterface\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigInterface (94643613981392)>'
