...
class DomainController(DomainDevice):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainController), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainController (94643613474288)>, '__doc__': None, '__gsignals__': {}, 'get_index': gi.FunctionInfo(get_index), 'set_address': gi.FunctionInfo(set_address), 'set_index': gi.FunctionInfo(set_index), 'parent': <property object at 0x7fa8bf3cbd60>, 'priv': <property object at 0x7fa8bf3cbe50>})"
    __gdoc__ = 'Object GVirConfigDomainController\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainController (94643613474288)>'
    __info__ = ObjectInfo(DomainController)
