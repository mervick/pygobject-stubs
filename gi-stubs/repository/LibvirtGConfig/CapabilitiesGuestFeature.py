...
class CapabilitiesGuestFeature(Object):
    """
    :Constructors:
    
    ::
    
        CapabilitiesGuestFeature(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf152be0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CapabilitiesGuestFeature), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigCapabilitiesGuestFeature (94643613158336)>, '__doc__': None, '__gsignals__': {}, 'get_name': gi.FunctionInfo(get_name), 'parent': <property object at 0x7fa8bf3b3c70>, 'priv': <property object at 0x7fa8bf3b3db0>})"
    __gdoc__ = 'Object GVirConfigCapabilitiesGuestFeature\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigCapabilitiesGuestFeature (94643613158336)>'
    __info__ = ObjectInfo(CapabilitiesGuestFeature)
