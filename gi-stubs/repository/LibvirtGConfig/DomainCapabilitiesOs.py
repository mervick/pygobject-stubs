...
class DomainCapabilitiesOs(Object):
    """
    :Constructors:
    
    ::
    
        DomainCapabilitiesOs(**properties)
    """
    ...
    def do_get_firmwares(self, *args, **kwargs): # real signature unknown
        """ get_firmwares(self) -> list """
        pass
    ...
    def get_firmwares(self): # real signature unknown; restored from __doc__
        """ get_firmwares(self) -> list """
        return []
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf400d30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainCapabilitiesOs), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainCapabilitiesOs (94643613617472)>, '__doc__': None, '__gsignals__': {}, 'get_firmwares': gi.FunctionInfo(get_firmwares), 'do_get_firmwares': gi.VFuncInfo(get_firmwares), 'parent': <property object at 0x7fa8bf3bed60>, 'priv': <property object at 0x7fa8bf3bee50>})"
    __gdoc__ = 'Object GVirConfigDomainCapabilitiesOs\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainCapabilitiesOs (94643613617472)>'
    __info__ = ObjectInfo(DomainCapabilitiesOs)
