...
class DomainSmartcardPassthrough(DomainSmartcard):
    """
    :Constructors:
    
    ::
    
        DomainSmartcardPassthrough(**properties)
        new() -> LibvirtGConfig.DomainSmartcardPassthrough
        new_from_xml(xml:str) -> LibvirtGConfig.DomainSmartcardPassthrough
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bef4cd30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainSmartcardPassthrough), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainSmartcardPassthrough (94643613952768)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'set_source': gi.FunctionInfo(set_source), 'parent': <property object at 0x7fa8bf1a29f0>, 'priv': <property object at 0x7fa8bf1a2ae0>})"
    __gdoc__ = 'Object GVirConfigDomainSmartcardPassthrough\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainSmartcardPassthrough (94643613952768)>'
    __info__ = ObjectInfo(DomainSmartcardPassthrough)
