...
class NodeDevice(Object):
    ...
    ::
        ...
        new() -> LibvirtGConfig.NodeDevice
        new_from_xml(xml:str) -> LibvirtGConfig.NodeDevice
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NodeDevice), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigNodeDevice (94643614032976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'parent': <property object at 0x7fa8bf1b4e00>, 'priv': <property object at 0x7fa8bf1b4ef0>})"
    __gdoc__ = 'Object GVirConfigNodeDevice\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigNodeDevice (94643614032976)>'
