...
class CapabilitiesGuestDomain(Object):
    """
    :Constructors:
    
    ::
    
        CapabilitiesGuestDomain(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf13db80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CapabilitiesGuestDomain), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigCapabilitiesGuestDomain (94643613150544)>, '__doc__': None, '__gsignals__': {}, 'get_emulator': gi.FunctionInfo(get_emulator), 'get_virt_type': gi.FunctionInfo(get_virt_type), 'parent': <property object at 0x7fa8bf3b36d0>, 'priv': <property object at 0x7fa8bf3b3810>})"
    __gdoc__ = 'Object GVirConfigCapabilitiesGuestDomain\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigCapabilitiesGuestDomain (94643613150544)>'
    __info__ = ObjectInfo(CapabilitiesGuestDomain)
