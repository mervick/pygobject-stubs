...
class Secret(Object):
    ...
    ::
        ...
        Secret(**properties)
        new() -> LibvirtGConfig.Secret
        new_from_xml(xml:str) -> LibvirtGConfig.Secret
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bec8ac40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Secret), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigSecret (94643614037952)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'parent': <property object at 0x7fa8bf137860>, 'priv': <property object at 0x7fa8bf137950>})"
    __gdoc__ = 'Object GVirConfigSecret\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigSecret (94643614037952)>'
