...
class Object(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf457d90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Object), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigObject (94643613070992)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'error_quark': gi.FunctionInfo(error_quark), 'get_schema': gi.FunctionInfo(get_schema), 'to_xml': gi.FunctionInfo(to_xml), 'validate': gi.FunctionInfo(validate), 'parent': <property object at 0x7fa8bf3afea0>, 'priv': <property object at 0x7fa8bf3afef0>})"
    __gdoc__ = 'Object GVirConfigObject\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigObject (94643613070992)>'
