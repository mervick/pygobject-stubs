...
class CapabilitiesHost(Object):
    """
    :Constructors:
    
    ::
    
        CapabilitiesHost(**properties)
    """
    ...
    def get_cpu(self): # real signature unknown; restored from __doc__
        """ get_cpu(self) -> LibvirtGConfig.CapabilitiesCpu """
        pass
    ...
    def get_secmodels(self): # real signature unknown; restored from __doc__
        """ get_secmodels(self) -> list """
        return []
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf13ddc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CapabilitiesHost), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigCapabilitiesHost (94643613398576)>, '__doc__': None, '__gsignals__': {}, 'get_cpu': gi.FunctionInfo(get_cpu), 'get_secmodels': gi.FunctionInfo(get_secmodels), 'get_uuid': gi.FunctionInfo(get_uuid), 'parent': <property object at 0x7fa8bf3b6310>, 'priv': <property object at 0x7fa8bf3b6450>})"
    __gdoc__ = 'Object GVirConfigCapabilitiesHost\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigCapabilitiesHost (94643613398576)>'
    __info__ = ObjectInfo(CapabilitiesHost)
