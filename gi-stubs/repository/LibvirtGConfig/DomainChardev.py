...
class DomainChardev(DomainDevice):
    """
    :Constructors:
    
    ::
    
        DomainChardev(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf1524c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainChardev), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainChardev (94643613372352)>, '__doc__': None, '__gsignals__': {}, 'get_source': gi.FunctionInfo(get_source), 'set_source': gi.FunctionInfo(set_source), 'parent': <property object at 0x7fa8bf3c0860>, 'priv': <property object at 0x7fa8bf3c0950>})"
    __gdoc__ = 'Object GVirConfigDomainChardev\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainChardev (94643613372352)>'
    __info__ = ObjectInfo(DomainChardev)
