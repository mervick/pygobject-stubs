...
class DomainParallel(DomainChardev):
    """
    :Constructors:
    
    ::
    
        DomainParallel(**properties)
        new() -> LibvirtGConfig.DomainParallel
        new_from_xml(xml:str) -> LibvirtGConfig.DomainParallel
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bef08370>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainParallel), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainParallel (94643613767344)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'parent': <property object at 0x7fa8bf1982c0>, 'priv': <property object at 0x7fa8bf1983b0>})"
    __gdoc__ = 'Object GVirConfigDomainParallel\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainParallel (94643613767344)>'
    __info__ = ObjectInfo(DomainParallel)
