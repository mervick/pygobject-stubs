...
class CapabilitiesGuestArch(Object):
    """
    :Constructors:
    
    ::
    
        CapabilitiesGuestArch(**properties)
    """
    ...
    def get_emulator(self): # real signature unknown; restored from __doc__
        """ get_emulator(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf40aca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CapabilitiesGuestArch), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigCapabilitiesGuestArch (94643613171712)>, '__doc__': None, '__gsignals__': {}, 'get_domains': gi.FunctionInfo(get_domains), 'get_emulator': gi.FunctionInfo(get_emulator), 'get_name': gi.FunctionInfo(get_name), 'parent': <property object at 0x7fa8bf3b0e50>, 'priv': <property object at 0x7fa8bf3b0f90>})"
    __gdoc__ = 'Object GVirConfigCapabilitiesGuestArch\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigCapabilitiesGuestArch (94643613171712)>'
    __info__ = ObjectInfo(CapabilitiesGuestArch)
