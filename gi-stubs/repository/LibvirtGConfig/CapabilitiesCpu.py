...
class CapabilitiesCpu(Object):
    """
    :Constructors:
    
    ::
    
        CapabilitiesCpu(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf13df10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CapabilitiesCpu), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigCapabilitiesCpu (94643613181920)>, '__doc__': None, '__gsignals__': {}, 'add_feature': gi.FunctionInfo(add_feature), 'get_arch': gi.FunctionInfo(get_arch), 'get_features': gi.FunctionInfo(get_features), 'get_model': gi.FunctionInfo(get_model), 'get_topology': gi.FunctionInfo(get_topology), 'set_topology': gi.FunctionInfo(set_topology), 'do_get_features': gi.VFuncInfo(get_features), 'parent': <property object at 0x7fa8bf3a8400>, 'priv': <property object at 0x7fa8bf3a8540>})"
    __gdoc__ = 'Object GVirConfigCapabilitiesCpu\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigCapabilitiesCpu (94643613181920)>'
    __info__ = ObjectInfo(CapabilitiesCpu)
