...
class CapabilitiesHostSecModel(Object):
    """
    :Constructors:
    
    ::
    
        CapabilitiesHostSecModel(**properties)
    """
    ...
    def get_doi(self): # real signature unknown; restored from __doc__
        """ get_doi(self) -> str """
        return ""
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf13de80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CapabilitiesHostSecModel), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigCapabilitiesHostSecModel (94643613218272)>, '__doc__': None, '__gsignals__': {}, 'get_doi': gi.FunctionInfo(get_doi), 'get_model': gi.FunctionInfo(get_model), 'parent': <property object at 0x7fa8bf3b68b0>, 'priv': <property object at 0x7fa8bf3b69f0>})"
    __gdoc__ = 'Object GVirConfigCapabilitiesHostSecModel\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigCapabilitiesHostSecModel (94643613218272)>'
    __info__ = ObjectInfo(CapabilitiesHostSecModel)
