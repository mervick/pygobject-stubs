...
class DomainSmartcardHost(DomainSmartcard):
    """
    :Constructors:
    
    ::
    
        DomainSmartcardHost(**properties)
        new() -> LibvirtGConfig.DomainSmartcardHost
        new_from_xml(xml:str) -> LibvirtGConfig.DomainSmartcardHost
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bed4d490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainSmartcardHost), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainSmartcardHost (94643613942352)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'parent': <property object at 0x7fa8bf19ecc0>, 'priv': <property object at 0x7fa8bf19edb0>})"
    __gdoc__ = 'Object GVirConfigDomainSmartcardHost\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainSmartcardHost (94643613942352)>'
    __info__ = ObjectInfo(DomainSmartcardHost)
