...
class DomainDevice(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf0cb8b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainDevice), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainDevice (94643613148448)>, '__doc__': None, '__gsignals__': {}, 'get_alias': gi.FunctionInfo(get_alias), 'parent': <property object at 0x7fa8bf3c05e0>, 'priv': <property object at 0x7fa8bf3c06d0>})"
    __gdoc__ = 'Object GVirConfigDomainDevice\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainDevice (94643613148448)>'
