...
class DomainGraphicsDesktop(DomainGraphics):
    """
    :Constructors:
    
    ::
    
        DomainGraphicsDesktop(**properties)
        new() -> LibvirtGConfig.DomainGraphicsDesktop
        new_from_xml(xml:str) -> LibvirtGConfig.DomainGraphicsDesktop
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainGraphicsDesktop), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainGraphicsDesktop (94643613785792)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'get_display': gi.FunctionInfo(get_display), 'get_fullscreen': gi.FunctionInfo(get_fullscreen), 'set_display': gi.FunctionInfo(set_display), 'set_fullscreen': gi.FunctionInfo(set_fullscreen), 'parent': <property object at 0x7fa8bf17ee00>, 'priv': <property object at 0x7fa8bf17eef0>})"
    __gdoc__ = 'Object GVirConfigDomainGraphicsDesktop\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainGraphicsDesktop (94643613785792)>'
    __info__ = ObjectInfo(DomainGraphicsDesktop)
