...
class CapabilitiesGuest(Object):
    """
    :Constructors:
    
    ::
    
        CapabilitiesGuest(**properties)
    """
    ...
    def get_arch(self): # real signature unknown; restored from __doc__
        """ get_arch(self) -> LibvirtGConfig.CapabilitiesGuestArch """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf3ed580>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CapabilitiesGuest), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigCapabilitiesGuest (94643613131552)>, '__doc__': None, '__gsignals__': {}, 'get_arch': gi.FunctionInfo(get_arch), 'get_features': gi.FunctionInfo(get_features), 'get_os_type': gi.FunctionInfo(get_os_type), 'parent': <property object at 0x7fa8bf3b0bd0>, 'priv': <property object at 0x7fa8bf3b0d10>})"
    __gdoc__ = 'Object GVirConfigCapabilitiesGuest\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigCapabilitiesGuest (94643613131552)>'
    __info__ = ObjectInfo(CapabilitiesGuest)
