...
class DomainSnapshotDisk(Object):
    """
    :Constructors:
    
    ::
    
        DomainSnapshotDisk(**properties)
        new() -> LibvirtGConfig.DomainSnapshotDisk
        new_from_xml(xml:str) -> LibvirtGConfig.DomainSnapshotDisk
    """
    ...
    def set_source_file(self, filename): # real signature unknown; restored from __doc__
        """ set_source_file(self, filename:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bee9e1f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DomainSnapshotDisk), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigDomainSnapshotDisk (94643613966704)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'get_driver_format': gi.FunctionInfo(get_driver_format), 'get_name': gi.FunctionInfo(get_name), 'get_snapshot_type': gi.FunctionInfo(get_snapshot_type), 'get_source_file': gi.FunctionInfo(get_source_file), 'set_driver_format': gi.FunctionInfo(set_driver_format), 'set_name': gi.FunctionInfo(set_name), 'set_snapshot_type': gi.FunctionInfo(set_snapshot_type), 'set_source_file': gi.FunctionInfo(set_source_file), 'parent': <property object at 0x7fa8bf1a47c0>, 'priv': <property object at 0x7fa8bf1a48b0>})"
    __gdoc__ = 'Object GVirConfigDomainSnapshotDisk\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigDomainSnapshotDisk (94643613966704)>'
    __info__ = ObjectInfo(DomainSnapshotDisk)
