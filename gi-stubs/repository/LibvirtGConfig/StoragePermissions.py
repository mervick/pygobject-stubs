...
class StoragePermissions(Object):
    """
    :Constructors:
    
    ::
    
        StoragePermissions(**properties)
        new() -> LibvirtGConfig.StoragePermissions
        new_from_xml(xml:str) -> LibvirtGConfig.StoragePermissions
    """
    ...
    def set_group(self, group): # real signature unknown; restored from __doc__
        """ set_group(self, group:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bed4dd30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StoragePermissions), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigStoragePermissions (94643614026992)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'get_group': gi.FunctionInfo(get_group), 'get_label': gi.FunctionInfo(get_label), 'get_mode': gi.FunctionInfo(get_mode), 'get_owner': gi.FunctionInfo(get_owner), 'set_group': gi.FunctionInfo(set_group), 'set_label': gi.FunctionInfo(set_label), 'set_mode': gi.FunctionInfo(set_mode), 'set_owner': gi.FunctionInfo(set_owner), 'parent': <property object at 0x7fa8bf137ea0>, 'priv': <property object at 0x7fa8bf137f90>})"
    __gdoc__ = 'Object GVirConfigStoragePermissions\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigStoragePermissions (94643614026992)>'
    __info__ = ObjectInfo(StoragePermissions)
