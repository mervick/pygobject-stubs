...
class NetworkFilter(Object):
    ...
    ::
        ...
        new() -> LibvirtGConfig.NetworkFilter
        new_from_xml(xml:str) -> LibvirtGConfig.NetworkFilter
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bec068b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NetworkFilter), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigNetworkFilter (94643614026736)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_xml': gi.FunctionInfo(new_from_xml), 'parent': <property object at 0x7fa8bf1b46d0>, 'priv': <property object at 0x7fa8bf1b47c0>})"
    __gdoc__ = 'Object GVirConfigNetworkFilter\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigNetworkFilter (94643614026736)>'
