...
class CapabilitiesCpuFeature(Object):
    """
    :Constructors:
    
    ::
    
        CapabilitiesCpuFeature(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fa8bf4000d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CapabilitiesCpuFeature), '__module__': 'gi.repository.LibvirtGConfig', '__gtype__': <GType GVirConfigCapabilitiesCpuFeature (94643613211920)>, '__doc__': None, '__gsignals__': {}, 'get_name': gi.FunctionInfo(get_name), 'set_name': gi.FunctionInfo(set_name), 'parent': <property object at 0x7fa8bf3a89f0>, 'priv': <property object at 0x7fa8bf3a8b30>})"
    __gdoc__ = 'Object GVirConfigCapabilitiesCpuFeature\n\nProperties from GVirConfigObject:\n  schema -> gchararray: Schema\n    The doc RNG schema\n  node -> gpointer: XML Node\n    The XML node this config object corresponds to\n  doc -> GVirConfigXmlDoc: XML Doc\n    The XML doc this config object corresponds to\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVirConfigCapabilitiesCpuFeature (94643613211920)>'
    __info__ = ObjectInfo(CapabilitiesCpuFeature)
