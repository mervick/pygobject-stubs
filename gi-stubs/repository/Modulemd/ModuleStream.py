...
class ModuleStream(__gi_overrides_GObject.Object):
    """
    :Constructors:
    
    ::
    
        ModuleStream(**properties)
        new(mdversion:int, module_name:str=None, module_stream:str=None) -> Modulemd.ModuleStream
    """
    ...
    def new(self, mdversion, module_name=None, module_stream=None): # real signature unknown; restored from __doc__
        """ new(mdversion:int, module_name:str=None, module_stream:str=None) -> Modulemd.ModuleStream """
        pass
    ...
    def set_arch(self, arch=None): # real signature unknown; restored from __doc__
        """ set_arch(self, arch:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f723ee79070>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModuleStream), '__module__': 'gi.repository.Modulemd', '__gtype__': <GType ModulemdModuleStream (94446540355776)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'read_file': gi.FunctionInfo(read_file), 'read_string': gi.FunctionInfo(read_string), 'build_depends_on_stream': gi.FunctionInfo(build_depends_on_stream), 'copy': gi.FunctionInfo(copy), 'depends_on_stream': gi.FunctionInfo(depends_on_stream), 'equals': gi.FunctionInfo(equals), 'get_NSVCA': gi.FunctionInfo(get_NSVCA), 'get_arch': gi.FunctionInfo(get_arch), 'get_context': gi.FunctionInfo(get_context), 'get_mdversion': gi.FunctionInfo(get_mdversion), 'get_module_name': gi.FunctionInfo(get_module_name), 'get_nsvc': gi.FunctionInfo(get_nsvc), 'get_stream_name': gi.FunctionInfo(get_stream_name), 'get_version': gi.FunctionInfo(get_version), 'set_arch': gi.FunctionInfo(set_arch), 'set_context': gi.FunctionInfo(set_context), 'set_version': gi.FunctionInfo(set_version), 'upgrade': gi.FunctionInfo(upgrade), 'validate': gi.FunctionInfo(validate), 'do_build_depends_on_stream': gi.VFuncInfo(build_depends_on_stream), 'do_copy': gi.VFuncInfo(copy), 'do_depends_on_stream': gi.VFuncInfo(depends_on_stream), 'do_equals': gi.VFuncInfo(equals), 'do_get_mdversion': gi.VFuncInfo(get_mdversion), 'do_validate': gi.VFuncInfo(validate), 'parent_instance': <property object at 0x7f723f1b0d10>})"
    __gdoc__ = 'Object ModulemdModuleStream\n\nProperties from ModulemdModuleStream:\n  mdversion -> guint64: Metadata Version\n    The metadata version of this ModuleStream object. Read-only.\n  module-name -> gchararray: Module Name\n    The name of the module providing this stream.\n  stream-name -> gchararray: Stream Name\n    The name of this module stream.\n  version -> guint64: Module Stream Version\n    The version of this module stream\n  context -> gchararray: Module Stream Context\n    The context of this module stream. Distinguishes between streams with the same version but different dependencies due to module stream expansion.\n  arch -> gchararray: Module Stream Architecture\n    The processor architecture of this module stream.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ModulemdModuleStream (94446540355776)>'
    __info__ = ObjectInfo(ModuleStream)
