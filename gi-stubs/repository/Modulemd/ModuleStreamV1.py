...
class ModuleStreamV1(ModuleStream):
    """
    :Constructors:
    
    ::
    
        ModuleStreamV1(**properties)
        new(module_name:str=None, module_stream:str=None) -> Modulemd.ModuleStreamV1
    """
    def add_buildtime_requirement(self, module_name, module_stream): # real signature unknown; restored from __doc__
        """ add_buildtime_requirement(self, module_name:str, module_stream:str) """
        pass
    ...
    def add_runtime_requirement(self, module_name, module_stream): # real signature unknown; restored from __doc__
        """ add_runtime_requirement(self, module_name:str, module_stream:str) """
        pass
    ...
    def clear_buildtime_requirements(self): # real signature unknown; restored from __doc__
        """ clear_buildtime_requirements(self) """
        pass
    ...
    def clear_runtime_requirements(self): # real signature unknown; restored from __doc__
        """ clear_runtime_requirements(self) """
        pass
    ...
    def get_buildtime_modules(self): # real signature unknown; restored from __doc__
        """ get_buildtime_modules(self) -> list """
        return []

    def get_buildtime_requirement_stream(self, module_name): # real signature unknown; restored from __doc__
        """ get_buildtime_requirement_stream(self, module_name:str) -> str """
        return ""
    ...
    def get_eol(self): # real signature unknown; restored from __doc__
        """ get_eol(self) -> GLib.Date """
        pass
    ...
    def get_runtime_modules(self): # real signature unknown; restored from __doc__
        """ get_runtime_modules(self) -> list """
        return []

    def get_runtime_requirement_stream(self, module_name): # real signature unknown; restored from __doc__
        """ get_runtime_requirement_stream(self, module_name:str) -> str """
        return ""
    ...
    def remove_buildtime_requirement(self, module_name): # real signature unknown; restored from __doc__
        """ remove_buildtime_requirement(self, module_name:str) """
        pass
    ...
    def remove_runtime_requirement(self, module_name): # real signature unknown; restored from __doc__
        """ remove_runtime_requirement(self, module_name:str) """
        pass
    ...
    def set_eol(self, eol): # real signature unknown; restored from __doc__
        """ set_eol(self, eol:GLib.Date) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f723f1d5460>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModuleStreamV1), '__module__': 'gi.repository.Modulemd', '__gtype__': <GType ModulemdModuleStreamV1 (94446540356112)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_buildtime_requirement': gi.FunctionInfo(add_buildtime_requirement), 'add_component': gi.FunctionInfo(add_component), 'add_content_license': gi.FunctionInfo(add_content_license), 'add_module_license': gi.FunctionInfo(add_module_license), 'add_profile': gi.FunctionInfo(add_profile), 'add_rpm_api': gi.FunctionInfo(add_rpm_api), 'add_rpm_artifact': gi.FunctionInfo(add_rpm_artifact), 'add_rpm_filter': gi.FunctionInfo(add_rpm_filter), 'add_runtime_requirement': gi.FunctionInfo(add_runtime_requirement), 'add_servicelevel': gi.FunctionInfo(add_servicelevel), 'clear_buildtime_requirements': gi.FunctionInfo(clear_buildtime_requirements), 'clear_content_licenses': gi.FunctionInfo(clear_content_licenses), 'clear_module_components': gi.FunctionInfo(clear_module_components), 'clear_module_licenses': gi.FunctionInfo(clear_module_licenses), 'clear_profiles': gi.FunctionInfo(clear_profiles), 'clear_rpm_api': gi.FunctionInfo(clear_rpm_api), 'clear_rpm_artifacts': gi.FunctionInfo(clear_rpm_artifacts), 'clear_rpm_components': gi.FunctionInfo(clear_rpm_components), 'clear_rpm_filters': gi.FunctionInfo(clear_rpm_filters), 'clear_runtime_requirements': gi.FunctionInfo(clear_runtime_requirements), 'clear_servicelevels': gi.FunctionInfo(clear_servicelevels), 'get_arch': gi.FunctionInfo(get_arch), 'get_buildopts': gi.FunctionInfo(get_buildopts), 'get_buildtime_modules': gi.FunctionInfo(get_buildtime_modules), 'get_buildtime_requirement_stream': gi.FunctionInfo(get_buildtime_requirement_stream), 'get_community': gi.FunctionInfo(get_community), 'get_content_licenses': gi.FunctionInfo(get_content_licenses), 'get_description': gi.FunctionInfo(get_description), 'get_documentation': gi.FunctionInfo(get_documentation), 'get_eol': gi.FunctionInfo(get_eol), 'get_module_component': gi.FunctionInfo(get_module_component), 'get_module_component_names': gi.FunctionInfo(get_module_component_names), 'get_module_licenses': gi.FunctionInfo(get_module_licenses), 'get_profile': gi.FunctionInfo(get_profile), 'get_profile_names': gi.FunctionInfo(get_profile_names), 'get_rpm_api': gi.FunctionInfo(get_rpm_api), 'get_rpm_artifacts': gi.FunctionInfo(get_rpm_artifacts), 'get_rpm_component': gi.FunctionInfo(get_rpm_component), 'get_rpm_component_names': gi.FunctionInfo(get_rpm_component_names), 'get_rpm_filters': gi.FunctionInfo(get_rpm_filters), 'get_runtime_modules': gi.FunctionInfo(get_runtime_modules), 'get_runtime_requirement_stream': gi.FunctionInfo(get_runtime_requirement_stream), 'get_servicelevel': gi.FunctionInfo(get_servicelevel), 'get_servicelevel_names': gi.FunctionInfo(get_servicelevel_names), 'get_summary': gi.FunctionInfo(get_summary), 'get_tracker': gi.FunctionInfo(get_tracker), 'get_xmd': gi.FunctionInfo(get_xmd), 'remove_buildtime_requirement': gi.FunctionInfo(remove_buildtime_requirement), 'remove_content_license': gi.FunctionInfo(remove_content_license), 'remove_module_component': gi.FunctionInfo(remove_module_component), 'remove_module_license': gi.FunctionInfo(remove_module_license), 'remove_rpm_api': gi.FunctionInfo(remove_rpm_api), 'remove_rpm_artifact': gi.FunctionInfo(remove_rpm_artifact), 'remove_rpm_component': gi.FunctionInfo(remove_rpm_component), 'remove_rpm_filter': gi.FunctionInfo(remove_rpm_filter), 'remove_runtime_requirement': gi.FunctionInfo(remove_runtime_requirement), 'set_arch': gi.FunctionInfo(set_arch), 'set_buildopts': gi.FunctionInfo(set_buildopts), 'set_community': gi.FunctionInfo(set_community), 'set_description': gi.FunctionInfo(set_description), 'set_documentation': gi.FunctionInfo(set_documentation), 'set_eol': gi.FunctionInfo(set_eol), 'set_summary': gi.FunctionInfo(set_summary), 'set_tracker': gi.FunctionInfo(set_tracker), 'set_xmd': gi.FunctionInfo(set_xmd)})"
    __gdoc__ = 'Object ModulemdModuleStreamV1\n\nProperties from ModulemdModuleStreamV1:\n  arch -> gchararray: Module Artifact Architecture\n    The architecture of the produced artifacts\n  buildopts -> ModulemdBuildopts: Module Build Options\n    Build options for module components\n  community -> gchararray: Module Community Website\n    The website address of the upstream community for this module\n  documentation -> gchararray: Module Documentation Website\n    The website address of the upstream documentation for this module\n  tracker -> gchararray: Module Bug Tracker Website\n    The website address of the upstream bug tracker for this module\n\nProperties from ModulemdModuleStream:\n  mdversion -> guint64: Metadata Version\n    The metadata version of this ModuleStream object. Read-only.\n  module-name -> gchararray: Module Name\n    The name of the module providing this stream.\n  stream-name -> gchararray: Stream Name\n    The name of this module stream.\n  version -> guint64: Module Stream Version\n    The version of this module stream\n  context -> gchararray: Module Stream Context\n    The context of this module stream. Distinguishes between streams with the same version but different dependencies due to module stream expansion.\n  arch -> gchararray: Module Stream Architecture\n    The processor architecture of this module stream.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ModulemdModuleStreamV1 (94446540356112)>'
    __info__ = ObjectInfo(ModuleStreamV1)
