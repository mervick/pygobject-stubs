...
class Component(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f723f1bbaf0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Component), '__module__': 'gi.repository.Modulemd', '__gtype__': <GType ModulemdComponent (94446540078640)>, '__doc__': None, '__gsignals__': {}, 'add_buildafter': gi.FunctionInfo(add_buildafter), 'clear_buildafter': gi.FunctionInfo(clear_buildafter), 'copy': gi.FunctionInfo(copy), 'equals': gi.FunctionInfo(equals), 'get_buildafter': gi.FunctionInfo(get_buildafter), 'get_buildonly': gi.FunctionInfo(get_buildonly), 'get_buildorder': gi.FunctionInfo(get_buildorder), 'get_key': gi.FunctionInfo(get_key), 'get_name': gi.FunctionInfo(get_name), 'get_rationale': gi.FunctionInfo(get_rationale), 'set_buildonly': gi.FunctionInfo(set_buildonly), 'set_buildorder': gi.FunctionInfo(set_buildorder), 'set_name': gi.FunctionInfo(set_name), 'set_rationale': gi.FunctionInfo(set_rationale), 'validate': gi.FunctionInfo(validate), 'do_copy': gi.VFuncInfo(copy), 'do_equals': gi.VFuncInfo(equals), 'do_get_name': gi.VFuncInfo(get_name), 'do_set_name': gi.VFuncInfo(set_name), 'do_validate': gi.VFuncInfo(validate), 'parent_instance': <property object at 0x7f723f1da4a0>})"
    __gdoc__ = 'Object ModulemdComponent\n\nProperties from ModulemdComponent:\n  buildonly -> gboolean: Buildonly\n    Whether the artifacts produced by this component are intended only for building this module.\n  buildorder -> gint64: Buildorder\n    The order this component should be built relative to others.\n  name -> gchararray: Name\n    The name of the component. This is the real name of the component and may differ from the key used to associate this component with the ModuleStream.\n  rationale -> gchararray: Rationale\n    A description of the reason this component is part of the module stream.\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ModulemdComponent (94446540078640)>'
