...
class BlockDevNotImplementedError(NotImplementedError, __gi_overrides_BlockDev.BlockDevError):
    # no doc
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.BlockDev', '__weakref__': <attribute '__weakref__' of 'BlockDevNotImplementedError' objects>, '__doc__': None})"
