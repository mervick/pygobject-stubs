...
class EnvironmentConfig(__gi_overrides_GObject.Object, Configuration):
    """
    :Constructors:
    ...
    ::
        ...
        new() -> RygelCore.EnvironmentConfig
    """
    ...
    def get_default(self): # real signature unknown; restored from __doc__
        """ get_default() -> RygelCore.EnvironmentConfig """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f381fd2b250>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EnvironmentConfig), '__module__': 'gi.repository.RygelCore', '__gtype__': <GType RygelEnvironmentConfig (94624372770256)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default), 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f38205d4e00>, 'priv': <property object at 0x7f38205d4ef0>})"
    __gdoc__ = 'Object RygelEnvironmentConfig\n\nSignals from RygelConfiguration:\n  configuration-changed (RygelConfigurationEntry)\n  section-changed (gchararray, RygelSectionEntry)\n  setting-changed (gchararray, gchararray)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelEnvironmentConfig (94624372770256)>'
    __info__ = ObjectInfo(EnvironmentConfig)
