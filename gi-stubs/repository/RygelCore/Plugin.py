...
class Plugin(__gi_repository_GUPnP.ResourceFactory):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f381fc9b250>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Plugin), '__module__': 'gi.repository.RygelCore', '__gtype__': <GType RygelPlugin (94624372794944)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_resource': gi.FunctionInfo(add_resource), 'add_icon': gi.FunctionInfo(add_icon), 'apply_hacks': gi.FunctionInfo(apply_hacks), 'get_capabilities': gi.FunctionInfo(get_capabilities), 'set_capabilities': gi.FunctionInfo(set_capabilities), 'get_name': gi.FunctionInfo(get_name), 'get_title': gi.FunctionInfo(get_title), 'set_title': gi.FunctionInfo(set_title), 'get_description': gi.FunctionInfo(get_description), 'get_desc_path': gi.FunctionInfo(get_desc_path), 'get_active': gi.FunctionInfo(get_active), 'set_active': gi.FunctionInfo(set_active), 'get_resource_infos': gi.FunctionInfo(get_resource_infos), 'get_icon_infos': gi.FunctionInfo(get_icon_infos), 'get_default_icons': gi.FunctionInfo(get_default_icons), 'do_apply_hacks': gi.VFuncInfo(apply_hacks), 'parent_instance': <property object at 0x7f381fd11450>, 'priv': <property object at 0x7f381fd11540>})"
    __gdoc__ = 'Object RygelPlugin\n\nProperties from RygelPlugin:\n  capabilities -> RygelPluginCapabilities: capabilities\n    capabilities\n  name -> gchararray: name\n    name\n  title -> gchararray: title\n    title\n  description -> gchararray: description\n    description\n  desc-path -> gchararray: desc-path\n    desc-path\n  active -> gboolean: active\n    active\n  resource-infos -> GeeArrayList: resource-infos\n    resource-infos\n  icon-infos -> GeeArrayList: icon-infos\n    icon-infos\n  default-icons -> GeeArrayList: default-icons\n    default-icons\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelPlugin (94624372794944)>'
