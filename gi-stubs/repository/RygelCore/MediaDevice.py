...
class MediaDevice(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f381fd2be50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MediaDevice), '__module__': 'gi.repository.RygelCore', '__gtype__': <GType RygelMediaDevice (94624372741648)>, '__doc__': None, '__gsignals__': {}, 'add_interface': gi.FunctionInfo(add_interface), 'remove_interface': gi.FunctionInfo(remove_interface), 'get_interfaces': gi.FunctionInfo(get_interfaces), 'get_plugin': gi.FunctionInfo(get_plugin), 'set_plugin': gi.FunctionInfo(set_plugin), 'get_title': gi.FunctionInfo(get_title), 'get_capabilities': gi.FunctionInfo(get_capabilities), 'parent_instance': <property object at 0x7f38205d9450>, 'priv': <property object at 0x7f38205d9540>})"
    __gdoc__ = 'Object RygelMediaDevice\n\nProperties from RygelMediaDevice:\n  plugin -> RygelPlugin: plugin\n    plugin\n  title -> gchararray: title\n    title\n  capabilities -> RygelPluginCapabilities: capabilities\n    capabilities\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelMediaDevice (94624372741648)>'
    __info__ = ObjectInfo(MediaDevice)
