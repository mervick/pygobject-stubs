...
class CmdlineConfig(__gi_overrides_GObject.Object, Configuration):
    """
    :Constructors:
    
    ::
    
        CmdlineConfig(**properties)
        new() -> RygelCore.CmdlineConfig
    """
    ...
    def get_config_file(self): # real signature unknown; restored from __doc__
    ...
    def get_default(self): # real signature unknown; restored from __doc__
        """ get_default() -> RygelCore.CmdlineConfig """
        pass
    ...
    def parse_args(self, args): # real signature unknown; restored from __doc__
        """ parse_args(args:list) -> args:list """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f381fd2b100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CmdlineConfig), '__module__': 'gi.repository.RygelCore', '__gtype__': <GType RygelCmdlineConfig (94624372595744)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default), 'parse_args': gi.FunctionInfo(parse_args), 'get_config_file': gi.FunctionInfo(get_config_file), 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f38205cc540>, 'priv': <property object at 0x7f38205cc680>})"
    __gdoc__ = 'Object RygelCmdlineConfig\n\nSignals from RygelConfiguration:\n  configuration-changed (RygelConfigurationEntry)\n  section-changed (gchararray, RygelSectionEntry)\n  setting-changed (gchararray, gchararray)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelCmdlineConfig (94624372595744)>'
    __info__ = ObjectInfo(CmdlineConfig)
