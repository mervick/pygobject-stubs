...
class RootDevice(__gi_repository_GUPnP.RootDevice):
    """
    :Constructors:
    ...
    ::
        ...
        new(context:GUPnP.Context, plugin:RygelCore.Plugin, description_doc:GUPnP.XMLDoc, description_path:str, description_dir:str) -> RygelCore.RootDevice
    """
    ...
    def get_services(self): # real signature unknown; restored from __doc__
        """ get_services(self) -> Gee.ArrayList """
        pass
    ...
    def new(self, context, plugin, description_doc, description_path, description_dir): # real signature unknown; restored from __doc__
        """ new(context:GUPnP.Context, plugin:RygelCore.Plugin, description_doc:GUPnP.XMLDoc, description_path:str, description_dir:str) -> RygelCore.RootDevice """
        pass
