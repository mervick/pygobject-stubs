...
class MetaConfig(__gi_overrides_GObject.Object, Configuration):
    """
    :Constructors:
    
    ::
    
        MetaConfig(**properties)
        new() -> RygelCore.MetaConfig
    """
    ...
    def get_default(self): # real signature unknown; restored from __doc__
        """ get_default() -> RygelCore.MetaConfig """
        pass
    ...
    def register_configuration(self, config): # real signature unknown; restored from __doc__
        """ register_configuration(config:RygelCore.Configuration) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f381fd1cd90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MetaConfig), '__module__': 'gi.repository.RygelCore', '__gtype__': <GType RygelMetaConfig (94624372742080)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default), 'register_configuration': gi.FunctionInfo(register_configuration), 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f38205d99f0>, 'priv': <property object at 0x7f38205d9ae0>})"
    __gdoc__ = 'Object RygelMetaConfig\n\nSignals from RygelConfiguration:\n  configuration-changed (RygelConfigurationEntry)\n  section-changed (gchararray, RygelSectionEntry)\n  setting-changed (gchararray, gchararray)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType RygelMetaConfig (94624372742080)>'
    __info__ = ObjectInfo(MetaConfig)
