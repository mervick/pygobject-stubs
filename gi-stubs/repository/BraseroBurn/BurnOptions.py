...
class BurnOptions(__gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    
    ::
    
        BurnOptions(**properties)
        new(session:BraseroBurn.SessionCfg) -> Gtk.Widget
    """
    ...
    def add_options(self, options): # real signature unknown; restored from __doc__
        """ add_options(self, options:Gtk.Widget) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd613694f0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
