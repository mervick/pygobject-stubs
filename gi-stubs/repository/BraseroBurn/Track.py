...
class Track(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd61369370>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Track), '__module__': 'gi.repository.BraseroBurn', '__gtype__': <GType BraseroTrack (94320849296048)>, '__doc__': None, '__gsignals__': {}, 'changed': gi.FunctionInfo(changed), 'get_checksum': gi.FunctionInfo(get_checksum), 'get_checksum_type': gi.FunctionInfo(get_checksum_type), 'get_size': gi.FunctionInfo(get_size), 'get_status': gi.FunctionInfo(get_status), 'get_track_type': gi.FunctionInfo(get_track_type), 'set_checksum': gi.FunctionInfo(set_checksum), 'tag_add': gi.FunctionInfo(tag_add), 'tag_add_int': gi.FunctionInfo(tag_add_int), 'tag_add_string': gi.FunctionInfo(tag_add_string), 'tag_copy_missing': gi.FunctionInfo(tag_copy_missing), 'tag_lookup': gi.FunctionInfo(tag_lookup), 'tag_lookup_int': gi.FunctionInfo(tag_lookup_int), 'tag_lookup_string': gi.FunctionInfo(tag_lookup_string), 'do_changed': gi.VFuncInfo(changed), 'do_get_size': gi.VFuncInfo(get_size), 'do_get_status': gi.VFuncInfo(get_status), 'do_get_type': gi.VFuncInfo(get_type), 'parent_instance': <property object at 0x7fdd6135eae0>})"
    __gdoc__ = 'Object BraseroTrack\n\nSignals from BraseroTrack:\n  changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroTrack (94320849296048)>'
    __info__ = ObjectInfo(Track)
