...
class TrackImageCfg(TrackImage):
    """
    :Constructors:
    
    ::
    
        TrackImageCfg(**properties)
        new() -> BraseroBurn.TrackImageCfg
    """
    ...
    def do_set_block_num(self, *args, **kwargs): # real signature unknown
        """ set_block_num(self, blocks:int) -> BraseroBurn.BurnResult """
        pass

    def do_set_source(self, *args, **kwargs): # real signature unknown
        """ set_source(self, image:str, toc:str, format:BraseroBurn.ImageFormat) -> BraseroBurn.BurnResult """
        pass
    ...
    def force_format(self, format): # real signature unknown; restored from __doc__
        """ force_format(self, format:BraseroBurn.ImageFormat) -> BraseroBurn.BurnResult """
        pass
    ...
    def get_forced_format(self): # real signature unknown; restored from __doc__
        """ get_forced_format(self) -> BraseroBurn.ImageFormat """
        pass

    def get_format(self): # real signature unknown; restored from __doc__
        """ get_format(self) -> BraseroBurn.ImageFormat """
        pass
    ...
    def get_toc_source(self, uri): # real signature unknown; restored from __doc__
        """ get_toc_source(self, uri:bool) -> str """
        return ""
    ...
    def need_byte_swap(self): # real signature unknown; restored from __doc__
        """ need_byte_swap(self) -> bool """
        return False
    ...
    def set_block_num(self, blocks): # real signature unknown; restored from __doc__
        """ set_block_num(self, blocks:int) -> BraseroBurn.BurnResult """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd60913ca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TrackImageCfg), '__module__': 'gi.repository.BraseroBurn', '__gtype__': <GType BraseroTrackImageCfg (94320849368864)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'force_format': gi.FunctionInfo(force_format), 'get_forced_format': gi.FunctionInfo(get_forced_format), 'set_source': gi.FunctionInfo(set_source), 'parent_instance': <property object at 0x7fdd61366a90>})"
    __gdoc__ = 'Object BraseroTrackImageCfg\n\nSignals from BraseroTrack:\n  changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroTrackImageCfg (94320849368864)>'
    __info__ = ObjectInfo(TrackImageCfg)
