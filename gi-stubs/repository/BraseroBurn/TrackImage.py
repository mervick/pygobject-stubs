...
class TrackImage(Track):
    ...
    ::
        ...
        TrackImage(**properties)
        new() -> BraseroBurn.TrackImage
    """
    ...
    def set_source(self, image, toc, format): # real signature unknown; restored from __doc__
        """ set_source(self, image:str, toc:str, format:BraseroBurn.ImageFormat) -> BraseroBurn.BurnResult """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd609132e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TrackImage), '__module__': 'gi.repository.BraseroBurn', '__gtype__': <GType BraseroTrackImage (94320849367664)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_format': gi.FunctionInfo(get_format), 'get_source': gi.FunctionInfo(get_source), 'get_toc_source': gi.FunctionInfo(get_toc_source), 'need_byte_swap': gi.FunctionInfo(need_byte_swap), 'set_block_num': gi.FunctionInfo(set_block_num), 'set_source': gi.FunctionInfo(set_source), 'do_set_block_num': gi.VFuncInfo(set_block_num), 'do_set_source': gi.VFuncInfo(set_source), 'parent_instance': <property object at 0x7fdd613668b0>})"
    __gdoc__ = 'Object BraseroTrackImage\n\nSignals from BraseroTrack:\n  changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroTrackImage (94320849367664)>'
    __info__ = ObjectInfo(TrackImage)
