...
class BurnDialog(__gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    
    ::
    
        BurnDialog(**properties)
        new() -> Gtk.Widget
    """
    ...
    def cancel(self, force_cancellation): # real signature unknown; restored from __doc__
        """ cancel(self, force_cancellation:bool) -> bool """
        return False
    ...
    def run(self, session): # real signature unknown; restored from __doc__
        """ run(self, session:BraseroBurn.BurnSession) -> bool """
        return False
    ...
    def run_multi(self, session): # real signature unknown; restored from __doc__
        """ run_multi(self, session:BraseroBurn.BurnSession) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd613b4e80>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
