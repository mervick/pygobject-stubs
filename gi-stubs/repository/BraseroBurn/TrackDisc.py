...
class TrackDisc(Track):
    """
    :Constructors:
    
    ::
    
        TrackDisc(**properties)
        new() -> BraseroBurn.TrackDisc
    """
    ...
    def set_track_num(self, num): # real signature unknown; restored from __doc__
        """ set_track_num(self, num:int) -> BraseroBurn.BurnResult """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TrackDisc), '__module__': 'gi.repository.BraseroBurn', '__gtype__': <GType BraseroTrackDisc (94320849361088)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_track_num': gi.FunctionInfo(get_track_num), 'set_track_num': gi.FunctionInfo(set_track_num), 'parent_instance': <property object at 0x7fdd61366590>})"
    __gdoc__ = 'Object BraseroTrackDisc\n\nSignals from BraseroTrack:\n  changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroTrackDisc (94320849361088)>'
    __info__ = ObjectInfo(TrackDisc)
