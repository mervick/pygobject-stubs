...
class TrackData(Track):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd609c8220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TrackData), '__module__': 'gi.repository.BraseroBurn', '__gtype__': <GType BraseroTrackData (94320849329504)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_fs': gi.FunctionInfo(add_fs), 'get_excluded_list': gi.FunctionInfo(get_excluded_list), 'get_file_num': gi.FunctionInfo(get_file_num), 'get_fs': gi.FunctionInfo(get_fs), 'get_grafts': gi.FunctionInfo(get_grafts), 'rm_fs': gi.FunctionInfo(rm_fs), 'set_data_blocks': gi.FunctionInfo(set_data_blocks), 'set_file_num': gi.FunctionInfo(set_file_num), 'set_source': gi.FunctionInfo(set_source), 'write_to_paths': gi.FunctionInfo(write_to_paths), 'do_add_fs': gi.VFuncInfo(add_fs), 'do_get_file_num': gi.VFuncInfo(get_file_num), 'do_get_fs': gi.VFuncInfo(get_fs), 'do_get_grafts': gi.VFuncInfo(get_grafts), 'do_rm_fs': gi.VFuncInfo(rm_fs), 'do_set_source': gi.VFuncInfo(set_source), 'parent_instance': <property object at 0x7fdd6135d540>})"
    __gdoc__ = 'Object BraseroTrackData\n\nSignals from BraseroTrack:\n  changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroTrackData (94320849329504)>'
    __info__ = ObjectInfo(TrackData)
