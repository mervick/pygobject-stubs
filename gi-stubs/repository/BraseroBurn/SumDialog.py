...
class SumDialog(ToolDialog):
    """
    :Constructors:
    
    ::
    
        SumDialog(**properties)
        new() -> BraseroBurn.SumDialog
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd609c8670>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
