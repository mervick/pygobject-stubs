...
class TrackStream(Track):
    """
    :Constructors:
    
    ::
    
        TrackStream(**properties)
        new() -> BraseroBurn.TrackStream
    """
    ...
    def do_set_boundaries(self, *args, **kwargs): # real signature unknown
        """ set_boundaries(self, start:int, end:int, gap:int) -> BraseroBurn.BurnResult """
        pass

    def do_set_format(self, *args, **kwargs): # real signature unknown
        """ set_format(self, format:BraseroBurn.StreamFormat) -> BraseroBurn.BurnResult """
        pass

    def do_set_source(self, *args, **kwargs): # real signature unknown
        """ set_source(self, uri:str) -> BraseroBurn.BurnResult """
        pass
    ...
    def get_format(self): # real signature unknown; restored from __doc__
        """ get_format(self) -> BraseroBurn.StreamFormat """
        pass

    def get_gap(self): # real signature unknown; restored from __doc__
        """ get_gap(self) -> int """
        return 0

    def get_length(self, length): # real signature unknown; restored from __doc__
        """ get_length(self, length:int) -> BraseroBurn.BurnResult """
        pass
    ...
    def get_source(self, uri): # real signature unknown; restored from __doc__
        """ get_source(self, uri:bool) -> str """
        return ""
    ...
    def set_boundaries(self, start, end, gap): # real signature unknown; restored from __doc__
        """ set_boundaries(self, start:int, end:int, gap:int) -> BraseroBurn.BurnResult """
        pass
    ...
    def set_source(self, uri): # real signature unknown; restored from __doc__
        """ set_source(self, uri:str) -> BraseroBurn.BurnResult """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd609c89a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TrackStream), '__module__': 'gi.repository.BraseroBurn', '__gtype__': <GType BraseroTrackStream (94320849319648)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_end': gi.FunctionInfo(get_end), 'get_format': gi.FunctionInfo(get_format), 'get_gap': gi.FunctionInfo(get_gap), 'get_length': gi.FunctionInfo(get_length), 'get_source': gi.FunctionInfo(get_source), 'get_start': gi.FunctionInfo(get_start), 'set_boundaries': gi.FunctionInfo(set_boundaries), 'set_format': gi.FunctionInfo(set_format), 'set_source': gi.FunctionInfo(set_source), 'do_set_boundaries': gi.VFuncInfo(set_boundaries), 'do_set_format': gi.VFuncInfo(set_format), 'do_set_source': gi.VFuncInfo(set_source), 'parent_instance': <property object at 0x7fdd6135da40>})"
    __gdoc__ = 'Object BraseroTrackStream\n\nSignals from BraseroTrack:\n  changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroTrackStream (94320849319648)>'
    __info__ = ObjectInfo(TrackStream)
