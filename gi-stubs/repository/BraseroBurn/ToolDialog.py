...
class ToolDialog(__gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    
    ::
    
        ToolDialog(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd613697f0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
