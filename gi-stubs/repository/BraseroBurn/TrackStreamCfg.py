...
class TrackStreamCfg(TrackStream):
    """
    :Constructors:
    
    ::
    
        TrackStreamCfg(**properties)
        new() -> BraseroBurn.TrackStreamCfg
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd609133a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TrackStreamCfg), '__module__': 'gi.repository.BraseroBurn', '__gtype__': <GType BraseroTrackStreamCfg (94320849320576)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7fdd613672c0>})"
    __gdoc__ = 'Object BraseroTrackStreamCfg\n\nSignals from BraseroTrack:\n  changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroTrackStreamCfg (94320849320576)>'
    __info__ = ObjectInfo(TrackStreamCfg)
