...
class SessionCfg(SessionSpan):
    """
    :Constructors:
    
    ::
    
        SessionCfg(**properties)
        new() -> BraseroBurn.SessionCfg
    """
    ...
    def add_flags(self, flags): # real signature unknown; restored from __doc__
        """ add_flags(self, flags:BraseroBurn.BurnFlag) """
        pass
    ...
    def get_error(self): # real signature unknown; restored from __doc__
        """ get_error(self) -> BraseroBurn.SessionError """
        pass
    ...
    def has_default_output_path(self): # real signature unknown; restored from __doc__
        """ has_default_output_path(self) -> bool """
        return False
    ...
    def is_compulsory(self, flag): # real signature unknown; restored from __doc__
        """ is_compulsory(self, flag:BraseroBurn.BurnFlag) -> bool """
        return False
    ...
    def is_supported(self, flag): # real signature unknown; restored from __doc__
        """ is_supported(self, flag:BraseroBurn.BurnFlag) -> bool """
        return False
    ...
    def remove_flags(self, flags): # real signature unknown; restored from __doc__
        """ remove_flags(self, flags:BraseroBurn.BurnFlag) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fdd613b4100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SessionCfg), '__module__': 'gi.repository.BraseroBurn', '__gtype__': <GType BraseroSessionCfg (94320849308208)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_flags': gi.FunctionInfo(add_flags), 'disable': gi.FunctionInfo(disable), 'enable': gi.FunctionInfo(enable), 'get_error': gi.FunctionInfo(get_error), 'has_default_output_path': gi.FunctionInfo(has_default_output_path), 'is_compulsory': gi.FunctionInfo(is_compulsory), 'is_supported': gi.FunctionInfo(is_supported), 'remove_flags': gi.FunctionInfo(remove_flags), 'parent_instance': <property object at 0x7fdd613591d0>})"
    __gdoc__ = 'Object BraseroSessionCfg\n\nSignals from BraseroSessionCfg:\n  wrong-extension () -> gboolean\n  is-valid ()\n\nSignals from BraseroBurnSession:\n  output-changed (BraseroMedium)\n  track-added (BraseroTrack)\n  track-removed (BraseroTrack, guint)\n  track-changed (BraseroTrack)\n  tag-changed (gchararray)\n\nProperties from BraseroBurnSession:\n  tmpdir -> gchararray: Temporary directory\n    The path to the temporary directory\n  speed -> gint64: Burning speed\n    The speed at which a disc should be burned\n  flags -> gint: Burning flags\n    The flags that will be used to burn\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType BraseroSessionCfg (94320849308208)>'
    __info__ = ObjectInfo(SessionCfg)
