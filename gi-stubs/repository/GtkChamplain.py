# encoding: utf-8
# module gi.repository.GtkChamplain
# from /usr/lib64/girepository-1.0/GtkChamplain-0.12.typelib
# by generator 1.147
"""
...
class Embed(__gi_repository_Gtk.Alignment):
    """
    :Constructors:
...
class EmbedClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(EmbedClass), '__module__': 'gi.repository.GtkChamplain', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'EmbedClass' objects>, '__weakref__': <attribute '__weakref__' of 'EmbedClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f46353f3f40>})"
...
class EmbedPrivate(__gi.Struct):
    ...
    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(EmbedPrivate), '__module__': 'gi.repository.GtkChamplain', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'EmbedPrivate' objects>, '__weakref__': <attribute '__weakref__' of 'EmbedPrivate' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x7f463682e1f0>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x7f463682e280>, '__repr__': <function IntrospectionModule.__repr__ at 0x7f463682e310>, '__dir__': <function IntrospectionModule.__dir__ at 0x7f463682e3a0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x7f463746ad00>'

__path__ = [
    '/usr/lib64/girepository-1.0/GtkChamplain-0.12.typelib',
]

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.GtkChamplain', loader=<gi.importer.DynamicImporter object at 0x7f463746ad00>)"
