...
class SourceCredentialsProviderImplPassword(SourceCredentialsProviderImpl):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e6d4760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceCredentialsProviderImplPassword), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceCredentialsProviderImplPassword (94877537147472)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f626e928db0>, 'priv': <property object at 0x7f626e928ef0>})"
    __gdoc__ = 'Object ESourceCredentialsProviderImplPassword\n\nProperties from EExtension:\n  extensible -> EExtensible: Extensible Object\n    The object being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceCredentialsProviderImplPassword (94877537147472)>'
    __info__ = ObjectInfo(SourceCredentialsProviderImplPassword)
