...
class NetworkMonitorClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(NetworkMonitorClass), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'NetworkMonitorClass' objects>, '__weakref__': <attribute '__weakref__' of 'NetworkMonitorClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f626e904090>})"
