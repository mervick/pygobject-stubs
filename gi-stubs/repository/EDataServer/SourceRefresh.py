...
class SourceRefresh(SourceExtension):
    ...
    def get_interval_minutes(self): # real signature unknown; restored from __doc__
        """ get_interval_minutes(self) -> int """
        return 0
    ...
    def set_interval_minutes(self, interval_minutes): # real signature unknown; restored from __doc__
        """ set_interval_minutes(self, interval_minutes:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e645f70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceRefresh), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceRefresh (94877537188768)>, '__doc__': None, '__gsignals__': {}, 'get_enabled': gi.FunctionInfo(get_enabled), 'get_interval_minutes': gi.FunctionInfo(get_interval_minutes), 'set_enabled': gi.FunctionInfo(set_enabled), 'set_interval_minutes': gi.FunctionInfo(set_interval_minutes), 'parent': <property object at 0x7f626e9407c0>, 'priv': <property object at 0x7f626e9408b0>})"
    __gdoc__ = 'Object ESourceRefresh\n\nProperties from ESourceRefresh:\n  enabled -> gboolean: Enabled\n    Whether to periodically refresh\n  interval-minutes -> guint: Interval in Minutes\n    Refresh interval in minutes\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceRefresh (94877537188768)>'
    __info__ = ObjectInfo(SourceRefresh)
