...
class SourceUoa(SourceExtension):
    ...
    def set_account_id(self, account_id): # real signature unknown; restored from __doc__
        """ set_account_id(self, account_id:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e6231f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceUoa), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceUoa (94877537153504)>, '__doc__': None, '__gsignals__': {}, 'get_account_id': gi.FunctionInfo(get_account_id), 'set_account_id': gi.FunctionInfo(set_account_id), 'parent': <property object at 0x7f626e8cab80>, 'priv': <property object at 0x7f626e8cac70>})"
    __gdoc__ = 'Object ESourceUoa\n\nProperties from ESourceUoa:\n  account-id -> guint: Account ID\n    Ubuntu Online Account ID\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceUoa (94877537153504)>'
    __info__ = ObjectInfo(SourceUoa)
