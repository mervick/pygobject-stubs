...
class SourceCredentialsProviderImplOAuth2(SourceCredentialsProviderImpl):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e8ecac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceCredentialsProviderImplOAuth2), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceCredentialsProviderImplOAuth2 (94877537021440)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f626e9288b0>, 'priv': <property object at 0x7f626e9289a0>})"
    __gdoc__ = 'Object ESourceCredentialsProviderImplOAuth2\n\nProperties from EExtension:\n  extensible -> EExtensible: Extensible Object\n    The object being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceCredentialsProviderImplOAuth2 (94877537021440)>'
    __info__ = ObjectInfo(SourceCredentialsProviderImplOAuth2)
