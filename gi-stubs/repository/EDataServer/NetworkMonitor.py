...
class NetworkMonitor(__gi_overrides_GObject.Object, __gi_repository_Gio.Initable, __gi_repository_Gio.NetworkMonitor):
    """
    :Constructors:
    ...
    def dup_gio_name(self): # real signature unknown; restored from __doc__
        """ dup_gio_name(self) -> str """
        return ""
    ...
    def list_gio_names(self): # real signature unknown; restored from __doc__
        """ list_gio_names(self) -> list """
        return []
    ...
    def set_gio_name(self, gio_name=None): # real signature unknown; restored from __doc__
        """ set_gio_name(self, gio_name:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e8dbcd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NetworkMonitor), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ENetworkMonitor (94877536993712)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default), 'dup_gio_name': gi.FunctionInfo(dup_gio_name), 'list_gio_names': gi.FunctionInfo(list_gio_names), 'set_gio_name': gi.FunctionInfo(set_gio_name), 'parent': <property object at 0x7f6271be1db0>, 'priv': <property object at 0x7f6271be1ea0>})"
    __gdoc__ = 'Object ENetworkMonitor\n\nProperties from ENetworkMonitor:\n  gio-name -> gchararray: GIO name\n\nSignals from GNetworkMonitor:\n  network-changed (gboolean)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ENetworkMonitor (94877536993712)>'
    __info__ = ObjectInfo(NetworkMonitor)
