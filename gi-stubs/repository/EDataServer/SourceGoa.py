...
class SourceGoa(SourceExtension):
    ...
    def dup_account_id(self): # real signature unknown; restored from __doc__
        """ dup_account_id(self) -> str """
        return ""
    ...
    def get_account_id(self): # real signature unknown; restored from __doc__
    ...
    def set_account_id(self, account_id=None): # real signature unknown; restored from __doc__
        """ set_account_id(self, account_id:str=None) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceGoa), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceGoa (94877537168672)>, '__doc__': None, '__gsignals__': {}, 'dup_account_id': gi.FunctionInfo(dup_account_id), 'dup_address': gi.FunctionInfo(dup_address), 'dup_calendar_url': gi.FunctionInfo(dup_calendar_url), 'dup_contacts_url': gi.FunctionInfo(dup_contacts_url), 'dup_name': gi.FunctionInfo(dup_name), 'get_account_id': gi.FunctionInfo(get_account_id), 'get_address': gi.FunctionInfo(get_address), 'get_calendar_url': gi.FunctionInfo(get_calendar_url), 'get_contacts_url': gi.FunctionInfo(get_contacts_url), 'get_name': gi.FunctionInfo(get_name), 'set_account_id': gi.FunctionInfo(set_account_id), 'set_address': gi.FunctionInfo(set_address), 'set_calendar_url': gi.FunctionInfo(set_calendar_url), 'set_contacts_url': gi.FunctionInfo(set_contacts_url), 'set_name': gi.FunctionInfo(set_name), 'parent': <property object at 0x7f626e92bc20>, 'priv': <property object at 0x7f626e92bd10>})"
    __gdoc__ = "Object ESourceGoa\n\nProperties from ESourceGoa:\n  account-id -> gchararray: Account ID\n    GNOME Online Account ID\n  calendar-url -> gchararray: Calendar URL\n    GNOME Online Calendar URL\n  contacts-url -> gchararray: Contacts URL\n    GNOME Online Contacts URL\n  name -> gchararray: Name\n    GNOME Online Account's original Name\n  address -> gchararray: Address\n    GNOME Online Account's original Address\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceGoa (94877537168672)>'
    __info__ = ObjectInfo(SourceGoa)
