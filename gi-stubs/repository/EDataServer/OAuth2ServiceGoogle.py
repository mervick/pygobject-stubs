...
class OAuth2ServiceGoogle(OAuth2ServiceBase, OAuth2Service):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e8ecc10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OAuth2ServiceGoogle), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType EOAuth2ServiceGoogle (94877537005520)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f626e907040>})"
    __gdoc__ = 'Object EOAuth2ServiceGoogle\n\nProperties from EExtension:\n  extensible -> EExtensible: Extensible Object\n    The object being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EOAuth2ServiceGoogle (94877537005520)>'
    __info__ = ObjectInfo(OAuth2ServiceGoogle)
