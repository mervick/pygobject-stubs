...
class SourceMailSignature(SourceExtension):
    ...
    def dup_mime_type(self): # real signature unknown; restored from __doc__
        """ dup_mime_type(self) -> str or None """
        return ""
    ...
    def set_mime_type(self, mime_type=None): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e6239a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceMailSignature), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceMailSignature (94877537027248)>, '__doc__': None, '__gsignals__': {}, 'dup_mime_type': gi.FunctionInfo(dup_mime_type), 'get_file': gi.FunctionInfo(get_file), 'get_mime_type': gi.FunctionInfo(get_mime_type), 'set_mime_type': gi.FunctionInfo(set_mime_type), 'parent': <property object at 0x7f626e9384a0>, 'priv': <property object at 0x7f626e938590>})"
    __gdoc__ = 'Object ESourceMailSignature\n\nProperties from ESourceMailSignature:\n  file -> GFile: File\n    File containing signature content\n  mime-type -> gchararray: MIME Type\n    MIME type of the signature content\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceMailSignature (94877537027248)>'
    __info__ = ObjectInfo(SourceMailSignature)
