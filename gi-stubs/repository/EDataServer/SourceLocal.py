...
class SourceLocal(SourceExtension):
    ...
    def dup_custom_file(self): # real signature unknown; restored from __doc__
        """ dup_custom_file(self) -> Gio.File or None """
        pass
    ...
    def get_custom_file(self): # real signature unknown; restored from __doc__
        """ get_custom_file(self) -> Gio.File or None """
        pass
    ...
    def set_custom_file(self, custom_file=None): # real signature unknown; restored from __doc__
        """ set_custom_file(self, custom_file:Gio.File=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e886f70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceLocal), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceLocal (94877537182736)>, '__doc__': None, '__gsignals__': {}, 'dup_custom_file': gi.FunctionInfo(dup_custom_file), 'get_custom_file': gi.FunctionInfo(get_custom_file), 'get_writable': gi.FunctionInfo(get_writable), 'set_custom_file': gi.FunctionInfo(set_custom_file), 'set_writable': gi.FunctionInfo(set_writable), 'parent': <property object at 0x7f626e92ed60>, 'priv': <property object at 0x7f626e92ee50>})"
    __gdoc__ = 'Object ESourceLocal\n\nProperties from ESourceLocal:\n  custom-file -> GFile: Custom File\n    Custom iCalendar file\n  writable -> gboolean: Writable\n    Whether the file can be opened in writable mode\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceLocal (94877537182736)>'
    __info__ = ObjectInfo(SourceLocal)
