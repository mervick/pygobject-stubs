...
class SourceSelectable(SourceBackend):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e8eca90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceSelectable), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceSelectable (94877537090688)>, '__doc__': None, '__gsignals__': {}, 'dup_color': gi.FunctionInfo(dup_color), 'get_color': gi.FunctionInfo(get_color), 'get_selected': gi.FunctionInfo(get_selected), 'set_color': gi.FunctionInfo(set_color), 'set_selected': gi.FunctionInfo(set_selected), 'parent': <property object at 0x7f626e91cef0>, 'priv': <property object at 0x7f626e91f040>})"
    __gdoc__ = 'Object ESourceSelectable\n\nProperties from ESourceSelectable:\n  color -> gchararray: Color\n    Textual specification of a color\n  selected -> gboolean: Selected\n    Whether the data source is selected\n\nProperties from ESourceBackend:\n  backend-name -> gchararray: Backend Name\n    The name of the backend handling the data source\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceSelectable (94877537090688)>'
    __info__ = ObjectInfo(SourceSelectable)
