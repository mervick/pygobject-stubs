...
class SourceMemoList(SourceSelectable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e6d4cd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceMemoList), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceMemoList (94877537241872)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f626e93b720>, 'priv': <property object at 0x7f626e93b810>})"
    __gdoc__ = 'Object ESourceMemoList\n\nProperties from ESourceSelectable:\n  color -> gchararray: Color\n    Textual specification of a color\n  selected -> gboolean: Selected\n    Whether the data source is selected\n\nProperties from ESourceBackend:\n  backend-name -> gchararray: Backend Name\n    The name of the backend handling the data source\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceMemoList (94877537241872)>'
    __info__ = ObjectInfo(SourceMemoList)
