...
class Module(__gi_repository_GObject.TypeModule):
    ...
    def load_all_in_directory(self, dirname): # real signature unknown; restored from __doc__
        """ load_all_in_directory(dirname:str) -> list """
        return []

    def load_file(self, filename): # real signature unknown; restored from __doc__
        """ load_file(filename:str) -> EDataServer.Module """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Module), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType EModule (94877536982624)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'load_all_in_directory': gi.FunctionInfo(load_all_in_directory), 'load_file': gi.FunctionInfo(load_file), 'get_filename': gi.FunctionInfo(get_filename), 'parent': <property object at 0x7f6271be1590>, 'priv': <property object at 0x7f6271be1680>})"
    __gdoc__ = 'Object EModule\n\nProperties from EModule:\n  filename -> gchararray: Filename\n    The filename of the module\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EModule (94877536982624)>'
