...
class SourceRevisionGuards(SourceExtension):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e8ec3d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceRevisionGuards), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceRevisionGuards (94877537279744)>, '__doc__': None, '__gsignals__': {}, 'get_enabled': gi.FunctionInfo(get_enabled), 'set_enabled': gi.FunctionInfo(set_enabled), 'parent': <property object at 0x7f626e8c7090>, 'priv': <property object at 0x7f626e8c7180>})"
    __gdoc__ = 'Object ESourceRevisionGuards\n\nProperties from ESourceRevisionGuards:\n  enabled -> gboolean: Enabled\n    Whether to enable or disable the revision guards\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceRevisionGuards (94877537279744)>'
    __info__ = ObjectInfo(SourceRevisionGuards)
