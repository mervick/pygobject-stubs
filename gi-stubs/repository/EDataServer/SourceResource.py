...
class SourceResource(SourceExtension):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e645a60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceResource), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceResource (94877537138720)>, '__doc__': None, '__gsignals__': {}, 'dup_identity': gi.FunctionInfo(dup_identity), 'get_identity': gi.FunctionInfo(get_identity), 'set_identity': gi.FunctionInfo(set_identity), 'parent': <property object at 0x7f626e8c6ae0>, 'priv': <property object at 0x7f626e8c6bd0>})"
    __gdoc__ = 'Object ESourceResource\n\nProperties from ESourceResource:\n  identity -> gchararray: Identity\n    Resource identity\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceResource (94877537138720)>'
    __info__ = ObjectInfo(SourceResource)
