...
class SourceAutoconfig(SourceExtension):
    ...
    def set_revision(self, revision): # real signature unknown; restored from __doc__
        """ set_revision(self, revision:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e886d60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceAutoconfig), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceAutoconfig (94877537090288)>, '__doc__': None, '__gsignals__': {}, 'dup_revision': gi.FunctionInfo(dup_revision), 'get_revision': gi.FunctionInfo(get_revision), 'set_revision': gi.FunctionInfo(set_revision), 'parent': <property object at 0x7f626e91c6d0>, 'priv': <property object at 0x7f626e91c7c0>})"
    __gdoc__ = 'Object ESourceAutoconfig\n\nProperties from ESourceAutoconfig:\n  revision -> gchararray: Revision\n    Identifier to map a particular version of a system-wide source to a user-specific source\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceAutoconfig (94877537090288)>'
    __info__ = ObjectInfo(SourceAutoconfig)
