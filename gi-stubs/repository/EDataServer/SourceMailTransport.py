...
class SourceMailTransport(SourceBackend):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e6232b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceMailTransport), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceMailTransport (94877537236528)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f626e93b1d0>, 'priv': <property object at 0x7f626e93b2c0>})"
    __gdoc__ = 'Object ESourceMailTransport\n\nProperties from ESourceBackend:\n  backend-name -> gchararray: Backend Name\n    The name of the backend handling the data source\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceMailTransport (94877537236528)>'
    __info__ = ObjectInfo(SourceMailTransport)
