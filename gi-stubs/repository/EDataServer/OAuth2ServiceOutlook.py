...
class OAuth2ServiceOutlook(OAuth2ServiceBase, OAuth2Service):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6271c1fe80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OAuth2ServiceOutlook), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType EOAuth2ServiceOutlook (94877537011488)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f626e908860>})"
    __gdoc__ = 'Object EOAuth2ServiceOutlook\n\nProperties from EExtension:\n  extensible -> EExtensible: Extensible Object\n    The object being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EOAuth2ServiceOutlook (94877537011488)>'
    __info__ = ObjectInfo(OAuth2ServiceOutlook)
