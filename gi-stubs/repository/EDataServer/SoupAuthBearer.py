...
class SoupAuthBearer(__gi_repository_Soup.Auth):
    """
    :Constructors:
    ...
    def set_access_token(self, access_token, expires_in_seconds): # real signature unknown; restored from __doc__
        """ set_access_token(self, access_token:str, expires_in_seconds:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e886dc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SoupAuthBearer), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESoupAuthBearer (94877536961840)>, '__doc__': None, '__gsignals__': {}, 'is_expired': gi.FunctionInfo(is_expired), 'set_access_token': gi.FunctionInfo(set_access_token), 'parent': <property object at 0x7f626e909db0>, 'priv': <property object at 0x7f626e909ea0>})"
    __gdoc__ = 'Object ESoupAuthBearer\n\nProperties from SoupAuth:\n  scheme-name -> gchararray: Scheme name\n    Authentication scheme name\n  realm -> gchararray: Realm\n    Authentication realm\n  host -> gchararray: Host\n    Authentication host\n  is-for-proxy -> gboolean: For Proxy\n    Whether or not the auth is for a proxy server\n  is-authenticated -> gboolean: Authenticated\n    Whether or not the auth is authenticated\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESoupAuthBearer (94877536961840)>'
    __info__ = ObjectInfo(SoupAuthBearer)
