...
class SourceAddressBook(SourceBackend):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e8dbbb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceAddressBook), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceAddressBook (94877537063616)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f626e916ae0>, 'priv': <property object at 0x7f626e916bd0>})"
    __gdoc__ = 'Object ESourceAddressBook\n\nProperties from ESourceBackend:\n  backend-name -> gchararray: Backend Name\n    The name of the backend handling the data source\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceAddressBook (94877537063616)>'
    __info__ = ObjectInfo(SourceAddressBook)
