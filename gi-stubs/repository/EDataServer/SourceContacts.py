...
class SourceContacts(SourceExtension):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e8dbca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceContacts), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceContacts (94877537134448)>, '__doc__': None, '__gsignals__': {}, 'get_include_me': gi.FunctionInfo(get_include_me), 'set_include_me': gi.FunctionInfo(set_include_me), 'parent': <property object at 0x7f626e926310>, 'priv': <property object at 0x7f626e926400>})"
    __gdoc__ = 'Object ESourceContacts\n\nProperties from ESourceContacts:\n  include-me -> gboolean: Include Me\n    Include this address book in the contacts calendar\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceContacts (94877537134448)>'
    __info__ = ObjectInfo(SourceContacts)
