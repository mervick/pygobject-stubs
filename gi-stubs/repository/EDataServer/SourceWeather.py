...
class SourceWeather(SourceExtension):
    ...
    def dup_location(self): # real signature unknown; restored from __doc__
        """ dup_location(self) -> str """
        return ""
    ...
    def get_units(self): # real signature unknown; restored from __doc__
        """ get_units(self) -> EDataServer.SourceWeatherUnits """
        pass
    ...
    def set_units(self, units): # real signature unknown; restored from __doc__
        """ set_units(self, units:EDataServer.SourceWeatherUnits) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e6d4640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceWeather), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceWeather (94877537155968)>, '__doc__': None, '__gsignals__': {}, 'dup_location': gi.FunctionInfo(dup_location), 'get_location': gi.FunctionInfo(get_location), 'get_units': gi.FunctionInfo(get_units), 'set_location': gi.FunctionInfo(set_location), 'set_units': gi.FunctionInfo(set_units), 'parent': <property object at 0x7f626e8ce130>, 'priv': <property object at 0x7f626e8ce220>})"
    __gdoc__ = 'Object ESourceWeather\n\nProperties from ESourceWeather:\n  location -> gchararray: Location\n    Weather location code\n  units -> ESourceWeatherUnits: Units\n    Fahrenheit, Centigrade or Kelvin units\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceWeather (94877537155968)>'
    __info__ = ObjectInfo(SourceWeather)
