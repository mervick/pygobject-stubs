...
class SourceSecurity(SourceExtension):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceSecurity), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceSecurity (94877537317376)>, '__doc__': None, '__gsignals__': {}, 'dup_method': gi.FunctionInfo(dup_method), 'get_method': gi.FunctionInfo(get_method), 'get_secure': gi.FunctionInfo(get_secure), 'set_method': gi.FunctionInfo(set_method), 'set_secure': gi.FunctionInfo(set_secure), 'parent': <property object at 0x7f626e8c7d60>, 'priv': <property object at 0x7f626e8c7e50>})"
    __gdoc__ = 'Object ESourceSecurity\n\nProperties from ESourceSecurity:\n  method -> gchararray: Method\n    Security method\n  secure -> gboolean: Secure\n    Secure the network connection\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceSecurity (94877537317376)>'
    __info__ = ObjectInfo(SourceSecurity)
