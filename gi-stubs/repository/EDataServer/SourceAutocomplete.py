...
class SourceAutocomplete(SourceExtension):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f626e8ec760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SourceAutocomplete), '__module__': 'gi.repository.EDataServer', '__gtype__': <GType ESourceAutocomplete (94877537089984)>, '__doc__': None, '__gsignals__': {}, 'get_include_me': gi.FunctionInfo(get_include_me), 'set_include_me': gi.FunctionInfo(set_include_me), 'parent': <property object at 0x7f626e91c1d0>, 'priv': <property object at 0x7f626e91c2c0>})"
    __gdoc__ = 'Object ESourceAutocomplete\n\nProperties from ESourceAutocomplete:\n  include-me -> gboolean: IncludeMe\n    Include this source when autocompleting\n\nProperties from ESourceExtension:\n  source -> ESource: Source\n    The ESource being extended\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ESourceAutocomplete (94877537089984)>'
    __info__ = ObjectInfo(SourceAutocomplete)
