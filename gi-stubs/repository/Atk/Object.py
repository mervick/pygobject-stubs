...
class Object(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cd7bc4dc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Object), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkObject (93922956182080)>, '__doc__': None, '__gsignals__': {}, 'add_relationship': gi.FunctionInfo(add_relationship), 'get_accessible_id': gi.FunctionInfo(get_accessible_id), 'get_attributes': gi.FunctionInfo(get_attributes), 'get_description': gi.FunctionInfo(get_description), 'get_index_in_parent': gi.FunctionInfo(get_index_in_parent), 'get_layer': gi.FunctionInfo(get_layer), 'get_mdi_zorder': gi.FunctionInfo(get_mdi_zorder), 'get_n_accessible_children': gi.FunctionInfo(get_n_accessible_children), 'get_name': gi.FunctionInfo(get_name), 'get_object_locale': gi.FunctionInfo(get_object_locale), 'get_parent': gi.FunctionInfo(get_parent), 'get_role': gi.FunctionInfo(get_role), 'initialize': gi.FunctionInfo(initialize), 'notify_state_change': gi.FunctionInfo(notify_state_change), 'peek_parent': gi.FunctionInfo(peek_parent), 'ref_accessible_child': gi.FunctionInfo(ref_accessible_child), 'ref_relation_set': gi.FunctionInfo(ref_relation_set), 'ref_state_set': gi.FunctionInfo(ref_state_set), 'remove_property_change_handler': gi.FunctionInfo(remove_property_change_handler), 'remove_relationship': gi.FunctionInfo(remove_relationship), 'set_accessible_id': gi.FunctionInfo(set_accessible_id), 'set_description': gi.FunctionInfo(set_description), 'set_name': gi.FunctionInfo(set_name), 'set_parent': gi.FunctionInfo(set_parent), 'set_role': gi.FunctionInfo(set_role), 'do_active_descendant_changed': gi.VFuncInfo(active_descendant_changed), 'do_children_changed': gi.VFuncInfo(children_changed), 'do_focus_event': gi.VFuncInfo(focus_event), 'do_get_attributes': gi.VFuncInfo(get_attributes), 'do_get_description': gi.VFuncInfo(get_description), 'do_get_index_in_parent': gi.VFuncInfo(get_index_in_parent), 'do_get_layer': gi.VFuncInfo(get_layer), 'do_get_mdi_zorder': gi.VFuncInfo(get_mdi_zorder), 'do_get_n_children': gi.VFuncInfo(get_n_children), 'do_get_name': gi.VFuncInfo(get_name), 'do_get_object_locale': gi.VFuncInfo(get_object_locale), 'do_get_parent': gi.VFuncInfo(get_parent), 'do_get_role': gi.VFuncInfo(get_role), 'do_initialize': gi.VFuncInfo(initialize), 'do_property_change': gi.VFuncInfo(property_change), 'do_ref_relation_set': gi.VFuncInfo(ref_relation_set), 'do_ref_state_set': gi.VFuncInfo(ref_state_set), 'do_remove_property_change_handler': gi.VFuncInfo(remove_property_change_handler), 'do_set_description': gi.VFuncInfo(set_description), 'do_set_name': gi.VFuncInfo(set_name), 'do_set_parent': gi.VFuncInfo(set_parent), 'do_set_role': gi.VFuncInfo(set_role), 'do_state_change': gi.VFuncInfo(state_change), 'do_visible_data_changed': gi.VFuncInfo(visible_data_changed), 'parent': <property object at 0x7f0cd7be42c0>, 'description': <property object at 0x7f0cd7be4400>, 'name': <property object at 0x7f0cd7be44f0>, 'accessible_parent': <property object at 0x7f0cd7be4630>, 'role': <property object at 0x7f0cd7be4720>, 'relation_set': <property object at 0x7f0cd7be4810>, 'layer': <property object at 0x7f0cd7be4900>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkObject (93922956182080)>'
