...
class Socket(Object, Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f44c6dedb50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Socket), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkSocket (94258338202160)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'embed': gi.FunctionInfo(embed), 'is_occupied': gi.FunctionInfo(is_occupied), 'do_embed': gi.VFuncInfo(embed), 'parent': <property object at 0x7f44c6dc8db0>, 'embedded_plug_id': <property object at 0x7f44c6dc8ef0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkSocket (94258338202160)>'
