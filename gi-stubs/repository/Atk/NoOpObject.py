...
class NoOpObject(Object, Action, Component, Document, EditableText, Hypertext, Image, Selection, Table, TableCell, Text, Value, Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cd81d0880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NoOpObject), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkNoOpObject (93922955650400)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7f0cd819e8b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkNoOpObject (93922955650400)>'
