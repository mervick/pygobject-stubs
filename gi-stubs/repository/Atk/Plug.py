...
class Plug(Object, Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f44c6d283d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Plug), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkPlug (94258337940064)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_id': gi.FunctionInfo(get_id), 'set_child': gi.FunctionInfo(set_child), 'do_get_object_id': gi.VFuncInfo(get_object_id), 'parent': <property object at 0x7f44c6dbe8b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkPlug (94258337940064)>'
