...
class GObjectAccessible(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f44c6d28400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GObjectAccessible), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkGObjectAccessible (94258337592032)>, '__doc__': None, '__gsignals__': {}, 'for_object': gi.FunctionInfo(for_object), 'get_object': gi.FunctionInfo(get_object), 'parent': <property object at 0x7f44c6da8f40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkGObjectAccessible (94258337592032)>'
