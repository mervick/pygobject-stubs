...
class GObjectAccessible(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cd81c3e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GObjectAccessible), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkGObjectAccessible (93922956182224)>, '__doc__': None, '__gsignals__': {}, 'for_object': gi.FunctionInfo(for_object), 'get_object': gi.FunctionInfo(get_object), 'parent': <property object at 0x7f0cd7be4a90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkGObjectAccessible (93922956182224)>'
