...
class Password(__gi_repository_Gio.TlsPassword):
    """
    :Constructors:
    ...
    def do_get_value(self, *args, **kwargs): # real signature unknown
        """ get_value(self, length:int=None) -> int """
        pass
    ...
    def get_token(self): # real signature unknown; restored from __doc__
        """ get_token(self) -> Gck.Slot """
        pass

    def get_value(self, length=None): # real signature unknown; restored from __doc__
        """ get_value(self, length:int=None) -> int """
        return 0
    ...
    def new(self, flags, description): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fc2e5f82a00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Password), '__module__': 'gi.repository.Gck', '__gtype__': <GType GckPassword (94702127784752)>, '__doc__': None, '__gsignals__': {}, 'get_key': gi.FunctionInfo(get_key), 'get_module': gi.FunctionInfo(get_module), 'get_token': gi.FunctionInfo(get_token), 'parent': <property object at 0x7fc2e614d360>, 'pv': <property object at 0x7fc2e614d450>, 'reserved': <property object at 0x7fc2e614d540>})"
    __gdoc__ = 'Object GckPassword\n\nProperties from GckPassword:\n  module -> GckModule: Module\n    PKCS11 Module\n  token -> GckSlot: Token\n    PKCS11 Token\n  key -> GckObject: Object\n    PKCS11 Key Object\n\nProperties from GTlsPassword:\n  flags -> GTlsPasswordFlags: Flags\n    Flags about the password\n  description -> gchararray: Description\n    Description of what the password is for\n  warning -> gchararray: Warning\n    Warning about the password\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GckPassword (94702127784752)>'
    __info__ = ObjectInfo(Password)
