...
class ProxyPad(Pad):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42603adf70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProxyPad), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstProxyPad (94058977693104)>, '__doc__': None, '__gsignals__': {}, 'chain_default': gi.FunctionInfo(chain_default), 'chain_list_default': gi.FunctionInfo(chain_list_default), 'getrange_default': gi.FunctionInfo(getrange_default), 'iterate_internal_links_default': gi.FunctionInfo(iterate_internal_links_default), 'get_internal': gi.FunctionInfo(get_internal), 'pad': <property object at 0x7f426055eae0>, 'priv': <property object at 0x7f426055ebd0>})"
    __gdoc__ = 'Object GstProxyPad\n\nSignals from GstPad:\n  linked (GstPad)\n  unlinked (GstPad)\n\nProperties from GstPad:\n  direction -> GstPadDirection: Direction\n    The direction of the pad\n  template -> GstPadTemplate: Template\n    The GstPadTemplate of this pad\n  offset -> gint64: Offset\n    The running time offset of the pad\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstProxyPad (94058977693104)>'
    __info__ = ObjectInfo(ProxyPad)
