...
class ControlSource(Object):
    ...
    def control_source_get_value(self, timestamp): # real signature unknown; restored from __doc__
        """ control_source_get_value(self, timestamp:int) -> bool, value:float """
        return False

    def control_source_get_value_array(self, timestamp, interval, values): # real signature unknown; restored from __doc__
        """ control_source_get_value_array(self, timestamp:int, interval:int, values:list) -> bool """
        return False
    ...
    get_value_array = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42604ca8e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ControlSource), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstControlSource (94058977535632)>, '__doc__': None, '__gsignals__': {}, 'control_source_get_value': gi.FunctionInfo(control_source_get_value), 'control_source_get_value_array': gi.FunctionInfo(control_source_get_value_array), 'parent': <property object at 0x7f426072d680>, 'get_value': <property object at 0x7f426072d770>, 'get_value_array': <property object at 0x7f426072d860>, '_gst_reserved': <property object at 0x7f426072d950>})"
    __gdoc__ = 'Object GstControlSource\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstControlSource (94058977535632)>'
    __info__ = ObjectInfo(ControlSource)
