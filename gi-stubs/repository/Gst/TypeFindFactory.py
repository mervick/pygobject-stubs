...
class TypeFindFactory(PluginFeature):
    ...
    def call_function(self, find): # real signature unknown; restored from __doc__
        """ call_function(self, find:Gst.TypeFind) """
        pass
    ...
    def has_function(self): # real signature unknown; restored from __doc__
        """ has_function(self) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42601f4cd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TypeFindFactory), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstTypeFindFactory (94058978098032)>, '__doc__': None, '__gsignals__': {}, 'get_list': gi.FunctionInfo(get_list), 'call_function': gi.FunctionInfo(call_function), 'get_caps': gi.FunctionInfo(get_caps), 'get_extensions': gi.FunctionInfo(get_extensions), 'has_function': gi.FunctionInfo(has_function)})"
    __gdoc__ = 'Object GstTypeFindFactory\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstTypeFindFactory (94058978098032)>'
    __info__ = ObjectInfo(TypeFindFactory)
