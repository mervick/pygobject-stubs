...
class Bus(Object):
    ...
    def add_signal_watch(self): # real signature unknown; restored from __doc__
        """ add_signal_watch(self) """
        pass

    def add_signal_watch_full(self, priority): # real signature unknown; restored from __doc__
        """ add_signal_watch_full(self, priority:int) """
        pass

    def add_watch(self, priority, func, user_data=None): # real signature unknown; restored from __doc__
        """ add_watch(self, priority:int, func:Gst.BusFunc, user_data=None) -> int """
        return 0

    def async_signal_func(self, message, data=None): # real signature unknown; restored from __doc__
        """ async_signal_func(self, message:Gst.Message, data=None) -> bool """
        return False
    ...
    def create_watch(self): # real signature unknown; restored from __doc__
        """ create_watch(self) -> GLib.Source or None """
        pass
    ...
    def disable_sync_message_emission(self): # real signature unknown; restored from __doc__
        """ disable_sync_message_emission(self) """
        pass
    ...
    def do_sync_message(self, *args, **kwargs): # real signature unknown
    ...
    def enable_sync_message_emission(self): # real signature unknown; restored from __doc__
        """ enable_sync_message_emission(self) """
        pass
    ...
    def get_pollfd(self): # real signature unknown; restored from __doc__
        """ get_pollfd(self) -> fd:GLib.PollFD """
        pass
    ...
    def have_pending(self): # real signature unknown; restored from __doc__
        """ have_pending(self) -> bool """
        return False
    ...
    def peek(self): # real signature unknown; restored from __doc__
        """ peek(self) -> Gst.Message or None """
        pass

    def poll(self, events, timeout): # real signature unknown; restored from __doc__
        """ poll(self, events:Gst.MessageType, timeout:int) -> Gst.Message or None """
        pass

    def pop(self): # real signature unknown; restored from __doc__
        """ pop(self) -> Gst.Message or None """
        pass

    def pop_filtered(self, types): # real signature unknown; restored from __doc__
        """ pop_filtered(self, types:Gst.MessageType) -> Gst.Message or None """
        pass

    def post(self, message): # real signature unknown; restored from __doc__
        """ post(self, message:Gst.Message) -> bool """
        return False
    ...
    def remove_signal_watch(self): # real signature unknown; restored from __doc__
        """ remove_signal_watch(self) """
        pass

    def remove_watch(self): # real signature unknown; restored from __doc__
        """ remove_watch(self) -> bool """
        return False
    ...
    def set_sync_handler(self, func=None, user_data=None): # real signature unknown; restored from __doc__
        """ set_sync_handler(self, func:Gst.BusSyncHandler=None, user_data=None) """
        pass
    ...
    def sync_signal_handler(self, message, data=None): # real signature unknown; restored from __doc__
        """ sync_signal_handler(self, message:Gst.Message, data=None) -> Gst.BusSyncReply """
        pass
    ...
    def timed_pop(self, timeout): # real signature unknown; restored from __doc__
        """ timed_pop(self, timeout:int) -> Gst.Message or None """
        pass

    def timed_pop_filtered(self, timeout, types): # real signature unknown; restored from __doc__
        """ timed_pop_filtered(self, timeout:int, types:Gst.MessageType) -> Gst.Message or None """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f426048eb80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Bus), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstBus (94058977426672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_signal_watch': gi.FunctionInfo(add_signal_watch), 'add_signal_watch_full': gi.FunctionInfo(add_signal_watch_full), 'add_watch': gi.FunctionInfo(add_watch), 'async_signal_func': gi.FunctionInfo(async_signal_func), 'create_watch': gi.FunctionInfo(create_watch), 'disable_sync_message_emission': gi.FunctionInfo(disable_sync_message_emission), 'enable_sync_message_emission': gi.FunctionInfo(enable_sync_message_emission), 'get_pollfd': gi.FunctionInfo(get_pollfd), 'have_pending': gi.FunctionInfo(have_pending), 'peek': gi.FunctionInfo(peek), 'poll': gi.FunctionInfo(poll), 'pop': gi.FunctionInfo(pop), 'pop_filtered': gi.FunctionInfo(pop_filtered), 'post': gi.FunctionInfo(post), 'remove_signal_watch': gi.FunctionInfo(remove_signal_watch), 'remove_watch': gi.FunctionInfo(remove_watch), 'set_flushing': gi.FunctionInfo(set_flushing), 'set_sync_handler': gi.FunctionInfo(set_sync_handler), 'sync_signal_handler': gi.FunctionInfo(sync_signal_handler), 'timed_pop': gi.FunctionInfo(timed_pop), 'timed_pop_filtered': gi.FunctionInfo(timed_pop_filtered), 'do_message': gi.VFuncInfo(message), 'do_sync_message': gi.VFuncInfo(sync_message), 'object': <property object at 0x7f426071ecc0>, 'priv': <property object at 0x7f426071edb0>, '_gst_reserved': <property object at 0x7f426071eea0>})"
    __gdoc__ = 'Object GstBus\n\nProperties from GstBus:\n  enable-async -> gboolean: Enable Async\n    Enable async message delivery for bus watches and gst_bus_pop()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstBus (94058977426672)>'
