...
class Object(__gi_repository_GObject.InitiallyUnowned):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42604ca520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Object), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstObject (94058976953088)>, '__doc__': None, '__gsignals__': {}, 'check_uniqueness': gi.FunctionInfo(check_uniqueness), 'default_deep_notify': gi.FunctionInfo(default_deep_notify), 'replace': gi.FunctionInfo(replace), 'add_control_binding': gi.FunctionInfo(add_control_binding), 'default_error': gi.FunctionInfo(default_error), 'get_control_binding': gi.FunctionInfo(get_control_binding), 'get_control_rate': gi.FunctionInfo(get_control_rate), 'get_g_value_array': gi.FunctionInfo(get_g_value_array), 'get_name': gi.FunctionInfo(get_name), 'get_parent': gi.FunctionInfo(get_parent), 'get_path_string': gi.FunctionInfo(get_path_string), 'get_value': gi.FunctionInfo(get_value), 'has_active_control_bindings': gi.FunctionInfo(has_active_control_bindings), 'has_ancestor': gi.FunctionInfo(has_ancestor), 'has_as_ancestor': gi.FunctionInfo(has_as_ancestor), 'has_as_parent': gi.FunctionInfo(has_as_parent), 'ref': gi.FunctionInfo(ref), 'remove_control_binding': gi.FunctionInfo(remove_control_binding), 'set_control_binding_disabled': gi.FunctionInfo(set_control_binding_disabled), 'set_control_bindings_disabled': gi.FunctionInfo(set_control_bindings_disabled), 'set_control_rate': gi.FunctionInfo(set_control_rate), 'set_name': gi.FunctionInfo(set_name), 'set_parent': gi.FunctionInfo(set_parent), 'suggest_next_sync': gi.FunctionInfo(suggest_next_sync), 'sync_values': gi.FunctionInfo(sync_values), 'unparent': gi.FunctionInfo(unparent), 'unref': gi.FunctionInfo(unref), 'do_deep_notify': gi.VFuncInfo(deep_notify), 'object': <property object at 0x7f42606fe270>, 'lock': <property object at 0x7f42606fe360>, 'name': <property object at 0x7f42606fe450>, 'parent': <property object at 0x7f42606fe540>, 'flags': <property object at 0x7f42606fe630>, 'control_bindings': <property object at 0x7f42606fe770>, 'control_rate': <property object at 0x7f42606fe860>, 'last_sync': <property object at 0x7f42606fe950>, '_gst_reserved': <property object at 0x7f42606fea40>})"
    __gdoc__ = 'Object GstObject\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstObject (94058976953088)>'
