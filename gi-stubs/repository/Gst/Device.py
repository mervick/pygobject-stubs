...
class Device(Object):
    ...
    def create_element(self, name=None): # real signature unknown; restored from __doc__
    ...
    def do_create_element(self, *args, **kwargs): # real signature unknown
        """ create_element(self, name:str=None) -> Gst.Element or None """
        pass
    ...
    def do_reconfigure_element(self, *args, **kwargs): # real signature unknown
    ...
    def get_device_class(self): # real signature unknown; restored from __doc__
        """ get_device_class(self) -> str """
        return ""
    ...
    def get_properties(self): # real signature unknown; restored from __doc__
        """ get_properties(self) -> Gst.Structure or None """
        pass
    ...
    def has_classes(self, classes): # real signature unknown; restored from __doc__
        """ has_classes(self, classes:str) -> bool """
        return False

    def has_classesv(self, classes): # real signature unknown; restored from __doc__
        """ has_classesv(self, classes:list) -> bool """
        return False
    ...
    def reconfigure_element(self, element): # real signature unknown; restored from __doc__
        """ reconfigure_element(self, element:Gst.Element) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4260535d30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Device), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstDevice (94058977593424)>, '__doc__': None, '__gsignals__': {}, 'create_element': gi.FunctionInfo(create_element), 'get_caps': gi.FunctionInfo(get_caps), 'get_device_class': gi.FunctionInfo(get_device_class), 'get_display_name': gi.FunctionInfo(get_display_name), 'get_properties': gi.FunctionInfo(get_properties), 'has_classes': gi.FunctionInfo(has_classes), 'has_classesv': gi.FunctionInfo(has_classesv), 'reconfigure_element': gi.FunctionInfo(reconfigure_element), 'do_create_element': gi.VFuncInfo(create_element), 'do_reconfigure_element': gi.VFuncInfo(reconfigure_element), 'parent': <property object at 0x7f42605444a0>, 'priv': <property object at 0x7f42605445e0>, '_gst_reserved': <property object at 0x7f42605446d0>})"
    __gdoc__ = 'Object GstDevice\n\nSignals from GstDevice:\n  removed ()\n\nProperties from GstDevice:\n  display-name -> gchararray: Display Name\n    The user-friendly name of the device\n  device-class -> gchararray: Device Class\n    The Class of the device\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstDevice (94058977593424)>'
