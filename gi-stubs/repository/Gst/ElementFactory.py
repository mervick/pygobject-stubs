...
class ElementFactory(PluginFeature):
    ...
    def can_sink_all_caps(self, caps): # real signature unknown; restored from __doc__
        """ can_sink_all_caps(self, caps:Gst.Caps) -> bool """
        return False

    def can_sink_any_caps(self, caps): # real signature unknown; restored from __doc__
        """ can_sink_any_caps(self, caps:Gst.Caps) -> bool """
        return False

    def can_src_all_caps(self, caps): # real signature unknown; restored from __doc__
        """ can_src_all_caps(self, caps:Gst.Caps) -> bool """
        return False

    def can_src_any_caps(self, caps): # real signature unknown; restored from __doc__
        """ can_src_any_caps(self, caps:Gst.Caps) -> bool """
        return False
    ...
    def check_version(self, min_major, min_minor, min_micro): # real signature unknown; restored from __doc__
        """ check_version(self, min_major:int, min_minor:int, min_micro:int) -> bool """
        return False
    ...
    def create(self, name=None): # real signature unknown; restored from __doc__
        """ create(self, name:str=None) -> Gst.Element or None """
        pass
    ...
    def find(self, name): # real signature unknown; restored from __doc__
        """ find(name:str) -> Gst.ElementFactory or None """
        pass
    ...
    def get_metadata(self, key): # real signature unknown; restored from __doc__
        """ get_metadata(self, key:str) -> str or None """
        return ""

    def get_metadata_keys(self): # real signature unknown; restored from __doc__
        """ get_metadata_keys(self) -> list or None """
        return []
    ...
    def get_num_pad_templates(self): # real signature unknown; restored from __doc__
        """ get_num_pad_templates(self) -> int """
        return 0
    ...
    def get_plugin(self): # real signature unknown; restored from __doc__
        """ get_plugin(self) -> Gst.Plugin or None """
        pass

    def get_plugin_name(self): # real signature unknown; restored from __doc__
        """ get_plugin_name(self) -> str or None """
        return ""
    ...
    def get_static_pad_templates(self): # real signature unknown; restored from __doc__
        """ get_static_pad_templates(self) -> list """
        return []

    def get_uri_protocols(self): # real signature unknown; restored from __doc__
        """ get_uri_protocols(self) -> list """
        return []
    ...
    def has_interface(self, interfacename): # real signature unknown; restored from __doc__
        """ has_interface(self, interfacename:str) -> bool """
        return False
    ...
    def list_copy(self, p_list): # real signature unknown; restored from __doc__
        """ list_copy(list:list) -> list """
        return []

    def list_debug(self, p_list): # real signature unknown; restored from __doc__
        """ list_debug(list:list) """
        pass

    def list_filter(self, p_list, caps, direction, subsetonly): # real signature unknown; restored from __doc__
        """ list_filter(list:list, caps:Gst.Caps, direction:Gst.PadDirection, subsetonly:bool) -> list """
        return []

    def list_free(self, p_list): # real signature unknown; restored from __doc__
        """ list_free(list:list) """
        pass

    def list_get_elements(self, type, minrank): # real signature unknown; restored from __doc__
        """ list_get_elements(type:int, minrank:Gst.Rank) -> list """
        return []

    def list_is_type(self, type): # real signature unknown; restored from __doc__
        """ list_is_type(self, type:int) -> bool """
        return False
    ...
    def load(self): # real signature unknown; restored from __doc__
        """ load(self) -> Gst.PluginFeature or None """
        pass

    def make(self, factoryname, name=None): # real signature unknown; restored from __doc__
    ...
    def rank_compare_func(self, p1=None, p2=None): # real signature unknown; restored from __doc__
    ...
    def set_rank(self, rank): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f426048e670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ElementFactory), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstElementFactory (94058977650928)>, '__doc__': None, '__gsignals__': {}, 'find': gi.FunctionInfo(find), 'list_filter': gi.FunctionInfo(list_filter), 'list_get_elements': gi.FunctionInfo(list_get_elements), 'make': gi.FunctionInfo(make), 'can_sink_all_caps': gi.FunctionInfo(can_sink_all_caps), 'can_sink_any_caps': gi.FunctionInfo(can_sink_any_caps), 'can_src_all_caps': gi.FunctionInfo(can_src_all_caps), 'can_src_any_caps': gi.FunctionInfo(can_src_any_caps), 'create': gi.FunctionInfo(create), 'get_element_type': gi.FunctionInfo(get_element_type), 'get_metadata': gi.FunctionInfo(get_metadata), 'get_metadata_keys': gi.FunctionInfo(get_metadata_keys), 'get_num_pad_templates': gi.FunctionInfo(get_num_pad_templates), 'get_static_pad_templates': gi.FunctionInfo(get_static_pad_templates), 'get_uri_protocols': gi.FunctionInfo(get_uri_protocols), 'get_uri_type': gi.FunctionInfo(get_uri_type), 'has_interface': gi.FunctionInfo(has_interface), 'list_is_type': gi.FunctionInfo(list_is_type)})"
    __gdoc__ = 'Object GstElementFactory\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstElementFactory (94058977650928)>'
    __info__ = ObjectInfo(ElementFactory)
