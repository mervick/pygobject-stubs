...
class ControlBinding(Object):
    ...
    def do_get_g_value_array(self, *args, **kwargs): # real signature unknown
    ...
    def do_sync_values(self, *args, **kwargs): # real signature unknown
    ...
    def get_g_value_array(self, timestamp, interval, values): # real signature unknown; restored from __doc__
        """ get_g_value_array(self, timestamp:int, interval:int, values:list) -> bool """
        return False
    ...
    def get_value(self, timestamp): # real signature unknown; restored from __doc__
        """ get_value(self, timestamp:int) -> GObject.Value or None """
        pass
    ...
    def sync_values(self, p_object, timestamp, last_sync): # real signature unknown; restored from __doc__
        """ sync_values(self, object:Gst.Object, timestamp:int, last_sync:int) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4260535e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ControlBinding), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstControlBinding (94058977361344)>, '__doc__': None, '__gsignals__': {}, 'get_g_value_array': gi.FunctionInfo(get_g_value_array), 'get_value': gi.FunctionInfo(get_value), 'is_disabled': gi.FunctionInfo(is_disabled), 'set_disabled': gi.FunctionInfo(set_disabled), 'sync_values': gi.FunctionInfo(sync_values), 'do_get_g_value_array': gi.VFuncInfo(get_g_value_array), 'do_get_value': gi.VFuncInfo(get_value), 'do_sync_values': gi.VFuncInfo(sync_values), 'parent': <property object at 0x7f426072b860>, 'name': <property object at 0x7f426072b9a0>, 'pspec': <property object at 0x7f426072ba90>, 'object': <property object at 0x7f426072bb80>, 'disabled': <property object at 0x7f426072bc70>})"
    __gdoc__ = 'Object GstControlBinding\n\nProperties from GstControlBinding:\n  object -> GstObject: Object\n    The object of the property\n  name -> gchararray: Name\n    The name of the property\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstControlBinding (94058977361344)>'
    __info__ = ObjectInfo(ControlBinding)
