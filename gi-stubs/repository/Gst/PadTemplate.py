...
class PadTemplate(Object):
    ...
    def do_pad_created(self, *args, **kwargs): # real signature unknown
    ...
    def new(self, name_template, direction, presence, caps): # real signature unknown; restored from __doc__
        """ new(name_template:str, direction:Gst.PadDirection, presence:Gst.PadPresence, caps:Gst.Caps) -> Gst.PadTemplate or None """
        pass
    ...
    def new_from_static_pad_template_with_gtype(self, pad_template, pad_type): # real signature unknown; restored from __doc__
        """ new_from_static_pad_template_with_gtype(pad_template:Gst.StaticPadTemplate, pad_type:GType) -> Gst.PadTemplate or None """
        pass

    def new_with_gtype(self, name_template, direction, presence, caps, pad_type): # real signature unknown; restored from __doc__
        """ new_with_gtype(name_template:str, direction:Gst.PadDirection, presence:Gst.PadPresence, caps:Gst.Caps, pad_type:GType) -> Gst.PadTemplate or None """
        pass
    ...
    def pad_created(self, pad): # real signature unknown; restored from __doc__
        """ pad_created(self, pad:Gst.Pad) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4260238bb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PadTemplate), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstPadTemplate (94058977814336)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_static_pad_template_with_gtype': gi.FunctionInfo(new_from_static_pad_template_with_gtype), 'new_with_gtype': gi.FunctionInfo(new_with_gtype), 'get_caps': gi.FunctionInfo(get_caps), 'pad_created': gi.FunctionInfo(pad_created), 'do_pad_created': gi.VFuncInfo(pad_created), 'object': <property object at 0x7f426057ac20>, 'name_template': <property object at 0x7f426057ad10>, 'direction': <property object at 0x7f426057ae00>, 'presence': <property object at 0x7f426057aef0>, 'caps': <property object at 0x7f426057c040>})"
    __gdoc__ = 'Object GstPadTemplate\n\nSignals from GstPadTemplate:\n  pad-created (GstPad)\n\nProperties from GstPadTemplate:\n  name-template -> gchararray: Name template\n    The name template of the pad template\n  direction -> GstPadDirection: Direction\n    The direction of the pad described by the pad template\n  presence -> GstPadPresence: Presence\n    When the pad described by the pad template will become available\n  gtype -> GType: GType\n    The GType of the pad described by the pad template\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstPadTemplate (94058977814336)>'
    __info__ = ObjectInfo(PadTemplate)
