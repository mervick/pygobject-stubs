...
class DynamicTypeFactory(PluginFeature):
    ...
    def load(self, factoryname): # real signature unknown; restored from __doc__
        """ load(factoryname:str) -> GType """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f426048e130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DynamicTypeFactory), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstDynamicTypeFactory (94058977544816)>, '__doc__': None, '__gsignals__': {}, 'load': gi.FunctionInfo(load)})"
    __gdoc__ = 'Object GstDynamicTypeFactory\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstDynamicTypeFactory (94058977544816)>'
    __info__ = ObjectInfo(DynamicTypeFactory)
