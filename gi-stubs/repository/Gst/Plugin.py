...
class Plugin(Object):
    ...
    def add_dependency(self, env_vars=None, paths=None, names=None, flags): # real signature unknown; restored from __doc__
        """ add_dependency(self, env_vars:list=None, paths:list=None, names:list=None, flags:Gst.PluginDependencyFlags) """
        pass

    def add_dependency_simple(self, env_vars=None, paths=None, names=None, flags): # real signature unknown; restored from __doc__
        """ add_dependency_simple(self, env_vars:str=None, paths:str=None, names:str=None, flags:Gst.PluginDependencyFlags) """
        pass
    ...
    def get_cache_data(self): # real signature unknown; restored from __doc__
        """ get_cache_data(self) -> Gst.Structure or None """
        pass
    ...
    def get_release_date_string(self): # real signature unknown; restored from __doc__
        """ get_release_date_string(self) -> str or None """
        return ""
    ...
    def load(self): # real signature unknown; restored from __doc__
        """ load(self) -> Gst.Plugin or None """
        pass

    def load_by_name(self, name): # real signature unknown; restored from __doc__
        """ load_by_name(name:str) -> Gst.Plugin or None """
        pass

    def load_file(self, filename): # real signature unknown; restored from __doc__
        """ load_file(filename:str) -> Gst.Plugin """
        pass
    ...
    def register_static(self, major_version, minor_version, name, description, init_func, version, license, source, package, origin): # real signature unknown; restored from __doc__
        """ register_static(major_version:int, minor_version:int, name:str, description:str, init_func:Gst.PluginInitFunc, version:str, license:str, source:str, package:str, origin:str) -> bool """
        return False

    def register_static_full(self, major_version, minor_version, name, description, init_full_func, version, license, source, package, origin, user_data=None): # real signature unknown; restored from __doc__
        """ register_static_full(major_version:int, minor_version:int, name:str, description:str, init_full_func:Gst.PluginInitFullFunc, version:str, license:str, source:str, package:str, origin:str, user_data=None) -> bool """
        return False
    ...
    def set_cache_data(self, cache_data): # real signature unknown; restored from __doc__
        """ set_cache_data(self, cache_data:Gst.Structure) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f426048eee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Plugin), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstPlugin (94058977851600)>, '__doc__': None, '__gsignals__': {}, 'list_free': gi.FunctionInfo(list_free), 'load_by_name': gi.FunctionInfo(load_by_name), 'load_file': gi.FunctionInfo(load_file), 'register_static': gi.FunctionInfo(register_static), 'register_static_full': gi.FunctionInfo(register_static_full), 'add_dependency': gi.FunctionInfo(add_dependency), 'add_dependency_simple': gi.FunctionInfo(add_dependency_simple), 'get_cache_data': gi.FunctionInfo(get_cache_data), 'get_description': gi.FunctionInfo(get_description), 'get_filename': gi.FunctionInfo(get_filename), 'get_license': gi.FunctionInfo(get_license), 'get_name': gi.FunctionInfo(get_name), 'get_origin': gi.FunctionInfo(get_origin), 'get_package': gi.FunctionInfo(get_package), 'get_release_date_string': gi.FunctionInfo(get_release_date_string), 'get_source': gi.FunctionInfo(get_source), 'get_version': gi.FunctionInfo(get_version), 'is_loaded': gi.FunctionInfo(is_loaded), 'load': gi.FunctionInfo(load), 'set_cache_data': gi.FunctionInfo(set_cache_data)})"
    __gdoc__ = 'Object GstPlugin\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstPlugin (94058977851600)>'
