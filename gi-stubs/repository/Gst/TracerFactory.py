...
class TracerFactory(PluginFeature):
    ...
    def get_tracer_type(self): # real signature unknown; restored from __doc__
        """ get_tracer_type(self) -> GType """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4260048af0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TracerFactory), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstTracerFactory (94058978085984)>, '__doc__': None, '__gsignals__': {}, 'get_list': gi.FunctionInfo(get_list), 'get_tracer_type': gi.FunctionInfo(get_tracer_type)})"
    __gdoc__ = 'Object GstTracerFactory\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstTracerFactory (94058978085984)>'
    __info__ = ObjectInfo(TracerFactory)
