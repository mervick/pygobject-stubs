...
class Registry(Object):
    ...
    def add_feature(self, feature): # real signature unknown; restored from __doc__
        """ add_feature(self, feature:Gst.PluginFeature) -> bool """
        return False

    def add_plugin(self, plugin): # real signature unknown; restored from __doc__
        """ add_plugin(self, plugin:Gst.Plugin) -> bool """
        return False
    ...
    def check_feature_version(self, feature_name, min_major, min_minor, min_micro): # real signature unknown; restored from __doc__
        """ check_feature_version(self, feature_name:str, min_major:int, min_minor:int, min_micro:int) -> bool """
        return False
    ...
    def feature_filter(self, filter, first, user_data=None): # real signature unknown; restored from __doc__
        """ feature_filter(self, filter:Gst.PluginFeatureFilter, first:bool, user_data=None) -> list """
        return []

    def find_feature(self, name, type): # real signature unknown; restored from __doc__
        """ find_feature(self, name:str, type:GType) -> Gst.PluginFeature or None """
        pass

    def find_plugin(self, name): # real signature unknown; restored from __doc__
        """ find_plugin(self, name:str) -> Gst.Plugin or None """
        pass
    ...
    def fork_is_enabled(self): # real signature unknown; restored from __doc__
        """ fork_is_enabled() -> bool """
        return False

    def fork_set_enabled(self, enabled): # real signature unknown; restored from __doc__
        """ fork_set_enabled(enabled:bool) """
        pass
    ...
    def get_feature_list(self, type): # real signature unknown; restored from __doc__
        """ get_feature_list(self, type:GType) -> list """
        return []

    def get_feature_list_by_plugin(self, name): # real signature unknown; restored from __doc__
        """ get_feature_list_by_plugin(self, name:str) -> list """
        return []

    def get_feature_list_cookie(self): # real signature unknown; restored from __doc__
        """ get_feature_list_cookie(self) -> int """
        return 0
    ...
    def lookup(self, filename): # real signature unknown; restored from __doc__
        """ lookup(self, filename:str) -> Gst.Plugin or None """
        pass

    def lookup_feature(self, name): # real signature unknown; restored from __doc__
        """ lookup_feature(self, name:str) -> Gst.PluginFeature """
        pass
    ...
    def plugin_filter(self, filter, first, user_data=None): # real signature unknown; restored from __doc__
        """ plugin_filter(self, filter:Gst.PluginFilter, first:bool, user_data=None) -> list """
        return []
    ...
    def remove_feature(self, feature): # real signature unknown; restored from __doc__
        """ remove_feature(self, feature:Gst.PluginFeature) """
        pass

    def remove_plugin(self, plugin): # real signature unknown; restored from __doc__
        """ remove_plugin(self, plugin:Gst.Plugin) """
        pass
    ...
    def scan_path(self, path): # real signature unknown; restored from __doc__
        """ scan_path(self, path:str) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42602386a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Registry), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstRegistry (94058977925232)>, '__doc__': None, '__gsignals__': {}, 'fork_is_enabled': gi.FunctionInfo(fork_is_enabled), 'fork_set_enabled': gi.FunctionInfo(fork_set_enabled), 'get': gi.FunctionInfo(get), 'add_feature': gi.FunctionInfo(add_feature), 'add_plugin': gi.FunctionInfo(add_plugin), 'check_feature_version': gi.FunctionInfo(check_feature_version), 'feature_filter': gi.FunctionInfo(feature_filter), 'find_feature': gi.FunctionInfo(find_feature), 'find_plugin': gi.FunctionInfo(find_plugin), 'get_feature_list': gi.FunctionInfo(get_feature_list), 'get_feature_list_by_plugin': gi.FunctionInfo(get_feature_list_by_plugin), 'get_feature_list_cookie': gi.FunctionInfo(get_feature_list_cookie), 'get_plugin_list': gi.FunctionInfo(get_plugin_list), 'lookup': gi.FunctionInfo(lookup), 'lookup_feature': gi.FunctionInfo(lookup_feature), 'plugin_filter': gi.FunctionInfo(plugin_filter), 'remove_feature': gi.FunctionInfo(remove_feature), 'remove_plugin': gi.FunctionInfo(remove_plugin), 'scan_path': gi.FunctionInfo(scan_path), 'object': <property object at 0x7f4260512c70>, 'priv': <property object at 0x7f4260512d60>})"
    __gdoc__ = 'Object GstRegistry\n\nSignals from GstRegistry:\n  plugin-added (GstPlugin)\n  feature-added (GstPluginFeature)\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstRegistry (94058977925232)>'
