...
class BufferPool(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f426075fd00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BufferPool), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstBufferPool (94058977087712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'config_add_option': gi.FunctionInfo(config_add_option), 'config_get_allocator': gi.FunctionInfo(config_get_allocator), 'config_get_option': gi.FunctionInfo(config_get_option), 'config_get_params': gi.FunctionInfo(config_get_params), 'config_has_option': gi.FunctionInfo(config_has_option), 'config_n_options': gi.FunctionInfo(config_n_options), 'config_set_allocator': gi.FunctionInfo(config_set_allocator), 'config_set_params': gi.FunctionInfo(config_set_params), 'config_validate_params': gi.FunctionInfo(config_validate_params), 'acquire_buffer': gi.FunctionInfo(acquire_buffer), 'get_config': gi.FunctionInfo(get_config), 'get_options': gi.FunctionInfo(get_options), 'has_option': gi.FunctionInfo(has_option), 'is_active': gi.FunctionInfo(is_active), 'release_buffer': gi.FunctionInfo(release_buffer), 'set_active': gi.FunctionInfo(set_active), 'set_config': gi.FunctionInfo(set_config), 'set_flushing': gi.FunctionInfo(set_flushing), 'do_acquire_buffer': gi.VFuncInfo(acquire_buffer), 'do_alloc_buffer': gi.VFuncInfo(alloc_buffer), 'do_flush_start': gi.VFuncInfo(flush_start), 'do_flush_stop': gi.VFuncInfo(flush_stop), 'do_free_buffer': gi.VFuncInfo(free_buffer), 'do_get_options': gi.VFuncInfo(get_options), 'do_release_buffer': gi.VFuncInfo(release_buffer), 'do_reset_buffer': gi.VFuncInfo(reset_buffer), 'do_set_config': gi.VFuncInfo(set_config), 'do_start': gi.VFuncInfo(start), 'do_stop': gi.VFuncInfo(stop), 'object': <property object at 0x7f4260718c70>, 'flushing': <property object at 0x7f4260718d60>, 'priv': <property object at 0x7f4260718e50>, '_gst_reserved': <property object at 0x7f4260718f40>})"
    __gdoc__ = 'Object GstBufferPool\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstBufferPool (94058977087712)>'
    __info__ = ObjectInfo(BufferPool)
