...
class Stream(Object):
    ...
    def get_stream_flags(self): # real signature unknown; restored from __doc__
        """ get_stream_flags(self) -> Gst.StreamFlags """
        pass
    ...
    def get_stream_type(self): # real signature unknown; restored from __doc__
        """ get_stream_type(self) -> Gst.StreamType """
        pass

    def get_tags(self): # real signature unknown; restored from __doc__
        """ get_tags(self) -> Gst.TagList or None """
        pass
    ...
    def new(self, stream_id=None, caps=None, type, flags): # real signature unknown; restored from __doc__
        """ new(stream_id:str=None, caps:Gst.Caps=None, type:Gst.StreamType, flags:Gst.StreamFlags) -> Gst.Stream """
        pass
    ...
    def set_caps(self, caps=None): # real signature unknown; restored from __doc__
        """ set_caps(self, caps:Gst.Caps=None) """
        pass
    ...
    def set_stream_type(self, stream_type): # real signature unknown; restored from __doc__
        """ set_stream_type(self, stream_type:Gst.StreamType) """
        pass
    ...
    stream_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4260048100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Stream), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstStream (94058977939616)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_caps': gi.FunctionInfo(get_caps), 'get_stream_flags': gi.FunctionInfo(get_stream_flags), 'get_stream_id': gi.FunctionInfo(get_stream_id), 'get_stream_type': gi.FunctionInfo(get_stream_type), 'get_tags': gi.FunctionInfo(get_tags), 'set_caps': gi.FunctionInfo(set_caps), 'set_stream_flags': gi.FunctionInfo(set_stream_flags), 'set_stream_type': gi.FunctionInfo(set_stream_type), 'set_tags': gi.FunctionInfo(set_tags), 'object': <property object at 0x7f426051cf90>, 'stream_id': <property object at 0x7f426051e0e0>, 'priv': <property object at 0x7f426051e1d0>, '_gst_reserved': <property object at 0x7f426051e2c0>})"
    __gdoc__ = 'Object GstStream\n\nProperties from GstStream:\n  stream-id -> gchararray: Stream ID\n    The stream ID of the stream\n  stream-flags -> GstStreamFlags: Stream Flags\n    The stream flags\n  stream-type -> GstStreamType: Stream Type\n    The type of stream\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstStream (94058977939616)>'
