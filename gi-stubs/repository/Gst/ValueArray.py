...
class ValueArray(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ValueArray), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstValueArray (224)>, '__dict__': <attribute '__dict__' of 'ValueArray' objects>, '__weakref__': <attribute '__weakref__' of 'ValueArray' objects>, '__doc__': None, '__gsignals__': {}, 'append_and_take_value': gi.FunctionInfo(append_and_take_value), 'append_value': gi.FunctionInfo(append_value), 'get_size': gi.FunctionInfo(get_size), 'get_value': gi.FunctionInfo(get_value), 'prepend_value': gi.FunctionInfo(prepend_value)})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstValueArray (224)>'
    __info__ = ObjectInfo(ValueArray)
