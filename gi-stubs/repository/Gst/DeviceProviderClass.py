...
class DeviceProviderClass(__gi.Struct):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(DeviceProviderClass), '__module__': 'gi.repository.Gst', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'DeviceProviderClass' objects>, '__weakref__': <attribute '__weakref__' of 'DeviceProviderClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f4260546a90>, 'factory': <property object at 0x7f4260546b80>, 'probe': <property object at 0x7f4260546c70>, 'start': <property object at 0x7f4260546d60>, 'stop': <property object at 0x7f4260546e50>, 'metadata': <property object at 0x7f4260546f40>, '_gst_reserved': <property object at 0x7f4260549090>, 'add_metadata': gi.FunctionInfo(add_metadata), 'add_static_metadata': gi.FunctionInfo(add_static_metadata), 'get_metadata': gi.FunctionInfo(get_metadata), 'set_metadata': gi.FunctionInfo(set_metadata), 'set_static_metadata': gi.FunctionInfo(set_static_metadata)})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(DeviceProviderClass)
