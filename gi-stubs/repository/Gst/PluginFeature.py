...
class PluginFeature(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42604cae80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PluginFeature), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstPluginFeature (94058977617200)>, '__doc__': None, '__gsignals__': {}, 'list_copy': gi.FunctionInfo(list_copy), 'list_debug': gi.FunctionInfo(list_debug), 'list_free': gi.FunctionInfo(list_free), 'rank_compare_func': gi.FunctionInfo(rank_compare_func), 'check_version': gi.FunctionInfo(check_version), 'get_plugin': gi.FunctionInfo(get_plugin), 'get_plugin_name': gi.FunctionInfo(get_plugin_name), 'get_rank': gi.FunctionInfo(get_rank), 'load': gi.FunctionInfo(load), 'set_rank': gi.FunctionInfo(set_rank)})"
    __gdoc__ = 'Object GstPluginFeature\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstPluginFeature (94058977617200)>'
    __info__ = ObjectInfo(PluginFeature)
