...
class Clock(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f426076af70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Clock), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstClock (94058977319248)>, '__doc__': None, '__gsignals__': {}, 'id_compare_func': gi.FunctionInfo(id_compare_func), 'id_get_clock': gi.FunctionInfo(id_get_clock), 'id_get_time': gi.FunctionInfo(id_get_time), 'id_ref': gi.FunctionInfo(id_ref), 'id_unref': gi.FunctionInfo(id_unref), 'id_unschedule': gi.FunctionInfo(id_unschedule), 'id_uses_clock': gi.FunctionInfo(id_uses_clock), 'id_wait': gi.FunctionInfo(id_wait), 'id_wait_async': gi.FunctionInfo(id_wait_async), 'add_observation': gi.FunctionInfo(add_observation), 'add_observation_unapplied': gi.FunctionInfo(add_observation_unapplied), 'adjust_unlocked': gi.FunctionInfo(adjust_unlocked), 'adjust_with_calibration': gi.FunctionInfo(adjust_with_calibration), 'get_calibration': gi.FunctionInfo(get_calibration), 'get_internal_time': gi.FunctionInfo(get_internal_time), 'get_master': gi.FunctionInfo(get_master), 'get_resolution': gi.FunctionInfo(get_resolution), 'get_time': gi.FunctionInfo(get_time), 'get_timeout': gi.FunctionInfo(get_timeout), 'is_synced': gi.FunctionInfo(is_synced), 'new_periodic_id': gi.FunctionInfo(new_periodic_id), 'new_single_shot_id': gi.FunctionInfo(new_single_shot_id), 'periodic_id_reinit': gi.FunctionInfo(periodic_id_reinit), 'set_calibration': gi.FunctionInfo(set_calibration), 'set_master': gi.FunctionInfo(set_master), 'set_resolution': gi.FunctionInfo(set_resolution), 'set_synced': gi.FunctionInfo(set_synced), 'set_timeout': gi.FunctionInfo(set_timeout), 'single_shot_id_reinit': gi.FunctionInfo(single_shot_id_reinit), 'unadjust_unlocked': gi.FunctionInfo(unadjust_unlocked), 'unadjust_with_calibration': gi.FunctionInfo(unadjust_with_calibration), 'wait_for_sync': gi.FunctionInfo(wait_for_sync), 'do_change_resolution': gi.VFuncInfo(change_resolution), 'do_get_internal_time': gi.VFuncInfo(get_internal_time), 'do_get_resolution': gi.VFuncInfo(get_resolution), 'do_unschedule': gi.VFuncInfo(unschedule), 'do_wait': gi.VFuncInfo(wait), 'do_wait_async': gi.VFuncInfo(wait_async), 'object': <property object at 0x7f4260725db0>, 'priv': <property object at 0x7f4260725ea0>, '_gst_reserved': <property object at 0x7f4260725f90>})"
    __gdoc__ = 'Object GstClock\n\nSignals from GstClock:\n  synced (gboolean)\n\nProperties from GstClock:\n  window-size -> gint: Window size\n    The size of the window used to calculate rate and offset\n  window-threshold -> gint: Window threshold\n    The threshold to start calculating rate and offset\n  timeout -> guint64: Timeout\n    The amount of time, in nanoseconds, to sample master and slave clocks\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstClock (94058977319248)>'
    __info__ = ObjectInfo(Clock)
