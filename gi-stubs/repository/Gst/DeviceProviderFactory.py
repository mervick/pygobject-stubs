...
class DeviceProviderFactory(PluginFeature):
    ...
    def find(self, name): # real signature unknown; restored from __doc__
        """ find(name:str) -> Gst.DeviceProviderFactory or None """
        pass
    ...
    def get(self): # real signature unknown; restored from __doc__
        """ get(self) -> Gst.DeviceProvider or None """
        pass
    ...
    def get_by_name(self, factoryname): # real signature unknown; restored from __doc__
        """ get_by_name(factoryname:str) -> Gst.DeviceProvider or None """
        pass
    ...
    def get_device_provider_type(self): # real signature unknown; restored from __doc__
        """ get_device_provider_type(self) -> GType """
        pass
    ...
    def has_classes(self, classes=None): # real signature unknown; restored from __doc__
        """ has_classes(self, classes:str=None) -> bool """
        return False

    def has_classesv(self, classes=None): # real signature unknown; restored from __doc__
        """ has_classesv(self, classes:list=None) -> bool """
        return False
    ...
    def list_get_device_providers(self, minrank): # real signature unknown; restored from __doc__
        """ list_get_device_providers(minrank:Gst.Rank) -> list """
        return []
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42603ad220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceProviderFactory), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstDeviceProviderFactory (94058977617424)>, '__doc__': None, '__gsignals__': {}, 'find': gi.FunctionInfo(find), 'get_by_name': gi.FunctionInfo(get_by_name), 'list_get_device_providers': gi.FunctionInfo(list_get_device_providers), 'get': gi.FunctionInfo(get), 'get_device_provider_type': gi.FunctionInfo(get_device_provider_type), 'get_metadata': gi.FunctionInfo(get_metadata), 'get_metadata_keys': gi.FunctionInfo(get_metadata_keys), 'has_classes': gi.FunctionInfo(has_classes), 'has_classesv': gi.FunctionInfo(has_classesv)})"
    __gdoc__ = 'Object GstDeviceProviderFactory\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstDeviceProviderFactory (94058977617424)>'
    __info__ = ObjectInfo(DeviceProviderFactory)
