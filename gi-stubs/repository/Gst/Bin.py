...
class Bin(Element, ChildProxy):
    ...
    def remove(self, element): # real signature unknown; restored from __doc__
        """ remove(self, element:Gst.Element) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42604ca190>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Bin), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstBin (94058977075952)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add': gi.FunctionInfo(add), 'find_unlinked_pad': gi.FunctionInfo(find_unlinked_pad), 'get_by_interface': gi.FunctionInfo(get_by_interface), 'get_by_name': gi.FunctionInfo(get_by_name), 'get_by_name_recurse_up': gi.FunctionInfo(get_by_name_recurse_up), 'get_suppressed_flags': gi.FunctionInfo(get_suppressed_flags), 'iterate_all_by_interface': gi.FunctionInfo(iterate_all_by_interface), 'iterate_elements': gi.FunctionInfo(iterate_elements), 'iterate_recurse': gi.FunctionInfo(iterate_recurse), 'iterate_sinks': gi.FunctionInfo(iterate_sinks), 'iterate_sorted': gi.FunctionInfo(iterate_sorted), 'iterate_sources': gi.FunctionInfo(iterate_sources), 'recalculate_latency': gi.FunctionInfo(recalculate_latency), 'remove': gi.FunctionInfo(remove), 'set_suppressed_flags': gi.FunctionInfo(set_suppressed_flags), 'sync_children_states': gi.FunctionInfo(sync_children_states), 'do_add_element': gi.VFuncInfo(add_element), 'do_deep_element_added': gi.VFuncInfo(deep_element_added), 'do_deep_element_removed': gi.VFuncInfo(deep_element_removed), 'do_do_latency': gi.VFuncInfo(do_latency), 'do_element_added': gi.VFuncInfo(element_added), 'do_element_removed': gi.VFuncInfo(element_removed), 'do_handle_message': gi.VFuncInfo(handle_message), 'do_remove_element': gi.VFuncInfo(remove_element), 'element': <property object at 0x7f42607126d0>, 'numchildren': <property object at 0x7f42607127c0>, 'children': <property object at 0x7f42607128b0>, 'children_cookie': <property object at 0x7f42607129a0>, 'child_bus': <property object at 0x7f4260712a90>, 'messages': <property object at 0x7f4260712b80>, 'polling': <property object at 0x7f4260712c70>, 'state_dirty': <property object at 0x7f4260712d60>, 'clock_dirty': <property object at 0x7f4260712e50>, 'provided_clock': <property object at 0x7f4260712f40>, 'clock_provider': <property object at 0x7f4260715090>, 'priv': <property object at 0x7f4260715180>, '_gst_reserved': <property object at 0x7f4260715270>})"
    __gdoc__ = 'Object GstBin\n\nSignals from GstBin:\n  element-added (GstElement)\n  element-removed (GstElement)\n  deep-element-added (GstBin, GstElement)\n  deep-element-removed (GstBin, GstElement)\n  do-latency () -> gboolean\n\nProperties from GstBin:\n  async-handling -> gboolean: Async Handling\n    The bin will handle Asynchronous state changes\n  message-forward -> gboolean: Message Forward\n    Forwards all children messages\n\nSignals from GstChildProxy:\n  child-added (GObject, gchararray)\n  child-removed (GObject, gchararray)\n\nSignals from GstElement:\n  pad-added (GstPad)\n  pad-removed (GstPad)\n  no-more-pads ()\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstBin (94058977075952)>'
