...
class ParamArray(__gi_repository_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamArray), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstParamArray (94058977815184)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstParamArray (94058977815184)>'
