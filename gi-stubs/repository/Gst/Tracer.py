...
class Tracer(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f425ffa3b20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Tracer), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstTracer (94058978083616)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f4260530b80>, 'priv': <property object at 0x7f4260530c70>, '_gst_reserved': <property object at 0x7f4260530d60>})"
    __gdoc__ = 'Object GstTracer\n\nProperties from GstTracer:\n  params -> gchararray: Params\n    Extra configuration parameters\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstTracer (94058978083616)>'
    __info__ = ObjectInfo(Tracer)
