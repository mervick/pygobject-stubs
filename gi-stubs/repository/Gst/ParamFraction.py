...
class ParamFraction(__gi_repository_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamFraction), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstParamFraction (94058977830576)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstParamFraction (94058977830576)>'
    __info__ = ObjectInfo(ParamFraction)
