...
class TaskPool(Object):
    ...
    def do_join(self, *args, **kwargs): # real signature unknown
        """ join(self, id=None) """
        pass
    ...
    def do_push(self, *args, **kwargs): # real signature unknown
    ...
    def join(self, id=None): # real signature unknown; restored from __doc__
        """ join(self, id=None) """
        pass
    ...
    def push(self, func, user_data=None): # real signature unknown; restored from __doc__
        """ push(self, func:Gst.TaskPoolFunction, user_data=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42600480a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TaskPool), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstTaskPool (94058977806016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'cleanup': gi.FunctionInfo(cleanup), 'join': gi.FunctionInfo(join), 'prepare': gi.FunctionInfo(prepare), 'push': gi.FunctionInfo(push), 'do_cleanup': gi.VFuncInfo(cleanup), 'do_join': gi.VFuncInfo(join), 'do_prepare': gi.VFuncInfo(prepare), 'do_push': gi.VFuncInfo(push), 'object': <property object at 0x7f426052d180>, 'pool': <property object at 0x7f426052d270>, '_gst_reserved': <property object at 0x7f426052d360>})"
    __gdoc__ = 'Object GstTaskPool\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstTaskPool (94058977806016)>'
    __info__ = ObjectInfo(TaskPool)
