...
class Task(Object):
    ...
    def cleanup_all(self): # real signature unknown; restored from __doc__
        """ cleanup_all() """
        pass
    ...
    def get_pool(self): # real signature unknown; restored from __doc__
        """ get_pool(self) -> Gst.TaskPool """
        pass
    ...
    def new(self, func, user_data=None): # real signature unknown; restored from __doc__
        """ new(func:Gst.TaskFunction, user_data=None) -> Gst.Task """
        pass
    ...
    def set_enter_callback(self, enter_func, user_data=None): # real signature unknown; restored from __doc__
        """ set_enter_callback(self, enter_func:Gst.TaskThreadFunc, user_data=None) """
        pass

    def set_leave_callback(self, leave_func, user_data=None): # real signature unknown; restored from __doc__
        """ set_leave_callback(self, leave_func:Gst.TaskThreadFunc, user_data=None) """
        pass

    def set_lock(self, mutex): # real signature unknown; restored from __doc__
        """ set_lock(self, mutex:GLib.RecMutex) """
        pass
    ...
    def set_pool(self, pool): # real signature unknown; restored from __doc__
        """ set_pool(self, pool:Gst.TaskPool) """
        pass
    ...
    def set_state(self, state): # real signature unknown; restored from __doc__
        """ set_state(self, state:Gst.TaskState) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f425ffa33a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Task), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstTask (94058978042560)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'cleanup_all': gi.FunctionInfo(cleanup_all), 'get_pool': gi.FunctionInfo(get_pool), 'get_state': gi.FunctionInfo(get_state), 'join': gi.FunctionInfo(join), 'pause': gi.FunctionInfo(pause), 'set_enter_callback': gi.FunctionInfo(set_enter_callback), 'set_leave_callback': gi.FunctionInfo(set_leave_callback), 'set_lock': gi.FunctionInfo(set_lock), 'set_pool': gi.FunctionInfo(set_pool), 'set_state': gi.FunctionInfo(set_state), 'start': gi.FunctionInfo(start), 'stop': gi.FunctionInfo(stop), 'object': <property object at 0x7f426052b2c0>, 'state': <property object at 0x7f426052b3b0>, 'cond': <property object at 0x7f426052b4a0>, 'lock': <property object at 0x7f426052b590>, 'func': <property object at 0x7f426052b680>, 'user_data': <property object at 0x7f426052b770>, 'notify': <property object at 0x7f426052b860>, 'running': <property object at 0x7f426052b950>, 'thread': <property object at 0x7f426052ba40>, 'priv': <property object at 0x7f426052bb30>, '_gst_reserved': <property object at 0x7f426052bc20>})"
    __gdoc__ = 'Object GstTask\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstTask (94058978042560)>'
