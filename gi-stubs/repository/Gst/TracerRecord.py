...
class TracerRecord(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f425ffa3fd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TracerRecord), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstTracerRecord (94058978091952)>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GstTracerRecord\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstTracerRecord (94058978091952)>'
    __info__ = ObjectInfo(TracerRecord)
