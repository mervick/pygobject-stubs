...
class Pad(Object):
    ...
    def iterate_internal_links_default(self, parent=None): # real signature unknown; restored from __doc__
        """ iterate_internal_links_default(self, parent:Gst.Object=None) -> Gst.Iterator or None """
        pass
    ...
    def new(self, name=None, direction): # real signature unknown; restored from __doc__
        """ new(name:str=None, direction:Gst.PadDirection) -> Gst.Pad """
        pass
    ...
    def new_from_template(self, templ, name=None): # real signature unknown; restored from __doc__
        """ new_from_template(templ:Gst.PadTemplate, name:str=None) -> Gst.Pad """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42602d65b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Pad), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstPad (94058977692736)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'new_from_static_template': gi.FunctionInfo(new_from_static_template), 'new_from_template': gi.FunctionInfo(new_from_template), 'link_get_name': gi.FunctionInfo(link_get_name), 'activate_mode': gi.FunctionInfo(activate_mode), 'add_probe': gi.FunctionInfo(add_probe), 'can_link': gi.FunctionInfo(can_link), 'chain': gi.FunctionInfo(chain), 'chain_list': gi.FunctionInfo(chain_list), 'check_reconfigure': gi.FunctionInfo(check_reconfigure), 'create_stream_id': gi.FunctionInfo(create_stream_id), 'event_default': gi.FunctionInfo(event_default), 'forward': gi.FunctionInfo(forward), 'get_allowed_caps': gi.FunctionInfo(get_allowed_caps), 'get_current_caps': gi.FunctionInfo(get_current_caps), 'get_direction': gi.FunctionInfo(get_direction), 'get_element_private': gi.FunctionInfo(get_element_private), 'get_last_flow_return': gi.FunctionInfo(get_last_flow_return), 'get_offset': gi.FunctionInfo(get_offset), 'get_pad_template': gi.FunctionInfo(get_pad_template), 'get_pad_template_caps': gi.FunctionInfo(get_pad_template_caps), 'get_parent_element': gi.FunctionInfo(get_parent_element), 'get_peer': gi.FunctionInfo(get_peer), 'get_range': gi.FunctionInfo(get_range), 'get_sticky_event': gi.FunctionInfo(get_sticky_event), 'get_stream': gi.FunctionInfo(get_stream), 'get_stream_id': gi.FunctionInfo(get_stream_id), 'get_task_state': gi.FunctionInfo(get_task_state), 'has_current_caps': gi.FunctionInfo(has_current_caps), 'is_active': gi.FunctionInfo(is_active), 'is_blocked': gi.FunctionInfo(is_blocked), 'is_blocking': gi.FunctionInfo(is_blocking), 'is_linked': gi.FunctionInfo(is_linked), 'iterate_internal_links': gi.FunctionInfo(iterate_internal_links), 'iterate_internal_links_default': gi.FunctionInfo(iterate_internal_links_default), 'link': gi.FunctionInfo(link), 'link_full': gi.FunctionInfo(link_full), 'link_maybe_ghosting': gi.FunctionInfo(link_maybe_ghosting), 'link_maybe_ghosting_full': gi.FunctionInfo(link_maybe_ghosting_full), 'mark_reconfigure': gi.FunctionInfo(mark_reconfigure), 'needs_reconfigure': gi.FunctionInfo(needs_reconfigure), 'pause_task': gi.FunctionInfo(pause_task), 'peer_query': gi.FunctionInfo(peer_query), 'peer_query_accept_caps': gi.FunctionInfo(peer_query_accept_caps), 'peer_query_caps': gi.FunctionInfo(peer_query_caps), 'peer_query_convert': gi.FunctionInfo(peer_query_convert), 'peer_query_duration': gi.FunctionInfo(peer_query_duration), 'peer_query_position': gi.FunctionInfo(peer_query_position), 'proxy_query_accept_caps': gi.FunctionInfo(proxy_query_accept_caps), 'proxy_query_caps': gi.FunctionInfo(proxy_query_caps), 'pull_range': gi.FunctionInfo(pull_range), 'push': gi.FunctionInfo(push), 'push_event': gi.FunctionInfo(push_event), 'push_list': gi.FunctionInfo(push_list), 'query': gi.FunctionInfo(query), 'query_accept_caps': gi.FunctionInfo(query_accept_caps), 'query_caps': gi.FunctionInfo(query_caps), 'query_convert': gi.FunctionInfo(query_convert), 'query_default': gi.FunctionInfo(query_default), 'query_duration': gi.FunctionInfo(query_duration), 'query_position': gi.FunctionInfo(query_position), 'remove_probe': gi.FunctionInfo(remove_probe), 'send_event': gi.FunctionInfo(send_event), 'set_activate_function_full': gi.FunctionInfo(set_activate_function_full), 'set_activatemode_function_full': gi.FunctionInfo(set_activatemode_function_full), 'set_active': gi.FunctionInfo(set_active), 'set_chain_function_full': gi.FunctionInfo(set_chain_function_full), 'set_chain_list_function_full': gi.FunctionInfo(set_chain_list_function_full), 'set_element_private': gi.FunctionInfo(set_element_private), 'set_event_full_function_full': gi.FunctionInfo(set_event_full_function_full), 'set_event_function_full': gi.FunctionInfo(set_event_function_full), 'set_getrange_function_full': gi.FunctionInfo(set_getrange_function_full), 'set_iterate_internal_links_function_full': gi.FunctionInfo(set_iterate_internal_links_function_full), 'set_link_function_full': gi.FunctionInfo(set_link_function_full), 'set_offset': gi.FunctionInfo(set_offset), 'set_query_function_full': gi.FunctionInfo(set_query_function_full), 'set_unlink_function_full': gi.FunctionInfo(set_unlink_function_full), 'start_task': gi.FunctionInfo(start_task), 'sticky_events_foreach': gi.FunctionInfo(sticky_events_foreach), 'stop_task': gi.FunctionInfo(stop_task), 'store_sticky_event': gi.FunctionInfo(store_sticky_event), 'unlink': gi.FunctionInfo(unlink), 'use_fixed_caps': gi.FunctionInfo(use_fixed_caps), 'do_linked': gi.VFuncInfo(linked), 'do_unlinked': gi.VFuncInfo(unlinked), 'object': <property object at 0x7f4260557e00>, 'element_private': <property object at 0x7f4260557ef0>, 'padtemplate': <property object at 0x7f426055b040>, 'direction': <property object at 0x7f426055b130>, 'stream_rec_lock': <property object at 0x7f426055b220>, 'task': <property object at 0x7f426055b310>, 'block_cond': <property object at 0x7f426055b400>, 'probes': <property object at 0x7f426055b4f0>, 'mode': <property object at 0x7f426055b5e0>, 'activatefunc': <property object at 0x7f426055b6d0>, 'activatedata': <property object at 0x7f426055b7c0>, 'activatenotify': <property object at 0x7f426055b8b0>, 'activatemodefunc': <property object at 0x7f426055b9f0>, 'activatemodedata': <property object at 0x7f426055bb30>, 'activatemodenotify': <property object at 0x7f426055bc70>, 'peer': <property object at 0x7f426055bd60>, 'linkfunc': <property object at 0x7f426055be50>, 'linkdata': <property object at 0x7f426055bf40>, 'linknotify': <property object at 0x7f426055d090>, 'unlinkfunc': <property object at 0x7f426055d180>, 'unlinkdata': <property object at 0x7f426055d270>, 'unlinknotify': <property object at 0x7f426055d360>, 'chainfunc': <property object at 0x7f426055d450>, 'chaindata': <property object at 0x7f426055d540>, 'chainnotify': <property object at 0x7f426055d630>, 'chainlistfunc': <property object at 0x7f426055d720>, 'chainlistdata': <property object at 0x7f426055d810>, 'chainlistnotify': <property object at 0x7f426055d900>, 'getrangefunc': <property object at 0x7f426055d9f0>, 'getrangedata': <property object at 0x7f426055dae0>, 'getrangenotify': <property object at 0x7f426055dbd0>, 'eventfunc': <property object at 0x7f426055dcc0>, 'eventdata': <property object at 0x7f426055ddb0>, 'eventnotify': <property object at 0x7f426055dea0>, 'offset': <property object at 0x7f426055df90>, 'queryfunc': <property object at 0x7f426055e0e0>, 'querydata': <property object at 0x7f426055e1d0>, 'querynotify': <property object at 0x7f426055e2c0>, 'iterintlinkfunc': <property object at 0x7f426055e3b0>, 'iterintlinkdata': <property object at 0x7f426055e4a0>, 'iterintlinknotify': <property object at 0x7f426055e5e0>, 'num_probes': <property object at 0x7f426055e6d0>, 'num_blocked': <property object at 0x7f426055e7c0>, 'priv': <property object at 0x7f426055e8b0>})"
    __gdoc__ = 'Object GstPad\n\nSignals from GstPad:\n  linked (GstPad)\n  unlinked (GstPad)\n\nProperties from GstPad:\n  direction -> GstPadDirection: Direction\n    The direction of the pad\n  template -> GstPadTemplate: Template\n    The GstPadTemplate of this pad\n  offset -> gint64: Offset\n    The running time offset of the pad\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstPad (94058977692736)>'
    __info__ = ObjectInfo(Pad)
