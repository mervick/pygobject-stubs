...
class StreamCollection(Object):
    ...
    def add_stream(self, stream): # real signature unknown; restored from __doc__
        """ add_stream(self, stream:Gst.Stream) -> bool """
        return False
    ...
    def do_stream_notify(self, *args, **kwargs): # real signature unknown
    ...
    def get_stream(self, index): # real signature unknown; restored from __doc__
        """ get_stream(self, index:int) -> Gst.Stream or None """
        pass

    def get_upstream_id(self): # real signature unknown; restored from __doc__
        """ get_upstream_id(self) -> str """
        return ""
    ...
    def new(self, upstream_id=None): # real signature unknown; restored from __doc__
        """ new(upstream_id:str=None) -> Gst.StreamCollection """
        pass
    ...
    upstream_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f42601f4c70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StreamCollection), '__module__': 'gi.repository.Gst', '__gtype__': <GType GstStreamCollection (94058977851728)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_stream': gi.FunctionInfo(add_stream), 'get_size': gi.FunctionInfo(get_size), 'get_stream': gi.FunctionInfo(get_stream), 'get_upstream_id': gi.FunctionInfo(get_upstream_id), 'do_stream_notify': gi.VFuncInfo(stream_notify), 'object': <property object at 0x7f426051e5e0>, 'upstream_id': <property object at 0x7f426051e6d0>, 'priv': <property object at 0x7f426051e7c0>, '_gst_reserved': <property object at 0x7f426051e8b0>})"
    __gdoc__ = 'Object GstStreamCollection\n\nSignals from GstStreamCollection:\n  stream-notify (GstStream, GParam)\n\nProperties from GstStreamCollection:\n  upstream-id -> gchararray: Upstream ID\n    The stream ID of the parent stream\n\nSignals from GstObject:\n  deep-notify (GstObject, GParam)\n\nProperties from GstObject:\n  name -> gchararray: Name\n    The name of the object\n  parent -> GstObject: Parent\n    The parent of the object\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GstStreamCollection (94058977851728)>'
    __info__ = ObjectInfo(StreamCollection)
