...
class TileSource(MapSource):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2e2cac2e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TileSource), '__module__': 'gi.repository.Champlain', '__gtype__': <GType ChamplainTileSource (94016588012624)>, '__doc__': None, '__gsignals__': {}, 'get_cache': gi.FunctionInfo(get_cache), 'set_cache': gi.FunctionInfo(set_cache), 'set_id': gi.FunctionInfo(set_id), 'set_license': gi.FunctionInfo(set_license), 'set_license_uri': gi.FunctionInfo(set_license_uri), 'set_max_zoom_level': gi.FunctionInfo(set_max_zoom_level), 'set_min_zoom_level': gi.FunctionInfo(set_min_zoom_level), 'set_name': gi.FunctionInfo(set_name), 'set_projection': gi.FunctionInfo(set_projection), 'set_tile_size': gi.FunctionInfo(set_tile_size), 'parent_instance': <property object at 0x7f2e2ca8f1d0>, 'priv': <property object at 0x7f2e2ca8f2c0>})"
    __gdoc__ = "Object ChamplainTileSource\n\nProperties from ChamplainTileSource:\n  id -> gchararray: Id\n    The id of the tile source\n  name -> gchararray: Name\n    The name of the tile source\n  license -> gchararray: License\n    The usage license of the tile source\n  license-uri -> gchararray: License-uri\n    The usage license's uri for more information\n  min-zoom-level -> guint: Minimum Zoom Level\n    The minimum zoom level\n  max-zoom-level -> guint: Maximum Zoom Level\n    The maximum zoom level\n  tile-size -> guint: Tile Size\n    The tile size\n  projection -> ChamplainMapProjection: Projection\n    The map projection\n  cache -> ChamplainTileCache: Cache\n    Cache used for tile sorage\n\nProperties from ChamplainMapSource:\n  next-source -> ChamplainMapSource: Next Source\n    Next source in the loading chain\n  renderer -> ChamplainRenderer: Tile renderer\n    Tile renderer used to render tiles\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ChamplainTileSource (94016588012624)>'
