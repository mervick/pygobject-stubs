...
class Viewport(__gi_repository_Clutter.Actor):
    """
    :Constructors:
    ...
    def get_adjustments(self, hadjustment, vadjustment): # real signature unknown; restored from __doc__
        """ get_adjustments(self, hadjustment:Champlain.Adjustment, vadjustment:Champlain.Adjustment) """
        pass
    ...
    def get_anchor(self, x, y): # real signature unknown; restored from __doc__
        """ get_anchor(self, x:int, y:int) """
        pass
    ...
    def get_origin(self, x, y): # real signature unknown; restored from __doc__
    ...
    def set_actor_position(self, actor, x, y): # real signature unknown; restored from __doc__
        """ set_actor_position(self, actor:Clutter.Actor, x:float, y:float) """
        pass

    def set_adjustments(self, hadjustment, vadjustment): # real signature unknown; restored from __doc__
        """ set_adjustments(self, hadjustment:Champlain.Adjustment, vadjustment:Champlain.Adjustment) """
        pass
    ...
    def set_child(self, child): # real signature unknown; restored from __doc__
        """ set_child(self, child:Clutter.Actor) """
        pass
