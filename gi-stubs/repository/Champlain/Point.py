...
class Point(Marker, Exportable):
    ...
    ::
        ...
        Point(**properties)
        new() -> Clutter.Actor
        new_full(size:float, color:Clutter.Color) -> Clutter.Actor
    """
    ...
    def new_full(self, size, color): # real signature unknown; restored from __doc__
        """ new_full(size:float, color:Clutter.Color) -> Clutter.Actor """
        pass
