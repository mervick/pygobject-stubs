...
class MapSourceChain(MapSource):
    """
    :Constructors:
    
    ::
    
        MapSourceChain(**properties)
    ...
    def push(self, map_source): # real signature unknown; restored from __doc__
        """ push(self, map_source:Champlain.MapSource) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MapSourceChain), '__module__': 'gi.repository.Champlain', '__gtype__': <GType ChamplainMapSourceChain (94016588058432)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'pop': gi.FunctionInfo(pop), 'push': gi.FunctionInfo(push), 'parent_instance': <property object at 0x7f2e2ca969f0>, 'priv': <property object at 0x7f2e2ca96ae0>})"
    __gdoc__ = 'Object ChamplainMapSourceChain\n\nProperties from ChamplainMapSource:\n  next-source -> ChamplainMapSource: Next Source\n    Next source in the loading chain\n  renderer -> ChamplainRenderer: Tile renderer\n    Tile renderer used to render tiles\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ChamplainMapSourceChain (94016588058432)>'
    __info__ = ObjectInfo(MapSourceChain)
