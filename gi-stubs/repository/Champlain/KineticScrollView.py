...
class KineticScrollView(__gi_repository_Clutter.Actor):
    """
    :Constructors:
    
    ::
    
        KineticScrollView(**properties)
        new(kinetic:bool, viewport:Champlain.Viewport) -> Clutter.Actor
    """
    ...
    def new(self, kinetic, viewport): # real signature unknown; restored from __doc__
        """ new(kinetic:bool, viewport:Champlain.Viewport) -> Clutter.Actor """
        pass
