...
class License(__gi_repository_Clutter.Actor):
    """
    :Constructors:
    ...
    def connect_view(self, view): # real signature unknown; restored from __doc__
        """ connect_view(self, view:Champlain.View) """
        pass
    ...
    def disconnect_view(self): # real signature unknown; restored from __doc__
    ...
    def get_extra_text(self): # real signature unknown; restored from __doc__
        """ get_extra_text(self) -> str """
        return ""
    ...
    def set_extra_text(self, text): # real signature unknown; restored from __doc__
        """ set_extra_text(self, text:str) """
        pass
