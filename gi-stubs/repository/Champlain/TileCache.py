...
class TileCache(MapSource):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2e2d99e490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TileCache), '__module__': 'gi.repository.Champlain', '__gtype__': <GType ChamplainTileCache (94016587945904)>, '__doc__': None, '__gsignals__': {}, 'on_tile_filled': gi.FunctionInfo(on_tile_filled), 'refresh_tile_time': gi.FunctionInfo(refresh_tile_time), 'store_tile': gi.FunctionInfo(store_tile), 'do_on_tile_filled': gi.VFuncInfo(on_tile_filled), 'do_refresh_tile_time': gi.VFuncInfo(refresh_tile_time), 'do_store_tile': gi.VFuncInfo(store_tile), 'parent_instance': <property object at 0x7f2e2ca8c9a0>, 'priv': <property object at 0x7f2e2ca8ca90>})"
    __gdoc__ = 'Object ChamplainTileCache\n\nProperties from ChamplainMapSource:\n  next-source -> ChamplainMapSource: Next Source\n    Next source in the loading chain\n  renderer -> ChamplainRenderer: Tile renderer\n    Tile renderer used to render tiles\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ChamplainTileCache (94016587945904)>'
    __info__ = ObjectInfo(TileCache)
