...
class NetworkTileSource(TileSource):
    """
    :Constructors:
    
    ::
    
        NetworkTileSource(**properties)
        new_full(id:str, name:str, license:str, license_uri:str, min_zoom:int, max_zoom:int, tile_size:int, projection:Champlain.MapProjection, uri_format:str, renderer:Champlain.Renderer) -> Champlain.NetworkTileSource
    """
    ...
    def get_max_conns(self): # real signature unknown; restored from __doc__
        """ get_max_conns(self) -> int """
        return 0
    ...
    def get_offline(self): # real signature unknown; restored from __doc__
        """ get_offline(self) -> bool """
        return False
    ...
    def get_uri_format(self): # real signature unknown; restored from __doc__
        """ get_uri_format(self) -> str """
        return ""
    ...
    def new_full(self, id, name, license, license_uri, min_zoom, max_zoom, tile_size, projection, uri_format, renderer): # real signature unknown; restored from __doc__
        """ new_full(id:str, name:str, license:str, license_uri:str, min_zoom:int, max_zoom:int, tile_size:int, projection:Champlain.MapProjection, uri_format:str, renderer:Champlain.Renderer) -> Champlain.NetworkTileSource """
        pass
    ...
    def set_max_conns(self, max_conns): # real signature unknown; restored from __doc__
        """ set_max_conns(self, max_conns:int) """
        pass
    ...
    def set_proxy_uri(self, proxy_uri): # real signature unknown; restored from __doc__
        """ set_proxy_uri(self, proxy_uri:str) """
        pass
    ...
    def set_uri_format(self, uri_format): # real signature unknown; restored from __doc__
        """ set_uri_format(self, uri_format:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2e2ca6c850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NetworkTileSource), '__module__': 'gi.repository.Champlain', '__gtype__': <GType ChamplainNetworkTileSource (94016588104672)>, '__doc__': None, '__gsignals__': {}, 'new_full': gi.FunctionInfo(new_full), 'get_max_conns': gi.FunctionInfo(get_max_conns), 'get_offline': gi.FunctionInfo(get_offline), 'get_proxy_uri': gi.FunctionInfo(get_proxy_uri), 'get_uri_format': gi.FunctionInfo(get_uri_format), 'set_max_conns': gi.FunctionInfo(set_max_conns), 'set_offline': gi.FunctionInfo(set_offline), 'set_proxy_uri': gi.FunctionInfo(set_proxy_uri), 'set_uri_format': gi.FunctionInfo(set_uri_format), 'set_user_agent': gi.FunctionInfo(set_user_agent), 'parent_instance': <property object at 0x7f2e2ca9ed10>, 'priv': <property object at 0x7f2e2ca9ee00>})"
    __gdoc__ = "Object ChamplainNetworkTileSource\n\nProperties from ChamplainNetworkTileSource:\n  uri-format -> gchararray: URI Format\n    The URI format\n  offline -> gboolean: Offline\n    Offline\n  proxy-uri -> gchararray: Proxy URI\n    The proxy URI to use to access network\n  max-conns -> gint: Max Connection Count\n    The maximum number of allowed simultaneous connections for this tile source.\n  user-agent -> gchararray: HTTP User Agent\n    The HTTP user agent used for network requests\n\nProperties from ChamplainTileSource:\n  id -> gchararray: Id\n    The id of the tile source\n  name -> gchararray: Name\n    The name of the tile source\n  license -> gchararray: License\n    The usage license of the tile source\n  license-uri -> gchararray: License-uri\n    The usage license's uri for more information\n  min-zoom-level -> guint: Minimum Zoom Level\n    The minimum zoom level\n  max-zoom-level -> guint: Maximum Zoom Level\n    The maximum zoom level\n  tile-size -> guint: Tile Size\n    The tile size\n  projection -> ChamplainMapProjection: Projection\n    The map projection\n  cache -> ChamplainTileCache: Cache\n    Cache used for tile sorage\n\nProperties from ChamplainMapSource:\n  next-source -> ChamplainMapSource: Next Source\n    Next source in the loading chain\n  renderer -> ChamplainRenderer: Tile renderer\n    Tile renderer used to render tiles\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ChamplainNetworkTileSource (94016588104672)>'
    __info__ = ObjectInfo(NetworkTileSource)
