...
class NetworkBboxTileSource(TileSource):
    """
    :Constructors:
    
    ::
    
        NetworkBboxTileSource(**properties)
        new_full(id:str, name:str, license:str, license_uri:str, min_zoom:int, max_zoom:int, tile_size:int, projection:Champlain.MapProjection, renderer:Champlain.Renderer) -> Champlain.NetworkBboxTileSource
    """
    ...
    def get_api_uri(self): # real signature unknown; restored from __doc__
        """ get_api_uri(self) -> str """
        return ""
    ...
    def load_map_data(self, bbox): # real signature unknown; restored from __doc__
        """ load_map_data(self, bbox:Champlain.BoundingBox) """
        pass
    ...
    def set_api_uri(self, api_uri): # real signature unknown; restored from __doc__
        """ set_api_uri(self, api_uri:str) """
        pass
