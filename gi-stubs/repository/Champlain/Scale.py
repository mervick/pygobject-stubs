...
class Scale(__gi_repository_Clutter.Actor):
    """
    :Constructors:
    ...
    def set_max_width(self, value): # real signature unknown; restored from __doc__
        """ set_max_width(self, value:int) """
        pass
    ...
    def set_unit(self, unit): # real signature unknown; restored from __doc__
        """ set_unit(self, unit:Champlain.Unit) """
        pass
