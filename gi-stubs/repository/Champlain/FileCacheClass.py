...
class FileCacheClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(FileCacheClass), '__module__': 'gi.repository.Champlain', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'FileCacheClass' objects>, '__weakref__': <attribute '__weakref__' of 'FileCacheClass' objects>, '__doc__': None, 'parent_class': <property object at 0x7f2e2ca8cea0>})"
