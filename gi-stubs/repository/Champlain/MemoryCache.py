...
class MemoryCache(TileCache):
    ...
    ::
        ...
        new_full(size_limit:int, renderer:Champlain.Renderer) -> Champlain.MemoryCache
    """
    ...
    def new_full(self, size_limit, renderer): # real signature unknown; restored from __doc__
        """ new_full(size_limit:int, renderer:Champlain.Renderer) -> Champlain.MemoryCache """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f2e2ca6c9a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MemoryCache), '__module__': 'gi.repository.Champlain', '__gtype__': <GType ChamplainMemoryCache (94016588039072)>, '__doc__': None, '__gsignals__': {}, 'new_full': gi.FunctionInfo(new_full), 'clean': gi.FunctionInfo(clean), 'get_size_limit': gi.FunctionInfo(get_size_limit), 'set_size_limit': gi.FunctionInfo(set_size_limit), 'parent_instance': <property object at 0x7f2e2ca9e270>, 'priv': <property object at 0x7f2e2ca9e360>})"
    __gdoc__ = 'Object ChamplainMemoryCache\n\nProperties from ChamplainMemoryCache:\n  size-limit -> guint: Size Limit\n    Maximal number of stored tiles\n\nProperties from ChamplainMapSource:\n  next-source -> ChamplainMapSource: Next Source\n    Next source in the loading chain\n  renderer -> ChamplainRenderer: Tile renderer\n    Tile renderer used to render tiles\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ChamplainMemoryCache (94016588039072)>'
    __info__ = ObjectInfo(MemoryCache)
