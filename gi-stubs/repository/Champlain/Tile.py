...
class Tile(__gi_repository_Clutter.Actor, Exportable):
    """
    :Constructors:
    ...
    ::
        ...
        Tile(**properties)
        new() -> Champlain.Tile
        new_full(x:int, y:int, size:int, zoom_level:int) -> Champlain.Tile
    """
    ...
    def display_content(self): # real signature unknown; restored from __doc__
    ...
    def get_content(self): # real signature unknown; restored from __doc__
        """ get_content(self) -> Clutter.Actor """
        pass
    ...
    def get_fade_in(self): # real signature unknown; restored from __doc__
        """ get_fade_in(self) -> bool """
        return False
    ...
    def get_modified_time(self): # real signature unknown; restored from __doc__
        """ get_modified_time(self) -> GLib.TimeVal """
        pass
    ...
    def new_full(self, x, y, size, zoom_level): # real signature unknown; restored from __doc__
        """ new_full(x:int, y:int, size:int, zoom_level:int) -> Champlain.Tile """
        pass
    ...
    def set_content(self, actor): # real signature unknown; restored from __doc__
        """ set_content(self, actor:Clutter.Actor) """
        pass
    ...
    def set_etag(self, etag): # real signature unknown; restored from __doc__
        """ set_etag(self, etag:str) """
        pass

    def set_fade_in(self, fade_in): # real signature unknown; restored from __doc__
        """ set_fade_in(self, fade_in:bool) """
        pass
    ...
    def set_modified_time(self, time): # real signature unknown; restored from __doc__
        """ set_modified_time(self, time:GLib.TimeVal) """
        pass
    ...
    def set_state(self, state): # real signature unknown; restored from __doc__
        """ set_state(self, state:Champlain.State) """
        pass
