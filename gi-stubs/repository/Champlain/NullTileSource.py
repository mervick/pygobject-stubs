...
class NullTileSource(TileSource):
    ...
    ::
        ...
        NullTileSource(**properties)
        new_full(renderer:Champlain.Renderer) -> Champlain.NullTileSource
    """
    ...
    def new_full(self, renderer): # real signature unknown; restored from __doc__
        """ new_full(renderer:Champlain.Renderer) -> Champlain.NullTileSource """
        pass
