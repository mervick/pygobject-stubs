...
class ObjectManagerClient(__gi_repository_Gio.DBusObjectManagerClient):
    """
    :Constructors:
    ...
    ::
        ...
        new_finish(res:Gio.AsyncResult) -> UDisks.ObjectManagerClient
        new_for_bus_finish(res:Gio.AsyncResult) -> UDisks.ObjectManagerClient
        new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusObjectManagerClientFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.ObjectManagerClient
        new_sync(connection:Gio.DBusConnection, flags:Gio.DBusObjectManagerClientFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.ObjectManagerClient
    """
    ...
    def new(self, connection, flags, name=None, object_path, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ new(connection:Gio.DBusConnection, flags:Gio.DBusObjectManagerClientFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
