...
class FilesystemSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Filesystem):
    """
    :Constructors:
    
    ::
    
        FilesystemSkeleton(**properties)
        new() -> UDisks.FilesystemSkeleton
    """
