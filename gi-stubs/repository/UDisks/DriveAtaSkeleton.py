...
class DriveAtaSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, DriveAta):
    """
    :Constructors:
    
    ::
    
        DriveAtaSkeleton(**properties)
        new() -> UDisks.DriveAtaSkeleton
    """
