...
class JobSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Job):
    """
    :Constructors:
    
    ::
    
        JobSkeleton(**properties)
        new() -> UDisks.JobSkeleton
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(JobSkeleton), '__module__': 'gi.repository.UDisks', '__gtype__': <GType UDisksJobSkeleton (93969722702592)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f13a8057c20>, 'priv': <property object at 0x7f13a8057d60>})"
    __gdoc__ = 'Object UDisksJobSkeleton\n\nSignals from UDisksJob:\n  handle-cancel (GDBusMethodInvocation, GVariant) -> gboolean\n  completed (gboolean, gchararray)\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UDisksJobSkeleton (93969722702592)>'
    __info__ = ObjectInfo(JobSkeleton)
