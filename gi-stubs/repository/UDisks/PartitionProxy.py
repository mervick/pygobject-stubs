...
class PartitionProxy(__gi_overrides_Gio.DBusProxy, Partition):
    """
    :Constructors:
    
    ::
    
        PartitionProxy(**properties)
        new_finish(res:Gio.AsyncResult) -> UDisks.PartitionProxy
        new_for_bus_finish(res:Gio.AsyncResult) -> UDisks.PartitionProxy
        new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.PartitionProxy
        new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.PartitionProxy
    """
