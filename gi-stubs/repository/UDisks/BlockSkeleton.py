...
class BlockSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Block):
    """
    :Constructors:
    
    ::
    
        BlockSkeleton(**properties)
        new() -> UDisks.BlockSkeleton
    """
