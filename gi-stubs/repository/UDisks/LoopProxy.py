...
class LoopProxy(__gi_overrides_Gio.DBusProxy, Loop):
    """
    :Constructors:
    
    ::
    
        LoopProxy(**properties)
        new_finish(res:Gio.AsyncResult) -> UDisks.LoopProxy
        new_for_bus_finish(res:Gio.AsyncResult) -> UDisks.LoopProxy
        new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.LoopProxy
        new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.LoopProxy
    """
    ...
    def call_set_autoclear(self, arg_value, arg_options, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_set_autoclear(self, arg_value:bool, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_set_autoclear_finish(self, res): # real signature unknown; restored from __doc__
        """ call_set_autoclear_finish(self, res:Gio.AsyncResult) """
        pass

    def call_set_autoclear_sync(self, arg_value, arg_options, cancellable=None): # real signature unknown; restored from __doc__
        """ call_set_autoclear_sync(self, arg_value:bool, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None) """
        pass
    ...
    def complete_set_autoclear(self, invocation): # real signature unknown; restored from __doc__
        """ complete_set_autoclear(self, invocation:Gio.DBusMethodInvocation) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LoopProxy), '__module__': 'gi.repository.UDisks', '__gtype__': <GType UDisksLoopProxy (93969722458512)>, '__doc__': None, '__gsignals__': {}, 'new_finish': gi.FunctionInfo(new_finish), 'new_for_bus_finish': gi.FunctionInfo(new_for_bus_finish), 'new_for_bus_sync': gi.FunctionInfo(new_for_bus_sync), 'new_sync': gi.FunctionInfo(new_sync), 'new': gi.FunctionInfo(new), 'new_for_bus': gi.FunctionInfo(new_for_bus), 'parent_instance': <property object at 0x7f13a805ac20>, 'priv': <property object at 0x7f13a805ad10>})"
    __gdoc__ = 'Object UDisksLoopProxy\n\nSignals from UDisksLoop:\n  handle-delete (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-set-autoclear (GDBusMethodInvocation, gboolean, GVariant) -> gboolean\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UDisksLoopProxy (93969722458512)>'
    __info__ = ObjectInfo(LoopProxy)
