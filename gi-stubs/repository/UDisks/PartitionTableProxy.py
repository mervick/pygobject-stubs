...
class PartitionTableProxy(__gi_overrides_Gio.DBusProxy, PartitionTable):
    """
    :Constructors:
    
    ::
    
        PartitionTableProxy(**properties)
        new_finish(res:Gio.AsyncResult) -> UDisks.PartitionTableProxy
        new_for_bus_finish(res:Gio.AsyncResult) -> UDisks.PartitionTableProxy
        new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.PartitionTableProxy
        new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.PartitionTableProxy
    """
    ...
    def call_create_partition(self, arg_offset, arg_size, arg_type, arg_name, arg_options, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_create_partition(self, arg_offset:int, arg_size:int, arg_type:str, arg_name:str, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_create_partition_and_format(self, arg_offset, arg_size, arg_type, arg_name, arg_options, arg_format_type, arg_format_options, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_create_partition_and_format(self, arg_offset:int, arg_size:int, arg_type:str, arg_name:str, arg_options:GLib.Variant, arg_format_type:str, arg_format_options:GLib.Variant, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_create_partition_and_format_finish(self, res): # real signature unknown; restored from __doc__
        """ call_create_partition_and_format_finish(self, res:Gio.AsyncResult) -> out_created_partition:str """
        pass

    def call_create_partition_and_format_sync(self, arg_offset, arg_size, arg_type, arg_name, arg_options, arg_format_type, arg_format_options, cancellable=None): # real signature unknown; restored from __doc__
        """ call_create_partition_and_format_sync(self, arg_offset:int, arg_size:int, arg_type:str, arg_name:str, arg_options:GLib.Variant, arg_format_type:str, arg_format_options:GLib.Variant, cancellable:Gio.Cancellable=None) -> out_created_partition:str """
        pass

    def call_create_partition_finish(self, res): # real signature unknown; restored from __doc__
        """ call_create_partition_finish(self, res:Gio.AsyncResult) -> out_created_partition:str """
        pass

    def call_create_partition_sync(self, arg_offset, arg_size, arg_type, arg_name, arg_options, cancellable=None): # real signature unknown; restored from __doc__
        """ call_create_partition_sync(self, arg_offset:int, arg_size:int, arg_type:str, arg_name:str, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None) -> out_created_partition:str """
        pass
    ...
    def complete_create_partition(self, invocation, created_partition): # real signature unknown; restored from __doc__
        """ complete_create_partition(self, invocation:Gio.DBusMethodInvocation, created_partition:str) """
        pass

    def complete_create_partition_and_format(self, invocation, created_partition): # real signature unknown; restored from __doc__
        """ complete_create_partition_and_format(self, invocation:Gio.DBusMethodInvocation, created_partition:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13a7e483a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PartitionTableProxy), '__module__': 'gi.repository.UDisks', '__gtype__': <GType UDisksPartitionTableProxy (93969722702320)>, '__doc__': None, '__gsignals__': {}, 'new_finish': gi.FunctionInfo(new_finish), 'new_for_bus_finish': gi.FunctionInfo(new_for_bus_finish), 'new_for_bus_sync': gi.FunctionInfo(new_for_bus_sync), 'new_sync': gi.FunctionInfo(new_sync), 'new': gi.FunctionInfo(new), 'new_for_bus': gi.FunctionInfo(new_for_bus), 'parent_instance': <property object at 0x7f13a8074130>, 'priv': <property object at 0x7f13a8074220>})"
    __gdoc__ = 'Object UDisksPartitionTableProxy\n\nSignals from UDisksPartitionTable:\n  handle-create-partition (GDBusMethodInvocation, guint64, guint64, gchararray, gchararray, GVariant) -> gboolean\n  handle-create-partition-and-format (GDBusMethodInvocation, guint64, guint64, gchararray, gchararray, GVariant, gchararray, GVariant) -> gboolean\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UDisksPartitionTableProxy (93969722702320)>'
    __info__ = ObjectInfo(PartitionTableProxy)
