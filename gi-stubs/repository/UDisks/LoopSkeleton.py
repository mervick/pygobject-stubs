...
class LoopSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Loop):
    """
    :Constructors:
    
    ::
    
        LoopSkeleton(**properties)
        new() -> UDisks.LoopSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13a813d4f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LoopSkeleton), '__module__': 'gi.repository.UDisks', '__gtype__': <GType UDisksLoopSkeleton (93969722458912)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f13a805d180>, 'priv': <property object at 0x7f13a805d2c0>})"
    __gdoc__ = 'Object UDisksLoopSkeleton\n\nSignals from UDisksLoop:\n  handle-delete (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-set-autoclear (GDBusMethodInvocation, gboolean, GVariant) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UDisksLoopSkeleton (93969722458912)>'
    __info__ = ObjectInfo(LoopSkeleton)
