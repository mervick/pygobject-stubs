...
class MDRaidSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, MDRaid):
    """
    :Constructors:
    
    ::
    
        MDRaidSkeleton(**properties)
        new() -> UDisks.MDRaidSkeleton
    """
