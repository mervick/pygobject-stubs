...
class SwapspaceProxy(__gi_overrides_Gio.DBusProxy, Swapspace):
    """
    :Constructors:
    
    ::
    
        SwapspaceProxy(**properties)
        new_finish(res:Gio.AsyncResult) -> UDisks.SwapspaceProxy
        new_for_bus_finish(res:Gio.AsyncResult) -> UDisks.SwapspaceProxy
        new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.SwapspaceProxy
        new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.SwapspaceProxy
    """
