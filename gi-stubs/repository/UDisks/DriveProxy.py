...
class DriveProxy(__gi_overrides_Gio.DBusProxy, Drive):
    """
    :Constructors:
    
    ::
    
        DriveProxy(**properties)
        new_finish(res:Gio.AsyncResult) -> UDisks.DriveProxy
        new_for_bus_finish(res:Gio.AsyncResult) -> UDisks.DriveProxy
        new_for_bus_sync(bus_type:Gio.BusType, flags:Gio.DBusProxyFlags, name:str, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.DriveProxy
        new_sync(connection:Gio.DBusConnection, flags:Gio.DBusProxyFlags, name:str=None, object_path:str, cancellable:Gio.Cancellable=None) -> UDisks.DriveProxy
    """
    ...
    def call_eject(self, arg_options, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_eject(self, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_eject_finish(self, res): # real signature unknown; restored from __doc__
        """ call_eject_finish(self, res:Gio.AsyncResult) """
        pass

    def call_eject_sync(self, arg_options, cancellable=None): # real signature unknown; restored from __doc__
        """ call_eject_sync(self, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None) """
        pass
    ...
    def call_power_off(self, arg_options, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_power_off(self, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_power_off_finish(self, res): # real signature unknown; restored from __doc__
        """ call_power_off_finish(self, res:Gio.AsyncResult) """
        pass

    def call_power_off_sync(self, arg_options, cancellable=None): # real signature unknown; restored from __doc__
        """ call_power_off_sync(self, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None) """
        pass

    def call_set_configuration(self, arg_value, arg_options, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ call_set_configuration(self, arg_value:GLib.Variant, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def call_set_configuration_finish(self, res): # real signature unknown; restored from __doc__
        """ call_set_configuration_finish(self, res:Gio.AsyncResult) """
        pass

    def call_set_configuration_sync(self, arg_value, arg_options, cancellable=None): # real signature unknown; restored from __doc__
        """ call_set_configuration_sync(self, arg_value:GLib.Variant, arg_options:GLib.Variant, cancellable:Gio.Cancellable=None) """
        pass
    ...
    def complete_eject(self, invocation): # real signature unknown; restored from __doc__
        """ complete_eject(self, invocation:Gio.DBusMethodInvocation) """
        pass

    def complete_power_off(self, invocation): # real signature unknown; restored from __doc__
        """ complete_power_off(self, invocation:Gio.DBusMethodInvocation) """
        pass

    def complete_set_configuration(self, invocation): # real signature unknown; restored from __doc__
        """ complete_set_configuration(self, invocation:Gio.DBusMethodInvocation) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13a808b0a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DriveProxy), '__module__': 'gi.repository.UDisks', '__gtype__': <GType UDisksDriveProxy (93969722625936)>, '__doc__': None, '__gsignals__': {}, 'new_finish': gi.FunctionInfo(new_finish), 'new_for_bus_finish': gi.FunctionInfo(new_for_bus_finish), 'new_for_bus_sync': gi.FunctionInfo(new_for_bus_sync), 'new_sync': gi.FunctionInfo(new_sync), 'new': gi.FunctionInfo(new), 'new_for_bus': gi.FunctionInfo(new_for_bus), 'parent_instance': <property object at 0x7f13a816f950>, 'priv': <property object at 0x7f13a816fa90>})"
    __gdoc__ = 'Object UDisksDriveProxy\n\nSignals from UDisksDrive:\n  handle-eject (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-set-configuration (GDBusMethodInvocation, GVariant, GVariant) -> gboolean\n  handle-power-off (GDBusMethodInvocation, GVariant) -> gboolean\n\nSignals from GDBusProxy:\n  g-properties-changed (GVariant, GStrv)\n  g-signal (gchararray, gchararray, GVariant)\n\nProperties from GDBusProxy:\n  g-connection -> GDBusConnection: g-connection\n    The connection the proxy is for\n  g-bus-type -> GBusType: Bus Type\n    The bus to connect to, if any\n  g-name -> gchararray: g-name\n    The well-known or unique name that the proxy is for\n  g-name-owner -> gchararray: g-name-owner\n    The unique name for the owner\n  g-flags -> GDBusProxyFlags: g-flags\n    Flags for the proxy\n  g-object-path -> gchararray: g-object-path\n    The object path the proxy is for\n  g-interface-name -> gchararray: g-interface-name\n    The D-Bus interface name the proxy is for\n  g-default-timeout -> gint: Default Timeout\n    Timeout for remote method invocation\n  g-interface-info -> GDBusInterfaceInfo: Interface Information\n    Interface Information\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UDisksDriveProxy (93969722625936)>'
    __info__ = ObjectInfo(DriveProxy)
