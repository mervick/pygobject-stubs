...
class ObjectProxy(__gi_repository_Gio.DBusObjectProxy, Object):
    """
    :Constructors:
    ...
    ::
        ...
        new(connection:Gio.DBusConnection, object_path:str) -> UDisks.ObjectProxy
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13a8013d00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ObjectProxy), '__module__': 'gi.repository.UDisks', '__gtype__': <GType UDisksObjectProxy (93969722794016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f13a806aa40>, 'priv': <property object at 0x7f13a806ab80>})"
    __gdoc__ = 'Object UDisksObjectProxy\n\nSignals from GDBusObject:\n  interface-added (GDBusInterface)\n  interface-removed (GDBusInterface)\n\nProperties from GDBusObjectProxy:\n  g-object-path -> gchararray: Object Path\n    The object path of the proxy\n  g-connection -> GDBusConnection: Connection\n    The connection of the proxy\n\nSignals from GDBusObject:\n  interface-added (GDBusInterface)\n  interface-removed (GDBusInterface)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UDisksObjectProxy (93969722794016)>'
    __info__ = ObjectInfo(ObjectProxy)
