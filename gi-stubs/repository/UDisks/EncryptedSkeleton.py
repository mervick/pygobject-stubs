...
class EncryptedSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Encrypted):
    """
    :Constructors:
    
    ::
    
        EncryptedSkeleton(**properties)
        new() -> UDisks.EncryptedSkeleton
    """
