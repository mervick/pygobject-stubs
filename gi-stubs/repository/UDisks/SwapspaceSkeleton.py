...
class SwapspaceSkeleton(__gi_repository_Gio.DBusInterfaceSkeleton, Swapspace):
    """
    :Constructors:
    
    ::
    
        SwapspaceSkeleton(**properties)
        new() -> UDisks.SwapspaceSkeleton
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f13a8013100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SwapspaceSkeleton), '__module__': 'gi.repository.UDisks', '__gtype__': <GType UDisksSwapspaceSkeleton (93969722867232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f13a8079180>, 'priv': <property object at 0x7f13a80792c0>})"
    __gdoc__ = 'Object UDisksSwapspaceSkeleton\n\nSignals from UDisksSwapspace:\n  handle-set-label (GDBusMethodInvocation, gchararray, GVariant) -> gboolean\n  handle-start (GDBusMethodInvocation, GVariant) -> gboolean\n  handle-stop (GDBusMethodInvocation, GVariant) -> gboolean\n\nSignals from GDBusInterfaceSkeleton:\n  g-authorize-method (GDBusMethodInvocation) -> gboolean\n\nProperties from GDBusInterfaceSkeleton:\n  g-flags -> GDBusInterfaceSkeletonFlags: g-flags\n    Flags for the interface skeleton\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UDisksSwapspaceSkeleton (93969722867232)>'
    __info__ = ObjectInfo(SwapspaceSkeleton)
