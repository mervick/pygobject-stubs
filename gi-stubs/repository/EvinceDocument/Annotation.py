...
class Annotation(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6ab15b1b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Annotation), '__module__': 'gi.repository.EvinceDocument', '__gtype__': <GType EvAnnotation (94742333850800)>, '__doc__': None, '__gsignals__': {}, 'equal': gi.FunctionInfo(equal), 'get_annotation_type': gi.FunctionInfo(get_annotation_type), 'get_area': gi.FunctionInfo(get_area), 'get_color': gi.FunctionInfo(get_color), 'get_contents': gi.FunctionInfo(get_contents), 'get_modified': gi.FunctionInfo(get_modified), 'get_name': gi.FunctionInfo(get_name), 'get_page': gi.FunctionInfo(get_page), 'get_page_index': gi.FunctionInfo(get_page_index), 'get_rgba': gi.FunctionInfo(get_rgba), 'set_area': gi.FunctionInfo(set_area), 'set_color': gi.FunctionInfo(set_color), 'set_contents': gi.FunctionInfo(set_contents), 'set_modified': gi.FunctionInfo(set_modified), 'set_modified_from_time': gi.FunctionInfo(set_modified_from_time), 'set_name': gi.FunctionInfo(set_name), 'set_rgba': gi.FunctionInfo(set_rgba)})"
    __gdoc__ = 'Object EvAnnotation\n\nProperties from EvAnnotation:\n  page -> EvPage: Page\n    The page wehere the annotation is\n  contents -> gchararray: Contents\n    The annotation contents\n  name -> gchararray: Name\n    The annotation unique name\n  modified -> gchararray: Modified\n    Last modified date as string\n  color -> gpointer: Color\n    The annotation color\n  rgba -> GdkRGBA: rgba\n  area -> EvRectangle: Area\n    The area of the page where the annotation is placed\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EvAnnotation (94742333850800)>'
    __info__ = ObjectInfo(Annotation)
