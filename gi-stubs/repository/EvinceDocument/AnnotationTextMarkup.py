...
class AnnotationTextMarkup(Annotation, AnnotationMarkup):
    """
    :Constructors:
    
    ::
    
        AnnotationTextMarkup(**properties)
        highlight_new(page:EvinceDocument.Page) -> EvinceDocument.Annotation
        squiggly_new(page:EvinceDocument.Page) -> EvinceDocument.Annotation
        strike_out_new(page:EvinceDocument.Page) -> EvinceDocument.Annotation
        underline_new(page:EvinceDocument.Page) -> EvinceDocument.Annotation
    """
    ...
    def get_markup_type(self): # real signature unknown; restored from __doc__
        """ get_markup_type(self) -> EvinceDocument.AnnotationTextMarkupType """
        pass
    ...
    def highlight_new(self, page): # real signature unknown; restored from __doc__
        """ highlight_new(page:EvinceDocument.Page) -> EvinceDocument.Annotation """
        pass
    ...
    def set_markup_type(self, markup_type): # real signature unknown; restored from __doc__
        """ set_markup_type(self, markup_type:EvinceDocument.AnnotationTextMarkupType) -> bool """
        return False
    ...
    def squiggly_new(self, page): # real signature unknown; restored from __doc__
        """ squiggly_new(page:EvinceDocument.Page) -> EvinceDocument.Annotation """
        pass
    ...
    def strike_out_new(self, page): # real signature unknown; restored from __doc__
        """ strike_out_new(page:EvinceDocument.Page) -> EvinceDocument.Annotation """
        pass
    ...
    def underline_new(self, page): # real signature unknown; restored from __doc__
        """ underline_new(page:EvinceDocument.Page) -> EvinceDocument.Annotation """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6ab15b1c40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AnnotationTextMarkup), '__module__': 'gi.repository.EvinceDocument', '__gtype__': <GType EvAnnotationTextMarkup (94742333898224)>, '__doc__': None, '__gsignals__': {}, 'highlight_new': gi.FunctionInfo(highlight_new), 'squiggly_new': gi.FunctionInfo(squiggly_new), 'strike_out_new': gi.FunctionInfo(strike_out_new), 'underline_new': gi.FunctionInfo(underline_new), 'get_markup_type': gi.FunctionInfo(get_markup_type), 'set_markup_type': gi.FunctionInfo(set_markup_type)})"
    __gdoc__ = 'Object EvAnnotationTextMarkup\n\nProperties from EvAnnotationTextMarkup:\n  type -> EvAnnotationTextMarkupType: Type\n    The text markup annotation type\n\nProperties from EvAnnotation:\n  page -> EvPage: Page\n    The page wehere the annotation is\n  contents -> gchararray: Contents\n    The annotation contents\n  name -> gchararray: Name\n    The annotation unique name\n  modified -> gchararray: Modified\n    Last modified date as string\n  color -> gpointer: Color\n    The annotation color\n  rgba -> GdkRGBA: rgba\n  area -> EvRectangle: Area\n    The area of the page where the annotation is placed\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EvAnnotationTextMarkup (94742333898224)>'
    __info__ = ObjectInfo(AnnotationTextMarkup)
