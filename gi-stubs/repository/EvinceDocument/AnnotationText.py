...
class AnnotationText(Annotation, AnnotationMarkup):
    """
    :Constructors:
    
    ::
    
        AnnotationText(**properties)
        new(page:EvinceDocument.Page) -> EvinceDocument.Annotation
    """
    ...
    def get_icon(self): # real signature unknown; restored from __doc__
        """ get_icon(self) -> EvinceDocument.AnnotationTextIcon """
        pass
    ...
    def new(self, page): # real signature unknown; restored from __doc__
        """ new(page:EvinceDocument.Page) -> EvinceDocument.Annotation """
        pass
    ...
    def set_icon(self, icon): # real signature unknown; restored from __doc__
        """ set_icon(self, icon:EvinceDocument.AnnotationTextIcon) -> bool """
        return False

    def set_is_open(self, is_open): # real signature unknown; restored from __doc__
        """ set_is_open(self, is_open:bool) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f6ab16b15b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AnnotationText), '__module__': 'gi.repository.EvinceDocument', '__gtype__': <GType EvAnnotationText (94742333219632)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_icon': gi.FunctionInfo(get_icon), 'get_is_open': gi.FunctionInfo(get_is_open), 'set_icon': gi.FunctionInfo(set_icon), 'set_is_open': gi.FunctionInfo(set_is_open)})"
    __gdoc__ = 'Object EvAnnotationText\n\nProperties from EvAnnotationText:\n  icon -> EvAnnotationTextIcon: Icon\n    The icon fo the text annotation\n  is-open -> gboolean: IsOpen\n    Whether text annot is initially open\n\nProperties from EvAnnotation:\n  page -> EvPage: Page\n    The page wehere the annotation is\n  contents -> gchararray: Contents\n    The annotation contents\n  name -> gchararray: Name\n    The annotation unique name\n  modified -> gchararray: Modified\n    Last modified date as string\n  color -> gpointer: Color\n    The annotation color\n  rgba -> GdkRGBA: rgba\n  area -> EvRectangle: Area\n    The area of the page where the annotation is placed\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EvAnnotationText (94742333219632)>'
    __info__ = ObjectInfo(AnnotationText)
