...
class TypeInfo(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TypeInfo), '__module__': 'gi.repository.EvinceDocument', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TypeInfo' objects>, '__weakref__': <attribute '__weakref__' of 'TypeInfo' objects>, '__doc__': None, 'desc': <property object at 0x7f6ab15b0090>, 'mime_types': <property object at 0x7f6ab15b0180>})"
