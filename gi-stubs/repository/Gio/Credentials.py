...
class Credentials(__gi_overrides_GObject.Object):
    ...
    def get_unix_pid(self): # real signature unknown; restored from __doc__
        """ get_unix_pid(self) -> int """
        return 0

    def get_unix_user(self): # real signature unknown; restored from __doc__
        """ get_unix_user(self) -> int """
        return 0
    ...
    def set_unix_user(self, uid): # real signature unknown; restored from __doc__
        """ set_unix_user(self, uid:int) -> bool """
        return False
