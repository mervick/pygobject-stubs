...
class ListStore(ListStore):
    ...
    def find_with_equal_func(self, item, equal_func): # real signature unknown; restored from __doc__
        """ find_with_equal_func(self, item:GObject.Object, equal_func:GLib.EqualFunc) -> bool, position:int """
        return False
