...
class TlsConnection(IOStream):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4b8822d2e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TlsConnection), '__module__': 'gi.repository.Gio', '__gtype__': <GType GTlsConnection (94269257503920)>, '__doc__': None, '__gsignals__': {}, 'emit_accept_certificate': gi.FunctionInfo(emit_accept_certificate), 'get_certificate': gi.FunctionInfo(get_certificate), 'get_database': gi.FunctionInfo(get_database), 'get_interaction': gi.FunctionInfo(get_interaction), 'get_negotiated_protocol': gi.FunctionInfo(get_negotiated_protocol), 'get_peer_certificate': gi.FunctionInfo(get_peer_certificate), 'get_peer_certificate_errors': gi.FunctionInfo(get_peer_certificate_errors), 'get_rehandshake_mode': gi.FunctionInfo(get_rehandshake_mode), 'get_require_close_notify': gi.FunctionInfo(get_require_close_notify), 'get_use_system_certdb': gi.FunctionInfo(get_use_system_certdb), 'handshake': gi.FunctionInfo(handshake), 'handshake_async': gi.FunctionInfo(handshake_async), 'handshake_finish': gi.FunctionInfo(handshake_finish), 'set_advertised_protocols': gi.FunctionInfo(set_advertised_protocols), 'set_certificate': gi.FunctionInfo(set_certificate), 'set_database': gi.FunctionInfo(set_database), 'set_interaction': gi.FunctionInfo(set_interaction), 'set_rehandshake_mode': gi.FunctionInfo(set_rehandshake_mode), 'set_require_close_notify': gi.FunctionInfo(set_require_close_notify), 'set_use_system_certdb': gi.FunctionInfo(set_use_system_certdb), 'do_accept_certificate': gi.VFuncInfo(accept_certificate), 'do_handshake': gi.VFuncInfo(handshake), 'do_handshake_async': gi.VFuncInfo(handshake_async), 'do_handshake_finish': gi.VFuncInfo(handshake_finish), 'parent_instance': <property object at 0x7f4b87fd87c0>, 'priv': <property object at 0x7f4b87fd8900>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GTlsConnection (94269257503920)>'
