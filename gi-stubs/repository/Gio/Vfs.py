...
class Vfs(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f28de082a00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Vfs), '__module__': 'gi.repository.Gio', '__gtype__': <GType GVfs (94125582434352)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default), 'get_local': gi.FunctionInfo(get_local), 'get_file_for_path': gi.FunctionInfo(get_file_for_path), 'get_file_for_uri': gi.FunctionInfo(get_file_for_uri), 'get_supported_uri_schemes': gi.FunctionInfo(get_supported_uri_schemes), 'is_active': gi.FunctionInfo(is_active), 'parse_name': gi.FunctionInfo(parse_name), 'register_uri_scheme': gi.FunctionInfo(register_uri_scheme), 'unregister_uri_scheme': gi.FunctionInfo(unregister_uri_scheme), 'do_add_writable_namespaces': gi.VFuncInfo(add_writable_namespaces), 'do_get_file_for_path': gi.VFuncInfo(get_file_for_path), 'do_get_file_for_uri': gi.VFuncInfo(get_file_for_uri), 'do_get_supported_uri_schemes': gi.VFuncInfo(get_supported_uri_schemes), 'do_is_active': gi.VFuncInfo(is_active), 'do_local_file_add_info': gi.VFuncInfo(local_file_add_info), 'do_local_file_moved': gi.VFuncInfo(local_file_moved), 'do_local_file_removed': gi.VFuncInfo(local_file_removed), 'do_local_file_set_attributes': gi.VFuncInfo(local_file_set_attributes), 'do_parse_name': gi.VFuncInfo(parse_name), 'parent_instance': <property object at 0x7f28dd60bae0>})"
    __gdoc__ = 'Object GVfs\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVfs (94125582434352)>'
