...
class DBusConnection(__gi_overrides_GObject.Object, AsyncInitable, Initable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDBusConnection (94269256655488)>'
