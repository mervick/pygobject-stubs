...
class InetAddressMask(__gi_overrides_GObject.Object, Initable):
    ...
    def new(self, addr, length): # real signature unknown; restored from __doc__
        """ new(addr:Gio.InetAddress, length:int) -> Gio.InetAddressMask """
        pass
    ...
    def new_from_string(self, mask_string): # real signature unknown; restored from __doc__
        """ new_from_string(mask_string:str) -> Gio.InetAddressMask """
        pass
