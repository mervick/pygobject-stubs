...
class DBusObjectManagerClient(__gi_overrides_GObject.Object, AsyncInitable, DBusObjectManager, Initable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f28dd4ad5e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DBusObjectManagerClient), '__module__': 'gi.repository.Gio', '__gtype__': <GType GDBusObjectManagerClient (94125582140736)>, '__doc__': None, '__gsignals__': {}, 'new_finish': gi.FunctionInfo(new_finish), 'new_for_bus_finish': gi.FunctionInfo(new_for_bus_finish), 'new_for_bus_sync': gi.FunctionInfo(new_for_bus_sync), 'new_sync': gi.FunctionInfo(new_sync), 'new': gi.FunctionInfo(new), 'new_for_bus': gi.FunctionInfo(new_for_bus), 'get_connection': gi.FunctionInfo(get_connection), 'get_flags': gi.FunctionInfo(get_flags), 'get_name': gi.FunctionInfo(get_name), 'get_name_owner': gi.FunctionInfo(get_name_owner), 'do_interface_proxy_properties_changed': gi.VFuncInfo(interface_proxy_properties_changed), 'do_interface_proxy_signal': gi.VFuncInfo(interface_proxy_signal), 'parent_instance': <property object at 0x7f28ddecef40>, 'priv': <property object at 0x7f28dded10e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDBusObjectManagerClient (94125582140736)>'
