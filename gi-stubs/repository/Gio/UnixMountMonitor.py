...
class UnixMountMonitor(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    def set_rate_limit(self, limit_msec): # real signature unknown; restored from __doc__
        """ set_rate_limit(self, limit_msec:int) """
        pass
