...
class MountOperation(__gi_overrides_GObject.Object):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMountOperation (94269256629024)>'
