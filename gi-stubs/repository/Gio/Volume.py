...
class Volume(__gobject.GInterface):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(Volume), '__module__': 'gi.repository.Gio', '__gtype__': <GType GVolume (94125582434640)>, '__dict__': <attribute '__dict__' of 'Volume' objects>, '__weakref__': <attribute '__weakref__' of 'Volume' objects>, '__doc__': None, '__gsignals__': {}, 'can_eject': gi.FunctionInfo(can_eject), 'can_mount': gi.FunctionInfo(can_mount), 'eject': gi.FunctionInfo(eject), 'eject_finish': gi.FunctionInfo(eject_finish), 'eject_with_operation': gi.FunctionInfo(eject_with_operation), 'eject_with_operation_finish': gi.FunctionInfo(eject_with_operation_finish), 'enumerate_identifiers': gi.FunctionInfo(enumerate_identifiers), 'get_activation_root': gi.FunctionInfo(get_activation_root), 'get_drive': gi.FunctionInfo(get_drive), 'get_icon': gi.FunctionInfo(get_icon), 'get_identifier': gi.FunctionInfo(get_identifier), 'get_mount': gi.FunctionInfo(get_mount), 'get_name': gi.FunctionInfo(get_name), 'get_sort_key': gi.FunctionInfo(get_sort_key), 'get_symbolic_icon': gi.FunctionInfo(get_symbolic_icon), 'get_uuid': gi.FunctionInfo(get_uuid), 'mount': gi.FunctionInfo(mount), 'mount_finish': gi.FunctionInfo(mount_finish), 'should_automount': gi.FunctionInfo(should_automount)})"
    __gdoc__ = 'Interface GVolume\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GVolume (94125582434640)>'
