...
class SimpleProxyResolver(__gi_overrides_GObject.Object, ProxyResolver):
    ...
    def new(self, default_proxy=None, ignore_hosts=None): # real signature unknown; restored from __doc__
        """ new(default_proxy:str=None, ignore_hosts:str=None) -> Gio.ProxyResolver """
        pass
    ...
    def set_default_proxy(self, default_proxy): # real signature unknown; restored from __doc__
        """ set_default_proxy(self, default_proxy:str) """
        pass
