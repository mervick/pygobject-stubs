...
class DBusMethodInvocation(__gi_overrides_GObject.Object):
    ...
    def get_method_info(self): # real signature unknown; restored from __doc__
        """ get_method_info(self) -> Gio.DBusMethodInfo """
        pass
    ...
    def get_property_info(self): # real signature unknown; restored from __doc__
        """ get_property_info(self) -> Gio.DBusPropertyInfo """
        pass
    ...
    def return_value_with_unix_fd_list(self, parameters=None, fd_list=None): # real signature unknown; restored from __doc__
        """ return_value_with_unix_fd_list(self, parameters:GLib.Variant=None, fd_list:Gio.UnixFDList=None) """
        pass
