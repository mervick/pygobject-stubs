...
class Socket(__gi_overrides_GObject.Object, DatagramBased, Initable):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GSocket (94269257359104)>'
