...
class DataInputStream(BufferedInputStream):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f4b877327c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DataInputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GDataInputStream (94269256813552)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_byte_order': gi.FunctionInfo(get_byte_order), 'get_newline_type': gi.FunctionInfo(get_newline_type), 'read_byte': gi.FunctionInfo(read_byte), 'read_int16': gi.FunctionInfo(read_int16), 'read_int32': gi.FunctionInfo(read_int32), 'read_int64': gi.FunctionInfo(read_int64), 'read_line': gi.FunctionInfo(read_line), 'read_line_async': gi.FunctionInfo(read_line_async), 'read_line_finish': gi.FunctionInfo(read_line_finish), 'read_line_finish_utf8': gi.FunctionInfo(read_line_finish_utf8), 'read_line_utf8': gi.FunctionInfo(read_line_utf8), 'read_uint16': gi.FunctionInfo(read_uint16), 'read_uint32': gi.FunctionInfo(read_uint32), 'read_uint64': gi.FunctionInfo(read_uint64), 'read_until': gi.FunctionInfo(read_until), 'read_until_async': gi.FunctionInfo(read_until_async), 'read_until_finish': gi.FunctionInfo(read_until_finish), 'read_upto': gi.FunctionInfo(read_upto), 'read_upto_async': gi.FunctionInfo(read_upto_async), 'read_upto_finish': gi.FunctionInfo(read_upto_finish), 'set_byte_order': gi.FunctionInfo(set_byte_order), 'set_newline_type': gi.FunctionInfo(set_newline_type), 'parent_instance': <property object at 0x7f4b88040450>, 'priv': <property object at 0x7f4b88040540>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataInputStream (94269256813552)>'
