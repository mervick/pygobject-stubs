...
class DataInputStream(BufferedInputStream):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataInputStream (94125582186272)>'
