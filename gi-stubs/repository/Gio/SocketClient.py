...
class SocketClient(__gi_overrides_GObject.Object):
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GSocketClient (94269257369088)>'
