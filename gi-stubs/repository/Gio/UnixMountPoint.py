...
class UnixMountPoint(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(UnixMountPoint), '__module__': 'gi.repository.Gio', '__gtype__': <GType GUnixMountPoint (94269257542352)>, '__dict__': <attribute '__dict__' of 'UnixMountPoint' objects>, '__weakref__': <attribute '__weakref__' of 'UnixMountPoint' objects>, '__doc__': None, 'compare': gi.FunctionInfo(compare), 'copy': gi.FunctionInfo(copy), 'free': gi.FunctionInfo(free), 'get_device_path': gi.FunctionInfo(get_device_path), 'get_fs_type': gi.FunctionInfo(get_fs_type), 'get_mount_path': gi.FunctionInfo(get_mount_path), 'get_options': gi.FunctionInfo(get_options), 'guess_can_eject': gi.FunctionInfo(guess_can_eject), 'guess_icon': gi.FunctionInfo(guess_icon), 'guess_name': gi.FunctionInfo(guess_name), 'guess_symbolic_icon': gi.FunctionInfo(guess_symbolic_icon), 'is_loopback': gi.FunctionInfo(is_loopback), 'is_readonly': gi.FunctionInfo(is_readonly), 'is_user_mountable': gi.FunctionInfo(is_user_mountable)})"
    __gtype__ = None # (!) real value is '<GType GUnixMountPoint (94269257542352)>'
