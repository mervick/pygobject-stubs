...
class UnixFDMessage(SocketControlMessage):
    ...
    """
    def append_fd(self, fd): # real signature unknown; restored from __doc__
        """ append_fd(self, fd:int) -> bool """
        return False
    ...
    def deserialize(self, level, type, data): # real signature unknown; restored from __doc__
        """ deserialize(level:int, type:int, data:list) -> Gio.SocketControlMessage """
        pass
    ...
    def new_with_fd_list(self, fd_list): # real signature unknown; restored from __doc__
        """ new_with_fd_list(fd_list:Gio.UnixFDList) -> Gio.SocketControlMessage """
        pass
    ...
    def steal_fds(self): # real signature unknown; restored from __doc__
        """ steal_fds(self) -> list, length:int """
        return []
