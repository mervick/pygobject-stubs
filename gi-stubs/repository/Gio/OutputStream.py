...
class OutputStream(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f28dd62d550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OutputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GOutputStream (94125581550752)>, '__doc__': None, '__gsignals__': {}, 'clear_pending': gi.FunctionInfo(clear_pending), 'close': gi.FunctionInfo(close), 'close_async': gi.FunctionInfo(close_async), 'close_finish': gi.FunctionInfo(close_finish), 'flush': gi.FunctionInfo(flush), 'flush_async': gi.FunctionInfo(flush_async), 'flush_finish': gi.FunctionInfo(flush_finish), 'has_pending': gi.FunctionInfo(has_pending), 'is_closed': gi.FunctionInfo(is_closed), 'is_closing': gi.FunctionInfo(is_closing), 'set_pending': gi.FunctionInfo(set_pending), 'splice': gi.FunctionInfo(splice), 'splice_async': gi.FunctionInfo(splice_async), 'splice_finish': gi.FunctionInfo(splice_finish), 'write': gi.FunctionInfo(write), 'write_all': gi.FunctionInfo(write_all), 'write_all_async': gi.FunctionInfo(write_all_async), 'write_all_finish': gi.FunctionInfo(write_all_finish), 'write_async': gi.FunctionInfo(write_async), 'write_bytes': gi.FunctionInfo(write_bytes), 'write_bytes_async': gi.FunctionInfo(write_bytes_async), 'write_bytes_finish': gi.FunctionInfo(write_bytes_finish), 'write_finish': gi.FunctionInfo(write_finish), 'writev': gi.FunctionInfo(writev), 'writev_all': gi.FunctionInfo(writev_all), 'writev_all_async': gi.FunctionInfo(writev_all_async), 'writev_all_finish': gi.FunctionInfo(writev_all_finish), 'writev_async': gi.FunctionInfo(writev_async), 'writev_finish': gi.FunctionInfo(writev_finish), 'do_close_async': gi.VFuncInfo(close_async), 'do_close_finish': gi.VFuncInfo(close_finish), 'do_close_fn': gi.VFuncInfo(close_fn), 'do_flush': gi.VFuncInfo(flush), 'do_flush_async': gi.VFuncInfo(flush_async), 'do_flush_finish': gi.VFuncInfo(flush_finish), 'do_splice': gi.VFuncInfo(splice), 'do_splice_async': gi.VFuncInfo(splice_async), 'do_splice_finish': gi.VFuncInfo(splice_finish), 'do_write_async': gi.VFuncInfo(write_async), 'do_write_finish': gi.VFuncInfo(write_finish), 'do_write_fn': gi.VFuncInfo(write_fn), 'do_writev_async': gi.VFuncInfo(writev_async), 'do_writev_finish': gi.VFuncInfo(writev_finish), 'do_writev_fn': gi.VFuncInfo(writev_fn), 'parent_instance': <property object at 0x7f28ddf2f590>, 'priv': <property object at 0x7f28ddf2f680>})"
    __gdoc__ = 'Object GOutputStream\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GOutputStream (94125581550752)>'
