...
class Preview(AbstractPreview, __gi_repository_Dee.Serializable):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cf0dd2550>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Preview), '__module__': 'gi.repository.Unity', '__gtype__': <GType UnityPreview (26330864)>, '__doc__': None, '__gsignals__': {}, 'add_action': gi.FunctionInfo(add_action), 'add_info': gi.FunctionInfo(add_info), 'get_title': gi.FunctionInfo(get_title), 'set_title': gi.FunctionInfo(set_title), 'get_subtitle': gi.FunctionInfo(get_subtitle), 'set_subtitle': gi.FunctionInfo(set_subtitle), 'get_description_markup': gi.FunctionInfo(get_description_markup), 'set_description_markup': gi.FunctionInfo(set_description_markup), 'get_image_source_uri': gi.FunctionInfo(get_image_source_uri), 'set_image_source_uri': gi.FunctionInfo(set_image_source_uri), 'get_image': gi.FunctionInfo(get_image), 'set_image': gi.FunctionInfo(set_image), 'parent_instance': <property object at 0x7f0cf0ea9458>, 'priv': <property object at 0x7f0cf0ea94a8>})"
    __gdoc__ = 'Object UnityPreview\n\nProperties from UnityPreview:\n  title -> gchararray: title\n    title\n  subtitle -> gchararray: subtitle\n    subtitle\n  description-markup -> gchararray: description-markup\n    description-markup\n  image-source-uri -> gchararray: image-source-uri\n    image-source-uri\n  image -> GIcon: image\n    image\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UnityPreview (26330864)>'
