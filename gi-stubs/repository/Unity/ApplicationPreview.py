...
class ApplicationPreview(Preview):
    ...
    ::
        ...
        ApplicationPreview(**properties)
        new(title:str, subtitle:str, description:str, icon:Gio.Icon=None, screenshot:Gio.Icon=None) -> Unity.ApplicationPreview
    """
    ...
    get_app_icon = gi.FunctionInfo(get_app_icon)
    get_copyright = gi.FunctionInfo(get_copyright)
    ...
    get_last_update = gi.FunctionInfo(get_last_update)
    get_license = gi.FunctionInfo(get_license)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cf0e2c828>'
    serialize = gi.FunctionInfo(serialize)
    serialize_as = gi.FunctionInfo(serialize_as)
    set_app_icon = gi.FunctionInfo(set_app_icon)
    set_copyright = gi.FunctionInfo(set_copyright)
    ...
    set_last_update = gi.FunctionInfo(set_last_update)
    set_license = gi.FunctionInfo(set_license)
    set_rating = gi.FunctionInfo(set_rating)
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ApplicationPreview), '__module__': 'gi.repository.Unity', '__gtype__': <GType UnityApplicationPreview (26564736)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'set_rating': gi.FunctionInfo(set_rating), 'get_app_icon': gi.FunctionInfo(get_app_icon), 'set_app_icon': gi.FunctionInfo(set_app_icon), 'get_license': gi.FunctionInfo(get_license), 'set_license': gi.FunctionInfo(set_license), 'get_copyright': gi.FunctionInfo(get_copyright), 'set_copyright': gi.FunctionInfo(set_copyright), 'get_last_update': gi.FunctionInfo(get_last_update), 'set_last_update': gi.FunctionInfo(set_last_update), 'parent_instance': <property object at 0x7f0cf0ea9548>, 'priv': <property object at 0x7f0cf0ea9598>})"
    __gdoc__ = 'Object UnityApplicationPreview\n\nProperties from UnityApplicationPreview:\n  app-icon -> GIcon: app-icon\n    app-icon\n  license -> gchararray: license\n    license\n  copyright -> gchararray: copyright\n    copyright\n  last-update -> gchararray: last-update\n    last-update\n\nProperties from UnityPreview:\n  title -> gchararray: title\n    title\n  subtitle -> gchararray: subtitle\n    subtitle\n  description-markup -> gchararray: description-markup\n    description-markup\n  image-source-uri -> gchararray: image-source-uri\n    image-source-uri\n  image -> GIcon: image\n    image\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UnityApplicationPreview (26564736)>'
    __info__ = ObjectInfo(ApplicationPreview)
