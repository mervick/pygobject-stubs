...
class GenericPreview(Preview):
    ...
    ::
        ...
        GenericPreview(**properties)
        new(title:str, description:str, image:Gio.Icon=None) -> Unity.GenericPreview
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cf0d03cc0>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GenericPreview), '__module__': 'gi.repository.Unity', '__gtype__': <GType UnityGenericPreview (26645424)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent_instance': <property object at 0x7f0cf0eb8b38>, 'priv': <property object at 0x7f0cf0eb8b88>})"
    __gdoc__ = 'Object UnityGenericPreview\n\nProperties from UnityPreview:\n  title -> gchararray: title\n    title\n  subtitle -> gchararray: subtitle\n    subtitle\n  description-markup -> gchararray: description-markup\n    description-markup\n  image-source-uri -> gchararray: image-source-uri\n    image-source-uri\n  image -> GIcon: image\n    image\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UnityGenericPreview (26645424)>'
    __info__ = ObjectInfo(GenericPreview)
