...
class DeprecatedScopeBase(__gi_overrides_GObject.Object):
    """
    :Constructors:
    
    ::
    
        DeprecatedScopeBase(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeprecatedScopeBase), '__module__': 'gi.repository.Unity', '__gtype__': <GType UnityDeprecatedScopeBase (26543728)>, '__doc__': None, '__gsignals__': {}, 'export': gi.FunctionInfo(export), 'unexport': gi.FunctionInfo(unexport), 'get_id': gi.FunctionInfo(get_id), 'get_dbus_path': gi.FunctionInfo(get_dbus_path), 'get_search_in_global': gi.FunctionInfo(get_search_in_global), 'set_search_in_global': gi.FunctionInfo(set_search_in_global), 'get_visible': gi.FunctionInfo(get_visible), 'set_visible': gi.FunctionInfo(set_visible), 'get_is_master': gi.FunctionInfo(get_is_master), 'get_search_hint': gi.FunctionInfo(get_search_hint), 'set_search_hint': gi.FunctionInfo(set_search_hint), 'get_sources': gi.FunctionInfo(get_sources), 'get_categories': gi.FunctionInfo(get_categories), 'set_categories': gi.FunctionInfo(set_categories), 'get_filters': gi.FunctionInfo(get_filters), 'set_filters': gi.FunctionInfo(set_filters), 'get_schema': gi.FunctionInfo(get_schema), 'set_schema': gi.FunctionInfo(set_schema), 'parent_instance': <property object at 0x7f0cf0e9d868>, 'priv': <property object at 0x7f0cf0e9d8b8>})"
    __gdoc__ = 'Object UnityDeprecatedScopeBase\n\nSignals from UnityDeprecatedScopeBase:\n  active-sources-changed (GStrv, gint)\n\nProperties from UnityDeprecatedScopeBase:\n  id -> gchararray: id\n    id\n  dbus-path -> gchararray: dbus-path\n    dbus-path\n  search-in-global -> gboolean: search-in-global\n    search-in-global\n  visible -> gboolean: visible\n    visible\n  is-master -> gboolean: is-master\n    is-master\n  search-hint -> gchararray: search-hint\n    search-hint\n  sources -> UnityOptionsFilter: sources\n    sources\n  categories -> UnityCategorySet: categories\n    categories\n  filters -> UnityFilterSet: filters\n    filters\n  schema -> UnitySchema: schema\n    schema\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UnityDeprecatedScopeBase (26543728)>'
    __info__ = ObjectInfo(DeprecatedScopeBase)
