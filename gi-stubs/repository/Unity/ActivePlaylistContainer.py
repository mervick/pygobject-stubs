...
class ActivePlaylistContainer(__gi.Struct):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ActivePlaylistContainer), '__module__': 'gi.repository.Unity', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ActivePlaylistContainer' objects>, '__weakref__': <attribute '__weakref__' of 'ActivePlaylistContainer' objects>, '__doc__': None, 'valid': <property object at 0x7f0cf0e9d2c8>, 'details': <property object at 0x7f0cf0e9d318>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ActivePlaylistContainer)
