...
class MoviePreview(Preview):
    ...
    ::
        ...
        MoviePreview(**properties)
        new(title:str, subtitle:str, description:str, image:Gio.Icon=None) -> Unity.MoviePreview
    """
    ...
    get_year = gi.FunctionInfo(get_year)
    ...
    set_year = gi.FunctionInfo(set_year)
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MoviePreview), '__module__': 'gi.repository.Unity', '__gtype__': <GType UnityMoviePreview (26915904)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'set_rating': gi.FunctionInfo(set_rating), 'get_year': gi.FunctionInfo(get_year), 'set_year': gi.FunctionInfo(set_year), 'parent_instance': <property object at 0x7f0cf0e45458>, 'priv': <property object at 0x7f0cf0e454a8>})"
    __gdoc__ = 'Object UnityMoviePreview\n\nProperties from UnityMoviePreview:\n  year -> gchararray: year\n    year\n\nProperties from UnityPreview:\n  title -> gchararray: title\n    title\n  subtitle -> gchararray: subtitle\n    subtitle\n  description-markup -> gchararray: description-markup\n    description-markup\n  image-source-uri -> gchararray: image-source-uri\n    image-source-uri\n  image -> GIcon: image\n    image\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UnityMoviePreview (26915904)>'
    __info__ = ObjectInfo(MoviePreview)
