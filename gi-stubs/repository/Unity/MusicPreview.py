...
class MusicPreview(Preview):
    ...
    ::
        ...
        MusicPreview(**properties)
        new(title:str, subtitle:str, image:Gio.Icon=None) -> Unity.MusicPreview
    """
    ...
    add_track = gi.FunctionInfo(add_track)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cf0d03550>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MusicPreview), '__module__': 'gi.repository.Unity', '__gtype__': <GType UnityMusicPreview (26897120)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_track': gi.FunctionInfo(add_track), 'parent_instance': <property object at 0x7f0cf0e45bd8>, 'priv': <property object at 0x7f0cf0e45c28>})"
    __gdoc__ = 'Object UnityMusicPreview\n\nProperties from UnityPreview:\n  title -> gchararray: title\n    title\n  subtitle -> gchararray: subtitle\n    subtitle\n  description-markup -> gchararray: description-markup\n    description-markup\n  image-source-uri -> gchararray: image-source-uri\n    image-source-uri\n  image -> GIcon: image\n    image\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UnityMusicPreview (26897120)>'
    __info__ = ObjectInfo(MusicPreview)
