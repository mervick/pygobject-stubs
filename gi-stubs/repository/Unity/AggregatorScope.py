...
class AggregatorScope(DeprecatedScopeBase):
    """
    :Constructors:
    
    ::
    
        AggregatorScope(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cf0dd2128>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AggregatorScope), '__module__': 'gi.repository.Unity', '__gtype__': <GType UnityAggregatorScope (26267184)>, '__doc__': None, '__gsignals__': {}, 'category_index_for_scope_id': gi.FunctionInfo(category_index_for_scope_id), 'add_sorter': gi.FunctionInfo(add_sorter), 'add_constraint': gi.FunctionInfo(add_constraint), 'search': gi.FunctionInfo(search), 'search_finish': gi.FunctionInfo(search_finish), 'activate': gi.FunctionInfo(activate), 'activate_finish': gi.FunctionInfo(activate_finish), 'get_merge_mode': gi.FunctionInfo(get_merge_mode), 'set_merge_mode': gi.FunctionInfo(set_merge_mode), 'get_proxy_filter_hints': gi.FunctionInfo(get_proxy_filter_hints), 'set_proxy_filter_hints': gi.FunctionInfo(set_proxy_filter_hints), 'get_automatic_flushing': gi.FunctionInfo(get_automatic_flushing), 'set_automatic_flushing': gi.FunctionInfo(set_automatic_flushing), 'do_category_index_for_scope_id': gi.VFuncInfo(category_index_for_scope_id), 'do_search': gi.VFuncInfo(search), 'do_search_finish': gi.VFuncInfo(search_finish), 'do_activate': gi.VFuncInfo(activate), 'do_activate_finish': gi.VFuncInfo(activate_finish), 'parent_instance': <property object at 0x7f0cf0e9d9a8>, 'priv': <property object at 0x7f0cf0e9da48>})"
    __gdoc__ = 'Object UnityAggregatorScope\n\nProperties from UnityAggregatorScope:\n  merge-mode -> UnityAggregatorScopeMergeMode: merge-mode\n    merge-mode\n  proxy-filter-hints -> gboolean: proxy-filter-hints\n    proxy-filter-hints\n  automatic-flushing -> gboolean: automatic-flushing\n    automatic-flushing\n\nSignals from UnityDeprecatedScopeBase:\n  active-sources-changed (GStrv, gint)\n\nProperties from UnityDeprecatedScopeBase:\n  id -> gchararray: id\n    id\n  dbus-path -> gchararray: dbus-path\n    dbus-path\n  search-in-global -> gboolean: search-in-global\n    search-in-global\n  visible -> gboolean: visible\n    visible\n  is-master -> gboolean: is-master\n    is-master\n  search-hint -> gchararray: search-hint\n    search-hint\n  sources -> UnityOptionsFilter: sources\n    sources\n  categories -> UnityCategorySet: categories\n    categories\n  filters -> UnityFilterSet: filters\n    filters\n  schema -> UnitySchema: schema\n    schema\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UnityAggregatorScope (26267184)>'
    __info__ = ObjectInfo(AggregatorScope)
