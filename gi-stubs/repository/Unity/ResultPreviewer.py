...
class ResultPreviewer(ResultPreviewer):
    """
    :Constructors:
    
    ::
    
        ResultPreviewer(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f0cf0b827b8>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Unity', '__init__': <function ResultPreviewer.__init__ at 0x7f0cf7cdd1e0>, 'do_run_async': <function ResultPreviewer.do_run_async at 0x7f0cf7cdd268>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object UnityResultPreviewer\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType UnityResultPreviewer (26235440)>'
    __info__ = ObjectInfo(ResultPreviewer)
