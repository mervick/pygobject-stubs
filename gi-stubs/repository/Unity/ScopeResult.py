...
class ScopeResult(ScopeResult):
    ...
    def create(*args, **kwargs): # reliably restored by inspect
        # no doc
        pass
    ...
    dnd_uri = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    icon_hint = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    result_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Unity', 'create': <staticmethod object at 0x7f0cf7ce1390>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType UnityScopeResult (26244096)>'
    __info__ = StructInfo(ScopeResult)
