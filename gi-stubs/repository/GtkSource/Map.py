...
class Map(View):
    ...
    def get_view(self): # real signature unknown; restored from __doc__
        """ get_view(self) -> GtkSource.View or None """
        pass
    ...
    def set_view(self, view): # real signature unknown; restored from __doc__
        """ set_view(self, view:GtkSource.View) """
        pass
