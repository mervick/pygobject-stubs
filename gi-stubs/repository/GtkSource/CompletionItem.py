...
class CompletionItem(__gi_overrides_GObject.Object, CompletionProposal):
    """
    :Constructors:
    ...
    def set_gicon(self, gicon=None): # real signature unknown; restored from __doc__
        """ set_gicon(self, gicon:Gio.Icon=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f77ca442040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CompletionItem), '__module__': 'gi.repository.GtkSource', '__gtype__': <GType GtkSourceCompletionItem (94260244158192)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'set_gicon': gi.FunctionInfo(set_gicon), 'set_icon': gi.FunctionInfo(set_icon), 'set_icon_name': gi.FunctionInfo(set_icon_name), 'set_info': gi.FunctionInfo(set_info), 'set_label': gi.FunctionInfo(set_label), 'set_markup': gi.FunctionInfo(set_markup), 'set_text': gi.FunctionInfo(set_text), 'parent': <property object at 0x7f77ca6c46d0>, 'priv': <property object at 0x7f77ca6c47c0>})"
    __gdoc__ = 'Object GtkSourceCompletionItem\n\nProperties from GtkSourceCompletionItem:\n  label -> gchararray: Label\n    \n  markup -> gchararray: Markup\n    \n  text -> gchararray: Text\n    \n  icon -> GdkPixbuf: Icon\n    \n  icon-name -> gchararray: Icon Name\n    \n  gicon -> GIcon: GIcon\n    \n  info -> gchararray: Info\n    \n\nSignals from GtkSourceCompletionProposal:\n  changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSourceCompletionItem (94260244158192)>'
    __info__ = ObjectInfo(CompletionItem)
