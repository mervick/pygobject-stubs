...
class Completion(__gi_overrides_GObject.Object, __gi_repository_Gtk.Buildable):
    """
    :Constructors:
    ...
    def add_provider(self, provider): # real signature unknown; restored from __doc__
        """ add_provider(self, provider:GtkSource.CompletionProvider) -> bool """
        return False
    ...
    def block_interactive(self): # real signature unknown; restored from __doc__
    ...
    def create_context(self, position=None): # real signature unknown; restored from __doc__
        """ create_context(self, position:Gtk.TextIter=None) -> GtkSource.CompletionContext """
        pass
    ...
    def do_activate_proposal(self, *args, **kwargs): # real signature unknown
        """ activate_proposal(self) """
        pass
    ...
    def do_move_cursor(self, *args, **kwargs): # real signature unknown
        """ move_cursor(self, step:Gtk.ScrollStep, num:int) """
        pass

    def do_move_page(self, *args, **kwargs): # real signature unknown
        """ move_page(self, step:Gtk.ScrollStep, num:int) """
        pass

    def do_populate_context(self, *args, **kwargs): # real signature unknown
        """ populate_context(self, context:GtkSource.CompletionContext) """
        pass

    def do_proposal_activated(self, *args, **kwargs): # real signature unknown
        """ proposal_activated(self, provider:GtkSource.CompletionProvider, proposal:GtkSource.CompletionProposal) -> bool """
        pass
    ...
    def get_info_window(self): # real signature unknown; restored from __doc__
    ...
    def remove_provider(self, provider): # real signature unknown; restored from __doc__
        """ remove_provider(self, provider:GtkSource.CompletionProvider) -> bool """
        return False
    ...
    def start(self, providers=None, context): # real signature unknown; restored from __doc__
        """ start(self, providers:list=None, context:GtkSource.CompletionContext) -> bool """
        return False
    ...
    def unblock_interactive(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f77ca788eb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Completion), '__module__': 'gi.repository.GtkSource', '__gtype__': <GType GtkSourceCompletion (94260244431984)>, '__doc__': None, '__gsignals__': {}, 'add_provider': gi.FunctionInfo(add_provider), 'block_interactive': gi.FunctionInfo(block_interactive), 'create_context': gi.FunctionInfo(create_context), 'get_info_window': gi.FunctionInfo(get_info_window), 'get_providers': gi.FunctionInfo(get_providers), 'get_view': gi.FunctionInfo(get_view), 'hide': gi.FunctionInfo(hide), 'remove_provider': gi.FunctionInfo(remove_provider), 'start': gi.FunctionInfo(start), 'unblock_interactive': gi.FunctionInfo(unblock_interactive), 'do_activate_proposal': gi.VFuncInfo(activate_proposal), 'do_hide': gi.VFuncInfo(hide), 'do_move_cursor': gi.VFuncInfo(move_cursor), 'do_move_page': gi.VFuncInfo(move_page), 'do_populate_context': gi.VFuncInfo(populate_context), 'do_proposal_activated': gi.VFuncInfo(proposal_activated), 'do_show': gi.VFuncInfo(show), 'parent_instance': <property object at 0x7f77ca6be720>, 'priv': <property object at 0x7f77ca6be900>})"
    __gdoc__ = 'Object GtkSourceCompletion\n\nSignals from GtkSourceCompletion:\n  show ()\n  hide ()\n  populate-context (GtkSourceCompletionContext)\n  move-cursor (GtkScrollStep, gint)\n  move-page (GtkScrollStep, gint)\n  activate-proposal ()\n\nProperties from GtkSourceCompletion:\n  view -> GtkSourceView: View\n    The GtkSourceView bound to the completion\n  remember-info-visibility -> gboolean: Remember Info Visibility\n    Remember the last info window visibility state\n  select-on-show -> gboolean: Select on Show\n    Select first proposal when completion is shown\n  show-headers -> gboolean: Show Headers\n    Show provider headers when proposals from multiple providers are available\n  show-icons -> gboolean: Show Icons\n    Show provider and proposal icons in the completion popup\n  accelerators -> guint: Accelerators\n    Number of proposal accelerators to show\n  auto-complete-delay -> guint: Auto Complete Delay\n    Completion popup delay for interactive completion\n  provider-page-size -> guint: Provider Page Size\n    Provider scrolling page size\n  proposal-page-size -> guint: Proposal Page Size\n    Proposal scrolling page size\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSourceCompletion (94260244431984)>'
    __info__ = ObjectInfo(Completion)
