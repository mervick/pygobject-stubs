...
class Style(__gi_overrides_GObject.Object):
    ...
    ::
        ...
        Style(**properties)
    """
    def apply(self, tag): # real signature unknown; restored from __doc__
        """ apply(self, tag:Gtk.TextTag) """
        pass
