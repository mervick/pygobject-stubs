...
class CompletionWords(__gi_overrides_GObject.Object, CompletionProvider):
    """
    :Constructors:
    ...
    def new(self, name=None, icon=None): # real signature unknown; restored from __doc__
        """ new(name:str=None, icon:GdkPixbuf.Pixbuf=None) -> GtkSource.CompletionWords """
        pass
    ...
    def register(self, buffer): # real signature unknown; restored from __doc__
        """ register(self, buffer:Gtk.TextBuffer) """
        pass
    ...
    def unregister(self, buffer): # real signature unknown; restored from __doc__
        """ unregister(self, buffer:Gtk.TextBuffer) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f77ca6f0e80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CompletionWords), '__module__': 'gi.repository.GtkSource', '__gtype__': <GType GtkSourceCompletionWords (94260244085312)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'register': gi.FunctionInfo(register), 'unregister': gi.FunctionInfo(unregister), 'parent': <property object at 0x7f77ca6c97c0>, 'priv': <property object at 0x7f77ca6c98b0>})"
    __gdoc__ = 'Object GtkSourceCompletionWords\n\nProperties from GtkSourceCompletionWords:\n  name -> gchararray: Name\n    The provider name\n  icon -> GdkPixbuf: Icon\n    The provider icon\n  proposals-batch-size -> guint: Proposals Batch Size\n    Number of proposals added in one batch\n  scan-batch-size -> guint: Scan Batch Size\n    Number of lines scanned in one batch\n  minimum-word-size -> guint: Minimum Word Size\n    The minimum word size to complete\n  interactive-delay -> gint: Interactive Delay\n    The delay before initiating interactive completion\n  priority -> gint: Priority\n    Provider priority\n  activation -> GtkSourceCompletionActivation: Activation\n    The type of activation\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSourceCompletionWords (94260244085312)>'
    __info__ = ObjectInfo(CompletionWords)
