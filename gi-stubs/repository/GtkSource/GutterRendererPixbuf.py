...
class GutterRendererPixbuf(GutterRenderer):
    ...
    def set_gicon(self, icon=None): # real signature unknown; restored from __doc__
        """ set_gicon(self, icon:Gio.Icon=None) """
        pass
    ...
    def set_pixbuf(self, pixbuf=None): # real signature unknown; restored from __doc__
        """ set_pixbuf(self, pixbuf:GdkPixbuf.Pixbuf=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f77ca471e50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GutterRendererPixbuf), '__module__': 'gi.repository.GtkSource', '__gtype__': <GType GtkSourceGutterRendererPixbuf (94260244521808)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_gicon': gi.FunctionInfo(get_gicon), 'get_icon_name': gi.FunctionInfo(get_icon_name), 'get_pixbuf': gi.FunctionInfo(get_pixbuf), 'set_gicon': gi.FunctionInfo(set_gicon), 'set_icon_name': gi.FunctionInfo(set_icon_name), 'set_pixbuf': gi.FunctionInfo(set_pixbuf), 'parent': <property object at 0x7f77ca6d2770>, 'priv': <property object at 0x7f77ca6d2860>})"
    __gdoc__ = 'Object GtkSourceGutterRendererPixbuf\n\nProperties from GtkSourceGutterRendererPixbuf:\n  pixbuf -> GdkPixbuf: Pixbuf\n    The pixbuf\n  icon-name -> gchararray: Icon Name\n    The icon name\n  gicon -> GIcon: GIcon\n    The gicon\n\nSignals from GtkSourceGutterRenderer:\n  query-tooltip (GtkTextIter, GdkRectangle, gint, gint, GtkTooltip) -> gboolean\n  activate (GtkTextIter, GdkRectangle, GdkEvent)\n  queue-draw ()\n  query-data (GtkTextIter, GtkTextIter, GtkSourceGutterRendererState)\n  query-activatable (GtkTextIter, GdkRectangle, GdkEvent) -> gboolean\n\nProperties from GtkSourceGutterRenderer:\n  visible -> gboolean: Visible\n    Visible\n  xpad -> gint: X Padding\n    The x-padding\n  ypad -> gint: Y Padding\n    The y-padding\n  xalign -> gfloat: X Alignment\n    The x-alignment\n  yalign -> gfloat: Y Alignment\n    The y-alignment\n  view -> GtkTextView: The View\n    The view\n  alignment-mode -> GtkSourceGutterRendererAlignmentMode: Alignment Mode\n    The alignment mode\n  window-type -> GtkTextWindowType: Window Type\n    The window type\n  size -> gint: Size\n    The size\n  background-rgba -> GdkRGBA: Background Color\n    The background color\n  background-set -> gboolean: Background Set\n    Whether the background color is set\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSourceGutterRendererPixbuf (94260244521808)>'
    __info__ = ObjectInfo(GutterRendererPixbuf)
