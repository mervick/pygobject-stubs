...
class GutterRendererText(GutterRenderer):
    ...
    def measure(self, text): # real signature unknown; restored from __doc__
        """ measure(self, text:str) -> width:int, height:int """
        pass

    def measure_markup(self, markup): # real signature unknown; restored from __doc__
        """ measure_markup(self, markup:str) -> width:int, height:int """
        pass
    ...
    def set_markup(self, markup, length): # real signature unknown; restored from __doc__
    ...
    def set_text(self, text, length): # real signature unknown; restored from __doc__
