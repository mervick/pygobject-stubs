...
class CompletionInfo(__gi_overrides_Gtk.Window):
    """
    :Constructors:
    ...
    def move_to_iter(self, view, iter=None): # real signature unknown; restored from __doc__
        """ move_to_iter(self, view:Gtk.TextView, iter:Gtk.TextIter=None) """
        pass
