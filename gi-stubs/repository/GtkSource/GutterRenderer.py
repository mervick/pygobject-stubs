...
class GutterRenderer(__gi_repository_GObject.InitiallyUnowned):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f77ca71cdc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GutterRenderer), '__module__': 'gi.repository.GtkSource', '__gtype__': <GType GtkSourceGutterRenderer (94260244483312)>, '__doc__': None, '__gsignals__': {}, 'activate': gi.FunctionInfo(activate), 'begin': gi.FunctionInfo(begin), 'draw': gi.FunctionInfo(draw), 'end': gi.FunctionInfo(end), 'get_alignment': gi.FunctionInfo(get_alignment), 'get_alignment_mode': gi.FunctionInfo(get_alignment_mode), 'get_background': gi.FunctionInfo(get_background), 'get_padding': gi.FunctionInfo(get_padding), 'get_size': gi.FunctionInfo(get_size), 'get_view': gi.FunctionInfo(get_view), 'get_visible': gi.FunctionInfo(get_visible), 'get_window_type': gi.FunctionInfo(get_window_type), 'query_activatable': gi.FunctionInfo(query_activatable), 'query_data': gi.FunctionInfo(query_data), 'query_tooltip': gi.FunctionInfo(query_tooltip), 'queue_draw': gi.FunctionInfo(queue_draw), 'set_alignment': gi.FunctionInfo(set_alignment), 'set_alignment_mode': gi.FunctionInfo(set_alignment_mode), 'set_background': gi.FunctionInfo(set_background), 'set_padding': gi.FunctionInfo(set_padding), 'set_size': gi.FunctionInfo(set_size), 'set_visible': gi.FunctionInfo(set_visible), 'do_activate': gi.VFuncInfo(activate), 'do_begin': gi.VFuncInfo(begin), 'do_change_buffer': gi.VFuncInfo(change_buffer), 'do_change_view': gi.VFuncInfo(change_view), 'do_draw': gi.VFuncInfo(draw), 'do_end': gi.VFuncInfo(end), 'do_query_activatable': gi.VFuncInfo(query_activatable), 'do_query_data': gi.VFuncInfo(query_data), 'do_query_tooltip': gi.VFuncInfo(query_tooltip), 'do_queue_draw': gi.VFuncInfo(queue_draw), 'parent': <property object at 0x7f77ca6d05e0>, 'priv': <property object at 0x7f77ca6d0720>})"
    __gdoc__ = 'Object GtkSourceGutterRenderer\n\nSignals from GtkSourceGutterRenderer:\n  query-tooltip (GtkTextIter, GdkRectangle, gint, gint, GtkTooltip) -> gboolean\n  activate (GtkTextIter, GdkRectangle, GdkEvent)\n  queue-draw ()\n  query-data (GtkTextIter, GtkTextIter, GtkSourceGutterRendererState)\n  query-activatable (GtkTextIter, GdkRectangle, GdkEvent) -> gboolean\n\nProperties from GtkSourceGutterRenderer:\n  visible -> gboolean: Visible\n    Visible\n  xpad -> gint: X Padding\n    The x-padding\n  ypad -> gint: Y Padding\n    The y-padding\n  xalign -> gfloat: X Alignment\n    The x-alignment\n  yalign -> gfloat: Y Alignment\n    The y-alignment\n  view -> GtkTextView: The View\n    The view\n  alignment-mode -> GtkSourceGutterRendererAlignmentMode: Alignment Mode\n    The alignment mode\n  window-type -> GtkTextWindowType: Window Type\n    The window type\n  size -> gint: Size\n    The size\n  background-rgba -> GdkRGBA: Background Color\n    The background color\n  background-set -> gboolean: Background Set\n    Whether the background color is set\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSourceGutterRenderer (94260244483312)>'
    __info__ = ObjectInfo(GutterRenderer)
