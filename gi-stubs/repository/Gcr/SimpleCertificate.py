...
class SimpleCertificate(__gi_overrides_GObject.Object, Certificate, Comparable):
    """
    :Constructors:
    
    ::
    
        SimpleCertificate(**properties)
        new(data:list) -> Gcr.SimpleCertificate
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7eff9cb5c430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SimpleCertificate), '__module__': 'gi.repository.Gcr', '__gtype__': <GType GcrSimpleCertificate (94112497850880)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7eff9cfb8e00>, 'pv': <property object at 0x7eff9cfb8ef0>})"
    __gdoc__ = 'Object GcrSimpleCertificate\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GcrSimpleCertificate (94112497850880)>'
    __info__ = ObjectInfo(SimpleCertificate)
