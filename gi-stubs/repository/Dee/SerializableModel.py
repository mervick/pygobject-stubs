...
class SerializableModel(__gi_overrides_GObject.Object, __gi_overrides_Dee.Model, Serializable):
    """
    :Constructors:
    
    ::
    
        SerializableModel(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5a2cf24630>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SerializableModel), '__module__': 'gi.repository.Dee', '__gtype__': <GType DeeSerializableModel (19655568)>, '__doc__': None, '__gsignals__': {}, 'get_seqnum': gi.FunctionInfo(get_seqnum), 'inc_seqnum': gi.FunctionInfo(inc_seqnum), 'set_seqnum': gi.FunctionInfo(set_seqnum), 'parent': <property object at 0x7f5a2cf3c908>, 'priv': <property object at 0x7f5a2cf3c958>})"
    __gdoc__ = 'Object DeeSerializableModel\n\nSignals from DeeModel:\n  row-added (DeeModelIter)\n  row-removed (DeeModelIter)\n  row-changed (DeeModelIter)\n  changeset-started ()\n  changeset-finished ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DeeSerializableModel (19655568)>'
    __info__ = ObjectInfo(SerializableModel)
