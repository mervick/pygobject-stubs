...
class Transaction(SerializableModel):
    ...
    ::
        ...
        new(target:Dee.Model) -> Dee.Transaction
    """
    ...
    commit = gi.FunctionInfo(commit)
    end_changeset = gi.FunctionInfo(end_changeset)
    error_quark = gi.FunctionInfo(error_quark)
    ...
    get_target = gi.FunctionInfo(get_target)
    ...
    is_committed = gi.FunctionInfo(is_committed)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5a2ce70048>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Transaction), '__module__': 'gi.repository.Dee', '__gtype__': <GType DeeTransaction (19571872)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'error_quark': gi.FunctionInfo(error_quark), 'commit': gi.FunctionInfo(commit), 'get_target': gi.FunctionInfo(get_target), 'is_committed': gi.FunctionInfo(is_committed), 'parent': <property object at 0x7f5a2cf57cc8>, 'priv': <property object at 0x7f5a2cf57d18>})"
    __gdoc__ = 'Object DeeTransaction\n\nProperties from DeeTransaction:\n  target -> DeeModel: Target\n    Target model\n\nSignals from DeeModel:\n  row-added (DeeModelIter)\n  row-removed (DeeModelIter)\n  row-changed (DeeModelIter)\n  changeset-started ()\n  changeset-finished ()\n\nSignals from DeeModel:\n  row-added (DeeModelIter)\n  row-removed (DeeModelIter)\n  row-changed (DeeModelIter)\n  changeset-started ()\n  changeset-finished ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DeeTransaction (19571872)>'
