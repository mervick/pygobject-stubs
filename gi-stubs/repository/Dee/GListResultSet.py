...
class GListResultSet(__gi_overrides_GObject.Object, ResultSet):
    """
    :Constructors:
    
    ::
    
        GListResultSet(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5a2cec1b38>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GListResultSet), '__module__': 'gi.repository.Dee', '__gtype__': <GType DeeGListResultSet (19290800)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x7f5a2cf3cea8>})"
    __gdoc__ = 'Object DeeGListResultSet\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DeeGListResultSet (19290800)>'
    __info__ = ObjectInfo(GListResultSet)
