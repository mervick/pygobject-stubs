...
class SequenceModel(SerializableModel):
    """
    :Constructors:
    
    ::
    
        SequenceModel(**properties)
        new() -> Dee.SequenceModel
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5a2ce70e80>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SequenceModel), '__module__': 'gi.repository.Dee', '__gtype__': <GType DeeSequenceModel (19719024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7f5a2cf4df98>, 'priv': <property object at 0x7f5a2cf51048>})"
    __gdoc__ = 'Object DeeSequenceModel\n\nSignals from DeeModel:\n  row-added (DeeModelIter)\n  row-removed (DeeModelIter)\n  row-changed (DeeModelIter)\n  changeset-started ()\n  changeset-finished ()\n\nSignals from DeeModel:\n  row-added (DeeModelIter)\n  row-removed (DeeModelIter)\n  row-changed (DeeModelIter)\n  changeset-started ()\n  changeset-finished ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DeeSequenceModel (19719024)>'
    __info__ = ObjectInfo(SequenceModel)
