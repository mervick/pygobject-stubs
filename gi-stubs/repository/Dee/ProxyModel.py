...
class ProxyModel(SerializableModel):
    """
    :Constructors:
    
    ::
    
        ProxyModel(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f5a2cf5a940>'
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProxyModel), '__module__': 'gi.repository.Dee', '__gtype__': <GType DeeProxyModel (19212864)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x7f5a2cf3c9f8>, 'priv': <property object at 0x7f5a2cf3ca48>})"
    __gdoc__ = 'Object DeeProxyModel\n\nProperties from DeeProxyModel:\n  back-end -> DeeModel: Back end\n    Back end model\n  proxy-signals -> gboolean: Proxy signals\n    Whether or not to automatically forward signals from the back end\n  inherit-seqnums -> gboolean: Inherit seqnums\n    Whether or not to inherit seqnums\n\nSignals from DeeModel:\n  row-added (DeeModelIter)\n  row-removed (DeeModelIter)\n  row-changed (DeeModelIter)\n  changeset-started ()\n  changeset-finished ()\n\nSignals from DeeModel:\n  row-added (DeeModelIter)\n  row-removed (DeeModelIter)\n  row-changed (DeeModelIter)\n  changeset-started ()\n  changeset-finished ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType DeeProxyModel (19212864)>'
    __info__ = ObjectInfo(ProxyModel)
