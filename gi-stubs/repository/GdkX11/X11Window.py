...
class X11Window(__gi_overrides_Gdk.Window):
    """
    :Constructors:
    ...
    ::
        ...
        foreign_new_for_display(display:GdkX11.X11Display, window:int) -> Gdk.Window
    """
    ...
    def foreign_new_for_display(self, display, window): # real signature unknown; restored from __doc__
        """ foreign_new_for_display(display:GdkX11.X11Display, window:int) -> Gdk.Window """
        pass
    ...
    def get_desktop(self): # real signature unknown; restored from __doc__
        """ get_desktop(self) -> int """
        return 0
    ...
    def lookup_for_display(self, display, window): # real signature unknown; restored from __doc__
        """ lookup_for_display(display:GdkX11.X11Display, window:int) -> GdkX11.X11Window """
        pass
    ...
    def move_to_current_desktop(self): # real signature unknown; restored from __doc__
        """ move_to_current_desktop(self) """
        pass

    def move_to_desktop(self, desktop): # real signature unknown; restored from __doc__
        """ move_to_desktop(self, desktop:int) """
        pass
    ...
    def set_frame_extents(self, left, right, top, bottom): # real signature unknown; restored from __doc__
        """ set_frame_extents(self, left:int, right:int, top:int, bottom:int) """
        pass

    def set_frame_sync_enabled(self, frame_sync_enabled): # real signature unknown; restored from __doc__
        """ set_frame_sync_enabled(self, frame_sync_enabled:bool) """
        pass
    ...
    def set_hide_titlebar_when_maximized(self, hide_titlebar_when_maximized): # real signature unknown; restored from __doc__
        """ set_hide_titlebar_when_maximized(self, hide_titlebar_when_maximized:bool) """
        pass
    ...
    def set_theme_variant(self, variant): # real signature unknown; restored from __doc__
        """ set_theme_variant(self, variant:str) """
        pass
    ...
    def set_user_time(self, timestamp): # real signature unknown; restored from __doc__
        """ set_user_time(self, timestamp:int) """
        pass

    def set_utf8_property(self, name, value=None): # real signature unknown; restored from __doc__
        """ set_utf8_property(self, name:str, value:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f08a177f1c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(X11Window), '__module__': 'gi.repository.GdkX11', '__gtype__': <GType GdkX11Window (94435716640864)>, '__doc__': None, '__gsignals__': {}, 'foreign_new_for_display': gi.FunctionInfo(foreign_new_for_display), 'lookup_for_display': gi.FunctionInfo(lookup_for_display), 'get_desktop': gi.FunctionInfo(get_desktop), 'get_xid': gi.FunctionInfo(get_xid), 'move_to_current_desktop': gi.FunctionInfo(move_to_current_desktop), 'move_to_desktop': gi.FunctionInfo(move_to_desktop), 'set_frame_extents': gi.FunctionInfo(set_frame_extents), 'set_frame_sync_enabled': gi.FunctionInfo(set_frame_sync_enabled), 'set_hide_titlebar_when_maximized': gi.FunctionInfo(set_hide_titlebar_when_maximized), 'set_theme_variant': gi.FunctionInfo(set_theme_variant), 'set_user_time': gi.FunctionInfo(set_user_time), 'set_utf8_property': gi.FunctionInfo(set_utf8_property)})"
    __gdoc__ = 'Object GdkX11Window\n\nSignals from GdkWindow:\n  pick-embedded-child (gdouble, gdouble) -> GdkWindow\n  to-embedder (gdouble, gdouble, gpointer, gpointer)\n  from-embedder (gdouble, gdouble, gpointer, gpointer)\n  create-surface (gint, gint) -> CairoSurface\n  moved-to-rect (gpointer, gpointer, gboolean, gboolean)\n\nProperties from GdkWindow:\n  cursor -> GdkCursor: Cursor\n    Cursor\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkX11Window (94435716640864)>'
    __info__ = ObjectInfo(X11Window)
