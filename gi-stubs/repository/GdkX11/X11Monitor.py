...
class X11Monitor(__gi_repository_Gdk.Monitor):
    """
    :Constructors:
    ...
    def get_output(self, monitor): # real signature unknown; restored from __doc__
        """ get_output(monitor:Gdk.Monitor) -> int """
        return 0
