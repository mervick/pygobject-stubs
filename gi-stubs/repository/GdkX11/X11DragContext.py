...
class X11DragContext(__gi_overrides_Gdk.DragContext):
    """
    :Constructors:
    
    ::
    
        X11DragContext(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f08a17f1ee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(X11DragContext), '__module__': 'gi.repository.GdkX11', '__gtype__': <GType GdkX11DragContext (94435717217136)>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GdkX11DragContext\n\nSignals from GdkDragContext:\n  cancel (GdkDragCancelReason)\n  drop-performed (gint)\n  dnd-finished ()\n  action-changed (GdkDragAction)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkX11DragContext (94435717217136)>'
    __info__ = ObjectInfo(X11DragContext)
