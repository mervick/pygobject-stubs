...
class X11Cursor(__gi_overrides_Gdk.Cursor):
    """
    :Constructors:
    
    ::
    
        X11Cursor(**properties)
    """
    ...
    def get_xcursor(self): # real signature unknown; restored from __doc__
        """ get_xcursor(self) -> int """
        return 0
    ...
    def new_for_display(self, display, cursor_type): # real signature unknown; restored from __doc__
        """ new_for_display(display:Gdk.Display, cursor_type:Gdk.CursorType) -> Gdk.Cursor """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f08a17f1a00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(X11Cursor), '__module__': 'gi.repository.GdkX11', '__gtype__': <GType GdkX11Cursor (94435716819408)>, '__doc__': None, '__gsignals__': {}, 'get_xcursor': gi.FunctionInfo(get_xcursor), 'get_xdisplay': gi.FunctionInfo(get_xdisplay)})"
    __gdoc__ = 'Object GdkX11Cursor\n\nProperties from GdkCursor:\n  cursor-type -> GdkCursorType: Cursor type\n    Standard cursor type\n  display -> GdkDisplay: Display\n    Display of this cursor\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkX11Cursor (94435716819408)>'
    __info__ = ObjectInfo(X11Cursor)
