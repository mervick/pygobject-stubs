...
class X11DisplayManager(__gi_repository_Gdk.DisplayManager):
    """
    :Constructors:
    
    ::
    
        X11DisplayManager(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f08a17fed60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(X11DisplayManager), '__module__': 'gi.repository.GdkX11', '__gtype__': <GType GdkX11DisplayManager (94435717212720)>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GdkX11DisplayManager\n\nSignals from GdkDisplayManager:\n  display-opened (GdkDisplay)\n\nProperties from GdkDisplayManager:\n  default-display -> GdkDisplay: Default Display\n    The default display for GDK\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkX11DisplayManager (94435717212720)>'
    __info__ = ObjectInfo(X11DisplayManager)
