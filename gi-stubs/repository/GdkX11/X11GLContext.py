...
class X11GLContext(__gi_repository_Gdk.GLContext):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f08a17d66d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(X11GLContext), '__module__': 'gi.repository.GdkX11', '__gtype__': <GType GdkX11GLContext (94435716712976)>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GdkX11GLContext\n\nProperties from GdkGLContext:\n  display -> GdkDisplay: Display\n    The GDK display used to create the GL context\n  window -> GdkWindow: Window\n    The GDK window bound to the GL context\n  shared-context -> GdkGLContext: Shared context\n    The GL context this context shares data with\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkX11GLContext (94435716712976)>'
    __info__ = ObjectInfo(X11GLContext)
