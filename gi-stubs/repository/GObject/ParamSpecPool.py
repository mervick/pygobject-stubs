...
class ParamSpecPool(__gi.Struct):
    ...
    def list(self, owner_type): # real signature unknown; restored from __doc__
        """ list(self, owner_type:GType) -> list, n_pspecs_p:int """
        return []
    ...
    def lookup(self, param_name, owner_type, walk_ancestors): # real signature unknown; restored from __doc__
        """ lookup(self, param_name:str, owner_type:GType, walk_ancestors:bool) -> GObject.ParamSpec """
        pass

    def new(self, type_prefixing): # real signature unknown; restored from __doc__
        """ new(type_prefixing:bool) -> GObject.ParamSpecPool """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ParamSpecPool), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ParamSpecPool' objects>, '__weakref__': <attribute '__weakref__' of 'ParamSpecPool' objects>, '__doc__': None, 'insert': gi.FunctionInfo(insert), 'list': gi.FunctionInfo(list), 'list_owned': gi.FunctionInfo(list_owned), 'lookup': gi.FunctionInfo(lookup), 'remove': gi.FunctionInfo(remove), 'new': gi.FunctionInfo(new)})"
