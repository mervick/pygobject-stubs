...
class ParamSpec(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpec), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParam (76)>, '__dict__': <attribute '__dict__' of 'ParamSpec' objects>, '__weakref__': <attribute '__weakref__' of 'ParamSpec' objects>, '__doc__': None, '__gsignals__': {}, 'get_blurb': gi.FunctionInfo(get_blurb), 'get_default_value': gi.FunctionInfo(get_default_value), 'get_name': gi.FunctionInfo(get_name), 'get_name_quark': gi.FunctionInfo(get_name_quark), 'get_nick': gi.FunctionInfo(get_nick), 'get_qdata': gi.FunctionInfo(get_qdata), 'get_redirect_target': gi.FunctionInfo(get_redirect_target), 'set_qdata': gi.FunctionInfo(set_qdata), 'sink': gi.FunctionInfo(sink), 'steal_qdata': gi.FunctionInfo(steal_qdata), 'do_finalize': gi.VFuncInfo(finalize), 'do_value_set_default': gi.VFuncInfo(value_set_default), 'do_value_validate': gi.VFuncInfo(value_validate), 'do_values_cmp': gi.VFuncInfo(values_cmp), 'g_type_instance': <property object at 0x7fe46b8b60e0>, 'name': <property object at 0x7fe46b8b61d0>, 'flags': <property object at 0x7fe46b8b62c0>, 'value_type': <property object at 0x7fe46b8b63b0>, 'owner_type': <property object at 0x7fe46b8b64a0>, '_nick': <property object at 0x7fe46b8b6590>, '_blurb': <property object at 0x7fe46b8b6680>, 'qdata': <property object at 0x7fe46b8b6770>, 'ref_count': <property object at 0x7fe46b8b6860>, 'param_id': <property object at 0x7fe46b8b6950>})"
    __gsignals__ = {}
