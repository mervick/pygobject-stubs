...
class DataCalFactory(__gi_repository_EBackend.DataFactory):
    """
    :Constructors:
    
    ::
    
        DataCalFactory(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb65e5dd4f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DataCalFactory), '__module__': 'gi.repository.EDataCal', '__gtype__': <GType EDataCalFactory (94060045474208)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'parent': <property object at 0x7fb65af48310>, 'priv': <property object at 0x7fb65af48450>})"
    __gdoc__ = 'Object EDataCalFactory\n\nProperties from EDataFactory:\n  registry -> ESourceRegistry: Registry\n    Data source registry\n  reload-supported -> gboolean: Reload Supported\n    Whether the data factory supports Reload\n  backend-per-process -> gint: Backend Per Process\n    Override backend-per-process compile-time option\n\nSignals from EDBusServer:\n  bus-acquired (GDBusConnection)\n  bus-name-acquired (GDBusConnection)\n  bus-name-lost (GDBusConnection)\n  run-server () -> EDBusServerExitCode\n  quit-server (EDBusServerExitCode)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType EDataCalFactory (94060045474208)>'
    __info__ = ObjectInfo(DataCalFactory)
