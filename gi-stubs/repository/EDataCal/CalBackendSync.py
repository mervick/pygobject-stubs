...
class CalBackendSync(CalBackend):
    """
    :Constructors:
    
    ::
    
        CalBackendSync(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7fb65e5caf40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CalBackendSync), '__module__': 'gi.repository.EDataCal', '__gtype__': <GType ECalBackendSync (94060045404336)>, '__doc__': None, '__gsignals__': {}, 'add_timezone': gi.FunctionInfo(add_timezone), 'create_objects': gi.FunctionInfo(create_objects), 'discard_alarm': gi.FunctionInfo(discard_alarm), 'get_attachment_uris': gi.FunctionInfo(get_attachment_uris), 'get_free_busy': gi.FunctionInfo(get_free_busy), 'get_object': gi.FunctionInfo(get_object), 'get_object_list': gi.FunctionInfo(get_object_list), 'get_timezone': gi.FunctionInfo(get_timezone), 'modify_objects': gi.FunctionInfo(modify_objects), 'open': gi.FunctionInfo(open), 'receive_objects': gi.FunctionInfo(receive_objects), 'refresh': gi.FunctionInfo(refresh), 'remove_objects': gi.FunctionInfo(remove_objects), 'send_objects': gi.FunctionInfo(send_objects), 'do_add_timezone_sync': gi.VFuncInfo(add_timezone_sync), 'do_discard_alarm_sync': gi.VFuncInfo(discard_alarm_sync), 'do_get_object_sync': gi.VFuncInfo(get_object_sync), 'do_get_timezone_sync': gi.VFuncInfo(get_timezone_sync), 'do_open_sync': gi.VFuncInfo(open_sync), 'do_receive_objects_sync': gi.VFuncInfo(receive_objects_sync), 'do_refresh_sync': gi.VFuncInfo(refresh_sync), 'parent': <property object at 0x7fb65e5f4ea0>, 'priv': <property object at 0x7fb65e5f6090>})"
    __gdoc__ = "Object ECalBackendSync\n\nSignals from ETimezoneCache:\n  timezone-added (ICalTimezone)\n\nSignals from ECalBackend:\n  closed (gchararray)\n  shutdown ()\n\nProperties from ECalBackend:\n  cache-dir -> gchararray: Cache Dir\n    The backend's cache directory\n  kind -> gulong: Kind\n    The kind of iCalendar components this backend manages\n  proxy-resolver -> GProxyResolver: Proxy Resolver\n    The proxy resolver for this backend\n  registry -> ESourceRegistry: Registry\n    Data source registry\n  writable -> gboolean: Writable\n    Whether the backend will accept changes\n\nSignals from ETimezoneCache:\n  timezone-added (ICalTimezone)\n\nProperties from EBackend:\n  connectable -> GSocketConnectable: Connectable\n    Socket endpoint of a network service\n  main-context -> GMainContext: Main Context\n    The main loop context on which to attach event sources\n  online -> gboolean: Online\n    Whether the backend is online\n  source -> ESource: Source\n    The data source being acted upon\n  user-prompter -> EUserPrompter: User Prompter\n    User prompter instance\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType ECalBackendSync (94060045404336)>'
    __info__ = ObjectInfo(CalBackendSync)
