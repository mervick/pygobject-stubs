...
class EditableText(__gobject.GInterface):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(EditableText), '__module__': 'gi.repository.Atspi', '__gtype__': <GType AtspiEditableText (94141573319488)>, '__dict__': <attribute '__dict__' of 'EditableText' objects>, '__weakref__': <attribute '__weakref__' of 'EditableText' objects>, '__doc__': None, '__gsignals__': {}, 'copy_text': gi.FunctionInfo(copy_text), 'cut_text': gi.FunctionInfo(cut_text), 'delete_text': gi.FunctionInfo(delete_text), 'insert_text': gi.FunctionInfo(insert_text), 'paste_text': gi.FunctionInfo(paste_text), 'set_text_contents': gi.FunctionInfo(set_text_contents)})"
    __gdoc__ = 'Interface AtspiEditableText\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtspiEditableText (94141573319488)>'
