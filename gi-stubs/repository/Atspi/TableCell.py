...
class TableCell(__gobject.GInterface):
    ...
    def get_position(self): # real signature unknown; restored from __doc__
        """ get_position(self) -> int, row:int, column:int """
        return 0
