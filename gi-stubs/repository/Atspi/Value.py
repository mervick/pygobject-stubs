...
class Value(__gobject.GInterface):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(Value), '__module__': 'gi.repository.Atspi', '__gtype__': <GType AtspiValue (94141572560224)>, '__dict__': <attribute '__dict__' of 'Value' objects>, '__weakref__': <attribute '__weakref__' of 'Value' objects>, '__doc__': None, '__gsignals__': {}, 'get_current_value': gi.FunctionInfo(get_current_value), 'get_maximum_value': gi.FunctionInfo(get_maximum_value), 'get_minimum_increment': gi.FunctionInfo(get_minimum_increment), 'get_minimum_value': gi.FunctionInfo(get_minimum_value), 'set_current_value': gi.FunctionInfo(set_current_value)})"
    __gdoc__ = 'Interface AtspiValue\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtspiValue (94141572560224)>'
