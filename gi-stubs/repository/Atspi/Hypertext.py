...
class Hypertext(__gobject.GInterface):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(Hypertext), '__module__': 'gi.repository.Atspi', '__gtype__': <GType AtspiHypertext (94141573300496)>, '__dict__': <attribute '__dict__' of 'Hypertext' objects>, '__weakref__': <attribute '__weakref__' of 'Hypertext' objects>, '__doc__': None, '__gsignals__': {}, 'get_link': gi.FunctionInfo(get_link), 'get_link_index': gi.FunctionInfo(get_link_index), 'get_n_links': gi.FunctionInfo(get_n_links)})"
    __gdoc__ = 'Interface AtspiHypertext\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtspiHypertext (94141573300496)>'
