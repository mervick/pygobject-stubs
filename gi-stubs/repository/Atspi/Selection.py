...
class Selection(__gobject.GInterface):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(Selection), '__module__': 'gi.repository.Atspi', '__gtype__': <GType AtspiSelection (94141573184800)>, '__dict__': <attribute '__dict__' of 'Selection' objects>, '__weakref__': <attribute '__weakref__' of 'Selection' objects>, '__doc__': None, '__gsignals__': {}, 'clear_selection': gi.FunctionInfo(clear_selection), 'deselect_child': gi.FunctionInfo(deselect_child), 'deselect_selected_child': gi.FunctionInfo(deselect_selected_child), 'get_n_selected_children': gi.FunctionInfo(get_n_selected_children), 'get_selected_child': gi.FunctionInfo(get_selected_child), 'is_child_selected': gi.FunctionInfo(is_child_selected), 'select_all': gi.FunctionInfo(select_all), 'select_child': gi.FunctionInfo(select_child)})"
    __gdoc__ = 'Interface AtspiSelection\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtspiSelection (94141573184800)>'
