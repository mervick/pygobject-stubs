...
class Hook(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Hook), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Hook' objects>, '__weakref__': <attribute '__weakref__' of 'Hook' objects>, '__doc__': None, 'data': <property object at 0x7f85134e1810>, 'next': <property object at 0x7f85134e1900>, 'prev': <property object at 0x7f85134e19f0>, 'ref_count': <property object at 0x7f85134e1ae0>, 'hook_id': <property object at 0x7f85134e1bd0>, 'flags': <property object at 0x7f85134e1cc0>, 'func': <property object at 0x7f85134e1db0>, 'destroy': gi.FunctionInfo(destroy), 'compare_ids': gi.FunctionInfo(compare_ids), 'destroy_link': gi.FunctionInfo(destroy_link), 'free': gi.FunctionInfo(free), 'insert_before': gi.FunctionInfo(insert_before), 'prepend': gi.FunctionInfo(prepend), 'unref': gi.FunctionInfo(unref)})"
