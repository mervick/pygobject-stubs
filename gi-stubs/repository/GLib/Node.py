...
class Node(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Node), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Node' objects>, '__weakref__': <attribute '__weakref__' of 'Node' objects>, '__doc__': None, 'data': <property object at 0x7f85134f11d0>, 'next': <property object at 0x7f85134f12c0>, 'prev': <property object at 0x7f85134f13b0>, 'parent': <property object at 0x7f85134f14a0>, 'children': <property object at 0x7f85134f1590>, 'child_index': gi.FunctionInfo(child_index), 'child_position': gi.FunctionInfo(child_position), 'depth': gi.FunctionInfo(depth), 'destroy': gi.FunctionInfo(destroy), 'is_ancestor': gi.FunctionInfo(is_ancestor), 'max_height': gi.FunctionInfo(max_height), 'n_children': gi.FunctionInfo(n_children), 'n_nodes': gi.FunctionInfo(n_nodes), 'reverse_children': gi.FunctionInfo(reverse_children), 'unlink': gi.FunctionInfo(unlink)})"
