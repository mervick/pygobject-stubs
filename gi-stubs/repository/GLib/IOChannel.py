...
class IOChannel(IOChannel):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.GLib', '__new__': <staticmethod object at 0x7f1d2ccaadc0>, '__init__': <function IOChannel.__init__ at 0x7f1d2ccc7700>, 'read': <function IOChannel.read at 0x7f1d2ccc7790>, 'readline': <function IOChannel.readline at 0x7f1d2ccc7820>, 'readlines': <function IOChannel.readlines at 0x7f1d2ccc78b0>, 'write': <function IOChannel.write at 0x7f1d2ccc7940>, 'writelines': <function IOChannel.writelines at 0x7f1d2ccc79d0>, '_whence_map': {0: <enum G_SEEK_SET of type GLib.SeekType>, 1: <enum G_SEEK_CUR of type GLib.SeekType>, 2: <enum G_SEEK_END of type GLib.SeekType>}, 'seek': <function IOChannel.seek at 0x7f1d2ccc7a60>, 'add_watch': <function IOChannel.add_watch at 0x7f1d2ccc7b80>, '__iter__': <function IOChannel.__iter__ at 0x7f1d2ccc7c10>, '__next__': <function IOChannel.__next__ at 0x7f1d2ccc7ca0>, 'next': <function IOChannel.__next__ at 0x7f1d2ccc7ca0>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GIOChannel (94243598386064)>'
