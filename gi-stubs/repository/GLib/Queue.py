...
class Queue(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Queue), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Queue' objects>, '__weakref__': <attribute '__weakref__' of 'Queue' objects>, '__doc__': None, 'head': <property object at 0x7f85134f54f0>, 'tail': <property object at 0x7f85134f55e0>, 'length': <property object at 0x7f85134f56d0>, 'clear': gi.FunctionInfo(clear), 'clear_full': gi.FunctionInfo(clear_full), 'free': gi.FunctionInfo(free), 'free_full': gi.FunctionInfo(free_full), 'get_length': gi.FunctionInfo(get_length), 'index': gi.FunctionInfo(index), 'init': gi.FunctionInfo(init), 'is_empty': gi.FunctionInfo(is_empty), 'peek_head': gi.FunctionInfo(peek_head), 'peek_nth': gi.FunctionInfo(peek_nth), 'peek_tail': gi.FunctionInfo(peek_tail), 'pop_head': gi.FunctionInfo(pop_head), 'pop_nth': gi.FunctionInfo(pop_nth), 'pop_tail': gi.FunctionInfo(pop_tail), 'push_head': gi.FunctionInfo(push_head), 'push_nth': gi.FunctionInfo(push_nth), 'push_tail': gi.FunctionInfo(push_tail), 'remove': gi.FunctionInfo(remove), 'remove_all': gi.FunctionInfo(remove_all), 'reverse': gi.FunctionInfo(reverse)})"
