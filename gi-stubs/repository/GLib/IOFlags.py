...
class IOFlags(__gobject.GFlags):
    ...
    SET_MASK = 3
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GLib', '__dict__': <attribute '__dict__' of 'IOFlags' objects>, '__doc__': None, '__gtype__': <GType PyGLibIOFlags (94243598351808)>, '__flags_values__': {1: <flags G_IO_FLAG_APPEND of type GLib.IOFlags>, 2: <flags G_IO_FLAG_NONBLOCK of type GLib.IOFlags>, 4: <flags G_IO_FLAG_IS_READABLE of type GLib.IOFlags>, 8: <flags G_IO_FLAG_IS_WRITABLE | G_IO_FLAG_IS_WRITEABLE of type GLib.IOFlags>, 16: <flags G_IO_FLAG_IS_SEEKABLE of type GLib.IOFlags>, 31: <flags G_IO_FLAG_APPEND | G_IO_FLAG_NONBLOCK | G_IO_FLAG_IS_READABLE | G_IO_FLAG_IS_WRITABLE | G_IO_FLAG_IS_WRITEABLE | G_IO_FLAG_IS_SEEKABLE | G_IO_FLAG_MASK | G_IO_FLAG_GET_MASK | G_IO_FLAG_SET_MASK of type GLib.IOFlags>, 3: <flags G_IO_FLAG_APPEND | G_IO_FLAG_NONBLOCK | G_IO_FLAG_SET_MASK of type GLib.IOFlags>}, '__info__': gi.EnumInfo(IOFlags), 'APPEND': <flags G_IO_FLAG_APPEND of type GLib.IOFlags>, 'NONBLOCK': <flags G_IO_FLAG_NONBLOCK of type GLib.IOFlags>, 'IS_READABLE': <flags G_IO_FLAG_IS_READABLE of type GLib.IOFlags>, 'IS_WRITABLE': <flags G_IO_FLAG_IS_WRITABLE | G_IO_FLAG_IS_WRITEABLE of type GLib.IOFlags>, 'IS_WRITEABLE': <flags G_IO_FLAG_IS_WRITABLE | G_IO_FLAG_IS_WRITEABLE of type GLib.IOFlags>, 'IS_SEEKABLE': <flags G_IO_FLAG_IS_SEEKABLE of type GLib.IOFlags>, 'MASK': <flags G_IO_FLAG_APPEND | G_IO_FLAG_NONBLOCK | G_IO_FLAG_IS_READABLE | G_IO_FLAG_IS_WRITABLE | G_IO_FLAG_IS_WRITEABLE | G_IO_FLAG_IS_SEEKABLE | G_IO_FLAG_MASK | G_IO_FLAG_GET_MASK | G_IO_FLAG_SET_MASK of type GLib.IOFlags>, 'GET_MASK': <flags G_IO_FLAG_APPEND | G_IO_FLAG_NONBLOCK | G_IO_FLAG_IS_READABLE | G_IO_FLAG_IS_WRITABLE | G_IO_FLAG_IS_WRITEABLE | G_IO_FLAG_IS_SEEKABLE | G_IO_FLAG_MASK | G_IO_FLAG_GET_MASK | G_IO_FLAG_SET_MASK of type GLib.IOFlags>, 'SET_MASK': <flags G_IO_FLAG_APPEND | G_IO_FLAG_NONBLOCK | G_IO_FLAG_SET_MASK of type GLib.IOFlags>})"
    __flags_values__ = {
        1: 1,
        2: 2,
        3: 3,
    ...
    __gtype__ = None # (!) real value is '<GType PyGLibIOFlags (94243598351808)>'
