...
class Hmac(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Hmac), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Hmac' objects>, '__weakref__': <attribute '__weakref__' of 'Hmac' objects>, '__doc__': None, 'get_digest': gi.FunctionInfo(get_digest), 'get_string': gi.FunctionInfo(get_string), 'unref': gi.FunctionInfo(unref), 'update': gi.FunctionInfo(update)})"
