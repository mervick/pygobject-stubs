...
class Rand(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Rand), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Rand' objects>, '__weakref__': <attribute '__weakref__' of 'Rand' objects>, '__doc__': None, 'double': gi.FunctionInfo(double), 'double_range': gi.FunctionInfo(double_range), 'free': gi.FunctionInfo(free), 'int': gi.FunctionInfo(int), 'int_range': gi.FunctionInfo(int_range), 'set_seed': gi.FunctionInfo(set_seed), 'set_seed_array': gi.FunctionInfo(set_seed_array)})"
